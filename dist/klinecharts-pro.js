...
import { utils as R, OverlayMode as r0, init as E9, FormatDateType as W1, DomPosition as a0, ActionType as O9, dispose as i0, TooltipIconPosition as q1, CandleType as B9, YAxisType as U9, registerOverlay as K9 } from "klinecharts";
function z1(e, t, n) {
...
const F9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    ...
    if (e.length > 1) {
      ...
      c.forEach((u) => {
        const h = e[1].y + o * u, p = (C[1].value + y * u).toFixed(n.price);
    ...
    if (e.length > 1) {
      ...
      for (let h = 2; h < 9; h++) {
        ...
        switch (h % 4) {
          ...
          case 1: {
            b = s + Math.PI / 2, u -= C[h - 2].r;
            break;
          }
          case 2: {
            b = s + Math.PI, y += C[h - 2].r;
            break;
          }
          case 3: {
            b = s + Math.PI / 2 * 3, u += C[h - 2].r;
            break;
          }
        }
...
var X = null;
let $1 = null, Z = null, e1 = null, C1 = null, Be = 0;
function re(e, t) {
...
function o5(e, t, n) {
  ...
  let c = null, o = xe, C = null, y = !1, u = "initialValue" in s, h = typeof r == "function" && Y(r);
  const p = /* @__PURE__ */ new Set(), [b, S] = (s.storage || M)(s.initialValue), [I, N] = M(void 0), [P, E] = M(void 0, {
    equals: !1
  }), [w, D] = M(u ? "ready" : "unresolved");
  if (t1.context) {
    C = `${t1.context.id}${t1.context.count++}`;
    let O;
    s.ssrLoadFrom === "initial" ? o = s.initialValue : t1.load && (O = t1.load(C)) && (o = O[0]);
  }
  function A(O, z, H, u1) {
    return c === O && (c = null, u = !0, (O === o || z === o) && s.onHydrated && queueMicrotask(() => s.onHydrated(u1, {
      value: z
    })), o = xe, F(z, H)), z;
  }
  function F(O, z) {
    m1(() => {
      z === void 0 && S(() => O), D(z !== void 0 ? "errored" : "ready"), N(z);
  ...
  function W() {
    ...
    if (H !== void 0 && !c)
      throw H;
    return Z && !Z.user && O && s0(() => {
      P(), c && (O.resolved || p.has(O) || (O.increment(), p.add(O)));
    }), z;
  }
  function l1(O = !0) {
    if (O !== !1 && y)
...
function y5(e, t, n = {}) {
  ...
  return ye(() => o0(s)), () => {
    let C = e() || [], y, u;
    return C[s5], f1(() => {
      let p = C.length, b, S, I, N, P, E, w, D, A;
      if (p === 0)
        ...
        for (I = new Array(p), N = new Array(p), o && (P = new Array(p)), E = 0, w = Math.min(c, p); E < w && r[E] === C[E]; E++)
          ;
        for (w = c - 1, D = p - 1; w >= E && D >= E && r[w] === C[D]; w--, D--)
          I[D] = a[w], N[D] = s[w], o && (P[D] = o[w]);
        for (b = /* @__PURE__ */ new Map(), S = new Array(D + 1), u = D; u >= E; u--)
          A = C[u], y = b.get(A), S[u] = y === void 0 ? -1 : y, b.set(A, u);
        for (y = E; y <= w; y++)
  ...
  if (e = c && n[0] && n[0].parentNode || e, s === "string" || s === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (o.length === 0) {
        ...
        C ? n.length === 0 ? l0(e, o, r) : m5(e, n, o) : (n && w1(e), l0(e, o));
      n = o;
...
var D5 = P5, d0 = me, N5 = S5, E5 = D5, O5 = "[object Null]", B5 = "[object Undefined]", C0 = d0 ? d0.toStringTag : void 0;
function U5(e) {
  return e == null ? e === void 0 ? B5 : O5 : C0 && C0 in Object(e) ? N5(e) : E5(e);
}
var Y1 = U5;
function K5(e) {
  var t = typeof e;
...
var Fe = N6, E6 = I1, O6 = Fe, B6 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, U6 = /^\w*$/;
function K6(e, t) {
  if (E6(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || O6(e) ? !0 : U6.test(e) || !B6.test(e) || t != null && e in Object(t);
}
var F6 = K6, j6 = b1, Z6 = j6(Object, "create"), pe = Z6, h0 = pe;
function Q6() {
...
var It = Tt, Pt = ht, Dt = Lt, Nt = kt, Et = Mt, Ot = It;
function N1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
N1.prototype.has = Et;
N1.prototype.set = Ot;
var _e = N1, Bt = b1, Ut = c1, Kt = Bt(Ut, "Map"), je = Kt, g0 = ft, Ft = _e, jt = je;
function Zt() {
...
var B2 = O2, U2 = 9007199254740991, K2 = /^(?:0|[1-9]\d*)$/;
function F2(e, t) {
  var n = typeof e;
...
var z2 = Q2, R2 = Ke, Y2 = B2, H2 = C9, _0 = T1, V2 = z2;
function G2(e, t, n, r) {
  if (!_0(e))
    return e;
  t = Y2(t, e);
  for (var a = -1, s = t.length, c = s - 1, o = e; o != null && ++a < s; ) {
    ...
    if (a != c) {
      var u = o[C];
      y = r ? r(u, C, o) : void 0, y === void 0 && (y = _0(u) ? u : H2(t[a + 1]) ? [] : {});
    }
    R2(o, C, y), o = o[C];
  }
  return e;
...
O1.prototype.clear = g3;
O1.prototype.delete = m3;
O1.prototype.get = p3;
O1.prototype.has = v3;
O1.prototype.set = _3;
var $3 = O1;
...
function A3(e, t, n, r) {
  ...
  for (var s = -1, c = t.length; ++s < c; ) {
    ...
    C === void 0 && (C = e[o]), a ? k3(n, o, C) : x3(n, o, C);
  }
  return n;
}
var Le = A3;
...
var D3 = P3, $0 = D3, N3 = P1, f9 = Object.prototype, E3 = f9.hasOwnProperty, O3 = f9.propertyIsEnumerable, B3 = $0(function() {
  return arguments;
}()) ? $0 : function(e) {
  return N3(e) && E3.call(e, "callee") && !O3.call(e, "callee");
}, U3 = B3, ue = { exports: {} };
function K3() {
  return !1;
}
...
ue.exports;
(function(e, t) {
  var n = c1, r = F3, a = t && !t.nodeType && t, s = a && !0 && e && !e.nodeType && e, c = s && s.exports === a, o = c ? n.Buffer : void 0, C = o ? o.isBuffer : void 0, y = C || r;
  e.exports = y;
})(ue, ue.exports);
...
function I8(e, t) {
  var n = k8(e), r = !n && x8(e), a = !n && !r && A8(e), s = !n && !r && !a && M8(e), c = n || r || a || s, o = c ? b8(e.length, String) : [], C = o.length;
  for (var y in e)
...
var m9 = N8, E8 = m9, O8 = E8(Object.keys, Object), B8 = O8, U8 = Re, K8 = B8, F8 = Object.prototype, j8 = F8.hasOwnProperty;
function Z8(e) {
  if (!U8(e))
    return K8(e);
  var t = [];
...
var _9 = D7, N7 = m9, E7 = N7(Object.getPrototypeOf, Object), $9 = E7, O7 = _9, B7 = $9, U7 = Ve, K7 = v9, F7 = Object.getOwnPropertySymbols, j7 = F7 ? function(e) {
  for (var t = []; e; )
    O7(t, U7(e)), e = B7(e);
  return t;
...
var an = rn, sn = b1, on = c1, cn = sn(on, "DataView"), ln = cn, un = b1, dn = c1, Cn = un(dn, "Promise"), fn = Cn, yn = b1, hn = c1, gn = yn(hn, "Set"), mn = gn, pn = b1, vn = c1, _n = pn(vn, "WeakMap"), $n = _n, Pe = ln, De = je, Ne = fn, Ee = mn, Oe = $n, x9 = Y1, B1 = s9, k0 = "[object Map]", Ln = "[object Object]", A0 = "[object Promise]", w0 = "[object Set]", M0 = "[object WeakMap]", S0 = "[object DataView]", bn = B1(Pe), xn = B1(De), kn = B1(Ne), An = B1(Ee), wn = B1(Oe), _1 = x9;
(Pe && _1(new Pe(new ArrayBuffer(1))) != S0 || De && _1(new De()) != k0 || Ne && _1(Ne.resolve()) != A0 || Ee && _1(new Ee()) != w0 || Oe && _1(new Oe()) != M0) && (_1 = function(e) {
  var t = x9(e), n = t == Ln ? e.constructor : void 0, r = n ? B1(n) : "";
  if (r)
    switch (r) {
      case bn:
        return S0;
...
function ae(e, t, n, r, a, s) {
  ...
  if (u) {
    ...
    if (h == w9 || h == k9 || p && !a) {
      if (c = C || p ? {} : i4(e), !o)
        return C ? qr(e, Gr(c, e)) : Wr(e, Vr(c, e));
    } else {
      if (!K[h])
        return a ? e : {};
      c = a4(e, h, o);
  ...
  var S = y ? C ? t4 : e4 : C ? C4 : d4, I = u ? void 0 : S(e);
...
const R4 = /* @__PURE__ */ n9(z4), Y4 = /* @__PURE__ */ m("<button></button>"), H4 = (e) => (() => {
  ...
  return g1(t, "click", e.onClick, !0), _(t, () => e.children), Q((n) => {
    ...
    return n._v$ = S1(t, r, n._v$), a !== n._v$2 && L1(t, n._v$2 = a), n;
  }, {
    _v$: void 0,
    _v$2: void 0
  }), t;
...
const V4 = /* @__PURE__ */ m('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), G4 = /* @__PURE__ */ m('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), X4 = /* @__PURE__ */ m("<div></div>"), J4 = /* @__PURE__ */ m('<span class="label"></span>'), W4 = () => V4.cloneNode(!0), q4 = () => G4.cloneNode(!0), K0 = (e) => {
  ...
  return d1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a._v$ = S1(r, s, a._v$), c !== a._v$2 && L1(r, a._v$2 = c), a;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
...
const ea = /* @__PURE__ */ m('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), M9 = () => ea.cloneNode(!0), ta = /* @__PURE__ */ m('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), na = () => ta.cloneNode(!0), ra = /* @__PURE__ */ m("<ul></ul>"), aa = /* @__PURE__ */ m("<li></li>"), fe = (e) => (() => {
  ...
  return _(r, () => e.title, a), g1(a, "click", e.onClose, !0), _(s, () => e.children), _(n, (() => {
    ...
    return () => c() && (() => {
      ...
      return _(o, () => e.buttons.map((C) => v(H4, t9(C, {
        get style() {
          return {
      ...
      })))), Q(() => o.classList.toggle("mobile-buttons", !!e.isMobile)), o;
    })();
  })(), null), Q((c) => {
    const o = !!e.isMobile, C = e.isMobile ? "100%" : `${e.width ?? 400}px`, y = e.isMobile ? "100%" : "auto", u = e.isMobile ? "100vh" : "90vh", h = !!e.isMobile, p = !!e.isMobile, b = !!e.isMobile;
...
const oa = /* @__PURE__ */ m('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ca = /* @__PURE__ */ m('<div class="drop-down-container"><ul></ul></div>'), la = /* @__PURE__ */ m('<div><input type="text"></div>'), ua = /* @__PURE__ */ m("<li></li>"), S9 = (e) => {
  ...
  return (() => {
    ...
    return typeof b == "function" ? R1(b, u) : c = u, _(p, () => e.value), _(u, (() => {
      ...
      return S._v$ = S1(u, I, S._v$), N !== S._v$2 && L1(u, S._v$2 = N), S;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), u;
  ...
  return (() => {
    ...
    return s.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        p <= 0 ? h = new RegExp(/^[1-9]\d*$/) : h = new RegExp("^\\d+\\.?\\d{0," + p + "}$"), (C === "" || h.test(C) && +C >= t.min && +C <= t.max) && ((y = t.onChange) == null || y.call(t, C === "" ? C : +C));
      } else
      ...
      const C = t.style, y = `klinecharts-pro-input ${t.class ?? ""}`, u = r(), h = t.placeholder ?? "";
      return o._v$ = S1(s, C, o._v$), y !== o._v$2 && L1(s, o._v$2 = y), u !== o._v$3 && r1(s, "data-status", o._v$3 = u), h !== o._v$4 && r1(c, "placeholder", o._v$4 = h), o;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
const i = (e, t) => {
  ...
  return Ue(() => {
    ...
    const s = Dc.cloneNode(!0), c = s.firstChild, o = c.firstChild, C = c.nextSibling, y = C.firstChild, u = y.nextSibling, h = C.nextSibling, p = h.firstChild, b = p.nextSibling, S = h.nextSibling, I = S.firstChild, N = I.nextSibling, P = S.nextSibling, E = P.firstChild, w = E.nextSibling, D = P.nextSibling;
    return R1((A) => {
      t = A;
    ...
    }), C), _(s, () => e.periods.map((A) => (() => {
      const F = we.cloneNode(!0);
      return F.$$click = () => {
        e.onPeriodChange(A);
      }, _(F, () => A.text), Q(() => L1(F, `item period ${A.text === e.period.text ? "selected" : ""}`)), F;
    })()), C), g1(C, "click", e.onIndicatorClick, !0), _(u, () => i("indicator", e.locale)), g1(h, "click", e.onTimezoneClick, !0), _(b, () => i("timezone", e.locale)), g1(S, "click", e.onSettingClick, !0), _(N, () => i("setting", e.locale)), g1(P, "click", e.onScreenshotClick, !0), _(w, () => i("screenshot", e.locale)), D.$$click = () => {
      if (n())
...
const a1 = (e) => ru[e.name](e.class), uu = /* @__PURE__ */ m('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), du = /* @__PURE__ */ m('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), F0 = /* @__PURE__ */ m('<li><span style="padding-left:8px"></span></li>'), j0 = "drawing_tools", Cu = (e) => {
  const [t, n] = M("horizontalStraightLine"), [r, a] = M("priceChannelLine"), [s, c] = M("circle"), [o, C] = M("fibonacciLine"), [y, u] = M("xabcd"), [h, p] = M("weak_magnet"), [b, S] = M("normal"), [I, N] = M(!1), [P, E] = M(!0), [w, D] = M(""), A = Y(() => [{
    key: "singleLine",
    icon: t(),
    list: au(e.locale),
    setter: n
  ...
  return (() => {
    const W = uu.cloneNode(!0), l1 = W.firstChild, O = l1.nextSibling, z = O.firstChild, H = z.nextSibling, u1 = H.firstChild, K1 = O.nextSibling, F1 = K1.firstChild, p1 = K1.nextSibling, H1 = p1.firstChild, V1 = p1.nextSibling, G1 = V1.nextSibling, X1 = G1.firstChild;
    return _(W, () => A().map((B) => (() => {
      ...
      return J.addEventListener("blur", () => {
        ...
        return () => x1() && v(fe, {
          class: "list",
          get children() {
            return B.list.map((s1) => (() => {
              const k1 = F0.cloneNode(!0), v1 = k1.firstChild;
              return k1.$$click = () => {
                B.setter(s1.key), e.onDrawingItemClick({
                  name: s1.key,
                  lock: I(),
                  mode: b()
                }), D("");
      ...
      })(), null), Q(() => r1(n1, "class", B.key === w() ? "rotate" : "")), J;
    })()), l1), O.addEventListener("blur", () => {
      D("");
    }), z.$$click = () => {
      let B = h();
      b() !== "normal" && (B = "normal"), S(B), e.onModeChange(B);
    }, _(z, (() => {
      const B = Y(() => h() === "weak_magnet");
      return () => B() ? (() => {
...
const Iu = (e) => {
  let t, n = null, r, a = !1;
  const [s, c] = M(e.theme), [o, C] = M(e.styles), [y, u] = M(e.locale), [h, p] = M(e.symbol), [b, S] = M(e.period), [I, N] = M(!1), [P, E] = M([...e.mainIndicators]), [w, D] = M({}), [A, F] = M(!1), [W, l1] = M({
    key: e.timezone,
    text: z0(e.timezone, e.locale)
  }), [O, z] = M(!1), [H, u1] = M(), [K1, F1] = M(""), [p1, H1] = M(e.drawingBarVisible), [V1, G1] = M(!1), [X1, B] = M(!1), [J, i1] = M({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const x1 = (l) => ({
    ...
    var d, g, $;
    try {
      const x = (d = n == null ? void 0 : n.getOverlayById) == null ? void 0 : d.call(n, l);
      if (!x)
        return;
      const T = k1(x);
      if (T) {
    ...
    document.addEventListener("mouseup", $), document.addEventListener("touchend", $), setTimeout(() => {
      ...
      if (x && !x.complete) {
        ...
        const f = G.get(l);
        if (f) {
          const L = x1(f.type), k = ((T = f.points) == null ? void 0 : T.length) || 0;
      ...
      try {
        const g = `kline_drawings_${l}`, x = {
          drawings: d.map((T) => {
            ...
            const L = x1(T.type), k = ((U = T.points) == null ? void 0 : U.length) || 0;
  ...
  const Je = () => {
    const l = h();
    if (l != null && l.ticker) {
      const d = Array.from(G.values());
      A1.saveDrawings(l.ticker, d);
    }
  };
  e.ref({
    setTheme: c,
    ...
    setSettings: (l) => {
      ...
      if (l.candleType !== void 0 && (d.candle = {
        ...
        const J1 = ((g = d.candle) == null ? void 0 : g.bar) || {};
        d.candle = {
          ...d.candle,
          bar: {
            ...J1,
      ...
      l.showLastPrice !== void 0 && (d.candle = {
        ...d.candle,
        priceMark: {
          ...($ = d.candle) == null ? void 0 : $.priceMark,
          last: {
            ...(T = (x = d.candle) == null ? void 0 : x.priceMark) == null ? void 0 : T.last,
        ...
        priceMark: {
          ...
          high: {
            ...(k = (L = d.candle) == null ? void 0 : L.priceMark) == null ? void 0 : k.high,
        ...
        priceMark: {
          ...
          low: {
            ...(h1 = (V = d.candle) == null ? void 0 : V.priceMark) == null ? void 0 : h1.low,
        ...
        ...d.indicator,
        lastValueMark: {
          ...(j1 = d.indicator) == null ? void 0 : j1.lastValueMark,
    ...
    resetSettings: () => {
      ...
      if (d) {
        const U = {
          ...
          grid: {
            show: (k = d.grid) == null ? void 0 : k.show
          }
        };
        n.setStyles(U);
      } else
    ...
    saveDrawings: (l) => {
      ...
      d.forEach((g, $) => {
        var f;
        const x = x1(g.type), T = ((f = g.points) == null ? void 0 : f.length) || 0;
        T < x && console.warn(`⚠️ ${g.type} ${g.id} has only ${T} point(s), should have ${x}`);
      }), A1.saveDrawings(l, d);
    },
    loadDrawings: (l) => {
      A1.loadDrawings(l).forEach((g, $) => {
        var x;
        try {
          const T = {
            name: g.type,
    ...
    getDrawings: (l) => A1.loadDrawings(l),
    clearDrawings: (l) => {
      A1.clearDrawings(l);
    },
  ...
  return Ue(() => {
    ...
    if (!a) {
      ...
      return a = !0, B(!0), (async () => {
        const [x, T] = be(g, (/* @__PURE__ */ new Date()).getTime(), 500), f = await e.datafeed.getHistoryKLineData(d, g, x, T);
        n == null || n.applyNewData(f, f.length > 0), e.datafeed.subscribe(d, g, (L) => {
      ...
      return v(fu, {
        ...
        onMainIndicatorChange: (l) => {
          ...
          l.added ? (ne(n, l.name, !0, {
            id: "candle_pane"
          }), d.push(l.name)) : (n == null || n.removeIndicator("candle_pane", l.name), d.splice(d.indexOf(l.name), 1)), E(d);
        },
        onSubIndicatorChange: (l) => {
          ...
          if (l.added) {
            ...
            l.paneId && (n == null || n.removeIndicator(l.paneId, l.name), delete d[l.name]);
          D(d);
        }
      });
    }
    ...
    const l = Tu.cloneNode(!0), d = l.firstChild;
    return _(l, v(q, {
      get when() {
        return X1();
      },
    ...
    }), d), R1((g) => t = g, d), Q(() => r1(d, "data-drawing-bar-visible", p1())), l;
  })()];

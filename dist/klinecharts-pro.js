  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      ...
      for (let p = 2; p < 9; p++) {
        ...
        const A = x + Math.PI / 2, N = V1({ x: h, y: u }, e[0], s);
        y.push({
          ...N,
          r: v,
          startAngle: x,
...
function l5(e, t, n) {
  ...
  const v = /* @__PURE__ */ new Set(), [x, A] = (s.storage || w)(s.initialValue), [N, B] = w(void 0), [M, P] = w(void 0, {
    equals: !1
  ...
  function t1() {
    ...
    return R && !R.user && O && o0(() => {
      M(), l && (O.resolved || v.has(O) || (O.increment(), v.add(O)));
    }), F;
  }
  function W(O = !0) {
    if (O !== !1 && h)
...
function g5(e, t, n = {}) {
  ...
  return G1(() => c0(s)), () => {
    let y = e() || [], h, u;
    return y[c5], m1(() => {
      let v = y.length, x, A, N, B, M, P, S, I, E;
      if (v === 0)
        ...
        for (N = new Array(v), B = new Array(v), o && (M = new Array(v)), P = 0, S = Math.min(l, v); P < S && r[P] === y[P]; P++)
          ;
        ...
        for (u = P; u < v; u++)
          u in N ? (a[u] = N[u], s[u] = B[u], o && (o[u] = M[u], o[u](u))) : a[u] = se(p);
...
const la = /* @__PURE__ */ m('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ua = /* @__PURE__ */ m('<div class="drop-down-container"><ul></ul></div>'), da = /* @__PURE__ */ m('<div><input type="text"></div>'), ya = /* @__PURE__ */ m("<li></li>"), T9 = (e) => {
  ...
  const o = j(() => {
    ...
    return u ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((v) => v.toLowerCase().includes(u)) : e.dataSource.filter((v) => {
      var N, B;
      const x = ((N = v.text) == null ? void 0 : N.toString().toLowerCase()) || "", A = ((B = v.key) == null ? void 0 : B.toLowerCase()) || "";
...
const i = (e, t) => {
  ...
  const [n, r] = w(window.innerWidth < 768), [a, s] = w(localStorage.getItem("klinechart_secondary_period") || ""), l = () => {
    ...
    if (t && n()) {
      const M = t;
      p(M.scrollLeft > 10), x(M.scrollLeft + M.clientWidth < M.scrollWidth - 10);
    } else
      p(!1), x(!1);
  };
  Ke(() => {
  ...
  return f1(() => {
    ...
    const M = Uc.cloneNode(!0), P = M.firstChild, S = P.firstChild, I = S.firstChild, E = S.nextSibling, s1 = E.firstChild, t1 = s1.nextSibling, W = E.nextSibling, O = W.firstChild, F = O.nextSibling, Z = F.nextSibling, o1 = Z.nextSibling;
...
const d1 = (e) => lu[e.name](e.class), gu = /* @__PURE__ */ m('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), mu = /* @__PURE__ */ m('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), F0 = /* @__PURE__ */ m('<li><span style="padding-left:8px"></span></li>'), z0 = "drawing_tools", pu = (e) => {
  const [t, n] = w("horizontalStraightLine"), [r, a] = w("priceChannelLine"), [s, l] = w("circle"), [o, y] = w("fibonacciLine"), [h, u] = w("xabcd"), [p, v] = w("weak_magnet"), [x, A] = w("normal"), [N, B] = w(!1), [M, P] = w(!0), [S, I] = w(""), E = j(() => [{
    key: "singleLine",
    icon: t(),
    list: uu(e.locale),
    setter: n
      ...
      return () => K() && $(ge, {
        ...
        get children() {
          return s1().map((J) => (() => {
            ...
            return u1.$$click = () => {
              v(J.key), A(J.key), e.onModeChange(J.key), I("");
            }, L(u1, $(d1, {
              get name() {
                return J.key;
              }
...
const $u = (e) => {
  const [t, n] = w(e.timezone), r = j(() => _u(e.locale));
  return $(z1, {
    get title() {
...
const bu = /* @__PURE__ */ m('<div class="klinecharts-pro-setting-modal-content"></div>'), Lu = /* @__PURE__ */ m('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), xu = (e) => {
    ...
    get children() {
      ...
      return L(h, $(p5, {
        ...
        children: (u) => {
          ...
          return (() => {
            const x = Lu.cloneNode(!0), A = x.firstChild, N = A.nextSibling;
            return L(A, () => u.text), L(N, p), H(() => x.classList.toggle("mobile-item", !!s())), x;
          })();
        }
  ...
  const [t, n] = w(Y.clone(e.params.calcParams)), r = (a) => wu[a];
  return $(z1, {
    get title() {
...
const Ou = (e) => {
  let t, n = null, r;
  const [a, s] = w(!1), [l, o] = w(e.theme), [y, h] = w(e.styles), [u, p] = w(e.locale), [v, x] = w(e.symbol), [A, N] = w(e.period), [B, M] = w(!1), [P, S] = w([...e.mainIndicators]), [I, E] = w({}), [s1, t1] = w(!1), [W, O] = w({
    key: e.timezone,
    text: R0(e.timezone, e.locale)
  }), [F, Z] = w(!1), [o1, _] = w(), [c1, y1] = w(""), [l1, Z1] = w(e.drawingBarVisible), [W1, Q1] = w(!1), [K, J] = w(!1), [u1, v1] = w({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  return Ke(() => {
    ...
    e.subIndicators.forEach((f) => {
      ...
      s(!0), (async () => {
        try {
          const T = A(), [U] = ke(T, f, 1), [V] = ke(T, U, 500), _1 = await e.datafeed.getHistoryKLineData(v(), T, V, U);

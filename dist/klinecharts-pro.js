...
const j9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    const r = [], a = [];
    if (e.length > 1) {
      const i = e[1].x > e[0].x ? e[0].x : e[1].x, c = [1, 0.786, 0.618, 0.5, 0.382, 0.236, 0], s = e[0].y - e[1].y, f = t.points, g = f[0].value - f[1].value;
      c.forEach((C) => {
        const m = e[1].y + s * C, b = (f[1].value + g * C).toFixed(n.price);
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      ...
      for (let m = 2; m < 9; m++) {
        ...
        const N = k + Math.PI / 2, j = R1({ x: g, y: C }, e[0], i);
        f.push({
          ...j,
          r: b,
          startAngle: k,
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    const r = [], a = [];
    if (e.length > 2) {
      const i = t.points, c = i[1].value - i[0].value, s = e[1].y - e[0].y, f = [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1], g = e[2].x > e[1].x ? e[1].x : e[2].x;
      f.forEach((C) => {
...
var G = null;
let $1 = null, E = null, W = null, d1 = null, O0 = 0;
function n0(e, t) {
  const n = E, r = G, a = e.length === 0, i = a ? He : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function o5(e, t, n) {
  ...
  let c = null, s = $0, f = null, g = !1, C = "initialValue" in i, m = typeof r == "function" && R(r);
  ...
  function l1(I = !0) {
    ...
    return typeof z != "object" || !(z && "then" in z) ? (M(c, z, void 0, F), z) : (c = z, g = !0, queueMicrotask(() => g = !1), y1(() => {
      S(C ? "refreshing" : "pending"), Y();
    }, !1), z.then((u1) => M(z, u1, void 0, F), (u1) => M(z, void 0, qe(u1), F)));
  }
...
function c5(e) {
  ...
  return Promise.resolve().then(() => {
    E = t, G = n;
    let r;
    return y1(e, !1), E = G = null, r ? r.done : void 0;
  });
}
let l5;
function Ge() {
...
function Xe(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && y1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      const i = e.observers[a], c = $1 && $1.running;
      c && $1.disposed.has(i), (c && !i.tState || !c && !i.state) && (i.pure ? W.push(i) : d1.push(i), i.observers && We(i)), c || (i.state = g1);
    }
    if (W.length > 1e6)
      throw W = [], new Error();
  }, !1)), t;
...
function C0(e, t, n, r = g1, a) {
  ...
  return G === null || G !== He && (G.owned ? G.owned.push(i) : G.owned = [i]), i;
}
function s0(e) {
  const t = $1;
  if (e.state === 0 || t)
...
function o0(e, t) {
  ...
  for (let r = 0; r < e.sources.length; r += 1) {
    const a = e.sources[r];
    a.sources && (a.state === g1 || n ? a !== t && s0(a) : (a.state === i0 || n) && o0(a, t));
  }
}
function We(e) {
  const t = $1;
  for (let n = 0; n < e.observers.length; n += 1) {
    ...
    (!r.state || t) && (r.state = i0, r.pure ? W.push(r) : d1.push(r), r.observers && We(r));
  }
}
function g0(e) {
  let t;
...
function g5(e, t, n = {}) {
  ...
  return B0(() => se(i)), () => {
    let f = e() || [], g, C;
    return f[s5], C1(() => {
      let b = f.length, k, N, j, Q, D, Y, P, S, M;
      if (b === 0)
        ...
        for (k = /* @__PURE__ */ new Map(), N = new Array(S + 1), C = S; C >= Y; C--)
          M = f[C], g = k.get(M), N[C] = g === void 0 ? -1 : g, k.set(M, C);
        for (g = Y; g <= P; g++)
          M = r[g], C = k.get(M), C !== void 0 && C !== -1 ? (j[C] = a[g], Q[C] = i[g], s && (D[C] = s[g]), C = N[C], k.set(M, C)) : i[g]();
        for (C = Y; C < b; C++)
...
function t9(...e) {
  ...
  for (let r = 0; r < e.length; r++) {
    const a = e[r];
    t = t || !!a && w0 in a, e[r] = typeof a == "function" ? (t = !0, R(a)) : a;
  }
  if (t)
    return new Proxy({
      get(r) {
...
function p5(e, t, n) {
  let r = n.length, a = t.length, i = r, c = 0, s = 0, f = t[a - 1].nextSibling, g = null;
  for (; c < a || s < i; ) {
    if (t[c] === n[s]) {
      c++, s++;
      continue;
    ...
    if (a === c) {
      ...
      if (C != null)
        if (s < C && C < i) {
          let m = c, b = 1, k;
          for (; ++m < a && m < i && !((k = g.get(t[m])) == null || k !== C + b); )
            b++;
          if (b > C - s) {
            const N = t[c];
            for (; s < C; )
  ...
  for (let i = 0, c = t.length; i < c; i++) {
    ...
    if (s instanceof Node)
      ...
      if (Array.isArray(s))
        ...
        const g = String(s);
        f && f.nodeType === 3 && f.data === g ? e.push(f) : e.push(document.createTextNode(g));
      }
  }
  return a;
}
...
var _5 = typeof e0 == "object" && e0 && e0.Object === Object && e0, r9 = _5, L5 = r9, $5 = typeof self == "object" && self && self.Object === Object && self, b5 = L5 || $5 || Function("return this")(), c1 = b5, x5 = c1, k5 = x5.Symbol, h0 = k5, le = h0, a9 = Object.prototype, A5 = a9.hasOwnProperty, w5 = a9.toString, z1 = le ? le.toStringTag : void 0;
function M5(e) {
...
var N5 = D5, ue = h0, P5 = S5, O5 = N5, B5 = "[object Null]", E5 = "[object Undefined]", fe = ue ? ue.toStringTag : void 0;
function F5(e) {
...
var S1 = K5, j5 = U1, Z5 = S1, Q5 = "[object AsyncFunction]", z5 = "[object Function]", R5 = "[object GeneratorFunction]", U5 = "[object Proxy]";
function Y5(e) {
  if (!Z5(e))
    return !1;
  var t = j5(e);
...
var h6 = g6, y6 = C6, p6 = h6;
function m6(e, t) {
  var n = p6(e, t);
  return y6(n) ? n : void 0;
}
var x1 = m6, v6 = x1, _6 = function() {
  try {
...
var T1 = I6, T6 = U1, D6 = T1, N6 = "[object Symbol]";
function P6(e) {
...
var j6 = K6, Z6 = x1, Q6 = Z6(Object, "create"), y0 = Q6, ge = y0;
function z6() {
...
var T2 = I2, D2 = h2, N2 = $2, P2 = k2, O2 = M2, B2 = T2;
function N1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
N1.prototype.has = O2;
N1.prototype.set = B2;
var m0 = N1, E2 = x1, F2 = c1, K2 = E2(F2, "Map"), j0 = K2, he = C2, j2 = m0, Z2 = j0;
function Q2() {
...
var b3 = $3, ye = h0, x3 = b3, k3 = I1, A3 = K0, w3 = 1 / 0, pe = ye ? ye.prototype : void 0, me = pe ? pe.toString : void 0;
function f9(e) {
  if (typeof e == "string")
    return e;
  if (k3(e))
...
var R3 = z3, U3 = F0, Y3 = E3, H3 = d9, ve = S1, V3 = R3;
function G3(e, t, n, r) {
  if (!ve(e))
    return e;
  t = Y3(t, e);
  for (var a = -1, i = t.length, c = i - 1, s = e; s != null && ++a < i; ) {
    ...
    if (a != c) {
      var C = s[f];
      g = r ? r(C, f, s) : void 0, g === void 0 && (g = ve(C) ? C : H3(t[a + 1]) ? [] : {});
    }
    U3(s, f, g), s = s[f];
  }
  return e;
...
var g8 = C8, h8 = m0, y8 = n8, p8 = a8, m8 = s8, v8 = c8, _8 = g8;
function O1(e) {
...
var M8 = w8, S8 = U1, I8 = T1, T8 = "[object Arguments]";
function D8(e) {
  return I8(e) && S8(e) == T8;
}
...
l0.exports;
(function(e, t) {
  var n = c1, r = j8, a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, c = i && i.exports === a, s = c ? n.Buffer : void 0, f = s ? s.isBuffer : void 0, g = f || r;
  e.exports = g;
})(l0, l0.exports);
var g9 = l0.exports, Z8 = 9007199254740991;
function Q8(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= Z8;
}
var h9 = Q8, z8 = U1, R8 = h9, U8 = T1, Y8 = "[object Arguments]", H8 = "[object Array]", V8 = "[object Boolean]", G8 = "[object Date]", X8 = "[object Error]", J8 = "[object Function]", W8 = "[object Map]", q8 = "[object Number]", et = "[object Object]", tt = "[object RegExp]", nt = "[object Set]", rt = "[object String]", at = "[object WeakMap]", it = "[object ArrayBuffer]", st = "[object DataView]", ot = "[object Float32Array]", ct = "[object Float64Array]", lt = "[object Int8Array]", ut = "[object Int16Array]", ft = "[object Int32Array]", dt = "[object Uint8Array]", Ct = "[object Uint8ClampedArray]", gt = "[object Uint16Array]", ht = "[object Uint32Array]", B = {};
B[ot] = B[ct] = B[lt] = B[ut] = B[ft] = B[dt] = B[Ct] = B[gt] = B[ht] = !0;
B[Y8] = B[H8] = B[it] = B[V8] = B[st] = B[G8] = B[X8] = B[J8] = B[W8] = B[q8] = B[et] = B[tt] = B[nt] = B[rt] = B[at] = !1;
function yt(e) {
  return U8(e) && R8(e.length) && !!B[z8(e)];
}
var pt = yt;
function mt(e) {
  return function(t) {
...
var z0 = u0.exports, vt = pt, _t = Q0, Le = z0, $e = Le && Le.isTypedArray, Lt = $e ? _t($e) : vt, $t = Lt, bt = M8, xt = F8, kt = I1, At = g9, wt = d9, Mt = $t, St = Object.prototype, It = St.hasOwnProperty;
function Tt(e, t) {
  var n = kt(e), r = !n && xt(e), a = !n && !r && At(e), i = !n && !r && !a && Mt(e), c = n || r || a || i, s = c ? bt(e.length, String) : [], f = s.length;
  for (var g in e)
    (t || It.call(e, g)) && !(c && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var n7 = t7, r7 = S1, a7 = R0, i7 = n7, s7 = Object.prototype, o7 = s7.hasOwnProperty;
function c7(e) {
  if (!r7(e))
    return i7(e);
  var t = a7(e), n = [];
...
var Y0 = C7, g7 = _0, h7 = Y0;
function y7(e, t) {
  return e && g7(t, h7(t), e);
}
...
(function(e, t) {
  ...
  function f(g, C) {
    if (C)
      return g.slice();
    var m = g.length, b = s ? s(m) : new g.constructor(m);
    return g.copy(b), b;
  }
  e.exports = f;
})(f0, f0.exports);
...
var an = rn, sn = x1, on = c1, cn = sn(on, "DataView"), ln = cn, un = x1, fn = c1, dn = un(fn, "Promise"), Cn = dn, gn = x1, hn = c1, yn = gn(hn, "Set"), pn = yn, mn = x1, vn = c1, _n = mn(vn, "WeakMap"), Ln = _n, I0 = ln, T0 = j0, D0 = Cn, N0 = pn, P0 = Ln, x9 = U1, B1 = s9, xe = "[object Map]", $n = "[object Object]", ke = "[object Promise]", Ae = "[object Set]", we = "[object WeakMap]", Me = "[object DataView]", bn = B1(I0), xn = B1(T0), kn = B1(D0), An = B1(N0), wn = B1(P0), L1 = x9;
(I0 && L1(new I0(new ArrayBuffer(1))) != Me || T0 && L1(new T0()) != xe || D0 && L1(D0.resolve()) != ke || N0 && L1(new N0()) != Ae || P0 && L1(new P0()) != we) && (L1 = function(e) {
...
var V0 = L1, Mn = Object.prototype, Sn = Mn.hasOwnProperty;
function In(e) {
...
var j4 = K4, Z4 = j4, Q4 = Q0, Be = z0, Ee = Be && Be.isSet, z4 = Ee ? Q4(Ee) : Z4, R4 = z4, U4 = L8, Y4 = b8, H4 = F0, V4 = e7, G4 = p7, X4 = m7, J4 = _7, W4 = D7, q4 = U7, er = q7, tr = an, nr = V0, rr = Tn, ar = m4, ir = A4, sr = I1, or = g9, cr = O4, lr = S1, ur = R4, fr = U0, dr = Y0, Cr = 1, gr = 2, hr = 4, k9 = "[object Arguments]", yr = "[object Array]", pr = "[object Boolean]", mr = "[object Date]", vr = "[object Error]", A9 = "[object Function]", _r = "[object GeneratorFunction]", Lr = "[object Map]", $r = "[object Number]", w9 = "[object Object]", br = "[object RegExp]", xr = "[object Set]", kr = "[object String]", Ar = "[object Symbol]", wr = "[object WeakMap]", Mr = "[object ArrayBuffer]", Sr = "[object DataView]", Ir = "[object Float32Array]", Tr = "[object Float64Array]", Dr = "[object Int8Array]", Nr = "[object Int16Array]", Pr = "[object Int32Array]", Or = "[object Uint8Array]", Br = "[object Uint8ClampedArray]", Er = "[object Uint16Array]", Fr = "[object Uint32Array]", O = {};
...
function r0(e, t, n, r, a, i) {
  ...
  var N = g ? f ? tr : er : f ? dr : fr, j = C ? void 0 : N(e);
...
var Rr = zr;
const Ur = /* @__PURE__ */ n9(Rr), Yr = /* @__PURE__ */ p("<button></button>"), Hr = (e) => (() => {
  const t = Yr.cloneNode(!0);
  return h1(t, "click", e.onClick, !0), $(t, () => e.children), V((n) => {
    const r = e.style, a = `klinecharts-pro-button ${e.type ?? "confirm"} ${e.class ?? ""}`;
    return n._v$ = M1(t, r, n._v$), a !== n._v$2 && b1(t, n._v$2 = a), n;
  }, {
    _v$: void 0,
    _v$2: void 0
  }), t;
...
const Vr = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), Gr = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), Xr = /* @__PURE__ */ p("<div></div>"), Jr = /* @__PURE__ */ p('<span class="label"></span>'), Wr = () => Vr.cloneNode(!0), qr = () => Gr.cloneNode(!0), Fe = (e) => {
  ...
  return f1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a._v$ = M1(r, i, a._v$), c !== a._v$2 && b1(r, a._v$2 = c), a;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
...
const ea = /* @__PURE__ */ p('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), M9 = () => ea.cloneNode(!0), ta = /* @__PURE__ */ p('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), na = () => ta.cloneNode(!0), ra = /* @__PURE__ */ p("<ul></ul>"), aa = /* @__PURE__ */ p("<li></li>"), d0 = (e) => (() => {
  ...
  return $(r, () => e.title, a), h1(a, "click", e.onClose, !0), $(i, () => e.children), $(n, (() => {
...
const oa = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ca = /* @__PURE__ */ p('<div class="drop-down-container"><ul></ul></div>'), la = /* @__PURE__ */ p("<li></li>"), S9 = (e) => {
  ...
  return (() => {
    ...
    return r.addEventListener("blur", (c) => {
      ...
      const c = R(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => c() && (() => {
        const s = ca.cloneNode(!0), f = s.firstChild;
        return $(f, () => e.dataSource.map((g) => {
          const m = g[e.valueKey ?? "text"] ?? g;
          return (() => {
            const b = la.cloneNode(!0);
            return b.$$click = (k) => {
              var N;
              k.stopPropagation(), e.value !== m && ((N = e.onSelected) == null || N.call(e, g)), n(!1);
            }, $(b, m), b;
          })();
        })), s;
      })();
      ...
      return c._v$ = M1(r, s, c._v$), f !== c._v$2 && b1(r, c._v$2 = f), c;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
  ...
  return (() => {
    ...
    return i.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        b <= 0 ? m = new RegExp(/^[1-9]\d*$/) : m = new RegExp("^\\d+\\.?\\d{0," + b + "}$"), (f === "" || m.test(f) && +f >= t.min && +f <= t.max) && ((g = t.onChange) == null || g.call(t, f === "" ? f : +f));
      } else
      ...
      const f = t.style, g = `klinecharts-pro-input ${t.class ?? ""}`, C = r(), m = t.placeholder ?? "";
      return s._v$ = M1(i, f, s._v$), g !== s._v$2 && b1(i, s._v$2 = g), C !== s._v$3 && r1(i, "data-status", s._v$3 = C), m !== s._v$4 && r1(c, "placeholder", s._v$4 = m), s;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
o1(["click"]);
const Ca = /* @__PURE__ */ p('<div><i class="thumb"></i></div>'), ga = (e) => (() => {
...
const d = (e, t) => {
  ...
  return Ve(() => {
    ...
    const i = Dc.cloneNode(!0), c = i.firstChild, s = c.firstChild, f = c.nextSibling, g = f.firstChild, C = g.nextSibling, m = f.nextSibling, b = m.firstChild, k = b.nextSibling, N = m.nextSibling, j = N.firstChild, Q = j.nextSibling, D = N.nextSibling, Y = D.firstChild, P = Y.nextSibling, S = D.nextSibling;
    return E0((M) => {
      t = M;
    }, i), h1(s, "click", e.onMenuClick, !0), $(i, L(J, {
      get when() {
        return e.symbol;
      },
      get children() {
        const M = Tc.cloneNode(!0), Z = M.firstChild;
        return h1(M, "click", e.onSymbolClick, !0), $(M, L(J, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const n1 = Ic.cloneNode(!0);
            return V(() => r1(n1, "src", e.symbol.logo)), n1;
          }
      ...
      return Z.$$click = () => {
        e.onPeriodChange(M);
      }, $(Z, () => M.text), V(() => b1(Z, `item period ${M.text === e.period.text ? "selected" : ""}`)), Z;
    })()), f), h1(f, "click", e.onIndicatorClick, !0), $(C, () => d("indicator", e.locale)), h1(m, "click", e.onTimezoneClick, !0), $(k, () => d("timezone", e.locale)), h1(N, "click", e.onSettingClick, !0), $(Q, () => d("setting", e.locale)), h1(D, "click", e.onScreenshotClick, !0), $(P, () => d("screenshot", e.locale)), S.$$click = () => {
      if (n())
...
const a1 = (e) => nu[e.name](e.class), lu = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), uu = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Ke = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), je = "drawing_tools", fu = (e) => {
  const [t, n] = A("horizontalStraightLine"), [r, a] = A("priceChannelLine"), [i, c] = A("circle"), [s, f] = A("fibonacciLine"), [g, C] = A("xabcd"), [m, b] = A("weak_magnet"), [k, N] = A("normal"), [j, Q] = A(!1), [D, Y] = A(!0), [P, S] = A(""), M = R(() => [{
    key: "singleLine",
    icon: t(),
    list: ru(e.locale),
    setter: n
  ...
  return (() => {
    ...
    return $(n1, () => M().map((T) => (() => {
      const X = uu.cloneNode(!0), i1 = X.firstChild, U = i1.nextSibling, q = U.firstChild;
        ...
        return () => m1() && L(d0, {
          ...
          get children() {
            return T.list.map((s1) => (() => {
              const k1 = Ke.cloneNode(!0), v1 = k1.firstChild;
              return k1.$$click = () => {
      ...
      })(), null), V(() => r1(q, "class", T.key === P() ? "rotate" : "")), X;
      ...
      const T = R(() => m() === "weak_magnet");
      return () => T() ? (() => {
        const X = R(() => k() === "weak_magnet");
        return () => X() ? L(a1, {
          name: "weak_magnet",
          class: "selected"
        }) : L(a1, {
      ...
      return () => T() && L(d0, {
        ...
        get children() {
          return Z().map((X) => (() => {
            const i1 = Ke.cloneNode(!0), U = i1.firstChild;
            return i1.$$click = () => {
              b(X.key), N(X.key), e.onModeChange(X.key), S("");
            }, $(i1, L(a1, {
              get name() {
                return X.key;
              }
      ...
      name: "remove"
    })), V(() => r1(u1, "class", P() === "mode" ? "rotate" : "")), n1;
  })();
};
o1(["click"]);
...
const gu = (e) => {
  const [t, n] = A(e.timezone), r = R(() => Cu(e.locale));
  return L(E1, {
    get title() {
...
const hu = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), yu = /* @__PURE__ */ p("<span></span>"), pu = (e) => {
  const [t, n] = A(e.currentStyles), [r, a] = A(Re(e.locale));
  f1(() => {
    a(Re(e.locale));
  });
  const i = (c, s) => {
        ...
        renderItem: (a) => (() => {
          ...
          return i.$$click = () => {
            ...
            get children() {
              ...
              return V(() => r1(f, "src", a.logo)), f;
            }
          }), s), $(s, () => a.shortName ?? a.ticker, null), $(s, () => `${a.name ? `(${a.name})` : ""}`, null), $(i, () => a.exchange ?? "", null), V(() => r1(s, "title", a.name ?? "")), i;
        })()
      })];
    }
  });
...
const Iu = (e) => {
  let t, n = null, r, a = !1;
  const [i, c] = A(e.theme), [s, f] = A(e.styles), [g, C] = A(e.locale), [m, b] = A(e.symbol), [k, N] = A(e.period), [j, Q] = A(!1), [D, Y] = A([...e.mainIndicators]), [P, S] = A({}), [M, Z] = A(!1), [n1, l1] = A({
    key: e.timezone,
    text: ze(e.timezone, e.locale)
  }), [I, F] = A(!1), [z, u1] = A(), [F1, K1] = A(""), [p1, Y1] = A(e.drawingBarVisible), [H1, V1] = A(!1), [G1, T] = A(!1), [X, i1] = A({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  });
  let U = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map();
  const m1 = (o) => ({
    line: 2,
    segment: 2,
    arrow: 2,
    ...
    var l, y, u;
    try {
      const h = (l = n == null ? void 0 : n.getOverlayById) == null ? void 0 : l.call(n, o);
      if (!h)
        return;
      const _ = k1(h);
      if (_) {
        const v = U.get(o), x = ((y = v == null ? void 0 : v.points) == null ? void 0 : y.length) || 0, w = ((u = _.points) == null ? void 0 : u.length) || 0;
        U.set(o, _), w > x && console.log(`📌 ${_.type} ${o}: ${x} → ${w} points`);
        const H = m1(_.type);
        if (w >= H) {
          const e1 = q.get(o);
          e1 && !e1.complete && (e1.complete = !0, console.log(`✅ ${_.type} ${o} is complete (${w}/${H} points)!`), e1.checkInterval && (clearInterval(e1.checkInterval), e1.checkInterval = void 0));
        }
      }
    } catch (h) {
      console.error(`Error updating overlay tracking for ${o}:`, h);
    }
  }, D9 = (o, l) => {
    if (q.has(o))
      return;
    ...
    q.set(o, y), console.log(`🔍 Started monitoring ${l} ${o}`), v1(o);
    const u = () => {
      v1(o);
    };
    document.addEventListener("mouseup", u), document.addEventListener("touchend", u), setTimeout(() => {
      ...
      const h = q.get(o);
      if (h && !h.complete) {
        console.log(`⏰ Stopped monitoring ${o} after 30 seconds`), h.checkInterval && clearInterval(h.checkInterval), h.mouseUpHandler && (document.removeEventListener("mouseup", h.mouseUpHandler), document.removeEventListener("touchend", h.mouseUpHandler)), v1(o);
        const v = U.get(o);
        if (v) {
          const x = m1(v.type), w = ((_ = v.points) == null ? void 0 : _.length) || 0;
          w < x && console.warn(`⚠️ ${v.type} ${o} has only ${w} point(s), should have ${x}`);
        }
      }
    }, 3e4);
  };
    ...
    saveDrawings: (o, l) => {
      try {
        const y = `kline_drawings_${o}`, u = l.map((_) => {
          ...
          const x = m1(_.type), w = ((H = _.points) == null ? void 0 : H.length) || 0;
          return w < x && console.warn(`⚠️ Saving ${_.type} with only ${w} point(s), needs ${x}`), v;
        }), h = {
          drawings: u,
          timestamp: Date.now()
        };
        localStorage.setItem(y, JSON.stringify(h, null, 2)), console.log(`💾 Library: Saved ${l.length} drawings for ${o}`), u.forEach((_, v) => {
          var x;
    ...
    loadDrawings: (o) => {
      ...
      try {
        ...
        if (u) {
          ...
          console.log(`📂 Library: Loaded ${((l = h.drawings) == null ? void 0 : l.length) || 0} drawings for ${o}`);
          const _ = [];
          return h.drawings && h.drawings.forEach((v, x) => {
            var e1;
            const w = m1(v.type), H = ((e1 = v.points) == null ? void 0 : e1.length) || 0;
            H >= w ? (_.push(v), console.log(`📥 Valid drawing ${x + 1}:`, {
              type: v.type,
              points: H
            })) : console.warn(`📥 Skipping ${v.type}: Only ${H} point(s), need ${w}`);
          }), _;
        }
      } catch (y) {
  ...
  e.ref({
    ...
    removeOverlay: (o) => {
      ...
      if ((l = n == null ? void 0 : n.removeOverlay) == null || l.call(n, o), o.id) {
        U.delete(o.id);
        const y = q.get(o.id);
        y && (y.checkInterval && clearInterval(y.checkInterval), y.mouseUpHandler && (document.removeEventListener("mouseup", y.mouseUpHandler), document.removeEventListener("touchend", y.mouseUpHandler)), q.delete(o.id)), X0();
      }
    },
    removeAllOverlay: () => {
      U.forEach((o, l) => {
    ...
    getAllOverlay: () => Array.from(U.values()),
    getOverlay: (o) => U.get(o) || null,
    overrideOverlay: (o) => {
    ...
    getSettings: () => {
      var y, u, h, _, v, x, w, H, e1, j1, Z1, X1, W0, q0, ee, te;
      if (!n)
        return {};
      ...
      return {
        ...
        showLastPrice: (v = (_ = (h = o.candle) == null ? void 0 : h.priceMark) == null ? void 0 : _.last) == null ? void 0 : v.show,
        showHighestPrice: (H = (w = (x = o.candle) == null ? void 0 : x.priceMark) == null ? void 0 : w.high) == null ? void 0 : H.show,
    ...
    setSettings: (o) => {
      ...
      o.showLastPrice !== void 0 && (l.candle = {
        ...
        priceMark: {
          ...
          last: {
            ...(_ = (h = l.candle) == null ? void 0 : h.priceMark) == null ? void 0 : _.last,
        ...
        priceMark: {
          ...
          high: {
            ...(w = (x = l.candle) == null ? void 0 : x.priceMark) == null ? void 0 : w.high,
      ...
      if (l) {
        const H = {
          candle: {
            ...
            priceMark: (h = l.candle) == null ? void 0 : h.priceMark
          },
          indicator: {
          ...
          grid: {
            show: (w = l.grid) == null ? void 0 : w.show
          }
        };
        n.setStyles(H);
      } else
    ...
    saveDrawings: (o) => {
      ...
      l.forEach((y, u) => {
        var v;
        const h = m1(y.type), _ = ((v = y.points) == null ? void 0 : v.length) || 0;
        _ < h && console.warn(`⚠️ ${y.type} ${y.id} has only ${_} point(s), should have ${h}`);
      }), _1.saveDrawings(o, l);
    },
    loadDrawings: (o) => {
      const l = _1.loadDrawings(o);
      console.log(`🔄 Restoring ${l.length} drawings...`), l.forEach((y, u) => {
        var h, _;
        try {
          console.log(`   ${u + 1}/${l.length}: ${y.type} with ${((h = y.points) == null ? void 0 : h.length) || 0} points`);
          const v = {
            name: y.type,
            points: y.points || [],
          ...
          x && (console.log(`   ✅ Created ${x}`), U.set(x, {
            ...y,
            id: x
          }), q.set(x, {
            monitoring: !1,
    ...
    getDrawings: (o) => _1.loadDrawings(o),
    clearDrawings: (o) => {
      _1.clearDrawings(o);
    },
    ...
    enableAutoSave: (o, l = !0) => {
      if (l) {
        ...
        const y = setInterval(() => {
          const u = Array.from(U.values());
          u.length > 0 && (console.log(`⏰ Auto-saving ${u.length} drawings...`), _1.saveDrawings(o, u));
        }, 3e4);
        return () => {
  ...
  const J0 = () => {
    ...
    switch (o.timespan) {
      case "minute": {
        u = u - u % (60 * 1e3), h = u - y * o.multiplier * 60 * 1e3;
        break;
      }
      case "hour": {
        u = u - u % (60 * 60 * 1e3), h = u - y * o.multiplier * 60 * 60 * 1e3;
        break;
      }
      case "day": {
        u = u - u % (60 * 60 * 1e3), h = u - y * o.multiplier * 24 * 60 * 60 * 1e3;
        break;
      }
      case "week": {
        ...
        u = u - x * 60 * 60 * 24;
        const w = new Date(u);
        u = (/* @__PURE__ */ new Date(`${w.getFullYear()}-${w.getMonth() + 1}-${w.getDate()}`)).getTime(), h = y * o.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const _ = new Date(u), v = _.getFullYear(), x = _.getMonth() + 1;
        u = (/* @__PURE__ */ new Date(`${v}-${x}-01`)).getTime(), h = y * o.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const w = new Date(h);
        h = (/* @__PURE__ */ new Date(`${w.getFullYear()}-${w.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const v = new Date(u).getFullYear();
        u = (/* @__PURE__ */ new Date(`${v}-01-01`)).getTime(), h = y * o.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const x = new Date(h);
        h = (/* @__PURE__ */ new Date(`${x.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [h, u];
  ...
  return Ve(() => {
    if (window.addEventListener("resize", J0), n = O9(t, {
      customApi: {
        formatDate: (u, h, _, v) => {
          switch (k().timespan) {
            case "minute":
              return v === J1.XAxis ? K.formatDate(u, h, "HH:mm") : K.formatDate(u, h, "YYYY-MM-DD HH:mm");
            case "hour":
              return v === J1.XAxis ? K.formatDate(u, h, "MM-DD HH:mm") : K.formatDate(u, h, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return K.formatDate(u, h, "YYYY-MM-DD");
            case "month":
              return v === J1.XAxis ? K.formatDate(u, h, "YYYY-MM") : K.formatDate(u, h, "YYYY-MM-DD");
            case "year":
              return v === J1.XAxis ? K.formatDate(u, h, "YYYY") : K.formatDate(u, h, "YYYY-MM-DD");
          }
          return K.formatDate(u, h, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      ...
      const h = n.getDom("candle_pane", ae.YAxis);
    ...
    e.subIndicators.forEach((u) => {
      ...
      a = !0, (async () => {
        const _ = k(), [v] = L0(_, u, 1), [x] = L0(_, v, 500), w = await e.datafeed.getHistoryKLineData(m(), _, x, v);
      ...
      if (u.indicatorName)
        switch (u.iconId) {
          ...
          case "setting": {
            const h = n == null ? void 0 : n.getIndicatorByPaneId(u.paneId, u.indicatorName);
            i1({
              visible: !0,
          ...
          case "close":
            if (u.paneId === "candle_pane") {
              const h = [...D()];
              n == null || n.removeIndicator("candle_pane", u.indicatorName), h.splice(h.indexOf(u.indicatorName), 1), Y(h);
            } else {
              const h = {
                ...P()
              };
              n == null || n.removeIndicator(u.paneId, u.indicatorName), delete h[u.indicatorName], S(h);
            }
        }
    });
    const l = n == null ? void 0 : n.createOverlay;
    n && l && (n.createOverlay = function(...u) {
      const h = u[0], _ = l.apply(this, u);
      return _ && (console.log(`🆕 ${h.name} created with ID: ${_}`), D9(_, h.name || "unknown"), v1(_), X0()), _;
    });
    const y = n == null ? void 0 : n.removeOverlay;
    n && y && (n.removeOverlay = function(...u) {
      const h = y.apply(this, u), _ = u[0];
      let v;
      if (typeof _ == "string" ? v = _ : _ && typeof _ == "object" && _.id && (v = _.id), v) {
        U.delete(v);
        const x = q.get(v);
        x && (x.checkInterval && clearInterval(x.checkInterval), x.mouseUpHandler && (document.removeEventListener("mouseup", x.mouseUpHandler), document.removeEventListener("touchend", x.mouseUpHandler)), q.delete(v)), console.log(`🗑️ Removed overlay ${v}`);
        const w = m();
        if (w != null && w.ticker) {
          const H = Array.from(U.values());
          _1.saveDrawings(w.ticker, H), console.log(`💾 Synced ${H.length} drawings to storage`);
        }
      }
      return h;
    });
  }), B0(() => {
    window.removeEventListener("resize", J0), q.forEach((o, l) => {
    ...
    if (!a) {
      ...
      return a = !0, T(!0), (async () => {
        const [h, _] = L0(y, (/* @__PURE__ */ new Date()).getTime(), 500), v = await e.datafeed.getHistoryKLineData(l, y, h, _);
    ...
    const y = t;
    return typeof y == "function" ? E0(y, l) : t = l, V(() => r1(l, "data-drawing-bar-visible", p1())), o;
  })()];

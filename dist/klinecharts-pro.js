...
const u5 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    ...
    if (e.length > 1) {
      ...
      u.forEach((f) => {
        const x = e[1].y + c * f, k = (g[1].value + $ * f).toFixed(r.price);
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((f) => {
        const x = e[1].x - c * f, k = e[1].y - g * f;
        r.push({ coordinates: [{ x, y: e[0].y }, { x, y: e[1].y }] }), r.push({ coordinates: [{ x: e[0].x, y: k }, { x: e[1].x, y: k }] }), n = n.concat(kt([e[0], { x, y: e[1].y }], t)), n = n.concat(kt([e[0], { x: e[1].x, y: k }], t)), a.unshift({
          x: e[0].x + l,
          y: k + 10,
          text: `${f.toFixed(3)}`
        }), a.unshift({
...
function P5(e, t, r) {
  ...
  let u = null, c = $t, g = null, $ = !1, f = "initialValue" in l, x = typeof n == "function" && Y(n);
  const k = /* @__PURE__ */ new Set(), [S, P] = (l.storage || w)(l.initialValue), [O, H] = w(void 0), [Q, E] = w(void 0, {
    equals: !1
  ...
  function c1() {
    ...
    return n1 && !n1.user && j && m0(() => {
      Q(), u && (j.resolved || k.has(j) || (j.increment(), k.add(j)));
    }), X;
  }
  function T1(j = !0) {
    if (j !== !1 && $)
...
function U5(e, t, r = {}) {
  ...
  return re(() => p0(l)), () => {
    let g = e() || [], $, f;
    return g[T5], V1(() => {
      let k = g.length, S, P, O, H, Q, E, N, K, G;
      if (k === 0)
        u !== 0 && (p0(l), l = [], n = [], a = [], u = 0, c && (c = [])), r.fallback && (n = [B5], a[0] = Ne((S1) => (l[0] = S1, r.fallback())), u = 1);
      else if (u === 0) {
        for (a = new Array(k), f = 0; f < k; f++)
          n[f] = g[f], a[f] = Ne(x);
        u = k;
      } else {
        for (O = new Array(k), H = new Array(k), c && (Q = new Array(k)), E = 0, N = Math.min(u, k); E < N && n[E] === g[E]; E++)
          ;
        for (N = u - 1, K = k - 1; N >= E && K >= E && n[N] === g[K]; N--, K--)
        ...
        for (f = E; f < k; f++)
          f in O ? (a[f] = O[f], l[f] = H[f], c && (c[f] = Q[f], c[f](f))) : a[f] = Ne(x);
        a = a.slice(0, u = k), n = g.slice(0);
      }
      return a;
    });
    function x(k) {
  ...
  for (; u < a || c < l; ) {
    ...
    if (a === u) {
      ...
      if (f != null)
        if (c < f && f < l) {
          let x = u, k = 1, S;
          for (; ++x < a && x < l && !((S = $.get(t[x])) == null || S !== f + k); )
            k++;
          if (k > f - c) {
            const P = t[u];
            for (; c < f; )
...
(function(e, t) {
  ...
  function g($, f) {
    if (f)
      return $.slice();
    var x = $.length, k = c ? c(x) : new $.constructor(x);
    return $.copy(k), k;
  }
  e.exports = g;
})(tt, tt.exports);
...
const A4 = /* @__PURE__ */ b('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), F9 = () => A4.cloneNode(!0), w4 = /* @__PURE__ */ b('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), M4 = () => w4.cloneNode(!0), S4 = /* @__PURE__ */ b("<ul></ul>"), T4 = /* @__PURE__ */ b("<li></li>"), rt = (e) => (() => {
  ...
  return t.$$click = (u) => {
    ...
    return () => u() && (() => {
      ...
      return _(c, () => e.buttons.map((g) => L(v4, h9(g, {
        get style() {
          return {
            ...e.minButtonWidth ? {
    ...
    const c = !!e.isMobile, g = e.isMobile ? "100%" : `${e.width ?? 400}px`, $ = (e.isMobile, "auto"), f = e.isMobile ? "60vh" : "90vh", x = !!e.isMobile, k = !!e.isMobile, S = !!e.isMobile;
    return c !== u._v$ && t.classList.toggle("mobile-modal", u._v$ = c), g !== u._v$2 && r.style.setProperty("width", u._v$2 = g), $ !== u._v$3 && r.style.setProperty("height", u._v$3 = $), f !== u._v$4 && r.style.setProperty("max-height", u._v$4 = f), x !== u._v$5 && r.classList.toggle("mobile-inner", u._v$5 = x), k !== u._v$6 && n.classList.toggle("mobile-title", u._v$6 = k), S !== u._v$7 && l.classList.toggle("mobile-content", u._v$7 = S), u;
  }, {
    _v$: void 0,
    _v$2: void 0,
    _v$3: void 0,
...
const I4 = /* @__PURE__ */ b('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), D4 = /* @__PURE__ */ b('<div class="drop-down-container"><ul></ul></div>'), N4 = /* @__PURE__ */ b('<div><input type="text"></div>'), E4 = /* @__PURE__ */ b("<li></li>"), K9 = (e) => {
  ...
  const c = Y(() => {
    ...
    return f ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((k) => k.toLowerCase().includes(f)) : e.dataSource.filter((k) => {
      var O, H;
      const S = ((O = k.text) == null ? void 0 : O.toString().toLowerCase()) || "", P = ((H = k.key) == null ? void 0 : H.toLowerCase()) || "";
  ...
  return (() => {
    ...
    const S = u;
    return typeof S == "function" ? te(S, f) : u = f, _(k, () => e.value), _(f, (() => {
        ...
        return O.$$mousedown = (Q) => Q.preventDefault(), _(O, (() => {
          ...
          return (Q = c()) == null ? void 0 : Q.map((E) => {
            ...
            return (() => {
              ...
              return G.$$click = (S1) => {
                var c1;
                S1.stopPropagation(), e.value !== K && ((c1 = e.onSelected) == null || c1.call(e, E)), r(!1), a("");
              }, _(G, K), G;
            })();
          });
        }), O;
  ...
  return (() => {
    ...
    return l.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        k <= 0 ? x = new RegExp(/^[1-9]\d*$/) : x = new RegExp("^\\d+\\.?\\d{0," + k + "}$"), (g === "" || x.test(g) && +g >= t.min && +g <= t.max) && (($ = t.onChange) == null || $.call(t, g === "" ? g : +g));
      } else
      ...
      return c._v$ = ne(l, g, c._v$), $ !== c._v$2 && h1(l, c._v$2 = $), f !== c._v$3 && v1(l, "data-status", c._v$3 = f), x !== c._v$4 && v1(u, "placeholder", c._v$4 = x), c;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
const o = (e, t) => {
  ...
  let t, r, n;
  const [a, l] = w(window.innerWidth < 768), [u, c] = w(localStorage.getItem("klinechart_secondary_period") || ""), [g, $] = w(!1), [f, x] = w(!1), [k, S] = w({
    top: 0,
    left: 0,
    minWidth: 220
  }), P = () => {
    ...
    if (t && a()) {
      const Z = t;
      K(Z.scrollLeft > 10), S1(Z.scrollLeft + Z.clientWidth < Z.scrollWidth - 10);
    } else
      K(!1), S1(!1);
  };
  Nt(() => {
  ...
  return M1(() => {
    ...
    return Z.style.setProperty("position", "relative"), Z.style.setProperty("width", "100%"), Z.style.setProperty("display", "flex"), Z.style.setProperty("align-items", "center"), _(Z, L(z, {
      ...
      t = C;
    }, V), V.style.setProperty("width", "100%"), q1(k1, "click", e.onMenuClick, !0), _(V, L(z, {
      get when() {
        return e.symbol;
      },
      get children() {
        const C = su.cloneNode(!0), U = C.firstChild;
        return q1(C, "click", e.onSymbolClick, !0), _(C, L(z, {
          get when() {
    ...
    }), s1), s1.style.setProperty("display", "flex"), s1.style.setProperty("gap", "4px"), s1.style.setProperty("margin-left", "auto"), s1.style.setProperty("align-items", "center"), _(s1, L(z, {
      get when() {
      ...
      get children() {
        ...
        return te((W) => {
          ...
          W.stopPropagation(), T1();
        }, U.style.setProperty("gap", "6px"), u1.style.setProperty("transition", "transform 0.2s ease"), _(C, L(z, {
          get when() {
            return g();
          },
          get children() {
            return L(R5, {
              ...
              get children() {
                const W = du.cloneNode(!0), $1 = W.firstChild, P1 = $1.firstChild, F1 = P1.nextSibling, K1 = F1.firstChild, W1 = K1.firstChild, j1 = W1.firstChild, Be = K1.nextSibling, O1 = Be.firstChild, _e = O1.firstChild, Ue = $1.nextSibling, oe = Ue.firstChild, Y1 = oe.firstChild, dt = Ue.nextSibling, _1 = dt.nextSibling, A1 = _1.firstChild, I1 = A1.firstChild, D1 = _1.nextSibling, ht = D1.nextSibling, Le = ht.firstChild, se = Le.firstChild;
                return W.$$mousedown = (I) => I.stopPropagation(), te((I) => {
                  n = I;
                }, W), W.style.setProperty("position", "fixed"), W.style.setProperty("z-index", "9999"), P1.$$click = (I) => {
                  I.preventDefault(), I.stopPropagation(), x((D) => !D);
                }, j1.addEventListener("change", (I) => {
                  var D;
                  ...
                  const D = `${k().top}px`, y1 = `${k().left}px`, Fe = `${k().minWidth}px`, N1 = `klinecharts-pro-order-tools-group${f() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return D !== I._v$ && W.style.setProperty("top", I._v$ = D), y1 !== I._v$2 && W.style.setProperty("left", I._v$2 = y1), Fe !== I._v$3 && W.style.setProperty("width", I._v$3 = Fe), N1 !== I._v$4 && h1($1, I._v$4 = N1), I;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var I;
                  return I1.checked = ((I = e.orderToolsState) == null ? void 0 : I.positions) ?? !0;
                }), B(() => {
                  var I;
          ...
          const $1 = a() ? "0 8px" : "0 10px", P1 = g() ? "rotate(180deg)" : "rotate(0deg)";
          return $1 !== W._v$5 && U.style.setProperty("padding", W._v$5 = $1), P1 !== W._v$6 && u1.style.setProperty("transform", W._v$6 = P1), W;
        }, {
          _v$5: void 0,
          _v$6: void 0
        }), C;
...
const B1 = (e) => zd[e.name](e.class), qd = /* @__PURE__ */ b('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Gd = /* @__PURE__ */ b('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), W0 = /* @__PURE__ */ b('<li><span style="padding-left:8px"></span></li>'), X0 = "drawing_tools", Wd = (e) => {
  const [t, r] = w("horizontalStraightLine"), [n, a] = w("priceChannelLine"), [l, u] = w("circle"), [c, g] = w("fibonacciLine"), [$, f] = w("xabcd"), [x, k] = w("weak_magnet"), [S, P] = w("normal"), [O, H] = w(!1), [Q, E] = w(!0), [N, K] = w(""), G = Y(() => [{
    key: "singleLine",
    icon: t(),
    list: Qd(e.locale),
    setter: r
  ...
  return (() => {
    const c1 = qd.cloneNode(!0), T1 = c1.firstChild, j = T1.nextSibling, X = j.firstChild, R = X.nextSibling, L1 = R.firstChild, Q1 = j.nextSibling, Z = Q1.firstChild, V = Q1.nextSibling, g1 = V.firstChild, k1 = V.nextSibling, s1 = k1.nextSibling, x1 = s1.firstChild;
    return _(c1, () => G().map((C) => (() => {
      ...
      return U.addEventListener("blur", () => {
        ...
        return () => $1() && L(rt, {
          class: "list",
          get children() {
            return C.list.map((P1) => (() => {
              const F1 = W0.cloneNode(!0), K1 = F1.firstChild;
              return F1.$$click = () => {
                C.setter(P1.key), e.onDrawingItemClick({
                  name: P1.key,
                  lock: O(),
                  mode: S()
                }), K("");
      ...
      return () => C() && L(rt, {
        ...
        get children() {
          return S1().map((U) => (() => {
            ...
            return J.$$click = () => {
              k(U.key), P(U.key), e.onModeChange(U.key), K("");
            }, _(J, L(B1, {
              get name() {
                return U.key;
              }
...
U1(["click"]);
const J0 = /* @__PURE__ */ b('<li class="title"></li>'), e9 = /* @__PURE__ */ b('<li class="row"></li>'), Xd = (e) => L(ae, {
  get title() {
  ...
  return L(ae, {
    ...
    get children() {
      ...
      return _($, L(At, {
        ...
        children: (f) => {
          let x;
          const k = o1.formatValue(t(), f.key);
          switch (f.component) {
            case "select": {
              x = L(K9, {
                get style() {
          ...
          return (() => {
            ...
            return _(P, () => f.text), _(O, x), B(() => S.classList.toggle("mobile-item", !!l())), S;
          })();
        }
      })), B(() => $.classList.toggle("mobile-layout", !!l())), $;
    }
  });
}, ih = /* @__PURE__ */ b('<img style="width:500px;margin-top: 20px">'), ah = (e) => L(ae, {
  get title() {
...
const Ah = (e) => {
  ...
  let t, r = null, n;
  const [a, l] = w(!1), [u, c] = w(e.theme), [g, $] = w(e.styles), [f, x] = w(e.locale), [k, S] = w(e.symbol), [P, O] = w(e.period), [H, Q] = w(!1), [E, N] = w([...e.mainIndicators]), [K, G] = w({}), [S1, c1] = w(!1), [T1, j] = w({
    key: e.timezone,
    text: t9(e.timezone, e.locale)
  }), [X, R] = w(!1), [L1, Q1] = w(), [Z, V] = w(""), [g1, k1] = w(e.drawingBarVisible), [s1, x1] = w(!1), [C, U] = w(!1), [J, u1] = w(!1), W = ((i0 = e.orderTools) == null ? void 0 : i0.quickOrder) ?? !0, [$1, P1] = w({
    quickOrder: W,
  ...
  const yt = () => {
    ...
    }), D.clear(), y1.clear(), A1(null), D1(null), X1.loadDrawings(i).forEach((d) => {
      var h;
      try {
        const m = Ae({
          name: d.type,
    ...
    P1(s), (h = (d = e.orderTools) == null ? void 0 : d.onChange) == null || h.call(d, s);
  }, Ke = (i) => {
    var d;
    ...
    return (!s || ((h = _1()) == null ? void 0 : h.id) === s) && (A1(null), D1(null)), !1;
  }, Ae = (i) => {
    ...
    if (!s || !t)
      return;
    i.preventDefault(), i.stopPropagation(), D1(null);
  ...
  M1(() => {
    ...
    getSettings: () => {
      var d, h, m, p, y, v, A, M, T, q, i1, l1, f1, t1, E1, de;
      if (!r)
        return {};
  ...
  return Nt(() => {
    ...
    e.subIndicators.forEach((y) => {
      ...
      l(!0), (async () => {
        try {
          const A = P(), [M] = pt(A, y, 1), [T] = pt(A, M, 500), q = await e.datafeed.getHistoryKLineData(k(), A, T, M);
      ...
      if (y.indicatorName)
        switch (y.iconId) {
          case "visible": {
            ...
            N1(y.indicatorName, y.paneId, v, "change");
            break;
          }
          case "invisible": {
            r == null || r.overrideIndicator({
          ...
          case "close":
            if (y.paneId === "candle_pane") {
              const v = [...E()];
              r == null || r.removeIndicator("candle_pane", y.indicatorName), v.splice(v.indexOf(y.indicatorName), 1), N(v), N1(y.indicatorName, "candle_pane", "main", "remove");
            } else {
              const v = {
                ...K()
              };
              r == null || r.removeIndicator(y.paneId, y.indicatorName), delete v[y.indicatorName], G(v), N1(y.indicatorName, y.paneId, "sub", "remove");
            }
        }
    ...
    return i.addEventListener("mouseleave", () => {
    ...
    }), s), te((d) => t = d, s), _(i, L(z, {
      get when() {
        return _1();
      },
      keyed: !0,
      children: (d) => (() => {
        const h = $h.cloneNode(!0), m = h.firstChild, p = m.nextSibling, y = p.nextSibling, v = y.firstChild, A = y.nextSibling, M = A.firstChild, T = M.firstChild, q = T.nextSibling, i1 = q.firstChild, l1 = A.nextSibling, f1 = l1.firstChild, t1 = l1.nextSibling, E1 = t1.nextSibling, de = E1.nextSibling;
        return h.$$click = (F) => {
          F.stopPropagation();
        }, h.$$mousedown = (F) => {
          F.preventDefault(), F.stopPropagation();
        }, m.$$mousedown = r5, p.$$click = e5, v.$$click = () => D1(I1() === "color" ? null : "color"), _(y, L(z, {
          get when() {
            return I1() === "color";
          },
          get children() {
            ...
            return _(m1, L(At, {
              each: ht,
              children: (a1) => (() => {
                const b1 = _h.cloneNode(!0);
                return b1.$$click = () => t5(a1), b1.style.setProperty("background", a1), B(() => h1(b1, `overlay-toolbar-color-swatch ${d.color.toLowerCase() === a1.toLowerCase() ? "selected" : ""}`)), b1;
              })()
            })), F;
          }
        }), null), M.$$click = () => D1(I1() === "width" ? null : "width"), _(q, () => d.lineSize, i1), _(A, L(z, {
          get when() {
            return I1() === "width";
          },
          get children() {
            ...
            return _(F, L(At, {
              each: [1, 2, 3, 4],
              children: (m1) => (() => {
                const a1 = Lh.cloneNode(!0), b1 = a1.firstChild;
                return a1.$$click = () => J9(m1), b1.style.setProperty("height", `${m1}px`), B(() => h1(a1, d.lineSize === m1 ? "selected" : "")), a1;
              })()
            })), F;
          }
        }), null), f1.$$click = () => D1(I1() === "style" ? null : "style"), _(l1, L(z, {
          get when() {
            return I1() === "style";
          },
          get children() {
            const F = bh.cloneNode(!0), m1 = F.firstChild, a1 = m1.nextSibling, b1 = a1.nextSibling;
            return m1.$$click = () => mt(Z1.Solid, []), a1.$$click = () => mt(Z1.Dashed, [6, 4]), b1.$$click = () => mt(Z1.Dashed, [2, 4]), B((w1) => {
              var Te, Pe;
              ...
              return we !== w1._v$ && h1(m1, w1._v$ = we), Me !== w1._v$2 && h1(a1, w1._v$2 = Me), Se !== w1._v$3 && h1(b1, w1._v$3 = Se), w1;
            }, {
              _v$: void 0,
              _v$2: void 0,
              _v$3: void 0
        ...
        }), null), t1.$$click = X9, E1.$$click = W9, de.$$click = G9, B((F) => {
          const m1 = `${d.x}px`, a1 = `${d.y}px`, b1 = `overlay-toolbar-icon edit ${I1() === "color" ? "active" : ""}`, w1 = `overlay-toolbar-line-size ${I1() === "width" ? "active" : ""}`, we = `overlay-toolbar-icon minus ${I1() === "style" ? "active" : ""}`, Me = `overlay-toolbar-icon visibility ${d.visible ? "" : "muted"}`, Se = d.visible ? "Hide" : "Show", Te = `overlay-toolbar-icon lock ${d.locked ? "active" : ""}`, Pe = d.locked ? "Unlock" : "Lock";
          return m1 !== F._v$4 && h.style.setProperty("left", F._v$4 = m1), a1 !== F._v$5 && h.style.setProperty("top", F._v$5 = a1), b1 !== F._v$6 && h1(v, F._v$6 = b1), w1 !== F._v$7 && h1(M, F._v$7 = w1), we !== F._v$8 && h1(f1, F._v$8 = we), Me !== F._v$9 && h1(t1, F._v$9 = Me), Se !== F._v$10 && v1(t1, "title", F._v$10 = Se), Te !== F._v$11 && h1(E1, F._v$11 = Te), Pe !== F._v$12 && v1(E1, "title", F._v$12 = Pe), F;
        }, {
          _v$4: void 0,
          _v$5: void 0,
          _v$6: void 0,
      ...
      children: (d) => (() => {
        ...
        return h.addEventListener("mouseleave", () => {
          ...
          const y = `${Math.max(0, d.y - 12)}px`, v = `${_e()}px`, A = $1().quickOrderPlusButton ? "block" : "none";
      ...
      children: (d) => (() => {
        ...
        f1.nextSibling;
        const t1 = T.nextSibling, E1 = t1.nextSibling, de = E1.firstChild, F = de.nextSibling;
        F.nextSibling;
        const m1 = E1.nextSibling;
        return m1.firstChild, h.addEventListener("mouseleave", () => O1(!1)), h.addEventListener("mouseenter", () => O1(!0)), m.$$mousemove = () => {
          ce();
        }, m.$$mousedown = (a1) => {
          a1.preventDefault(), a1.stopPropagation(), ce();
        }, p.$$click = () => Ct("limit"), _(p, () => k().shortName ?? k().name ?? k().ticker, v), _(p, () => Ke(d.price), M), T.$$click = () => Ct("stop"), _(T, () => k().shortName ?? k().name ?? k().ticker, i1), _(T, () => Ke(d.price), f1), t1.$$click = () => Ct("create"), E1.$$click = H9, _(E1, () => Ke(d.price), F), m1.$$click = Y9, _(m1, () => Ke(d.price), null), B((a1) => {
          const b1 = `${Math.max(0, d.y + 24)}px`, w1 = `${d.yAxisWidth + dt}px`;
          return b1 !== a1._v$16 && h.style.setProperty("top", a1._v$16 = b1), w1 !== a1._v$17 && h.style.setProperty("right", a1._v$17 = w1), a1;
        }, {
          _v$16: void 0,
          _v$17: void 0
        }), h;
      ...
      return L(Xd, {
        ...
        onMainIndicatorChange: (i) => {
          ...
          i.added ? (Ve(r, i.name, !0, {
            id: "candle_pane"
          }), s.push(i.name), N1(i.name, "candle_pane", "main", "add")) : (r == null || r.removeIndicator("candle_pane", i.name), s.splice(s.indexOf(i.name), 1), N1(i.name, "candle_pane", "main", "remove")), N(s);
        },
        onSubIndicatorChange: (i) => {
          ...
          if (i.added) {
            const d = Ve(r, i.name);
            d && (s[i.name] = d, N1(i.name, d, "sub", "add"));
          } else
            i.paneId && (r == null || r.removeIndicator(i.paneId, i.name), delete s[i.name], N1(i.name, i.paneId, "sub", "remove"));
          G(s);
        }
      });
    }
    ...
    get children() {
      return L(ch, {
        ...
        onConfirm: (i) => {
          ...
          N1(s.indicatorName, s.paneId, d, "change");
        }
      });
    }
  }), L(z, {

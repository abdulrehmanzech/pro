...
var we = (e, t, n) => t in e ? Ae(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var F1 = (e, t, n) => (we(e, typeof t != "symbol" ? t + "" : t, n), n);
import { utils as F, OverlayMode as X0, dispose as J0, init as Me, FormatDateType as H1, DomPosition as W0, ActionType as Se, TooltipIconPosition as G1, CandleType as Te, YAxisType as Ie, registerOverlay as De } from "klinecharts";
function j1(e, t, n) {
...
const Ne = {
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = K9(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = F.getLinearSlopeIntercept(e[0], e[1]);
      let i;
      ...
      for (let h = 2; h < 9; h++) {
        ...
        const D = $ + Math.PI / 2, K = j1({ x: g, y: f }, e[0], i);
        l.push({
          ...K,
          r: L,
          startAngle: $,
...
var V = null;
let m1 = null, B = null, J = null, l1 = null, I0 = 0;
function q1(e, t) {
  const n = B, r = V, a = e.length === 0, i = a ? Z9 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function b(e, t) {
  ...
  }, r = (a) => (typeof a == "function" && (a = a(n.value)), R9(n, a));
  return [z9.bind(n), r];
}
function q0(e, t, n) {
  const r = u0(e, t, !0, C1);
...
function c1(e, t, n) {
  j9 = i5;
  const r = u0(e, t, !1, C1);
  r.user = !0, l1 ? l1.push(r) : $1(r);
}
function z(e, t, n) {
  n = n ? Object.assign({}, t0, n) : t0;
  const r = u0(e, t, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, $1(r), z9.bind(r);
}
function e5(e, t, n) {
  let r, a, i;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (r = !0, a = e, i = t || {}) : (r = e, a = t, i = n || {});
  let o = null, s = m0, l = null, g = !1, f = "initialValue" in i, h = typeof r == "function" && z(r);
  const L = /* @__PURE__ */ new Set(), [$, D] = (i.storage || b)(i.initialValue), [K, Z] = b(void 0), [I, U] = b(void 0, {
    equals: !1
  }), [N, M] = b(f ? "ready" : "unresolved");
  if (W.context) {
    l = `${W.context.id}${W.context.count++}`;
    let S;
    i.ssrLoadFrom === "initial" ? s = i.initialValue : W.load && (S = W.load(l)) && (s = S[0]);
  }
  function k(S, E, Q, o1) {
    return o === S && (o = null, f = !0, (S === s || E === s) && i.onHydrated && queueMicrotask(() => i.onHydrated(o1, {
      value: E
    })), s = m0, j(E, Q)), E;
  }
  function j(S, E) {
    y1(() => {
      E === void 0 && D(() => S), M(E !== void 0 ? "errored" : "ready"), Z(E);
      for (const Q of L.keys())
        Q.decrement();
      L.clear();
    }, !1);
  }
  function q() {
    ...
    if (Q !== void 0 && !o)
      throw Q;
    return B && !B.user && S && q0(() => {
      I(), o && (S.resolved || L.has(S) || (S.increment(), L.add(S)));
    }), E;
  }
  function s1(S = !0) {
    if (S !== !1 && g)
    ...
    const Q = s !== m0 ? s : u1(() => a(E, {
      value: $(),
      refetching: S
    }));
    return typeof Q != "object" || !(Q && "then" in Q) ? (k(o, Q, void 0, E), Q) : (o = Q, g = !0, queueMicrotask(() => g = !1), y1(() => {
      M(f ? "refreshing" : "pending"), U();
    }, !1), Q.then((o1) => k(Q, o1, void 0, E), (o1) => k(Q, void 0, V9(o1), E)));
  }
...
function t5(e) {
  ...
  return Promise.resolve().then(() => {
    B = t, V = n;
    let r;
    return y1(e, !1), B = V = null, r ? r.done : void 0;
  });
}
let n5;
function z9() {
...
function R9(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && y1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      o && m1.disposed.has(i), (o && !i.tState || !o && !i.state) && (i.pure ? J.push(i) : l1.push(i), i.observers && Y9(i)), o || (i.state = C1);
    }
    if (J.length > 1e6)
      throw J = [], new Error();
  }, !1)), t;
...
function r5(e, t, n) {
  ...
  try {
    ...
    e.pure && (e.state = C1, e.owned && e.owned.forEach(C0), e.owned = null), H9(a);
  }
  (!e.updatedAt || e.updatedAt <= n) && (e.updatedAt != null && "observers" in e ? R9(e, r) : e.value = r, e.updatedAt = n);
}
function u0(e, t, n, r = C1, a) {
  const i = {
    fn: e,
    state: r,
    updatedAt: null,
  ...
  return V === null || V !== Z9 && (V.owned ? V.owned.push(i) : V.owned = [i]), i;
}
function r0(e) {
  const t = m1;
  if (e.state === 0 || t)
...
function a0(e, t) {
  ...
  for (let r = 0; r < e.sources.length; r += 1) {
    const a = e.sources[r];
    a.sources && (a.state === C1 || n ? a !== t && r0(a) : (a.state === n0 || n) && a0(a, t));
  }
}
function Y9(e) {
  const t = m1;
  for (let n = 0; n < e.observers.length; n += 1) {
    ...
    (!r.state || t) && (r.state = n0, r.pure ? J.push(r) : l1.push(r), r.observers && Y9(r));
  }
}
function C0(e) {
  let t;
...
function o5(e, t, n = {}) {
  ...
  return D0(() => e9(i)), () => {
    let l = e() || [], g, f;
    return l[qe], u1(() => {
      let L = l.length, $, D, K, Z, I, U, N, M, k;
      if (L === 0)
        o !== 0 && (e9(i), i = [], r = [], a = [], o = 0, s && (s = [])), n.fallback && (r = [s5], a[0] = q1((j) => (i[0] = j, n.fallback())), o = 1);
      else if (o === 0) {
        for (a = new Array(L), f = 0; f < L; f++)
          r[f] = l[f], a[f] = q1(h);
        o = L;
      } else {
        for (K = new Array(L), Z = new Array(L), s && (I = new Array(L)), U = 0, N = Math.min(o, L); U < N && r[U] === l[U]; U++)
          ;
        for (N = o - 1, M = L - 1; N >= U && M >= U && r[N] === l[M]; N--, M--)
          K[M] = a[N], Z[M] = i[N], s && (I[M] = s[N]);
        for ($ = /* @__PURE__ */ new Map(), D = new Array(M + 1), f = M; f >= U; f--)
          k = l[f], g = $.get(k), D[f] = g === void 0 ? -1 : g, $.set(k, f);
        for (g = U; g <= N; g++)
          k = r[g], f = $.get(k), f !== void 0 && f !== -1 ? (K[f] = a[g], Z[f] = i[g], s && (I[f] = s[g]), f = D[f], $.set(k, f)) : i[g]();
        for (f = U; f < L; f++)
          f in K ? (a[f] = K[f], i[f] = Z[f], s && (s[f] = I[f], s[f](f))) : a[f] = q1(h);
...
function G9(...e) {
  ...
  for (let r = 0; r < e.length; r++) {
    const a = e[r];
    t = t || !!a && b0 in a, e[r] = typeof a == "function" ? (t = !0, z(a)) : a;
  }
  if (t)
    return new Proxy({
      get(r) {
...
function a1(e, t = window.document) {
  const n = t[t9] || (t[t9] = /* @__PURE__ */ new Set());
  ...
  if (e = o && n[0] && n[0].parentNode || e, i === "string" || i === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (s.length === 0) {
        ...
        l ? n.length === 0 ? n9(e, s, r) : u5(e, n, s) : (n && L1(e), n9(e, s));
      n = s;
...
var d5 = typeof J1 == "object" && J1 && J1.Object === Object && J1, J9 = d5, g5 = J9, y5 = typeof self == "object" && self && self.Object === Object && self, h5 = g5 || y5 || Function("return this")(), i1 = h5, p5 = i1, m5 = p5.Symbol, f0 = m5, r9 = f0, W9 = Object.prototype, v5 = W9.hasOwnProperty, _5 = W9.toString, K1 = r9 ? r9.toStringTag : void 0;
function L5(e) {
...
var A5 = k5, a9 = f0, w5 = $5, M5 = A5, S5 = "[object Null]", T5 = "[object Undefined]", i9 = a9 ? a9.toStringTag : void 0;
function I5(e) {
  return e == null ? e === void 0 ? T5 : S5 : i9 && i9 in Object(e) ? w5(e) : M5(e);
}
var Z1 = I5;
function D5(e) {
  var t = typeof e;
...
var q9 = K5, j5 = i1, Z5 = j5["__core-js_shared__"], Q5 = Z5, _0 = Q5, s9 = function() {
...
var ee = V5, H5 = q9, G5 = R5, X5 = x1, J5 = ee, W5 = /[\\^$.*+?()[\]{}|]/g, q5 = /^\[object .+?Constructor\]$/, e6 = Function.prototype, t6 = Object.prototype, n6 = e6.toString, r6 = t6.hasOwnProperty, a6 = RegExp(
...
var ne = h6, p6 = te, m6 = ne, v6 = Object.prototype, _6 = v6.hasOwnProperty;
function L6(e, t, n) {
  var r = e[t];
...
var N6 = D6, O6 = _1, P6 = O6(Object, "create"), d0 = P6, c9 = d0;
function B6() {
  this.__data__ = c9 ? c9(null) : {}, this.size = 0;
}
var E6 = B6;
function F6(e) {
...
M1.prototype.has = M2;
M1.prototype.set = S2;
var y0 = M1, T2 = _1, I2 = i1, D2 = T2(I2, "Map"), B0 = D2, l9 = s2, N2 = y0, O2 = B0;
function P2() {
...
S1.prototype.has = n3;
S1.prototype.set = r3;
var re = S1, ae = re, a3 = "Expected a function";
function E0(e, t) {
  ...
  return n.cache = new (E0.Cache || ae)(), n;
}
E0.Cache = ae;
...
var h3 = y3, u9 = f0, p3 = h3, m3 = k1, v3 = P0, _3 = 1 / 0, C9 = u9 ? u9.prototype : void 0, f9 = C9 ? C9.toString : void 0;
function ie(e) {
  if (typeof e == "string")
    return e;
  if (m3(e))
...
var E3 = B3, F3 = O0, K3 = T3, j3 = se, d9 = x1, Z3 = E3;
function Q3(e, t, n, r) {
  if (!d9(e))
    return e;
  t = K3(t, e);
  for (var a = -1, i = t.length, o = i - 1, s = e; s != null && ++a < i; ) {
    ...
    if (a != o) {
      var f = s[l];
      g = r ? r(f, l, s) : void 0, g === void 0 && (g = d9(f) ? f : j3(t[a + 1]) ? [] : {});
    }
    F3(s, l, g), s = s[l];
  }
  return e;
...
var t8 = e8, n8 = y0, r8 = B0, a8 = re, i8 = 200;
function s8(e, t) {
  var n = this.__data__;
  if (n instanceof n8) {
    var r = n.__data__;
...
var A8 = k8, g9 = A8, w8 = A1, oe = Object.prototype, M8 = oe.hasOwnProperty, S8 = oe.propertyIsEnumerable, T8 = g9(function() {
  return arguments;
}()) ? g9 : function(e) {
...
s0.exports;
(function(e, t) {
  var n = i1, r = N8, a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, o = i && i.exports === a, s = o ? n.Buffer : void 0, l = s ? s.isBuffer : void 0, g = l || r;
  e.exports = g;
})(s0, s0.exports);
var ce = s0.exports, O8 = 9007199254740991;
function P8(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= O8;
}
var le = P8, B8 = Z1, E8 = le, F8 = A1, K8 = "[object Arguments]", j8 = "[object Array]", Z8 = "[object Boolean]", Q8 = "[object Date]", z8 = "[object Error]", R8 = "[object Function]", U8 = "[object Map]", Y8 = "[object Number]", V8 = "[object Object]", H8 = "[object RegExp]", G8 = "[object Set]", X8 = "[object String]", J8 = "[object WeakMap]", W8 = "[object ArrayBuffer]", q8 = "[object DataView]", e7 = "[object Float32Array]", t7 = "[object Float64Array]", n7 = "[object Int8Array]", r7 = "[object Int16Array]", a7 = "[object Int32Array]", i7 = "[object Uint8Array]", s7 = "[object Uint8ClampedArray]", o7 = "[object Uint16Array]", c7 = "[object Uint32Array]", P = {};
P[e7] = P[t7] = P[n7] = P[r7] = P[a7] = P[i7] = P[s7] = P[o7] = P[c7] = !0;
P[K8] = P[j8] = P[W8] = P[Z8] = P[q8] = P[Q8] = P[z8] = P[R8] = P[U8] = P[Y8] = P[V8] = P[H8] = P[G8] = P[X8] = P[J8] = !1;
function l7(e) {
  return F8(e) && E8(e.length) && !!P[B8(e)];
}
var u7 = l7;
function C7(e) {
  return function(t) {
...
var K0 = o0.exports, f7 = u7, d7 = F0, y9 = K0, h9 = y9 && y9.isTypedArray, g7 = h9 ? d7(h9) : f7, y7 = g7, h7 = L8, p7 = I8, m7 = k1, v7 = ce, _7 = se, L7 = y7, $7 = Object.prototype, b7 = $7.hasOwnProperty;
function x7(e, t) {
...
var Ce = w7, M7 = Ce, S7 = M7(Object.keys, Object), T7 = S7, I7 = j0, D7 = T7, N7 = Object.prototype, O7 = N7.hasOwnProperty;
function P7(e) {
  if (!I7(e))
    return D7(e);
  var t = [];
...
var B7 = P7, E7 = q9, F7 = le;
function K7(e) {
  return e != null && F7(e.length) && !E7(e);
}
var fe = K7, j7 = ue, Z7 = B7, Q7 = fe;
function z7(e) {
...
c0.exports;
(function(e, t) {
  var n = i1, r = t && !t.nodeType && t, a = r && !0 && e && !e.nodeType && e, i = a && a.exports === r, o = i ? n.Buffer : void 0, s = o ? o.allocUnsafe : void 0;
  function l(g, f) {
    if (f)
      return g.slice();
...
var de = ht, pt = yt, mt = de, vt = Object.prototype, _t = vt.propertyIsEnumerable, p9 = Object.getOwnPropertySymbols, Lt = p9 ? function(e) {
  return e == null ? [] : (e = Object(e), pt(p9(e), function(t) {
    return _t.call(e, t);
  }));
} : mt, z0 = Lt, $t = p0, bt = z0;
function xt(e, t) {
...
var ge = At, wt = Ce, Mt = wt(Object.getPrototypeOf, Object), ye = Mt, St = ge, Tt = ye, It = z0, Dt = de, Nt = Object.getOwnPropertySymbols, Ot = Nt ? function(e) {
  for (var t = []; e; )
    St(t, It(e)), e = Tt(e);
  return t;
} : Dt, he = Ot, Pt = p0, Bt = he;
function Et(e, t) {
  return Pt(e, Bt(e), t);
}
var Ft = Et, Kt = ge, jt = k1;
function Zt(e, t, n) {
  var r = t(e);
  return jt(e) ? r : Kt(r, n(e));
}
var pe = Zt, Qt = pe, zt = z0, Rt = Z0;
function Ut(e) {
  return Qt(e, Rt, zt);
}
var Yt = Ut, Vt = pe, Ht = he, Gt = Q0;
function Xt(e) {
  return Vt(e, Gt, Ht);
}
var Jt = Xt, Wt = _1, qt = i1, e4 = Wt(qt, "DataView"), t4 = e4, n4 = _1, r4 = i1, a4 = n4(r4, "Promise"), i4 = a4, s4 = _1, o4 = i1, c4 = s4(o4, "Set"), l4 = c4, u4 = _1, C4 = i1, f4 = u4(C4, "WeakMap"), d4 = f4, A0 = t4, w0 = B0, M0 = i4, S0 = l4, T0 = d4, me = Z1, I1 = ee, m9 = "[object Map]", g4 = "[object Object]", v9 = "[object Promise]", _9 = "[object Set]", L9 = "[object WeakMap]", $9 = "[object DataView]", y4 = I1(A0), h4 = I1(w0), p4 = I1(M0), m4 = I1(S0), v4 = I1(T0), p1 = me;
(A0 && p1(new A0(new ArrayBuffer(1))) != $9 || w0 && p1(new w0()) != m9 || M0 && p1(M0.resolve()) != v9 || S0 && p1(new S0()) != _9 || T0 && p1(new T0()) != L9) && (p1 = function(e) {
  var t = me(e), n = t == g4 ? e.constructor : void 0, r = n ? I1(n) : "";
  if (r)
    switch (r) {
      case y4:
        return $9;
...
var b4 = $4, x4 = i1, k4 = x4.Uint8Array, A4 = k4, b9 = A4;
function w4(e) {
...
var N4 = D4, x9 = f0, k9 = x9 ? x9.prototype : void 0, A9 = k9 ? k9.valueOf : void 0;
function O4(e) {
  return A9 ? Object(A9.call(e)) : {};
}
var P4 = O4, B4 = U0;
function E4(e, t) {
...
var Cn = un, fn = x1, w9 = Object.create, dn = function() {
  function e() {
  }
  return function(t) {
    if (!fn(t))
...
var xn = bn, kn = xn, An = F0, M9 = K0, S9 = M9 && M9.isMap, wn = S9 ? An(S9) : kn, Mn = wn, Sn = R0, Tn = A1, In = "[object Set]";
function Dn(e) {
  return Tn(e) && Sn(e) == In;
}
var Nn = Dn, On = Nn, Pn = F0, T9 = K0, I9 = T9 && T9.isSet, Bn = I9 ? Pn(I9) : On, En = Bn, Fn = g8, Kn = h8, jn = O0, Zn = V7, Qn = ut, zn = Ct, Rn = dt, Un = kt, Yn = Ft, Vn = Yt, Hn = Jt, Gn = R0, Xn = b4, Jn = Cn, Wn = vn, qn = k1, er = ce, tr = Mn, nr = x1, rr = En, ar = Z0, ir = Q0, sr = 1, or = 2, cr = 4, ve = "[object Arguments]", lr = "[object Array]", ur = "[object Boolean]", Cr = "[object Date]", fr = "[object Error]", _e = "[object Function]", dr = "[object GeneratorFunction]", gr = "[object Map]", yr = "[object Number]", Le = "[object Object]", hr = "[object RegExp]", pr = "[object Set]", mr = "[object String]", vr = "[object Symbol]", _r = "[object WeakMap]", Lr = "[object ArrayBuffer]", $r = "[object DataView]", br = "[object Float32Array]", xr = "[object Float64Array]", kr = "[object Int8Array]", Ar = "[object Int16Array]", wr = "[object Int32Array]", Mr = "[object Uint8Array]", Sr = "[object Uint8ClampedArray]", Tr = "[object Uint16Array]", Ir = "[object Uint32Array]", O = {};
O[ve] = O[lr] = O[Lr] = O[$r] = O[ur] = O[Cr] = O[br] = O[xr] = O[kr] = O[Ar] = O[wr] = O[gr] = O[yr] = O[Le] = O[hr] = O[pr] = O[mr] = O[vr] = O[Mr] = O[Sr] = O[Tr] = O[Ir] = !0;
O[fr] = O[_e] = O[_r] = !1;
function e0(e, t, n, r, a, i) {
  ...
  if ($)
    return $;
  i.set(e, o), rr(e) ? e.forEach(function(Z) {
    o.add(e0(Z, t, n, Z, e, i));
  }) : tr(e) && e.forEach(function(Z, I) {
    o.set(I, e0(Z, t, n, I, e, i));
  });
  var D = g ? l ? Hn : Vn : l ? ir : ar, K = f ? void 0 : D(e);
  return Kn(K || e, function(Z, I) {
    K && (I = Z, Z = e[I]), jn(o, I, e0(Z, t, n, I, e, i));
  }), o;
}
...
var Er = Br;
const Fr = /* @__PURE__ */ X9(Er), Kr = /* @__PURE__ */ y("<button></button>"), jr = (e) => (() => {
  const t = Kr.cloneNode(!0);
  return g1(t, "click", e.onClick, !0), v(t, () => e.children), Y((n) => {
...
const Vr = /* @__PURE__ */ y('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), $e = () => Vr.cloneNode(!0), Hr = /* @__PURE__ */ y('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), Gr = () => Hr.cloneNode(!0), Xr = /* @__PURE__ */ y("<ul></ul>"), Jr = /* @__PURE__ */ y("<li></li>"), l0 = (e) => (() => {
  ...
  return v(r, () => e.title, a), g1(a, "click", e.onClose, !0), v(i, () => e.children), v(n, (() => {
    const o = z(() => !!(e.buttons && e.buttons.length > 0));
    return () => o() && (() => {
      const s = qr.cloneNode(!0);
      return v(s, () => e.buttons.map((l) => m(jr, G9(l, {
        get children() {
          return l.children;
        }
      })))), s;
...
a1(["click"]);
const ea = /* @__PURE__ */ y('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ta = /* @__PURE__ */ y('<div class="drop-down-container"><ul></ul></div>'), na = /* @__PURE__ */ y("<li></li>"), be = (e) => {
  const [t, n] = b(!1);
  return (() => {
    ...
    return r.addEventListener("blur", (o) => {
      ...
      const o = z(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => o() && (() => {
        ...
        return v(l, () => e.dataSource.map((g) => {
          ...
          return (() => {
            ...
            return L.$$click = ($) => {
              var D;
              $.stopPropagation(), e.value !== h && ((D = e.onSelected) == null || D.call(e, g)), n(!1);
            }, v(L, h), L;
          })();
        })), s;
      })();
...
a1(["click"]);
const ra = /* @__PURE__ */ y('<span class="prefix"></span>'), aa = /* @__PURE__ */ y('<span class="suffix"></span>'), ia = /* @__PURE__ */ y('<div><input class="value"></div>'), xe = (e) => {
  const t = G9({
...
const C = (e, t) => {
  var n;
  return ((n = ke[t]) == null ? void 0 : n[e]) ?? e;
  ...
  return Q9(() => {
    ...
    const i = kc.cloneNode(!0), o = i.firstChild, s = o.firstChild, l = o.nextSibling, g = l.firstChild, f = g.nextSibling, h = l.nextSibling, L = h.firstChild, $ = L.nextSibling, D = h.nextSibling, K = D.firstChild, Z = K.nextSibling, I = D.nextSibling, U = I.firstChild, N = U.nextSibling, M = I.nextSibling;
    return N0((k) => {
      t = k;
    }, i), g1(s, "click", e.onMenuClick, !0), v(i, m(X, {
      get when() {
        return e.symbol;
      },
      get children() {
        const k = xc.cloneNode(!0), j = k.firstChild;
        return g1(k, "click", e.onSymbolClick, !0), v(k, m(X, {
          get when() {
        ...
        }), j), v(j, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), k;
      }
    }), l), v(i, () => e.periods.map((k) => (() => {
      const j = L0.cloneNode(!0);
      return j.$$click = () => {
        e.onPeriodChange(k);
      }, v(j, () => k.text), Y(() => v1(j, `item period ${k.text === e.period.text ? "selected" : ""}`)), j;
    })()), l), g1(l, "click", e.onIndicatorClick, !0), v(f, () => C("indicator", e.locale)), g1(h, "click", e.onTimezoneClick, !0), v($, () => C("timezone", e.locale)), g1(D, "click", e.onSettingClick, !0), v(Z, () => C("setting", e.locale)), g1(I, "click", e.onScreenshotClick, !0), v(N, () => C("screenshot", e.locale)), M.$$click = () => {
      if (n())
      ...
      return () => k() ? [Ac.cloneNode(!0), (() => {
        const j = L0.cloneNode(!0);
        return v(j, () => C("exit_full_screen", e.locale)), j;
      })()] : [wc.cloneNode(!0), (() => {
        const j = L0.cloneNode(!0);
        return v(j, () => C("full_screen", e.locale)), j;
      })()];
...
const n1 = (e) => Gl[e.name](e.class), nu = /* @__PURE__ */ y('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), ru = /* @__PURE__ */ y('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), N9 = /* @__PURE__ */ y('<li><span style="padding-left:8px"></span></li>'), O9 = "drawing_tools", au = (e) => {
  const [t, n] = b("horizontalStraightLine"), [r, a] = b("priceChannelLine"), [i, o] = b("circle"), [s, l] = b("fibonacciLine"), [g, f] = b("xabcd"), [h, L] = b("weak_magnet"), [$, D] = b("normal"), [K, Z] = b(!1), [I, U] = b(!0), [N, M] = b(""), k = z(() => [{
    key: "singleLine",
    icon: t(),
    list: Xl(e.locale),
    setter: n
  ...
  return (() => {
    const q = nu.cloneNode(!0), s1 = q.firstChild, S = s1.nextSibling, E = S.firstChild, Q = E.nextSibling, o1 = Q.firstChild, N1 = S.nextSibling, O1 = N1.firstChild, h1 = N1.nextSibling, Q1 = h1.firstChild, z1 = h1.nextSibling, R1 = z1.nextSibling, U1 = R1.firstChild;
    return v(q, () => k().map((T) => (() => {
      const H = ru.cloneNode(!0), r1 = H.firstChild, G = r1.nextSibling, f1 = G.firstChild;
      return H.addEventListener("blur", () => {
        ...
        return () => Y1() && m(l0, {
          class: "list",
          get children() {
            return T.list.map((d1) => (() => {
              const c = N9.cloneNode(!0), u = c.firstChild;
              return c.$$click = () => {
                T.setter(d1.key), e.onDrawingItemClick({
                  name: d1.key,
                  lock: K(),
                  mode: $()
                }), M("");
      ...
      })(), null), Y(() => e1(f1, "class", T.key === N() ? "rotate" : "")), H;
    })()), s1), S.addEventListener("blur", () => {
      M("");
    }), E.$$click = () => {
      let T = h();
      $() !== "normal" && (T = "normal"), D(T), e.onModeChange(T);
    }, v(E, (() => {
      const T = z(() => h() === "weak_magnet");
      return () => T() ? (() => {
        const H = z(() => $() === "weak_magnet");
        return () => H() ? m(n1, {
          name: "weak_magnet",
          class: "selected"
        }) : m(n1, {
      ...
      return () => T() && m(l0, {
        ...
        get children() {
          return j().map((H) => (() => {
            const r1 = N9.cloneNode(!0), G = r1.firstChild;
            return r1.$$click = () => {
              L(H.key), D(H.key), e.onModeChange(H.key), M("");
            }, v(r1, m(n1, {
              get name() {
                return H.key;
              }
      ...
      name: "remove"
    })), Y(() => e1(o1, "class", N() === "mode" ? "rotate" : "")), q;
  })();
};
a1(["click"]);
const P9 = /* @__PURE__ */ y('<li class="title"></li>'), B9 = /* @__PURE__ */ y('<li class="row"></li>'), iu = (e) => m(D1, {
  get title() {
...
const ou = (e) => {
  const [t, n] = b(e.timezone), r = z(() => su(e.locale));
  return m(D1, {
    get title() {
...
const cu = /* @__PURE__ */ y('<div class="klinecharts-pro-setting-modal-content"></div>'), lu = /* @__PURE__ */ y("<span></span>"), uu = (e) => {
  const [t, n] = b(e.currentStyles), [r, a] = b(F9(e.locale));
  c1(() => {
    a(F9(e.locale));
  });
  const i = (o, s) => {
  ...
  const [t, n] = b(F.clone(e.params.calcParams)), r = (a) => du[a];
  return m(D1, {
    get title() {
...
const bu = (e) => {
  let t, n = null, r, a = !1;
  const [i, o] = b(e.theme), [s, l] = b(e.styles), [g, f] = b(e.locale), [h, L] = b(e.symbol), [$, D] = b(e.period), [K, Z] = b(!1), [I, U] = b([...e.mainIndicators]), [N, M] = b({}), [k, j] = b(!1), [q, s1] = b({
    key: e.timezone,
    text: E9(e.timezone, e.locale)
  }), [S, E] = b(!1), [Q, o1] = b(), [N1, O1] = b(""), [h1, Q1] = b(e.drawingBarVisible), [z1, R1] = b(!1), [U1, T] = b(!1), [H, r1] = b({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  });
  let G = /* @__PURE__ */ new Map(), f1 = {
    saveDrawings: (c, u) => {
      try {
  ...
  e.ref({
    ...
    getSettings: () => {
      var _, d, p, x, A, w, R, t1, P1, B1, E1, V1, Y0, V0, H0, G0;
      if (!n)
        return {};
      ...
      return {
        ...
        showLastPrice: (A = (x = (p = c.candle) == null ? void 0 : p.priceMark) == null ? void 0 : x.last) == null ? void 0 : A.show,
        showHighestPrice: (t1 = (R = (w = c.candle) == null ? void 0 : w.priceMark) == null ? void 0 : R.high) == null ? void 0 : t1.show,
    ...
    setSettings: (c) => {
      ...
      c.showLastPrice !== void 0 && (u.candle = {
        ...
        priceMark: {
          ...
          last: {
            ...(x = (p = u.candle) == null ? void 0 : p.priceMark) == null ? void 0 : x.last,
        ...
        ...u.candle,
        priceMark: {
          ...(A = u.candle) == null ? void 0 : A.priceMark,
          high: {
            ...(R = (w = u.candle) == null ? void 0 : w.priceMark) == null ? void 0 : R.high,
        ...
        ...u.candle,
        priceMark: {
          ...(t1 = u.candle) == null ? void 0 : t1.priceMark,
          low: {
    ...
    resetSettings: () => {
      ...
      if (u) {
        const t1 = {
          ...
          indicator: {
            lastValueMark: (x = u.indicator) == null ? void 0 : x.lastValueMark
          },
          yAxis: {
            type: (A = u.yAxis) == null ? void 0 : A.type,
            reverse: (w = u.yAxis) == null ? void 0 : w.reverse
          },
          grid: {
            show: (R = u.grid) == null ? void 0 : R.show
          }
        };
        n.setStyles(t1);
      } else
      ...
      if (u) {
        const _ = new MutationObserver(() => {
          setTimeout(() => {
            ...
            p.length > 0 && f1.saveDrawings(c, p);
          }, 100);
        });
        t && _.observe(t, {
          childList: !0,
  ...
  const Y1 = () => {
    ...
    switch (c.timespan) {
      ...
      case "week": {
        const A = new Date(d).getDay(), w = A === 0 ? 6 : A - 1;
        d = d - w * 60 * 60 * 24;
        const R = new Date(d);
        d = (/* @__PURE__ */ new Date(`${R.getFullYear()}-${R.getMonth() + 1}-${R.getDate()}`)).getTime(), p = _ * c.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const x = new Date(d), A = x.getFullYear(), w = x.getMonth() + 1;
        d = (/* @__PURE__ */ new Date(`${A}-${w}-01`)).getTime(), p = _ * c.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const R = new Date(p);
        p = (/* @__PURE__ */ new Date(`${R.getFullYear()}-${R.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const A = new Date(d).getFullYear();
        d = (/* @__PURE__ */ new Date(`${A}-01-01`)).getTime(), p = _ * c.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const w = new Date(p);
        p = (/* @__PURE__ */ new Date(`${w.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [p, d];
  ...
  return Q9(() => {
    if (window.addEventListener("resize", Y1), n = Me(t, {
      customApi: {
        formatDate: (d, p, x, A) => {
          switch ($().timespan) {
            case "minute":
              return A === H1.XAxis ? F.formatDate(d, p, "HH:mm") : F.formatDate(d, p, "YYYY-MM-DD HH:mm");
            case "hour":
              return A === H1.XAxis ? F.formatDate(d, p, "MM-DD HH:mm") : F.formatDate(d, p, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return F.formatDate(d, p, "YYYY-MM-DD");
            case "month":
              return A === H1.XAxis ? F.formatDate(d, p, "YYYY-MM") : F.formatDate(d, p, "YYYY-MM-DD");
            case "year":
              return A === H1.XAxis ? F.formatDate(d, p, "YYYY") : F.formatDate(d, p, "YYYY-MM-DD");
          }
          return F.formatDate(d, p, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      const d = n.getDom("candle_pane", W0.Main);
      if (d) {
        let x = document.createElement("div");
        if (x.className = "klinecharts-pro-watermark", F.isString(e.watermark)) {
      ...
      const p = n.getDom("candle_pane", W0.YAxis);
    ...
    e.subIndicators.forEach((d) => {
      const p = W1(n, d, !0);
      p && (c[d] = p);
    }), M(c), n == null || n.loadMore((d) => {
      a = !0, (async () => {
        const x = $(), [A] = d1(x, d, 1), [w] = d1(x, A, 500), R = await e.datafeed.getHistoryKLineData(h(), x, w, A);
        n == null || n.applyMoreData(R, R.length > 0), a = !1;
      })();
        ...
        switch (d.iconId) {
          ...
          case "close":
            if (d.paneId === "candle_pane") {
              ...
              n == null || n.removeIndicator(d.paneId, d.indicatorName), delete p[d.indicatorName], M(p);
            }
        }
    });
    const u = n == null ? void 0 : n.createOverlay;
    n && u && (n.createOverlay = function(...d) {
      const p = d[0], x = u.apply(this, d);
      return x && setTimeout(() => {
        var A;
        try {
          const w = (A = n == null ? void 0 : n.getOverlayById) == null ? void 0 : A.call(n, x);
          if (w) {
            const R = {
              id: x,
              type: w.name || p.name || "unknown",
              points: (w.points || []).map((t1) => (console.log("Extracting point from library :", t1), {
                timestamp: t1.timestamp || 0,
                value: t1.value || 0,
                dataIndex: t1.dataIndex || 0
              })),
              // Capture extendData from the config if not available on overlay
              extendData: w.extendData || p.extendData,
              styles: w.styles || p.styles,
              name: w.name || p.name,
              visible: w.visible ?? !0,
              lock: w.lock ?? !1,
              mode: w.mode || p.mode || X0.Normal
            };
            G.set(x, R), console.log("📝 Tracked overlay creation:", R);
          }
        } catch (w) {
          console.error("Error tracking overlay:", w);
        }
      }, 100), x;
    });
    const _ = n == null ? void 0 : n.removeOverlay;
    n && _ && (n.removeOverlay = function(...d) {
      const p = _.apply(this, d), x = d[0];
      return typeof x == "string" ? G.delete(x) : x && typeof x == "object" && x.id && G.delete(x.id), p;
    });
  }), D0(() => {
    window.removeEventListener("resize", Y1), J0(t);
  }), c1(() => {
    const c = h();
    ...
    if (!a) {
      ...
      return a = !0, T(!0), (async () => {
        const [p, x] = d1(_, (/* @__PURE__ */ new Date()).getTime(), 500), A = await e.datafeed.getHistoryKLineData(u, _, p, x);
        n == null || n.applyNewData(A, A.length > 0), e.datafeed.subscribe(u, _, (w) => {
    ...
    s() && (n == null || n.setStyles(s()), o1(Fr(n.getStyles())));
  }), [Lu.cloneNode(!0), m(X, {
    get when() {
      return z1();
    },
    ...
    onMenuClick: async () => {
      try {
        await t5(() => Q1(!h1())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    const _ = t;
    return typeof _ == "function" ? N0(_, u) : t = u, Y(() => e1(u, "data-drawing-bar-visible", h1())), c;
  })()];

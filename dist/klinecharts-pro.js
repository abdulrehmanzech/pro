  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((f) => {
        ...
        r.push({ coordinates: [{ x: k, y: e[0].y }, { x: k, y: e[1].y }] }), r.push({ coordinates: [{ x: e[0].x, y: x }, { x: e[1].x, y: x }] }), n = n.concat(kt([e[0], { x: k, y: e[1].y }], t)), n = n.concat(kt([e[0], { x: e[1].x, y: x }], t)), a.unshift({
          x: e[0].x + l,
          y: x + 10,
          text: `${f.toFixed(3)}`
        }), a.unshift({
...
function P5(e, t, r) {
  ...
  let u = null, c = $t, g = null, $ = !1, f = "initialValue" in l, k = typeof n == "function" && Y(n);
  ...
  return re(() => p0(l)), () => {
    ...
    return g[T5], V1(() => {
      ...
      if (x === 0)
        ...
        for (f = E; f < x; f++)
          f in O ? (a[f] = O[f], l[f] = H[f], c && (c[f] = Q[f], c[f](f))) : a[f] = Ne(k);
...
const B4 = /* @__PURE__ */ b('<span class="prefix"></span>'), U4 = /* @__PURE__ */ b('<span class="suffix"></span>'), F4 = /* @__PURE__ */ b('<div><input class="value"></div>'), j9 = (e) => {
  ...
  return (() => {
    ...
    return l.$$click = () => {
      ...
      return c._v$ = ne(l, g, c._v$), $ !== c._v$2 && h1(l, c._v$2 = $), f !== c._v$3 && v1(l, "data-status", c._v$3 = f), k !== c._v$4 && v1(u, "placeholder", c._v$4 = k), c;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
const o = (e, t) => {
  ...
  const [a, l] = w(window.innerWidth < 768), [u, c] = w(localStorage.getItem("klinechart_secondary_period") || ""), [g, $] = w(!1), [f, k] = w(!1), [x, S] = w({
    ...
    $((Z) => {
      const V = !Z;
      return V ? queueMicrotask(c1) : k(!1), V;
    });
  }, j = (Z) => {
    if (!g())
      return;
    const V = Z.target;
    V && (r != null && r.contains(V) || n != null && n.contains(V) || (k(!1), $(!1)));
  }, X = () => {
    g() && c1();
  }, R = () => {
    if (t && a()) {
        ...
        return te((W) => {
          ...
          get children() {
            return L(R5, {
              ...
              get children() {
                const W = du.cloneNode(!0), b1 = W.firstChild, P1 = b1.firstChild, O1 = P1.nextSibling, K1 = O1.firstChild, W1 = K1.firstChild, j1 = W1.firstChild, Be = K1.nextSibling, I1 = Be.firstChild, _e = I1.firstChild, Ue = b1.nextSibling, oe = Ue.firstChild, Y1 = oe.firstChild, dt = Ue.nextSibling, _1 = dt.nextSibling, A1 = _1.firstChild, D1 = A1.firstChild, N1 = _1.nextSibling, ht = N1.nextSibling, Le = ht.firstChild, se = Le.firstChild;
                return W.addEventListener("mouseleave", () => k(!1)), W.$$mousedown = (I) => I.stopPropagation(), te((I) => {
                  n = I;
                }, W), W.style.setProperty("position", "fixed"), W.style.setProperty("z-index", "9999"), b1.addEventListener("mouseenter", () => k(!0)), P1.$$click = (I) => {
                  I.preventDefault(), I.stopPropagation(), k((D) => !D);
                }, O1.addEventListener("mouseenter", () => k(!0)), j1.addEventListener("change", (I) => {
                  var D;
          ...
          const b1 = a() ? "0 8px" : "0 10px", P1 = g() ? "rotate(180deg)" : "rotate(0deg)";
          return b1 !== W._v$5 && U.style.setProperty("padding", W._v$5 = b1), P1 !== W._v$6 && u1.style.setProperty("transform", W._v$6 = P1), W;
        }, {
          _v$5: void 0,
          _v$6: void 0
        }), C;
...
const U1 = (e) => zd[e.name](e.class), qd = /* @__PURE__ */ b('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Gd = /* @__PURE__ */ b('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), W0 = /* @__PURE__ */ b('<li><span style="padding-left:8px"></span></li>'), X0 = "drawing_tools", Wd = (e) => {
  const [t, r] = w("horizontalStraightLine"), [n, a] = w("priceChannelLine"), [l, u] = w("circle"), [c, g] = w("fibonacciLine"), [$, f] = w("xabcd"), [k, x] = w("weak_magnet"), [S, P] = w("normal"), [O, H] = w(!1), [Q, E] = w(!0), [N, K] = w(""), G = Y(() => [{
    key: "singleLine",
    icon: t(),
    list: Qd(e.locale),
    setter: r
      ...
      return _($, L(At, {
        ...
        children: (f) => {
          ...
          return (() => {
            ...
            return _(P, () => f.text), _(O, k), B(() => S.classList.toggle("mobile-item", !!l())), S;
          })();
        }
...
const Ah = (e) => {
  ...
  let t, r = null, n;
  const [a, l] = w(!1), [u, c] = w(e.theme), [g, $] = w(e.styles), [f, k] = w(e.locale), [x, S] = w(e.symbol), [P, O] = w(e.period), [H, Q] = w(!1), [E, N] = w([...e.mainIndicators]), [K, G] = w({}), [S1, c1] = w(!1), [T1, j] = w({
    key: e.timezone,
    text: t9(e.timezone, e.locale)
  }), [X, R] = w(!1), [L1, Q1] = w(), [Z, V] = w(""), [g1, k1] = w(e.drawingBarVisible), [s1, x1] = w(!1), [C, U] = w(!1), [J, u1] = w(!1), W = ((i0 = e.orderTools) == null ? void 0 : i0.quickOrder) ?? !0, [b1, P1] = w({
    quickOrder: W,
  ...
  const yt = () => {
    ...
    }), D.clear(), y1.clear(), A1(null), N1(null), X1.loadDrawings(i).forEach((d) => {
      var h;
      try {
        const m = Ae({
          name: d.type,
    ...
    return (!s || ((h = _1()) == null ? void 0 : h.id) === s) && (A1(null), N1(null)), !1;
  }, Ae = (i) => {
  ...
  return Nt(() => {
    ...
    return i.addEventListener("mouseleave", () => {
      ...
      children: (d) => (() => {
        ...
        return h.$$click = (F) => {
        ...
        }, m.$$mousedown = r5, p.$$click = e5, v.$$click = () => N1(D1() === "color" ? null : "color"), _(y, L(z, {
          get when() {
            return D1() === "color";
          },
          get children() {
        ...
        }), null), M.$$click = () => N1(D1() === "width" ? null : "width"), _(q, () => d.lineSize, i1), _(A, L(z, {
          get when() {
            return D1() === "width";
          },
          get children() {
        ...
        }), null), f1.$$click = () => N1(D1() === "style" ? null : "style"), _(l1, L(z, {
          get when() {
            return D1() === "style";
          },
          get children() {
            const F = bh.cloneNode(!0), m1 = F.firstChild, a1 = m1.nextSibling, $1 = a1.nextSibling;
            return m1.$$click = () => mt(Z1.Solid, []), a1.$$click = () => mt(Z1.Dashed, [6, 4]), $1.$$click = () => mt(Z1.Dashed, [2, 4]), B((w1) => {
              var Te, Pe;
              ...
              return we !== w1._v$ && h1(m1, w1._v$ = we), Me !== w1._v$2 && h1(a1, w1._v$2 = Me), Se !== w1._v$3 && h1($1, w1._v$3 = Se), w1;
            }, {
              _v$: void 0,
              _v$2: void 0,
              _v$3: void 0
          ...
          const m1 = `${d.x}px`, a1 = `${d.y}px`, $1 = `overlay-toolbar-icon edit ${D1() === "color" ? "active" : ""}`, w1 = `overlay-toolbar-line-size ${D1() === "width" ? "active" : ""}`, we = `overlay-toolbar-icon minus ${D1() === "style" ? "active" : ""}`, Me = `overlay-toolbar-icon visibility ${d.visible ? "" : "muted"}`, Se = d.visible ? "Hide" : "Show", Te = `overlay-toolbar-icon lock ${d.locked ? "active" : ""}`, Pe = d.locked ? "Unlock" : "Lock";
          return m1 !== F._v$4 && h.style.setProperty("left", F._v$4 = m1), a1 !== F._v$5 && h.style.setProperty("top", F._v$5 = a1), $1 !== F._v$6 && h1(v, F._v$6 = $1), w1 !== F._v$7 && h1(M, F._v$7 = w1), we !== F._v$8 && h1(f1, F._v$8 = we), Me !== F._v$9 && h1(t1, F._v$9 = Me), Se !== F._v$10 && v1(t1, "title", F._v$10 = Se), Te !== F._v$11 && h1(B1, F._v$11 = Te), Pe !== F._v$12 && v1(B1, "title", F._v$12 = Pe), F;
        }, {
          _v$4: void 0,
          _v$5: void 0,
          _v$6: void 0,
      ...
      children: (d) => (() => {
        ...
        return m1.firstChild, h.addEventListener("mouseleave", () => I1(!1)), h.addEventListener("mouseenter", () => I1(!0)), m.$$mousemove = () => {
          ...
          const $1 = `${Math.max(0, d.y + 24)}px`, w1 = `${d.yAxisWidth + dt}px`;
          return $1 !== a1._v$16 && h.style.setProperty("top", a1._v$16 = $1), w1 !== a1._v$17 && h.style.setProperty("right", a1._v$17 = w1), a1;
        }, {
          _v$16: void 0,
          _v$17: void 0
        }), h;

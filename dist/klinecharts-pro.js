...
var N9 = (e, t, n) => t in e ? P9(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var Z1 = (e, t, n) => (N9(e, typeof t != "symbol" ? t + "" : t, n), n);
import { utils as z, OverlayMode as n0, init as E9, FormatDateType as W1, DomPosition as r0, ActionType as O9, dispose as a0, TooltipIconPosition as q1, CandleType as B9, YAxisType as U9, registerOverlay as K9 } from "klinecharts";
function z1(e, t, n) {
...
function we(e, t) {
  if (e.length > 1) {
    ...
    return e[0].x === e[1].x && e[0].y !== e[1].y ? e[0].y < e[1].y ? n = {
      ...
      x: 0,
      y: z.getLinearYFromCoordinates(e[0], e[1], { x: 0, y: e[0].y })
    } : n = {
      x: t.width,
      y: z.getLinearYFromCoordinates(e[0], e[1], { x: t.width, y: e[0].y })
    }, { coordinates: [e[0], n] };
  }
  return [];
}
...
const F9 = {
  ...
  createPointFigures: ({ coordinates: e }) => {
    if (e.length > 1) {
      const t = e[1].x > e[0].x ? 0 : 1, n = z.getLinearSlopeIntercept(e[0], e[1]);
      let r;
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    const r = [], a = [];
    if (e.length > 1) {
      const s = e[1].x > e[0].x ? e[0].x : e[1].x, l = [1, 0.786, 0.618, 0.5, 0.382, 0.236, 0], o = e[0].y - e[1].y, d = t.points, y = d[0].value - d[1].value;
      l.forEach((u) => {
        const g = e[1].y + o * u, L = (d[1].value + y * u).toFixed(n.price);
        r.push({ coordinates: [{ x: e[0].x, y: g }, { x: e[1].x, y: g }] }), a.push({
          x: s,
          y: g,
          text: `${L} (${(u * 100).toFixed(1)}%)`,
          baseline: "bottom"
        });
      });
    }
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = R0(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = z.getLinearSlopeIntercept(e[0], e[1]);
      let s;
      ...
      for (let g = 2; g < 9; g++) {
        ...
        switch (g % 4) {
          ...
          case 1: {
            A = s + Math.PI / 2, u -= d[g - 2].r;
            break;
          }
          case 2: {
            A = s + Math.PI, y += d[g - 2].r;
            break;
          }
          case 3: {
            A = s + Math.PI / 2 * 3, u += d[g - 2].r;
            break;
          }
        }
        const I = A + Math.PI / 2, D = z1({ x: y, y: u }, e[0], s);
        d.push({
          ...D,
          r: L,
          startAngle: A,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    const a = [];
    if (e.length > 1) {
      const s = e[1].x > e[0].x ? -38 : 4, l = e[1].y > e[0].y ? -2 : 20, o = e[1].x - e[0].x, d = e[1].y - e[0].y;
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((u) => {
        const g = e[1].x - o * u, L = e[1].y - d * u;
        n.push({ coordinates: [{ x: g, y: e[0].y }, { x: g, y: e[1].y }] }), n.push({ coordinates: [{ x: e[0].x, y: L }, { x: e[1].x, y: L }] }), r = r.concat(we([e[0], { x: g, y: e[1].y }], t)), r = r.concat(we([e[0], { x: e[1].x, y: L }], t)), a.unshift({
          x: e[0].x + s,
          y: L + 10,
          text: `${u.toFixed(3)}`
        }), a.unshift({
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    const r = [], a = [];
    if (e.length > 2) {
      const s = t.points, l = s[1].value - s[0].value, o = e[1].y - e[0].y, d = [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1], y = e[2].x > e[1].x ? e[1].x : e[2].x;
      d.forEach((u) => {
        const g = e[2].y + o * u, L = (s[2].value + l * u).toFixed(n.price);
...
const i5 = (e, t) => e === t, Me = Symbol("solid-proxy"), s5 = Symbol("solid-track"), ie = {
  equals: i5
};
let Y0 = J0;
const y1 = 1, se = 2, H0 = {
...
var X = null;
let $1 = null, Z = null, e1 = null, d1 = null, Oe = 0;
function re(e, t) {
  const n = Z, r = X, a = e.length === 0, s = a ? H0 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function o5(e, t, n) {
  ...
  let l = null, o = be, d = null, y = !1, u = "initialValue" in s, g = typeof r == "function" && R(r);
  const L = /* @__PURE__ */ new Set(), [A, I] = (s.storage || M)(s.initialValue), [D, E] = M(void 0), [P, K] = M(void 0, {
    equals: !1
  }), [T, x] = M(u ? "ready" : "unresolved");
  if (t1.context) {
    d = `${t1.context.id}${t1.context.count++}`;
    let O;
    s.ssrLoadFrom === "initial" ? o = s.initialValue : t1.load && (O = t1.load(d)) && (o = O[0]);
  }
  function w(O, Q, Y, u1) {
    return l === O && (l = null, u = !0, (O === o || Q === o) && s.onHydrated && queueMicrotask(() => s.onHydrated(u1, {
      value: Q
    })), o = be, N(Q, Y)), Q;
  }
  function N(O, Q) {
    p1(() => {
      Q === void 0 && I(() => O), x(Q !== void 0 ? "errored" : "ready"), E(Q);
  ...
  function q() {
    ...
    if (Y !== void 0 && !l)
      throw Y;
    return Z && !Z.user && O && i0(() => {
      P(), l && (O.resolved || L.has(O) || (O.increment(), L.add(O)));
    }), Q;
  }
  function a1(O = !0) {
    if (O !== !1 && y)
    ...
    const Y = o !== be ? o : f1(() => a(Q, {
      value: A(),
      refetching: O
    }));
    return typeof Y != "object" || !(Y && "then" in Y) ? (w(l, Y, void 0, Q), Y) : (l = Y, y = !0, queueMicrotask(() => y = !1), p1(() => {
      x(u ? "refreshing" : "pending"), K();
    }, !1), Y.then((u1) => w(Y, u1, void 0, Q), (u1) => w(Y, void 0, q0(u1), Q)));
  }
...
function X0(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && p1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      l && $1.disposed.has(s), (l && !s.tState || !l && !s.state) && (s.pure ? e1.push(s) : d1.push(s), s.observers && W0(s)), l || (s.state = y1);
    }
    if (e1.length > 1e6)
      throw e1 = [], new Error();
  }, !1)), t;
...
function ye(e, t, n, r = y1, a) {
  ...
  return X === null || X !== H0 && (X.owned ? X.owned.push(s) : X.owned = [s]), s;
}
function oe(e) {
  const t = $1;
  if (e.state === 0 || t)
...
function W0(e) {
  ...
  for (let n = 0; n < e.observers.length; n += 1) {
    ...
    (!r.state || t) && (r.state = se, r.pure ? e1.push(r) : d1.push(r), r.observers && W0(r));
  }
}
function he(e) {
  let t;
...
function y5(e, t, n = {}) {
  ...
  return Be(() => s0(s)), () => {
    let d = e() || [], y, u;
    return d[s5], f1(() => {
      let L = d.length, A, I, D, E, P, K, T, x, w;
      if (L === 0)
        l !== 0 && (s0(s), s = [], r = [], a = [], l = 0, o && (o = [])), n.fallback && (r = [f5], a[0] = re((N) => (s[0] = N, n.fallback())), l = 1);
      else if (l === 0) {
        for (a = new Array(L), u = 0; u < L; u++)
          r[u] = d[u], a[u] = re(g);
        l = L;
      } else {
        for (D = new Array(L), E = new Array(L), o && (P = new Array(L)), K = 0, T = Math.min(l, L); K < T && r[K] === d[K]; K++)
          ;
        for (T = l - 1, x = L - 1; T >= K && x >= K && r[T] === d[x]; T--, x--)
          D[x] = a[T], E[x] = s[T], o && (P[x] = o[T]);
        for (A = /* @__PURE__ */ new Map(), I = new Array(x + 1), u = x; u >= K; u--)
          w = d[u], y = A.get(w), I[u] = y === void 0 ? -1 : y, A.set(w, u);
        for (y = K; y <= T; y++)
          w = r[y], u = A.get(w), u !== void 0 && u !== -1 ? (D[u] = a[y], E[u] = s[y], o && (P[u] = o[y]), u = I[u], A.set(w, u)) : s[y]();
        for (u = K; u < L; u++)
          u in D ? (a[u] = D[u], s[u] = E[u], o && (o[u] = P[u], o[u](u))) : a[u] = re(g);
        a = a.slice(0, l = L), r = d.slice(0);
      }
      return a;
    });
    function g(L) {
...
function t9(...e) {
  ...
  for (let r = 0; r < e.length; r++) {
    const a = e[r];
    t = t || !!a && Me in a, e[r] = typeof a == "function" ? (t = !0, R(a)) : a;
  }
  if (t)
    return new Proxy({
      get(r) {
...
function g5(e) {
  ...
  return R(y5(() => e.each, e.children, t || void 0));
}
function W(e) {
  let t = !1;
...
function p5(e, t, n) {
  let r = n.length, a = t.length, s = r, l = 0, o = 0, d = t[a - 1].nextSibling, y = null;
  for (; l < a || o < s; ) {
    if (t[l] === n[o]) {
      l++, o++;
      continue;
    ...
    if (a === l) {
      ...
      if (u != null)
        if (o < u && u < s) {
          let g = l, L = 1, A;
          for (; ++g < a && g < s && !((A = y.get(t[g])) == null || A !== u + L); )
            L++;
          if (L > u - o) {
            const I = t[l];
            for (; o < u; )
              e.insertBefore(n[o++], I);
          } else
  ...
  if (e = l && n[0] && n[0].parentNode || e, s === "string" || s === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (o.length === 0) {
        ...
        d ? n.length === 0 ? c0(e, o, r) : p5(e, n, o) : (n && w1(e), c0(e, o));
      n = o;
  ...
  if (t.length) {
    ...
    for (let l = t.length - 1; l >= 0; l--) {
      ...
      if (a !== o) {
        ...
        !s && !l ? d ? e.replaceChild(a, o) : e.insertBefore(a, n) : d && o.remove();
      } else
        s = !0;
    }
  } else
...
var _5 = typeof te == "object" && te && te.Object === Object && te, r9 = _5, $5 = r9, L5 = typeof self == "object" && self && self.Object === Object && self, b5 = $5 || L5 || Function("return this")(), l1 = b5, x5 = l1, k5 = x5.Symbol, ge = k5, l0 = ge, a9 = Object.prototype, A5 = a9.hasOwnProperty, w5 = a9.toString, Q1 = l0 ? l0.toStringTag : void 0;
function M5(e) {
...
var P5 = D5, u0 = ge, N5 = S5, E5 = P5, O5 = "[object Null]", B5 = "[object Undefined]", C0 = u0 ? u0.toStringTag : void 0;
function U5(e) {
...
var i9 = Y5, H5 = l1, V5 = H5["__core-js_shared__"], G5 = V5, ke = G5, d0 = function() {
...
var s9 = e6, t6 = i9, n6 = J5, r6 = T1, a6 = s9, i6 = /[\\^$.*+?()[\]{}|]/g, s6 = /^\[object .+?Constructor\]$/, o6 = Function.prototype, c6 = Object.prototype, l6 = o6.toString, u6 = c6.hasOwnProperty, C6 = RegExp(
...
var Ue = M6, S6 = Array.isArray, I1 = S6;
function T6(e) {
  return e != null && typeof e == "object";
}
var D1 = T6, I6 = Y1, D6 = D1, P6 = "[object Symbol]";
function N6(e) {
  return typeof e == "symbol" || D6(e) && I6(e) == P6;
}
var Ke = N6, E6 = I1, O6 = Ke, B6 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, U6 = /^\w*$/;
function K6(e, t) {
  if (E6(e))
    return !1;
  var n = typeof e;
...
var F6 = K6, j6 = b1, Z6 = j6(Object, "create"), pe = Z6, y0 = pe;
function Q6() {
...
var ot = st, ct = z6, lt = Y6, ut = W6, Ct = rt, dt = ot;
function P1(e) {
...
P1.prototype.clear = ct;
P1.prototype.delete = lt;
P1.prototype.get = ut;
P1.prototype.has = Ct;
P1.prototype.set = dt;
var ft = P1;
...
var me = pt, mt = me, vt = Array.prototype, _t = vt.splice;
function $t(e) {
...
var It = Tt, Dt = ht, Pt = Lt, Nt = kt, Et = Mt, Ot = It;
function N1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
N1.prototype.clear = Dt;
N1.prototype.delete = Pt;
N1.prototype.get = Nt;
N1.prototype.has = Et;
N1.prototype.set = Ot;
var ve = N1, Bt = b1, Ut = l1, Kt = Bt(Ut, "Map"), Fe = Kt, h0 = ft, Ft = ve, jt = Fe;
function Zt() {
...
E1.prototype.has = l2;
E1.prototype.set = u2;
var l9 = E1, u9 = l9, C2 = "Expected a function";
function je(e, t) {
  ...
  return n.cache = new (je.Cache || u9)(), n;
}
je.Cache = u9;
var d2 = je, f2 = d2, y2 = 500;
function h2(e) {
...
var g2 = h2, p2 = g2, m2 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, v2 = /\\(\\)?/g, _2 = p2(function(e) {
  var t = [];
...
var b2 = L2, g0 = ge, x2 = b2, k2 = I1, A2 = Ke, w2 = 1 / 0, p0 = g0 ? g0.prototype : void 0, m0 = p0 ? p0.toString : void 0;
function C9(e) {
  if (typeof e == "string")
    return e;
  if (k2(e))
...
var I2 = T2, D2 = I1, P2 = F6, N2 = $2, E2 = I2;
function O2(e, t) {
  return D2(e) ? e : P2(e, t) ? [e] : N2(E2(e));
}
...
var z2 = Q2, R2 = Ue, Y2 = B2, H2 = d9, v0 = T1, V2 = z2;
function G2(e, t, n, r) {
  if (!v0(e))
    return e;
  t = Y2(t, e);
  for (var a = -1, s = t.length, l = s - 1, o = e; o != null && ++a < s; ) {
    ...
    if (a != l) {
      var u = o[d];
      y = r ? r(u, d, o) : void 0, y === void 0 && (y = v0(u) ? u : H2(t[a + 1]) ? [] : {});
    }
    R2(o, d, y), o = o[d];
  }
  return e;
...
var c3 = o3, l3 = ve, u3 = Fe, C3 = l9, d3 = 200;
function f3(e, t) {
  var n = this.__data__;
  if (n instanceof l3) {
    var r = n.__data__;
...
var y3 = f3, h3 = ve, g3 = n3, p3 = a3, m3 = s3, v3 = c3, _3 = y3;
function O1(e) {
  var t = this.__data__ = new h3(e);
  this.size = t.size;
}
O1.prototype.clear = g3;
O1.prototype.delete = p3;
O1.prototype.get = m3;
O1.prototype.has = v3;
O1.prototype.set = _3;
var $3 = O1;
...
var M3 = w3, S3 = Y1, T3 = D1, I3 = "[object Arguments]";
function D3(e) {
  return T3(e) && S3(e) == I3;
}
var P3 = D3, _0 = P3, N3 = D1, f9 = Object.prototype, E3 = f9.hasOwnProperty, O3 = f9.propertyIsEnumerable, B3 = _0(function() {
  return arguments;
}()) ? _0 : function(e) {
...
ue.exports;
(function(e, t) {
  var n = l1, r = F3, a = t && !t.nodeType && t, s = a && !0 && e && !e.nodeType && e, l = s && s.exports === a, o = l ? n.Buffer : void 0, d = o ? o.isBuffer : void 0, y = d || r;
  e.exports = y;
})(ue, ue.exports);
...
var h9 = Z3, Q3 = Y1, z3 = h9, R3 = D1, Y3 = "[object Arguments]", H3 = "[object Array]", V3 = "[object Boolean]", G3 = "[object Date]", X3 = "[object Error]", J3 = "[object Function]", W3 = "[object Map]", q3 = "[object Number]", e8 = "[object Object]", t8 = "[object RegExp]", n8 = "[object Set]", r8 = "[object String]", a8 = "[object WeakMap]", i8 = "[object ArrayBuffer]", s8 = "[object DataView]", o8 = "[object Float32Array]", c8 = "[object Float64Array]", l8 = "[object Int8Array]", u8 = "[object Int16Array]", C8 = "[object Int32Array]", d8 = "[object Uint8Array]", f8 = "[object Uint8ClampedArray]", y8 = "[object Uint16Array]", h8 = "[object Uint32Array]", j = {};
j[o8] = j[c8] = j[l8] = j[u8] = j[C8] = j[d8] = j[f8] = j[y8] = j[h8] = !0;
...
var Qe = Ce.exports, v8 = p8, _8 = Ze, $0 = Qe, L0 = $0 && $0.isTypedArray, $8 = L0 ? _8(L0) : v8, L8 = $8, b8 = M3, x8 = U3, k8 = I1, A8 = y9, w8 = d9, M8 = L8, S8 = Object.prototype, T8 = S8.hasOwnProperty;
function I8(e, t) {
  var n = k8(e), r = !n && x8(e), a = !n && !r && A8(e), s = !n && !r && !a && M8(e), l = n || r || a || s, o = l ? b8(e.length, String) : [], d = o.length;
  for (var y in e)
    (t || T8.call(e, y)) && !(l && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var p9 = N8, E8 = p9, O8 = E8(Object.keys, Object), B8 = O8, U8 = ze, K8 = B8, F8 = Object.prototype, j8 = F8.hasOwnProperty;
function Z8(e) {
  if (!U8(e))
    return K8(e);
  var t = [];
...
var m9 = Y8, H8 = g9, V8 = Q8, G8 = m9;
function X8(e) {
  return G8(e) ? H8(e) : V8(e);
}
var Re = X8, J8 = $e, W8 = Re;
function q8(e, t) {
...
var n7 = t7, r7 = T1, a7 = ze, i7 = n7, s7 = Object.prototype, o7 = s7.hasOwnProperty;
function c7(e) {
  if (!r7(e))
    return i7(e);
  var t = a7(e), n = [];
...
var l7 = c7, u7 = g9, C7 = l7, d7 = m9;
function f7(e) {
  return d7(e) ? u7(e, !0) : C7(e);
}
var Ye = f7, y7 = $e, h7 = Ye;
function g7(e, t) {
  return e && y7(t, h7(t), e);
}
var p7 = g7, de = { exports: {} };
de.exports;
(function(e, t) {
  ...
  function d(y, u) {
    if (u)
      return y.slice();
    var g = y.length, L = o ? o(g) : new y.constructor(g);
    return y.copy(L), L;
  }
  e.exports = d;
})(de, de.exports);
...
var v9 = b7, x7 = L7, k7 = v9, A7 = Object.prototype, w7 = A7.propertyIsEnumerable, b0 = Object.getOwnPropertySymbols, M7 = b0 ? function(e) {
  return e == null ? [] : (e = Object(e), x7(b0(e), function(t) {
    return w7.call(e, t);
  }));
} : k7, He = M7, S7 = $e, T7 = He;
function I7(e, t) {
...
var _9 = P7, N7 = p9, E7 = N7(Object.getPrototypeOf, Object), $9 = E7, O7 = _9, B7 = $9, U7 = He, K7 = v9, F7 = Object.getOwnPropertySymbols, j7 = F7 ? function(e) {
  for (var t = []; e; )
    O7(t, U7(e)), e = B7(e);
  return t;
} : K7, L9 = j7, Z7 = $e, Q7 = L9;
...
var b9 = V7, G7 = b9, X7 = He, J7 = Re;
function W7(e) {
  return G7(e, J7, X7);
}
var q7 = W7, en = b9, tn = L9, nn = Ye;
function rn(e) {
  return en(e, nn, tn);
}
var an = rn, sn = b1, on = l1, cn = sn(on, "DataView"), ln = cn, un = b1, Cn = l1, dn = un(Cn, "Promise"), fn = dn, yn = b1, hn = l1, gn = yn(hn, "Set"), pn = gn, mn = b1, vn = l1, _n = mn(vn, "WeakMap"), $n = _n, Ie = ln, De = Fe, Pe = fn, Ne = pn, Ee = $n, x9 = Y1, B1 = s9, x0 = "[object Map]", Ln = "[object Object]", k0 = "[object Promise]", A0 = "[object Set]", w0 = "[object WeakMap]", M0 = "[object DataView]", bn = B1(Ie), xn = B1(De), kn = B1(Pe), An = B1(Ne), wn = B1(Ee), _1 = x9;
(Ie && _1(new Ie(new ArrayBuffer(1))) != M0 || De && _1(new De()) != x0 || Pe && _1(Pe.resolve()) != k0 || Ne && _1(new Ne()) != A0 || Ee && _1(new Ee()) != w0) && (_1 = function(e) {
...
var Ve = _1, Mn = Object.prototype, Sn = Mn.hasOwnProperty;
function Tn(e) {
  var t = e.length, n = new e.constructor(t);
  return t && typeof e[0] == "string" && Sn.call(e, "index") && (n.index = e.index, n.input = e.input), n;
}
var In = Tn, Dn = l1, Pn = Dn.Uint8Array, Nn = Pn, S0 = Nn;
function En(e) {
...
var jn = Fn, T0 = ge, I0 = T0 ? T0.prototype : void 0, D0 = I0 ? I0.valueOf : void 0;
function Zn(e) {
...
var Yn = Rn, Hn = Ge, Vn = Un, Gn = jn, Xn = Qn, Jn = Yn, Wn = "[object Boolean]", qn = "[object Date]", er = "[object Map]", tr = "[object Number]", nr = "[object RegExp]", rr = "[object Set]", ar = "[object String]", ir = "[object Symbol]", sr = "[object ArrayBuffer]", or = "[object DataView]", cr = "[object Float32Array]", lr = "[object Float64Array]", ur = "[object Int8Array]", Cr = "[object Int16Array]", dr = "[object Int32Array]", fr = "[object Uint8Array]", yr = "[object Uint8ClampedArray]", hr = "[object Uint16Array]", gr = "[object Uint32Array]";
function pr(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case sr:
...
var mr = pr, vr = T1, P0 = Object.create, _r = function() {
  function e() {
  }
  return function(t) {
    if (!vr(t))
...
}(), $r = _r, Lr = $r, br = $9, xr = ze;
function kr(e) {
  return typeof e.constructor == "function" && !xr(e) ? Lr(br(e)) : {};
}
var Ar = kr, wr = Ve, Mr = D1, Sr = "[object Map]";
function Tr(e) {
  return Mr(e) && wr(e) == Sr;
}
var Ir = Tr, Dr = Ir, Pr = Ze, N0 = Qe, E0 = N0 && N0.isMap, Nr = E0 ? Pr(E0) : Dr, Er = Nr, Or = Ve, Br = D1, Ur = "[object Set]";
function Kr(e) {
  return Br(e) && Or(e) == Ur;
}
var Fr = Kr, jr = Fr, Zr = Ze, O0 = Qe, B0 = O0 && O0.isSet, Qr = B0 ? Zr(B0) : jr, zr = Qr, Rr = $3, Yr = b3, Hr = Ue, Vr = e7, Gr = p7, Xr = m7, Jr = _7, Wr = D7, qr = R7, e4 = q7, t4 = an, n4 = Ve, r4 = In, a4 = mr, i4 = Ar, s4 = I1, o4 = y9, c4 = Er, l4 = T1, u4 = zr, C4 = Re, d4 = Ye, f4 = 1, y4 = 2, h4 = 4, k9 = "[object Arguments]", g4 = "[object Array]", p4 = "[object Boolean]", m4 = "[object Date]", v4 = "[object Error]", A9 = "[object Function]", _4 = "[object GeneratorFunction]", $4 = "[object Map]", L4 = "[object Number]", w9 = "[object Object]", b4 = "[object RegExp]", x4 = "[object Set]", k4 = "[object String]", A4 = "[object Symbol]", w4 = "[object WeakMap]", M4 = "[object ArrayBuffer]", S4 = "[object DataView]", T4 = "[object Float32Array]", I4 = "[object Float64Array]", D4 = "[object Int8Array]", P4 = "[object Int16Array]", N4 = "[object Int32Array]", E4 = "[object Uint8Array]", O4 = "[object Uint8ClampedArray]", B4 = "[object Uint16Array]", U4 = "[object Uint32Array]", F = {};
F[k9] = F[g4] = F[M4] = F[S4] = F[p4] = F[m4] = F[T4] = F[I4] = F[D4] = F[P4] = F[N4] = F[$4] = F[L4] = F[w9] = F[b4] = F[x4] = F[k4] = F[A4] = F[E4] = F[O4] = F[B4] = F[U4] = !0;
F[v4] = F[A9] = F[w4] = !1;
function ae(e, t, n, r, a, s) {
  var l, o = t & f4, d = t & y4, y = t & h4;
  ...
  if (u) {
    ...
    var g = n4(e), L = g == A9 || g == _4;
    if (o4(e))
      return Xr(e, o);
    if (g == w9 || g == k9 || L && !a) {
      if (l = d || L ? {} : i4(e), !o)
        return d ? qr(e, Gr(l, e)) : Wr(e, Vr(l, e));
    } else {
      if (!F[g])
        return a ? e : {};
      l = a4(e, g, o);
  ...
  if (A)
    return A;
  s.set(e, l), u4(e) ? e.forEach(function(E) {
    l.add(ae(E, t, n, E, e, s));
  }) : c4(e) && e.forEach(function(E, P) {
    l.set(P, ae(E, t, n, P, e, s));
  });
  var I = y ? d ? t4 : e4 : d ? d4 : C4, D = u ? void 0 : I(e);
  return Yr(D || e, function(E, P) {
    D && (P = E, E = e[P]), Hr(l, P, ae(E, t, n, P, e, s));
  }), l;
}
...
var z4 = Q4;
const R4 = /* @__PURE__ */ n9(z4), Y4 = /* @__PURE__ */ p("<button></button>"), H4 = (e) => (() => {
  const t = Y4.cloneNode(!0);
  return g1(t, "click", e.onClick, !0), _(t, () => e.children), V((n) => {
...
c1(["click"]);
const V4 = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), G4 = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), X4 = /* @__PURE__ */ p("<div></div>"), J4 = /* @__PURE__ */ p('<span class="label"></span>'), W4 = () => V4.cloneNode(!0), q4 = () => G4.cloneNode(!0), U0 = (e) => {
  ...
  return C1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a._v$ = S1(r, s, a._v$), l !== a._v$2 && L1(r, a._v$2 = l), a;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
...
const ea = /* @__PURE__ */ p('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), M9 = () => ea.cloneNode(!0), ta = /* @__PURE__ */ p('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), na = () => ta.cloneNode(!0), ra = /* @__PURE__ */ p("<ul></ul>"), aa = /* @__PURE__ */ p("<li></li>"), fe = (e) => (() => {
  ...
  return _(r, () => e.title, a), g1(a, "click", e.onClose, !0), _(s, () => e.children), _(n, (() => {
    ...
    return () => l() && (() => {
      ...
      return _(o, () => e.buttons.map((d) => m(H4, t9(d, {
        get children() {
          return d.children;
        }
      })))), o;
    })();
  })(), null), V(() => n.style.setProperty("width", `${e.width ?? 400}px`)), t;
})();
c1(["click"]);
const oa = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ca = /* @__PURE__ */ p('<div class="drop-down-container"> <ul></ul></div>'), la = /* @__PURE__ */ p('<div><input type="text"></div>'), ua = /* @__PURE__ */ p("<li></li>"), S9 = (e) => {
  const [t, n] = M(!1), [r, a] = M("");
  let s, l;
  const o = R(() => {
    ...
    return u ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((L) => L.toLowerCase().includes(u)) : e.dataSource.filter((L) => {
      var D, E;
      const A = ((D = L.text) == null ? void 0 : D.toString().toLowerCase()) || "", I = ((E = L.key) == null ? void 0 : E.toLowerCase()) || "";
      return A.includes(u) || I.includes(u);
    }) : e.dataSource;
  }), d = () => {
    n(!0), a(""), e.searchable && setTimeout(() => s == null ? void 0 : s.focus(), 10);
  }, y = (u) => {
    const g = u.relatedTarget;
    l && g && l.contains(g) || (n(!1), a(""));
  };
  return (() => {
    const u = oa.cloneNode(!0), g = u.firstChild, L = g.firstChild;
    u.addEventListener("blur", y), u.$$click = (I) => {
      t() || d();
    };
    const A = l;
    return typeof A == "function" ? R1(A, u) : l = u, _(L, () => e.value), _(u, (() => {
      const I = R(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => I() && (() => {
        const D = ca.cloneNode(!0), E = D.firstChild, P = E.nextSibling;
        return D.$$mousedown = (K) => K.preventDefault(), _(D, (() => {
          const K = R(() => !!e.searchable);
          return () => K() && (() => {
            const T = la.cloneNode(!0), x = T.firstChild;
            T.style.setProperty("padding", "8px"), T.style.setProperty("border-bottom", "1px solid #333"), x.$$click = (N) => N.stopPropagation(), x.$$input = (N) => a(N.currentTarget.value);
            const w = s;
            return typeof w == "function" ? R1(w, x) : s = x, x.style.setProperty("width", "100%"), x.style.setProperty("padding", "6px 10px"), x.style.setProperty("border", "1px solid #333"), x.style.setProperty("border-radius", "4px"), x.style.setProperty("background-color", "#1a1a1a"), x.style.setProperty("color", "#fff"), x.style.setProperty("font-size", "13px"), x.style.setProperty("outline", "none"), V(() => r1(x, "placeholder", e.searchPlaceholder || "Search...")), V(() => x.value = r()), T;
          })();
        })(), P), _(P, () => {
          var K;
          return (K = o()) == null ? void 0 : K.map((T) => {
            const w = T[e.valueKey ?? "text"] ?? T;
            return (() => {
              const N = ua.cloneNode(!0);
              return N.$$click = (q) => {
                var a1;
                q.stopPropagation(), e.value !== w && ((a1 = e.onSelected) == null || a1.call(e, T)), n(!1), a("");
              }, _(N, w), N;
            })();
          });
        }), D;
      ...
      const D = e.style, E = `klinecharts-pro-select ${e.class ?? ""} ${t() ? "klinecharts-pro-select-show" : ""}`;
      return I._v$ = S1(u, D, I._v$), E !== I._v$2 && L1(u, I._v$2 = E), I;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), u;
...
const Ca = /* @__PURE__ */ p('<span class="prefix"></span>'), da = /* @__PURE__ */ p('<span class="suffix"></span>'), fa = /* @__PURE__ */ p('<div><input class="value"></div>'), T9 = (e) => {
  const t = t9({
  ...
  return (() => {
    ...
    return s.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        L <= 0 ? g = new RegExp(/^[1-9]\d*$/) : g = new RegExp("^\\d+\\.?\\d{0," + L + "}$"), (d === "" || g.test(d) && +d >= t.min && +d <= t.max) && ((y = t.onChange) == null || y.call(t, d === "" ? d : +d));
      } else
      ...
      const d = t.style, y = `klinecharts-pro-input ${t.class ?? ""}`, u = r(), g = t.placeholder ?? "";
      return o._v$ = S1(s, d, o._v$), y !== o._v$2 && L1(s, o._v$2 = y), u !== o._v$3 && r1(s, "data-status", o._v$3 = u), g !== o._v$4 && r1(l, "placeholder", o._v$4 = g), o;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
c1(["click"]);
const ya = /* @__PURE__ */ p('<div><i class="thumb"></i></div>'), ha = (e) => (() => {
...
const ga = "指标", pa = "主图指标", ma = "副图指标", va = "设置", _a = "时区", $a = "截屏", La = "全屏", ba = "退出全屏", xa = "保存", ka = "确定", Aa = "取消", wa = "MA(移动平均线)", Ma = "EMA(指数平滑移动平均线)", Sa = "SMA", Ta = "BOLL(布林线)", Ia = "BBI(多空指数)", Da = "SAR(停损点指向指标)", Pa = "VOL(成交量)", Na = "MACD(指数平滑异同移动平均线)", Ea = "KDJ(随机指标)", Oa = "RSI(相对强弱指标)", Ba = "BIAS(乖离率)", Ua = "BRAR(情绪指标)", Ka = "CCI(顺势指标)", Fa = "DMI(动向指标)", ja = "CR(能量指标)", Za = "PSY(心理线)", Qa = "DMA(平行线差指标)", za = "TRIX(三重指数平滑平均线)", Ra = "OBV(能量潮指标)", Ya = "VR(成交量变异率)", Ha = "WR(威廉指标)", Va = "MTM(动量指标)", Ga = "EMV(简易波动指标)", Xa = "ROC(变动率指标)", Ja = "PVT(价量趋势指标)", Wa = "AO(动量震荡指标)", qa = "世界统一时间", ei = "(UTC-10) 檀香山", ti = "(UTC-8) 朱诺", ni = "(UTC-7) 洛杉矶", ri = "(UTC-5) 芝加哥", ai = "(UTC-4) 多伦多", ii = "(UTC-3) 圣保罗", si = "(UTC+1) 伦敦", oi = "(UTC+2) 柏林", ci = "(UTC+3) 巴林", li = "(UTC+4) 迪拜", ui = "(UTC+5) 阿什哈巴德", Ci = "(UTC+6) 阿拉木图", di = "(UTC+7) 曼谷", fi = "(UTC+8) 上海", yi = "(UTC+9) 东京", hi = "(UTC+10) 悉尼", gi = "(UTC+12) 诺福克岛", pi = "水平直线", mi = "水平射线", vi = "水平线段", _i = "垂直直线", $i = "垂直射线", Li = "垂直线段", bi = "直线", xi = "射线", ki = "线段", Ai = "箭头", wi = "价格线", Mi = "价格通道线", Si = "平行直线", Ti = "斐波那契回调直线", Ii = "斐波那契回调线段", Di = "斐波那契圆环", Pi = "斐波那契螺旋", Ni = "斐波那契速度阻力扇", Ei = "斐波那契趋势扩展", Oi = "江恩箱", Bi = "矩形", Ui = "平行四边形", Ki = "圆", Fi = "三角形", ji = "三浪", Zi = "五浪", Qi = "八浪", zi = "任意浪", Ri = "ABCD形态", Yi = "XABCD形态", Hi = "弱磁模式", Vi = "强磁模式", Gi = "商品搜索", Xi = "商品代码", Ji = "参数1", Wi = "参数2", qi = "参数3", es = "参数4", ts = "参数5", ns = "周期", rs = "标准差", as = "蜡烛图类型", is = "全实心", ss = "全空心", os = "涨空心", cs = "跌空心", ls = "OHLC", us = "面积图", Cs = "最新价显示", ds = "最高价显示", fs = "最低价显示", ys = "指标最新值显示", hs = "价格轴类型", gs = "线性轴", ps = "百分比轴", ms = "对数轴", vs = "倒置坐标", _s = "网格线显示", $s = "恢复默认", Ls = {
  ...
  grid_show: _s,
  restore_default: $s
}, bs = "Indicator", xs = "Main Indicator", ks = "Sub Indicator", As = "Setting", ws = "Timezone", Ms = "Screenshot", Ss = "Full Screen", Ts = "Exit", Is = "Save", Ds = "Confirm", Ps = "Cancel", Ns = "MA(Moving Average)", Es = "EMA(Exponential Moving Average)", Os = "SMA", Bs = "BOLL(Bolinger Bands)", Us = "BBI(Bull And Bearlndex)", Ks = "SAR(Stop and Reverse)", Fs = "VOL(Volume)", js = "MACD(Moving Average Convergence / Divergence)", Zs = "KDJ(KDJ Index)", Qs = "RSI(Relative Strength Index)", zs = "BIAS(Bias Ratio)", Rs = "BRAR(情绪指标)", Ys = "CCI(Commodity Channel Index)", Hs = "DMI(Directional Movement Index)", Vs = "CR(能量指标)", Gs = "PSY(Psychological Line)", Xs = "DMA(Different of Moving Average)", Js = "TRIX(Triple Exponentially Smoothed Moving Average)", Ws = "OBV(On Balance Volume)", qs = "VR(Volatility Volume Ratio)", eo = "WR(Williams %R)", to = "MTM(Momentum Index)", no = "EMV(Ease of Movement Value)", ro = "ROC(Price Rate of Change)", ao = "PVT(Price and Volume Trend)", io = "AO(Awesome Oscillator)", so = "UTC", oo = "(UTC-10) Honolulu", co = "(UTC-8) Juneau", lo = "(UTC-7) Los Angeles", uo = "(UTC-5) Chicago", Co = "(UTC-4) Toronto", fo = "(UTC-3) Sao Paulo", yo = "(UTC+1) London", ho = "(UTC+2) Berlin", go = "(UTC+3) Bahrain", po = "(UTC+4) Dubai", mo = "(UTC+5) Ashkhabad", vo = "(UTC+6) Almaty", _o = "(UTC+7) Bangkok", $o = "(UTC+8) Shanghai", Lo = "(UTC+9) Tokyo", bo = "(UTC+10) Sydney", xo = "(UTC+12) Norfolk", ko = "Horizontal Line", Ao = "Horizontal Ray", wo = "Horizontal Segment", Mo = "Vertical Line", So = "Vertical Ray", To = "Vertical Segment", Io = "Trend Line", Do = "Ray", Po = "Segment", No = "Arrow", Eo = "Price Line", Oo = "Price Channel Line", Bo = "Parallel Line", Uo = "Fibonacci Line", Ko = "Fibonacci Segment", Fo = "Fibonacci Circle", jo = "Fibonacci Spiral", Zo = "Fibonacci Sector", Qo = "Fibonacci Extension", zo = "Gann Box", Ro = "Rect", Yo = "Parallelogram", Ho = "Circle", Vo = "Triangle", Go = "Three Waves", Xo = "Five Waves", Jo = "Eight Waves", Wo = "Any Waves", qo = "ABCD Pattern", ec = "XABCD Pattern", tc = "Weak Magnet", nc = "Strong Magnet", rc = "Symbol Search", ac = "Symbol Code", ic = "Parameter 1", sc = "Parameter 2", oc = "Parameter 3", cc = "Parameter 4", lc = "Parameter 5", uc = "Period", Cc = "Standard Deviation", dc = "Candle Type", fc = "Candle Solid", yc = "Candle Stroke", hc = "Candle Up Stroke", gc = "Candle Down Stroke", pc = "OHLC", mc = "Area", vc = "Show Last Price", _c = "Show Highest Price", $c = "Show Lowest Price", Lc = "Show indicator's last value", bc = "Price Axis Type", xc = "Normal", kc = "Percentage", Ac = "Log", wc = "Reverse Coordinate", Mc = "Show Grids", Sc = "Restore Defaults", Tc = {
  indicator: bs,
  main_indicator: xs,
  sub_indicator: ks,
  setting: As,
...
const i = (e, t) => {
  ...
  return V0(() => {
    ...
    const s = Pc.cloneNode(!0), l = s.firstChild, o = l.firstChild, d = l.nextSibling, y = d.firstChild, u = y.nextSibling, g = d.nextSibling, L = g.firstChild, A = L.nextSibling, I = g.nextSibling, D = I.firstChild, E = D.nextSibling, P = I.nextSibling, K = P.firstChild, T = K.nextSibling, x = P.nextSibling;
    return R1((w) => {
      t = w;
    }, s), g1(o, "click", e.onMenuClick, !0), _(s, m(W, {
      get when() {
        return e.symbol;
      },
      get children() {
        const w = Dc.cloneNode(!0), N = w.firstChild;
        return g1(w, "click", e.onSymbolClick, !0), _(w, m(W, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const q = Ic.cloneNode(!0);
            return V(() => r1(q, "src", e.symbol.logo)), q;
          }
        }), N), _(N, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), w;
      }
    }), d), _(s, () => e.periods.map((w) => (() => {
      const N = Ae.cloneNode(!0);
      return N.$$click = () => {
        e.onPeriodChange(w);
      }, _(N, () => w.text), V(() => L1(N, `item period ${w.text === e.period.text ? "selected" : ""}`)), N;
    })()), d), g1(d, "click", e.onIndicatorClick, !0), _(u, () => i("indicator", e.locale)), g1(g, "click", e.onTimezoneClick, !0), _(A, () => i("timezone", e.locale)), g1(I, "click", e.onSettingClick, !0), _(E, () => i("setting", e.locale)), g1(P, "click", e.onScreenshotClick, !0), _(T, () => i("screenshot", e.locale)), x.$$click = () => {
      if (n())
...
const Bc = /* @__PURE__ */ p('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M12.41465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L12.41465,12C12.20873,12.5826,11.65311,13,11,13C10.34689,13,9.79127,12.5826,9.58535,12L3.5,12C3.223857,12,3,11.77614,3,11.5C3,11.22386,3.223857,11,3.5,11L9.58535,11C9.79127,10.417404,10.34689,10,11,10C11.65311,10,12.20873,10.417404,12.41465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), Uc = () => Bc.cloneNode(!0), Kc = /* @__PURE__ */ p('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465,11L11.08535,11C11.29127,10.417404,11.84689,10,12.5,10C13.15311,10,13.70873,10.417404,13.91465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L13.91465,12C13.70873,12.5826,13.15311,13,12.5,13C11.84689,13,11.29127,12.5826,11.08535,12L6.91465,12C6.70873,12.5826,6.15311,13,5.5,13C4.671573,13,4,12.32843,4,11.5C4,10.671573,4.671573,10,5.5,10C6.15311,10,6.70873,10.417404,6.91465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), Fc = () => Kc.cloneNode(!0), jc = /* @__PURE__ */ p('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465,12.5C6.70873,13.0826,6.15311,13.5,5.5,13.5C4.671573,13.5,4,12.82843,4,12C4,11.171573,4.671573,10.5,5.5,10.5C6.15311,10.5,6.70873,10.917404,6.91465,11.5L16.0853,11.5C16.2913,10.917404,16.846899999999998,10.5,17.5,10.5C18.328400000000002,10.5,19,11.171573,19,12C19,12.82843,18.328400000000002,13.5,17.5,13.5C16.846899999999998,13.5,16.2913,13.0826,16.0853,12.5L6.91465,12.5Z" stroke-opacity="0" stroke="none"></path></svg>'), Zc = () => jc.cloneNode(!0), Qc = /* @__PURE__ */ p('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M11,12.41465L11,18.5C11,18.7761,11.22386,19,11.5,19C11.77614,19,12,18.7761,12,18.5L12,12.41465C12.5826,12.20873,13,11.65311,13,11C13,10.34689,12.5826,9.79127,12,9.58535L12,3.5C12,3.223857,11.77614,3,11.5,3C11.22386,3,11,3.223857,11,3.5L11,9.58535C10.417404,9.79127,10,10.34689,10,11C10,11.65311,10.417404,12.20873,11,12.41465Z" stroke-opacity="0" stroke="none"></path></svg>'), zc = () => Qc.cloneNode(!0), Rc = /* @__PURE__ */ p('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M11.66558837890625,19C10.83716137890625,19,10.16558837890625,18.328400000000002,10.16558837890625,17.5C10.16558837890625,16.846899999999998,10.58298437890625,16.2913,11.16557337890625,16.0854L11.16557337890625,11.91464C10.58298437890625,11.70872,10.16558837890625,11.1531,10.16558837890625,10.5C10.16558837890625,9.8469,10.58298437890625,9.29128,11.16557337890625,9.08536L11.16557337890625,4.5C11.16557337890625,4.223857,11.38942837890625,4,11.66556837890625,4C11.94171837890625,4,12.16556837
638671875,8.007996215820313ZM12.172299638671875,5.662106215820312L10.323809638671875,3.8136162158203124L5.4287196386718755,8.709096215820313C3.422893638671875,10.714536215820312,3.4549956386718748,14.055196215820313,5.484999638671875,16.08479621582031C7.514609638671875,18.114796215820313,10.855289638671875,18.146496215820314,12.860719638671876,16.141096215820312L15.465629638671874,13.535796215820312L14.090929638671875,12.160756215820312L14.791629638671875,11.460436215820312L16.166229638671876,12.834996215820313L17.755829638671877,11.245226215820313L15.907729638671874,9.396736215820312L11.011839638671875,14.292596215820312C10.042809638671875,15.262396215820312,8.418249638671874,15.243796215820312,7.406019638671875,14.306496215820312L7.333099638671875,14.236296215820312C6.327599638671876,13.230796215820313,6.284009638671876,11.550396215820312,7.276419638671875,10.557586215820312L9.882199638671874,7.952026215820313L8.501079638671875,6.570906215820313L9.201789638671876,5.870186215820313L10.582939638671874,7.251336215820312L12.172299638671875,5.662106215820312Z" stroke-opacity="0" fill-rule="evenodd" fill-opacity="1"></path></svg>'), zl = (e) => (() => {
  ...
  fibonacciCircle: yl,
  fibonacciSpiral: gl,
  fibonacciSpeedResistanceFan: ml,
...
const i1 = (e) => ru[e.name](e.class), uu = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Cu = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), K0 = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), F0 = "drawing_tools", du = (e) => {
  const [t, n] = M("horizontalStraightLine"), [r, a] = M("priceChannelLine"), [s, l] = M("circle"), [o, d] = M("fibonacciLine"), [y, u] = M("xabcd"), [g, L] = M("weak_magnet"), [A, I] = M("normal"), [D, E] = M(!1), [P, K] = M(!0), [T, x] = M(""), w = R(() => [{
    key: "singleLine",
    icon: t(),
    list: au(e.locale),
    setter: n
  ...
  return (() => {
    const q = uu.cloneNode(!0), a1 = q.firstChild, O = a1.nextSibling, Q = O.firstChild, Y = Q.nextSibling, u1 = Y.firstChild, K1 = O.nextSibling, F1 = K1.firstChild, m1 = K1.nextSibling, H1 = m1.firstChild, V1 = m1.nextSibling, G1 = V1.nextSibling, X1 = G1.firstChild;
    return _(q, () => w().map((B) => (() => {
      const J = Cu.cloneNode(!0), s1 = J.firstChild, G = s1.nextSibling, n1 = G.firstChild;
      return J.addEventListener("blur", () => {
        ...
        return () => x1() && m(fe, {
          class: "list",
          get children() {
            return B.list.map((o1) => (() => {
              const k1 = K0.cloneNode(!0), v1 = k1.firstChild;
              return k1.$$click = () => {
                B.setter(o1.key), e.onDrawingItemClick({
                  name: o1.key,
                  lock: D(),
                  mode: A()
                }), x("");
      ...
      })(), null), V(() => r1(n1, "class", B.key === T() ? "rotate" : "")), J;
    })()), a1), O.addEventListener("blur", () => {
      x("");
    }), Q.$$click = () => {
      let B = g();
      A() !== "normal" && (B = "normal"), I(B), e.onModeChange(B);
    }, _(Q, (() => {
      const B = R(() => g() === "weak_magnet");
      return () => B() ? (() => {
        const J = R(() => A() === "weak_magnet");
        return () => J() ? m(i1, {
          name: "weak_magnet",
          class: "selected"
        }) : m(i1, {
      ...
      return () => B() && m(fe, {
        ...
        get children() {
          return N().map((J) => (() => {
            const s1 = K0.cloneNode(!0), G = s1.firstChild;
            return s1.$$click = () => {
              L(J.key), I(J.key), e.onModeChange(J.key), x("");
            }, _(s1, m(i1, {
              get name() {
                return J.key;
              }
      ...
      name: "remove"
    })), V(() => r1(u1, "class", T() === "mode" ? "rotate" : "")), q;
  })();
};
c1(["click"]);
const j0 = /* @__PURE__ */ p('<li class="title"></li>'), Z0 = /* @__PURE__ */ p('<li class="row"></li>'), fu = (e) => m(U1, {
  get title() {
...
const hu = (e) => {
  const [t, n] = M(e.timezone), r = R(() => yu(e.locale));
  return m(U1, {
    get title() {
...
const gu = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), pu = /* @__PURE__ */ p("<span></span>"), mu = (e) => {
  const [t, n] = M(e.currentStyles), [r, a] = M(z0(e.locale));
  C1(() => {
    a(z0(e.locale));
  });
  const s = (l, o) => {
...
}, vu = /* @__PURE__ */ p('<img style="width:500px;margin-top: 20px">'), _u = (e) => m(U1, {
  get title() {
...
}, Lu = /* @__PURE__ */ p('<div class="klinecharts-pro-indicator-setting-modal-content"></div>'), bu = /* @__PURE__ */ p("<span></span>"), xu = (e) => {
  const [t, n] = M(z.clone(e.params.calcParams)), r = (a) => $u[a];
  return m(U1, {
    get title() {
    ...
    get buttons() {
      return [{
        ...
        onClick: () => {
          ...
          z.clone(t()).forEach((l, o) => {
            !z.isValid(l) || l === "" ? "default" in a[o] && s.push(a[o].default) : s.push(l);
...
}, ku = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z"></path></svg>'), Au = /* @__PURE__ */ p('<img alt="symbol">'), wu = /* @__PURE__ */ p("<li><div><span></span></div></li>"), Mu = (e) => {
  ...
  return m(U1, {
    ...
    get children() {
      return [m(T9, {
        ...
        renderItem: (a) => (() => {
          const s = wu.cloneNode(!0), l = s.firstChild, o = l.firstChild;
          return s.$$click = () => {
            ...
            get children() {
              ...
              return V(() => r1(d, "src", a.logo)), d;
            }
          }), o), _(o, () => a.shortName ?? a.ticker, null), _(o, () => `${a.name ? `(${a.name})` : ""}`, null), _(s, () => a.exchange ?? "", null), V(() => r1(o, "title", a.name ?? "")), s;
        })()
      })];
    }
  });
...
c1(["click"]);
const Su = /* @__PURE__ */ p('<i class="icon-close klinecharts-pro-load-icon"></i>'), Tu = /* @__PURE__ */ p('<div class="klinecharts-pro-content"><div class="klinecharts-pro-widget"></div></div>');
function ne(e, t, n, r) {
  return t === "VOL" && (r = {
    gap: {
      bottom: 2
...
const Iu = (e) => {
  let t, n = null, r, a = !1;
  const [s, l] = M(e.theme), [o, d] = M(e.styles), [y, u] = M(e.locale), [g, L] = M(e.symbol), [A, I] = M(e.period), [D, E] = M(!1), [P, K] = M([...e.mainIndicators]), [T, x] = M({}), [w, N] = M(!1), [q, a1] = M({
    key: e.timezone,
    text: Q0(e.timezone, e.locale)
  }), [O, Q] = M(!1), [Y, u1] = M(), [K1, F1] = M(""), [m1, H1] = M(e.drawingBarVisible), [V1, G1] = M(!1), [X1, B] = M(!1), [J, s1] = M({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const x1 = (c) => ({
    ...
    priceLine: 1,
    priceChannelLine: 3
  })[c] || 1, o1 = (c, C = /* @__PURE__ */ new WeakSet()) => {
    if (c == null)
      return c;
    if (C.has(c))
      return "[Circular]";
    if (typeof c != "object")
      return c;
    if (C.add(c), Array.isArray(c))
      return c.map((v) => o1(v, C));
    const h = {};
    for (const v in c)
    ...
    var C, h, v;
    try {
      const b = (C = n == null ? void 0 : n.getOverlayById) == null ? void 0 : C.call(n, c);
      if (!b)
        return;
      const S = k1(b);
      if (S) {
        const f = G.get(c), $ = ((h = f == null ? void 0 : f.points) == null ? void 0 : h.length) || 0, k = ((v = S.points) == null ? void 0 : v.length) || 0;
        G.set(c, S);
        const U = x1(S.type);
        if (k >= U) {
          const H = n1.get(c);
    ...
    document.addEventListener("mouseup", v), document.addEventListener("touchend", v), setTimeout(() => {
      ...
      if (b && !b.complete) {
        ...
        const f = G.get(c);
        if (f) {
          const $ = x1(f.type), k = ((S = f.points) == null ? void 0 : S.length) || 0;
          k < $ && console.warn(`⚠️ ${f.type} ${c} has only ${k} point(s), should have ${$}`);
        }
      }
    }, 3e4);
  };
  let A1 = {
    saveDrawings: (c, C) => {
      try {
        const h = `kline_drawings_${c}`, b = {
          drawings: C.map((S) => {
            var U;
            const f = {
              ...S
            };
            f.extendData && (f.extendData = o1(f.extendData)), f.styles && (f.styles = o1(f.styles));
            const $ = x1(S.type), k = ((U = S.points) == null ? void 0 : U.length) || 0;
            return k < $ && console.warn(`⚠️ Saving ${S.type} with only ${k} point(s), needs ${$}`), f;
          }),
          timestamp: Date.now()
        };
      } catch (h) {
  ...
  e.ref({
    ...
    setMainIndicators: K,
    setSubIndicators: x,
    overrideIndicator: (c, C) => {
      n == null || n.overrideIndicator(c, C);
    },
    createOverlay: (c) => {
      var C;
      return ((C = n == null ? void 0 : n.createOverlay) == null ? void 0 : C.call(n, c)) ?? null;
    },
    removeOverlay: (c) => {
      var C;
      if ((C = n == null ? void 0 : n.removeOverlay) == null || C.call(n, c), c.id) {
        G.delete(c.id);
        const h = n1.get(c.id);
        h && (h.checkInterval && clearInterval(h.checkInterval), h.mouseUpHandler && (document.removeEventListener("mouseup", h.mouseUpHandler), document.removeEventListener("touchend", h.mouseUpHandler)), n1.delete(c.id)), Xe();
      }
    },
    removeAllOverlay: () => {
      G.forEach((c, C) => {
    ...
    getSettings: () => {
      var h, v, b, S, f, $, k, U, H, h1, j1, J1, We, qe, e0, t0;
      if (!n)
        return {};
      const c = n.getStyles(), C = (h = c.candle) == null ? void 0 : h.bar;
      return {
        // Candle settings
        candleType: (v = c.candle) == null ? void 0 : v.type,
        candleBarStyle: C == null ? void 0 : C.style,
        // bar.style might be LineType
        showLastPrice: (f = (S = (b = c.candle) == null ? void 0 : b.priceMark) == null ? void 0 : S.last) == null ? void 0 : f.show,
        showHighestPrice: (U = (k = ($ = c.candle) == null ? void 0 : $.priceMark) == null ? void 0 : k.high) == null ? void 0 : U.show,
        showLowestPrice: (j1 = (h1 = (H = c.candle) == null ? void 0 : H.priceMark) == null ? void 0 : h1.low) == null ? void 0 : j1.show,
        // Indicator settings
        showIndicatorLastValue: (We = (J1 = c.indicator) == null ? void 0 : J1.lastValueMark) == null ? void 0 : We.show,
        // Axis settings - yAxis.reverse is boolean according to YAxisStyle interface
        priceAxisType: (qe = c.yAxis) == null ? void 0 : qe.type,
        reverseCoordinate: (e0 = c.yAxis) == null ? void 0 : e0.reverse,
        // Grid settings
        showGrids: (t0 = c.grid) == null ? void 0 : t0.show,
        timestamp: Date.now()
      };
    },
    setSettings: (c) => {
      var h, v, b, S, f, $, k, U, H, h1, j1;
      if (!n)
        return;
      const C = {};
      if (c.candleType !== void 0 && (C.candle = {
        ...C.candle,
        type: c.candleType
      }), c.candleBarStyle !== void 0) {
        const J1 = ((h = C.candle) == null ? void 0 : h.bar) || {};
        C.candle = {
          ...C.candle,
          bar: {
            ...J1,
      ...
      c.showLastPrice !== void 0 && (C.candle = {
        ...C.candle,
        priceMark: {
          ...(v = C.candle) == null ? void 0 : v.priceMark,
          last: {
            ...(S = (b = C.candle) == null ? void 0 : b.priceMark) == null ? void 0 : S.last,
            show: c.showLastPrice
          }
        }
      }), c.showHighestPrice !== void 0 && (C.candle = {
        ...C.candle,
        priceMark: {
          ...(f = C.candle) == null ? void 0 : f.priceMark,
          high: {
            ...(k = ($ = C.candle) == null ? void 0 : $.priceMark) == null ? void 0 : k.high,
            show: c.showHighestPrice
          }
        }
      }), c.showLowestPrice !== void 0 && (C.candle = {
        ...C.candle,
        priceMark: {
      ...
      }), c.showIndicatorLastValue !== void 0 && (C.indicator = {
        ...C.indicator,
        lastValueMark: {
          ...(j1 = C.indicator) == null ? void 0 : j1.lastValueMark,
          show: c.showIndicatorLastValue
        }
      }), c.priceAxisType !== void 0 && (C.yAxis = {
        ...C.yAxis,
        type: c.priceAxisType
      }), c.reverseCoordinate !== void 0 && (C.yAxis = {
        ...C.yAxis,
        reverse: c.reverseCoordinate
      }), c.showGrids !== void 0 && (C.grid = {
        ...C.grid,
        show: c.showGrids
      }), n.setStyles(C);
    },
    resetSettings: () => {
      ...
      if (C) {
        const U = {
          candle: {
            type: (h = C.candle) == null ? void 0 : h.type,
            bar: (v = C.candle) == null ? void 0 : v.bar,
            priceMark: (b = C.candle) == null ? void 0 : b.priceMark
          },
          indicator: {
            lastValueMark: (S = C.indicator) == null ? void 0 : S.lastValueMark
          },
          yAxis: {
            type: (f = C.yAxis) == null ? void 0 : f.type,
            reverse: ($ = C.yAxis) == null ? void 0 : $.reverse
          },
          grid: {
    ...
    saveDrawings: (c) => {
      ...
      C.forEach((h, v) => {
        var f;
        const b = x1(h.type), S = ((f = h.points) == null ? void 0 : f.length) || 0;
        S < b && console.warn(`⚠️ ${h.type} ${h.id} has only ${S} point(s), should have ${b}`);
      }), A1.saveDrawings(c, C);
    },
    loadDrawings: (c) => {
      A1.loadDrawings(c).forEach((h, v) => {
        var b;
        try {
          const S = {
            name: h.type,
            ...
            visible: h.visible ?? !0,
            lock: h.lock ?? !1,
            mode: h.mode ?? n0.Normal
          }, f = n == null ? void 0 : n.createOverlay(S);
          f && (G.set(f, {
            ...h,
            id: f
          }), n1.set(f, {
            monitoring: !1,
            complete: !0,
            lastPointCount: ((b = h.points) == null ? void 0 : b.length) || 0
          }));
        } catch (S) {
          console.error(`   ❌ Error restoring ${h.type}:`, S);
        }
      });
    },
  ...
  const Je = () => {
    ...
    switch (c.timespan) {
      case "minute": {
        v = v - v % (60 * 1e3), b = v - h * c.multiplier * 60 * 1e3;
        break;
      }
      case "hour": {
        v = v - v % (60 * 60 * 1e3), b = v - h * c.multiplier * 60 * 60 * 1e3;
        break;
      }
      case "day": {
        v = v - v % (60 * 60 * 1e3), b = v - h * c.multiplier * 24 * 60 * 60 * 1e3;
        break;
      }
      case "week": {
        const f = new Date(v).getDay(), $ = f === 0 ? 6 : f - 1;
        v = v - $ * 60 * 60 * 24;
        const k = new Date(v);
        v = (/* @__PURE__ */ new Date(`${k.getFullYear()}-${k.getMonth() + 1}-${k.getDate()}`)).getTime(), b = h * c.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const S = new Date(v), f = S.getFullYear(), $ = S.getMonth() + 1;
        v = (/* @__PURE__ */ new Date(`${f}-${$}-01`)).getTime(), b = h * c.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const k = new Date(b);
        b = (/* @__PURE__ */ new Date(`${k.getFullYear()}-${k.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const f = new Date(v).getFullYear();
        v = (/* @__PURE__ */ new Date(`${f}-01-01`)).getTime(), b = h * c.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const $ = new Date(b);
        b = (/* @__PURE__ */ new Date(`${$.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [b, v];
  ...
  return V0(() => {
    if (window.addEventListener("resize", Je), n = E9(t, {
      customApi: {
        formatDate: (f, $, k, U) => {
          switch (A().timespan) {
            case "minute":
              return U === W1.XAxis ? z.formatDate(f, $, "HH:mm") : z.formatDate(f, $, "YYYY-MM-DD HH:mm");
            case "hour":
              return U === W1.XAxis ? z.formatDate(f, $, "MM-DD HH:mm") : z.formatDate(f, $, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return z.formatDate(f, $, "YYYY-MM-DD");
            case "month":
              return U === W1.XAxis ? z.formatDate(f, $, "YYYY-MM") : z.formatDate(f, $, "YYYY-MM-DD");
            case "year":
              return U === W1.XAxis ? z.formatDate(f, $, "YYYY") : z.formatDate(f, $, "YYYY-MM-DD");
          }
          return z.formatDate(f, $, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      const f = n.getDom("candle_pane", r0.Main);
      if (f) {
        let k = document.createElement("div");
        if (k.className = "klinecharts-pro-watermark", z.isString(e.watermark)) {
      ...
      const $ = n.getDom("candle_pane", r0.YAxis);
    ...
    const C = () => {
      ...
      if (f != null && f.ticker)
        try {
          const $ = Array.from(G.values());
          A1.saveDrawings(f.ticker, $);
        } catch ($) {
    ...
    n && v && (n.removeOverlay = function(...f) {
      const $ = v.apply(this, f), k = f[0];
      let U;
      if (typeof k == "string" ? U = k : k && typeof k == "object" && k.id && (U = k.id), U) {
        G.delete(U);
        const H = n1.get(U);
        H && (H.checkInterval && clearInterval(H.checkInterval), H.mouseUpHandler && (document.removeEventListener("mouseup", H.mouseUpHandler), document.removeEventListener("touchend", H.mouseUpHandler)), n1.delete(U)), C();
      }
      return $;
    }), P().forEach((f) => {
      ne(n, f, !0, {
    ...
    e.subIndicators.forEach((f) => {
      const $ = ne(n, f, !0);
      $ && (b[f] = $);
    }), x(b), n == null || n.loadMore((f) => {
      a = !0, (async () => {
        const k = A(), [U] = Le(k, f, 1), [H] = Le(k, U, 500), h1 = await e.datafeed.getHistoryKLineData(g(), k, H, U);
        ...
        switch (f.iconId) {
          ...
          case "close":
            if (f.paneId === "candle_pane") {
              const $ = [...P()];
              n == null || n.removeIndicator("candle_pane", f.indicatorName), $.splice($.indexOf(f.indicatorName), 1), K($);
            } else {
              const $ = {
                ...T()
              };
              n == null || n.removeIndicator(f.paneId, f.indicatorName), delete $[f.indicatorName], x($);
            }
        }
    });
    const S = n == null ? void 0 : n.createOverlay;
    n && S && (n.createOverlay = function(...f) {
      const $ = f[0], k = S.apply(this, f);
      return k && (D9(k, $.name || "unknown"), v1(k), Xe()), k;
    });
  }), Be(() => {
    window.removeEventListener("resize", Je), n1.clear(), G.clear(), a0(t);
  }), C1(() => {
    const c = g();
    ...
    if (!a) {
      ...
      return a = !0, B(!0), (async () => {
        const [b, S] = Le(h, (/* @__PURE__ */ new Date()).getTime(), 500), f = await e.datafeed.getHistoryKLineData(C, h, b, S);
        n == null || n.applyNewData(f, f.length > 0), e.datafeed.subscribe(C, h, ($) => {
          n == null || n.updateData($);
        }), a = !1, B(!1);
      })(), {
        symbol: C,
      ...
      return m(fu, {
        ...
        onMainIndicatorChange: (c) => {
          ...
          c.added ? (ne(n, c.name, !0, {
            id: "candle_pane"
          }), C.push(c.name)) : (n == null || n.removeIndicator("candle_pane", c.name), C.splice(C.indexOf(c.name), 1)), K(C);
        },
        onSubIndicatorChange: (c) => {
          ...
          if (c.added) {
            ...
            c.paneId && (n == null || n.removeIndicator(c.paneId, c.name), delete C[c.name]);
          x(C);
        }
      });
    }
    ...
    onMenuClick: async () => {
      try {
        await c5(() => H1(!m1())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    const c = Tu.cloneNode(!0), C = c.firstChild;
    return _(c, m(W, {
      get when() {
        return X1();
      },

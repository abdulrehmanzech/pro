...
var sa = (e, t, r) => t in e ? aa(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var _1 = (e, t, r) => (sa(e, typeof t != "symbol" ? t + "" : t, r), r);
import { utils as O, registerFigure as la, PolygonType as Wt, LineType as Ke, OverlayMode as Qn, ActionType as Nt, init as ca, FormatDateType as en, DomPosition as st, dispose as Bo, TooltipIconPosition as tn, CandleType as ua, YAxisType as da, registerOverlay as ha } from "klinecharts";
function L1(e, t, r) {
...
const fa = {
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const r = D0(e[0], e[1]) / Math.sqrt(24), n = e[1].x > e[0].x ? 0 : 1, a = O.getLinearSlopeIntercept(e[0], e[1]);
      let c;
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((b) => {
        ...
        r.push({ coordinates: [{ x: w, y: e[0].y }, { x: w, y: e[1].y }] }), r.push({ coordinates: [{ x: e[0].x, y: I }, { x: e[1].x, y: I }] }), n = n.concat(nr([e[0], { x: w, y: e[1].y }], t)), n = n.concat(nr([e[0], { x: e[1].x, y: I }], t)), a.unshift({
          x: e[0].x + c,
          y: I + 10,
          text: `${b.toFixed(3)}`
        }), a.unshift({
...
const Da = (e, t) => e === t, rr = Symbol("solid-proxy"), Na = Symbol("solid-track"), hn = {
  equals: Da
};
let N0 = B0;
const bt = 1, fn = 2, O0 = {
...
var Ee = null;
let Et = null, Le = null, je = null, vt = null, mr = 0;
function w1(e, t) {
  const r = Le, n = Ee, a = e.length === 0, c = a ? O0 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? n : t
...
function T(e, t) {
  ...
  }, n = (a) => (typeof a == "function" && (a = a(r.value)), E0(r, a));
  return [I0.bind(r), n];
}
function Fo(e, t, r) {
  const n = kn(e, t, !0, bt);
...
function W(e, t, r) {
  ...
  const n = kn(e, t, !0, 0);
  return n.observers = null, n.observerSlots = null, n.comparator = r.equals || void 0, Xt(n), I0.bind(n);
}
function Oa(e, t, r) {
  let n, a, c;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (n = !0, a = e, c = t || {}) : (n = e, a = t, c = r || {});
  let f = null, h = Zn, v = null, L = !1, b = "initialValue" in c, w = typeof n == "function" && W(n);
  ...
  if (Ve.context) {
    ...
    let ee;
    c.ssrLoadFrom === "initial" ? h = c.initialValue : Ve.load && (ee = Ve.load(v)) && (h = ee[0]);
  }
  ...
  function Y() {
    const ee = Ea, se = P(), M = V();
    if (M !== void 0 && !f)
      throw M;
    return Le && !Le.user && ee && Fo(() => {
...
function Ia(e) {
  ...
  return Promise.resolve().then(() => {
    Le = t, Ee = r;
    let n;
    return wt(e, !1), Le = Ee = null, n ? n.done : void 0;
  });
}
let Ea;
function I0() {
...
function E0(e, t, r) {
  ...
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && wt(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      f && Et.disposed.has(c), (f && !c.tState || !f && !c.state) && (c.pure ? je.push(c) : vt.push(c), c.observers && F0(c)), f || (c.state = bt);
    }
    if (je.length > 1e6)
      throw je = [], new Error();
  }, !1)), t;
...
function Xt(e) {
  if (!e.fn)
    return;
  xn(e);
  const t = Ee, r = Le, n = mr;
  Le = Ee = e, Ba(e, e.value, n), Le = r, Ee = t;
}
function Ba(e, t, r) {
  let n;
  try {
    ...
    e.pure && (e.state = bt, e.owned && e.owned.forEach(xn), e.owned = null), z0(a);
  }
  (!e.updatedAt || e.updatedAt <= r) && (e.updatedAt != null && "observers" in e ? E0(e, n) : e.value = n, e.updatedAt = r);
}
function kn(e, t, r, n = bt, a) {
  ...
  return Ee === null || Ee !== O0 && (Ee.owned ? Ee.owned.push(c) : Ee.owned = [c]), c;
}
function mn(e) {
  const t = Et;
  if (e.state === 0 || t)
...
function wt(e, t) {
  ...
  try {
    ...
    r || (vt = null), je = null, z0(n);
  }
}
function Fa(e) {
  if (je && (B0(je), je = null), e)
    return;
  const t = vt;
  vt = null, t.length && wt(() => N0(t), !1);
}
function B0(e) {
...
function F0(e) {
  ...
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = fn, n.pure ? je.push(n) : vt.push(n), n.observers && F0(n));
  }
}
function xn(e) {
  let t;
...
function Va(e, t, r = {}) {
  ...
  return Lt(() => Uo(c)), () => {
    ...
    return v[Na], ht(() => {
      ...
      if (I === 0)
        f !== 0 && (Uo(c), c = [], n = [], a = [], f = 0, h && (h = [])), r.fallback && (n = [za], a[0] = w1((ve) => (c[0] = ve, r.fallback())), f = 1);
      else if (f === 0) {
        ...
        for (b = he; b < I; b++)
          b in V ? (a[b] = V[b], c[b] = K[b], h && (h[b] = U[b], h[b](b))) : a[b] = w1(w);
...
function V0(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const a = e[n];
    t = t || !!a && rr in a, e[n] = typeof a == "function" ? (t = !0, W(a)) : a;
  }
  if (t)
    return new Proxy({
      get(n) {
...
function A1(e) {
  ...
  return W(Va(() => e.each, e.children, t || void 0));
}
function de(e) {
  let t = !1;
...
function We(e, t = window.document) {
  ...
  for (let n = 0, a = e.length; n < a; n++) {
    const c = e[n];
    r.has(c) || (r.add(c), t.addEventListener(c, Qa));
  }
}
function Ne(e, t, r) {
  ...
  if (e = f && r[0] && r[0].parentNode || e, c === "string" || c === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (h.length === 0) {
        ...
        v ? r.length === 0 ? Vo(e, h, n) : Ka(e, r, h) : (r && qt(e), Vo(e, h));
      r = h;
...
function Ya(e) {
  ...
  if (n instanceof HTMLHeadElement) {
    ...
    const c = Ha(e.isSVG ? "g" : "div", e.isSVG), f = t && c.attachShadow ? c.attachShadow({
      mode: "open"
    }) : c;
...
var Wa = typeof rn == "object" && rn && rn.Object === Object && rn, K0 = Wa, qa = K0, Ga = typeof self == "object" && self && self.Object === Object && self, Xa = qa || Ga || Function("return this")(), ft = Xa, Ja = ft, e9 = Ja.Symbol, Ln = e9, Ro = Ln, j0 = Object.prototype, t9 = j0.hasOwnProperty, n9 = j0.toString, k1 = Ro ? Ro.toStringTag : void 0;
function r9(e) {
  var t = t9.call(e, k1), r = e[k1];
  try {
    e[k1] = void 0;
    var n = !0;
  } catch {
...
var o9 = r9, i9 = Object.prototype, a9 = i9.toString;
function s9(e) {
  return a9.call(e);
}
var l9 = s9, Ko = Ln, c9 = o9, u9 = l9, d9 = "[object Null]", h9 = "[object Undefined]", jo = Ko ? Ko.toStringTag : void 0;
function f9(e) {
  return e == null ? e === void 0 ? h9 : d9 : jo && jo in Object(e) ? c9(e) : u9(e);
}
var M1 = f9;
function m9(e) {
  var t = typeof e;
...
var Jt = m9, g9 = M1, y9 = Jt, C9 = "[object AsyncFunction]", p9 = "[object Function]", v9 = "[object GeneratorFunction]", b9 = "[object Proxy]";
function $9(e) {
  if (!y9(e))
    return !1;
  var t = g9(e);
  return t == p9 || t == v9 || t == C9 || t == b9;
}
var Q0 = $9, _9 = ft, k9 = _9["__core-js_shared__"], x9 = k9, Yn = x9, Qo = function() {
...
var w9 = L9, A9 = Function.prototype, T9 = A9.toString;
function M9(e) {
  if (e != null) {
    try {
      return T9.call(e);
...
var Z0 = M9, S9 = Q0, P9 = w9, D9 = Jt, N9 = Z0, O9 = /[\\^$.*+?()[\]{}|]/g, I9 = /^\[object .+?Constructor\]$/, E9 = Function.prototype, B9 = Object.prototype, F9 = E9.toString, U9 = B9.hasOwnProperty, z9 = RegExp(
  "^" + F9.call(U9).replace(O9, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function V9(e) {
  if (!D9(e) || P9(e))
    return !1;
...
var j9 = K9, Q9 = R9, Z9 = j9;
function H9(e, t) {
  var r = Z9(e, t);
  return Q9(r) ? r : void 0;
}
var Ft = H9, Y9 = Ft, W9 = function() {
  try {
    var e = Y9(Object, "defineProperty");
    return e({}, "", {}), e;
  } catch {
  }
}(), q9 = W9, Zo = q9;
...
var Y0 = X9, J9 = H0, e5 = Y0, t5 = Object.prototype, n5 = t5.hasOwnProperty;
function r5(e, t, r) {
  var n = e[t];
  (!(n5.call(e, t) && e5(n, r)) || r === void 0 && !(t in e)) && J9(e, t, r);
}
var yr = r5, o5 = Array.isArray, e1 = o5;
function i5(e) {
  return e != null && typeof e == "object";
}
var t1 = i5, a5 = M1, s5 = t1, l5 = "[object Symbol]";
function c5(e) {
  return typeof e == "symbol" || s5(e) && a5(e) == l5;
}
var Cr = c5, u5 = e1, d5 = Cr, h5 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, f5 = /^\w*$/;
function m5(e, t) {
  if (u5(e))
    return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || d5(e) ? !0 : f5.test(e) || !h5.test(e) || t != null && e in Object(t);
}
var g5 = m5, y5 = Ft, C5 = y5(Object, "create"), wn = C5, Ho = wn;
function p5() {
...
var $5 = b5, _5 = wn, k5 = "__lodash_hash_undefined__", x5 = Object.prototype, L5 = x5.hasOwnProperty;
function w5(e) {
  var t = this.__data__;
  if (_5) {
    var r = t[e];
    return r === k5 ? void 0 : r;
  }
  return L5.call(t, e) ? t[e] : void 0;
}
var A5 = w5, T5 = wn, M5 = Object.prototype, S5 = M5.hasOwnProperty;
function P5(e) {
  var t = this.__data__;
  return T5 ? t[e] !== void 0 : S5.call(t, e);
}
var D5 = P5, N5 = wn, O5 = "__lodash_hash_undefined__";
function I5(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = N5 && t === void 0 ? O5 : t, this;
}
var E5 = I5, B5 = v5, F5 = $5, U5 = A5, z5 = D5, V5 = E5;
function n1(e) {
...
n1.prototype.clear = B5;
n1.prototype.delete = F5;
n1.prototype.get = U5;
n1.prototype.has = z5;
n1.prototype.set = V5;
var R5 = n1;
...
var An = Z5, H5 = An, Y5 = Array.prototype, W5 = Y5.splice;
function q5(e) {
  var t = this.__data__, r = H5(t, e);
  if (r < 0)
    return !1;
  var n = t.length - 1;
  return r == n ? t.pop() : W5.call(t, r, 1), --this.size, !0;
}
var G5 = q5, X5 = An;
function J5(e) {
...
var as = is, ss = j5, ls = G5, cs = es, us = rs, ds = as;
function r1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
r1.prototype.clear = ss;
r1.prototype.delete = ls;
r1.prototype.get = cs;
r1.prototype.has = us;
r1.prototype.set = ds;
var Tn = r1, hs = Ft, fs = ft, ms = hs(fs, "Map"), pr = ms, Yo = R5, gs = Tn, ys = pr;
function Cs() {
...
function _s(e, t) {
  var r = e.__data__;
  return $s(t) ? r[typeof t == "string" ? "string" : "hash"] : r.map;
}
var Mn = _s, ks = Mn;
function xs(e) {
...
var Os = Ns, Is = ps, Es = Ls, Bs = Ts, Fs = Ps, Us = Os;
function o1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
o1.prototype.clear = Is;
o1.prototype.delete = Es;
o1.prototype.get = Bs;
o1.prototype.has = Fs;
o1.prototype.set = Us;
var W0 = o1, q0 = W0, zs = "Expected a function";
function vr(e, t) {
  ...
  return r.cache = new (vr.Cache || q0)(), r;
}
vr.Cache = q0;
var Vs = vr, Rs = Vs, Ks = 500;
function js(e) {
...
var Qs = js, Zs = Qs, Hs = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Ys = /\\(\\)?/g, Ws = Zs(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(Hs, function(r, n, a, c) {
    t.push(a ? c.replace(Ys, "$1") : n || r);
  }), t;
}), qs = Ws;
function Gs(e, t) {
...
var Xs = Gs, Wo = Ln, Js = Xs, e6 = e1, t6 = Cr, n6 = 1 / 0, qo = Wo ? Wo.prototype : void 0, Go = qo ? qo.toString : void 0;
function G0(e) {
  if (typeof e == "string")
    return e;
  if (e6(e))
...
var a6 = i6, s6 = e1, l6 = g5, c6 = qs, u6 = a6;
function d6(e, t) {
  return s6(e) ? e : l6(e, t) ? [e] : c6(u6(e));
}
var h6 = d6, f6 = 9007199254740991, m6 = /^(?:0|[1-9]\d*)$/;
function g6(e, t) {
  var r = typeof e;
  return t = t ?? f6, !!t && (r == "number" || r != "symbol" && m6.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var X0 = g6, y6 = Cr, C6 = 1 / 0;
function p6(e) {
  if (typeof e == "string" || y6(e))
    return e;
  var t = e + "";
  return t == "0" && 1 / e == -C6 ? "-0" : t;
}
var v6 = p6, b6 = yr, $6 = h6, _6 = X0, Xo = Jt, k6 = v6;
function x6(e, t, r, n) {
  if (!Xo(e))
    return e;
  t = $6(t, e);
  for (var a = -1, c = t.length, f = c - 1, h = e; h != null && ++a < c; ) {
    ...
    if (a != f) {
      var b = h[v];
      L = n ? n(b, v, h) : void 0, L === void 0 && (L = Xo(b) ? b : _6(t[a + 1]) ? [] : {});
    }
    b6(h, v, L), h = h[v];
  }
  return e;
...
var L6 = x6, w6 = L6;
function A6(e, t, r) {
  return e == null ? e : w6(e, t, r);
}
var T6 = A6;
const Ie = /* @__PURE__ */ R0(T6);
var M6 = Tn;
function S6() {
...
var B6 = E6, F6 = Tn, U6 = pr, z6 = W0, V6 = 200;
function R6(e, t) {
  var r = this.__data__;
  if (r instanceof F6) {
    var n = r.__data__;
    ...
    r = this.__data__ = new z6(n);
  }
  return r.set(e, t), this.size = r.size, this;
}
var K6 = R6, j6 = Tn, Q6 = P6, Z6 = N6, H6 = I6, Y6 = B6, W6 = K6;
function i1(e) {
  var t = this.__data__ = new j6(e);
  this.size = t.size;
}
i1.prototype.clear = Q6;
i1.prototype.delete = Z6;
i1.prototype.get = H6;
i1.prototype.has = Y6;
i1.prototype.set = W6;
var q6 = i1;
...
var r2 = n2, o2 = M1, i2 = t1, a2 = "[object Arguments]";
function s2(e) {
  return i2(e) && o2(e) == a2;
}
var l2 = s2, Jo = l2, c2 = t1, J0 = Object.prototype, u2 = J0.hasOwnProperty, d2 = J0.propertyIsEnumerable, h2 = Jo(function() {
  return arguments;
}()) ? Jo : function(e) {
  return c2(e) && u2.call(e, "callee") && !d2.call(e, "callee");
}, f2 = h2, Cn = { exports: {} };
function m2() {
  return !1;
}
...
Cn.exports;
(function(e, t) {
  var r = ft, n = g2, a = t && !t.nodeType && t, c = a && !0 && e && !e.nodeType && e, f = c && c.exports === a, h = f ? r.Buffer : void 0, v = h ? h.isBuffer : void 0, L = v || n;
  e.exports = L;
})(Cn, Cn.exports);
var ei = Cn.exports, y2 = 9007199254740991;
function C2(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= y2;
}
var ti = C2, p2 = M1, v2 = ti, b2 = t1, $2 = "[object Arguments]", _2 = "[object Array]", k2 = "[object Boolean]", x2 = "[object Date]", L2 = "[object Error]", w2 = "[object Function]", A2 = "[object Map]", T2 = "[object Number]", M2 = "[object Object]", S2 = "[object RegExp]", P2 = "[object Set]", D2 = "[object String]", N2 = "[object WeakMap]", O2 = "[object ArrayBuffer]", I2 = "[object DataView]", E2 = "[object Float32Array]", B2 = "[object Float64Array]", F2 = "[object Int8Array]", U2 = "[object Int16Array]", z2 = "[object Int32Array]", V2 = "[object Uint8Array]", R2 = "[object Uint8ClampedArray]", K2 = "[object Uint16Array]", j2 = "[object Uint32Array]", xe = {};
xe[E2] = xe[B2] = xe[F2] = xe[U2] = xe[z2] = xe[V2] = xe[R2] = xe[K2] = xe[j2] = !0;
xe[$2] = xe[_2] = xe[O2] = xe[k2] = xe[I2] = xe[x2] = xe[L2] = xe[w2] = xe[A2] = xe[T2] = xe[M2] = xe[S2] = xe[P2] = xe[D2] = xe[N2] = !1;
function Q2(e) {
  return b2(e) && v2(e.length) && !!xe[p2(e)];
}
var Z2 = Q2;
function H2(e) {
  return function(t) {
...
var br = H2, pn = { exports: {} };
pn.exports;
(function(e, t) {
  var r = K0, n = t && !t.nodeType && t, a = n && !0 && e && !e.nodeType && e, c = a && a.exports === n, f = c && r.process, h = function() {
    try {
...
var $r = pn.exports, Y2 = Z2, W2 = br, e0 = $r, t0 = e0 && e0.isTypedArray, q2 = t0 ? W2(t0) : Y2, G2 = q2, X2 = r2, J2 = f2, e3 = e1, t3 = ei, n3 = X0, r3 = G2, o3 = Object.prototype, i3 = o3.hasOwnProperty;
function a3(e, t) {
  var r = e3(e), n = !r && J2(e), a = !r && !n && t3(e), c = !r && !n && !a && r3(e), f = r || n || a || c, h = f ? X2(e.length, String) : [], v = h.length;
  for (var L in e)
    (t || i3.call(e, L)) && !(f && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var ni = a3, s3 = Object.prototype;
function l3(e) {
  var t = e && e.constructor, r = typeof t == "function" && t.prototype || s3;
  return e === r;
}
var _r = l3;
function c3(e, t) {
...
var ri = c3, u3 = ri, d3 = u3(Object.keys, Object), h3 = d3, f3 = _r, m3 = h3, g3 = Object.prototype, y3 = g3.hasOwnProperty;
function C3(e) {
  if (!f3(e))
    return m3(e);
  var t = [];
  for (var r in Object(e))
    y3.call(e, r) && r != "constructor" && t.push(r);
  return t;
}
var p3 = C3, v3 = Q0, b3 = ti;
function $3(e) {
  return e != null && b3(e.length) && !v3(e);
}
var oi = $3, _3 = ni, k3 = p3, x3 = oi;
function L3(e) {
  return x3(e) ? _3(e) : k3(e);
}
var kr = L3, w3 = Sn, A3 = kr;
function T3(e, t) {
  return e && w3(t, A3(t), e);
}
var M3 = T3;
function S3(e) {
  var t = [];
...
var P3 = S3, D3 = Jt, N3 = _r, O3 = P3, I3 = Object.prototype, E3 = I3.hasOwnProperty;
function B3(e) {
  if (!D3(e))
    return O3(e);
  var t = N3(e), r = [];
  for (var n in e)
    n == "constructor" && (t || !E3.call(e, n)) || r.push(n);
  return r;
}
var F3 = B3, U3 = ni, z3 = F3, V3 = oi;
function R3(e) {
  return V3(e) ? U3(e, !0) : z3(e);
}
var xr = R3, K3 = Sn, j3 = xr;
function Q3(e, t) {
  return e && K3(t, j3(t), e);
}
var Z3 = Q3, vn = { exports: {} };
vn.exports;
(function(e, t) {
  var r = ft, n = t && !t.nodeType && t, a = n && !0 && e && !e.nodeType && e, c = a && a.exports === n, f = c ? r.Buffer : void 0, h = f ? f.allocUnsafe : void 0;
  function v(L, b) {
    if (b)
      return L.slice();
...
var ii = X3, J3 = G3, el = ii, tl = Object.prototype, nl = tl.propertyIsEnumerable, n0 = Object.getOwnPropertySymbols, rl = n0 ? function(e) {
  return e == null ? [] : (e = Object(e), J3(n0(e), function(t) {
    return nl.call(e, t);
  }));
} : el, Lr = rl, ol = Sn, il = Lr;
function al(e, t) {
  return ol(e, il(e), t);
}
var sl = al;
...
var ai = ll, cl = ri, ul = cl(Object.getPrototypeOf, Object), si = ul, dl = ai, hl = si, fl = Lr, ml = ii, gl = Object.getOwnPropertySymbols, yl = gl ? function(e) {
  for (var t = []; e; )
    dl(t, fl(e)), e = hl(e);
  return t;
} : ml, li = yl, Cl = Sn, pl = li;
function vl(e, t) {
  return Cl(e, pl(e), t);
}
var bl = vl, $l = ai, _l = e1;
function kl(e, t, r) {
  var n = t(e);
  return _l(e) ? n : $l(n, r(e));
}
var ci = kl, xl = ci, Ll = Lr, wl = kr;
function Al(e) {
  return xl(e, wl, Ll);
}
var Tl = Al, Ml = ci, Sl = li, Pl = xr;
function Dl(e) {
  return Ml(e, Pl, Sl);
}
var Nl = Dl, Ol = Ft, Il = ft, El = Ol(Il, "DataView"), Bl = El, Fl = Ft, Ul = ft, zl = Fl(Ul, "Promise"), Vl = zl, Rl = Ft, Kl = ft, jl = Rl(Kl, "Set"), Ql = jl, Zl = Ft, Hl = ft, Yl = Zl(Hl, "WeakMap"), Wl = Yl, ir = Bl, ar = pr, sr = Vl, lr = Ql, cr = Wl, ui = M1, a1 = Z0, r0 = "[object Map]", ql = "[object Object]", o0 = "[object Promise]", i0 = "[object Set]", a0 = "[object WeakMap]", s0 = "[object DataView]", Gl = a1(ir), Xl = a1(ar), Jl = a1(sr), e8 = a1(lr), t8 = a1(cr), Ot = ui;
(ir && Ot(new ir(new ArrayBuffer(1))) != s0 || ar && Ot(new ar()) != r0 || sr && Ot(sr.resolve()) != o0 || lr && Ot(new lr()) != i0 || cr && Ot(new cr()) != a0) && (Ot = function(e) {
  var t = ui(e), r = t == ql ? e.constructor : void 0, n = r ? a1(r) : "";
  if (n)
    switch (n) {
      case Gl:
        return s0;
...
var wr = Ot, n8 = Object.prototype, r8 = n8.hasOwnProperty;
function o8(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && r8.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
var i8 = o8, a8 = ft, s8 = a8.Uint8Array, l8 = s8, l0 = l8;
function c8(e) {
...
var g8 = m8, c0 = Ln, u0 = c0 ? c0.prototype : void 0, d0 = u0 ? u0.valueOf : void 0;
function y8(e) {
...
var b8 = v8, $8 = Ar, _8 = h8, k8 = g8, x8 = C8, L8 = b8, w8 = "[object Boolean]", A8 = "[object Date]", T8 = "[object Map]", M8 = "[object Number]", S8 = "[object RegExp]", P8 = "[object Set]", D8 = "[object String]", N8 = "[object Symbol]", O8 = "[object ArrayBuffer]", I8 = "[object DataView]", E8 = "[object Float32Array]", B8 = "[object Float64Array]", F8 = "[object Int8Array]", U8 = "[object Int16Array]", z8 = "[object Int32Array]", V8 = "[object Uint8Array]", R8 = "[object Uint8ClampedArray]", K8 = "[object Uint16Array]", j8 = "[object Uint32Array]";
function Q8(e, t, r) {
  var n = e.constructor;
  switch (t) {
    case O8:
...
var Z8 = Q8, H8 = Jt, h0 = Object.create, Y8 = function() {
  function e() {
  }
  return function(t) {
    if (!H8(t))
...
}(), W8 = Y8, q8 = W8, G8 = si, X8 = _r;
function J8(e) {
  return typeof e.constructor == "function" && !X8(e) ? q8(G8(e)) : {};
}
var e7 = J8, t7 = wr, n7 = t1, r7 = "[object Map]";
function o7(e) {
  return n7(e) && t7(e) == r7;
}
var i7 = o7, a7 = i7, s7 = br, f0 = $r, m0 = f0 && f0.isMap, l7 = m0 ? s7(m0) : a7, c7 = l7, u7 = wr, d7 = t1, h7 = "[object Set]";
function f7(e) {
  return d7(e) && u7(e) == h7;
}
var m7 = f7, g7 = m7, y7 = br, g0 = $r, y0 = g0 && g0.isSet, C7 = y0 ? y7(y0) : g7, p7 = C7, v7 = q6, b7 = X6, $7 = yr, _7 = M3, k7 = Z3, x7 = H3, L7 = W3, w7 = sl, A7 = bl, T7 = Tl, M7 = Nl, S7 = wr, P7 = i8, D7 = Z8, N7 = e7, O7 = e1, I7 = ei, E7 = c7, B7 = Jt, F7 = p7, U7 = kr, z7 = xr, V7 = 1, R7 = 2, K7 = 4, di = "[object Arguments]", j7 = "[object Array]", Q7 = "[object Boolean]", Z7 = "[object Date]", H7 = "[object Error]", hi = "[object Function]", Y7 = "[object GeneratorFunction]", W7 = "[object Map]", q7 = "[object Number]", fi = "[object Object]", G7 = "[object RegExp]", X7 = "[object Set]", J7 = "[object String]", ec = "[object Symbol]", tc = "[object WeakMap]", nc = "[object ArrayBuffer]", rc = "[object DataView]", oc = "[object Float32Array]", ic = "[object Float64Array]", ac = "[object Int8Array]", sc = "[object Int16Array]", lc = "[object Int32Array]", cc = "[object Uint8Array]", uc = "[object Uint8ClampedArray]", dc = "[object Uint16Array]", hc = "[object Uint32Array]", be = {};
be[di] = be[j7] = be[nc] = be[rc] = be[Q7] = be[Z7] = be[oc] = be[ic] = be[ac] = be[sc] = be[lc] = be[W7] = be[q7] = be[fi] = be[G7] = be[X7] = be[J7] = be[ec] = be[cc] = be[uc] = be[dc] = be[hc] = !0;
be[H7] = be[hi] = be[tc] = !1;
function un(e, t, r, n, a, c) {
  var f, h = t & V7, v = t & R7, L = t & K7;
  ...
  if (b) {
    ...
    var w = S7(e), I = w == hi || w == Y7;
    if (I7(e))
      return x7(e, h);
    if (w == fi || w == di || I && !a) {
      if (f = v || I ? {} : N7(e), !h)
        return v ? A7(e, k7(f, e)) : w7(e, _7(f, e));
    } else {
      if (!be[w])
        return a ? e : {};
      f = D7(e, w, h);
  ...
  if (P)
    return P;
  c.set(e, f), F7(e) ? e.forEach(function(K) {
    f.add(un(K, t, r, K, e, c));
  }) : E7(e) && e.forEach(function(K, U) {
    f.set(U, un(K, t, r, U, e, c));
  });
  var oe = L ? v ? M7 : T7 : v ? z7 : U7, V = b ? void 0 : oe(e);
  return b7(V || e, function(K, U) {
    V && (U = K, K = e[U]), $7(f, U, un(K, t, r, U, e, c));
  }), f;
}
var fc = un, mc = fc, gc = 1, yc = 4;
function Cc(e) {
  return mc(e, gc | yc);
}
var pc = Cc;
const vc = /* @__PURE__ */ R0(pc), bc = /* @__PURE__ */ $("<button></button>"), $c = (e) => (() => {
  const t = bc.cloneNode(!0);
  return dt(t, "click", e.onClick, !0), C(t, () => e.children), R((r) => {
...
We(["click"]);
const _c = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), kc = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), xc = /* @__PURE__ */ $("<div></div>"), Lc = /* @__PURE__ */ $('<span class="label"></span>'), wc = () => _c.cloneNode(!0), Ac = () => kc.cloneNode(!0), C0 = (e) => {
  const [t, r] = T(e.checked ?? !1);
  return Ye(() => {
    "checked" in e && r(e.checked);
  }), (() => {
    const n = xc.cloneNode(!0);
    return n.$$click = (a) => {
      const c = !t();
...
We(["click"]);
const Tc = /* @__PURE__ */ $('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), mi = () => Tc.cloneNode(!0), Mc = /* @__PURE__ */ $('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), Sc = () => Mc.cloneNode(!0), Pc = /* @__PURE__ */ $("<ul></ul>"), Dc = /* @__PURE__ */ $("<li></li>"), bn = (e) => (() => {
  const t = Pc.cloneNode(!0);
  return C(t, A(de, {
    get when() {
      return e.loading;
    },
    ...
    get children() {
      ...
      return (r = e.dataSource) == null ? void 0 : r.map((n) => {
        var a;
        return ((a = e.renderItem) == null ? void 0 : a.call(e, n)) ?? Dc.cloneNode(!0);
      });
    }
  }), null), R((r) => {
...
})(), Nc = /* @__PURE__ */ $('<div class="klinecharts-pro-modal"><div class="inner"><div class="title-container"><svg class="close-icon" viewBox="0 0 1024 1024"><path d="M934.184927 199.723787 622.457206 511.452531l311.727721 311.703161c14.334473 14.229073 23.069415 33.951253 23.069415 55.743582 0 43.430138-35.178197 78.660524-78.735226 78.660524-21.664416 0-41.361013-8.865925-55.642275-23.069415L511.149121 622.838388 199.420377 934.490384c-14.204513 14.20349-33.901111 23.069415-55.642275 23.069415-43.482327 0-78.737272-35.230386-78.737272-78.660524 0-21.792329 8.864902-41.513486 23.094998-55.743582l311.677579-311.703161L88.135828 199.723787c-14.230096-14.255679-23.094998-33.92567-23.094998-55.642275 0-43.430138 35.254945-78.762855 78.737272-78.762855 21.741163 0 41.437761 8.813736 55.642275 23.069415l311.727721 311.727721L822.876842 88.389096c14.281261-14.255679 33.977859-23.069415 55.642275-23.069415 43.557028 0 78.735226 35.332716 78.735226 78.762855C957.254342 165.798117 948.5194 185.468109 934.184927 199.723787"></path></svg></div><div class="content-container"></div></div></div>'), Oc = /* @__PURE__ */ $('<div class="button-container"></div>'), At = (e) => (() => {
  const t = Nc.cloneNode(!0), r = t.firstChild, n = r.firstChild, a = n.firstChild, c = n.nextSibling;
  return t.$$click = (f) => {
    f.target === f.currentTarget && e.onClose && e.onClose();
  }, C(n, () => e.title, a), dt(a, "click", e.onClose, !0), C(c, () => e.children), C(r, (() => {
    const f = W(() => !!(e.buttons && e.buttons.length > 0));
    return () => f() && (() => {
      const h = Oc.cloneNode(!0);
      return C(h, () => e.buttons.map((v) => A($c, V0(v, {
        get style() {
          return {
            ...e.minButtonWidth ? {
...
We(["click"]);
const Ic = /* @__PURE__ */ $('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), Ec = /* @__PURE__ */ $('<div class="drop-down-container"><ul></ul></div>'), Bc = /* @__PURE__ */ $('<div><input type="text"></div>'), Fc = /* @__PURE__ */ $("<li></li>"), ur = (e) => {
  const [t, r] = T(!1), [n, a] = T("");
  let c, f;
  const h = W(() => {
  ...
  return (() => {
    const b = Ic.cloneNode(!0), w = b.firstChild, I = w.firstChild;
    ...
    return typeof P == "function" ? xt(P, b) : f = b, C(I, () => e.value), C(b, (() => {
      ...
      return () => oe() && (() => {
        const V = Ec.cloneNode(!0), K = V.firstChild;
        return V.$$click = (U) => U.stopPropagation(), V.$$mousedown = (U) => {
          U.preventDefault(), U.stopPropagation();
        }, C(V, (() => {
          const U = W(() => !!e.searchable);
          return () => U() && (() => {
            const he = Bc.cloneNode(!0), Z = he.firstChild;
      ...
      return oe._v$ = Bt(b, V, oe._v$), K !== oe._v$2 && me(b, oe._v$2 = K), oe;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), b;
...
const Uc = /* @__PURE__ */ $('<span class="prefix"></span>'), zc = /* @__PURE__ */ $('<span class="suffix"></span>'), Vc = /* @__PURE__ */ $('<div><input class="value"></div>'), gi = (e) => {
  const t = V0({
  ...
  const [n, a] = T("normal");
  return (() => {
    const c = Vc.cloneNode(!0), f = c.firstChild;
    return c.$$click = () => {
      r == null || r.focus();
    }, C(c, A(de, {
      get when() {
...
We(["click"]);
const Rc = /* @__PURE__ */ $('<div><i class="thumb"></i></div>'), yi = (e) => (() => {
  const t = Rc.cloneNode(!0);
  return t.$$click = (r) => {
...
We(["click"]);
let ue = null, p0 = !1;
const x1 = /* @__PURE__ */ new Map(), Kc = 500, v0 = 3;
function on(e) {
...
function Hc(e, t) {
  if (t)
    return !1;
  const r = Qc(e), n = Zc(e), a = x1.get(r) ?? 0;
  if (n > Math.max(v0, a)) {
    if (x1.set(r, n), x1.size > Kc) {
...
function Yc(e, t, r) {
  const n = r.style ?? Wt.Fill, a = r.color ?? "currentColor", c = dr(r.color) ?? dr(r.borderColor), f = n === Wt.Stroke, h = c ? Hc(t, f) : !1, v = Wn(a, h ? "wick" : "body", c), L = r.borderSize ?? 1, b = Wn(r.borderColor ?? a, "border", c), w = r.borderStyle ?? Ke.Solid, I = r.borderRadius ?? 0, P = r.borderDashedValue ?? [2, 2], oe = n === Wt.Fill || r.style === Wt.StrokeFill, V = n === Wt.Stroke || r.style === Wt.StrokeFill;
  if (oe) {
    e.fillStyle = v, qn(e, t, I), e.fill();
    const K = Wn(a, "border", c);
    !h && c && K && (e.strokeStyle = K, e.lineWidth = Math.max(1, L), e.setLineDash([]), qn(e, t, I), e.stroke());
  }
  V && (e.strokeStyle = b, e.lineWidth = L, e.setLineDash(w === Ke.Dashed ? P : []), qn(e, t, I), e.stroke());
}
function Wc() {
  p0 || (p0 = !0, la({
    name: "rect",
...
const d = (e, t) => {
  var r;
  return ((r = Ci[t]) == null ? void 0 : r[e]) ?? e;
  ...
  const te = W(() => {
    const E = e.periods.filter((F) => {
      ...
      if (F.text === ye || Te && F.text === Te)
        return !0;
      if (!Te || Te === ye) {
        const Ce = e.periods.find((Re) => Re.text !== ye);
  ...
  return Ye(() => {
    ...
    const E = Tf.cloneNode(!0), F = E.firstChild, ye = F.firstChild, Te = ye.firstChild, Ce = ye.nextSibling, Re = Ce.firstChild;
    return E.style.setProperty("position", "relative"), E.style.setProperty("width", "100%"), E.style.setProperty("display", "flex"), E.style.setProperty("align-items", "center"), C(E, A(de, {
      ...
      t = k;
    }, F), F.style.setProperty("width", "100%"), F.style.setProperty("overflow", "auto"), dt(Te, "click", e.onMenuClick, !0), C(F, A(de, {
      get when() {
        return e.symbol;
      },
      get children() {
        const k = gf.cloneNode(!0), pe = k.firstChild;
        return dt(k, "click", e.onSymbolClick, !0), C(k, A(de, {
          get when() {
      ...
      get children() {
        ...
        return dt(k, "click", e.onIndicatorClick, !0), C(Se, () => d("indicator", e.locale)), k;
      }
      ...
      get children() {
        const k = _f.cloneNode(!0), pe = k.firstChild, Se = pe.firstChild, mt = Se.nextSibling;
        return xt((Ae) => {
          r = Ae;
        }, k), k.style.setProperty("display", "flex"), k.style.setProperty("align-items", "center"), pe.$$click = (Ae) => {
          Ae.stopPropagation(), le();
        }, pe.style.setProperty("gap", "6px"), mt.style.setProperty("transition", "transform 0.2s ease"), C(k, A(de, {
          get when() {
            return v();
          },
          get children() {
            return A(Ya, {
              ...
              get children() {
                const Ae = $f.cloneNode(!0), Je = Ae.firstChild, gt = Je.firstChild, Ut = gt.firstChild, s1 = Ut.firstChild, l1 = s1.firstChild, S1 = gt.nextSibling, P1 = S1.firstChild, zt = P1.firstChild, D1 = zt.firstChild, N1 = P1.nextSibling, c1 = N1.firstChild, Ue = c1.firstChild, u1 = Je.nextSibling, $t = u1.firstChild, Vt = $t.firstChild, yt = Vt.firstChild, lt = yt.firstChild, O1 = $t.nextSibling, Ze = O1.firstChild;
                Ze.firstChild;
                const I1 = Ze.nextSibling, Pn = I1.firstChild, Tt = Pn.nextSibling, Ct = Tt.firstChild, Rt = Ct.firstChild, d1 = u1.nextSibling, Dn = d1.firstChild, E1 = Dn.firstChild, Nn = d1.nextSibling, B1 = Nn.nextSibling, Kt = B1.firstChild, h1 = Kt.firstChild, F1 = B1.nextSibling, U1 = F1.nextSibling, f1 = U1.firstChild, He = f1.firstChild, Qe = U1.nextSibling, qe = Qe.firstChild, Ge = qe.firstChild, m1 = Ge.firstChild, jt = m1.firstChild, g1 = qe.nextSibling, y1 = g1.firstChild, Me = y1.firstChild, Qt = Me.firstChild, ct = y1.nextSibling, pt = ct.firstChild, Mt = pt.firstChild, St = ct.nextSibling, et = St.firstChild, C1 = et.firstChild, z1 = Qe.nextSibling, V1 = z1.firstChild, R1 = V1.firstChild, On = z1.nextSibling, Be = On.firstChild, K1 = Be.firstChild;
                return Ae.$$mousedown = (_) => _.stopPropagation(), xt((_) => {
                  n = _;
                }, Ae), Ae.style.setProperty("position", "fixed"), Ae.style.setProperty("z-index", "9999"), gt.$$click = (_) => {
                ...
                }, yt.$$mousedown = (_) => _.stopPropagation(), yt.$$click = (_) => _.stopPropagation(), lt.addEventListener("change", (_) => {
                  var N;
                  ...
                  get children() {
                    ...
                    return C(_, () => ["left", "center", "right"].map((N) => (() => {
                      const Fe = Sf.cloneNode(!0);
                      return Fe.$$click = (ze) => {
                        var tt;
                        ze.preventDefault(), ze.stopPropagation(), (tt = e.onOrderToolsStateChange) == null || tt.call(e, {
                          openOrdersDisplay: N
                        }), V(!1);
                      }, C(Fe, () => b0(N)), R(() => {
                        var ze;
                        return me(Fe, (((ze = e.orderToolsState) == null ? void 0 : ze.openOrdersDisplay) ?? "right") === N ? "selected" : "");
                      }), Fe;
                    })())), _;
                  }
                  ...
                  const N = `${he().top}px`, Fe = `${he().left}px`, ze = `${he().minWidth}px`, tt = `klinecharts-pro-order-tools-group${b() ? " klinecharts-pro-order-tools-group-open" : ""}`, Pt = `klinecharts-pro-order-tools-group${I() ? " klinecharts-pro-order-tools-group-open" : ""}`, j1 = `klinecharts-pro-order-tools-display-arrow${oe() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, Q1 = `klinecharts-pro-order-tools-group${K() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return N !== _._v$ && Ae.style.setProperty("top", _._v$ = N), Fe !== _._v$2 && Ae.style.setProperty("left", _._v$2 = Fe), ze !== _._v$3 && Ae.style.setProperty("width", _._v$3 = ze), tt !== _._v$4 && me(Je, _._v$4 = tt), Pt !== _._v$5 && me(u1, _._v$5 = Pt), j1 !== _._v$6 && Ne(Rt, "class", _._v$6 = j1), Q1 !== _._v$7 && me(Qe, _._v$7 = Q1), _;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var _, N, Fe, ze;
                  return l1.checked = (((_ = e.orderToolsState) == null ? void 0 : _.quickOrderFloatingWindow) ?? ((N = e.orderToolsState) == null ? void 0 : N.quickOrder) ?? !0) || (((Fe = e.orderToolsState) == null ? void 0 : Fe.quickOrderPlusButton) ?? ((ze = e.orderToolsState) == null ? void 0 : ze.quickOrder) ?? !0);
                }), R(() => {
                  var _, N;
                  return D1.checked = ((_ = e.orderToolsState) == null ? void 0 : _.quickOrderFloatingWindow) ?? ((N = e.orderToolsState) == null ? void 0 : N.quickOrder) ?? !0;
                }), R(() => {
                  var _, N;
                  ...
                  var _;
                  return He.checked = ((_ = e.orderToolsState) == null ? void 0 : _.liquidationPrice) ?? !0;
                }), R(() => {
                  var _, N, Fe, ze, tt, Pt;
                  return jt.checked = (((_ = e.orderToolsState) == null ? void 0 : _.marketPriceLine) ?? ((N = e.orderToolsState) == null ? void 0 : N.priceLine) ?? !0) || (((Fe = e.orderToolsState) == null ? void 0 : Fe.countDown) ?? ((ze = e.orderToolsState) == null ? void 0 : ze.priceLine) ?? !0) || (((tt = e.orderToolsState) == null ? void 0 : tt.bidAskPrice) ?? ((Pt = e.orderToolsState) == null ? void 0 : Pt.priceLine) ?? !0);
                }), R(() => {
                  var _, N;
                  return Qt.checked = ((_ = e.orderToolsState) == null ? void 0 : _.marketPriceLine) ?? ((N = e.orderToolsState) == null ? void 0 : N.priceLine) ?? !0;
                }), R(() => {
                  var _, N;
                  return Mt.checked = ((_ = e.orderToolsState) == null ? void 0 : _.countDown) ?? ((N = e.orderToolsState) == null ? void 0 : N.priceLine) ?? !0;
                }), R(() => {
                  var _, N;
                  return C1.checked = ((_ = e.orderToolsState) == null ? void 0 : _.bidAskPrice) ?? ((N = e.orderToolsState) == null ? void 0 : N.priceLine) ?? !0;
                }), R(() => {
                  var _;
          ...
          const Je = a() ? "0 8px" : "0 10px", gt = v() ? "rotate(180deg)" : "rotate(0deg)";
          return Je !== Ae._v$8 && pe.style.setProperty("padding", Ae._v$8 = Je), gt !== Ae._v$9 && mt.style.setProperty("transform", Ae._v$9 = gt), Ae;
        }, {
          _v$8: void 0,
          _v$9: void 0
        }), k;
      ...
      return pe !== k._v$10 && Ne(Te, "class", k._v$10 = pe), Se !== k._v$11 && Ce.style.setProperty("padding-right", k._v$11 = Se), k;
    }, {
      _v$10: void 0,
      _v$11: void 0
    }), E;
    ...
    return C(Y, () => J().map((D) => (() => {
      ...
      return E.addEventListener("blur", () => {
        ...
        return () => Ce() && A(bn, {
          class: "list",
          get children() {
            return D.list.map((Re) => (() => {
              const k = $0.cloneNode(!0), pe = k.firstChild;
              return k.$$click = () => {
                D.setter(Re.key), e.onDrawingItemClick({
                  name: Re.key,
                  lock: V(),
                  mode: P()
                }), X("");
      ...
      return () => D() && A(bn, {
        ...
        get children() {
          return ve().map((E) => (() => {
            const F = $0.cloneNode(!0), ye = F.firstChild;
            return F.$$click = () => {
...
We(["click"]);
const k0 = /* @__PURE__ */ $('<li class="title"></li>'), x0 = /* @__PURE__ */ $('<li class="row"></li>'), hg = (e) => A(At, {
  get title() {
...
const gg = /* @__PURE__ */ $('<div class="chart-style-color-picker"><button type="button" class="chart-style-color-swatch"></button></div>'), yg = /* @__PURE__ */ $('<div class="chart-style-color-popover"><div class="chart-style-color-grid"></div></div>'), Cg = /* @__PURE__ */ $('<button type="button" class="chart-style-palette-color"></button>'), pg = /* @__PURE__ */ $('<div class="chart-style-line-control"><div class="chart-style-width-picker"><button type="button" class="chart-style-size-button"><span></span></button></div></div>'), vg = /* @__PURE__ */ $('<div class="chart-style-width-popover"></div>'), bg = /* @__PURE__ */ $('<button type="button"><span></span></button>'), $g = /* @__PURE__ */ $('<div class="klinecharts-pro-setting-modal-title-tabs"><button type="button"></button><button type="button">Chart Style</button></div>'), _g = /* @__PURE__ */ $('<div class="klinecharts-pro-setting-modal-content"></div>'), kg = /* @__PURE__ */ $('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), xg = /* @__PURE__ */ $('<div class="klinecharts-pro-chart-style-content"><div class="chart-style-sidebar"><button type="button">Symbol</button><button type="button">Background</button></div><div class="chart-style-panel"><p class="chart-style-note">* Chart Style takes precedence over default chart settings. Click Reset to align with the default theme.</p></div></div>'), Lg = /* @__PURE__ */ $("<h3>Symbol</h3>"), wg = /* @__PURE__ */ $('<div class="chart-style-row"><span>Candle Stick</span><div class="chart-style-color-pair"></div></div>'), Ag = /* @__PURE__ */ $('<div class="chart-style-row"><span>Borders</span><div class="chart-style-color-pair"></div></div>'), Tg = /* @__PURE__ */ $('<div class="chart-style-row"><span>Wick</span><div class="chart-style-color-pair"></div></div>'), Mg = /* @__PURE__ */ $("<h3>Background</h3>"), Sg = /* @__PURE__ */ $('<div class="chart-style-row"><span>Color</span></div>'), Pg = /* @__PURE__ */ $('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Vert Grid Lines</span></label></div>'), Dg = /* @__PURE__ */ $('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Horz Grid Lines</span></label></div>'), T1 = "chart.backgroundColor", $n = "#171a27", Ng = ["#f6465d", "#f59e0b", "#fcd535", "#2ebd85", "#4098a8", "#22c1dc", "#3861fb", "#7b3fe4", "#ec8aa4", "#f7c56b", "#fff0a3", "#9ed4a4", "#83c7bb", "#8bdce6", "#8bb9f7", "#b7a1dc", "#c9343e", "#e76f20", "#f0b93a", "#3f8d3a", "#236e5a", "#237c88", "#1d3fbf", "#3a209f", "#ffffff", "#cbd5e1", "#9ca3af", "#6b7280", "#374151", "#111827", "#000000"], Og = [{
  ...
  return Ie(r, "candle.bar.upBorderColor", O.formatValue(r, "candle.bar.upBorderColor", n)), Ie(r, "candle.bar.downBorderColor", O.formatValue(r, "candle.bar.downBorderColor", a)), Ie(r, "candle.bar.noChangeBorderColor", O.formatValue(r, "candle.bar.noChangeBorderColor", c)), Ie(r, "candle.bar.upWickColor", O.formatValue(r, "candle.bar.upWickColor", n)), Ie(r, "candle.bar.downWickColor", O.formatValue(r, "candle.bar.downWickColor", a)), Ie(r, "candle.bar.noChangeWickColor", O.formatValue(r, "candle.bar.noChangeWickColor", c)), Ie(r, "candle.bar.borderUpColor", O.formatValue(r, "candle.bar.borderUpColor", O.formatValue(r, "candle.bar.upBorderColor"))), Ie(r, "candle.bar.borderDownColor", O.formatValue(r, "candle.bar.borderDownColor", O.formatValue(r, "candle.bar.downBorderColor"))), Ie(r, "candle.bar.borderNoChangeColor", O.formatValue(r, "candle.bar.borderNoChangeColor", O.formatValue(r, "candle.bar.noChangeBorderColor"))), Ie(r, "candle.bar.wickUpColor", O.formatValue(r, "candle.bar.wickUpColor", O.formatValue(r, "candle.bar.upWickColor"))), Ie(r, "candle.bar.wickDownColor", O.formatValue(r, "candle.bar.wickDownColor", O.formatValue(r, "candle.bar.downWickColor"))), Ie(r, "candle.bar.wickNoChangeColor", O.formatValue(r, "candle.bar.wickNoChangeColor", O.formatValue(r, "candle.bar.noChangeWickColor"))), Ie(r, T1, t), r;
}, Eg = (e, t, r) => {
  if (t === T1)
    return r ?? $n;
  const a = {
  ...
  return a ? O.formatValue(e, a) : O.formatValue(e, t, O.formatValue(pi(e), t));
}, Bg = (e) => {
  const [t, r] = T(e.currentStyles), [n, a] = T(pi(e.currentStyles, e.currentBackgroundColor ?? $n)), [c, f] = T(w0(e.locale)), [h, v] = T(!1), [L, b] = T("settings"), [w, I] = T("symbol"), [P, oe] = T(null), [V, K] = T(null), U = () => {
  ...
  const he = (M, j) => {
    ...
    Ie(Q, M.key, j);
    const z = O.clone(t());
    Ie(z, M.key, j), r(z), f(c().map((le) => ({
      ...le
    }))), e.onChange(Q);
  }, Z = (M, j) => O.formatValue(n(), M, j), X = (M, j) => {
    const Q = O.clone(n());
    Ie(Q, M, j), a(Q), e.onChange(J(Q));
  }, J = (M) => {
    ...
    return {
      chart: {
        backgroundColor: O.formatValue(M, T1, $n)
      },
      candle: {
    ...
    if (M) {
      const Q = O.clone(n());
      A0.forEach((z) => {
        Ie(Q, z.key, Eg(M, z.key, e.defaultBackgroundColor));
      }), a(Q), r(O.clone(Q)), e.onChange(J(Q));
    } else
      e.onRestoreDefault(A0), a(O.clone(e.currentStyles));
  }, H = (M, j = M) => {
    const Q = Z(M, "#ffffff");
    return (() => {
      ...
      return W(() => L() === "settings")() ? (() => {
        ...
        return Q.$$click = () => I("symbol"), z.$$click = () => I("background"), C(le, (() => {
          ...
          return () => re() ? [Lg.cloneNode(!0), (() => {
            ...
            return B.firstChild, C(B, () => H(T1, "chart-background"), null), B;
          })(), (() => {
...
const Fg = /* @__PURE__ */ $('<img style="width:500px;margin-top: 20px">'), Ug = (e) => A(At, {
  ...
  const [t, r] = T(""), [n] = Oa(t, e.datafeed.searchSymbols.bind(e.datafeed));
  return A(At, {
    get title() {
...
const qg = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-picker"></div>'), Gg = /* @__PURE__ */ $('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), Xg = /* @__PURE__ */ $("<span></span>"), Jg = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), ey = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-grid"></div>'), ty = /* @__PURE__ */ $('<span class="weekday"></span>'), It = /* @__PURE__ */ $('<button type="button"></button>'), ny = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid"></div>'), ry = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), oy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), iy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-content"></div>'), ay = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-tabs"></div>'), sy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), ly = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), cy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), uy = [{
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], dy = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], T0 = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], Gt = (e) => String(e).padStart(2, "0"), M0 = (e, t, r) => Math.min(r, new Date(e, t + 1, 0).getDate()), Gn = (e) => {
  const t = new Date(e);
  return {
    year: t.getFullYear(),
    month: t.getMonth(),
  ...
  const [t, r] = T(!0), [n, a] = T("date"), [c, f] = T(e.value.year), [h, v] = T(e.value.month), L = W(() => hy(c(), h())), b = W(() => Math.floor(c() / 10) * 10), w = W(() => Array.from({
    ...
    v(Y), e.onChange({
      ...
      year: c(),
      month: Y,
      day: M0(c(), Y, e.value.day)
    }), a("date");
  }, X = (Y) => {
    f(Y), e.onChange({
      ...e.value,
      year: Y,
      day: M0(Y, e.value.month, e.value.day)
    }), a("month");
  }, J = (Y) => {
    const H = P() === "PM";
    e.onChange({
  ...
  return (() => {
    ...
    return C(Y, (() => {
      ...
      return () => H() && (() => {
        ...
        })(), se), se.$$click = () => r(!t()), C(M, () => hr(e.value)), ee;
      })();
    })(), null), C(Y, (() => {
      const H = W(() => !!t());
      return () => H() && (() => {
        ...
        return M.$$click = () => {
          ...
          return () => ce() && (() => {
            ...
            return C(re, () => dy.map((B) => (() => {
              ...
              const D = Xn({
                ...
                month: B.getMonth(),
                day: B.getDate()
              }), E = e.range ? Xn(e.range.from) : NaN, F = e.range ? Xn(e.range.to) : NaN, ye = Math.min(E, F), Te = Math.max(E, F), Ce = Number.isFinite(ye) && D >= ye && D <= Te, Re = Number.isFinite(ye) && (D === ye || D === Te), k = B.getFullYear() === e.value.year && B.getMonth() === e.value.month && B.getDate() === e.value.day;
              return (() => {
                const pe = It.cloneNode(!0);
                return pe.$$click = () => he(B), me(pe, `${te ? "" : "muted"} ${Ce ? "in-range" : ""} ${Re || k ? "selected" : ""}`), C(pe, () => B.getDate()), pe;
              })();
            }), null), re;
          })();
        })(), null), C(ee, (() => {
          ...
          return () => ce() && (() => {
            ...
            return C(re, () => T0.map((B, te) => (() => {
              const D = It.cloneNode(!0);
              return D.$$click = () => Z(te), C(D, B), R(() => me(D, te === e.value.month && c() === e.value.year ? "selected" : "")), D;
            })())), re;
          })();
        })(), null), C(ee, (() => {
          const ce = W(() => n() === "year");
          return () => ce() && (() => {
            ...
            return C(re, () => w().map((B) => (() => {
              ...
              return te.$$click = () => X(B), C(te, B), R(() => me(te, `${B < b() || B > b() + 9 ? "muted" : ""} ${B === e.value.year ? "selected" : ""}`)), te;
            })())), re;
          })();
        })(), null), C(ee, (() => {
          const ce = W(() => n() === "date");
          return () => ce() && (() => {
            ...
            return C(B, () => oe.map((E) => (() => {
              ...
              return F.$$click = () => J(E), C(F, () => Gt(E)), R(() => me(F, E === I() ? "selected" : "")), F;
            })())), C(te, () => V.map((E) => (() => {
              const F = It.cloneNode(!0);
              return F.$$click = () => e.onChange({
                ...e.value,
                minute: E
              }), C(F, () => Gt(E)), R(() => me(F, E === e.value.minute ? "selected" : "")), F;
            })())), C(D, () => ["AM", "PM"].map((E) => (() => {
              const F = It.cloneNode(!0);
              return F.$$click = () => ve(E), C(F, E), R(() => me(F, E === P() ? "selected" : "")), F;
            })())), re;
          })();
        })(), null), ee;
      })();
  ...
  const [t, r] = T(e.initialTab ?? "goToDate"), [n, a] = T(Gn(e.initialTimestamp)), [c, f] = T(Gn(e.initialRange.from)), [h, v] = T(Gn(e.initialRange.to)), [L, b] = T("from"), [w, I] = T({
    ...e.anchorSettings,
    ...
    if (V === "goToDate")
      ...
      e.onTimeAnchorChange({
        ...K,
        timestamp: K.anchorPoint === "date" ? an(n()) : K.timestamp
      });
    }
    e.onClose();
  };
    ...
    get title() {
      return (() => {
        ...
        return C(V, () => uy.map((K) => (() => {
          ...
          return U.$$click = () => r(K.key), C(U, () => K.label), R(() => me(U, t() === K.key ? "active" : "")), U;
        })())), V;
      })();
    },
    get buttons() {
    ...
    get children() {
      ...
      return C(V, (() => {
        ...
        return () => K() && (() => {
          ...
          return Z.$$click = () => b("from"), C(Z, () => hr(c())), J.$$click = () => b("to"), C(J, () => hr(h())), C(U, (() => {
            const ve = W(() => L() === "from");
            return () => ve() ? A(sn, {
              label: "Start",
              get value() {
            ...
            return Y !== ve._v$ && me(Z, ve._v$ = Y), H !== ve._v$2 && me(J, ve._v$2 = H), ve;
          }, {
            _v$: void 0,
            _v$2: void 0
          }), U;
        ...
        return () => K() && (() => {
          ...
          return X.$$click = () => P({
            ...
            return le !== z._v$3 && me(X, z._v$3 = le), ce !== z._v$4 && me(J, z._v$4 = ce), re !== z._v$5 && (Y.disabled = z._v$5 = re), B !== z._v$6 && me(H, z._v$6 = B), te !== z._v$7 && me(se, z._v$7 = te), D !== z._v$8 && (se.disabled = z._v$8 = D), E !== z._v$9 && me(M, z._v$9 = E), F !== z._v$10 && me(Q, z._v$10 = F), ye !== z._v$11 && (Q.disabled = z._v$11 = ye), z;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
Wc();
const Jn = "klinecharts_pro_chart_style", er = "klinecharts_pro_chart_background_color", fr = "klinecharts_pro_time_anchor_settings", tr = "candle_pane", Ny = 0.08, Oy = 80, S0 = 2e-3, Iy = /* @__PURE__ */ new Set(["horizontalRayLine", "horizontalSegment", "horizontalStraightLine", "orderLine", "priceLine"]);
function vi() {
  return {
    enabled: !1,
    timestamp: Date.now(),
...
const Fy = (e) => {
  ...
  const [c, f] = T(!1), [h, v] = T(e.theme), [L, b] = T(e.styles), [w, I] = T(e.locale), [P, oe] = T(e.symbol), [V, K] = T(e.period), U = () => {
    ...
    return s;
  }, [Te, Ce] = T(""), [Re, k] = T(!1), [pe, Se] = T(Date.now()), [mt, Ae] = T({
    from: Date.now() - 30 * 24 * 60 * 60 * 1e3,
    to: Date.now()
  }), [Je, gt] = T(Ey() ?? vi()), [Ut, s1] = T(e.drawingBarVisible), [l1, S1] = T(!1), [P1, zt] = T(!1), [D1, N1] = T(!1), c1 = ((oo = e.orderTools) == null ? void 0 : oo.quickOrder) ?? !0, [Ue, u1] = T({
    quickOrder: c1,
  ...
  let Me = /* @__PURE__ */ new Map(), Qt = /* @__PURE__ */ new Map(), ct, pt, Mt = null, St;
  const [et, C1] = T(!0), [z1, V1] = T(null), [R1, On] = T(null);
  ...
  const K1 = (o, i, s) => {
    ...
    var o, i;
    return (i = (o = N()) == null ? void 0 : o.getAxisComponent) == null ? void 0 : i.call(o);
  }, ze = () => {
    var l, u;
    ...
    return Math.abs(o.minPrice - i.minPrice) <= s * S0 && Math.abs(o.maxPrice - i.maxPrice) <= s * S0;
  }, Tr = (o, i) => {
    var g, p, x, S;
    const s = Fe();
    ...
    !o && Mt && _i(i, Mt) || (Tr(i, !0), Mt = i, nt());
  }, we = (o = !1) => {
    !et() || typeof window > "u" || (ct && window.clearTimeout(ct), ct = window.setTimeout(() => {
      ct = void 0, pt && window.cancelAnimationFrame(pt), pt = window.requestAnimationFrame(() => {
        pt = void 0, ki(o);
      });
    }, o ? 0 : Oy));
  }, Z1 = () => {
    var o, i;
    V1(null), C1(!0), (i = (o = Fe()) == null ? void 0 : o.setAutoCalcTickFlag) == null || i.call(o, !0), we(!0);
  }, In = () => {
    const o = ze();
    o && (V1(o), Tr(o, !1)), C1(!1);
  }, xi = () => {
    ...
    var g;
    const o = (g = n == null ? void 0 : n.getDom) == null ? void 0 : g.call(n, tr, st.YAxis);
  ...
  const En = () => {
    ...
    }), Me.clear(), Be.clear(), Qe(null), Ge(null), Dt.loadDrawings(o).forEach((s) => {
      var l;
      try {
        const u = b1({
          name: s.type,
    ...
    o && ((i = n == null ? void 0 : n.removeOverlay) == null || i.call(n, {
      id: o
    }), Me.delete(o), Be.delete(o), d1(null));
  }, Ti = (o) => {
    var g, p;
    ...
    m && (Me.delete(m), Be.delete(m), d1(m));
  }, H1 = (o) => {
    var s;
    ...
    const u = (it = n.convertToPixel) == null ? void 0 : it.call(n, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((at = u == null ? void 0 : u[0]) == null ? void 0 : at.y), m = (Oo = n.getSize) == null ? void 0 : Oo.call(n, "candle_pane"), g = (m == null ? void 0 : m.height) ?? t.clientHeight;
    ...
    }), S = (Eo = n.getSize) == null ? void 0 : Eo.call(n, "candle_pane", st.YAxis), ne = S != null && S.width && Number.isFinite(S.width) ? Math.max(74, Math.floor(S.width) - 2) : 96, ie = cn(V()), ae = o % ie, q = ae === 0 ? ie : ie - ae, fe = Number(s.close), $e = Number(s.open), _e = n.getStyles().candle.priceMark.last, Pe = _e.text, G = Number(Pe.size) || 12, ke = Number(Pe.paddingTop) || 2, ge = Number(Pe.paddingBottom) || 2, De = Math.min(Number(Pe.paddingLeft) || 4, 3), Oe = Math.min(Number(Pe.paddingRight) || 4, 3), rt = Math.max(34, G * 2 + ke + ge + 6), ut = Math.max(0, Math.min(y - rt / 2, g - rt));
    Kt({
      top: ut,
      width: Math.min(ne, Math.max(62, x.length * (G * 0.56) + De + Oe + 4)),
      priceText: x,
      text: By(q),
    ...
    const s = Number(o.y), l = Si(o), u = t.clientHeight;
    ...
    return (!i || ((l = He()) == null ? void 0 : l.id) === i) && (Qe(null), Ge(null)), !1;
  }, b1 = (o) => {
    ...
    if (!yt())
      return;
    const i = o.target;
    (s = i == null ? void 0 : i.closest) != null && s.call(i, ".klinecharts-pro-quick-order-marker") || (l = i == null ? void 0 : i.closest) != null && l.call(i, ".klinecharts-pro-quick-order-menu-anchor") || Vi();
  };
  ...
  Ye(() => {
    var fe, $e, _e, Pe, G, ke, ge, De, Oe, rt, ut, ot, it, at;
    const o = (fe = e.orderTools) == null ? void 0 : fe.quickOrder, i = ($e = e.orderTools) == null ? void 0 : $e.quickOrderFloatingWindow, s = (_e = e.orderTools) == null ? void 0 : _e.quickOrderPlusButton, l = (Pe = e.orderTools) == null ? void 0 : Pe.openOrders, u = (G = e.orderTools) == null ? void 0 : G.openOrdersExtendedPriceLine, y = (ke = e.orderTools) == null ? void 0 : ke.openOrdersDisplay, m = (ge = e.orderTools) == null ? void 0 : ge.positions, g = (De = e.orderTools) == null ? void 0 : De.breakevenPrice, p = (Oe = e.orderTools) == null ? void 0 : Oe.liquidationPrice, x = (rt = e.orderTools) == null ? void 0 : rt.priceLine, S = (ut = e.orderTools) == null ? void 0 : ut.marketPriceLine, ne = (ot = e.orderTools) == null ? void 0 : ot.countDown, ie = (it = e.orderTools) == null ? void 0 : it.bidAskPrice, ae = (at = e.orderTools) == null ? void 0 : at.orderHistory, q = {};
    typeof o == "boolean" && o !== Or && (Or = o, q.quickOrder = o, typeof i != "boolean" && (q.quickOrderFloatingWindow = o), typeof s != "boolean" && (q.quickOrderPlusButton = o)), typeof i == "boolean" && i !== Ir && (Ir = i, q.quickOrderFloatingWindow = i), typeof s == "boolean" && s !== Er && (Er = s, q.quickOrderPlusButton = s), typeof l == "boolean" && l !== Br && (Br = l, q.openOrders = l), typeof u == "boolean" && u !== Fr && (Fr = u, q.openOrdersExtendedPriceLine = u), y !== void 0 && y !== Ur && (Ur = y, q.openOrdersDisplay = y), typeof m == "boolean" && m !== zr && (zr = m, q.positions = m), typeof g == "boolean" && g !== Vr && (Vr = g, q.breakevenPrice = g), typeof p == "boolean" && p !== Rr && (Rr = p, q.liquidationPrice = p), typeof x == "boolean" && x !== Kr && (Kr = x, q.priceLine = x, typeof S != "boolean" && (q.marketPriceLine = x), typeof ne != "boolean" && (q.countDown = x), typeof ie != "boolean" && (q.bidAskPrice = x)), typeof S == "boolean" && S !== jr && (jr = S, q.marketPriceLine = S), typeof ne == "boolean" && ne !== Qr && (Qr = ne, q.countDown = ne), typeof ie == "boolean" && ie !== Zr && (Zr = ie, q.bidAskPrice = ie), typeof ae == "boolean" && ae !== Hr && (Hr = ae, q.orderHistory = ae), Object.keys(q).length > 0 && Bn(q);
  }), Ye(() => {
    ...
    getSettings: () => {
      var s, l, u, y, m, g, p, x, S, ne, ie, ae, q, fe, $e, _e;
      if (!n)
        return {};
    ...
    setSettings: (o) => {
      var s, l, u, y, m, g, p, x, S, ne, ie, ae, q, fe;
      if (!n)
        return;
      const i = {};
    ...
    setAutoScalePriceLines: (o, i = []) => {
      ...
      l.length > 0 ? Qt.set(s, l) : Qt.delete(s), we(!0);
    },
    // === Drawing Methods ===
    saveDrawings: (o) => {
      const i = Array.from(Me.values());
  ...
  const Ri = () => {
    ...
    we(), nt(), Jr(), _t(), Ki();
  }, Gr = [Nt.OnVisibleRangeChange, Nt.OnZoom, Nt.OnScroll], ji = (o) => {
    ...
    if (!n || !t)
      return null;
    const i = Qi(o), s = i == null ? void 0 : i.candle, l = Number((s == null ? void 0 : s.timestamp) ?? o), u = Number((s == null ? void 0 : s.high) ?? (s == null ? void 0 : s.close) ?? (s == null ? void 0 : s.open)), y = i ? G1(i.dataIndex) : void 0, m = i && Number.isFinite(u) ? {
      dataIndex: y,
      value: u
    } : {
      timestamp: l
    ...
    var i;
    !n || !Number.isFinite(o) || ((i = n.scrollToTimestamp) == null || i.call(n, o, 250), requestAnimationFrame(() => X1(o)), nt());
  }, eo = (o, i = "floor") => {
    var y, m, g;
    ...
    const u = (S = n.convertFromPixel) == null ? void 0 : S.call(n, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((ne = u == null ? void 0 : u[0]) == null ? void 0 : ne.dataIndex), m = Math.max(0, Math.min(l.length - 1, Number.isFinite(y) ? Math.round(y) : -1)), g = Zi(i);
    if (g) {
      const fe = G1(g.dataIndex), $e = (ie = n.convertToPixel) == null ? void 0 : ie.call(n, [{
        dataIndex: fe
      }], {
        paneId: "candle_pane",
        absolute: !0
    ...
    const s = ta(i), l = (S = n.getDom) == null ? void 0 : S.call(n, "candle_pane", st.Main), u = (ne = l == null ? void 0 : l.getBoundingClientRect) == null ? void 0 : ne.call(l), y = (ie = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : ie.call(r), m = (ae = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : ae.call(t), g = n.getSize("candle_pane", st.Main), p = u && Number.isFinite(u.top) ? u.top - ((y == null ? void 0 : y.top) ?? (m == null ? void 0 : m.top) ?? 0) : 0, x = Math.max(1, (u == null ? void 0 : u.height) ?? (g == null ? void 0 : g.height) ?? 0);
    if (s === null) {
      f1(null);
      return;
    }
    ...
    if (n) {
      ...
      try {
        const s = V(), l = o.from <= o.to ? o : {
          from: o.to,
          to: o.from
        }, u = Wi(l), y = i ? u : Ji(u, s), m = await e.datafeed.getHistoryKLineData(P(), s, y.from, y.to), g = qi(m, u);
        n.applyNewData(m, m.length > 0), we(!0), Ae(u), requestAnimationFrame(() => {
          const p = Xi(m, u);
          i ? Kn(i) : (ea(g), n == null || n.scrollToDataIndex(p, 0), X1(Gi(g, u))), _t();
        });
      } finally {
        f(!1), zt(!1);
      }
    ...
    Se(o), await ro(Hi(o), o);
  }, ra = (o) => {
    const s = {
      ...o,
      timestamp: (() => !n || o.anchorPoint === "date" ? o.timestamp : to(o.anchorPoint, o.timestamp))()
    };
    gt(s), P0(s), s.enabled ? (Se(s.timestamp), requestAnimationFrame(() => {
      no(s), _t(s);
    })) : requestAnimationFrame(() => _t(s));
  };
  gr(() => {
    if (window.addEventListener("resize", Yr), n = ca(t, {
      customApi: {
        formatDate: (m, g, p, x) => {
          switch (V().timespan) {
            case "minute":
              return x === en.XAxis ? O.formatDate(m, g, "HH:mm") : O.formatDate(m, g, "YYYY-MM-DD HH:mm");
            case "hour":
              return x === en.XAxis ? O.formatDate(m, g, "MM-DD HH:mm") : O.formatDate(m, g, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return O.formatDate(m, g, "YYYY-MM-DD");
            case "month":
              return x === en.XAxis ? O.formatDate(m, g, "YYYY-MM") : O.formatDate(m, g, "YYYY-MM-DD");
            case "year":
              return x === en.XAxis ? O.formatDate(m, g, "YYYY") : O.formatDate(m, g, "YYYY-MM-DD");
          }
      ...
      a = document.createElement("span"), a.className = "klinecharts-pro-price-unit", g == null || g.appendChild(a), St = Li(), we(!0);
    }
    let o = !1;
    const i = () => {
      const m = P();
    ...
    n && l && (n.removeOverlay = function(...m) {
      ...
      if (typeof p == "string" ? x = p : p && typeof p == "object" && p.id && (x = p.id), x) {
        Me.delete(x);
        const S = Be.get(x);
        S && (S.checkInterval && clearInterval(S.checkInterval), S.mouseUpHandler && (document.removeEventListener("mouseup", S.mouseUpHandler), document.removeEventListener("touchend", S.mouseUpHandler)), Be.delete(x)), i(), we(!0);
      }
      return g;
    }), X().forEach((m) => {
      ln(n, m, !0, {
    ...
    e.subIndicators.forEach((m) => {
      ...
      f(!0), (async () => {
        try {
          const p = V(), [x] = Rn(p, m, 1), [S] = Rn(p, x, 500), ne = await e.datafeed.getHistoryKLineData(P(), p, S, x);
        ...
        switch (m.iconId) {
          ...
          case "close":
            if (m.paneId === "candle_pane") {
              const g = [...X()];
              n == null || n.removeIndicator("candle_pane", m.indicatorName), we(!0), g.splice(g.indexOf(m.indicatorName), 1), J(g), _(m.indicatorName, "candle_pane", "main", "remove");
            } else {
              const g = {
                ...ve()
              };
              n == null || n.removeIndicator(m.paneId, m.indicatorName), we(!0), delete g[m.indicatorName], Y(g), _(m.indicatorName, m.paneId, "sub", "remove");
            }
        }
    }), n == null || n.subscribeAction(Nt.OnCrosshairChange, Pr), Gr.forEach((m) => {
      n == null || n.subscribeAction(m, qr);
    }), Y1 = window.setInterval(() => nt(), 1e3), nt(), document.addEventListener("mousedown", Nr);
    ...
    n && y && (n.createOverlay = function(...m) {
      ...
      return x && !((S = g.extendData) != null && S.isOrderPreviewLine) && (wi(x, g.name || "unknown"), v1(x), En(), we(!0)), p;
    });
  }), Lt(() => {
    ...
    }), Y1 && (window.clearInterval(Y1), Y1 = void 0), W1 && (window.clearTimeout(W1), W1 = void 0), ct && (window.clearTimeout(ct), ct = void 0), pt && (window.cancelAnimationFrame(pt), pt = void 0), St == null || St(), St = void 0, document.removeEventListener("mousedown", Nr), Be.clear(), Me.clear(), Bo(t);
  }), Ye(() => {
    const o = P();
  ...
  return Ye((o) => {
    ...
    return Lt(() => {
      ...
      try {
        const y = ht(Je), m = y.enabled && (!o || o.symbol.ticker === i.ticker || y.acrossTokens), g = m ? Yi(y, s) : null, [p, x] = g ? [g.from, g.to] : Rn(s, (/* @__PURE__ */ new Date()).getTime(), 500), S = await e.datafeed.getHistoryKLineData(i, s, p, x);
        if (!l)
          return;
        n == null || n.applyNewData(S, S.length > 0), we(!0), m ? requestAnimationFrame(() => {
          no(y), _t(y);
        }) : _t(), nt(), setTimeout(() => {
          l && (Ai(i == null ? void 0 : i.ticker), nt());
    ...
    if (L()) {
      kt(L()), n == null || n.setStyles(L()), le(vc(n.getStyles()));
      const o = ce();
      if (o) {
        F(o);
        const i = ye(o);
    ...
    onMenuClick: async () => {
      try {
        await Ia(() => s1(!Ut())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    return o.addEventListener("mouseleave", () => {
      ...
      l.preventDefault(), l.stopPropagation(), xi();
    }, i.$$mousedown = (l) => {
      ...
      children: (l) => (() => {
        ...
        return u.style.setProperty("right", "0px"), C(y, () => l.priceText), C(m, () => l.text), R((g) => {
          const p = `${l.top}px`, x = `${l.width}px`, S = l.color, ne = `${l.borderRadius}px`, ie = l.textFamily, ae = l.textWeight, q = `${l.paddingLeft}px`, fe = `${l.paddingRight}px`, $e = `${l.paddingTop}px`, _e = `${l.paddingBottom}px`, Pe = `${l.textSize}px`, G = `${Math.max(10, l.textSize - 1)}px`;
          return p !== g._v$11 && u.style.setProperty("top", g._v$11 = p), x !== g._v$12 && u.style.setProperty("width", g._v$12 = x), S !== g._v$13 && u.style.setProperty("background", g._v$13 = S), ne !== g._v$14 && u.style.setProperty("border-radius", g._v$14 = ne), ie !== g._v$15 && u.style.setProperty("font-family", g._v$15 = ie), ae !== g._v$16 && u.style.setProperty("font-weight", g._v$16 = ae), q !== g._v$17 && u.style.setProperty("padding-left", g._v$17 = q), fe !== g._v$18 && u.style.setProperty("padding-right", g._v$18 = fe), $e !== g._v$19 && u.style.setProperty("padding-top", g._v$19 = $e), _e !== g._v$20 && u.style.setProperty("padding-bottom", g._v$20 = _e), Pe !== g._v$21 && y.style.setProperty("font-size", g._v$21 = Pe), G !== g._v$22 && m.style.setProperty("font-size", g._v$22 = G), g;
        }, {
          _v$11: void 0,
          _v$12: void 0,
          _v$13: void 0,
      ...
      keyed: !0,
      children: (l) => (() => {
        const u = wy.cloneNode(!0), y = u.firstChild, m = y.nextSibling, g = m.nextSibling, p = g.firstChild, x = g.nextSibling, S = x.firstChild, ne = S.firstChild, ie = ne.nextSibling, ae = ie.firstChild, q = x.nextSibling, fe = q.firstChild, $e = q.nextSibling, _e = $e.nextSibling, Pe = _e.nextSibling;
        return u.$$click = (G) => {
          G.stopPropagation();
        }, u.$$mousedown = (G) => {
          G.preventDefault(), G.stopPropagation();
        }, y.$$mousedown = zi, m.$$click = Fi, p.$$click = () => Ge(qe() === "color" ? null : "color"), C(g, A(de, {
          get when() {
            return qe() === "color";
          },
          get children() {
            ...
            return C(ke, A(A1, {
              ...
              children: (ge) => (() => {
                ...
                return De.$$click = () => Ui(ge), De.style.setProperty("background", ge), R(() => me(De, `overlay-toolbar-color-swatch ${l.color.toLowerCase() === ge.toLowerCase() ? "selected" : ""}`)), De;
              })()
            })), G;
          }
          ...
          get children() {
            ...
            return C(G, A(A1, {
              ...
              children: (ke) => (() => {
                ...
                return ge.$$click = () => Bi(ke), De.style.setProperty("height", `${ke}px`), R(() => me(ge, l.lineSize === ke ? "selected" : "")), ge;
              })()
            })), G;
          }
          ...
          get children() {
            ...
            return ke.$$click = () => Vn(Ke.Solid, []), ge.$$click = () => Vn(Ke.Dashed, [6, 4]), De.$$click = () => Vn(Ke.Dashed, [2, 4]), R((Oe) => {
              var it, at;
              const rt = l.lineStyle === Ke.Solid ? "selected" : "", ut = l.lineStyle === Ke.Dashed && ((it = l.dashedValue) == null ? void 0 : it[0]) === 6 ? "selected" : "", ot = l.lineStyle === Ke.Dashed && ((at = l.dashedValue) == null ? void 0 : at[0]) === 2 ? "selected" : "";
              return rt !== Oe._v$23 && me(ke, Oe._v$23 = rt), ut !== Oe._v$24 && me(ge, Oe._v$24 = ut), ot !== Oe._v$25 && me(De, Oe._v$25 = ot), Oe;
            }, {
              _v$23: void 0,
              _v$24: void 0,
              _v$25: void 0
        ...
        }), null), $e.$$click = Ei, _e.$$click = Ii, Pe.$$click = Oi, R((G) => {
          const ke = `${l.x}px`, ge = `${l.y}px`, De = `overlay-toolbar-icon edit ${qe() === "color" ? "active" : ""}`, Oe = `overlay-toolbar-line-size ${qe() === "width" ? "active" : ""}`, rt = `overlay-toolbar-icon minus ${qe() === "style" ? "active" : ""}`, ut = `overlay-toolbar-icon visibility ${l.visible ? "" : "muted"}`, ot = l.visible ? "Hide" : "Show", it = `overlay-toolbar-icon lock ${l.locked ? "active" : ""}`, at = l.locked ? "Unlock" : "Lock";
          return ke !== G._v$26 && u.style.setProperty("left", G._v$26 = ke), ge !== G._v$27 && u.style.setProperty("top", G._v$27 = ge), De !== G._v$28 && me(p, G._v$28 = De), Oe !== G._v$29 && me(S, G._v$29 = Oe), rt !== G._v$30 && me(fe, G._v$30 = rt), ut !== G._v$31 && me($e, G._v$31 = ut), ot !== G._v$32 && Ne($e, "title", G._v$32 = ot), it !== G._v$33 && me(_e, G._v$33 = it), at !== G._v$34 && Ne(_e, "title", G._v$34 = at), G;
        }, {
          _v$26: void 0,
          _v$27: void 0,
          _v$28: void 0,
      ...
      children: (l) => (() => {
        ...
        S.nextSibling;
        const ne = m.nextSibling, ie = ne.firstChild, ae = ie.nextSibling, q = ae.nextSibling, fe = q.nextSibling;
        fe.nextSibling;
        const $e = ne.nextSibling, _e = $e.nextSibling, Pe = _e.firstChild, G = Pe.nextSibling;
        G.nextSibling;
        const ke = _e.nextSibling;
        return ke.firstChild, u.addEventListener("mouseleave", () => Ze(!1)), u.addEventListener("mouseenter", () => Ze(!0)), y.$$mousemove = () => {
          Ht();
        }, y.$$mousedown = (ge) => {
          ge.preventDefault(), ge.stopPropagation(), Ht();
        }, m.$$click = () => Un("limit"), C(m, () => P().shortName ?? P().name ?? P().ticker, p), C(m, () => H1(l.price), S), ne.$$click = () => Un("stop"), C(ne, () => P().shortName ?? P().name ?? P().ticker, ae), C(ne, () => H1(l.price), fe), $e.$$click = () => Un("create"), _e.$$click = Pi, C(_e, () => H1(l.price), G), ke.$$click = Di, C(ke, () => H1(l.price), null), R((ge) => {
          const De = `${Math.max(0, l.y + 24)}px`, Oe = `${l.yAxisWidth + Nn}px`;
          return De !== ge._v$38 && u.style.setProperty("top", ge._v$38 = De), Oe !== ge._v$39 && u.style.setProperty("right", ge._v$39 = Oe), ge;
        }, {
          _v$38: void 0,
          _v$39: void 0
        }), u;
      ...
      const u = `klinecharts-pro-auto-scale-button${et() ? " active" : ""}`, y = et(), m = et(), g = et() ? "Auto scale on" : "Auto scale off", p = Ut();
      ...
      return A(hg, {
        ...
        onMainIndicatorChange: (o) => {
          ...
          o.added ? (ln(n, o.name, !0, {
            id: "candle_pane"
          }), i.push(o.name), _(o.name, "candle_pane", "main", "add")) : (n == null || n.removeIndicator("candle_pane", o.name), i.splice(i.indexOf(o.name), 1), _(o.name, "candle_pane", "main", "remove")), J(i), we(!0);
        },

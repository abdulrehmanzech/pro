...
var q9 = (e, t, r) => t in e ? H9(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var dt = (e, t, r) => (q9(e, typeof t != "symbol" ? t + "" : t, r), r);
import { utils as fe, OverlayMode as pn, ActionType as S1, LineType as h1, init as Y9, FormatDateType as Ut, DomPosition as r1, dispose as G0, TooltipIconPosition as zt, CandleType as W9, YAxisType as G9, registerOverlay as X9 } from "klinecharts";
function ft(e, t, r) {
...
const J9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    ...
    if (e.length > 1) {
      ...
      h.forEach((p) => {
        const L = e[1].y + d * p, D = (v[1].value + x * p).toFixed(r.price);
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const r = jr(e[0], e[1]) / Math.sqrt(24), n = e[1].x > e[0].x ? 0 : 1, s = fe.getLinearSlopeIntercept(e[0], e[1]);
      let l;
      ...
      for (let L = 2; L < 9; L++) {
        ...
        switch (L % 4) {
          ...
          case 1: {
            M = l + Math.PI / 2, p -= v[L - 2].r;
            break;
          }
          case 2: {
            M = l + Math.PI, x += v[L - 2].r;
            break;
          }
          case 3: {
            M = l + Math.PI / 2 * 3, p += v[L - 2].r;
            break;
          }
        }
        const Y = M + Math.PI / 2, N = ft({ x, y: p }, e[0], l);
        v.push({
          ...N,
          r: D,
          startAngle: M,
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    ...
    if (e.length > 2) {
      ...
      v.forEach((p) => {
        const L = e[2].y + d * p, D = (l[2].value + h * p).toFixed(r.price);
...
const v5 = (e, t) => e === t, xn = Symbol("solid-proxy"), C5 = Symbol("solid-track"), qt = {
  equals: v5
};
let Rr = Hr;
const m1 = 1, Yt = 2, Qr = {
...
var Se = null;
let O1 = null, Ce = null, Fe = null, f1 = null, In = 0;
function mt(e, t) {
  const r = Ce, n = Se, s = e.length === 0, l = s ? Qr : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? n : t
...
function T(e, t) {
  ...
  }, n = (s) => (typeof s == "function" && (s = s(r.value)), Vr(r, s));
  return [Zr.bind(r), n];
}
function X0(e, t, r) {
  const n = rn(e, t, !0, m1);
...
function Ke(e, t, r) {
  Rr = L5;
  const n = rn(e, t, !1, m1);
  n.user = !0, f1 ? f1.push(n) : R1(n);
}
function R(e, t, r) {
  r = r ? Object.assign({}, qt, r) : qt;
  const n = rn(e, t, !0, 0);
  return n.observers = null, n.observerSlots = null, n.comparator = r.equals || void 0, R1(n), Zr.bind(n);
}
function b5(e, t, r) {
  let n, s, l;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (n = !0, s = e, l = t || {}) : (n = e, s = t, l = r || {});
  let h = null, d = vn, v = null, x = !1, p = "initialValue" in l, L = typeof n == "function" && R(n);
  const D = /* @__PURE__ */ new Set(), [M, Y] = (l.storage || T)(l.initialValue), [N, F] = T(void 0), [I, re] = T(void 0, {
    equals: !1
  }), [j, W] = T(p ? "ready" : "unresolved");
  if (Ne.context) {
    v = `${Ne.context.id}${Ne.context.count++}`;
    let H;
    l.ssrLoadFrom === "initial" ? d = l.initialValue : Ne.load && (H = Ne.load(v)) && (d = H[0]);
  }
  function V(H, te, se, Le) {
    return h === H && (h = null, p = !0, (H === d || te === d) && l.onHydrated && queueMicrotask(() => l.onHydrated(Le, {
      value: te
    })), d = vn, me(te, se)), te;
  }
  function me(H, te) {
    k1(() => {
      te === void 0 && Y(() => H), W(te !== void 0 ? "errored" : "ready"), F(te);
  ...
  function U() {
    const H = _5, te = M(), se = N();
    if (se !== void 0 && !h)
      throw se;
    return Ce && !Ce.user && H && X0(() => {
  ...
  function Q(H = !0) {
    ...
    const se = d !== vn ? d : i1(() => s(te, {
      value: M(),
      refetching: H
    }));
    return typeof se != "object" || !(se && "then" in se) ? (V(h, se, void 0, te), se) : (h = se, x = !0, queueMicrotask(() => x = !1), k1(() => {
      W(p ? "refreshing" : "pending"), re();
    }, !1), se.then((Le) => V(se, Le, void 0, te), (Le) => V(se, void 0, Yr(Le), te)));
  }
...
function Vr(e, t, r) {
  ...
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && k1(() => {
    for (let s = 0; s < e.observers.length; s += 1) {
      ...
      h && O1.disposed.has(l), (h && !l.tState || !h && !l.state) && (l.pure ? Fe.push(l) : f1.push(l), l.observers && qr(l)), h || (l.state = m1);
    }
    if (Fe.length > 1e6)
      throw Fe = [], new Error();
  }, !1)), t;
...
function R1(e) {
  if (!e.fn)
    return;
  on(e);
  const t = Se, r = Ce, n = In;
  Ce = Se = e, k5(e, e.value, n), Ce = r, Se = t;
}
function k5(e, t, r) {
  let n;
  try {
    ...
    e.pure && (e.state = m1, e.owned && e.owned.forEach(on), e.owned = null), Wr(s);
  }
  (!e.updatedAt || e.updatedAt <= r) && (e.updatedAt != null && "observers" in e ? Vr(e, n) : e.value = n, e.updatedAt = r);
}
function rn(e, t, r, n = m1, s) {
  ...
  return Se === null || Se !== Qr && (Se.owned ? Se.owned.push(l) : Se.owned = [l]), l;
}
function Wt(e) {
  const t = O1;
  if (e.state === 0 || t)
  ...
  const r = [e];
  for (; (e = e.owner) && (!e.updatedAt || e.updatedAt < In); )
    (e.state || t) && r.push(e);
...
function k1(e, t) {
  ...
  try {
    ...
    r || (f1 = null), Fe = null, Wr(n);
  }
}
function x5(e) {
  if (Fe && (Hr(Fe), Fe = null), e)
    return;
  const t = f1;
  f1 = null, t.length && k1(() => Rr(t), !1);
}
function Hr(e) {
...
function qr(e) {
  ...
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = Yt, n.pure ? Fe.push(n) : f1.push(n), n.observers && qr(n));
  }
}
function on(e) {
  let t;
...
function A5(e, t, r = {}) {
  ...
  return N1(() => J0(l)), () => {
    let v = e() || [], x, p;
    return v[C5], i1(() => {
      let D = v.length, M, Y, N, F, I, re, j, W, V;
      if (D === 0)
        h !== 0 && (J0(l), l = [], n = [], s = [], h = 0, d && (d = [])), r.fallback && (n = [w5], s[0] = mt((me) => (l[0] = me, r.fallback())), h = 1);
      else if (h === 0) {
        for (s = new Array(D), p = 0; p < D; p++)
          n[p] = v[p], s[p] = mt(L);
        h = D;
      } else {
        for (N = new Array(D), F = new Array(D), d && (I = new Array(D)), re = 0, j = Math.min(h, D); re < j && n[re] === v[re]; re++)
          ;
        for (j = h - 1, W = D - 1; j >= re && W >= re && n[j] === v[W]; j--, W--)
          N[W] = s[j], F[W] = l[j], d && (I[W] = d[j]);
        for (M = /* @__PURE__ */ new Map(), Y = new Array(W + 1), p = W; p >= re; p--)
          V = v[p], x = M.get(V), Y[p] = x === void 0 ? -1 : x, M.set(V, p);
        for (x = re; x <= j; x++)
          V = n[x], p = M.get(V), p !== void 0 && p !== -1 ? (N[p] = s[x], F[p] = l[x], d && (I[p] = d[x]), p = Y[p], M.set(V, p)) : l[x]();
        for (p = re; p < D; p++)
          p in N ? (s[p] = N[p], l[p] = F[p], d && (d[p] = I[p], d[p](p))) : s[p] = mt(L);
        s = s.slice(0, h = D), n = v.slice(0);
      }
      return s;
    });
    function L(D) {
...
function Gr(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const s = e[n];
    t = t || !!s && xn in s, e[n] = typeof s == "function" ? (t = !0, R(s)) : s;
  }
  if (t)
    return new Proxy({
      get(n) {
...
function Ln(e) {
  ...
  return R(A5(() => e.each, e.children, t || void 0));
}
function J(e) {
  let t = !1;
  const r = e.keyed, n = R(() => e.when, void 0, {
  ...
  return R(() => {
    ...
    if (s) {
      ...
      return t = r || h, h ? i1(() => l(s)) : l;
    }
    return e.fallback;
  }, void 0, void 0);
}
function T5(e, t, r) {
  let n = r.length, s = t.length, l = n, h = 0, d = 0, v = t[s - 1].nextSibling, x = null;
  for (; h < s || d < l; ) {
    if (t[h] === r[d]) {
      h++, d++;
      continue;
    ...
    for (; t[s - 1] === r[l - 1]; )
      s--, l--;
    if (s === h) {
      const p = l < n ? d ? r[d - 1].nextSibling : r[l - d] : v;
      for (; d < l; )
        e.insertBefore(r[d++], p);
    } else if (l === d)
      for (; h < s; )
        (!x || !x.has(t[h])) && t[h].remove(), h++;
    else if (t[h] === r[l - 1] && r[d] === t[s - 1]) {
      const p = t[--s].nextSibling;
      e.insertBefore(r[d++], t[h++].nextSibling), e.insertBefore(r[--l], p), t[s] = r[l];
    } else {
      if (!x) {
        x = /* @__PURE__ */ new Map();
        let L = d;
      ...
      if (p != null)
        if (d < p && p < l) {
          let L = h, D = 1, M;
          for (; ++L < s && L < l && !((M = x.get(t[L])) == null || M !== p + D); )
            D++;
          if (D > p - d) {
            const Y = t[h];
            for (; d < p; )
              e.insertBefore(r[d++], Y);
          } else
...
function Ze(e, t = window.document) {
  const r = t[er] || (t[er] = /* @__PURE__ */ new Set());
  for (let n = 0, s = e.length; n < s; n++) {
    const l = e[n];
    r.has(l) || (r.add(l), t.addEventListener(l, P5));
  }
}
function Oe(e, t, r) {
  ...
  if (e = h && r[0] && r[0].parentNode || e, l === "string" || l === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (d.length === 0) {
        ...
        v ? r.length === 0 ? tr(e, d, n) : T5(e, r, d) : (r && K1(e), tr(e, d));
      r = d;
  ...
  if (t.length) {
    ...
    for (let h = t.length - 1; h >= 0; h--) {
      ...
      if (s !== d) {
        ...
        !l && !h ? v ? e.replaceChild(s, d) : e.insertBefore(s, r) : v && d.remove();
      } else
        l = !0;
    }
  } else
...
function N5(e) {
  ...
  if (n instanceof HTMLHeadElement) {
    const [l, h] = T(!1), d = () => h(!0);
    mt((v) => C(n, () => l() ? v() : s()(), null)), N1(() => {
      Ne.context ? queueMicrotask(d) : d();
    });
  } else {
    const l = O5(e.isSVG ? "g" : "div", e.isSVG), h = t && l.attachShadow ? l.attachShadow({
      mode: "open"
    }) : l;
...
var I5 = typeof jt == "object" && jt && jt.Object === Object && jt, Jr = I5, E5 = Jr, B5 = typeof self == "object" && self && self.Object === Object && self, F5 = E5 || B5 || Function("return this")(), a1 = F5, U5 = a1, z5 = U5.Symbol, an = z5, nr = an, e9 = Object.prototype, K5 = e9.hasOwnProperty, j5 = e9.toString, ht = nr ? nr.toStringTag : void 0;
function R5(e) {
  var t = K5.call(e, ht), r = e[ht];
  try {
    e[ht] = void 0;
    var n = !0;
  } catch {
...
var Q5 = R5, Z5 = Object.prototype, V5 = Z5.toString;
function H5(e) {
  return V5.call(e);
}
var q5 = H5, rr = an, Y5 = Q5, W5 = q5, G5 = "[object Null]", X5 = "[object Undefined]", or = rr ? rr.toStringTag : void 0;
function J5(e) {
  return e == null ? e === void 0 ? X5 : G5 : or && or in Object(e) ? Y5(e) : W5(e);
}
var gt = J5;
function eo(e) {
  var t = typeof e;
...
var Q1 = eo, to = gt, no = Q1, ro = "[object AsyncFunction]", oo = "[object Function]", io = "[object GeneratorFunction]", ao = "[object Proxy]";
function so(e) {
  if (!no(e))
    return !1;
  var t = to(e);
  return t == oo || t == io || t == ro || t == ao;
}
var t9 = so, lo = a1, co = lo["__core-js_shared__"], uo = co, bn = uo, ir = function() {
...
var fo = ho, mo = Function.prototype, go = mo.toString;
function yo(e) {
  if (e != null) {
    try {
      return go.call(e);
...
var n9 = yo, po = t9, vo = fo, Co = Q1, bo = n9, $o = /[\\^$.*+?()[\]{}|]/g, _o = /^\[object .+?Constructor\]$/, ko = Function.prototype, xo = Object.prototype, Lo = ko.toString, wo = xo.hasOwnProperty, Ao = RegExp(
  "^" + Lo.call(wo).replace($o, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Mo(e) {
  if (!Co(e) || vo(e))
    return !1;
...
var Po = So, Do = To, Oo = Po;
function No(e, t) {
  var r = Oo(e, t);
  return Do(r) ? r : void 0;
}
var E1 = No, Io = E1, Eo = function() {
  try {
...
var o9 = Uo, zo = r9, Ko = o9, jo = Object.prototype, Ro = jo.hasOwnProperty;
function Qo(e, t, r) {
  var n = e[t];
  (!(Ro.call(e, t) && Ko(n, r)) || r === void 0 && !(t in e)) && zo(e, t, r);
}
var Bn = Qo, Zo = Array.isArray, Z1 = Zo;
function Vo(e) {
  return e != null && typeof e == "object";
}
var V1 = Vo, Ho = gt, qo = V1, Yo = "[object Symbol]";
function Wo(e) {
  return typeof e == "symbol" || qo(e) && Ho(e) == Yo;
}
var Fn = Wo, Go = Z1, Xo = Fn, Jo = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, e6 = /^\w*$/;
function t6(e, t) {
  if (Go(e))
    return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || Xo(e) ? !0 : e6.test(e) || !Jo.test(e) || t != null && e in Object(t);
}
var n6 = t6, r6 = E1, o6 = r6(Object, "create"), sn = o6, sr = sn;
function i6() {
...
var l6 = s6, c6 = sn, u6 = "__lodash_hash_undefined__", d6 = Object.prototype, h6 = d6.hasOwnProperty;
function f6(e) {
  var t = this.__data__;
  if (c6) {
    var r = t[e];
...
var m6 = f6, g6 = sn, y6 = Object.prototype, p6 = y6.hasOwnProperty;
function v6(e) {
  var t = this.__data__;
  return g6 ? t[e] !== void 0 : p6.call(t, e);
}
var C6 = v6, b6 = sn, $6 = "__lodash_hash_undefined__";
function _6(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = b6 && t === void 0 ? $6 : t, this;
}
var k6 = _6, x6 = a6, L6 = l6, w6 = m6, A6 = C6, M6 = k6;
function H1(e) {
...
H1.prototype.clear = x6;
H1.prototype.delete = L6;
H1.prototype.get = w6;
H1.prototype.has = A6;
H1.prototype.set = M6;
var T6 = H1;
...
var ln = O6, N6 = ln, I6 = Array.prototype, E6 = I6.splice;
function B6(e) {
...
var F6 = B6, U6 = ln;
function z6(e) {
  var t = this.__data__, r = U6(t, e);
  return r < 0 ? void 0 : t[r][1];
}
var K6 = z6, j6 = ln;
function R6(e) {
  return j6(this.__data__, e) > -1;
}
var Q6 = R6, Z6 = ln;
function V6(e, t) {
...
var H6 = V6, q6 = P6, Y6 = F6, W6 = K6, G6 = Q6, X6 = H6;
function q1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
q1.prototype.has = G6;
q1.prototype.set = X6;
var cn = q1, J6 = E1, e2 = a1, t2 = J6(e2, "Map"), Un = t2, lr = T6, n2 = cn, r2 = Un;
function o2() {
...
function c2(e, t) {
  var r = e.__data__;
  return l2(t) ? r[typeof t == "string" ? "string" : "hash"] : r.map;
}
var un = c2, u2 = un;
function d2(e) {
...
var v2 = p2, C2 = un;
function b2(e, t) {
  var r = C2(this, e), n = r.size;
  return r.set(e, t), this.size += r.size == n ? 0 : 1, this;
}
var $2 = b2, _2 = i2, k2 = h2, x2 = g2, L2 = v2, w2 = $2;
function Y1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
Y1.prototype.has = L2;
Y1.prototype.set = w2;
var i9 = Y1, a9 = i9, A2 = "Expected a function";
function zn(e, t) {
  ...
  return r.cache = new (zn.Cache || a9)(), r;
}
zn.Cache = a9;
var M2 = zn, T2 = M2, S2 = 500;
function P2(e) {
  var t = T2(e, function(n) {
    return r.size === S2 && r.clear(), n;
  }), r = t.cache;
  return t;
}
var D2 = P2, O2 = D2, N2 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, I2 = /\\(\\)?/g, E2 = O2(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(N2, function(r, n, s, l) {
    t.push(s ? l.replace(I2, "$1") : n || r);
  }), t;
}), B2 = E2;
function F2(e, t) {
...
var U2 = F2, cr = an, z2 = U2, K2 = Z1, j2 = Fn, R2 = 1 / 0, ur = cr ? cr.prototype : void 0, dr = ur ? ur.toString : void 0;
function s9(e) {
  if (typeof e == "string")
    return e;
  if (K2(e))
...
var H2 = V2, q2 = Z1, Y2 = n6, W2 = B2, G2 = H2;
function X2(e, t) {
  return q2(e) ? e : Y2(e, t) ? [e] : W2(G2(e));
}
var J2 = X2, ei = 9007199254740991, ti = /^(?:0|[1-9]\d*)$/;
function ni(e, t) {
  var r = typeof e;
  return t = t ?? ei, !!t && (r == "number" || r != "symbol" && ti.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var l9 = ni, ri = Fn, oi = 1 / 0;
function ii(e) {
...
var ai = ii, si = Bn, li = J2, ci = l9, hr = Q1, ui = ai;
function di(e, t, r, n) {
  if (!hr(e))
    return e;
  t = li(t, e);
  for (var s = -1, l = t.length, h = l - 1, d = e; d != null && ++s < l; ) {
    ...
    if (s != h) {
      var p = d[v];
      x = n ? n(p, v, d) : void 0, x === void 0 && (x = hr(p) ? p : ci(t[s + 1]) ? [] : {});
    }
    si(d, v, x), d = d[v];
  }
  return e;
...
var hi = di, fi = hi;
function mi(e, t, r) {
  return e == null ? e : fi(e, t, r);
}
var gi = mi;
const An = /* @__PURE__ */ Xr(gi);
var yi = cn;
function pi() {
...
var xi = ki, Li = cn, wi = Un, Ai = i9, Mi = 200;
function Ti(e, t) {
  var r = this.__data__;
  if (r instanceof Li) {
    var n = r.__data__;
...
var Si = Ti, Pi = cn, Di = vi, Oi = bi, Ni = _i, Ii = xi, Ei = Si;
function W1(e) {
  var t = this.__data__ = new Pi(e);
  this.size = t.size;
}
W1.prototype.clear = Di;
W1.prototype.delete = Oi;
W1.prototype.get = Ni;
W1.prototype.has = Ii;
W1.prototype.set = Ei;
var Bi = W1;
...
var Qi = Ri, Zi = gt, Vi = V1, Hi = "[object Arguments]";
function qi(e) {
  return Vi(e) && Zi(e) == Hi;
}
var Yi = qi, fr = Yi, Wi = V1, c9 = Object.prototype, Gi = c9.hasOwnProperty, Xi = c9.propertyIsEnumerable, Ji = fr(function() {
  return arguments;
}()) ? fr : function(e) {
  return Wi(e) && Gi.call(e, "callee") && !Xi.call(e, "callee");
}, e3 = Ji, Jt = { exports: {} };
function t3() {
  return !1;
}
...
Jt.exports;
(function(e, t) {
  var r = a1, n = n3, s = t && !t.nodeType && t, l = s && !0 && e && !e.nodeType && e, h = l && l.exports === s, d = h ? r.Buffer : void 0, v = d ? d.isBuffer : void 0, x = v || n;
  e.exports = x;
})(Jt, Jt.exports);
var u9 = Jt.exports, r3 = 9007199254740991;
function o3(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= r3;
}
var d9 = o3, i3 = gt, a3 = d9, s3 = V1, l3 = "[object Arguments]", c3 = "[object Array]", u3 = "[object Boolean]", d3 = "[object Date]", h3 = "[object Error]", f3 = "[object Function]", m3 = "[object Map]", g3 = "[object Number]", y3 = "[object Object]", p3 = "[object RegExp]", v3 = "[object Set]", C3 = "[object String]", b3 = "[object WeakMap]", $3 = "[object ArrayBuffer]", _3 = "[object DataView]", k3 = "[object Float32Array]", x3 = "[object Float64Array]", L3 = "[object Int8Array]", w3 = "[object Int16Array]", A3 = "[object Int32Array]", M3 = "[object Uint8Array]", T3 = "[object Uint8ClampedArray]", S3 = "[object Uint16Array]", P3 = "[object Uint32Array]", ve = {};
ve[k3] = ve[x3] = ve[L3] = ve[w3] = ve[A3] = ve[M3] = ve[T3] = ve[S3] = ve[P3] = !0;
ve[l3] = ve[c3] = ve[$3] = ve[u3] = ve[_3] = ve[d3] = ve[h3] = ve[f3] = ve[m3] = ve[g3] = ve[y3] = ve[p3] = ve[v3] = ve[C3] = ve[b3] = !1;
function D3(e) {
  return s3(e) && a3(e.length) && !!ve[i3(e)];
}
var O3 = D3;
function N3(e) {
  return function(t) {
...
var Kn = N3, en = { exports: {} };
en.exports;
(function(e, t) {
  var r = Jr, n = t && !t.nodeType && t, s = n && !0 && e && !e.nodeType && e, l = s && s.exports === n, h = l && r.process, d = function() {
    try {
...
var jn = en.exports, I3 = O3, E3 = Kn, mr = jn, gr = mr && mr.isTypedArray, B3 = gr ? E3(gr) : I3, F3 = B3, U3 = Qi, z3 = e3, K3 = Z1, j3 = u9, R3 = l9, Q3 = F3, Z3 = Object.prototype, V3 = Z3.hasOwnProperty;
function H3(e, t) {
  var r = K3(e), n = !r && z3(e), s = !r && !n && j3(e), l = !r && !n && !s && Q3(e), h = r || n || s || l, d = h ? U3(e.length, String) : [], v = d.length;
  for (var x in e)
    (t || V3.call(e, x)) && !(h && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var h9 = H3, q3 = Object.prototype;
function Y3(e) {
  var t = e && e.constructor, r = typeof t == "function" && t.prototype || q3;
  return e === r;
}
var Rn = Y3;
function W3(e, t) {
...
var f9 = W3, G3 = f9, X3 = G3(Object.keys, Object), J3 = X3, ea = Rn, ta = J3, na = Object.prototype, ra = na.hasOwnProperty;
function oa(e) {
  if (!ea(e))
    return ta(e);
  var t = [];
...
var ia = oa, aa = t9, sa = d9;
function la(e) {
  return e != null && sa(e.length) && !aa(e);
}
var m9 = la, ca = h9, ua = ia, da = m9;
function ha(e) {
  return da(e) ? ca(e) : ua(e);
}
var Qn = ha, fa = dn, ma = Qn;
function ga(e, t) {
  return e && fa(t, ma(t), e);
}
var ya = ga;
function pa(e) {
  var t = [];
...
var va = pa, Ca = Q1, ba = Rn, $a = va, _a = Object.prototype, ka = _a.hasOwnProperty;
function xa(e) {
  if (!Ca(e))
    return $a(e);
  var t = ba(e), r = [];
...
var La = xa, wa = h9, Aa = La, Ma = m9;
function Ta(e) {
  return Ma(e) ? wa(e, !0) : Aa(e);
}
var Zn = Ta, Sa = dn, Pa = Zn;
function Da(e, t) {
  return e && Sa(t, Pa(t), e);
}
var Oa = Da, tn = { exports: {} };
tn.exports;
(function(e, t) {
  var r = a1, n = t && !t.nodeType && t, s = n && !0 && e && !e.nodeType && e, l = s && s.exports === n, h = l ? r.Buffer : void 0, d = h ? h.allocUnsafe : void 0;
  function v(x, p) {
    if (p)
      return x.slice();
...
var g9 = Ua, za = Fa, Ka = g9, ja = Object.prototype, Ra = ja.propertyIsEnumerable, yr = Object.getOwnPropertySymbols, Qa = yr ? function(e) {
  return e == null ? [] : (e = Object(e), za(yr(e), function(t) {
    return Ra.call(e, t);
  }));
} : Ka, Vn = Qa, Za = dn, Va = Vn;
function Ha(e, t) {
  return Za(e, Va(e), t);
}
var qa = Ha;
...
var y9 = Ya, Wa = f9, Ga = Wa(Object.getPrototypeOf, Object), p9 = Ga, Xa = y9, Ja = p9, e8 = Vn, t8 = g9, n8 = Object.getOwnPropertySymbols, r8 = n8 ? function(e) {
  for (var t = []; e; )
    Xa(t, e8(e)), e = Ja(e);
  return t;
} : t8, v9 = r8, o8 = dn, i8 = v9;
function a8(e, t) {
  return o8(e, i8(e), t);
}
var s8 = a8, l8 = y9, c8 = Z1;
function u8(e, t, r) {
  var n = t(e);
  return c8(e) ? n : l8(n, r(e));
}
var C9 = u8, d8 = C9, h8 = Vn, f8 = Qn;
function m8(e) {
  return d8(e, f8, h8);
}
var g8 = m8, y8 = C9, p8 = v9, v8 = Zn;
function C8(e) {
  return y8(e, v8, p8);
}
var b8 = C8, $8 = E1, _8 = a1, k8 = $8(_8, "DataView"), x8 = k8, L8 = E1, w8 = a1, A8 = L8(w8, "Promise"), M8 = A8, T8 = E1, S8 = a1, P8 = T8(S8, "Set"), D8 = P8, O8 = E1, N8 = a1, I8 = O8(N8, "WeakMap"), E8 = I8, Mn = x8, Tn = Un, Sn = M8, Pn = D8, Dn = E8, b9 = gt, G1 = n9, pr = "[object Map]", B8 = "[object Object]", vr = "[object Promise]", Cr = "[object Set]", br = "[object WeakMap]", $r = "[object DataView]", F8 = G1(Mn), U8 = G1(Tn), z8 = G1(Sn), K8 = G1(Pn), j8 = G1(Dn), P1 = b9;
(Mn && P1(new Mn(new ArrayBuffer(1))) != $r || Tn && P1(new Tn()) != pr || Sn && P1(Sn.resolve()) != vr || Pn && P1(new Pn()) != Cr || Dn && P1(new Dn()) != br) && (P1 = function(e) {
  var t = b9(e), r = t == B8 ? e.constructor : void 0, n = r ? G1(r) : "";
  if (n)
    switch (n) {
      case F8:
        return $r;
...
var Hn = P1, R8 = Object.prototype, Q8 = R8.hasOwnProperty;
function Z8(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && Q8.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
var V8 = Z8, H8 = a1, q8 = H8.Uint8Array, Y8 = q8, _r = Y8;
function W8(e) {
...
var ns = ts, kr = an, xr = kr ? kr.prototype : void 0, Lr = xr ? xr.valueOf : void 0;
function rs(e) {
...
var ss = as, ls = qn, cs = J8, us = ns, ds = os, hs = ss, fs = "[object Boolean]", ms = "[object Date]", gs = "[object Map]", ys = "[object Number]", ps = "[object RegExp]", vs = "[object Set]", Cs = "[object String]", bs = "[object Symbol]", $s = "[object ArrayBuffer]", _s = "[object DataView]", ks = "[object Float32Array]", xs = "[object Float64Array]", Ls = "[object Int8Array]", ws = "[object Int16Array]", As = "[object Int32Array]", Ms = "[object Uint8Array]", Ts = "[object Uint8ClampedArray]", Ss = "[object Uint16Array]", Ps = "[object Uint32Array]";
function Ds(e, t, r) {
  var n = e.constructor;
  switch (t) {
    case $s:
...
var Os = Ds, Ns = Q1, wr = Object.create, Is = function() {
  function e() {
  }
  return function(t) {
    if (!Ns(t))
...
}(), Es = Is, Bs = Es, Fs = p9, Us = Rn;
function zs(e) {
  return typeof e.constructor == "function" && !Us(e) ? Bs(Fs(e)) : {};
}
var Ks = zs, js = Hn, Rs = V1, Qs = "[object Map]";
function Zs(e) {
  return Rs(e) && js(e) == Qs;
}
var Vs = Zs, Hs = Vs, qs = Kn, Ar = jn, Mr = Ar && Ar.isMap, Ys = Mr ? qs(Mr) : Hs, Ws = Ys, Gs = Hn, Xs = V1, Js = "[object Set]";
function e7(e) {
  return Xs(e) && Gs(e) == Js;
}
var t7 = e7, n7 = t7, r7 = Kn, Tr = jn, Sr = Tr && Tr.isSet, o7 = Sr ? r7(Sr) : n7, i7 = o7, a7 = Bi, s7 = Ui, l7 = Bn, c7 = ya, u7 = Oa, d7 = Na, h7 = Ea, f7 = qa, m7 = s8, g7 = g8, y7 = b8, p7 = Hn, v7 = V8, C7 = Os, b7 = Ks, $7 = Z1, _7 = u9, k7 = Ws, x7 = Q1, L7 = i7, w7 = Qn, A7 = Zn, M7 = 1, T7 = 2, S7 = 4, $9 = "[object Arguments]", P7 = "[object Array]", D7 = "[object Boolean]", O7 = "[object Date]", N7 = "[object Error]", _9 = "[object Function]", I7 = "[object GeneratorFunction]", E7 = "[object Map]", B7 = "[object Number]", k9 = "[object Object]", F7 = "[object RegExp]", U7 = "[object Set]", z7 = "[object String]", K7 = "[object Symbol]", j7 = "[object WeakMap]", R7 = "[object ArrayBuffer]", Q7 = "[object DataView]", Z7 = "[object Float32Array]", V7 = "[object Float64Array]", H7 = "[object Int8Array]", q7 = "[object Int16Array]", Y7 = "[object Int32Array]", W7 = "[object Uint8Array]", G7 = "[object Uint8ClampedArray]", X7 = "[object Uint16Array]", J7 = "[object Uint32Array]", ye = {};
ye[$9] = ye[P7] = ye[R7] = ye[Q7] = ye[D7] = ye[O7] = ye[Z7] = ye[V7] = ye[H7] = ye[q7] = ye[Y7] = ye[E7] = ye[B7] = ye[k9] = ye[F7] = ye[U7] = ye[z7] = ye[K7] = ye[W7] = ye[G7] = ye[X7] = ye[J7] = !0;
ye[N7] = ye[_9] = ye[j7] = !1;
function Ht(e, t, r, n, s, l) {
  var h, d = t & M7, v = t & T7, x = t & S7;
  ...
  if (p) {
    ...
    var L = p7(e), D = L == _9 || L == I7;
    if (_7(e))
      return d7(e, d);
    if (L == k9 || L == $9 || D && !s) {
      if (h = v || D ? {} : b7(e), !d)
        return v ? m7(e, u7(h, e)) : f7(e, c7(h, e));
    } else {
      if (!ye[L])
        return s ? e : {};
      h = C7(e, L, d);
  ...
  if (M)
    return M;
  l.set(e, h), L7(e) ? e.forEach(function(F) {
    h.add(Ht(F, t, r, F, e, l));
  }) : k7(e) && e.forEach(function(F, I) {
    h.set(I, Ht(F, t, r, I, e, l));
  });
  var Y = x ? v ? y7 : g7 : v ? A7 : w7, N = p ? void 0 : Y(e);
  return s7(N || e, function(F, I) {
    N && (I = F, F = e[I]), l7(h, I, Ht(F, t, r, I, e, l));
  }), h;
}
var el = Ht, tl = el, nl = 1, rl = 4;
function ol(e) {
  return tl(e, nl | rl);
}
var il = ol;
const al = /* @__PURE__ */ Xr(il), sl = /* @__PURE__ */ b("<button></button>"), ll = (e) => (() => {
  const t = sl.cloneNode(!0);
  return o1(t, "click", e.onClick, !0), C(t, () => e.children), B((r) => {
...
Ze(["click"]);
const cl = /* @__PURE__ */ b('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), ul = /* @__PURE__ */ b('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), dl = /* @__PURE__ */ b("<div></div>"), hl = /* @__PURE__ */ b('<span class="label"></span>'), fl = () => cl.cloneNode(!0), ml = () => ul.cloneNode(!0), Pr = (e) => {
...
Ze(["click"]);
const gl = /* @__PURE__ */ b('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), x9 = () => gl.cloneNode(!0), yl = /* @__PURE__ */ b('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), pl = () => yl.cloneNode(!0), vl = /* @__PURE__ */ b("<ul></ul>"), Cl = /* @__PURE__ */ b("<li></li>"), nn = (e) => (() => {
  ...
  return C(t, w(J, {
    ...
    get children() {
      ...
      return (r = e.dataSource) == null ? void 0 : r.map((n) => {
        var s;
        return ((s = e.renderItem) == null ? void 0 : s.call(e, n)) ?? Cl.cloneNode(!0);
      });
    }
  }), null), B((r) => {
...
})(), bl = /* @__PURE__ */ b('<div class="klinecharts-pro-modal"><div class="inner"><div class="title-container"><svg class="close-icon" viewBox="0 0 1024 1024"><path d="M934.184927 199.723787 622.457206 511.452531l311.727721 311.703161c14.334473 14.229073 23.069415 33.951253 23.069415 55.743582 0 43.430138-35.178197 78.660524-78.735226 78.660524-21.664416 0-41.361013-8.865925-55.642275-23.069415L511.149121 622.838388 199.420377 934.490384c-14.204513 14.20349-33.901111 23.069415-55.642275 23.069415-43.482327 0-78.737272-35.230386-78.737272-78.660524 0-21.792329 8.864902-41.513486 23.094998-55.743582l311.677579-311.703161L88.135828 199.723787c-14.230096-14.255679-23.094998-33.92567-23.094998-55.642275 0-43.430138 35.254945-78.762855 78.737272-78.762855 21.741163 0 41.437761 8.813736 55.642275 23.069415l311.727721 311.727721L822.876842 88.389096c14.281261-14.255679 33.977859-23.069415 55.642275-23.069415 43.557028 0 78.735226 35.332716 78.735226 78.762855C957.254342 165.798117 948.5194 185.468109 934.184927 199.723787"></path></svg></div><div class="content-container"></div></div></div>'), $l = /* @__PURE__ */ b('<div class="button-container"></div>'), x1 = (e) => (() => {
  const t = bl.cloneNode(!0), r = t.firstChild, n = r.firstChild, s = n.firstChild, l = n.nextSibling;
  return t.$$click = (h) => {
    h.target === h.currentTarget && e.onClose && e.onClose();
  }, C(n, () => e.title, s), o1(s, "click", e.onClose, !0), C(l, () => e.children), C(r, (() => {
    const h = R(() => !!(e.buttons && e.buttons.length > 0));
    return () => h() && (() => {
      const d = $l.cloneNode(!0);
      return C(d, () => e.buttons.map((v) => w(ll, Gr(v, {
        get style() {
          return {
            ...e.minButtonWidth ? {
        ...
        return v._v$8 = I1(d, x, v._v$8), p !== v._v$9 && d.classList.toggle("mobile-buttons", v._v$9 = p), v;
      }, {
        _v$8: void 0,
        _v$9: void 0
      }), d;
    ...
    const d = !!e.isMobile, v = e.isMobile ? "100%" : `${e.width ?? 400}px`, x = (e.isMobile, "auto"), p = e.isMobile ? "60vh" : "90vh", L = !!e.isMobile, D = !!e.isMobile, M = !!e.isMobile;
...
Ze(["click"]);
const _l = /* @__PURE__ */ b('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), kl = /* @__PURE__ */ b('<div class="drop-down-container"><ul></ul></div>'), xl = /* @__PURE__ */ b('<div><input type="text"></div>'), Ll = /* @__PURE__ */ b("<li></li>"), L9 = (e) => {
  const [t, r] = T(!1), [n, s] = T("");
  let l, h;
  const d = R(() => {
    ...
    return p ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((D) => D.toLowerCase().includes(p)) : e.dataSource.filter((D) => {
      var N, F;
      const M = ((N = D.text) == null ? void 0 : N.toString().toLowerCase()) || "", Y = ((F = D.key) == null ? void 0 : F.toLowerCase()) || "";
      return M.includes(p) || Y.includes(p);
    }) : e.dataSource;
  }), v = () => {
    const p = !t();
    r(p), s(""), p && e.searchable && setTimeout(() => l == null ? void 0 : l.focus(), 50);
  }, x = (p) => {
    const L = p.relatedTarget;
    h && L && h.contains(L) || (r(!1), s(""));
  };
  return (() => {
    const p = _l.cloneNode(!0), L = p.firstChild, D = L.firstChild;
    p.addEventListener("blur", x), p.$$click = (Y) => {
      Y.stopPropagation(), v();
    };
    const M = h;
    return typeof M == "function" ? _1(M, p) : h = p, C(D, () => e.value), C(p, (() => {
      const Y = R(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => Y() && (() => {
        const N = kl.cloneNode(!0), F = N.firstChild;
        return N.$$mousedown = (I) => I.preventDefault(), C(N, (() => {
          const I = R(() => !!e.searchable);
          return () => I() && (() => {
            const re = xl.cloneNode(!0), j = re.firstChild;
            re.style.setProperty("padding", "8px"), re.style.setProperty("border-bottom", "1px solid #333"), j.$$click = (V) => V.stopPropagation(), j.$$input = (V) => s(V.currentTarget.value);
            const W = l;
            return typeof W == "function" ? _1(W, j) : l = j, j.style.setProperty("width", "100%"), j.style.setProperty("padding", "6px 10px"), j.style.setProperty("border", "1px solid var(--klinecharts-pro-border-color)"), j.style.setProperty("border-radius", "4px"), j.style.setProperty("background-color", "var(--klinecharts-pro-popover-background-color)"), j.style.setProperty("color", "#fff"), j.style.setProperty("font-size", "13px"), j.style.setProperty("outline", "none"), B(() => Oe(j, "placeholder", e.searchPlaceholder || "Search...")), B(() => j.value = n()), re;
          })();
        })(), F), C(F, () => {
          var I;
          return (I = d()) == null ? void 0 : I.map((re) => {
            const W = re[e.valueKey ?? "text"] ?? re;
            return (() => {
              const V = Ll.cloneNode(!0);
              return V.$$click = (me) => {
                var U;
                me.stopPropagation(), e.value !== W && ((U = e.onSelected) == null || U.call(e, re)), r(!1), s("");
              }, C(V, W), B(() => V.classList.toggle("selected", e.value === W)), V;
            })();
          });
        }), N;
      })();
      ...
      return Y._v$ = I1(p, N, Y._v$), F !== Y._v$2 && ne(p, Y._v$2 = F), Y;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), p;
...
const wl = /* @__PURE__ */ b('<span class="prefix"></span>'), Al = /* @__PURE__ */ b('<span class="suffix"></span>'), Ml = /* @__PURE__ */ b('<div><input class="value"></div>'), w9 = (e) => {
  const t = Gr({
  ...
  const [n, s] = T("normal");
  return (() => {
    const l = Ml.cloneNode(!0), h = l.firstChild;
    return l.$$click = () => {
      r == null || r.focus();
    }, C(l, w(J, {
      get when() {
      ...
      if ("precision" in t) {
        ...
        D <= 0 ? L = new RegExp(/^[1-9]\d*$/) : L = new RegExp("^\\d+\\.?\\d{0," + D + "}$"), (v === "" || L.test(v) && +v >= t.min && +v <= t.max) && ((x = t.onChange) == null || x.call(t, v === "" ? v : +v));
      } else
        (p = t.onChange) == null || p.call(t, v);
      ...
      const v = t.style, x = `klinecharts-pro-input ${t.class ?? ""}`, p = n(), L = t.placeholder ?? "";
      return d._v$ = I1(l, v, d._v$), x !== d._v$2 && ne(l, d._v$2 = x), p !== d._v$3 && Oe(l, "data-status", d._v$3 = p), L !== d._v$4 && Oe(h, "placeholder", d._v$4 = L), d;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
Ze(["click"]);
const Tl = /* @__PURE__ */ b('<div><i class="thumb"></i></div>'), Sl = (e) => (() => {
...
Ze(["click"]);
const Pl = "指标", Dl = "更多", Ol = "主图指标", Nl = "副图指标", Il = "设置", El = "时区", Bl = "截屏", Fl = "全屏", Ul = "退出全屏", zl = "保存", Kl = "确定", jl = "取消", Rl = "MA(移动平均线)", Ql = "EMA(指数平滑移动平均线)", Zl = "SMA", Vl = "BOLL(布林线)", Hl = "BBI(多空指数)", ql = "SAR(停损点指向指标)", Yl = "VOL(成交量)", Wl = "MACD(指数平滑异同移动平均线)", Gl = "KDJ(随机指标)", Xl = "RSI(相对强弱指标)", Jl = "BIAS(乖离率)", e4 = "BRAR(情绪指标)", t4 = "CCI(顺势指标)", n4 = "DMI(动向指标)", r4 = "CR(能量指标)", o4 = "PSY(心理线)", i4 = "DMA(平行线差指标)", a4 = "TRIX(三重指数平滑平均线)", s4 = "OBV(能量潮指标)", l4 = "VR(成交量变异率)", c4 = "WR(威廉指标)", u4 = "MTM(动量指标)", d4 = "EMV(简易波动指标)", h4 = "ROC(变动率指标)", f4 = "PVT(价量趋势指标)", m4 = "AO(动量震荡指标)", g4 = "世界统一时间", y4 = "(UTC-10) 檀香山", p4 = "(UTC-8) 朱诺", v4 = "(UTC-7) 洛杉矶", C4 = "(UTC-5) 芝加哥", b4 = "(UTC-4) 多伦多", $4 = "(UTC-3) 圣保罗", _4 = "(UTC+1) 伦敦", k4 = "(UTC+2) 柏林", x4 = "(UTC+3) 巴林", L4 = "(UTC+4) 迪拜", w4 = "(UTC+5) 阿什哈巴德", A4 = "(UTC+6) 阿拉木图", M4 = "(UTC+7) 曼谷", T4 = "(UTC+8) 上海", S4 = "(UTC+9) 东京", P4 = "(UTC+10) 悉尼", D4 = "(UTC+12) 诺福克岛", O4 = "水平直线", N4 = "水平射线", I4 = "水平线段", E4 = "垂直直线", B4 = "垂直射线", F4 = "垂直线段", U4 = "直线", z4 = "射线", K4 = "线段", j4 = "箭头", R4 = "价格线", Q4 = "价格通道线", Z4 = "平行直线", V4 = "斐波那契回调直线", H4 = "斐波那契回调线段", q4 = "斐波那契圆环", Y4 = "斐波那契螺旋", W4 = "斐波那契速度阻力扇", G4 = "斐波那契趋势扩展", X4 = "江恩箱", J4 = "矩形", ec = "平行四边形", tc = "圆", nc = "三角形", rc = "三浪", oc = "五浪", ic = "八浪", ac = "任意浪", sc = "ABCD形态", lc = "XABCD形态", cc = "弱磁模式", uc = "强磁模式", dc = "商品搜索", hc = "商品代码", fc = "参数1", mc = "参数2", gc = "参数3", yc = "参数4", pc = "参数5", vc = "周期", Cc = "标准差", bc = "蜡烛图类型", $c = "全实心", _c = "全空心", kc = "涨空心", xc = "跌空心", Lc = "OHLC", wc = "面积图", Ac = "最新价显示", Mc = "最高价显示", Tc = "最低价显示", Sc = "指标最新值显示", Pc = "价格轴类型", Dc = "线性轴", Oc = "百分比轴", Nc = "对数轴", Ic = "倒置坐标", Ec = "网格线显示", Bc = "恢复默认", Fc = {
  indicator: Pl,
  more: Dl,
  main_indicator: Ol,
  sub_indicator: Nl,
  ...
  horizontal_ray_line: N4,
  horizontal_segment: I4,
  vertical_straight_line: E4,
  vertical_ray_line: B4,
  vertical_segment: F4,
  straight_line: U4,
  ray_line: z4,
  segment: K4,
  arrow: j4,
  price_line: R4,
  price_channel_line: Q4,
  parallel_straight_line: Z4,
  fibonacci_line: V4,
  fibonacci_segment: H4,
  fibonacci_circle: q4,
  fibonacci_spiral: Y4,
  fibonacci_speed_resistance_fan: W4,
  ...
  candle_stroke: _c,
  candle_up_stroke: kc,
  candle_down_stroke: xc,
  ohlc: Lc,
  area: wc,
  last_price_show: Ac,
  high_price_show: Mc,
  low_price_show: Tc,
  indicator_last_value_show: Sc,
  price_axis_type: Pc,
  normal: Dc,
  percentage: Oc,
  log: Nc,
  ...
  grid_show: Ec,
  restore_default: Bc
}, Uc = "Indicator", zc = "More", Kc = "Main Indicator", jc = "Sub Indicator", Rc = "Setting", Qc = "Timezone", Zc = "Screenshot", Vc = "Full Screen", Hc = "Exit", qc = "Save", Yc = "Confirm", Wc = "Cancel", Gc = "MA(Moving Average)", Xc = "EMA(Exponential Moving Average)", Jc = "SMA", eu = "BOLL(Bolinger Bands)", tu = "BBI(Bull And Bearlndex)", nu = "SAR(Stop and Reverse)", ru = "VOL(Volume)", ou = "MACD(Moving Average Convergence / Divergence)", iu = "KDJ(KDJ Index)", au = "RSI(Relative Strength Index)", su = "BIAS(Bias Ratio)", lu = "BRAR(情绪指标)", cu = "CCI(Commodity Channel Index)", uu = "DMI(Directional Movement Index)", du = "CR(能量指标)", hu = "PSY(Psychological Line)", fu = "DMA(Different of Moving Average)", mu = "TRIX(Triple Exponentially Smoothed Moving Average)", gu = "OBV(On Balance Volume)", yu = "VR(Volatility Volume Ratio)", pu = "WR(Williams %R)", vu = "MTM(Momentum Index)", Cu = "EMV(Ease of Movement Value)", bu = "ROC(Price Rate of Change)", $u = "PVT(Price and Volume Trend)", _u = "AO(Awesome Oscillator)", ku = "UTC", xu = "(UTC-10) Honolulu", Lu = "(UTC-8) Juneau", wu = "(UTC-7) Los Angeles", Au = "(UTC-5) Chicago", Mu = "(UTC-4) Toronto", Tu = "(UTC-3) Sao Paulo", Su = "(UTC+1) London", Pu = "(UTC+2) Berlin", Du = "(UTC+3) Bahrain", Ou = "(UTC+4) Dubai", Nu = "(UTC+5) Ashkhabad", Iu = "(UTC+6) Almaty", Eu = "(UTC+7) Bangkok", Bu = "(UTC+8) Shanghai", Fu = "(UTC+9) Tokyo", Uu = "(UTC+10) Sydney", zu = "(UTC+12) Norfolk", Ku = "Horizontal Line", ju = "Horizontal Ray", Ru = "Horizontal Segment", Qu = "Vertical Line", Zu = "Vertical Ray", Vu = "Vertical Segment", Hu = "Trend Line", qu = "Ray", Yu = "Segment", Wu = "Arrow", Gu = "Price Line", Xu = "Price Channel Line", Ju = "Parallel Line", ed = "Fibonacci Line", td = "Fibonacci Segment", nd = "Fibonacci Circle", rd = "Fibonacci Spiral", od = "Fibonacci Sector", id = "Fibonacci Extension", ad = "Gann Box", sd = "Rect", ld = "Parallelogram", cd = "Circle", ud = "Triangle", dd = "Three Waves", hd = "Five Waves", fd = "Eight Waves", md = "Any Waves", gd = "ABCD Pattern", yd = "XABCD Pattern", pd = "Weak Magnet", vd = "Strong Magnet", Cd = "Symbol Search", bd = "Symbol Code", $d = "Parameter 1", _d = "Parameter 2", kd = "Parameter 3", xd = "Parameter 4", Ld = "Parameter 5", wd = "Period", Ad = "Standard Deviation", Md = "Candle Type", Td = "Candle Solid", Sd = "Candle Stroke", Pd = "Candle Up Stroke", Dd = "Candle Down Stroke", Od = "OHLC", Nd = "Area", Id = "Show Last Price", Ed = "Show Highest Price", Bd = "Show Lowest Price", Fd = "Show indicator's last value", Ud = "Price Axis Type", zd = "Normal", Kd = "Percentage", jd = "Log", Rd = "Reverse Coordinate", Qd = "Show Grids", Zd = "Restore Defaults", Vd = {
  indicator: Uc,
  more: zc,
  main_indicator: Kc,
  sub_indicator: jc,
  ...
  horizontal_ray_line: ju,
  horizontal_segment: Ru,
  vertical_straight_line: Qu,
  ...
  parallel_straight_line: Ju,
  fibonacci_line: ed,
  fibonacci_segment: td,
  fibonacci_circle: nd,
  fibonacci_spiral: rd,
  fibonacci_speed_resistance_fan: od,
  fibonacci_extension: id,
  gann_box: ad,
  rect: sd,
  parallelogram: ld,
  circle: cd,
  ...
  params_5: Ld,
  period: wd,
  standard_deviation: Ad,
  candle_type: Md,
  candle_solid: Td,
  candle_stroke: Sd,
  candle_up_stroke: Pd,
  candle_down_stroke: Dd,
  ohlc: Od,
  area: Nd,
  last_price_show: Id,
  high_price_show: Ed,
...
const c = (e, t) => {
  ...
  return Ke(() => {
    ...
    const O = lh.cloneNode(!0), E = O.firstChild, be = E.firstChild, we = be.firstChild, de = be.nextSibling, Ae = de.firstChild;
    return O.style.setProperty("position", "relative"), O.style.setProperty("width", "100%"), O.style.setProperty("display", "flex"), O.style.setProperty("align-items", "center"), C(O, w(J, {
      ...
      t = _;
    }, E), E.style.setProperty("width", "100%"), E.style.setProperty("overflow", "auto"), o1(we, "click", e.onMenuClick, !0), C(E, w(J, {
      get when() {
        return e.symbol;
      },
      get children() {
        const _ = Yd.cloneNode(!0), le = _.firstChild;
        return o1(_, "click", e.onSymbolClick, !0), C(_, w(J, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const Pe = qd.cloneNode(!0);
      ...
      get children() {
        const _ = Jd.cloneNode(!0), le = _.firstChild, Pe = le.nextSibling;
        return o1(_, "click", e.onIndicatorClick, !0), C(Pe, () => c("indicator", e.locale)), _;
      }
      ...
      get children() {
        const _ = nh.cloneNode(!0), le = _.firstChild, Pe = le.firstChild, s1 = Pe.nextSibling;
        return _1((ge) => {
          r = ge;
        }, _), _.style.setProperty("display", "flex"), _.style.setProperty("align-items", "center"), le.$$click = (ge) => {
          ge.stopPropagation(), Ue();
        }, le.style.setProperty("gap", "6px"), s1.style.setProperty("transition", "transform 0.2s ease"), C(_, w(J, {
          get when() {
            return v();
          },
          get children() {
            return w(N5, {
              ...
              get children() {
                const ge = th.cloneNode(!0), g1 = ge.firstChild, l1 = g1.firstChild, X1 = l1.firstChild, Ie = X1.firstChild, yt = Ie.firstChild, B1 = l1.nextSibling, L1 = B1.firstChild, w1 = L1.firstChild, e1 = w1.firstChild, pt = L1.nextSibling, Ve = pt.firstChild, J1 = Ve.firstChild, et = g1.nextSibling, y1 = et.firstChild, A1 = y1.firstChild, tt = A1.firstChild, vt = tt.firstChild, F1 = y1.nextSibling, nt = F1.firstChild, Ct = nt.firstChild, bt = Ct.nextSibling, rt = nt.nextSibling, je = rt.firstChild, ze = je.nextSibling, Re = ze.firstChild, Qe = Re.firstChild, $t = et.nextSibling, ot = $t.firstChild, U1 = ot.firstChild, _t = $t.nextSibling, xe = _t.nextSibling, Ee = xe.firstChild, kt = Ee.firstChild, Ye = xe.nextSibling, p1 = Ye.nextSibling, v1 = p1.firstChild, xt = v1.firstChild, c1 = p1.nextSibling, it = c1.firstChild, u1 = it.firstChild, M1 = u1.firstChild, Lt = M1.firstChild, at = it.nextSibling, T1 = at.firstChild, He = T1.firstChild, wt = He.firstChild, st = T1.nextSibling, C1 = st.firstChild, z1 = C1.firstChild, hn = st.nextSibling, fn = hn.firstChild, At = fn.firstChild, lt = c1.nextSibling, Mt = lt.firstChild, b1 = Mt.firstChild;
                return ge.$$mousedown = ($) => $.stopPropagation(), _1(($) => {
                  n = $;
                }, ge), ge.style.setProperty("position", "fixed"), ge.style.setProperty("z-index", "9999"), l1.$$click = ($) => {
                ...
                }, tt.$$mousedown = ($) => $.stopPropagation(), tt.$$click = ($) => $.stopPropagation(), vt.addEventListener("change", ($) => {
                  var S;
                  ...
                  var $;
                  return Dr((($ = e.orderToolsState) == null ? void 0 : $.openOrdersDisplay) ?? "right");
                }, Qe), C(ze, w(J, {
                  get when() {
                    return Y();
                  },
                  get children() {
                    const $ = eh.cloneNode(!0);
                    return C($, () => ["left", "center", "right"].map((S) => (() => {
                      const De = uh.cloneNode(!0);
                      return De.$$click = (Be) => {
                        var t1;
                  ...
                  var Dt;
                  const S = `${re().top}px`, De = `${re().left}px`, Be = `${re().minWidth}px`, t1 = `klinecharts-pro-order-tools-group${p() ? " klinecharts-pro-order-tools-group-open" : ""}`, d1 = `klinecharts-pro-order-tools-group${D() ? " klinecharts-pro-order-tools-group-open" : ""}`, Tt = `klinecharts-pro-order-tools-switch${((Dt = e.orderToolsState) == null ? void 0 : Dt.openOrdersExtendedPriceLine) ?? !0 ? " klinecharts-pro-order-tools-switch-on" : ""}`, St = `klinecharts-pro-order-tools-display-arrow${Y() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, Pt = `klinecharts-pro-order-tools-group${F() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return S !== $._v$ && ge.style.setProperty("top", $._v$ = S), De !== $._v$2 && ge.style.setProperty("left", $._v$2 = De), Be !== $._v$3 && ge.style.setProperty("width", $._v$3 = Be), t1 !== $._v$4 && ne(g1, $._v$4 = t1), d1 !== $._v$5 && ne(et, $._v$5 = d1), Tt !== $._v$6 && ne(bt, $._v$6 = Tt), St !== $._v$7 && Oe(Qe, "class", $._v$7 = St), Pt !== $._v$8 && ne(c1, $._v$8 = Pt), $;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var $;
                  return vt.checked = (($ = e.orderToolsState) == null ? void 0 : $.openOrders) ?? !0;
                }), B(() => {
                  var $;
                  ...
                  var $, S, De, Be, t1, d1;
                  return Lt.checked = ((($ = e.orderToolsState) == null ? void 0 : $.marketPriceLine) ?? ((S = e.orderToolsState) == null ? void 0 : S.priceLine) ?? !0) || (((De = e.orderToolsState) == null ? void 0 : De.countDown) ?? ((Be = e.orderToolsState) == null ? void 0 : Be.priceLine) ?? !0) || (((t1 = e.orderToolsState) == null ? void 0 : t1.bidAskPrice) ?? ((d1 = e.orderToolsState) == null ? void 0 : d1.priceLine) ?? !0);
                }), B(() => {
                  var $, S;
          ...
          const g1 = s() ? "0 8px" : "0 10px", l1 = v() ? "rotate(180deg)" : "rotate(0deg)";
          return g1 !== ge._v$9 && le.style.setProperty("padding", ge._v$9 = g1), l1 !== ge._v$10 && s1.style.setProperty("transform", ge._v$10 = l1), ge;
        }, {
          _v$9: void 0,
          _v$10: void 0
        }), _;
      ...
      const _ = R(() => !!V());
      return () => _() ? dh.cloneNode(!0) : hh.cloneNode(!0);
    })()), C(de, w(J, {
      get when() {
        return R(() => !!e.chartViewToggle)() && !V();
      },
      get children() {
        const _ = ah.cloneNode(!0);
        return o1(_, "click", e.chartViewToggle.onToggle, !0), C(_, (() => {
          const le = R(() => e.chartViewToggle.view === "chart");
          return () => le() ? fh.cloneNode(!0) : mh.cloneNode(!0);
...
Ze(["click", "mousedown"]);
const yh = /* @__PURE__ */ b('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M12.41465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L12.41465,12C12.20873,12.5826,11.65311,13,11,13C10.34689,13,9.79127,12.5826,9.58535,12L3.5,12C3.223857,12,3,11.77614,3,11.5C3,11.22386,3.223857,11,3.5,11L9.58535,11C9.79127,10.417404,10.34689,10,11,10C11.65311,10,12.20873,10.417404,12.41465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), ph = () => yh.cloneNode(!0), vh = /* @__PURE__ */ b('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465
5.49096,17.9378,6.385540000000001,19,7.48614,19L15.512,19C16.6127,19,17.509,17.9378,17.509,16.631500000000003L17.509,9.21802C17.509,8.91558,17.2669,8.67144,16.966900000000003,8.67144ZM18.4578,6.21183L4.542169,6.21183C4.243976,6.21183,4,6.45779,4,6.75841C4,7.05903,4.243976,7.30499,4.542169,7.30499L18.4578,7.30499C18.756,7.30499,19,7.05903,19,6.75841C19,6.45779,18.756,6.21183,18.4578,6.21183ZM8.68072,5.10045L14.3193,5.10045C14.6175,5.10045,14.8614,4.852666,14.8614,4.550225C14.8614,4.247783,14.6175,4,14.3193,4L8.68072,4C8.38253,4,8.13855,4.247783,8.13855,4.550225C8.13855,4.852666,8.38253,5.10045,8.68072,5.10045Z" stroke-opacity="0" fill-opacity="1"></path></svg>'), Ef = () => If.cloneNode(!0), Bf = {
  horizontalStraightLine: ph,
  horizontalRayLine: Ch,
  horizontalSegment: $h,
  ...
  fibonacciCircle: Hh,
  fibonacciSpiral: Yh,
  fibonacciSpeedResistanceFan: Gh,
  fibonacciExtension: Jh,
  gannBox: tf,
  circle: rf,
  triangle: af,
  rect: lf,
...
const qe = (e) => Bf[e.name](e.class), Qf = /* @__PURE__ */ b('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Zf = /* @__PURE__ */ b('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Or = /* @__PURE__ */ b('<li><span style="padding-left:8px"></span></li>'), Nr = "drawing_tools", Vf = (e) => {
  const [t, r] = T("horizontalStraightLine"), [n, s] = T("priceChannelLine"), [l, h] = T("circle"), [d, v] = T("fibonacciLine"), [x, p] = T("xabcd"), [L, D] = T("weak_magnet"), [M, Y] = T("normal"), [N, F] = T(!1), [I, re] = T(!0), [j, W] = T(""), V = R(() => [{
    key: "singleLine",
    icon: t(),
    list: Ff(e.locale),
    setter: r
  ...
  return (() => {
    const U = Qf.cloneNode(!0), Q = U.firstChild, H = Q.nextSibling, te = H.firstChild, se = te.nextSibling, Le = se.firstChild, $e = H.nextSibling, ie = $e.firstChild, Ue = $e.nextSibling, ke = Ue.firstChild, pe = Ue.nextSibling, oe = pe.nextSibling, ce = oe.firstChild;
    return C(U, () => V().map((Z) => (() => {
      const O = Zf.cloneNode(!0), E = O.firstChild, be = E.nextSibling, we = be.firstChild;
        ...
        return () => de() && w(nn, {
          ...
          get children() {
            return Z.list.map((Ae) => (() => {
              const _ = Or.cloneNode(!0), le = _.firstChild;
              return _.$$click = () => {
      ...
      })(), null), B(() => Oe(we, "class", Z.key === j() ? "rotate" : "")), O;
    })()), Q), H.addEventListener("blur", () => {
      W("");
    }), te.$$click = () => {
      let Z = L();
      M() !== "normal" && (Z = "normal"), Y(Z), e.onModeChange(Z);
    }, C(te, (() => {
      const Z = R(() => L() === "weak_magnet");
      return () => Z() ? (() => {
        const O = R(() => M() === "weak_magnet");
        return () => O() ? w(qe, {
          name: "weak_magnet",
          class: "selected"
        }) : w(qe, {
      ...
      return () => Z() && w(nn, {
        ...
        get children() {
          return me().map((O) => (() => {
            const E = Or.cloneNode(!0), be = E.firstChild;
            return E.$$click = () => {
              D(O.key), Y(O.key), e.onModeChange(O.key), W("");
            }, C(E, w(qe, {
              get name() {
                return O.key;
              }
      ...
      name: "remove"
    })), B(() => Oe(Le, "class", j() === "mode" ? "rotate" : "")), U;
  })();
};
Ze(["click"]);
const Ir = /* @__PURE__ */ b('<li class="title"></li>'), Er = /* @__PURE__ */ b('<li class="row"></li>'), Hf = (e) => w(x1, {
  get title() {
...
const Yf = (e) => {
  const [t, r] = T(e.timezone), n = R(() => qf(e.locale));
  return w(x1, {
    get title() {
...
const Wf = /* @__PURE__ */ b('<div class="klinecharts-pro-setting-modal-content"></div>'), Gf = /* @__PURE__ */ b('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), Xf = (e) => {
  const [t, r] = T(e.currentStyles), [n, s] = T(Fr(e.locale)), [l, h] = T(!1), d = () => {
  ...
  return w(x1, {
    ...
    get children() {
      ...
      return C(x, w(Ln, {
        ...
        children: (p) => {
          let L;
          const D = fe.formatValue(t(), p.key);
          switch (p.component) {
            case "select": {
              const M = p.key === "candle.type" ? "170px" : "120px";
              L = w(L9, {
                get style() {
                  return {
                    width: l() ? "100%" : M,
          ...
          return (() => {
            const M = Gf.cloneNode(!0), Y = M.firstChild, N = Y.nextSibling;
            return C(Y, () => p.text), C(N, L), B(() => M.classList.toggle("mobile-item", !!l())), M;
          })();
        }
      })), B(() => x.classList.toggle("mobile-layout", !!l())), x;
    }
  });
}, Jf = /* @__PURE__ */ b('<img style="width:500px;margin-top: 20px">'), em = (e) => w(x1, {
  get title() {
...
}, nm = /* @__PURE__ */ b('<div class="klinecharts-pro-indicator-setting-modal-content"></div>'), rm = /* @__PURE__ */ b("<span></span>"), om = (e) => {
  const [t, r] = T(fe.clone(e.params.calcParams)), n = (s) => tm[s];
  return w(x1, {
    get title() {
...
}, im = /* @__PURE__ */ b('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z"></path></svg>'), am = /* @__PURE__ */ b('<img alt="symbol">'), sm = /* @__PURE__ */ b("<li><div><span></span></div></li>"), lm = (e) => {
  const [t, r] = T(""), [n] = b5(t, e.datafeed.searchSymbols.bind(e.datafeed));
  return w(x1, {
    get title() {
    ...
    get children() {
      return [w(w9, {
        ...
        renderItem: (s) => (() => {
          const l = sm.cloneNode(!0), h = l.firstChild, d = h.firstChild;
          return l.$$click = () => {
...
const cm = /* @__PURE__ */ b('<div class="klinecharts-pro-mobile-more-modal-content"><div class="item"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/sv
231,11.9504,7.7104,13.7095,10.0024,13.7095C12.2943,13.7095,14.1524,11.9504,14.1524,9.78068C14.1524,7.61092,12.2943,5.85189,10.0024,5.85189ZM11.8699,11.5486C11.37,12.0196,10.7074,12.2808,10.0024,12.2808C9.29732,12.2808,8.63473,12.0196,8.13483,11.5486C7.6373,11.0754,7.36142,10.4481,7.36142,9.78068C7.36142,9.11323,7.6373,8.48596,8.13483,8.01272C8.63473,7.53948,9.29732,7.28054,10.0024,7.28054C10.7074,7.28054,11.37,7.53948,11.8699,8.01272C12.3674,8.48596,12.6433,9.11323,12.6433,9.78068C12.6433,10.4481,12.3674,11.0754,11.8699,11.5486Z"></path></svg><span></span></div></div>'), um = (e) => w(x1, {
  ...
  get children() {
    const t = cm.cloneNode(!0), r = t.firstChild, n = r.firstChild, s = n.nextSibling, l = r.nextSibling, h = l.firstChild, d = h.nextSibling, v = l.nextSibling, x = v.nextSibling, p = x.firstChild, L = p.nextSibling;
    return r.$$click = () => {
...
Ze(["click"]);
const dm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-picker"></div>'), hm = /* @__PURE__ */ b('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), fm = /* @__PURE__ */ b("<span></span>"), mm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), gm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-grid"></div>'), ym = /* @__PURE__ */ b('<span class="weekday"></span>'), D1 = /* @__PURE__ */ b('<button type="button"></button>'), pm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-month-grid"></div>'), vm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), Cm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), bm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-content"></div>'), $m = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-tabs"></div>'), _m = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), km = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), xm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), Lm = [{
  key: "goToDate",
  label: "Go to Date"
}, {
  key: "timeRange",
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], wm = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], Ur = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], j1 = (e) => String(e).padStart(2, "0"), zr = (e, t, r) => Math.min(r, new Date(e, t + 1, 0).getDate()), $n = (e) => {
  const t = new Date(e);
  return {
    year: t.getFullYear(),
    month: t.getMonth(),
...
}, Rt = (e) => new Date(e.year, e.month, e.day, e.hour, e.minute, 0, 0).getTime(), _n = (e) => e.year * 1e4 + (e.month + 1) * 100 + e.day, On = (e) => {
  const t = e.hour >= 12 ? "PM" : "AM", r = e.hour % 12 || 12;
  return `${j1(e.month + 1)}/${j1(e.day)}/${e.year} ${j1(r)}:${j1(e.minute)} ${t}`;
}, Am = (e, t) => {
  ...
  const [t, r] = T(!0), [n, s] = T("date"), [l, h] = T(e.value.year), [d, v] = T(e.value.month), x = R(() => Am(l(), d())), p = R(() => Math.floor(l() / 10) * 10), L = R(() => Array.from({
    length: 12
  }, (U, Q) => p() - 1 + Q)), D = R(() => e.value.hour % 12 || 12), M = R(() => e.value.hour >= 12 ? "PM" : "AM"), Y = Array.from({
    length: 12
    ...
    e.onChange({
      ...
      month: U.getMonth(),
      day: U.getDate()
    }), (Q = e.onDateSelect) == null || Q.call(e), h(U.getFullYear()), v(U.getMonth());
  }, j = (U) => {
    v(U), e.onChange({
      ...e.value,
      year: l(),
      month: U,
      day: zr(l(), U, e.value.day)
    }), s("date");
  }, W = (U) => {
    h(U), e.onChange({
      ...e.value,
      year: U,
      day: zr(U, e.value.month, e.value.day)
    }), s("month");
  }, V = (U) => {
    const Q = M() === "PM";
    e.onChange({
  ...
  return (() => {
    const U = dm.cloneNode(!0);
    return C(U, (() => {
      const Q = R(() => e.showInput !== !1);
      return () => Q() && (() => {
        const H = hm.cloneNode(!0), te = H.firstChild, se = te.firstChild;
        return C(H, (() => {
          const Le = R(() => !!e.label);
          return () => Le() && (() => {
            const $e = fm.cloneNode(!0);
      ...
      const Q = R(() => !!t());
      return () => Q() && (() => {
        const H = mm.cloneNode(!0), te = H.firstChild, se = te.firstChild, Le = se.nextSibling, $e = Le.nextSibling, ie = $e.nextSibling, Ue = ie.nextSibling;
        return se.$$click = () => {
          ...
          const ke = R(() => n() === "date");
          return () => ke() && (() => {
            const pe = gm.cloneNode(!0);
            return C(pe, () => wm.map((oe) => (() => {
              const ce = ym.cloneNode(!0);
              return C(ce, oe), ce;
            })()), null), C(pe, () => x().map(({
              date: oe,
              current: ce
          ...
          const ke = R(() => n() === "month");
          return () => ke() && (() => {
            const pe = pm.cloneNode(!0);
            return C(pe, () => Ur.map((oe, ce) => (() => {
              const Z = D1.cloneNode(!0);
              return Z.$$click = () => j(ce), C(Z, oe), B(() => ne(Z, ce === e.value.month && l() === e.value.year ? "selected" : "")), Z;
            })())), pe;
          })();
        })(), null), C(H, (() => {
          const ke = R(() => n() === "year");
          return () => ke() && (() => {
            const pe = vm.cloneNode(!0);
            return C(pe, () => L().map((oe) => (() => {
              const ce = D1.cloneNode(!0);
              return ce.$$click = () => W(oe), C(ce, oe), B(() => ne(ce, `${oe < p() || oe > p() + 9 ? "muted" : ""} ${oe === e.value.year ? "selected" : ""}`)), ce;
            })())), pe;
          })();
        })(), null), C(H, (() => {
          const ke = R(() => n() === "date");
          return () => ke() && (() => {
            const pe = Cm.cloneNode(!0), oe = pe.firstChild, ce = oe.nextSibling, Z = ce.nextSibling;
            return C(oe, () => Y.map((O) => (() => {
              const E = D1.cloneNode(!0);
              return E.$$click = () => V(O), C(E, () => j1(O)), B(() => ne(E, O === D() ? "selected" : "")), E;
            })())), C(ce, () => N.map((O) => (() => {
              const E = D1.cloneNode(!0);
              return E.$$click = () => e.onChange({
                ...e.value,
                minute: O
              }), C(E, () => j1(O)), B(() => ne(E, O === e.value.minute ? "selected" : "")), E;
            })())), C(Z, () => ["AM", "PM"].map((O) => (() => {
              const E = D1.cloneNode(!0);
  ...
  const [t, r] = T(e.initialTab ?? "goToDate"), [n, s] = T($n(e.initialTimestamp)), [l, h] = T($n(e.initialRange.from)), [d, v] = T($n(e.initialRange.to)), [x, p] = T("from"), [L, D] = T({
    ...e.anchorSettings,
    ...
    if (N === "goToDate")
      ...
      e.onTimeAnchorChange({
        ...F,
        timestamp: F.anchorPoint === "date" ? Rt(n()) : F.timestamp
      });
    }
    e.onClose();
  };
  return w(x1, {
    ...
    minButtonWidth: 112,
    get children() {
      const N = bm.cloneNode(!0);
      return C(N, (() => {
        const F = R(() => t() === "goToDate");
        return () => F() && w(Qt, {
          label: "",
          get value() {
            return n();
        ...
        const F = R(() => t() === "timeRange");
        return () => F() && (() => {
          const I = _m.cloneNode(!0), re = I.firstChild, j = re.firstChild, W = j.nextSibling, V = W.nextSibling;
          return j.$$click = () => p("from"), C(j, () => On(l())), V.$$click = () => p("to"), C(V, () => On(d())), C(I, (() => {
            const me = R(() => x() === "from");
            return () => me() ? w(Qt, {
              label: "Start",
              get value() {
            ...
            return U !== me._v$ && ne(j, me._v$ = U), Q !== me._v$2 && ne(V, me._v$2 = Q), me;
          }, {
            _v$: void 0,
            _v$2: void 0
          }), I;
        ...
        const F = R(() => t() === "timeAnchor");
        return () => F() && (() => {
          const I = km.cloneNode(!0), re = I.firstChild, j = re.firstChild, W = j.nextSibling, V = re.nextSibling, me = V.firstChild, U = me.nextSibling, Q = V.nextSibling, H = Q.firstChild, te = H.nextSibling, se = Q.nextSibling, Le = se.firstChild, $e = Le.nextSibling;
          return W.$$click = () => M({
            enabled: !L().enabled
          }), U.addEventListener("change", (ie) => M({
            anchorPoint: ie.currentTarget.value
          })), C(I, (() => {
            const ie = R(() => !!(L().enabled && L().anchorPoint === "date"));
            return () => ie() && (() => {
              const Ue = xm.cloneNode(!0);
              return C(Ue, w(Qt, {
                label: "Anchor date",
                get value() {
                  return n();
            ...
            const Ue = `klinecharts-pro-time-tools-switch${L().enabled ? " on" : ""}`, ke = `klinecharts-pro-time-tools-row${L().enabled ? "" : " disabled"}`, pe = !L().enabled, oe = `klinecharts-pro-time-tools-row with-divider${L().enabled ? "" : " disabled"}`, ce = `klinecharts-pro-time-tools-switch${L().anchorLine ? " on" : ""}`, Z = !L().enabled, O = `klinecharts-pro-time-tools-row with-divider${L().enabled ? "" : " disabled"}`, E = `klinecharts-pro-time-tools-switch${L().acrossTokens ? " on" : ""}`, be = !L().enabled;
            return Ue !== ie._v$3 && ne(W, ie._v$3 = Ue), ke !== ie._v$4 && ne(V, ie._v$4 = ke), pe !== ie._v$5 && (U.disabled = ie._v$5 = pe), oe !== ie._v$6 && ne(Q, ie._v$6 = oe), ce !== ie._v$7 && ne(te, ie._v$7 = ce), Z !== ie._v$8 && (te.disabled = ie._v$8 = Z), O !== ie._v$9 && ne(se, ie._v$9 = O), E !== ie._v$10 && ne($e, ie._v$10 = E), be !== ie._v$11 && ($e.disabled = ie._v$11 = be), ie;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
Ze(["click"]);
const Tm = /* @__PURE__ */ b('<i class="icon-close klinecharts-pro-load-icon"></i>'), Sm = /* @__PURE__ */ b('<div class="klinecharts-pro-content"><div class="klinecharts-pro-widget"></div></div>'), Pm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-anchor-line"></div>'), Dm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-navigation-tooltip"></div>'), Om = /* @__PURE__ */ b('<div class="klinecharts-pro-countdown-price-mark"><span class="klinecharts-pro-countdown-price-mark-price"></span><span class="klinecharts-pro-countdown-price-mark-timer"></span></div>'), Nm = /* @__PURE__ */ b('<div class="overlay-toolbar-color-popover"><div class="overlay-toolbar-color-grid"></div><div class="overlay-toolbar-color-footer"><button type="button" class="overlay-toolbar-add-color">+</button><div class="overlay-toolbar-color-slider"><span></span></div></div></div>'), Im = /* @__PURE__ */ b('<div class="overlay-toolbar-dropdown width-menu"></div>'), Em = /* @__PURE__ */ b('<div class="overlay-toolbar-dropdown style-menu"><button type="button"><span class="overlay-toolbar-style-sample solid"></span></button><button type="button"><span class="overlay-toolbar-style-sample dashed"></span></button><button type="button"><span class="overlay-toolbar-style-sample dotted"></span></button></div>'), Bm = /* @__PURE__ */ b('<div class="klinecharts-pro-overlay-toolbar"><button type="button" class="overlay-toolbar-icon drag" title="Move"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="6" r="1.5"></circle><circle cx="15" cy="6" r="1.5"></circle><circle cx="9" cy="12" r="1.5"></circle><circle cx="15" cy="12" r="1.5"></circle><circle cx="9" cy="18" r="1.5"></circle><circle cx="15" cy="18" r="1.5"></circle></svg></button><button type="button" class="overlay-toolbar-icon refresh" title="Reset"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 0 1 15.4-6.36L21 8"></path><path d="M21 3v5h-5"></path><path d="M21 12a9 9 0 0 1-15.4 6.36L3 16"></path><path d="M3 21v-5h5"></path></svg></button><div class="overlay-toolbar-picker"><button type="button" title="Color"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line width"><span class="overlay-toolbar-line-preview"></span><span>px</span></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line style"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 12h16"></path></svg></button></div><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="5" width="14" height="14" rx="2"></rect><path d="M20 4 4 20"></path></svg></button><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="10" width="14" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></button><button type="button" class="overlay-toolbar-icon delete" title="Delete"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"></path><path d="M8 6V4h8v2"></path><path d="M19 6 18 20H6L5 6"></path><path d="M10 11v5"></path><path d="M14 11v5"></path></svg></button></div>'), Fm = /* @__PURE__ */ b('<button type="button"></button>'), Um = /* @__PURE__ */ b('<button type="button"><span class="overlay-toolbar-width-sample"></span></button>'), zm = /* @__PURE__ */ b('<div class="klinecharts-pro-quick-order-marker"><button type="button" class="klinecharts-pro-quick-order-plus"></button></div>'), Km = /* @__PURE__ */ b('<span class="klinecharts-pro-quick-order-plus-icon"></span>'), jm = /* @__PURE__ */ b('<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3" aria-hidden="true"><path d="M460-300h40v-160h160v-40H500v-160h-40v160H300v40h160v160ZM224.62-160q-27.62 0-46.12-18.5Q160-197 160-224.62v-510.76q0-27.62 18.5-46.12Q197-800 224.62-800h510.76q27.62 0 46.12 18.5Q800-763 800-735.38v510.76q0 27.62-18.5 46.12Q763-160 735.38-160H224.62Zm0-40h510.76q9.24 0 16.93-7.69 7.69-7.69 7.69-16.93v-510.76q0-9.24-7.69-16.93-7.69-7.69-16.93-7.69H224.62q-9.24 0-16.93 7.69-7.69 7.69-7.69 16.93v510.76q0 9.24 7.69 16.93 7.69 7.69 16.93 7.69ZM200-760v560-560Z"></path></svg>'), Rm = /* @__PURE__ */ b('<div class="klinecharts-pro-quick-order-menu-anchor"><div class="klinecharts-pro-quick-order-menu"><button type="button">Trade <!> @ <!> Limit</button><button type="button">Trade <!> @ <!> Stop</button><button type="button">Create new order...</button><button type="button">Copy Price (<!>)</button><button type="button">Draw horizontal line on </button></div></div>'), Nn = "klinecharts_pro_time_anchor_settings";
function M9() {
  return {
    enabled: !1,
    timestamp: Date.now(),
...
function Qm() {
  try {
    const e = window.localStorage.getItem(Nn);
    if (!e)
      return null;
...
function Kr(e) {
  try {
    if (!e.enabled || !e.acrossTokens) {
      window.localStorage.removeItem(Nn);
      return;
    }
    window.localStorage.setItem(Nn, JSON.stringify(e));
  } catch {
  }
}
function Zt(e, t, r, n) {
...
const Vm = (e) => {
  var b0, $0, _0, k0, x0, L0, w0, A0, M0, T0, S0, P0, D0, O0, N0, I0, E0, B0, F0, U0, z0, K0, j0, R0, Q0, Z0, V0, H0;
  let t, r, n = null, s;
  const [l, h] = T(!1), [d, v] = T(e.theme), [x, p] = T(e.styles), [L, D] = T(e.locale), [M, Y] = T(e.symbol), [N, F] = T(e.period), I = () => {
    var o, i, a, u;
    return {
  ...
  }, [re, j] = T(!1), [W, V] = T([...e.mainIndicators]), [me, U] = T({}), [Q, H] = T(!1), [te, se] = T({
    key: e.timezone,
    text: Br(e.timezone, e.locale)
  }), [Le, $e] = T(!1), [ie, Ue] = T(), [ke, pe] = T(""), [oe, ce] = T(!1), [Z, O] = T(Date.now()), [E, be] = T({
    from: Date.now() - 30 * 24 * 60 * 60 * 1e3,
    to: Date.now()
  }), [we, de] = T(Qm() ?? M9()), [Ae, _] = T(e.drawingBarVisible), [le, Pe] = T(!1), [s1, ge] = T(!1), [g1, l1] = T(!1), X1 = ((b0 = e.orderTools) == null ? void 0 : b0.quickOrder) ?? !0, [Ie, yt] = T({
    quickOrder: X1,
    quickOrderFloatingWindow: (($0 = e.orderTools) == null ? void 0 : $0.quickOrderFloatingWindow) ?? X1,
    quickOrderPlusButton: ((_0 = e.orderTools) == null ? void 0 : _0.quickOrderPlusButton) ?? X1,
    openOrders: ((k0 = e.orderTools) == null ? void 0 : k0.openOrders) ?? !0,
    openOrdersExtendedPriceLine: ((x0 = e.orderTools) == null ? void 0 : x0.openOrdersExtendedPriceLine) ?? !0,
    openOrdersDisplay: ((L0 = e.orderTools) == null ? void 0 : L0.openOrdersDisplay) ?? "right",
    positions: ((w0 = e.orderTools) == null ? void 0 : w0.positions) ?? !0,
    breakevenPrice: ((A0 = e.orderTools) == null ? void 0 : A0.breakevenPrice) ?? !0,
    liquidationPrice: ((M0 = e.orderTools) == null ? void 0 : M0.liquidationPrice) ?? !0,
    priceLine: ((T0 = e.orderTools) == null ? void 0 : T0.priceLine) ?? !0,
    marketPriceLine: ((S0 = e.orderTools) == null ? void 0 : S0.marketPriceLine) ?? !0,
    countDown: ((P0 = e.orderTools) == null ? void 0 : P0.countDown) ?? !0,
    bidAskPrice: ((D0 = e.orderTools) == null ? void 0 : D0.bidAskPrice) ?? !0,
    orderHistory: ((O0 = e.orderTools) == null ? void 0 : O0.orderHistory) ?? !0
  }), [B1, L1] = T(null), [w1, e1] = T(!1), [pt, Ve] = T(!1), [J1, et] = T(64), [y1, A1] = T(null), tt = 6, [vt, F1] = T(null), [nt, Ct] = T(null), [bt, rt] = T(null), [je, ze] = T(null), [Re, Qe] = T(null), $t = ["#000000", "#2b3342", "#3f4653", "#565d69", "#6f7580", "#8a9099", "#a7acb3", "#c4c8ce", "#ffffff", "#ff4d67", "#ffa629", "#f7ed4a", "#2fc58d", "#4ab09c", "#52c4d3", "#3157f6", "#6a36b8", "#a644b9", "#d83972", "#f2a3a6", "#f5c879", "#f7ee97", "#a6d29f", "#7fc9b9", "#91d7df", "#8fb2ee", "#b09ad2", "#c89ccf", "#d987ab", "#e8757a", "#efb34f", "#efe36e", "#86c17d", "#66b7a8", "#68c4d0", "#5f91e4", "#8059c9", "#aa62c2", "#d34d83", "#b9353d", "#ea8527", "#e8c245", "#4b8c43", "#2f6f60", "#47919b", "#2646c6", "#56309c", "#892f95", "#a82563", "#8e2528", "#de5c1f", "#dc8527", "#255a22", "#164b34", "#225b63", "#15309b", "#442180", "#6b1f74", "#86154e"];
  let ot = null;
  const [U1, _t] = T({
    visible: !1,
    indicatorName: "",
  ...
  const kt = (o, i, a) => {
    ...
    priceLine: 1,
    priceChannelLine: 3
  })[o] || 1, v1 = (o, i = /* @__PURE__ */ new WeakSet()) => {
    if (o == null)
      return o;
    if (i.has(o))
      return "[Circular]";
    ...
    try {
      return {
        ...
        extendData: v1(o.extendData || {}),
        styles: v1(o.styles || {}),
        visible: o.visible ?? !0,
        lock: o.lock ?? !1,
        mode: o.mode || pn.Normal
      };
    } catch (i) {
    ...
    document.addEventListener("mouseup", u), document.addEventListener("touchend", u), setTimeout(() => {
      ...
      const m = Ee.get(o);
      if (m && !m.complete) {
        m.checkInterval && clearInterval(m.checkInterval), m.mouseUpHandler && (document.removeEventListener("mouseup", m.mouseUpHandler), document.removeEventListener("touchend", m.mouseUpHandler)), c1(o);
        const f = xe.get(o);
        if (f) {
          const y = p1(f.type), k = ((g = f.points) == null ? void 0 : g.length) || 0;
      ...
      try {
        const a = `kline_drawings_${o}`, m = {
          drawings: i.map((g) => {
            ...
            f.extendData && (f.extendData = v1(f.extendData)), f.styles && (f.styles = v1(f.styles));
            const y = p1(g.type), k = ((A = g.points) == null ? void 0 : A.length) || 0;
  ...
  const M1 = () => {
    ...
    }), xe.clear(), Ee.clear(), ze(null), Qe(null), u1.loadDrawings(o).forEach((a) => {
      var u;
      try {
        const m = b1({
          name: a.type,
    ...
    const i = (g = n == null ? void 0 : n.getSize) == null ? void 0 : g.call(n, "candle_pane", r1.YAxis);
    ...
    if (i) {
      if (Number.isFinite(o == null ? void 0 : o.pageX) ? g = o.pageX - i.left : Number.isFinite(o == null ? void 0 : o.x) && a && (g = a.left - i.left + o.x), Number.isFinite(o == null ? void 0 : o.pageY))
        ...
        try {
          const G = (q = n == null ? void 0 : n.convertToPixel) == null ? void 0 : q.call(n, [{
            value: m.value
          }], {
            paneId: "candle_pane",
            absolute: !0
    ...
    if (!(i != null && i.id) || i.name !== "horizontalStraightLine")
      return !1;
    const a = At(o), u = Number((k = (y = i.styles) == null ? void 0 : y.line) == null ? void 0 : k.size) || 3, m = ((P = (A = i.styles) == null ? void 0 : A.line) == null ? void 0 : P.style) ?? h1.Solid, g = Array.isArray((X = (q = i.styles) == null ? void 0 : q.line) == null ? void 0 : X.dashedValue) ? i.styles.line.dashedValue : [], f = ((K = (G = i.styles) == null ? void 0 : G.line) == null ? void 0 : K.color) ?? "#2f6df6";
    return ze({
      id: i.id,
      x: a.x,
      y: a.y,
    ...
    return (!i || ((u = je()) == null ? void 0 : u.id) === i) && (ze(null), Qe(null)), !1;
  }, b1 = (o) => {
    var f, y, k, A, P, q, X, G, K;
    ...
    return {
      ...
      styles: {
        ...
        line: {
          ...
          style: ((P = (A = o.styles) == null ? void 0 : A.line) == null ? void 0 : P.style) ?? h1.Solid,
          dashedValue: ((X = (q = o.styles) == null ? void 0 : q.line) == null ? void 0 : X.dashedValue) ?? [6, 4],
    ...
    if (!o)
      return;
    const i = 1, a = h1.Solid, u = [6, 4], m = "#2f6df6";
    S({
      styles: {
        line: {
          size: i,
    ...
    if (!a)
      return;
    const u = o.clientX, m = o.clientY, g = i.x, f = i.y, y = (q) => {
      q.preventDefault();
      const X = g + q.clientX - u, G = f + q.clientY - m;
      ze({
        ...i,
  ...
  let Wn = (N0 = e.orderTools) == null ? void 0 : N0.quickOrder, Gn = (I0 = e.orderTools) == null ? void 0 : I0.quickOrderFloatingWindow, Xn = (E0 = e.orderTools) == null ? void 0 : E0.quickOrderPlusButton, Jn = (B0 = e.orderTools) == null ? void 0 : B0.openOrders, e0 = (F0 = e.orderTools) == null ? void 0 : F0.openOrdersExtendedPriceLine, t0 = (U0 = e.orderTools) == null ? void 0 : U0.openOrdersDisplay, n0 = (z0 = e.orderTools) == null ? void 0 : z0.positions, r0 = (K0 = e.orderTools) == null ? void 0 : K0.breakevenPrice, o0 = (j0 = e.orderTools) == null ? void 0 : j0.liquidationPrice, i0 = (R0 = e.orderTools) == null ? void 0 : R0.priceLine, a0 = (Q0 = e.orderTools) == null ? void 0 : Q0.marketPriceLine, s0 = (Z0 = e.orderTools) == null ? void 0 : Z0.countDown, l0 = (V0 = e.orderTools) == null ? void 0 : V0.bidAskPrice, c0 = (H0 = e.orderTools) == null ? void 0 : H0.orderHistory;
  Ke(() => {
    var ee, he, Me, z, ue, ae, _e, Te, We, Ge, n1, Xe, Je, ut;
    const o = (ee = e.orderTools) == null ? void 0 : ee.quickOrder, i = (he = e.orderTools) == null ? void 0 : he.quickOrderFloatingWindow, a = (Me = e.orderTools) == null ? void 0 : Me.quickOrderPlusButton, u = (z = e.orderTools) == null ? void 0 : z.openOrders, m = (ue = e.orderTools) == null ? void 0 : ue.openOrdersExtendedPriceLine, g = (ae = e.orderTools) == null ? void 0 : ae.openOrdersDisplay, f = (_e = e.orderTools) == null ? void 0 : _e.positions, y = (Te = e.orderTools) == null ? void 0 : Te.breakevenPrice, k = (We = e.orderTools) == null ? void 0 : We.liquidationPrice, A = (Ge = e.orderTools) == null ? void 0 : Ge.priceLine, P = (n1 = e.orderTools) == null ? void 0 : n1.marketPriceLine, q = (Xe = e.orderTools) == null ? void 0 : Xe.countDown, X = (Je = e.orderTools) == null ? void 0 : Je.bidAskPrice, G = (ut = e.orderTools) == null ? void 0 : ut.orderHistory, K = {};
    typeof o == "boolean" && o !== Wn && (Wn = o, K.quickOrder = o, typeof i != "boolean" && (K.quickOrderFloatingWindow = o), typeof a != "boolean" && (K.quickOrderPlusButton = o)), typeof i == "boolean" && i !== Gn && (Gn = i, K.quickOrderFloatingWindow = i), typeof a == "boolean" && a !== Xn && (Xn = a, K.quickOrderPlusButton = a), typeof u == "boolean" && u !== Jn && (Jn = u, K.openOrders = u), typeof m == "boolean" && m !== e0 && (e0 = m, K.openOrdersExtendedPriceLine = m), g !== void 0 && g !== t0 && (t0 = g, K.openOrdersDisplay = g), typeof f == "boolean" && f !== n0 && (n0 = f, K.positions = f), typeof y == "boolean" && y !== r0 && (r0 = y, K.breakevenPrice = y), typeof k == "boolean" && k !== o0 && (o0 = k, K.liquidationPrice = k), typeof A == "boolean" && A !== i0 && (i0 = A, K.priceLine = A, typeof P != "boolean" && (K.marketPriceLine = A), typeof q != "boolean" && (K.countDown = A), typeof X != "boolean" && (K.bidAskPrice = A)), typeof P == "boolean" && P !== a0 && (a0 = P, K.marketPriceLine = P), typeof q == "boolean" && q !== s0 && (s0 = q, K.countDown = q), typeof X == "boolean" && X !== l0 && (l0 = X, K.bidAskPrice = X), typeof G == "boolean" && G !== c0 && (c0 = G, K.orderHistory = G), Object.keys(K).length > 0 && at(K);
  }), Ke(() => {
    ...
    getSettings: () => {
      var a, u, m, g, f, y, k, A, P, q, X, G, K, ee, he, Me;
      if (!n)
        return {};
      ...
      return {
        ...
        showLowestPrice: (X = (q = (P = o.candle) == null ? void 0 : P.priceMark) == null ? void 0 : q.low) == null ? void 0 : X.show,
        // Indicator settings
    ...
    setSettings: (o) => {
      var a, u, m, g, f, y, k, A, P, q, X, G, K, ee;
      if (!n)
        return;
      const i = {};
      ...
      o.showLastPrice !== void 0 && (i.candle = {
        ...
        priceMark: {
          ...
          high: {
            ...(q = (P = i.candle) == null ? void 0 : P.priceMark) == null ? void 0 : q.high,
    ...
    saveDrawings: (o) => {
      ...
      i.forEach((a, u) => {
        var f;
        const m = p1(a.type), g = ((f = a.points) == null ? void 0 : f.length) || 0;
        g < m && console.warn(`âš ï¸ ${a.type} ${a.id} has only ${g} point(s), should have ${m}`);
      }), u1.saveDrawings(o, i);
    },
    loadDrawings: (o) => {
      u1.loadDrawings(o).forEach((a, u) => {
        var m;
        try {
          const g = {
            name: a.type,
    ...
    getDrawings: (o) => u1.loadDrawings(o),
    clearDrawings: (o) => {
      u1.clearDrawings(o);
    },
  ...
  const u0 = () => {
    n == null || n.resize(), He(), g0(), $1();
  };
  let Ot, Nt, It, ct = !1, d0 = 0;
  const T9 = () => {
    if (ct || Date.now() < d0)
      return;
    const o = we();
    if (!o.enabled || o.anchorPoint === "date")
      return;
    const i = p0(o.anchorPoint, o.timestamp);
    ...
    He(), g0(), $1(), S9();
  }, f0 = [S1.OnVisibleRangeChange, S1.OnZoom, S1.OnScroll], P9 = (o) => {
    ...
    if (!n || !t)
      return null;
    const i = D9(o), a = i == null ? void 0 : i.candle, u = Number((a == null ? void 0 : a.timestamp) ?? o), m = Number((a == null ? void 0 : a.high) ?? (a == null ? void 0 : a.close) ?? (a == null ? void 0 : a.open)), g = i ? Et(i.dataIndex) : void 0, f = i && Number.isFinite(m) ? {
      dataIndex: g,
      value: m
    } : {
      timestamp: u
      ...
      paneId: "candle_pane",
      absolute: !0
    }), k = Number((G = y == null ? void 0 : y[0]) == null ? void 0 : G.x), A = Number((K = y == null ? void 0 : y[0]) == null ? void 0 : K.y), P = t.clientWidth, q = t.clientHeight;
    return !Number.isFinite(k) || k < -80 || k > P + 80 ? null : {
      timestamp: u,
      text: P9(u),
      left: Math.max(58, Math.min(k, P - 58)),
      top: Number.isFinite(A) ? Math.max(8, Math.min(A - 42, q - 38)) : 10
    };
  }, g0 = () => {
    const o = nt();
    if (!o || !n || !t)
      return;
    const i = m0(o.timestamp);
    i && Ct(i);
  }, Bt = (o, i = 0) => {
    if (!n || !t)
      return;
    ...
    if (!n || !t || o.length === 0)
      return;
    const i = ((g = n.getSize("candle_pane", r1.YAxis)) == null ? void 0 : g.width) ?? 0, a = ((f = n.getSize("candle_pane", r1.Main)) == null ? void 0 : f.width) ?? t.clientWidth - i, u = Math.max(1, a - 8), m = Math.max(2, u / Math.max(1, o.length));
    ...
    if (!n || !t)
      return null;
    const i = (k = n.getDom) == null ? void 0 : k.call(n, "candle_pane", r1.Main), a = (A = i == null ? void 0 : i.getBoundingClientRect) == null ? void 0 : A.call(i), u = (P = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : P.call(r), m = t.getBoundingClientRect(), g = a && Number.isFinite(a.left) ? a.left - ((u == null ? void 0 : u.left) ?? m.left) : m.left - ((u == null ? void 0 : u.left) ?? m.left), f = n.getSize("candle_pane", r1.Main), y = (a == null ? void 0 : a.width) ?? (f == null ? void 0 : f.width) ?? t.clientWidth;
    ...
    const m = (P = n.convertFromPixel) == null ? void 0 : P.call(n, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), g = Number((q = m == null ? void 0 : m[0]) == null ? void 0 : q.dataIndex), f = Math.max(0, Math.min(u.length - 1, Number.isFinite(g) ? Math.round(g) : -1)), y = O9(i);
    if (y) {
    ...
    if (!n || !Number.isFinite(o.timestamp))
      return;
    if (ct = !0, d0 = Date.now() + 1e3, o.anchorPoint === "date") {
      gn(o.timestamp), window.setTimeout(() => {
        ct = !1;
      }, 1e3);
      return;
    }
    const i = y0(o.timestamp, "nearest"), a = Et(i), u = yn(o.anchorPoint);
    if (a < 0 || u === null) {
      gn(o.timestamp), window.setTimeout(() => {
        ct = !1;
      }, 1e3);
    ...
    if (i !== null)
      return i;
    const a = Et(y0(o.timestamp, "nearest")), u = a >= 0 ? {
      dataIndex: a
    } : {
    ...
    const a = j9(i), u = (P = n.getDom) == null ? void 0 : P.call(n, "candle_pane", r1.Main), m = (q = u == null ? void 0 : u.getBoundingClientRect) == null ? void 0 : q.call(u), g = (X = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : X.call(r), f = (G = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : G.call(t), y = n.getSize("candle_pane", r1.Main), k = m && Number.isFinite(m.top) ? m.top - ((g == null ? void 0 : g.top) ?? (f == null ? void 0 : f.top) ?? 0) : 0, A = Math.max(1, (m == null ? void 0 : m.height) ?? (y == null ? void 0 : y.height) ?? 0);
    if (a === null) {
      rt(null);
      return;
    }
    ...
    if (n) {
      ...
      try {
        const a = N(), u = o.from <= o.to ? o : {
          from: o.to,
          to: o.from
        }, m = E9(u), g = i ? m : z9(m, a), f = await e.datafeed.getHistoryKLineData(M(), a, g.from, g.to), y = B9(f, m);
        n.applyNewData(f, f.length > 0), be(m), requestAnimationFrame(() => {
          const k = U9(f, m);
          i ? gn(i) : (K9(y), n == null || n.scrollToDataIndex(k, 0), Bt(F9(y, m))), $1();
        });
      } finally {
        h(!1), ge(!1);
      }
    ...
    const a = {
      ...o,
      timestamp: (() => !n || o.anchorPoint === "date" ? o.timestamp : p0(o.anchorPoint, o.timestamp))()
    };
    de(a), Kr(a), a.enabled ? (O(a.timestamp), requestAnimationFrame(() => {
      v0(a), $1(a);
    })) : requestAnimationFrame(() => $1(a));
  };
  En(() => {
    if (window.addEventListener("resize", u0), n = Y9(t, {
      customApi: {
        formatDate: (f, y, k, A) => {
          switch (N().timespan) {
            case "minute":
      ...
      const f = n.getDom("candle_pane", r1.Main);
      if (f) {
      ...
      const y = n.getDom("candle_pane", r1.YAxis);
    ...
    e.subIndicators.forEach((f) => {
      ...
      h(!0), (async () => {
        try {
          const k = N(), [A] = mn(k, f, 1), [P] = mn(k, A, 500), q = await e.datafeed.getHistoryKLineData(M(), k, P, A);
          n == null || n.applyMoreData(q, q.length > 0);
        } finally {
          h(!1);
        }
      })();
    ...
    }), n == null || n.subscribeAction(S1.OnCrosshairChange, st), f0.forEach((f) => {
      n == null || n.subscribeAction(f, h0);
    }), Ot = window.setInterval(() => He(), 1e3), He(), document.addEventListener("mousedown", Yn);
    ...
    n && g && (n.createOverlay = function(...f) {
      ...
      return A && (it(A, y.name || "unknown"), c1(A), M1()), k;
    });
  }), N1(() => {
    window.removeEventListener("resize", u0), n == null || n.unsubscribeAction(S1.OnCrosshairChange, st), f0.forEach((o) => {
      n == null || n.unsubscribeAction(o, h0);
    }), Ot && (window.clearInterval(Ot), Ot = void 0), Nt && (window.clearTimeout(Nt), Nt = void 0), document.removeEventListener("mousedown", Yn), Ee.clear(), xe.clear(), G0(t);
  }), Ke(() => {
    const o = M();
  ...
  return Ke((o) => {
    ...
    return N1(() => {
      ...
      try {
        const g = i1(we), f = g.enabled && (!o || o.symbol.ticker === i.ticker || g.acrossTokens), y = f ? I9(g, a) : null, [k, A] = y ? [y.from, y.to] : mn(a, (/* @__PURE__ */ new Date()).getTime(), 500), P = await e.datafeed.getHistoryKLineData(i, a, k, A);
        if (!u)
          return;
        ...
        }, 0), e.datafeed.subscribe(i, a, (q) => {
          n == null || n.updateData(q), He();
        });
      } finally {
        u && (h(!1), ge(!1));
      }
    ...
    x() && (n == null || n.setStyles(x()), Ft(), Ue(al(n.getStyles())));
  }), [Tm.cloneNode(!0), w(gh, {
    get locale() {
      return e.locale;
    },
    ...
    const o = Sm.cloneNode(!0), i = o.firstChild;
    return o.addEventListener("mouseleave", () => {
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Om.cloneNode(!0), m = u.firstChild, g = m.nextSibling;
        return u.style.setProperty("right", "0px"), C(m, () => a.priceText), C(g, () => a.text), B((f) => {
          const y = `${a.top}px`, k = `${a.width}px`, A = a.color, P = `${a.borderRadius}px`, q = a.textFamily, X = a.textWeight, G = `${a.paddingLeft}px`, K = `${a.paddingRight}px`, ee = `${a.paddingTop}px`, he = `${a.paddingBottom}px`, Me = `${a.textSize}px`, z = `${Math.max(10, a.textSize - 1)}px`;
          return y !== f._v$6 && u.style.setProperty("top", f._v$6 = y), k !== f._v$7 && u.style.setProperty("width", f._v$7 = k), A !== f._v$8 && u.style.setProperty("background", f._v$8 = A), P !== f._v$9 && u.style.setProperty("border-radius", f._v$9 = P), q !== f._v$10 && u.style.setProperty("font-family", f._v$10 = q), X !== f._v$11 && u.style.setProperty("font-weight", f._v$11 = X), G !== f._v$12 && u.style.setProperty("padding-left", f._v$12 = G), K !== f._v$13 && u.style.setProperty("padding-right", f._v$13 = K), ee !== f._v$14 && u.style.setProperty("padding-top", f._v$14 = ee), he !== f._v$15 && u.style.setProperty("padding-bottom", f._v$15 = he), Me !== f._v$16 && m.style.setProperty("font-size", f._v$16 = Me), z !== f._v$17 && g.style.setProperty("font-size", f._v$17 = z), f;
        }, {
          _v$6: void 0,
          _v$7: void 0,
          _v$8: void 0,
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Bm.cloneNode(!0), m = u.firstChild, g = m.nextSibling, f = g.nextSibling, y = f.firstChild, k = f.nextSibling, A = k.firstChild, P = A.firstChild, q = P.nextSibling, X = q.firstChild, G = k.nextSibling, K = G.firstChild, ee = G.nextSibling, he = ee.nextSibling, Me = he.nextSibling;
        return u.$$click = (z) => {
          z.stopPropagation();
        }, u.$$mousedown = (z) => {
          z.preventDefault(), z.stopPropagation();
        }, m.$$mousedown = Pt, g.$$click = Tt, y.$$click = () => Qe(Re() === "color" ? null : "color"), C(f, w(J, {
          get when() {
            return Re() === "color";
          },
          get children() {
            const z = Nm.cloneNode(!0), ue = z.firstChild;
            return C(ue, w(Ln, {
              each: $t,
              children: (ae) => (() => {
                const _e = Fm.cloneNode(!0);
        ...
        }), null), A.$$click = () => Qe(Re() === "width" ? null : "width"), C(q, () => a.lineSize, X), C(k, w(J, {
          get when() {
            return Re() === "width";
          },
          get children() {
            ...
            return C(z, w(Ln, {
              each: [1, 2, 3, 4],
              children: (ue) => (() => {
                const ae = Um.cloneNode(!0), _e = ae.firstChild;
                return ae.$$click = () => t1(ue), _e.style.setProperty("height", `${ue}px`), B(() => ne(ae, a.lineSize === ue ? "selected" : "")), ae;
              })()
            })), z;
          }
        }), null), K.$$click = () => Qe(Re() === "style" ? null : "style"), C(G, w(J, {
          get when() {
            return Re() === "style";
          },
          get children() {
            const z = Em.cloneNode(!0), ue = z.firstChild, ae = ue.nextSibling, _e = ae.nextSibling;
            return ue.$$click = () => d1(h1.Solid, []), ae.$$click = () => d1(h1.Dashed, [6, 4]), _e.$$click = () => d1(h1.Dashed, [2, 4]), B((Te) => {
              var Xe, Je;
              const We = a.lineStyle === h1.Solid ? "selected" : "", Ge = a.lineStyle === h1.Dashed && ((Xe = a.dashedValue) == null ? void 0 : Xe[0]) === 6 ? "selected" : "", n1 = a.lineStyle === h1.Dashed && ((Je = a.dashedValue) == null ? void 0 : Je[0]) === 2 ? "selected" : "";
          ...
          const ue = `${a.x}px`, ae = `${a.y}px`, _e = `overlay-toolbar-icon edit ${Re() === "color" ? "active" : ""}`, Te = `overlay-toolbar-line-size ${Re() === "width" ? "active" : ""}`, We = `overlay-toolbar-icon minus ${Re() === "style" ? "active" : ""}`, Ge = `overlay-toolbar-icon visibility ${a.visible ? "" : "muted"}`, n1 = a.visible ? "Hide" : "Show", Xe = `overlay-toolbar-icon lock ${a.locked ? "active" : ""}`, Je = a.locked ? "Unlock" : "Lock";
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = zm.cloneNode(!0), m = u.firstChild;
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Rm.cloneNode(!0), m = u.firstChild, g = m.firstChild, f = g.firstChild, y = f.nextSibling, k = y.nextSibling, A = k.nextSibling;
        A.nextSibling;
        const P = g.nextSibling, q = P.firstChild, X = q.nextSibling, G = X.nextSibling, K = G.nextSibling;
        K.nextSibling;

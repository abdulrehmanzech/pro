...
import { utils as Q, OverlayMode as n0, init as E9, FormatDateType as J1, DomPosition as r0, ActionType as O9, dispose as a0, TooltipIconPosition as W1, CandleType as B9, YAxisType as U9, registerOverlay as K9 } from "klinecharts";
function z1(e, t, n) {
...
const F9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    const r = [], a = [];
    if (e.length > 1) {
      const s = e[1].x > e[0].x ? e[0].x : e[1].x, l = [1, 0.786, 0.618, 0.5, 0.382, 0.236, 0], o = e[0].y - e[1].y, u = t.points, y = u[0].value - u[1].value;
      l.forEach((d) => {
        const h = e[1].y + o * d, L = (u[1].value + y * d).toFixed(n.price);
        r.push({ coordinates: [{ x: e[0].x, y: h }, { x: e[1].x, y: h }] }), a.push({
          x: s,
          y: h,
          text: `${L} (${(d * 100).toFixed(1)}%)`,
          baseline: "bottom"
        });
      });
    }
    ...
    if (e.length > 1) {
      ...
      for (let h = 2; h < 9; h++) {
        ...
        switch (h % 4) {
          ...
          case 1: {
            x = s + Math.PI / 2, d -= u[h - 2].r;
            break;
          }
          case 2: {
            x = s + Math.PI, y += u[h - 2].r;
            break;
          }
          case 3: {
            x = s + Math.PI / 2 * 3, d += u[h - 2].r;
            break;
          }
        }
        const I = x + Math.PI / 2, P = z1({ x: y, y: d }, e[0], s);
        u.push({
          ...P,
          r: L,
          startAngle: x,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    const a = [];
    if (e.length > 1) {
      const s = e[1].x > e[0].x ? -38 : 4, l = e[1].y > e[0].y ? -2 : 20, o = e[1].x - e[0].x, u = e[1].y - e[0].y;
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((d) => {
        const h = e[1].x - o * d, L = e[1].y - u * d;
        n.push({ coordinates: [{ x: h, y: e[0].y }, { x: h, y: e[1].y }] }), n.push({ coordinates: [{ x: e[0].x, y: L }, { x: e[1].x, y: L }] }), r = r.concat(we([e[0], { x: h, y: e[1].y }], t)), r = r.concat(we([e[0], { x: e[1].x, y: L }], t)), a.unshift({
          x: e[0].x + s,
          y: L + 10,
          text: `${d.toFixed(3)}`
        }), a.unshift({
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    const r = [], a = [];
    if (e.length > 2) {
      const s = t.points, l = s[1].value - s[0].value, o = e[1].y - e[0].y, u = [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1], y = e[2].x > e[1].x ? e[1].x : e[2].x;
      u.forEach((d) => {
        const h = e[2].y + o * d, L = (s[2].value + l * d).toFixed(n.price);
...
class Ou {
  ...
  subscribe(t, n, r) {
    ...
    this._prevSymbolMarket !== t.market ? ((a = this._ws) == null || a.close(), this._ws = new WebSocket(`wss://delayed.polygon.io/${t.market}`), this._ws.onopen = () => {
      ...
      o[0].ev === "status" ? o[0].status === "auth_success" && ((u = this._ws) == null || u.send(JSON.stringify({ action: "subscribe", params: `T.${t.ticker}` }))) : "sym" in o && r({
        timestamp: o.s,
        open: o.o,
        high: o.h,
        low: o.l,
...
const i5 = (e, t) => e === t, Me = Symbol("solid-proxy"), s5 = Symbol("solid-track"), ae = {
  equals: i5
};
let Y0 = J0;
const y1 = 1, ie = 2, H0 = {
...
var X = null;
let $1 = null, j = null, q = null, d1 = null, Oe = 0;
function ne(e, t) {
  const n = j, r = X, a = e.length === 0, s = a ? H0 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function o5(e, t, n) {
  ...
  let l = null, o = be, u = null, y = !1, d = "initialValue" in s, h = typeof r == "function" && z(r);
  const L = /* @__PURE__ */ new Set(), [x, I] = (s.storage || A)(s.initialValue), [P, w] = A(void 0), [T, U] = A(void 0, {
    equals: !1
  }), [N, D] = A(d ? "ready" : "unresolved");
  if (e1.context) {
    u = `${e1.context.id}${e1.context.count++}`;
    let E;
    s.ssrLoadFrom === "initial" ? o = s.initialValue : e1.load && (E = e1.load(u)) && (o = E[0]);
  }
  function S(E, Z, Y, u1) {
  ...
  function R(E, Z) {
    p1(() => {
      Z === void 0 && I(() => E), D(Z !== void 0 ? "errored" : "ready"), w(Z);
  ...
  function t1() {
    ...
    if (Y !== void 0 && !l)
      throw Y;
    return j && !j.user && E && i0(() => {
      T(), l && (E.resolved || L.has(E) || (E.increment(), L.add(E)));
    }), Z;
  }
  function l1(E = !0) {
    if (E !== !1 && y)
    ...
    const Y = o !== be ? o : f1(() => a(Z, {
      value: x(),
      refetching: E
    }));
    return typeof Y != "object" || !(Y && "then" in Y) ? (S(l, Y, void 0, Z), Y) : (l = Y, y = !0, queueMicrotask(() => y = !1), p1(() => {
      D(d ? "refreshing" : "pending"), U();
    }, !1), Y.then((u1) => S(Y, u1, void 0, Z), (u1) => S(Y, void 0, q0(u1), Z)));
  }
...
function c5(e) {
  ...
  return Promise.resolve().then(() => {
    j = t, X = n;
    let r;
    return p1(e, !1), j = X = null, r ? r.done : void 0;
  });
}
let l5;
function G0() {
...
function X0(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && p1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      l && $1.disposed.has(s), (l && !s.tState || !l && !s.state) && (s.pure ? q.push(s) : d1.push(s), s.observers && W0(s)), l || (s.state = y1);
    }
    if (q.length > 1e6)
      throw q = [], new Error();
  }, !1)), t;
...
function oe(e, t) {
  ...
  for (let r = 0; r < e.sources.length; r += 1) {
    const a = e.sources[r];
    a.sources && (a.state === y1 || n ? a !== t && se(a) : (a.state === ie || n) && oe(a, t));
  }
}
function W0(e) {
  const t = $1;
  for (let n = 0; n < e.observers.length; n += 1) {
    ...
    (!r.state || t) && (r.state = ie, r.pure ? q.push(r) : d1.push(r), r.observers && W0(r));
  }
}
function ye(e) {
  let t;
...
function y5(e, t, n = {}) {
  ...
  return Be(() => s0(s)), () => {
    let u = e() || [], y, d;
    return u[s5], f1(() => {
      let L = u.length, x, I, P, w, T, U, N, D, S;
      if (L === 0)
        l !== 0 && (s0(s), s = [], r = [], a = [], l = 0, o && (o = [])), n.fallback && (r = [f5], a[0] = ne((R) => (s[0] = R, n.fallback())), l = 1);
      else if (l === 0) {
        for (a = new Array(L), d = 0; d < L; d++)
          r[d] = u[d], a[d] = ne(h);
        l = L;
      } else {
        for (P = new Array(L), w = new Array(L), o && (T = new Array(L)), U = 0, N = Math.min(l, L); U < N && r[U] === u[U]; U++)
          ;
        for (N = l - 1, D = L - 1; N >= U && D >= U && r[N] === u[D]; N--, D--)
          P[D] = a[N], w[D] = s[N], o && (T[D] = o[N]);
        for (x = /* @__PURE__ */ new Map(), I = new Array(D + 1), d = D; d >= U; d--)
          S = u[d], y = x.get(S), I[d] = y === void 0 ? -1 : y, x.set(S, d);
        for (y = U; y <= N; y++)
          S = r[y], d = x.get(S), d !== void 0 && d !== -1 ? (P[d] = a[y], w[d] = s[y], o && (T[d] = o[y]), d = I[d], x.set(S, d)) : s[y]();
        for (d = U; d < L; d++)
          d in P ? (a[d] = P[d], s[d] = w[d], o && (o[d] = T[d], o[d](d))) : a[d] = ne(h);
        a = a.slice(0, l = L), r = u.slice(0);
      }
      return a;
    });
    function h(L) {
...
function p5(e, t, n) {
  let r = n.length, a = t.length, s = r, l = 0, o = 0, u = t[a - 1].nextSibling, y = null;
  for (; l < a || o < s; ) {
    if (t[l] === n[o]) {
      l++, o++;
      continue;
    ...
    for (; t[a - 1] === n[s - 1]; )
      a--, s--;
    if (a === l) {
      const d = s < r ? o ? n[o - 1].nextSibling : n[s - o] : u;
      for (; o < s; )
      ...
      if (d != null)
        if (o < d && d < s) {
          let h = l, L = 1, x;
          for (; ++h < a && h < s && !((x = y.get(t[h])) == null || x !== d + L); )
            L++;
          if (L > d - o) {
            const I = t[l];
            for (; o < d; )
...
function ce(e, t, n, r, a) {
  ...
  if (e = l && n[0] && n[0].parentNode || e, s === "string" || s === "number") {
    ...
    if (Array.isArray(t)) {
      const o = [], u = n && Array.isArray(n);
      if (Se(o, t, n, a))
        return V(() => n = ce(e, o, n, r, !0)), () => n;
      if (e1.context) {
        if (!o.length)
          return n;
      ...
      if (o.length === 0) {
        ...
        u ? n.length === 0 ? c0(e, o, r) : p5(e, n, o) : (n && w1(e), c0(e, o));
      n = o;
    ...
    if (o instanceof Node)
      ...
      if (Array.isArray(o))
        ...
        if (r) {
          for (; typeof o == "function"; )
            o = o();
          a = Se(e, Array.isArray(o) ? o : [o], Array.isArray(u) ? u : [u]) || a;
        } else
          e.push(o), a = !0;
      else {
        const y = String(o);
  ...
  if (t.length) {
    ...
    for (let l = t.length - 1; l >= 0; l--) {
      ...
      if (a !== o) {
        ...
        !s && !l ? u ? e.replaceChild(a, o) : e.insertBefore(a, n) : u && o.remove();
      } else
        s = !0;
    }
  } else
...
var _5 = typeof ee == "object" && ee && ee.Object === Object && ee, r9 = _5, $5 = r9, L5 = typeof self == "object" && self && self.Object === Object && self, b5 = $5 || L5 || Function("return this")(), c1 = b5, x5 = c1, k5 = x5.Symbol, ge = k5, l0 = ge, a9 = Object.prototype, A5 = a9.hasOwnProperty, w5 = a9.toString, Q1 = l0 ? l0.toStringTag : void 0;
function M5(e) {
...
var T1 = K5, F5 = R1, j5 = T1, Z5 = "[object AsyncFunction]", Q5 = "[object Function]", z5 = "[object GeneratorFunction]", R5 = "[object Proxy]";
function Y5(e) {
  if (!j5(e))
    return !1;
  var t = F5(e);
...
var P1 = T6, I6 = R1, P6 = P1, D6 = "[object Symbol]";
function N6(e) {
...
var W6 = J6, q6 = pe, e2 = Object.prototype, t2 = e2.hasOwnProperty;
function n2(e) {
  var t = this.__data__;
...
var o2 = s2, c2 = z6, l2 = Y6, u2 = W6, C2 = r2, d2 = o2;
function D1(e) {
...
var I2 = T2, P2 = h2, D2 = L2, N2 = k2, E2 = M2, O2 = I2;
function N1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
N1.prototype.clear = P2;
N1.prototype.delete = D2;
N1.prototype.get = N2;
N1.prototype.has = E2;
N1.prototype.set = O2;
var ve = N1, B2 = b1, U2 = c1, K2 = B2(U2, "Map"), Fe = K2, h0 = f2, F2 = ve, j2 = Fe;
function Z2() {
...
var it = at, st = Q2, ot = X2, ct = q2, lt = nt, ut = it;
function E1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
E1.prototype.clear = st;
E1.prototype.delete = ot;
E1.prototype.get = ct;
E1.prototype.has = lt;
E1.prototype.set = ut;
var l9 = E1, u9 = l9, Ct = "Expected a function";
function je(e, t) {
...
je.Cache = u9;
var dt = je, ft = dt, yt = 500;
function ht(e) {
  var t = ft(e, function(r) {
    return n.size === yt && n.clear(), r;
  }), n = t.cache;
  return t;
}
var gt = ht, pt = gt, mt = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, vt = /\\(\\)?/g, _t = pt(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(mt, function(n, r, a, s) {
    t.push(a ? s.replace(vt, "$1") : r || n);
  }), t;
}), $t = _t;
function Lt(e, t) {
...
var bt = Lt, g0 = ge, xt = bt, kt = I1, At = Ke, wt = 1 / 0, p0 = g0 ? g0.prototype : void 0, m0 = p0 ? p0.toString : void 0;
function C9(e) {
  if (typeof e == "string")
    return e;
  if (kt(e))
...
var It = Tt, Pt = I1, Dt = F6, Nt = $t, Et = It;
function Ot(e, t) {
  return Pt(e) ? e : Dt(e, t) ? [e] : Nt(Et(e));
}
var Bt = Ot, Ut = 9007199254740991, Kt = /^(?:0|[1-9]\d*)$/;
function Ft(e, t) {
  var n = typeof e;
  return t = t ?? Ut, !!t && (n == "number" || n != "symbol" && Kt.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var d9 = Ft, jt = Ke, Zt = 1 / 0;
function Qt(e) {
...
var zt = Qt, Rt = Ue, Yt = Bt, Ht = d9, v0 = T1, Vt = zt;
function Gt(e, t, n, r) {
  if (!v0(e))
    return e;
  t = Yt(t, e);
  for (var a = -1, s = t.length, l = s - 1, o = e; o != null && ++a < s; ) {
    ...
    if (a != l) {
      var d = o[u];
      y = r ? r(d, u, o) : void 0, y === void 0 && (y = v0(d) ? d : Ht(t[a + 1]) ? [] : {});
    }
    Rt(o, u, y), o = o[u];
  }
  return e;
...
function A3(e, t, n, r) {
  ...
  for (var s = -1, l = t.length; ++s < l; ) {
    var o = t[s], u = r ? r(n[o], e[o], o, n, e) : void 0;
    u === void 0 && (u = e[o]), a ? k3(n, o, u) : x3(n, o, u);
  }
  return n;
}
var $e = A3;
...
var M3 = w3, S3 = R1, T3 = P1, I3 = "[object Arguments]";
function P3(e) {
  return T3(e) && S3(e) == I3;
}
...
le.exports;
(function(e, t) {
  var n = c1, r = F3, a = t && !t.nodeType && t, s = a && !0 && e && !e.nodeType && e, l = s && s.exports === a, o = l ? n.Buffer : void 0, u = o ? o.isBuffer : void 0, y = u || r;
  e.exports = y;
})(le, le.exports);
var y9 = le.exports, j3 = 9007199254740991;
function Z3(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= j3;
}
var h9 = Z3, Q3 = R1, z3 = h9, R3 = P1, Y3 = "[object Arguments]", H3 = "[object Array]", V3 = "[object Boolean]", G3 = "[object Date]", X3 = "[object Error]", J3 = "[object Function]", W3 = "[object Map]", q3 = "[object Number]", e8 = "[object Object]", t8 = "[object RegExp]", n8 = "[object Set]", r8 = "[object String]", a8 = "[object WeakMap]", i8 = "[object ArrayBuffer]", s8 = "[object DataView]", o8 = "[object Float32Array]", c8 = "[object Float64Array]", l8 = "[object Int8Array]", u8 = "[object Int16Array]", C8 = "[object Int32Array]", d8 = "[object Uint8Array]", f8 = "[object Uint8ClampedArray]", y8 = "[object Uint16Array]", h8 = "[object Uint32Array]", F = {};
F[o8] = F[c8] = F[l8] = F[u8] = F[C8] = F[d8] = F[f8] = F[y8] = F[h8] = !0;
F[Y3] = F[H3] = F[i8] = F[V3] = F[s8] = F[G3] = F[X3] = F[J3] = F[W3] = F[q3] = F[e8] = F[t8] = F[n8] = F[r8] = F[a8] = !1;
function g8(e) {
  return R3(e) && z3(e.length) && !!F[Q3(e)];
}
var p8 = g8;
function m8(e) {
  return function(t) {
...
var Qe = ue.exports, v8 = p8, _8 = Ze, $0 = Qe, L0 = $0 && $0.isTypedArray, $8 = L0 ? _8(L0) : v8, L8 = $8, b8 = M3, x8 = U3, k8 = I1, A8 = y9, w8 = d9, M8 = L8, S8 = Object.prototype, T8 = S8.hasOwnProperty;
function I8(e, t) {
  var n = k8(e), r = !n && x8(e), a = !n && !r && A8(e), s = !n && !r && !a && M8(e), l = n || r || a || s, o = l ? b8(e.length, String) : [], u = o.length;
  for (var y in e)
...
(function(e, t) {
  ...
  function u(y, d) {
    if (d)
      return y.slice();
    var h = y.length, L = o ? o(h) : new y.constructor(h);
    return y.copy(L), L;
  }
  e.exports = u;
})(Ce, Ce.exports);
...
var an = rn, sn = b1, on = c1, cn = sn(on, "DataView"), ln = cn, un = b1, Cn = c1, dn = un(Cn, "Promise"), fn = dn, yn = b1, hn = c1, gn = yn(hn, "Set"), pn = gn, mn = b1, vn = c1, _n = mn(vn, "WeakMap"), $n = _n, Ie = ln, Pe = Fe, De = fn, Ne = pn, Ee = $n, x9 = R1, B1 = s9, x0 = "[object Map]", Ln = "[object Object]", k0 = "[object Promise]", A0 = "[object Set]", w0 = "[object WeakMap]", M0 = "[object DataView]", bn = B1(Ie), xn = B1(Pe), kn = B1(De), An = B1(Ne), wn = B1(Ee), _1 = x9;
...
function re(e, t, n, r, a, s) {
  ...
  if (d) {
    ...
    var h = n4(e), L = h == A9 || h == _4;
    if (o4(e))
      return Xr(e, o);
    if (h == w9 || h == k9 || L && !a) {
      if (l = u || L ? {} : i4(e), !o)
        return u ? qr(e, Gr(l, e)) : Wr(e, Vr(l, e));
    } else {
      if (!K[h])
        return a ? e : {};
      l = a4(e, h, o);
  ...
  if (x)
    return x;
  s.set(e, l), u4(e) ? e.forEach(function(w) {
    l.add(re(w, t, n, w, e, s));
  }) : c4(e) && e.forEach(function(w, T) {
    l.set(T, re(w, t, n, T, e, s));
  });
  var I = y ? u ? t4 : e4 : u ? d4 : C4, P = d ? void 0 : I(e);
  return Yr(P || e, function(w, T) {
    P && (T = w, w = e[T]), Hr(l, T, re(w, t, n, T, e, s));
  }), l;
}
var K4 = re, F4 = K4, j4 = 1, Z4 = 4;
function Q4(e) {
  return F4(e, j4 | Z4);
}
var z4 = Q4;
...
const ea = /* @__PURE__ */ p('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), M9 = () => ea.cloneNode(!0), ta = /* @__PURE__ */ p('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), na = () => ta.cloneNode(!0), ra = /* @__PURE__ */ p("<ul></ul>"), aa = /* @__PURE__ */ p("<li></li>"), de = (e) => (() => {
  ...
  return _(r, () => e.title, a), g1(a, "click", e.onClose, !0), _(s, () => e.children), _(n, (() => {
    ...
    return () => l() && (() => {
      ...
      return _(o, () => e.buttons.map((u) => m(H4, t9(u, {
        get children() {
          return u.children;
        }
      })))), o;
...
const oa = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ca = /* @__PURE__ */ p('<div class="drop-down-container"><ul></ul></div>'), la = /* @__PURE__ */ p('<div><input type="text"></div>'), ua = /* @__PURE__ */ p("<li></li>"), S9 = (e) => {
  ...
  const l = z(() => {
    ...
    return u ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((d) => d.toLowerCase().includes(u)) : e.dataSource.filter((d) => {
      var x, I;
      const h = ((x = d.text) == null ? void 0 : x.toString().toLowerCase()) || "", L = ((I = d.key) == null ? void 0 : I.toLowerCase()) || "";
      return h.includes(u) || L.includes(u);
    }) : e.dataSource;
  }), o = () => {
    n(!0), a(""), e.searchable && setTimeout(() => s == null ? void 0 : s.focus(), 10);
  };
  return (() => {
    const u = oa.cloneNode(!0), y = u.firstChild, d = y.firstChild;
    return u.addEventListener("blur", (h) => {
      n(!1), a("");
    }), u.$$click = (h) => {
      t() || o();
    }, _(d, () => e.value), _(u, (() => {
      const h = z(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => h() && (() => {
        const L = ca.cloneNode(!0), x = L.firstChild;
        return _(L, (() => {
          const I = z(() => !!e.searchable);
          return () => I() && (() => {
            const P = la.cloneNode(!0), w = P.firstChild;
            P.style.setProperty("padding", "8px"), P.style.setProperty("border-bottom", "1px solid #333"), w.$$click = (U) => U.stopPropagation(), w.$$input = (U) => a(U.currentTarget.value);
            const T = s;
            return typeof T == "function" ? he(T, w) : s = w, w.style.setProperty("width", "100%"), w.style.setProperty("padding", "6px 10px"), w.style.setProperty("border", "1px solid #333"), w.style.setProperty("border-radius", "4px"), w.style.setProperty("background-color", "#1a1a1a"), w.style.setProperty("color", "#fff"), w.style.setProperty("font-size", "13px"), w.style.setProperty("outline", "none"), V(() => r1(w, "placeholder", e.searchPlaceholder || "Search...")), V(() => w.value = r()), P;
          })();
        })(), x), _(x, () => {
          var I;
          return (I = l()) == null ? void 0 : I.map((P) => {
            const T = P[e.valueKey ?? "text"] ?? P;
            return (() => {
              const U = ua.cloneNode(!0);
              return U.$$click = (N) => {
                var D;
                N.stopPropagation(), e.value !== T && ((D = e.onSelected) == null || D.call(e, P)), n(!1), a("");
              }, _(U, T), U;
            })();
          });
        }), L;
      ...
      const L = e.style, x = `klinecharts-pro-select ${e.class ?? ""} ${t() ? "klinecharts-pro-select-show" : ""}`;
      return h._v$ = S1(u, L, h._v$), x !== h._v$2 && L1(u, h._v$2 = x), h;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), u;
  ...
  return (() => {
    ...
    return s.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        L <= 0 ? h = new RegExp(/^[1-9]\d*$/) : h = new RegExp("^\\d+\\.?\\d{0," + L + "}$"), (u === "" || h.test(u) && +u >= t.min && +u <= t.max) && ((y = t.onChange) == null || y.call(t, u === "" ? u : +u));
      } else
      ...
      const u = t.style, y = `klinecharts-pro-input ${t.class ?? ""}`, d = r(), h = t.placeholder ?? "";
      return o._v$ = S1(s, u, o._v$), y !== o._v$2 && L1(s, o._v$2 = y), d !== o._v$3 && r1(s, "data-status", o._v$3 = d), h !== o._v$4 && r1(l, "placeholder", o._v$4 = h), o;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
const i = (e, t) => {
  ...
  return V0(() => {
    ...
    const s = Dc.cloneNode(!0), l = s.firstChild, o = l.firstChild, u = l.nextSibling, y = u.firstChild, d = y.nextSibling, h = u.nextSibling, L = h.firstChild, x = L.nextSibling, I = h.nextSibling, P = I.firstChild, w = P.nextSibling, T = I.nextSibling, U = T.firstChild, N = U.nextSibling, D = T.nextSibling;
    return he((S) => {
      t = S;
      ...
      get children() {
        const S = Pc.cloneNode(!0), R = S.firstChild;
        return g1(S, "click", e.onSymbolClick, !0), _(S, m(W, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const t1 = Ic.cloneNode(!0);
            return V(() => r1(t1, "src", e.symbol.logo)), t1;
          }
        }), R), _(R, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), S;
      }
    }), u), _(s, () => e.periods.map((S) => (() => {
      const R = Ae.cloneNode(!0);
      return R.$$click = () => {
        e.onPeriodChange(S);
      }, _(R, () => S.text), V(() => L1(R, `item period ${S.text === e.period.text ? "selected" : ""}`)), R;
    })()), u), g1(u, "click", e.onIndicatorClick, !0), _(d, () => i("indicator", e.locale)), g1(h, "click", e.onTimezoneClick, !0), _(x, () => i("timezone", e.locale)), g1(I, "click", e.onSettingClick, !0), _(w, () => i("setting", e.locale)), g1(T, "click", e.onScreenshotClick, !0), _(N, () => i("screenshot", e.locale)), D.$$click = () => {
      if (n())
        ...
        const S = t == null ? void 0 : t.parentElement;
        S && (S.requestFullscreen ?? S.webkitRequestFullscreen ?? S.mozRequestFullScreen ?? S.msRequestFullscreen).call(S);
      }
    }, _(D, (() => {
      const S = z(() => !!n());
      return () => S() ? [Nc.cloneNode(!0), (() => {
        const R = Ae.cloneNode(!0);
        return _(R, () => i("exit_full_screen", e.locale)), R;
      })()] : [Ec.cloneNode(!0), (() => {
        const R = Ae.cloneNode(!0);
        return _(R, () => i("full_screen", e.locale)), R;
      })()];
...
const a1 = (e) => ru[e.name](e.class), uu = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Cu = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), K0 = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), F0 = "drawing_tools", du = (e) => {
  const [t, n] = A("horizontalStraightLine"), [r, a] = A("priceChannelLine"), [s, l] = A("circle"), [o, u] = A("fibonacciLine"), [y, d] = A("xabcd"), [h, L] = A("weak_magnet"), [x, I] = A("normal"), [P, w] = A(!1), [T, U] = A(!0), [N, D] = A(""), S = z(() => [{
    key: "singleLine",
    icon: t(),
    list: au(e.locale),
    setter: n
  ...
  return (() => {
    const t1 = uu.cloneNode(!0), l1 = t1.firstChild, E = l1.nextSibling, Z = E.firstChild, Y = Z.nextSibling, u1 = Y.firstChild, K1 = E.nextSibling, F1 = K1.firstChild, m1 = K1.nextSibling, Y1 = m1.firstChild, H1 = m1.nextSibling, V1 = H1.nextSibling, G1 = V1.firstChild;
    return _(t1, () => S().map((O) => (() => {
      ...
      })(), null), V(() => r1(n1, "class", O.key === N() ? "rotate" : "")), J;
    })()), l1), E.addEventListener("blur", () => {
      D("");
    }), Z.$$click = () => {
      let O = h();
      x() !== "normal" && (O = "normal"), I(O), e.onModeChange(O);
    }, _(Z, (() => {
      const O = z(() => h() === "weak_magnet");
      return () => O() ? (() => {
        const J = z(() => x() === "weak_magnet");
        return () => J() ? m(a1, {
          name: "weak_magnet",
          class: "selected"
        }) : m(a1, {
      ...
      return () => O() && m(de, {
        ...
        get children() {
          return R().map((J) => (() => {
            ...
            return i1.$$click = () => {
              L(J.key), I(J.key), e.onModeChange(J.key), D("");
            }, _(i1, m(a1, {
              get name() {
                return J.key;
              }
      ...
      name: "remove"
    })), V(() => r1(u1, "class", N() === "mode" ? "rotate" : "")), t1;
  })();
};
o1(["click"]);
...
const hu = (e) => {
  const [t, n] = A(e.timezone), r = z(() => yu(e.locale));
  return m(U1, {
    get title() {
...
const gu = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), pu = /* @__PURE__ */ p("<span></span>"), mu = (e) => {
  const [t, n] = A(e.currentStyles), [r, a] = A(z0(e.locale));
  C1(() => {
    a(z0(e.locale));
  });
  const s = (l, o) => {
  ...
  const [t, n] = A(Q.clone(e.params.calcParams)), r = (a) => $u[a];
  return m(U1, {
    get title() {
      ...
      return [m(T9, {
        ...
        renderItem: (a) => (() => {
          ...
          return s.$$click = () => {
            ...
            get children() {
              const u = Au.cloneNode(!0);
              return V(() => r1(u, "src", a.logo)), u;
            }
...
const Iu = (e) => {
  let t, n = null, r, a = !1;
  const [s, l] = A(e.theme), [o, u] = A(e.styles), [y, d] = A(e.locale), [h, L] = A(e.symbol), [x, I] = A(e.period), [P, w] = A(!1), [T, U] = A([...e.mainIndicators]), [N, D] = A({}), [S, R] = A(!1), [t1, l1] = A({
    key: e.timezone,
    text: Q0(e.timezone, e.locale)
  }), [E, Z] = A(!1), [Y, u1] = A(), [K1, F1] = A(""), [m1, Y1] = A(e.drawingBarVisible), [H1, V1] = A(!1), [G1, O] = A(!1), [J, i1] = A({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const x1 = (c) => ({
    ...
    try {
      ...
      const M = k1(b);
      if (M) {
        const f = G.get(c), $ = ((g = f == null ? void 0 : f.points) == null ? void 0 : g.length) || 0, k = ((v = M.points) == null ? void 0 : v.length) || 0;
        G.set(c, M);
        const B = x1(M.type);
        if (k >= B) {
          const H = n1.get(c);
    ...
    document.addEventListener("mouseup", v), document.addEventListener("touchend", v), setTimeout(() => {
      ...
      if (b && !b.complete) {
        ...
        const f = G.get(c);
        if (f) {
          const $ = x1(f.type), k = ((M = f.points) == null ? void 0 : M.length) || 0;
      ...
      try {
        const g = `kline_drawings_${c}`, b = {
          drawings: C.map((M) => {
            ...
            const $ = x1(M.type), k = ((B = M.points) == null ? void 0 : B.length) || 0;
            return k < $ && console.warn(`⚠️ Saving ${M.type} with only ${k} point(s), needs ${$}`), f;
          }),
          timestamp: Date.now()
        };
      } catch (g) {
  ...
  e.ref({
    ...
    removeOverlay: (c) => {
      ...
      if ((C = n == null ? void 0 : n.removeOverlay) == null || C.call(n, c), c.id) {
        G.delete(c.id);
        const g = n1.get(c.id);
        g && (g.checkInterval && clearInterval(g.checkInterval), g.mouseUpHandler && (document.removeEventListener("mouseup", g.mouseUpHandler), document.removeEventListener("touchend", g.mouseUpHandler)), n1.delete(c.id)), Xe();
      }
    },
    removeAllOverlay: () => {
      G.forEach((c, C) => {
    ...
    getSettings: () => {
      var g, v, b, M, f, $, k, B, H, h1, j1, X1, We, qe, e0, t0;
      if (!n)
        return {};
      const c = n.getStyles(), C = (g = c.candle) == null ? void 0 : g.bar;
      return {
        // Candle settings
        candleType: (v = c.candle) == null ? void 0 : v.type,
        candleBarStyle: C == null ? void 0 : C.style,
        // bar.style might be LineType
        showLastPrice: (f = (M = (b = c.candle) == null ? void 0 : b.priceMark) == null ? void 0 : M.last) == null ? void 0 : f.show,
        showHighestPrice: (B = (k = ($ = c.candle) == null ? void 0 : $.priceMark) == null ? void 0 : k.high) == null ? void 0 : B.show,
        showLowestPrice: (j1 = (h1 = (H = c.candle) == null ? void 0 : H.priceMark) == null ? void 0 : h1.low) == null ? void 0 : j1.show,
        // Indicator settings
        showIndicatorLastValue: (We = (X1 = c.indicator) == null ? void 0 : X1.lastValueMark) == null ? void 0 : We.show,
    ...
    setSettings: (c) => {
      ...
      if (c.candleType !== void 0 && (C.candle = {
        ...
        const X1 = ((g = C.candle) == null ? void 0 : g.bar) || {};
        C.candle = {
          ...C.candle,
          bar: {
            ...X1,
      ...
      c.showLastPrice !== void 0 && (C.candle = {
        ...
        priceMark: {
          ...
          last: {
            ...(M = (b = C.candle) == null ? void 0 : b.priceMark) == null ? void 0 : M.last,
        ...
        ...C.candle,
        priceMark: {
          ...(B = C.candle) == null ? void 0 : B.priceMark,
          low: {
    ...
    resetSettings: () => {
      ...
      if (C) {
        const B = {
          ...
          indicator: {
            lastValueMark: (M = C.indicator) == null ? void 0 : M.lastValueMark
          },
          yAxis: {
    ...
    saveDrawings: (c) => {
      ...
      C.forEach((g, v) => {
        var f;
        const b = x1(g.type), M = ((f = g.points) == null ? void 0 : f.length) || 0;
        M < b && console.warn(`⚠️ ${g.type} ${g.id} has only ${M} point(s), should have ${b}`);
      }), A1.saveDrawings(c, C);
    },
    loadDrawings: (c) => {
      A1.loadDrawings(c).forEach((g, v) => {
        ...
        try {
          ...
          }, f = n == null ? void 0 : n.createOverlay(M);
          f && (G.set(f, {
            ...g,
            id: f
          }), n1.set(f, {
          ...
          console.error(`   ❌ Error restoring ${g.type}:`, M);
        }
      });
    },
  ...
  const Je = () => {
    ...
    switch (c.timespan) {
      ...
      case "week": {
        ...
        v = v - $ * 60 * 60 * 24;
        const k = new Date(v);
        v = (/* @__PURE__ */ new Date(`${k.getFullYear()}-${k.getMonth() + 1}-${k.getDate()}`)).getTime(), b = g * c.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const M = new Date(v), f = M.getFullYear(), $ = M.getMonth() + 1;
        v = (/* @__PURE__ */ new Date(`${f}-${$}-01`)).getTime(), b = g * c.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const k = new Date(b);
      ...
      case "year": {
        ...
        v = (/* @__PURE__ */ new Date(`${f}-01-01`)).getTime(), b = g * c.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const $ = new Date(b);
  ...
  return V0(() => {
    if (window.addEventListener("resize", Je), n = E9(t, {
      customApi: {
        formatDate: (f, $, k, B) => {
          switch (x().timespan) {
            case "minute":
              return B === J1.XAxis ? Q.formatDate(f, $, "HH:mm") : Q.formatDate(f, $, "YYYY-MM-DD HH:mm");
            case "hour":
              return B === J1.XAxis ? Q.formatDate(f, $, "MM-DD HH:mm") : Q.formatDate(f, $, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return Q.formatDate(f, $, "YYYY-MM-DD");
            case "month":
              return B === J1.XAxis ? Q.formatDate(f, $, "YYYY-MM") : Q.formatDate(f, $, "YYYY-MM-DD");
            case "year":
              return B === J1.XAxis ? Q.formatDate(f, $, "YYYY") : Q.formatDate(f, $, "YYYY-MM-DD");
          }
          return Q.formatDate(f, $, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      ...
      if (f) {
        ...
        if (k.className = "klinecharts-pro-watermark", Q.isString(e.watermark)) {
    ...
    n && v && (n.removeOverlay = function(...f) {
      ...
      let B;
      if (typeof k == "string" ? B = k : k && typeof k == "object" && k.id && (B = k.id), B) {
        G.delete(B);
        const H = n1.get(B);
        H && (H.checkInterval && clearInterval(H.checkInterval), H.mouseUpHandler && (document.removeEventListener("mouseup", H.mouseUpHandler), document.removeEventListener("touchend", H.mouseUpHandler)), n1.delete(B)), C();
      }
      return $;
    }), T().forEach((f) => {
      te(n, f, !0, {
    ...
    e.subIndicators.forEach((f) => {
      const $ = te(n, f, !0);
      $ && (b[f] = $);
    }), D(b), n == null || n.loadMore((f) => {
      a = !0, (async () => {
        const k = x(), [B] = Le(k, f, 1), [H] = Le(k, B, 500), h1 = await e.datafeed.getHistoryKLineData(h(), k, H, B);
        ...
        switch (f.iconId) {
          ...
          case "close":
            if (f.paneId === "candle_pane") {
              const $ = [...T()];
              n == null || n.removeIndicator("candle_pane", f.indicatorName), $.splice($.indexOf(f.indicatorName), 1), U($);
            } else {
              const $ = {
                ...N()
              };
              n == null || n.removeIndicator(f.paneId, f.indicatorName), delete $[f.indicatorName], D($);
            }
        }
    });
    const M = n == null ? void 0 : n.createOverlay;
    n && M && (n.createOverlay = function(...f) {
      const $ = f[0], k = M.apply(this, f);
      return k && (P9(k, $.name || "unknown"), v1(k), Xe()), k;
    });
  }), Be(() => {
    ...
    if (!a) {
      ...
      return a = !0, O(!0), (async () => {
        const [b, M] = Le(g, (/* @__PURE__ */ new Date()).getTime(), 500), f = await e.datafeed.getHistoryKLineData(C, g, b, M);
        n == null || n.applyNewData(f, f.length > 0), e.datafeed.subscribe(C, g, ($) => {
          n == null || n.updateData($);
        }), a = !1, O(!1);
      })(), {
        symbol: C,
    ...
    get children() {
      return m(fu, {
        ...
        onMainIndicatorChange: (c) => {
          const C = [...T()];
          c.added ? (te(n, c.name, !0, {
            id: "candle_pane"
          }), C.push(c.name)) : (n == null || n.removeIndicator("candle_pane", c.name), C.splice(C.indexOf(c.name), 1)), U(C);
        },
    ...
    }), C), he((g) => t = g, C), V(() => r1(C, "data-drawing-bar-visible", m1())), c;
  })()];

...
import { utils as Z, OverlayMode as ne, init as O9, FormatDateType as J1, DomPosition as re, ActionType as E9, dispose as ae, TooltipIconPosition as W1, CandleType as B9, YAxisType as F9, registerOverlay as K9 } from "klinecharts";
function z1(e, t, n) {
...
const j9 = {
  ...
  createPointFigures: ({ coordinates: e }) => {
    if (e.length > 1) {
      ...
      const a = z1({ x: e[1].x - 8, y: e[1].y + 4 }, e[1], r), i = z1({ x: e[1].x - 8, y: e[1].y - 4 }, e[1], r);
      return [
        {
          type: "line",
          attrs: { coordinates: e }
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    ...
    if (e.length > 1) {
      ...
      c.forEach((g) => {
        const m = e[1].y + s * g, x = (u[1].value + h * g).toFixed(n.price);
        r.push({ coordinates: [{ x: e[0].x, y: m }, { x: e[1].x, y: m }] }), a.push({
          x: i,
          y: m,
          text: `${x} (${(g * 100).toFixed(1)}%)`,
          baseline: "bottom"
        });
      });
    }
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = Ue(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = Z.getLinearSlopeIntercept(e[0], e[1]);
      let i;
      ...
      let h = e[0].x - n, g = e[0].y - n;
      for (let m = 2; m < 9; m++) {
        const x = u[m - 2].r + u[m - 1].r;
        let A = 0;
        switch (m % 4) {
          case 0: {
            A = i, h -= u[m - 2].r;
          ...
          case 1: {
            A = i + Math.PI / 2, g -= u[m - 2].r;
            break;
          }
          case 2: {
            A = i + Math.PI, h += u[m - 2].r;
            break;
          }
          case 3: {
            A = i + Math.PI / 2 * 3, g += u[m - 2].r;
            break;
          }
        }
        const P = A + Math.PI / 2, Q = z1({ x: h, y: g }, e[0], i);
        u.push({
          ...Q,
          r: x,
          startAngle: A,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((g) => {
        const m = e[1].x - s * g, x = e[1].y - u * g;
        n.push({ coordinates: [{ x: m, y: e[0].y }, { x: m, y: e[1].y }] }), n.push({ coordinates: [{ x: e[0].x, y: x }, { x: e[1].x, y: x }] }), r = r.concat(A0([e[0], { x: m, y: e[1].y }], t)), r = r.concat(A0([e[0], { x: e[1].x, y: x }], t)), a.unshift({
          x: e[0].x + i,
          y: x + 10,
          text: `${g.toFixed(3)}`
        }), a.unshift({
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    ...
    if (e.length > 2) {
      ...
      u.forEach((g) => {
        const m = e[2].y + s * g, x = (i[2].value + c * g).toFixed(n.price);
...
var X = null;
let b1 = null, K = null, q = null, d1 = null, O0 = 0;
function n0(e, t) {
  const n = K, r = X, a = e.length === 0, i = a ? He : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function Y(e, t, n) {
  ...
  const r = g0(e, t, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, M1(r), Ge.bind(r);
}
function o5(e, t, n) {
  let r, a, i;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (r = !0, a = e, i = t || {}) : (r = e, a = t, i = n || {});
  let c = null, s = $0, u = null, h = !1, g = "initialValue" in i, m = typeof r == "function" && Y(r);
  const x = /* @__PURE__ */ new Set(), [A, P] = (i.storage || w)(i.initialValue), [Q, z] = w(void 0), [N, V] = w(void 0, {
    equals: !1
  }), [O, I] = w(g ? "ready" : "unresolved");
  if (t1.context) {
    u = `${t1.context.id}${t1.context.count++}`;
    let T;
    i.ssrLoadFrom === "initial" ? s = i.initialValue : t1.load && (T = t1.load(u)) && (s = T[0]);
  }
  function M(T, j, U, u1) {
    return c === T && (c = null, g = !0, (T === s || j === s) && i.onHydrated && queueMicrotask(() => i.onHydrated(u1, {
      value: j
    })), s = $0, R(j, U)), j;
  }
  function R(T, j) {
    p1(() => {
      j === void 0 && P(() => T), I(j !== void 0 ? "errored" : "ready"), z(j);
  ...
  function l1(T = !0) {
    ...
    const U = s !== $0 ? s : g1(() => a(j, {
      value: A(),
      refetching: T
    }));
    return typeof U != "object" || !(U && "then" in U) ? (M(c, U, void 0, j), U) : (c = U, h = !0, queueMicrotask(() => h = !1), p1(() => {
      I(g ? "refreshing" : "pending"), V();
    }, !1), U.then((u1) => M(U, u1, void 0, j), (u1) => M(U, void 0, qe(u1), j)));
  }
...
function c5(e) {
  ...
  return Promise.resolve().then(() => {
    K = t, X = n;
    let r;
    return p1(e, !1), K = X = null, r ? r.done : void 0;
  });
}
let l5;
function Ge() {
...
function Xe(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && p1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      const i = e.observers[a], c = b1 && b1.running;
      c && b1.disposed.has(i), (c && !i.tState || !c && !i.state) && (i.pure ? q.push(i) : d1.push(i), i.observers && We(i)), c || (i.state = C1);
    }
    if (q.length > 1e6)
      throw q = [], new Error();
  }, !1)), t;
...
function g0(e, t, n, r = C1, a) {
  ...
  return X === null || X !== He && (X.owned ? X.owned.push(i) : X.owned = [i]), i;
}
function s0(e) {
  const t = b1;
  if (e.state === 0 || t)
  ...
  if (e.state === i0 || t)
    return o0(e);
  if (e.suspense && g1(e.suspense.inFallback))
...
function o0(e, t) {
  ...
  for (let r = 0; r < e.sources.length; r += 1) {
    const a = e.sources[r];
    a.sources && (a.state === C1 || n ? a !== t && s0(a) : (a.state === i0 || n) && o0(a, t));
  }
}
function We(e) {
  const t = b1;
...
function C5(e, t, n = {}) {
  ...
  return E0(() => se(i)), () => {
    let u = e() || [], h, g;
    return u[s5], g1(() => {
      let x = u.length, A, P, Q, z, N, V, O, I, M;
      if (x === 0)
        c !== 0 && (se(i), i = [], r = [], a = [], c = 0, s && (s = [])), n.fallback && (r = [g5], a[0] = n0((R) => (i[0] = R, n.fallback())), c = 1);
      else if (c === 0) {
        for (a = new Array(x), g = 0; g < x; g++)
          r[g] = u[g], a[g] = n0(m);
        c = x;
      } else {
        for (Q = new Array(x), z = new Array(x), s && (N = new Array(x)), V = 0, O = Math.min(c, x); V < O && r[V] === u[V]; V++)
          ;
        for (O = c - 1, I = x - 1; O >= V && I >= V && r[O] === u[I]; O--, I--)
          Q[I] = a[O], z[I] = i[O], s && (N[I] = s[O]);
        for (A = /* @__PURE__ */ new Map(), P = new Array(I + 1), g = I; g >= V; g--)
          M = u[g], h = A.get(M), P[g] = h === void 0 ? -1 : h, A.set(M, g);
        for (h = V; h <= O; h++)
          M = r[h], g = A.get(M), g !== void 0 && g !== -1 ? (Q[g] = a[h], z[g] = i[h], s && (N[g] = s[h]), g = P[g], A.set(M, g)) : i[h]();
        for (g = V; g < x; g++)
          g in Q ? (a[g] = Q[g], i[g] = z[g], s && (s[g] = N[g], s[g](g))) : a[g] = n0(m);
...
function p5(e, t, n) {
  ...
  for (; c < a || s < i; ) {
    ...
    for (; t[a - 1] === n[i - 1]; )
      a--, i--;
    if (a === c) {
      const g = i < r ? s ? n[s - 1].nextSibling : n[i - s] : u;
      for (; s < i; )
        e.insertBefore(n[s++], g);
    } else if (i === s)
      for (; c < a; )
        (!h || !h.has(t[c])) && t[c].remove(), c++;
    else if (t[c] === n[i - 1] && n[s] === t[a - 1]) {
      const g = t[--a].nextSibling;
      e.insertBefore(n[s++], t[c++].nextSibling), e.insertBefore(n[--i], g), t[a] = n[i];
    } else {
      if (!h) {
        h = /* @__PURE__ */ new Map();
        let m = s;
      ...
      if (g != null)
        if (s < g && g < i) {
          let m = c, x = 1, A;
          for (; ++m < a && m < i && !((A = h.get(t[m])) == null || A !== g + x); )
            x++;
          if (x > g - s) {
            const P = t[c];
            for (; s < g; )
  ...
  if (e = c && n[0] && n[0].parentNode || e, i === "string" || i === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (s.length === 0) {
        ...
        u ? n.length === 0 ? ce(e, s, r) : p5(e, n, s) : (n && w1(e), ce(e, s));
      n = s;
    ...
    if (s instanceof Node)
      ...
      if (Array.isArray(s))
        ...
        if (r) {
          for (; typeof s == "function"; )
            s = s();
          a = M0(e, Array.isArray(s) ? s : [s], Array.isArray(u) ? u : [u]) || a;
        } else
          e.push(s), a = !0;
      else {
        const h = String(s);
...
var _5 = typeof e0 == "object" && e0 && e0.Object === Object && e0, r9 = _5, L5 = r9, $5 = typeof self == "object" && self && self.Object === Object && self, b5 = L5 || $5 || Function("return this")(), c1 = b5, x5 = c1, k5 = x5.Symbol, h0 = k5, le = h0, a9 = Object.prototype, A5 = a9.hasOwnProperty, w5 = a9.toString, R1 = le ? le.toStringTag : void 0;
function M5(e) {
  var t = A5.call(e, R1), n = e[R1];
  try {
    e[R1] = void 0;
    var r = !0;
  } catch {
...
var N5 = D5, ue = h0, P5 = S5, O5 = N5, E5 = "[object Null]", B5 = "[object Undefined]", fe = ue ? ue.toStringTag : void 0;
function F5(e) {
  return e == null ? e === void 0 ? B5 : E5 : fe && fe in Object(e) ? P5(e) : O5(e);
}
var U1 = F5;
function K5(e) {
  var t = typeof e;
...
var I1 = K5, j5 = U1, Z5 = I1, Q5 = "[object AsyncFunction]", R5 = "[object Function]", z5 = "[object GeneratorFunction]", U5 = "[object Proxy]";
function Y5(e) {
  if (!Z5(e))
    return !1;
  var t = j5(e);
...
var s9 = e6, t6 = i9, n6 = J5, r6 = I1, a6 = s9, i6 = /[\\^$.*+?()[\]{}|]/g, s6 = /^\[object .+?Constructor\]$/, o6 = Function.prototype, c6 = Object.prototype, l6 = o6.toString, u6 = c6.hasOwnProperty, f6 = RegExp(
...
var F0 = M6, S6 = Array.isArray, T1 = S6;
function I6(e) {
  return e != null && typeof e == "object";
}
var D1 = I6, T6 = U1, D6 = D1, N6 = "[object Symbol]";
function P6(e) {
  return typeof e == "symbol" || D6(e) && T6(e) == N6;
}
var K0 = P6, O6 = T1, E6 = K0, B6 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, F6 = /^\w*$/;
function K6(e, t) {
  if (O6(e))
    return !1;
  var n = typeof e;
...
var j6 = K6, Z6 = k1, Q6 = Z6(Object, "create"), y0 = Q6, Ce = y0;
function R6() {
...
var o2 = s2, c2 = z6, l2 = Y6, u2 = W6, f2 = r2, d2 = o2;
function N1(e) {
...
P1.prototype.has = O2;
P1.prototype.set = E2;
var m0 = P1, B2 = k1, F2 = c1, K2 = B2(F2, "Map"), j0 = K2, he = g2, j2 = m0, Z2 = j0;
function Q2() {
...
var i3 = a3, s3 = R2, o3 = X2, c3 = q2, l3 = n3, u3 = i3;
function O1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
O1.prototype.has = l3;
O1.prototype.set = u3;
var l9 = O1, u9 = l9, f3 = "Expected a function";
function Z0(e, t) {
...
var b3 = $3, ye = h0, x3 = b3, k3 = T1, A3 = K0, w3 = 1 / 0, pe = ye ? ye.prototype : void 0, me = pe ? pe.toString : void 0;
function f9(e) {
  if (typeof e == "string")
    return e;
  if (k3(e))
...
var T3 = I3, D3 = T1, N3 = j6, P3 = L3, O3 = T3;
function E3(e, t) {
...
var z3 = R3, U3 = F0, Y3 = B3, H3 = d9, ve = I1, V3 = z3;
function G3(e, t, n, r) {
  if (!ve(e))
    return e;
  t = Y3(t, e);
  for (var a = -1, i = t.length, c = i - 1, s = e; s != null && ++a < i; ) {
    ...
    if (a != c) {
      var g = s[u];
      h = r ? r(g, u, s) : void 0, h === void 0 && (h = ve(g) ? g : H3(t[a + 1]) ? [] : {});
    }
    U3(s, u, h), s = s[u];
  }
  return e;
...
var C8 = g8, h8 = m0, y8 = n8, p8 = a8, m8 = s8, v8 = c8, _8 = C8;
function E1(e) {
  var t = this.__data__ = new h8(e);
  this.size = t.size;
}
E1.prototype.clear = y8;
E1.prototype.delete = p8;
E1.prototype.get = m8;
E1.prototype.has = v8;
E1.prototype.set = _8;
var L8 = E1;
...
var M8 = w8, S8 = U1, I8 = D1, T8 = "[object Arguments]";
function D8(e) {
  return I8(e) && S8(e) == T8;
}
var N8 = D8, _e = N8, P8 = D1, g9 = Object.prototype, O8 = g9.hasOwnProperty, E8 = g9.propertyIsEnumerable, B8 = _e(function() {
  return arguments;
}()) ? _e : function(e) {
...
l0.exports;
(function(e, t) {
  var n = c1, r = j8, a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, c = i && i.exports === a, s = c ? n.Buffer : void 0, u = s ? s.isBuffer : void 0, h = u || r;
  e.exports = h;
})(l0, l0.exports);
var C9 = l0.exports, Z8 = 9007199254740991;
function Q8(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= Z8;
}
var h9 = Q8, R8 = U1, z8 = h9, U8 = D1, Y8 = "[object Arguments]", H8 = "[object Array]", V8 = "[object Boolean]", G8 = "[object Date]", X8 = "[object Error]", J8 = "[object Function]", W8 = "[object Map]", q8 = "[object Number]", et = "[object Object]", tt = "[object RegExp]", nt = "[object Set]", rt = "[object String]", at = "[object WeakMap]", it = "[object ArrayBuffer]", st = "[object DataView]", ot = "[object Float32Array]", ct = "[object Float64Array]", lt = "[object Int8Array]", ut = "[object Int16Array]", ft = "[object Int32Array]", dt = "[object Uint8Array]", gt = "[object Uint8ClampedArray]", Ct = "[object Uint16Array]", ht = "[object Uint32Array]", F = {};
F[ot] = F[ct] = F[lt] = F[ut] = F[ft] = F[dt] = F[gt] = F[Ct] = F[ht] = !0;
F[Y8] = F[H8] = F[it] = F[V8] = F[st] = F[G8] = F[X8] = F[J8] = F[W8] = F[q8] = F[et] = F[tt] = F[nt] = F[rt] = F[at] = !1;
function yt(e) {
...
var R0 = u0.exports, vt = pt, _t = Q0, Le = R0, $e = Le && Le.isTypedArray, Lt = $e ? _t($e) : vt, $t = Lt, bt = M8, xt = F8, kt = T1, At = C9, wt = d9, Mt = $t, St = Object.prototype, It = St.hasOwnProperty;
function Tt(e, t) {
...
var p9 = Pt, Ot = p9, Et = Ot(Object.keys, Object), Bt = Et, Ft = z0, Kt = Bt, jt = Object.prototype, Zt = jt.hasOwnProperty;
function Qt(e) {
  if (!Ft(e))
    return Kt(e);
  var t = [];
...
var Rt = Qt, zt = i9, Ut = h9;
function Yt(e) {
  return e != null && Ut(e.length) && !zt(e);
}
var m9 = Yt, Ht = y9, Vt = Rt, Gt = m9;
function Xt(e) {
  return Gt(e) ? Ht(e) : Vt(e);
}
var U0 = Xt, Jt = _0, Wt = U0;
function qt(e, t) {
...
var n7 = t7, r7 = I1, a7 = z0, i7 = n7, s7 = Object.prototype, o7 = s7.hasOwnProperty;
function c7(e) {
  if (!r7(e))
    return i7(e);
  var t = a7(e), n = [];
...
(function(e, t) {
  ...
  function u(h, g) {
    if (g)
      return h.slice();
    var m = h.length, x = s ? s(m) : new h.constructor(m);
    return h.copy(x), x;
  }
  e.exports = u;
})(f0, f0.exports);
...
var _9 = N7, P7 = p9, O7 = P7(Object.getPrototypeOf, Object), L9 = O7, E7 = _9, B7 = L9, F7 = H0, K7 = v9, j7 = Object.getOwnPropertySymbols, Z7 = j7 ? function(e) {
  for (var t = []; e; )
    E7(t, F7(e)), e = B7(e);
  return t;
} : K7, $9 = Z7, Q7 = _0, R7 = $9;
...
var U7 = z7, Y7 = _9, H7 = T1;
function V7(e, t, n) {
  var r = t(e);
  return H7(e) ? r : Y7(r, n(e));
}
var b9 = V7, G7 = b9, X7 = H0, J7 = U0;
function W7(e) {
  return G7(e, J7, X7);
}
...
var an = rn, sn = k1, on = c1, cn = sn(on, "DataView"), ln = cn, un = k1, fn = c1, dn = un(fn, "Promise"), gn = dn, Cn = k1, hn = c1, yn = Cn(hn, "Set"), pn = yn, mn = k1, vn = c1, _n = mn(vn, "WeakMap"), Ln = _n, I0 = ln, T0 = j0, D0 = gn, N0 = pn, P0 = Ln, x9 = U1, B1 = s9, xe = "[object Map]", $n = "[object Object]", ke = "[object Promise]", Ae = "[object Set]", we = "[object WeakMap]", Me = "[object DataView]", bn = B1(I0), xn = B1(T0), kn = B1(D0), An = B1(N0), wn = B1(P0), $1 = x9;
(I0 && $1(new I0(new ArrayBuffer(1))) != Me || T0 && $1(new T0()) != xe || D0 && $1(D0.resolve()) != ke || N0 && $1(new N0()) != Ae || P0 && $1(new P0()) != we) && ($1 = function(e) {
...
var V0 = $1, Mn = Object.prototype, Sn = Mn.hasOwnProperty;
function In(e) {
...
var Zn = jn, Ie = h0, Te = Ie ? Ie.prototype : void 0, De = Te ? Te.valueOf : void 0;
function Qn(e) {
...
var Yn = Un, Hn = G0, Vn = Fn, Gn = Zn, Xn = Rn, Jn = Yn, Wn = "[object Boolean]", qn = "[object Date]", e4 = "[object Map]", t4 = "[object Number]", n4 = "[object RegExp]", r4 = "[object Set]", a4 = "[object String]", i4 = "[object Symbol]", s4 = "[object ArrayBuffer]", o4 = "[object DataView]", c4 = "[object Float32Array]", l4 = "[object Float64Array]", u4 = "[object Int8Array]", f4 = "[object Int16Array]", d4 = "[object Int32Array]", g4 = "[object Uint8Array]", C4 = "[object Uint8ClampedArray]", h4 = "[object Uint16Array]", y4 = "[object Uint32Array]";
function p4(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case s4:
...
var m4 = p4, v4 = I1, Ne = Object.create, _4 = function() {
  function e() {
  }
  return function(t) {
    if (!v4(t))
...
var T4 = I4, D4 = T4, N4 = Q0, Pe = R0, Oe = Pe && Pe.isMap, P4 = Oe ? N4(Oe) : D4, O4 = P4, E4 = V0, B4 = D1, F4 = "[object Set]";
function K4(e) {
  return B4(e) && E4(e) == F4;
}
var j4 = K4, Z4 = j4, Q4 = Q0, Ee = R0, Be = Ee && Ee.isSet, R4 = Be ? Q4(Be) : Z4, z4 = R4, U4 = L8, Y4 = b8, H4 = F0, V4 = e7, G4 = p7, X4 = m7, J4 = _7, W4 = D7, q4 = U7, er = q7, tr = an, nr = V0, rr = Tn, ar = m4, ir = A4, sr = T1, or = C9, cr = O4, lr = I1, ur = z4, fr = U0, dr = Y0, gr = 1, Cr = 2, hr = 4, k9 = "[object Arguments]", yr = "[object Array]", pr = "[object Boolean]", mr = "[object Date]", vr = "[object Error]", A9 = "[object Function]", _r = "[object GeneratorFunction]", Lr = "[object Map]", $r = "[object Number]", w9 = "[object Object]", br = "[object RegExp]", xr = "[object Set]", kr = "[object String]", Ar = "[object Symbol]", wr = "[object WeakMap]", Mr = "[object ArrayBuffer]", Sr = "[object DataView]", Ir = "[object Float32Array]", Tr = "[object Float64Array]", Dr = "[object Int8Array]", Nr = "[object Int16Array]", Pr = "[object Int32Array]", Or = "[object Uint8Array]", Er = "[object Uint8ClampedArray]", Br = "[object Uint16Array]", Fr = "[object Uint32Array]", E = {};
E[k9] = E[yr] = E[Mr] = E[Sr] = E[pr] = E[mr] = E[Ir] = E[Tr] = E[Dr] = E[Nr] = E[Pr] = E[Lr] = E[$r] = E[w9] = E[br] = E[xr] = E[kr] = E[Ar] = E[Or] = E[Er] = E[Br] = E[Fr] = !0;
E[vr] = E[A9] = E[wr] = !1;
function r0(e, t, n, r, a, i) {
  ...
  if (g) {
    ...
    var m = nr(e), x = m == A9 || m == _r;
    if (or(e))
      return X4(e, s);
    if (m == w9 || m == k9 || x && !a) {
      if (c = u || x ? {} : ir(e), !s)
        return u ? q4(e, G4(c, e)) : W4(e, V4(c, e));
    } else {
      if (!E[m])
        return a ? e : {};
      c = ar(e, m, s);
  ...
  if (A)
    return A;
  i.set(e, c), ur(e) ? e.forEach(function(z) {
    c.add(r0(z, t, n, z, e, i));
  }) : cr(e) && e.forEach(function(z, N) {
    c.set(N, r0(z, t, n, N, e, i));
  });
  var P = h ? u ? tr : er : u ? dr : fr, Q = g ? void 0 : P(e);
  return Y4(Q || e, function(z, N) {
    Q && (N = z, z = e[N]), H4(c, N, r0(z, t, n, N, e, i));
  }), c;
}
...
var zr = Rr;
const Ur = /* @__PURE__ */ n9(zr), Yr = /* @__PURE__ */ p("<button></button>"), Hr = (e) => (() => {
  ...
  return y1(t, "click", e.onClick, !0), L(t, () => e.children), G((n) => {
    ...
    return n._v$ = S1(t, r, n._v$), a !== n._v$2 && x1(t, n._v$2 = a), n;
  }, {
    _v$: void 0,
    _v$2: void 0
  }), t;
...
const Vr = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), Gr = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), Xr = /* @__PURE__ */ p("<div></div>"), Jr = /* @__PURE__ */ p('<span class="label"></span>'), Wr = () => Vr.cloneNode(!0), qr = () => Gr.cloneNode(!0), Fe = (e) => {
  ...
  return f1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a._v$ = S1(r, i, a._v$), c !== a._v$2 && x1(r, a._v$2 = c), a;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
...
const ea = /* @__PURE__ */ p('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), M9 = () => ea.cloneNode(!0), ta = /* @__PURE__ */ p('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), na = () => ta.cloneNode(!0), ra = /* @__PURE__ */ p("<ul></ul>"), aa = /* @__PURE__ */ p("<li></li>"), d0 = (e) => (() => {
  ...
  return L(r, () => e.title, a), y1(a, "click", e.onClose, !0), L(i, () => e.children), L(n, (() => {
    ...
    return () => c() && (() => {
      ...
      return L(s, () => e.buttons.map((u) => _(Hr, t9(u, {
        get children() {
          return u.children;
        }
      })))), s;
...
const oa = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ca = /* @__PURE__ */ p('<div class="drop-down-container"><ul></ul></div>'), la = /* @__PURE__ */ p("<li></li>"), S9 = (e) => {
  ...
  return (() => {
    ...
    return r.addEventListener("blur", (c) => {
      ...
      const c = Y(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => c() && (() => {
        ...
        return L(u, () => e.dataSource.map((h) => {
          ...
          return (() => {
            ...
            return x.$$click = (A) => {
              var P;
              A.stopPropagation(), e.value !== m && ((P = e.onSelected) == null || P.call(e, h)), n(!1);
            }, L(x, m), x;
          })();
        })), s;
      })();
      ...
      return c._v$ = S1(r, s, c._v$), u !== c._v$2 && x1(r, c._v$2 = u), c;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
  ...
  return (() => {
    ...
    return i.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        x <= 0 ? m = new RegExp(/^[1-9]\d*$/) : m = new RegExp("^\\d+\\.?\\d{0," + x + "}$"), (u === "" || m.test(u) && +u >= t.min && +u <= t.max) && ((h = t.onChange) == null || h.call(t, u === "" ? u : +u));
      } else
        (g = t.onChange) == null || g.call(t, u);
      ...
      const u = t.style, h = `klinecharts-pro-input ${t.class ?? ""}`, g = r(), m = t.placeholder ?? "";
      return s._v$ = S1(i, u, s._v$), h !== s._v$2 && x1(i, s._v$2 = h), g !== s._v$3 && r1(i, "data-status", s._v$3 = g), m !== s._v$4 && r1(c, "placeholder", s._v$4 = m), s;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
o1(["click"]);
const ga = /* @__PURE__ */ p('<div><i class="thumb"></i></div>'), Ca = (e) => (() => {
...
const f = (e, t) => {
  ...
  return Ve(() => {
    ...
    const i = Dc.cloneNode(!0), c = i.firstChild, s = c.firstChild, u = c.nextSibling, h = u.firstChild, g = h.nextSibling, m = u.nextSibling, x = m.firstChild, A = x.nextSibling, P = m.nextSibling, Q = P.firstChild, z = Q.nextSibling, N = P.nextSibling, V = N.firstChild, O = V.nextSibling, I = N.nextSibling;
    return B0((M) => {
      t = M;
    }, i), y1(s, "click", e.onMenuClick, !0), L(i, _(W, {
      get when() {
        return e.symbol;
      },
      get children() {
        const M = Tc.cloneNode(!0), R = M.firstChild;
        return y1(M, "click", e.onSymbolClick, !0), L(M, _(W, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const n1 = Ic.cloneNode(!0);
            return G(() => r1(n1, "src", e.symbol.logo)), n1;
          }
        }), R), L(R, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), M;
      }
    }), u), L(i, () => e.periods.map((M) => (() => {
      const R = k0.cloneNode(!0);
      return R.$$click = () => {
        e.onPeriodChange(M);
      }, L(R, () => M.text), G(() => x1(R, `item period ${M.text === e.period.text ? "selected" : ""}`)), R;
    })()), u), y1(u, "click", e.onIndicatorClick, !0), L(g, () => f("indicator", e.locale)), y1(m, "click", e.onTimezoneClick, !0), L(A, () => f("timezone", e.locale)), y1(P, "click", e.onSettingClick, !0), L(z, () => f("setting", e.locale)), y1(N, "click", e.onScreenshotClick, !0), L(O, () => f("screenshot", e.locale)), I.$$click = () => {
      if (n())
...
const a1 = (e) => nu[e.name](e.class), lu = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), uu = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Ke = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), je = "drawing_tools", fu = (e) => {
  const [t, n] = w("horizontalStraightLine"), [r, a] = w("priceChannelLine"), [i, c] = w("circle"), [s, u] = w("fibonacciLine"), [h, g] = w("xabcd"), [m, x] = w("weak_magnet"), [A, P] = w("normal"), [Q, z] = w(!1), [N, V] = w(!0), [O, I] = w(""), M = Y(() => [{
    key: "singleLine",
    icon: t(),
    list: ru(e.locale),
    setter: n
  ...
  return (() => {
    const n1 = lu.cloneNode(!0), l1 = n1.firstChild, T = l1.nextSibling, j = T.firstChild, U = j.nextSibling, u1 = U.firstChild, K1 = T.nextSibling, j1 = K1.firstChild, m1 = K1.nextSibling, Y1 = m1.firstChild, H1 = m1.nextSibling, V1 = H1.nextSibling, G1 = V1.firstChild;
    return L(n1, () => M().map((D) => (() => {
      const J = uu.cloneNode(!0), i1 = J.firstChild, H = i1.nextSibling, e1 = H.firstChild;
      return J.addEventListener("blur", () => {
        ...
        return () => v1() && _(d0, {
          class: "list",
          get children() {
            return D.list.map((s1) => (() => {
              const A1 = Ke.cloneNode(!0), _1 = A1.firstChild;
              return A1.$$click = () => {
                D.setter(s1.key), e.onDrawingItemClick({
                  name: s1.key,
                  lock: Q(),
                  mode: A()
                }), I("");
      ...
      })(), null), G(() => r1(e1, "class", D.key === O() ? "rotate" : "")), J;
    })()), l1), T.addEventListener("blur", () => {
      I("");
    }), j.$$click = () => {
      let D = m();
      A() !== "normal" && (D = "normal"), P(D), e.onModeChange(D);
    }, L(j, (() => {
      const D = Y(() => m() === "weak_magnet");
      return () => D() ? (() => {
        const J = Y(() => A() === "weak_magnet");
        return () => J() ? _(a1, {
          name: "weak_magnet",
          class: "selected"
        }) : _(a1, {
      ...
      return () => D() && _(d0, {
        ...
        get children() {
          return R().map((J) => (() => {
            const i1 = Ke.cloneNode(!0), H = i1.firstChild;
            return i1.$$click = () => {
              x(J.key), P(J.key), e.onModeChange(J.key), I("");
            }, L(i1, _(a1, {
              get name() {
                return J.key;
              }
      ...
      name: "remove"
    })), G(() => r1(u1, "class", O() === "mode" ? "rotate" : "")), n1;
  })();
};
o1(["click"]);
const Ze = /* @__PURE__ */ p('<li class="title"></li>'), Qe = /* @__PURE__ */ p('<li class="row"></li>'), du = (e) => _(F1, {
  get title() {
...
const Cu = (e) => {
  const [t, n] = w(e.timezone), r = Y(() => gu(e.locale));
  return _(F1, {
    get title() {
...
const hu = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), yu = /* @__PURE__ */ p("<span></span>"), pu = (e) => {
  const [t, n] = w(e.currentStyles), [r, a] = w(ze(e.locale));
  f1(() => {
    a(ze(e.locale));
  });
  const i = (c, s) => {
...
}, mu = /* @__PURE__ */ p('<img style="width:500px;margin-top: 20px">'), vu = (e) => _(F1, {
  get title() {
  ...
  const [t, n] = w(Z.clone(e.params.calcParams)), r = (a) => _u[a];
  return _(F1, {
    get title() {
    ...
    get buttons() {
      return [{
        ...
        onClick: () => {
          ...
          Z.clone(t()).forEach((c, s) => {
            !Z.isValid(c) || c === "" ? "default" in a[s] && i.push(a[s].default) : i.push(c);
...
const Iu = (e) => {
  let t, n = null, r, a = !1;
  const [i, c] = w(e.theme), [s, u] = w(e.styles), [h, g] = w(e.locale), [m, x] = w(e.symbol), [A, P] = w(e.period), [Q, z] = w(!1), [N, V] = w([...e.mainIndicators]), [O, I] = w({}), [M, R] = w(!1), [n1, l1] = w({
    key: e.timezone,
    text: Re(e.timezone, e.locale)
  }), [T, j] = w(!1), [U, u1] = w(), [K1, j1] = w(""), [m1, Y1] = w(e.drawingBarVisible), [H1, V1] = w(!1), [G1, D] = w(!1), [J, i1] = w({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  });
  let H = /* @__PURE__ */ new Map(), e1 = /* @__PURE__ */ new Map();
  const v1 = (o) => ({
    line: 2,
    segment: 2,
    arrow: 2,
    ...
    try {
      ...
      const k = A1(b);
      if (k) {
        const d = H.get(o), y = ((C = d == null ? void 0 : d.points) == null ? void 0 : C.length) || 0, $ = ((v = k.points) == null ? void 0 : v.length) || 0;
        H.set(o, k), $ > y && console.log(`📌 ${k.type} ${o}: ${y} → ${$} points`);
        const S = v1(k.type);
        if ($ >= S) {
          const B = e1.get(o);
          B && !B.complete && (B.complete = !0, console.log(`✅ ${k.type} ${o} is complete (${$}/${S} points)!`), B.checkInterval && (clearInterval(B.checkInterval), B.checkInterval = void 0));
        }
      }
    } catch (b) {
    ...
    e1.set(o, C), console.log(`🔍 Started monitoring ${l} ${o}`), _1(o);
    const v = () => {
      _1(o);
    };
    document.addEventListener("mouseup", v), document.addEventListener("touchend", v), setTimeout(() => {
      ...
      const b = e1.get(o);
      if (b && !b.complete) {
        console.log(`⏰ Stopped monitoring ${o} after 30 seconds`), b.checkInterval && clearInterval(b.checkInterval), b.mouseUpHandler && (document.removeEventListener("mouseup", b.mouseUpHandler), document.removeEventListener("touchend", b.mouseUpHandler)), _1(o);
        const d = H.get(o);
        if (d) {
          const y = v1(d.type), $ = ((k = d.points) == null ? void 0 : k.length) || 0;
          $ < y && console.warn(`⚠️ ${d.type} ${o} has only ${$} point(s), should have ${y}`);
        }
      }
    }, 3e4);
  };
  let L1 = {
    saveDrawings: (o, l) => {
      try {
        const C = `kline_drawings_${o}`, v = l.map((k) => {
          var S;
          const d = {
            ...k
          };
          d.extendData && (d.extendData = s1(d.extendData)), d.styles && (d.styles = s1(d.styles));
          const y = v1(k.type), $ = ((S = k.points) == null ? void 0 : S.length) || 0;
          return $ < y && console.warn(`⚠️ Saving ${k.type} with only ${$} point(s), needs ${y}`), d;
        }), b = {
          drawings: v,
          timestamp: Date.now()
        };
        localStorage.setItem(C, JSON.stringify(b, null, 2)), console.log(`💾 Library: Saved ${l.length} drawings for ${o}`), v.forEach((k, d) => {
          var y;
          console.log(`📝 Drawing ${d + 1}:`, {
            type: k.type,
            points: ((y = k.points) == null ? void 0 : y.length) || 0,
            hasExtendData: !!k.extendData,
            hasStyles: !!k.styles
          });
        });
      } catch (C) {
    ...
    loadDrawings: (o) => {
      ...
      try {
        ...
        if (v) {
          ...
          const k = [];
          return b.drawings && b.drawings.forEach((d, y) => {
            var B;
            const $ = v1(d.type), S = ((B = d.points) == null ? void 0 : B.length) || 0;
            S >= $ ? (k.push(d), console.log(`📥 Valid drawing ${y + 1}:`, {
              type: d.type,
              points: S
            })) : console.warn(`📥 Skipping ${d.type}: Only ${S} point(s), need ${$}`);
          }), k;
        }
      } catch (C) {
  ...
  const X0 = () => {
    const o = m();
    if (o != null && o.ticker) {
      const l = Array.from(H.values());
      L1.saveDrawings(o.ticker, l);
    }
  };
  e.ref({
    setTheme: c,
    ...
    removeOverlay: (o) => {
      ...
      if ((l = n == null ? void 0 : n.removeOverlay) == null || l.call(n, o), o.id) {
        H.delete(o.id);
        const C = e1.get(o.id);
        C && (C.checkInterval && clearInterval(C.checkInterval), C.mouseUpHandler && (document.removeEventListener("mouseup", C.mouseUpHandler), document.removeEventListener("touchend", C.mouseUpHandler)), e1.delete(o.id)), X0();
      }
    },
    removeAllOverlay: () => {
      H.forEach((o, l) => {
    ...
    getAllOverlay: () => Array.from(H.values()),
    getOverlay: (o) => H.get(o) || null,
    overrideOverlay: (o) => {
    ...
    getSettings: () => {
      var C, v, b, k, d, y, $, S, B, h1, Z1, X1, W0, q0, ee, te;
      if (!n)
        return {};
      ...
      return {
        ...
        showLastPrice: (d = (k = (b = o.candle) == null ? void 0 : b.priceMark) == null ? void 0 : k.last) == null ? void 0 : d.show,
        showHighestPrice: (S = ($ = (y = o.candle) == null ? void 0 : y.priceMark) == null ? void 0 : $.high) == null ? void 0 : S.show,
        showLowestPrice: (Z1 = (h1 = (B = o.candle) == null ? void 0 : B.priceMark) == null ? void 0 : h1.low) == null ? void 0 : Z1.show,
        // Indicator settings
    ...
    setSettings: (o) => {
      ...
      if (o.candleType !== void 0 && (l.candle = {
        ...
        const X1 = ((C = l.candle) == null ? void 0 : C.bar) || {};
        l.candle = {
          ...l.candle,
          bar: {
            ...X1,
      ...
      o.showLastPrice !== void 0 && (l.candle = {
        ...
        priceMark: {
          ...
          last: {
            ...(k = (b = l.candle) == null ? void 0 : b.priceMark) == null ? void 0 : k.last,
        ...
        ...l.candle,
        priceMark: {
          ...(d = l.candle) == null ? void 0 : d.priceMark,
          high: {
            ...($ = (y = l.candle) == null ? void 0 : y.priceMark) == null ? void 0 : $.high,
        ...
        priceMark: {
          ...
          low: {
            ...(h1 = (B = l.candle) == null ? void 0 : B.priceMark) == null ? void 0 : h1.low,
    ...
    resetSettings: () => {
      ...
      if (l) {
        const S = {
          ...
          indicator: {
            lastValueMark: (k = l.indicator) == null ? void 0 : k.lastValueMark
          },
          yAxis: {
            type: (d = l.yAxis) == null ? void 0 : d.type,
            reverse: (y = l.yAxis) == null ? void 0 : y.reverse
          },
          grid: {
            show: ($ = l.grid) == null ? void 0 : $.show
          }
        };
        n.setStyles(S);
      } else
    ...
    saveDrawings: (o) => {
      ...
      l.forEach((C, v) => {
        var d;
        const b = v1(C.type), k = ((d = C.points) == null ? void 0 : d.length) || 0;
        k < b && console.warn(`⚠️ ${C.type} ${C.id} has only ${k} point(s), should have ${b}`);
      }), L1.saveDrawings(o, l);
    },
    loadDrawings: (o) => {
      const l = L1.loadDrawings(o);
      console.log(`🔄 Restoring ${l.length} drawings...`), l.forEach((C, v) => {
        ...
        try {
          ...
          const d = {
            ...
            visible: C.visible ?? !0,
            lock: C.lock ?? !1,
            mode: C.mode ?? ne.Normal
          }, y = n == null ? void 0 : n.createOverlay(d);
          y && (console.log(`   ✅ Created ${y}`), H.set(y, {
            ...C,
            id: y
          }), e1.set(y, {
            monitoring: !1,
    ...
    getDrawings: (o) => L1.loadDrawings(o),
    clearDrawings: (o) => {
      L1.clearDrawings(o);
    },
    ...
    enableAutoSave: (o, l = !0) => {
      if (l) {
        ...
        const C = setInterval(() => {
          ...
          v.length > 0 && (console.log(`⏰ Auto-saving ${v.length} drawings...`), L1.saveDrawings(o, v));
        }, 3e4);
        return () => {
  ...
  const J0 = () => {
    ...
    switch (o.timespan) {
      ...
      case "week": {
        const d = new Date(v).getDay(), y = d === 0 ? 6 : d - 1;
        v = v - y * 60 * 60 * 24;
        const $ = new Date(v);
        v = (/* @__PURE__ */ new Date(`${$.getFullYear()}-${$.getMonth() + 1}-${$.getDate()}`)).getTime(), b = C * o.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const k = new Date(v), d = k.getFullYear(), y = k.getMonth() + 1;
        v = (/* @__PURE__ */ new Date(`${d}-${y}-01`)).getTime(), b = C * o.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const $ = new Date(b);
        b = (/* @__PURE__ */ new Date(`${$.getFullYear()}-${$.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const d = new Date(v).getFullYear();
        v = (/* @__PURE__ */ new Date(`${d}-01-01`)).getTime(), b = C * o.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const y = new Date(b);
        b = (/* @__PURE__ */ new Date(`${y.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [b, v];
  ...
  return Ve(() => {
    if (window.addEventListener("resize", J0), n = O9(t, {
      customApi: {
        formatDate: (d, y, $, S) => {
          switch (A().timespan) {
            case "minute":
              return S === J1.XAxis ? Z.formatDate(d, y, "HH:mm") : Z.formatDate(d, y, "YYYY-MM-DD HH:mm");
            case "hour":
              return S === J1.XAxis ? Z.formatDate(d, y, "MM-DD HH:mm") : Z.formatDate(d, y, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return Z.formatDate(d, y, "YYYY-MM-DD");
            case "month":
              return S === J1.XAxis ? Z.formatDate(d, y, "YYYY-MM") : Z.formatDate(d, y, "YYYY-MM-DD");
            case "year":
              return S === J1.XAxis ? Z.formatDate(d, y, "YYYY") : Z.formatDate(d, y, "YYYY-MM-DD");
          }
          return Z.formatDate(d, y, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      const d = n.getDom("candle_pane", re.Main);
      if (d) {
        let $ = document.createElement("div");
        if ($.className = "klinecharts-pro-watermark", Z.isString(e.watermark)) {
          const S = e.watermark.replace(/(^\s*)|(\s*$)/g, "");
          $.innerHTML = S;
        } else
          $.appendChild(e.watermark);
        d.appendChild($);
      }
      const y = n.getDom("candle_pane", re.YAxis);
      r = document.createElement("span"), r.className = "klinecharts-pro-price-unit", y == null || y.appendChild(r);
    }
    let o = !1;
    const l = () => {
      const d = m();
      if (d != null && d.ticker)
        try {
          const y = Array.from(H.values());
          console.log(`🔄 Refreshing local storage for ${d.ticker}`), console.log(`📊 Current drawings count: ${y.length}`), L1.saveDrawings(d.ticker, y), console.log("💾 Saved drawings:", {
            count: y.length,
            types: y.map(($) => $.type),
            ids: y.map(($) => $.id)
          });
        } catch (y) {
          console.error("❌ Error refreshing local storage:", y);
        }
    }, C = (d) => {
      o || (o = !0, d.preventDefault(), console.log("🖱️ Right-click detected on chart"), setTimeout(() => {
        l(), o = !1;
      }, 100));
    };
    setTimeout(() => {
      t && (t.addEventListener("contextmenu", C), console.log("✅ Right-click auto-refresh listener added"));
    }, 1e3), document.addEventListener("contextmenu", (d) => {
      t && t.contains(d.target) && C(d);
    });
    const v = n == null ? void 0 : n.removeOverlay;
    n && v && (n.removeOverlay = function(...d) {
      const y = v.apply(this, d), $ = d[0];
      let S;
      if (typeof $ == "string" ? S = $ : $ && typeof $ == "object" && $.id && (S = $.id), S) {
        console.log(`🗑️ Overlay removed: ${S}`), H.delete(S);
        const B = e1.get(S);
        B && (B.checkInterval && clearInterval(B.checkInterval), B.mouseUpHandler && (document.removeEventListener("mouseup", B.mouseUpHandler), document.removeEventListener("touchend", B.mouseUpHandler)), e1.delete(S)), l();
      }
      return y;
    }), N().forEach((d) => {
      t0(n, d, !0, {
    ...
    e.subIndicators.forEach((d) => {
      const y = t0(n, d, !0);
      y && (b[d] = y);
    }), I(b), n == null || n.loadMore((d) => {
      a = !0, (async () => {
        const $ = A(), [S] = L0($, d, 1), [B] = L0($, S, 500), h1 = await e.datafeed.getHistoryKLineData(m(), $, B, S);
        n == null || n.applyMoreData(h1, h1.length > 0), a = !1;
      })();
    }), n == null || n.subscribeAction(E9.OnTooltipIconClick, (d) => {
      if (d.indicatorName)
        switch (d.iconId) {
          case "visible": {
          ...
          case "setting": {
            const y = n == null ? void 0 : n.getIndicatorByPaneId(d.paneId, d.indicatorName);
            i1({
              visible: !0,
          ...
          case "close":
            if (d.paneId === "candle_pane") {
              const y = [...N()];
              n == null || n.removeIndicator("candle_pane", d.indicatorName), y.splice(y.indexOf(d.indicatorName), 1), V(y);
            } else {
              const y = {
                ...O()
              };
              n == null || n.removeIndicator(d.paneId, d.indicatorName), delete y[d.indicatorName], I(y);
            }
        }
    });
    const k = n == null ? void 0 : n.createOverlay;
    n && k && (n.createOverlay = function(...d) {
      const y = d[0], $ = k.apply(this, d);
      return $ && (console.log(`🆕 ${y.name} created with ID: ${$}`), D9($, y.name || "unknown"), _1($), X0()), $;
    });
  }), E0(() => {
    window.removeEventListener("resize", J0), e1.forEach((o, l) => {
    ...
    if (!a) {
      ...
      return a = !0, D(!0), (async () => {
        const [b, k] = L0(C, (/* @__PURE__ */ new Date()).getTime(), 500), d = await e.datafeed.getHistoryKLineData(l, C, b, k);
        n == null || n.applyNewData(d, d.length > 0), e.datafeed.subscribe(l, C, (y) => {
          n == null || n.updateData(y);
        }), a = !1, D(!1);
      })(), {
        symbol: l,
        period: C
    ...
    }), l), B0((C) => t = C, l), G(() => r1(l, "data-drawing-bar-visible", m1())), o;
  })()];

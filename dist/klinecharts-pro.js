...
const d = (e, t) => {
  ...
  return He(() => {
    ...
    }), ye), ye.style.setProperty("display", "flex"), ye.style.setProperty("gap", "4px"), ye.style.setProperty("margin-left", "auto"), ye.style.setProperty("align-items", "center"), ye.style.setProperty("flex", "0 0 auto"), C(ye, A(de, {
      get when() {

...
import { utils as B, registerFigure as Ba, PolygonType as Xt, LineType as Ke, OverlayMode as or, ActionType as mt, init as Fa, FormatDateType as sn, DomPosition as et, dispose as ni, TooltipIconPosition as ln, CandleType as za, YAxisType as Ua, TooltipShowRule as ri, registerOverlay as Va } from "klinecharts";
function I1(e, t, r) {
...
const Ra = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    ...
    if (e.length > 1) {
      ...
      f.forEach((x) => {
        const w = e[1].y + m * x, R = (p[1].value + L * x).toFixed(r.price);
        n.push({ coordinates: [{ x: e[0].x, y: w }, { x: e[1].x, y: w }] }), l.push({
          x: c,
          y: w,
          text: `${R} (${(x * 100).toFixed(1)}%)`,
          baseline: "bottom"
        });
      });
    }
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const r = Xi(e[0], e[1]) / Math.sqrt(24), n = e[1].x > e[0].x ? 0 : 1, l = B.getLinearSlopeIntercept(e[0], e[1]);
      let c;
      ...
      for (let w = 2; w < 9; w++) {
        ...
        switch (w % 4) {
          ...
          case 1: {
            Y = c + Math.PI / 2, x -= p[w - 2].r;
            break;
          }
          case 2: {
            Y = c + Math.PI, L += p[w - 2].r;
            break;
          }
          case 3: {
            Y = c + Math.PI / 2 * 3, x += p[w - 2].r;
            break;
          }
        }
        const ye = Y + Math.PI / 2, V = I1({ x: L, y: x }, e[0], c);
        p.push({
          ...V,
          r: R,
          startAngle: Y,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((x) => {
        const w = e[1].x - m * x, R = e[1].y - p * x;
        r.push({ coordinates: [{ x: w, y: e[0].y }, { x: w, y: e[1].y }] }), r.push({ coordinates: [{ x: e[0].x, y: R }, { x: e[1].x, y: R }] }), n = n.concat(mr([e[0], { x: w, y: e[1].y }], t)), n = n.concat(mr([e[0], { x: e[1].x, y: R }], t)), l.unshift({
          x: e[0].x + c,
          y: R + 10,
          text: `${x.toFixed(3)}`
        }), l.unshift({
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    ...
    if (e.length > 2) {
      ...
      p.forEach((x) => {
        const w = e[2].y + m * x, R = (c[2].value + f * x).toFixed(r.price);
...
const ss = (e, t) => e === t, gr = Symbol("solid-proxy"), ls = Symbol("solid-track"), vn = {
  equals: ss
};
let Ji = r0;
const vt = 1, bn = 2, e0 = {
...
var ze = null;
let Ut = null, Me = null, Qe = null, gt = null, Ar = 0;
function E1(e, t) {
  const r = Me, n = ze, l = e.length === 0, c = l ? e0 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? n : t
...
function D(e, t) {
  ...
  }, n = (l) => (typeof l == "function" && (l = l(r.value)), n0(r, l));
  return [t0.bind(r), n];
}
function oi(e, t, r) {
  const n = Mn(e, t, !0, vt);
...
function ee(e, t, r) {
  ...
  const n = Mn(e, t, !0, 0);
  return n.observers = null, n.observerSlots = null, n.comparator = r.equals || void 0, r1(n), t0.bind(n);
}
function cs(e, t, r) {
  let n, l, c;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (n = !0, l = e, c = t || {}) : (n = e, l = t, c = r || {});
  let f = null, m = ir, p = null, L = !1, x = "initialValue" in c, w = typeof n == "function" && ee(n);
  const R = /* @__PURE__ */ new Set(), [Y, ye] = (c.storage || D)(c.initialValue), [V, S] = D(void 0), [E, ne] = D(void 0, {
    equals: !1
  }), [F, Q] = D(x ? "ready" : "unresolved");
  if (Ue.context) {
    p = `${Ue.context.id}${Ue.context.count++}`;
    let X;
    c.ssrLoadFrom === "initial" ? m = c.initialValue : Ue.load && (X = Ue.load(p)) && (m = X[0]);
  }
  function K(X, ae, he, be) {
    return f === X && (f = null, x = !0, (X === m || ae === m) && c.onHydrated && queueMicrotask(() => c.onHydrated(be, {
      value: ae
    })), m = ir, ce(ae, he)), ae;
  }
  function ce(X, ae) {
    Tt(() => {
      ae === void 0 && ye(() => X), Q(ae !== void 0 ? "errored" : "ready"), S(ae);
  ...
  function G() {
    const X = ds, ae = Y(), he = V();
    if (he !== void 0 && !f)
      throw he;
    return Me && !Me.user && X && oi(() => {
      E(), f && (X.resolved || R.has(X) || (X.increment(), R.add(X)));
    }), ae;
  }
  function H(X = !0) {
    if (X !== !1 && L)
    ...
    const he = m !== ir ? m : dt(() => l(ae, {
      value: Y(),
      refetching: X
    }));
    return typeof he != "object" || !(he && "then" in he) ? (K(f, he, void 0, ae), he) : (f = he, L = !0, queueMicrotask(() => L = !1), Tt(() => {
      Q(x ? "refreshing" : "pending"), ne();
    }, !1), he.then((be) => K(he, be, void 0, ae), (be) => K(he, void 0, i0(be), ae)));
  }
...
function n0(e, t, r) {
  ...
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && Tt(() => {
    for (let l = 0; l < e.observers.length; l += 1) {
      ...
      f && Ut.disposed.has(c), (f && !c.tState || !f && !c.state) && (c.pure ? Qe.push(c) : gt.push(c), c.observers && o0(c)), f || (c.state = vt);
    }
    if (Qe.length > 1e6)
      throw Qe = [], new Error();
  }, !1)), t;
...
function r1(e) {
  if (!e.fn)
    return;
  Pn(e);
  const t = ze, r = Me, n = Ar;
  Me = ze = e, hs(e, e.value, n), Me = r, ze = t;
}
function hs(e, t, r) {
  let n;
  try {
    ...
    e.pure && (e.state = vt, e.owned && e.owned.forEach(Pn), e.owned = null), a0(l);
  }
  (!e.updatedAt || e.updatedAt <= r) && (e.updatedAt != null && "observers" in e ? n0(e, n) : e.value = n, e.updatedAt = r);
}
function Mn(e, t, r, n = vt, l) {
  const c = {
    fn: e,
    state: n,
    updatedAt: null,
  ...
  return ze === null || ze !== e0 && (ze.owned ? ze.owned.push(c) : ze.owned = [c]), c;
}
function $n(e) {
  const t = Ut;
  if (e.state === 0 || t)
  ...
  const r = [e];
  for (; (e = e.owner) && (!e.updatedAt || e.updatedAt < Ar); )
    (e.state || t) && r.push(e);
...
function Tt(e, t) {
  ...
  try {
    ...
    r || (gt = null), Qe = null, a0(n);
  }
}
function fs(e) {
  if (Qe && (r0(Qe), Qe = null), e)
    return;
  const t = gt;
  gt = null, t.length && Tt(() => Ji(t), !1);
}
function r0(e) {
...
function _n(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    const l = e.sources[n];
    l.sources && (l.state === vt || r ? l !== t && $n(l) : (l.state === bn || r) && _n(l, t));
  }
}
function o0(e) {
  const t = Ut;
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = bn, n.pure ? Qe.push(n) : gt.push(n), n.observers && o0(n));
  }
}
function Pn(e) {
  let t;
...
function ys(e, t, r = {}) {
  ...
  return pt(() => ii(c)), () => {
    let p = e() || [], L, x;
    return p[ls], dt(() => {
      let R = p.length, Y, ye, V, S, E, ne, F, Q, K;
      if (R === 0)
        f !== 0 && (ii(c), c = [], n = [], l = [], f = 0, m && (m = [])), r.fallback && (n = [gs], l[0] = E1((ce) => (c[0] = ce, r.fallback())), f = 1);
      else if (f === 0) {
        for (l = new Array(R), x = 0; x < R; x++)
          n[x] = p[x], l[x] = E1(w);
        f = R;
      } else {
        for (V = new Array(R), S = new Array(R), m && (E = new Array(R)), ne = 0, F = Math.min(f, R); ne < F && n[ne] === p[ne]; ne++)
          ;
        for (F = f - 1, Q = R - 1; F >= ne && Q >= ne && n[F] === p[Q]; F--, Q--)
          V[Q] = l[F], S[Q] = c[F], m && (E[Q] = m[F]);
        for (Y = /* @__PURE__ */ new Map(), ye = new Array(Q + 1), x = Q; x >= ne; x--)
          K = p[x], L = Y.get(K), ye[x] = L === void 0 ? -1 : L, Y.set(K, x);
        for (L = ne; L <= F; L++)
          K = n[L], x = Y.get(K), x !== void 0 && x !== -1 ? (V[x] = l[L], S[x] = c[L], m && (E[x] = m[L]), x = ye[x], Y.set(K, x)) : c[L]();
        for (x = ne; x < R; x++)
          x in V ? (l[x] = V[x], c[x] = S[x], m && (m[x] = E[x], m[x](x))) : l[x] = E1(w);
        l = l.slice(0, f = R), n = p.slice(0);
      }
      return l;
    });
    function w(R) {
...
function s0(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const l = e[n];
    t = t || !!l && gr in l, e[n] = typeof l == "function" ? (t = !0, ee(l)) : l;
  }
  if (t)
    return new Proxy({
      get(n) {
...
function n1(e) {
  ...
  return ee(ys(() => e.each, e.children, t || void 0));
}
function de(e) {
  let t = !1;
  ...
  for (; f < l || m < c; ) {
    ...
    if (l === f) {
      ...
      if (x != null)
        if (m < x && x < c) {
          let w = f, R = 1, Y;
          for (; ++w < l && w < c && !((Y = L.get(t[w])) == null || Y !== x + R); )
            R++;
          if (R > x - m) {
            const ye = t[f];
            for (; m < x; )
...
function Ye(e, t = window.document) {
  const r = t[ai] || (t[ai] = /* @__PURE__ */ new Set());
  for (let n = 0, l = e.length; n < l; n++) {
    const c = e[n];
    r.has(c) || (r.add(c), t.addEventListener(c, bs));
  }
}
function Ie(e, t, r) {
  ...
  if (e = f && r[0] && r[0].parentNode || e, c === "string" || c === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (m.length === 0) {
        ...
        p ? r.length === 0 ? si(e, m, n) : Cs(e, r, m) : (r && Jt(e), si(e, m));
      r = m;
    ...
    if (m instanceof Node)
      ...
      if (Array.isArray(m))
        ...
        if (n) {
          for (; typeof m == "function"; )
            m = m();
          l = yr(e, Array.isArray(m) ? m : [m], Array.isArray(p) ? p : [p]) || l;
        } else
          e.push(m), l = !0;
      else {
        const L = String(m);
...
function _s(e, t = !1) {
  return t ? document.createElementNS($s, e) : document.createElement(e);
}
function l0(e) {
  const {
    useShadow: t
  ...
  if (n instanceof HTMLHeadElement) {
    const [c, f] = D(!1), m = () => f(!0);
    E1((p) => C(n, () => c() ? p() : l()(), null)), pt(() => {
      Ue.context ? queueMicrotask(m) : m();
    });
  } else {
    const c = _s(e.isSVG ? "g" : "div", e.isSVG), f = t && c.attachShadow ? c.attachShadow({
      mode: "open"
    }) : c;
    Object.defineProperty(c, "_$host", {
      ...
      configurable: !0
    }), C(f, l()), n.appendChild(c), e.ref && e.ref(c), pt(() => n.removeChild(c));
  }
  return r;
}
...
var ks = typeof un == "object" && un && un.Object === Object && un, u0 = ks, xs = u0, Ls = typeof self == "object" && self && self.Object === Object && self, ws = xs || Ls || Function("return this")(), ht = ws, As = ht, Ts = As.Symbol, Dn = Ts, li = Dn, d0 = Object.prototype, Ss = d0.hasOwnProperty, Ms = d0.toString, N1 = li ? li.toStringTag : void 0;
function Ps(e) {
  var t = Ss.call(e, N1), r = e[N1];
  try {
    e[N1] = void 0;
    var n = !0;
  } catch {
...
var Ds = Ps, Ns = Object.prototype, Os = Ns.toString;
function Is(e) {
  return Os.call(e);
}
var Es = Is, ci = Dn, Bs = Ds, Fs = Es, zs = "[object Null]", Us = "[object Undefined]", ui = ci ? ci.toStringTag : void 0;
function Vs(e) {
  return e == null ? e === void 0 ? Us : zs : ui && ui in Object(e) ? Bs(e) : Fs(e);
}
var F1 = Vs;
function Rs(e) {
  var t = typeof e;
...
var o1 = Rs, Ks = F1, js = o1, Qs = "[object AsyncFunction]", Zs = "[object Function]", Hs = "[object GeneratorFunction]", Ws = "[object Proxy]";
function Ys(e) {
  if (!js(e))
    return !1;
  var t = Ks(e);
  return t == Zs || t == Hs || t == Qs || t == Ws;
}
var h0 = Ys, qs = ht, Gs = qs["__core-js_shared__"], Xs = Gs, sr = Xs, di = function() {
...
var e9 = Js, t9 = Function.prototype, n9 = t9.toString;
function r9(e) {
  if (e != null) {
    try {
      return n9.call(e);
...
var f0 = r9, o9 = h0, i9 = e9, a9 = o1, s9 = f0, l9 = /[\\^$.*+?()[\]{}|]/g, c9 = /^\[object .+?Constructor\]$/, u9 = Function.prototype, d9 = Object.prototype, h9 = u9.toString, f9 = d9.hasOwnProperty, m9 = RegExp(
  "^" + h9.call(f9).replace(l9, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function g9(e) {
  if (!a9(e) || i9(e))
    return !1;
...
var C9 = p9, v9 = y9, b9 = C9;
function $9(e, t) {
  var r = b9(e, t);
  return v9(r) ? r : void 0;
}
var Vt = $9, _9 = Vt, k9 = function() {
  try {
    var e = _9(Object, "defineProperty");
    return e({}, "", {}), e;
  } catch {
  }
}(), x9 = k9, hi = x9;
...
var g0 = w9, A9 = m0, T9 = g0, S9 = Object.prototype, M9 = S9.hasOwnProperty;
function P9(e, t, r) {
  var n = e[t];
  (!(M9.call(e, t) && T9(n, r)) || r === void 0 && !(t in e)) && A9(e, t, r);
}
var Sr = P9, D9 = Array.isArray, i1 = D9;
function N9(e) {
  return e != null && typeof e == "object";
}
var a1 = N9, O9 = F1, I9 = a1, E9 = "[object Symbol]";
function B9(e) {
  return typeof e == "symbol" || I9(e) && O9(e) == E9;
}
var Mr = B9, F9 = i1, z9 = Mr, U9 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, V9 = /^\w*$/;
function R9(e, t) {
  if (F9(e))
    return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || z9(e) ? !0 : V9.test(e) || !U9.test(e) || t != null && e in Object(t);
}
var K9 = R9, j9 = Vt, Q9 = j9(Object, "create"), Nn = Q9, fi = Nn;
function Z9() {
...
var Y9 = W9, q9 = Nn, G9 = "__lodash_hash_undefined__", X9 = Object.prototype, J9 = X9.hasOwnProperty;
function e5(e) {
  var t = this.__data__;
  if (q9) {
    var r = t[e];
...
var u5 = c5, d5 = H9, h5 = Y9, f5 = t5, m5 = a5, g5 = u5;
function s1(e) {
...
var O5 = N5, I5 = C5, E5 = L5, B5 = T5, F5 = P5, z5 = O5;
function l1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
l1.prototype.has = F5;
l1.prototype.set = z5;
var In = l1, U5 = Vt, V5 = ht, R5 = U5(V5, "Map"), Pr = R5, mi = y5, K5 = In, j5 = Pr;
function Q5() {
...
function q5(e, t) {
  var r = e.__data__;
  return Y5(t) ? r[typeof t == "string" ? "string" : "hash"] : r.map;
}
var En = q5, G5 = En;
function X5(e) {
...
var i2 = o2, a2 = En;
function s2(e, t) {
  var r = a2(this, e), n = r.size;
  return r.set(e, t), this.size += r.size == n ? 0 : 1, this;
}
var l2 = s2, c2 = Z5, u2 = J5, d2 = n2, h2 = i2, f2 = l2;
function c1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
c1.prototype.clear = c2;
c1.prototype.delete = u2;
c1.prototype.get = d2;
c1.prototype.has = h2;
c1.prototype.set = f2;
var y0 = c1, p0 = y0, m2 = "Expected a function";
function Dr(e, t) {
  ...
  return r.cache = new (Dr.Cache || p0)(), r;
}
Dr.Cache = p0;
var g2 = Dr, y2 = g2, p2 = 500;
function C2(e) {
  var t = y2(e, function(n) {
    return r.size === p2 && r.clear(), n;
  }), r = t.cache;
  return t;
}
var v2 = C2, b2 = v2, $2 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, _2 = /\\(\\)?/g, k2 = b2(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace($2, function(r, n, l, c) {
    t.push(l ? c.replace(_2, "$1") : n || r);
  }), t;
}), x2 = k2;
function L2(e, t) {
...
var w2 = L2, gi = Dn, A2 = w2, T2 = i1, S2 = Mr, M2 = 1 / 0, yi = gi ? gi.prototype : void 0, pi = yi ? yi.toString : void 0;
function C0(e) {
  if (typeof e == "string")
    return e;
  if (T2(e))
...
var O2 = N2, I2 = i1, E2 = K9, B2 = x2, F2 = O2;
function z2(e, t) {
  return I2(e) ? e : E2(e, t) ? [e] : B2(F2(e));
}
var U2 = z2, V2 = 9007199254740991, R2 = /^(?:0|[1-9]\d*)$/;
function K2(e, t) {
  var r = typeof e;
  return t = t ?? V2, !!t && (r == "number" || r != "symbol" && R2.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var v0 = K2, j2 = Mr, Q2 = 1 / 0;
function Z2(e) {
...
var H2 = Z2, W2 = Sr, Y2 = U2, q2 = v0, Ci = o1, G2 = H2;
function X2(e, t, r, n) {
  if (!Ci(e))
    return e;
  t = Y2(t, e);
  for (var l = -1, c = t.length, f = c - 1, m = e; m != null && ++l < c; ) {
    ...
    if (l != f) {
      var x = m[p];
      L = n ? n(x, p, m) : void 0, L === void 0 && (L = Ci(x) ? x : q2(t[l + 1]) ? [] : {});
    }
    W2(m, p, L), m = m[p];
  }
  return e;
...
var d6 = u6, h6 = In, f6 = Pr, m6 = y0, g6 = 200;
function y6(e, t) {
  var r = this.__data__;
  if (r instanceof h6) {
    var n = r.__data__;
    ...
    r = this.__data__ = new m6(n);
  }
  return r.set(e, t), this.size = r.size, this;
}
var p6 = y6, C6 = In, v6 = i6, b6 = s6, $6 = c6, _6 = d6, k6 = p6;
function u1(e) {
  var t = this.__data__ = new C6(e);
  this.size = t.size;
}
u1.prototype.clear = v6;
u1.prototype.delete = b6;
u1.prototype.get = $6;
u1.prototype.has = _6;
u1.prototype.set = k6;
var x6 = u1;
...
var P6 = M6, D6 = F1, N6 = a1, O6 = "[object Arguments]";
function I6(e) {
  return N6(e) && D6(e) == O6;
}
var E6 = I6, vi = E6, B6 = a1, b0 = Object.prototype, F6 = b0.hasOwnProperty, z6 = b0.propertyIsEnumerable, U6 = vi(function() {
  return arguments;
}()) ? vi : function(e) {
  return B6(e) && F6.call(e, "callee") && !z6.call(e, "callee");
}, V6 = U6, xn = { exports: {} };
function R6() {
  return !1;
}
...
xn.exports;
(function(e, t) {
  var r = ht, n = K6, l = t && !t.nodeType && t, c = l && !0 && e && !e.nodeType && e, f = c && c.exports === l, m = f ? r.Buffer : void 0, p = m ? m.isBuffer : void 0, L = p || n;
  e.exports = L;
})(xn, xn.exports);
var $0 = xn.exports, j6 = 9007199254740991;
function Q6(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= j6;
}
var _0 = Q6, Z6 = F1, H6 = _0, W6 = a1, Y6 = "[object Arguments]", q6 = "[object Array]", G6 = "[object Boolean]", X6 = "[object Date]", J6 = "[object Error]", el = "[object Function]", tl = "[object Map]", nl = "[object Number]", rl = "[object Object]", ol = "[object RegExp]", il = "[object Set]", al = "[object String]", sl = "[object WeakMap]", ll = "[object ArrayBuffer]", cl = "[object DataView]", ul = "[object Float32Array]", dl = "[object Float64Array]", hl = "[object Int8Array]", fl = "[object Int16Array]", ml = "[object Int32Array]", gl = "[object Uint8Array]", yl = "[object Uint8ClampedArray]", pl = "[object Uint16Array]", Cl = "[object Uint32Array]", Se = {};
Se[ul] = Se[dl] = Se[hl] = Se[fl] = Se[ml] = Se[gl] = Se[yl] = Se[pl] = Se[Cl] = !0;
Se[Y6] = Se[q6] = Se[ll] = Se[G6] = Se[cl] = Se[X6] = Se[J6] = Se[el] = Se[tl] = Se[nl] = Se[rl] = Se[ol] = Se[il] = Se[al] = Se[sl] = !1;
function vl(e) {
  return W6(e) && H6(e.length) && !!Se[Z6(e)];
}
var bl = vl;
function $l(e) {
  return function(t) {
...
Ln.exports;
(function(e, t) {
  var r = u0, n = t && !t.nodeType && t, l = n && !0 && e && !e.nodeType && e, c = l && l.exports === n, f = c && r.process, m = function() {
    try {
...
var Or = Ln.exports, _l = bl, kl = Nr, bi = Or, $i = bi && bi.isTypedArray, xl = $i ? kl($i) : _l, Ll = xl, wl = P6, Al = V6, Tl = i1, Sl = $0, Ml = v0, Pl = Ll, Dl = Object.prototype, Nl = Dl.hasOwnProperty;
function Ol(e, t) {
  var r = Tl(e), n = !r && Al(e), l = !r && !n && Sl(e), c = !r && !n && !l && Pl(e), f = r || n || l || c, m = f ? wl(e.length, String) : [], p = m.length;
  for (var L in e)
    (t || Nl.call(e, L)) && !(f && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var x0 = Bl, Fl = x0, zl = Fl(Object.keys, Object), Ul = zl, Vl = Ir, Rl = Ul, Kl = Object.prototype, jl = Kl.hasOwnProperty;
function Ql(e) {
  if (!Vl(e))
    return Rl(e);
  var t = [];
...
var Zl = Ql, Hl = h0, Wl = _0;
function Yl(e) {
  return e != null && Wl(e.length) && !Hl(e);
}
var L0 = Yl, ql = k0, Gl = Zl, Xl = L0;
function Jl(e) {
  return Xl(e) ? ql(e) : Gl(e);
}
var Er = Jl, e3 = Bn, t3 = Er;
function n3(e, t) {
...
var i3 = o3, a3 = o1, s3 = Ir, l3 = i3, c3 = Object.prototype, u3 = c3.hasOwnProperty;
function d3(e) {
  if (!a3(e))
    return l3(e);
  var t = s3(e), r = [];
...
var h3 = d3, f3 = k0, m3 = h3, g3 = L0;
function y3(e) {
  return g3(e) ? f3(e, !0) : m3(e);
}
var Br = y3, p3 = Bn, C3 = Br;
function v3(e, t) {
  return e && p3(t, C3(t), e);
}
...
(function(e, t) {
  ...
  function p(L, x) {
    if (x)
      return L.slice();
    var w = L.length, R = m ? m(w) : new L.constructor(w);
    return L.copy(R), R;
  }
  e.exports = p;
})(wn, wn.exports);
...
var w0 = w3, A3 = L3, T3 = w0, S3 = Object.prototype, M3 = S3.propertyIsEnumerable, _i = Object.getOwnPropertySymbols, P3 = _i ? function(e) {
  return e == null ? [] : (e = Object(e), A3(_i(e), function(t) {
    return M3.call(e, t);
  }));
} : T3, Fr = P3, D3 = Bn, N3 = Fr;
function O3(e, t) {
  return D3(e, N3(e), t);
}
var I3 = O3;
...
var A0 = E3, B3 = x0, F3 = B3(Object.getPrototypeOf, Object), T0 = F3, z3 = A0, U3 = T0, V3 = Fr, R3 = w0, K3 = Object.getOwnPropertySymbols, j3 = K3 ? function(e) {
  for (var t = []; e; )
    z3(t, V3(e)), e = U3(e);
  return t;
} : R3, S0 = j3, Q3 = Bn, Z3 = S0;
function H3(e, t) {
  return Q3(e, Z3(e), t);
}
var W3 = H3, Y3 = A0, q3 = i1;
function G3(e, t, r) {
  var n = t(e);
  return q3(e) ? n : Y3(n, r(e));
}
var M0 = G3, X3 = M0, J3 = Fr, e8 = Er;
function t8(e) {
  return X3(e, e8, J3);
}
var n8 = t8, r8 = M0, o8 = S0, i8 = Br;
function a8(e) {
  return r8(e, i8, o8);
}
var s8 = a8, l8 = Vt, c8 = ht, u8 = l8(c8, "DataView"), d8 = u8, h8 = Vt, f8 = ht, m8 = h8(f8, "Promise"), g8 = m8, y8 = Vt, p8 = ht, C8 = y8(p8, "Set"), v8 = C8, b8 = Vt, $8 = ht, _8 = b8($8, "WeakMap"), k8 = _8, pr = d8, Cr = Pr, vr = g8, br = v8, $r = k8, P0 = F1, d1 = f0, ki = "[object Map]", x8 = "[object Object]", xi = "[object Promise]", Li = "[object Set]", wi = "[object WeakMap]", Ai = "[object DataView]", L8 = d1(pr), w8 = d1(Cr), A8 = d1(vr), T8 = d1(br), S8 = d1($r), Ft = P0;
(pr && Ft(new pr(new ArrayBuffer(1))) != Ai || Cr && Ft(new Cr()) != ki || vr && Ft(vr.resolve()) != xi || br && Ft(new br()) != Li || $r && Ft(new $r()) != wi) && (Ft = function(e) {
  var t = P0(e), r = t == x8 ? e.constructor : void 0, n = r ? d1(r) : "";
  if (n)
    switch (n) {
      case L8:
        return Ai;
...
var zr = Ft, M8 = Object.prototype, P8 = M8.hasOwnProperty;
function D8(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && P8.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
var N8 = D8, O8 = ht, I8 = O8.Uint8Array, E8 = I8, Ti = E8;
function B8(e) {
...
var K8 = R8, Si = Dn, Mi = Si ? Si.prototype : void 0, Pi = Mi ? Mi.valueOf : void 0;
function j8(e) {
...
var W8 = H8, Y8 = Ur, q8 = U8, G8 = K8, X8 = Q8, J8 = W8, ec = "[object Boolean]", tc = "[object Date]", nc = "[object Map]", rc = "[object Number]", oc = "[object RegExp]", ic = "[object Set]", ac = "[object String]", sc = "[object Symbol]", lc = "[object ArrayBuffer]", cc = "[object DataView]", uc = "[object Float32Array]", dc = "[object Float64Array]", hc = "[object Int8Array]", fc = "[object Int16Array]", mc = "[object Int32Array]", gc = "[object Uint8Array]", yc = "[object Uint8ClampedArray]", pc = "[object Uint16Array]", Cc = "[object Uint32Array]";
function vc(e, t, r) {
  var n = e.constructor;
  switch (t) {
    case lc:
...
var bc = vc, $c = o1, Di = Object.create, _c = function() {
  function e() {
  }
  return function(t) {
    if (!$c(t))
...
}(), kc = _c, xc = kc, Lc = T0, wc = Ir;
function Ac(e) {
  return typeof e.constructor == "function" && !wc(e) ? xc(Lc(e)) : {};
}
var Tc = Ac, Sc = zr, Mc = a1, Pc = "[object Map]";
function Dc(e) {
  return Mc(e) && Sc(e) == Pc;
}
var Nc = Dc, Oc = Nc, Ic = Nr, Ni = Or, Oi = Ni && Ni.isMap, Ec = Oi ? Ic(Oi) : Oc, Bc = Ec, Fc = zr, zc = a1, Uc = "[object Set]";
function Vc(e) {
  return zc(e) && Fc(e) == Uc;
}
var Rc = Vc, Kc = Rc, jc = Nr, Ii = Or, Ei = Ii && Ii.isSet, Qc = Ei ? jc(Ei) : Kc, Zc = Qc, Hc = x6, Wc = w6, Yc = Sr, qc = r3, Gc = b3, Xc = $3, Jc = k3, e7 = I3, t7 = W3, n7 = n8, r7 = s8, o7 = zr, i7 = N8, a7 = bc, s7 = Tc, l7 = i1, c7 = $0, u7 = Bc, d7 = o1, h7 = Zc, f7 = Er, m7 = Br, g7 = 1, y7 = 2, p7 = 4, D0 = "[object Arguments]", C7 = "[object Array]", v7 = "[object Boolean]", b7 = "[object Date]", $7 = "[object Error]", N0 = "[object Function]", _7 = "[object GeneratorFunction]", k7 = "[object Map]", x7 = "[object Number]", O0 = "[object Object]", L7 = "[object RegExp]", w7 = "[object Set]", A7 = "[object String]", T7 = "[object Symbol]", S7 = "[object WeakMap]", M7 = "[object ArrayBuffer]", P7 = "[object DataView]", D7 = "[object Float32Array]", N7 = "[object Float64Array]", O7 = "[object Int8Array]", I7 = "[object Int16Array]", E7 = "[object Int32Array]", B7 = "[object Uint8Array]", F7 = "[object Uint8ClampedArray]", z7 = "[object Uint16Array]", U7 = "[object Uint32Array]", xe = {};
xe[D0] = xe[C7] = xe[M7] = xe[P7] = xe[v7] = xe[b7] = xe[D7] = xe[N7] = xe[O7] = xe[I7] = xe[E7] = xe[k7] = xe[x7] = xe[O0] = xe[L7] = xe[w7] = xe[A7] = xe[T7] = xe[B7] = xe[F7] = xe[z7] = xe[U7] = !0;
xe[$7] = xe[N0] = xe[S7] = !1;
function yn(e, t, r, n, l, c) {
  var f, m = t & g7, p = t & y7, L = t & p7;
  ...
  if (x) {
    ...
    var w = o7(e), R = w == N0 || w == _7;
    if (c7(e))
      return Xc(e, m);
    if (w == O0 || w == D0 || R && !l) {
      if (f = p || R ? {} : s7(e), !m)
        return p ? t7(e, Gc(f, e)) : e7(e, qc(f, e));
    } else {
      if (!xe[w])
        return l ? e : {};
      f = a7(e, w, m);
  ...
  if (Y)
    return Y;
  c.set(e, f), h7(e) ? e.forEach(function(S) {
    f.add(yn(S, t, r, S, e, c));
  }) : u7(e) && e.forEach(function(S, E) {
    f.set(E, yn(S, t, r, E, e, c));
  });
  var ye = L ? p ? r7 : n7 : p ? m7 : f7, V = x ? void 0 : ye(e);
  return Wc(V || e, function(S, E) {
    V && (E = S, S = e[E]), Yc(f, E, yn(S, t, r, E, e, c));
  }), f;
}
...
var Z7 = Q7;
const H7 = /* @__PURE__ */ c0(Z7), W7 = /* @__PURE__ */ $("<button></button>"), Y7 = (e) => (() => {
  const t = W7.cloneNode(!0);
  return ut(t, "click", e.onClick, !0), C(t, () => e.children), z((r) => {
    const n = e.style, l = `klinecharts-pro-button ${e.type ?? "confirm"} ${e.class ?? ""}`;
    return r._v$ = Ct(t, n, r._v$), l !== r._v$2 && le(t, r._v$2 = l), r;
  }, {
    _v$: void 0,
    _v$2: void 0
  }), t;
...
const q7 = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), G7 = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), X7 = /* @__PURE__ */ $("<div></div>"), J7 = /* @__PURE__ */ $('<span class="label"></span>'), e4 = () => q7.cloneNode(!0), t4 = () => G7.cloneNode(!0), Bi = (e) => {
  ...
  return je(() => {
    ...
    return n.$$click = (l) => {
      ...
      return l._v$ = Ct(n, c, l._v$), f !== l._v$2 && le(n, l._v$2 = f), l;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), n;
...
const n4 = /* @__PURE__ */ $('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), I0 = () => n4.cloneNode(!0), r4 = /* @__PURE__ */ $('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), o4 = () => r4.cloneNode(!0), i4 = /* @__PURE__ */ $("<ul></ul>"), a4 = /* @__PURE__ */ $("<li></li>"), An = (e) => (() => {
  ...
  return t.$$click = (f) => {
    ...
    return () => f() && (() => {
      const m = l4.cloneNode(!0);
      return C(m, () => e.buttons.map((p) => A(Y7, s0(p, {
        get style() {
          return {
            ...e.minButtonWidth ? {
        ...
        return L !== p._v$11 && le(m, p._v$11 = L), p._v$12 = Ct(m, x, p._v$12), w !== p._v$13 && m.classList.toggle("mobile-buttons", p._v$13 = w), p;
      }, {
        _v$11: void 0,
        _v$12: void 0,
        _v$13: void 0
    ...
    const m = `klinecharts-pro-modal ${e.class ?? ""}`, p = !!e.isMobile, L = e.isMobile ? "100%" : `${e.width ?? 400}px`, x = (e.isMobile, "auto"), w = e.isMobile ? "60vh" : "90vh", R = `inner ${e.innerClass ?? ""}`, Y = !!e.isMobile, ye = !!e.isMobile, V = `content-container ${e.contentClass ?? ""}`, S = !!e.isMobile;
    return m !== f._v$ && le(t, f._v$ = m), p !== f._v$2 && t.classList.toggle("mobile-modal", f._v$2 = p), L !== f._v$3 && r.style.setProperty("width", f._v$3 = L), x !== f._v$4 && r.style.setProperty("height", f._v$4 = x), w !== f._v$5 && r.style.setProperty("max-height", f._v$5 = w), R !== f._v$6 && le(r, f._v$6 = R), Y !== f._v$7 && r.classList.toggle("mobile-inner", f._v$7 = Y), ye !== f._v$8 && n.classList.toggle("mobile-title", f._v$8 = ye), V !== f._v$9 && le(c, f._v$9 = V), S !== f._v$10 && c.classList.toggle("mobile-content", f._v$10 = S), f;
  }, {
    _v$: void 0,
    _v$2: void 0,
    _v$3: void 0,
...
Ye(["click"]);
const c4 = /* @__PURE__ */ $("<div><ul></ul></div>"), u4 = /* @__PURE__ */ $('<div><input type="text"></div>'), d4 = /* @__PURE__ */ $("<li></li>"), h4 = /* @__PURE__ */ $('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), pn = (e) => {
  ...
  const x = (S, E, ne) => {
    ...
    if (!p)
      return;
    const S = p.getBoundingClientRect(), E = window.getComputedStyle(p), ne = x(E, "--klinecharts-pro-select-dropdown-gap", 4), F = p.closest(".klinecharts-pro-modal .inner"), Q = F == null ? void 0 : F.getBoundingClientRect(), K = (Q == null ? void 0 : Q.left) ?? 0, ce = (Q == null ? void 0 : Q.right) ?? window.innerWidth, H = !!p.closest(".klinecharts-pro-setting-modal") || ((k = e.dropdownClass) == null ? void 0 : k.includes("klinecharts-pro-timezone-dropdown")), X = x(E, H ? "--klinecharts-pro-setting-dropdown-boundary-padding" : "--klinecharts-pro-select-dropdown-boundary-padding", H ? 16 : 12), ae = x(E, "--klinecharts-pro-setting-dropdown-mobile-breakpoint", 768), he = window.innerWidth <= ae, be = E.getPropertyValue("--klinecharts-pro-setting-dropdown-mobile-width-mode").trim() || "trigger", Le = Math.max(S.width, ce - K - X * 2), ue = x(E, "--klinecharts-pro-setting-dropdown-max-width", 280), Pe = H ? he && be !== "expanded" ? S.width : Math.max(S.width, Math.min(ue, Le)) : S.width, ve = Math.min(Math.max(S.left, K + X), ce - Pe - X), O = x(E, "--klinecharts-pro-select-dropdown-min-height", 140), N = x(E, "--klinecharts-pro-select-dropdown-max-height", 260), U = x(E, "--klinecharts-pro-select-dropdown-viewport-padding-y", 32), q = x(E, "--klinecharts-pro-select-dropdown-open-up-threshold", 180), M = x(E, "--klinecharts-pro-select-dropdown-z-index", 1e4), T = Math.min(N, Math.max(O, window.innerHeight - U)), W = window.innerHeight - S.bottom - ne, Z = S.top - ne, j = W < q && Z > W, oe = Math.max(O, Math.min(T, j ? Z - ne : W - ne));
    f({
      position: "fixed",
      left: `${ve}px`,
      top: j ? "auto" : `${S.bottom + ne}px`,
      bottom: j ? `${window.innerHeight - S.top + ne}px` : "auto",
      width: `${Pe}px`,
      "max-height": `${oe}px`,
      "transform-origin": j ? "bottom" : "top",
      opacity: 1,
      transform: "scaleY(1)",
      "z-index": M
    });
    ...
    return S ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((ne) => ne.toLowerCase().includes(S)) : e.dataSource.filter((ne) => {
      var K, ce;
      const F = ((K = ne.text) == null ? void 0 : K.toString().toLowerCase()) || "", Q = ((ce = ne.key) == null ? void 0 : ce.toLowerCase()) || "";
      return F.includes(S) || Q.includes(S);
    }) : e.dataSource;
  }), Y = () => {
    const S = !t();
  ...
  je(() => {
    ...
    document.addEventListener("mousedown", S), window.addEventListener("resize", E), window.addEventListener("scroll", E, !0), pt(() => {
  ...
  const V = () => (() => {
    ...
    const ne = L;
    return typeof ne == "function" ? yt(ne, S) : L = S, C(S, (() => {
      const F = ee(() => !!e.searchable);
      return () => F() && (() => {
        const Q = u4.cloneNode(!0), K = Q.firstChild;
        Q.style.setProperty("padding", "8px"), Q.style.setProperty("border-bottom", "1px solid #333"), K.$$click = (G) => G.stopPropagation(), K.$$input = (G) => l(G.currentTarget.value);
        const ce = m;
        return typeof ce == "function" ? yt(ce, K) : m = K, K.style.setProperty("width", "100%"), K.style.setProperty("padding", "6px 10px"), K.style.setProperty("border", "1px solid var(--klinecharts-pro-border-color)"), K.style.setProperty("border-radius", "4px"), K.style.setProperty("background-color", "var(--klinecharts-pro-popover-background-color)"), K.style.setProperty("color", "#fff"), K.style.setProperty("font-size", "13px"), K.style.setProperty("outline", "none"), z(() => Ie(K, "placeholder", e.searchPlaceholder || "Search...")), z(() => K.value = n()), Q;
      })();
    })(), E), C(E, () => {
      var F;
      return (F = R()) == null ? void 0 : F.map((Q) => {
        const ce = Q[e.valueKey ?? "text"] ?? Q;
        return (() => {
          const G = d4.cloneNode(!0);
          return G.$$click = (H) => {
            var X;
            H.stopPropagation(), e.value !== ce && ((X = e.onSelected) == null || X.call(e, Q)), r(!1), l("");
          }, C(G, ce), z(() => G.classList.toggle("selected", e.value === ce)), G;
        })();
      });
    }), z((F) => {
      const Q = `drop-down-container klinecharts-pro-select-dropdown-portal ${e.dropdownClass ?? ""}`, K = c();
      return Q !== F._v$ && le(S, F._v$ = Q), F._v$2 = Ct(S, K, F._v$2), F;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), S;
  ...
  return (() => {
    const S = h4.cloneNode(!0), E = S.firstChild, ne = E.firstChild;
    S.addEventListener("blur", ye), S.$$click = (Q) => {
      Q.stopPropagation(), !Q.target.closest(".drop-down-container") && Y();
    };
    const F = p;
    return typeof F == "function" ? yt(F, S) : p = S, C(ne, () => e.value), C(S, (() => {
      const Q = ee(() => !!(e.dataSource && e.dataSource.length > 0 && t()));
      return () => Q() && A(l0, {
        get children() {
          return V();
        }
      ...
      const K = e.style, ce = `klinecharts-pro-select ${e.class ?? ""} ${t() ? "klinecharts-pro-select-show" : ""}`;
      return Q._v$3 = Ct(S, K, Q._v$3), ce !== Q._v$4 && le(S, Q._v$4 = ce), Q;
    }, {
      _v$3: void 0,
      _v$4: void 0
    }), S;
...
const f4 = /* @__PURE__ */ $('<span class="prefix"></span>'), m4 = /* @__PURE__ */ $('<span class="suffix"></span>'), g4 = /* @__PURE__ */ $('<div><input class="value"></div>'), E0 = (e) => {
  const t = s0({
  ...
  const [n, l] = D("normal");
  return (() => {
    const c = g4.cloneNode(!0), f = c.firstChild;
    return c.$$click = () => {
      r == null || r.focus();
    }, C(c, A(de, {
      get when() {
      ...
      if ("precision" in t) {
        let w;
        const R = Math.max(0, Math.floor(t.precision));
        R <= 0 ? w = new RegExp(/^[1-9]\d*$/) : w = new RegExp("^\\d+\\.?\\d{0," + R + "}$"), (p === "" || w.test(p) && +p >= t.min && +p <= t.max) && ((L = t.onChange) == null || L.call(t, p === "" ? p : +p));
      } else
      ...
      get children() {
        const m = m4.cloneNode(!0);
        return C(m, () => t.suffix), m;
      }
    }), null), z((m) => {
      const p = t.style, L = `klinecharts-pro-input ${t.class ?? ""}`, x = n(), w = t.placeholder ?? "";
      return m._v$ = Ct(c, p, m._v$), L !== m._v$2 && le(c, m._v$2 = L), x !== m._v$3 && Ie(c, "data-status", m._v$3 = x), w !== m._v$4 && Ie(f, "placeholder", m._v$4 = w), m;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
Ye(["click"]);
let fe = null, Fi = !1;
const O1 = /* @__PURE__ */ new Map(), p4 = 500, zi = 3;
function dn(e) {
...
function $4(e, t) {
  ...
  if (n > Math.max(zi, l)) {
    if (O1.set(r, n), O1.size > p4) {
      const f = O1.keys().next().value;
      f !== void 0 && O1.delete(f);
    }
    return !1;
  }
  const c = Math.max(zi, l * 0.35);
  return n <= c;
}
function cr(e, t, r) {
...
function _4(e, t, r) {
  const n = r.style ?? Xt.Fill, l = r.color ?? "currentColor", c = kr(r.color) ?? kr(r.borderColor), f = n === Xt.Stroke, m = c ? $4(t, f) : !1, p = lr(l, m ? "wick" : "body", c), L = r.borderSize ?? 1, x = lr(r.borderColor ?? l, "border", c), w = r.borderStyle ?? Ke.Solid, R = r.borderRadius ?? 0, Y = r.borderDashedValue ?? [2, 2], ye = n === Xt.Fill || r.style === Xt.StrokeFill, V = n === Xt.Stroke || r.style === Xt.StrokeFill;
  if (ye) {
    e.fillStyle = p, cr(e, t, R), e.fill();
    const S = lr(l, "border", c);
    !m && c && S && (e.strokeStyle = S, e.lineWidth = Math.max(1, L), e.setLineDash([]), cr(e, t, R), e.stroke());
  }
  V && (e.strokeStyle = x, e.lineWidth = L, e.setLineDash(w === Ke.Dashed ? Y : []), cr(e, t, R), e.stroke());
}
function k4() {
  Fi || (Fi = !0, Ba({
    name: "rect",
...
function At(e) {
  ...
  t && (fe = {
    ...fe ?? {},
    ...t,
    upBorderColor: t.upBorderColor ?? t.borderUpColor ?? t.upColor ?? (fe == null ? void 0 : fe.upBorderColor) ?? (fe == null ? void 0 : fe.borderUpColor),
    downBorderColor: t.downBorderColor ?? t.borderDownColor ?? t.downColor ?? (fe == null ? void 0 : fe.downBorderColor) ?? (fe == null ? void 0 : fe.borderDownColor),
    noChangeBorderColor: t.noChangeBorderColor ?? t.borderNoChangeColor ?? t.noChangeColor ?? (fe == null ? void 0 : fe.noChangeBorderColor) ?? (fe == null ? void 0 : fe.borderNoChangeColor),
    upWickColor: t.upWickColor ?? t.wickUpColor ?? t.upColor ?? (fe == null ? void 0 : fe.upWickColor) ?? (fe == null ? void 0 : fe.wickUpColor),
    downWickColor: t.downWickColor ?? t.wickDownColor ?? t.downColor ?? (fe == null ? void 0 : fe.downWickColor) ?? (fe == null ? void 0 : fe.wickDownColor),
    noChangeWickColor: t.noChangeWickColor ?? t.wickNoChangeColor ?? t.noChangeColor ?? (fe == null ? void 0 : fe.noChangeWickColor) ?? (fe == null ? void 0 : fe.wickNoChangeColor)
  });
}
const x4 = "指标", L4 = "更多", w4 = "主图指标", A4 = "副图指标", T4 = "设置", S4 = "时区", M4 = "截屏", P4 = "全屏", D4 = "退出全屏", N4 = "保存", O4 = "确定", I4 = "取消", E4 = "MA(移动平均线)", B4 = "EMA(指数平滑移动平均线)", F4 = "SMA", z4 = "BOLL(布林线)", U4 = "BBI(多空指数)", V4 = "SAR(停损点指向指标)", R4 = "VOL(成交量)", K4 = "MACD(指数平滑异同移动平均线)", j4 = "KDJ(随机指标)", Q4 = "RSI(相对强弱指标)", Z4 = "BIAS(乖离率)", H4 = "BRAR(情绪指标)", W4 = "CCI(顺势指标)", Y4 = "DMI(动向指标)", q4 = "CR(能量指标)", G4 = "PSY(心理线)", X4 = "DMA(平行线差指标)", J4 = "TRIX(三重指数平滑平均线)", eu = "OBV(能量潮指标)", tu = "VR(成交量变异率)", nu = "WR(威廉指标)", ru = "MTM(动量指标)", ou = "EMV(简易波动指标)", iu = "ROC(变动率指标)", au = "PVT(价量趋势指标)", su = "AO(动量震荡指标)", lu = "世界统一时间", cu = "(UTC-10) 檀香山", uu = "(UTC-8) 朱诺", du = "(UTC-7) 洛杉矶", hu = "(UTC-5) 芝加哥", fu = "(UTC-4) 多伦多", mu = "(UTC-3) 圣保罗", gu = "(UTC+1) 伦敦", yu = "(UTC+2) 柏林", pu = "(UTC+3) 巴林", Cu = "(UTC+4) 迪拜", vu = "(UTC+5) 阿什哈巴德", bu = "(UTC+6) 阿拉木图", $u = "(UTC+7) 曼谷", _u = "(UTC+8) 上海", ku = "(UTC+9) 东京", xu = "(UTC+10) 悉尼", Lu = "(UTC+12) 诺福克岛", wu = "水平直线", Au = "水平射线", Tu = "水平线段", Su = "垂直直线", Mu = "垂直射线", Pu = "垂直线段", Du = "直线", Nu = "射线", Ou = "线段", Iu = "箭头", Eu = "价格线", Bu = "价格通道线", Fu = "平行直线", zu = "斐波那契回调直线", Uu = "斐波那契回调线段", Vu = "斐波那契圆环", Ru = "斐波那契螺旋", Ku = "斐波那契速度阻力扇", ju = "斐波那契趋势扩展", Qu = "江恩箱", Zu = "矩形", Hu = "平行四边形", Wu = "圆", Yu = "三角形", qu = "三浪", Gu = "五浪", Xu = "八浪", Ju = "任意浪", ed = "ABCD形态", td = "XABCD形态", nd = "弱磁模式", rd = "强磁模式", od = "商品搜索", id = "商品代码", ad = "参数1", sd = "参数2", ld = "参数3", cd = "参数4", ud = "参数5", dd = "周期", hd = "标准差", fd = "蜡烛图类型", md = "全实心", gd = "全空心", yd = "涨空心", pd = "跌空心", Cd = "OHLC", vd = "面积图", bd = "最新价显示", $d = "最高价显示", _d = "最低价显示", kd = "指标最新值显示", xd = "价格轴类型", Ld = "线性轴", wd = "百分比轴", Ad = "对数轴", Td = "倒置坐标", Sd = "网格线显示", Md = "恢复默认", Pd = {
  indicator: x4,
  more: L4,
  main_indicator: w4,
  sub_indicator: A4,
  ...
  grid_show: Sd,
  restore_default: Md
}, Dd = "Indicator", Nd = "More", Od = "Main Indicator", Id = "Sub Indicator", Ed = "Setting", Bd = "Timezone", Fd = "Screenshot", zd = "Full Screen", Ud = "Exit", Vd = "Save", Rd = "Confirm", Kd = "Cancel", jd = "MA(Moving Average)", Qd = "EMA(Exponential Moving Average)", Zd = "SMA", Hd = "BOLL(Bolinger Bands)", Wd = "BBI(Bull And Bearlndex)", Yd = "SAR(Stop and Reverse)", qd = "VOL(Volume)", Gd = "MACD(Moving Average Convergence / Divergence)", Xd = "KDJ(KDJ Index)", Jd = "RSI(Relative Strength Index)", eh = "BIAS(Bias Ratio)", th = "BRAR(情绪指标)", nh = "CCI(Commodity Channel Index)", rh = "DMI(Directional Movement Index)", oh = "CR(能量指标)", ih = "PSY(Psychological Line)", ah = "DMA(Different of Moving Average)", sh = "TRIX(Triple Exponentially Smoothed Moving Average)", lh = "OBV(On Balance Volume)", ch = "VR(Volatility Volume Ratio)", uh = "WR(Williams %R)", dh = "MTM(Momentum Index)", hh = "EMV(Ease of Movement Value)", fh = "ROC(Price Rate of Change)", mh = "PVT(Price and Volume Trend)", gh = "AO(Awesome Oscillator)", yh = "UTC", ph = "(UTC-10) Honolulu", Ch = "(UTC-8) Juneau", vh = "(UTC-7) Los Angeles", bh = "(UTC-5) Chicago", $h = "(UTC-4) Toronto", _h = "(UTC-3) Sao Paulo", kh = "(UTC+1) London", xh = "(UTC+2) Berlin", Lh = "(UTC+3) Bahrain", wh = "(UTC+4) Dubai", Ah = "(UTC+5) Ashkhabad", Th = "(UTC+6) Almaty", Sh = "(UTC+7) Bangkok", Mh = "(UTC+8) Shanghai", Ph = "(UTC+9) Tokyo", Dh = "(UTC+10) Sydney", Nh = "(UTC+12) Norfolk", Oh = "Horizontal Line", Ih = "Horizontal Ray", Eh = "Horizontal Segment", Bh = "Vertical Line", Fh = "Vertical Ray", zh = "Vertical Segment", Uh = "Trend Line", Vh = "Ray", Rh = "Segment", Kh = "Arrow", jh = "Price Line", Qh = "Price Channel Line", Zh = "Parallel Line", Hh = "Fibonacci Line", Wh = "Fibonacci Segment", Yh = "Fibonacci Circle", qh = "Fibonacci Spiral", Gh = "Fibonacci Sector", Xh = "Fibonacci Extension", Jh = "Gann Box", ef = "Rectangle", tf = "Parallelogram", nf = "Circle", rf = "Triangle", of = "Three Waves", af = "Five Waves", sf = "Eight Waves", lf = "Any Waves", cf = "ABCD Pattern", uf = "XABCD Pattern", df = "Weak Magnet", hf = "Strong Magnet", ff = "Symbol Search", mf = "Symbol Code", gf = "Parameter 1", yf = "Parameter 2", pf = "Parameter 3", Cf = "Parameter 4", vf = "Parameter 5", bf = "Period", $f = "Standard Deviation", _f = "Candle Type", kf = "Candle Solid", xf = "Candle Stroke", Lf = "Candle Up Stroke", wf = "Candle Down Stroke", Af = "OHLC", Tf = "Area", Sf = "Show Last Price", Mf = "Show Highest Price", Pf = "Show Lowest Price", Df = "Show indicator's last value", Nf = "Price Axis Type", Of = "Normal", If = "Percentage", Ef = "Log", Bf = "Reverse Coordinate", Ff = "Show Grids", zf = "Restore Defaults", Uf = {
  indicator: Dd,
  more: Nd,
  main_indicator: Od,
  sub_indicator: Id,
...
const d = (e, t) => {
  ...
  const [l, c] = D(window.innerWidth < 768), [f, m] = D(localStorage.getItem("klinechart_secondary_period") || ""), [p, L] = D(!1), [x, w] = D(!1), [R, Y] = D(!1), [ye, V] = D(!1), [S, E] = D(!1), [ne, F] = D({
    ...
    ae(T && M.scrollLeft > 2), be(T && M.scrollLeft + M.clientWidth < M.scrollWidth - 2);
  };
  Tr(() => {
    window.addEventListener("resize", Q), document.addEventListener("fullscreenchange", H), document.addEventListener("pointerdown", ve, !0), document.addEventListener("mousedown", ve), window.addEventListener("scroll", O, !0), document.addEventListener("mozfullscreenchange", H), document.addEventListener("webkitfullscreenchange", H), document.addEventListener("msfullscreenchange", H), t && (t.addEventListener("scroll", N), setTimeout(N, 100));
  }), pt(() => {
    window.removeEventListener("resize", Q), document.removeEventListener("fullscreenchange", H), document.removeEventListener("pointerdown", ve, !0), document.removeEventListener("mousedown", ve), window.removeEventListener("scroll", O, !0), document.removeEventListener("mozfullscreenchange", H), document.removeEventListener("webkitfullscreenchange", H), document.removeEventListener("msfullscreenchange", H), t && t.removeEventListener("scroll", N);
  });
  const U = ee(() => {
    const M = e.periods.filter((T) => {
      if (!l() || K())
        return !0;
      const W = e.period.text, Z = f();
      if (T.text === W || Z && T.text === Z)
        return !0;
      if (!Z || Z === W) {
        const j = e.periods.find((oe) => oe.text !== W);
        return T.text === (j == null ? void 0 : j.text);
      }
      return !1;
    }).slice(0, l() && !K() ? 2 : e.periods.length);
    return setTimeout(N, 50), M;
  });
  let q = e.period.text;
  return je(() => {
    const M = e.period.text;
    M !== q && (l() && (m(q), localStorage.setItem("klinechart_secondary_period", q)), q = M), setTimeout(N, 50);
  }), je(() => {
    K(), setTimeout(N, 100);
  }), je(() => {
    ...
    const M = nm.cloneNode(!0), T = M.firstChild, W = T.firstChild, Z = W.firstChild, j = W.nextSibling, oe = j.firstChild;
    return M.style.setProperty("position", "relative"), M.style.setProperty("width", "100%"), M.style.setProperty("display", "flex"), M.style.setProperty("align-items", "center"), C(M, A(de, {
      get when() {
        return X();
      },
      get children() {
      ...
      t = k;
    }, T), T.style.setProperty("width", "100%"), T.style.setProperty("overflow", "auto"), ut(Z, "click", e.onMenuClick, !0), C(T, A(de, {
      get when() {
        return e.symbol;
      },
      get children() {
        const k = Kf.cloneNode(!0), me = k.firstChild;
        return ut(k, "click", e.onSymbolClick, !0), C(k, A(de, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const $e = Rf.cloneNode(!0);
            return z(() => Ie($e, "src", e.symbol.logo)), $e;
          }
        }), me), C(me, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), k;
      }
    }), j), C(T, () => U().map((k, me) => {
      const $e = k.text === e.period.text;
      return (() => {
        const Ve = rm.cloneNode(!0);
        return Ve.$$click = (Ce) => {
          l() && $e && !K() ? (e.onMobilePeriodClick ? e.onMobilePeriodClick(k) : e.onMenuClick(), Ce.stopPropagation()) : e.onPeriodChange(k);
        }, le(Ve, `item period ${$e ? "selected" : ""}`), C(Ve, () => k.text), Ve;
      })();
    }), j), C(T, A(de, {
      get when() {
        return ee(() => !!(l() && !K()))() && U().length > 1;
      },
      get children() {
      ...
      get children() {
        ...
        return k.$$click = (me) => {
          var $e;
          me.stopPropagation(), ($e = e.onMobileMoreClick) == null || $e.call(e);
      ...
      get children() {
        const k = Hf.cloneNode(!0), me = k.firstChild, $e = me.nextSibling;
        return ut(k, "click", e.onIndicatorClick, !0), C($e, () => d("indicator", e.locale)), k;
      }
    }), j), j.style.setProperty("display", "flex"), j.style.setProperty("height", "100%"), j.style.setProperty("margin-left", "auto"), j.style.setProperty("align-items", "center"), j.style.setProperty("flex", "0 0 auto"), C(j, A(de, {
      get when() {
        return e.showOrderToolsMenu;
      },
      get children() {
        const k = qf.cloneNode(!0), me = k.firstChild, $e = me.firstChild, Ve = $e.nextSibling;
        return yt((Ce) => {
          r = Ce;
        }, k), k.style.setProperty("display", "flex"), k.style.setProperty("align-items", "center"), k.style.setProperty("height", "100%"), me.$$click = (Ce) => {
          Ce.stopPropagation(), Pe();
        }, me.style.setProperty("gap", "6px"), Ve.style.setProperty("transition", "transform 0.2s ease"), C(k, A(de, {
          get when() {
            return p();
          },
          get children() {
            return A(l0, {
              ...
              get children() {
                const Ce = Yf.cloneNode(!0), bt = Ce.firstChild, $t = bt.firstChild, Rt = $t.firstChild, Kt = Rt.firstChild, Mt = Kt.firstChild, Fn = $t.nextSibling, h1 = Fn.firstChild, z1 = h1.firstChild, U1 = z1.firstChild, jt = h1.nextSibling, zn = jt.firstChild, f1 = zn.firstChild, Pt = bt.nextSibling, Ee = Pt.firstChild, Un = Ee.firstChild, _t = Un.firstChild, Dt = _t.firstChild, Nt = Ee.nextSibling, nt = Nt.firstChild;
                nt.firstChild;
                const m1 = nt.nextSibling, Xe = m1.firstChild, g1 = Xe.nextSibling, y1 = g1.firstChild, Ot = y1.firstChild, kt = m1.nextSibling, p1 = kt.firstChild, C1 = Pt.nextSibling, Vn = C1.firstChild, V1 = Vn.firstChild, Rn = C1.nextSibling, R1 = Rn.nextSibling, Qt = R1.firstChild, v1 = Qt.firstChild, K1 = R1.nextSibling, b1 = K1.nextSibling, j1 = b1.firstChild, Q1 = j1.firstChild, It = b1.nextSibling, Ze = It.firstChild, He = Ze.firstChild, qe = He.firstChild, We = qe.firstChild, Kn = Ze.nextSibling, Zt = Kn.firstChild, $1 = Zt.firstChild, _1 = $1.firstChild, _e = Zt.nextSibling, k1 = _e.firstChild, lt = k1.firstChild, ft = _e.nextSibling, Ht = ft.firstChild, xt = Ht.firstChild, Je = It.nextSibling, Z1 = Je.firstChild, H1 = Z1.firstChild, W1 = Je.nextSibling, jn = W1.firstChild, Y1 = jn.firstChild;
                return Ce.$$mousedown = (b) => b.stopPropagation(), yt((b) => {
                  n = b;
                }, Ce), Ce.style.setProperty("position", "fixed"), Ce.style.setProperty("z-index", "9999"), $t.$$click = (b) => {
                  ...
                  b.preventDefault(), b.stopPropagation(), Y((I) => !I), V(!1);
                }, _t.$$mousedown = (b) => b.stopPropagation(), _t.$$click = (b) => b.stopPropagation(), Dt.addEventListener("change", (b) => {
                  var I;
                  b.stopPropagation(), Y(!0), (I = e.onOrderToolsStateChange) == null || I.call(e, {
                  ...
                  b.preventDefault(), b.stopPropagation(), V((I) => !I);
                }, C(y1, () => {
                  var b;
                  return Vi(((b = e.orderToolsState) == null ? void 0 : b.openOrdersDisplay) ?? "right");
                }, Ot), C(g1, A(de, {
                  get when() {
                    return ye();
                  },
                  get children() {
                    const b = Wf.cloneNode(!0);
                    return C(b, () => ["left", "center", "right"].map((I) => (() => {
                      const De = om.cloneNode(!0);
                      return De.$$click = (Re) => {
                        var Ge;
                        Re.preventDefault(), Re.stopPropagation(), (Ge = e.onOrderToolsStateChange) == null || Ge.call(e, {
                          openOrdersDisplay: I
                        }), V(!1);
                      }, C(De, () => Vi(I)), z(() => {
                        var Re;
                        return le(De, (((Re = e.orderToolsState) == null ? void 0 : Re.openOrdersDisplay) ?? "right") === I ? "selected" : "");
                      }), De;
                    })())), b;
                  }
                }), null), C(p1, () => e.orderToolsConfirmAfterDragLabel ?? "Confirm After Drag"), C(kt, A(_r, {
                  get open() {
                    var b;
                  ...
                  const I = `${ne().top}px`, De = `${ne().left}px`, Re = `${ne().minWidth}px`, Ge = `klinecharts-pro-order-tools-group${x() ? " klinecharts-pro-order-tools-group-open" : ""}`, Lt = `klinecharts-pro-order-tools-group${R() ? " klinecharts-pro-order-tools-group-open" : ""}`, x1 = `klinecharts-pro-order-tools-display-arrow${ye() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, q1 = `klinecharts-pro-order-tools-group${S() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return I !== b._v$ && Ce.style.setProperty("top", b._v$ = I), De !== b._v$2 && Ce.style.setProperty("left", b._v$2 = De), Re !== b._v$3 && Ce.style.setProperty("width", b._v$3 = Re), Ge !== b._v$4 && le(bt, b._v$4 = Ge), Lt !== b._v$5 && le(Pt, b._v$5 = Lt), x1 !== b._v$6 && Ie(Ot, "class", b._v$6 = x1), q1 !== b._v$7 && le(It, b._v$7 = q1), b;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var b, I, De, Re;
                  return Mt.checked = (((b = e.orderToolsState) == null ? void 0 : b.quickOrderFloatingWindow) ?? ((I = e.orderToolsState) == null ? void 0 : I.quickOrder) ?? !0) || (((De = e.orderToolsState) == null ? void 0 : De.quickOrderPlusButton) ?? ((Re = e.orderToolsState) == null ? void 0 : Re.quickOrder) ?? !0);
                }), z(() => {
                  var b, I;
                  return U1.checked = ((b = e.orderToolsState) == null ? void 0 : b.quickOrderFloatingWindow) ?? ((I = e.orderToolsState) == null ? void 0 : I.quickOrder) ?? !0;
                }), z(() => {
                  var b, I;
                  return f1.checked = ((b = e.orderToolsState) == null ? void 0 : b.quickOrderPlusButton) ?? ((I = e.orderToolsState) == null ? void 0 : I.quickOrder) ?? !0;
                }), z(() => {
                  var b;
                  ...
                  var b, I, De, Re, Ge, Lt;
                  return We.checked = (((b = e.orderToolsState) == null ? void 0 : b.marketPriceLine) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0) || (((De = e.orderToolsState) == null ? void 0 : De.countDown) ?? ((Re = e.orderToolsState) == null ? void 0 : Re.priceLine) ?? !0) || (((Ge = e.orderToolsState) == null ? void 0 : Ge.bidAskPrice) ?? ((Lt = e.orderToolsState) == null ? void 0 : Lt.priceLine) ?? !0);
                }), z(() => {
                  var b, I;
                  return _1.checked = ((b = e.orderToolsState) == null ? void 0 : b.marketPriceLine) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0;
                }), z(() => {
                  var b, I;
                  return lt.checked = ((b = e.orderToolsState) == null ? void 0 : b.countDown) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0;
                }), z(() => {
                  var b, I;
                  return xt.checked = ((b = e.orderToolsState) == null ? void 0 : b.bidAskPrice) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0;
                }), z(() => {
                  var b;
                  return H1.checked = ((b = e.orderToolsState) == null ? void 0 : b.orderPreviewLine) ?? !0;
                }), z(() => {
                  var b;
                  return Y1.checked = ((b = e.orderToolsState) == null ? void 0 : b.orderHistory) ?? !0;
                }), Ce;
              }
            });
          }
        }), null), z((Ce) => {
          const bt = l() ? "0 8px" : "0 10px", $t = p() ? "rotate(180deg)" : "rotate(0deg)";
          return bt !== Ce._v$8 && me.style.setProperty("padding", Ce._v$8 = bt), $t !== Ce._v$9 && Ve.style.setProperty("transform", Ce._v$9 = $t), Ce;
        }, {
          _v$8: void 0,
          _v$9: void 0
        }), k;
      ...
      const k = ee(() => !!K());
      return () => (k(), Ui.cloneNode(!0));
    })()), C(j, A(de, {
      get when() {
        return ee(() => !!e.chartViewToggle)() && !K();
      },
      get children() {
        const k = em.cloneNode(!0);
        return ut(k, "click", e.chartViewToggle.onToggle, !0), C(k, (() => {
          const me = ee(() => e.chartViewToggle.view === "chart");
          return () => me() ? im.cloneNode(!0) : am.cloneNode(!0);
        })()), z(() => Ie(k, "title", e.chartViewToggle.view === "chart" ? "View Depth" : "View Chart")), k;
      }
    }), null), C(M, A(de, {
      get when() {
        return he();
      ...
      const me = e.spread ? "" : "rotate", $e = K() ? "0px" : "var(--klinecharts-pro-period-bar-padding-right)";
      return me !== k._v$10 && Ie(Z, "class", k._v$10 = me), $e !== k._v$11 && j.style.setProperty("padding-right", k._v$11 = $e), k;
    }, {
      _v$10: void 0,
      _v$11: void 0
    }), M;
...
const tt = (e) => Tg[e.name](e.class), Ig = /* @__PURE__ */ $('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item magnet-mode" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Eg = /* @__PURE__ */ $('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Ri = /* @__PURE__ */ $('<li><span style="padding-left:8px"></span></li>'), Bg = "drawing_tools", Fg = (e) => {
  const [t, r] = D("horizontalStraightLine"), [n, l] = D("priceChannelLine"), [c, f] = D("circle"), [m, p] = D("fibonacciLine"), [L, x] = D("xabcd"), [w, R] = D("weak_magnet"), [Y, ye] = D("normal"), [V, S] = D(!1), [E, ne] = D(!0), [F, Q] = D(""), K = (H) => {
    Q((X) => X === H ? "" : H);
  }, ce = ee(() => [{
    key: "singleLine",
    icon: t(),
  ...
  return (() => {
    const H = Ig.cloneNode(!0), X = H.firstChild, ae = X.nextSibling, he = ae.firstChild, be = he.nextSibling, Le = be.firstChild, ue = ae.nextSibling, Pe = ue.firstChild, ve = ue.nextSibling, O = ve.firstChild, N = ve.nextSibling, U = N.nextSibling, q = U.firstChild;
    return C(H, () => ce().map((M) => (() => {
      const T = Eg.cloneNode(!0), W = T.firstChild, Z = W.nextSibling, j = Z.firstChild;
      return T.addEventListener("blur", () => {
        ...
        return () => oe() && A(An, {
          ...
          get children() {
            return M.list.map((k) => (() => {
              const me = Ri.cloneNode(!0), $e = me.firstChild;
              return me.$$click = (Ve) => {
                Ve.stopPropagation(), M.setter(k.key), e.onDrawingItemClick({
                  name: k.key,
                  lock: V(),
                  mode: Y()
                }), Q("");
      ...
      })(), null), z(() => Ie(j, "class", M.key === F() ? "rotate" : "")), T;
      ...
      return () => M() && A(An, {
        ...
        get children() {
          return G().map((T) => (() => {
            const W = Ri.cloneNode(!0), Z = W.firstChild;
            return W.$$click = (j) => {
              j.stopPropagation();
              const oe = Y() === T.key ? "normal" : T.key;
              R(T.key), ye(oe), e.onModeChange(oe), Q("");
            }, C(W, A(tt, {
              get name() {
                return T.key;
              },
              get class() {
                return Y() === T.key ? "selected" : "";
              }
            }), Z), C(Z, () => T.text), z(() => le(W, Y() === T.key ? "selected" : "")), W;
          })());
        }
      });
    })(), null), Pe.$$click = () => {
      ...
      name: "remove"
    })), z(() => Ie(Le, "class", F() === "mode" ? "rotate" : "")), H;
  })();
};
Ye(["click"]);
const Ki = /* @__PURE__ */ $('<li class="title"></li>'), ji = /* @__PURE__ */ $('<li class="row"></li>'), zg = (e) => A(St, {
  get title() {
...
const Ug = (e) => {
  const [t, r] = D(e.timezone), n = ee(() => F0(e.locale));
  return A(St, {
    get title() {
...
const Vg = /* @__PURE__ */ $('<div><button type="button"></button></div>'), Rg = /* @__PURE__ */ $('<div><div class="chart-style-color-grid"></div></div>'), Kg = /* @__PURE__ */ $('<button type="button" class="chart-style-palette-color"></button>'), jg = /* @__PURE__ */ $('<div class="chart-style-line-control"><div class="chart-style-width-picker"><button type="button" class="chart-style-size-button"><span></span></button></div></div>'), Qg = /* @__PURE__ */ $('<div class="chart-style-width-popover"></div>'), Zg = /* @__PURE__ */ $('<button type="button"><span></span></button>'), Hg = /* @__PURE__ */ $('<div class="klinecharts-pro-setting-modal-title-tabs"><button type="button"></button><button type="button">Chart Style</button></div>'), Wg = /* @__PURE__ */ $('<div class="klinecharts-pro-setting-modal-content"></div>'), Zi = /* @__PURE__ */ $('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), Yg = /* @__PURE__ */ $('<div class="klinecharts-pro-chart-style-content"><div class="chart-style-sidebar"><button type="button">Symbol</button><button type="button">Background</button></div><div class="chart-style-panel"><p class="chart-style-note">* Chart Style takes precedence over default chart settings. Click Reset to align with the default theme.</p></div></div>'), qg = /* @__PURE__ */ $("<h3>Symbol</h3>"), Gg = /* @__PURE__ */ $('<div class="chart-style-row"><span>Candle Stick</span><div class="chart-style-color-pair"></div></div>'), Xg = /* @__PURE__ */ $('<div class="chart-style-row"><span>Borders</span><div class="chart-style-color-pair"></div></div>'), Jg = /* @__PURE__ */ $('<div class="chart-style-row"><span>Wick</span><div class="chart-style-color-pair"></div></div>'), ey = /* @__PURE__ */ $("<h3>Background</h3>"), ty = /* @__PURE__ */ $('<div class="chart-style-row"><span>Color</span></div>'), ny = /* @__PURE__ */ $('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Vert Grid Lines</span></label></div>'), ry = /* @__PURE__ */ $('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Horz Grid Lines</span></label></div>'), B1 = "chart.backgroundColor", Tn = "#171a27", oy = ["#f6465d", "#f59e0b", "#fcd535", "#2ebd85", "#4098a8", "#22c1dc", "#3861fb", "#7b3fe4", "#ec8aa4", "#f7c56b", "#fff0a3", "#9ed4a4", "#83c7bb", "#8bdce6", "#8bb9f7", "#b7a1dc", "#c9343e", "#e76f20", "#f0b93a", "#3f8d3a", "#236e5a", "#237c88", "#1d3fbf", "#3a209f", "#ffffff", "#cbd5e1", "#9ca3af", "#6b7280", "#374151", "#111827", "#000000"], iy = [{
  ...
  return Fe(r, "candle.bar.upBorderColor", B.formatValue(r, "candle.bar.upBorderColor", n)), Fe(r, "candle.bar.downBorderColor", B.formatValue(r, "candle.bar.downBorderColor", l)), Fe(r, "candle.bar.noChangeBorderColor", B.formatValue(r, "candle.bar.noChangeBorderColor", c)), Fe(r, "candle.bar.upWickColor", B.formatValue(r, "candle.bar.upWickColor", n)), Fe(r, "candle.bar.downWickColor", B.formatValue(r, "candle.bar.downWickColor", l)), Fe(r, "candle.bar.noChangeWickColor", B.formatValue(r, "candle.bar.noChangeWickColor", c)), Fe(r, "candle.bar.borderUpColor", B.formatValue(r, "candle.bar.borderUpColor", B.formatValue(r, "candle.bar.upBorderColor"))), Fe(r, "candle.bar.borderDownColor", B.formatValue(r, "candle.bar.borderDownColor", B.formatValue(r, "candle.bar.downBorderColor"))), Fe(r, "candle.bar.borderNoChangeColor", B.formatValue(r, "candle.bar.borderNoChangeColor", B.formatValue(r, "candle.bar.noChangeBorderColor"))), Fe(r, "candle.bar.wickUpColor", B.formatValue(r, "candle.bar.wickUpColor", B.formatValue(r, "candle.bar.upWickColor"))), Fe(r, "candle.bar.wickDownColor", B.formatValue(r, "candle.bar.wickDownColor", B.formatValue(r, "candle.bar.downWickColor"))), Fe(r, "candle.bar.wickNoChangeColor", B.formatValue(r, "candle.bar.wickNoChangeColor", B.formatValue(r, "candle.bar.noChangeWickColor"))), Fe(r, B1, t), r;
}, sy = (e, t, r) => {
  if (t === B1)
    return r ?? Tn;
  const l = {
  ...
  return l ? B.formatValue(e, l) : B.formatValue(e, t, B.formatValue(z0(e), t));
}, ly = (e) => {
  const [t, r] = D(e.currentStyles), [n, l] = D(z0(e.currentStyles, e.currentBackgroundColor ?? Tn)), [c, f] = D(Qi(e.locale)), [m, p] = D(e.timezone), [L, x] = D(!1), [w, R] = D("settings"), [Y, ye] = D("symbol"), [V, S] = D(null), [E, ne] = D({}), [F, Q] = D(null), K = () => Intl.DateTimeFormat().resolvedOptions().timeZone, ce = () => {
    x(window.innerWidth <= 768);
  };
  Tr(() => {
    const O = (N) => {
      const U = N.target;
      U instanceof Element && (U.closest(".chart-style-color-picker") || U.closest(".chart-style-width-picker") || U.closest(".klinecharts-pro-select") || (S(null), Q(null)));
    };
    ce(), window.addEventListener("resize", ce), document.addEventListener("mousedown", O), pt(() => {
  ...
  const G = () => F0(e.locale), H = (O, N) => {
    const U = {};
    Fe(U, O.key, N);
    const q = B.clone(t());
    Fe(q, O.key, N), r(q), f(c().map((M) => ({
      ...M
    }))), e.onChange(U);
  }, X = (O, N) => B.formatValue(n(), O, N), ae = (O, N) => {
    const U = B.clone(n());
    Fe(U, O, N), l(U), e.onChange(he(U));
  }, he = (O) => {
    const N = B.formatValue(O, "candle.bar.upColor"), U = B.formatValue(O, "candle.bar.downColor"), q = B.formatValue(O, "candle.bar.noChangeColor"), M = B.formatValue(O, "candle.bar.upBorderColor", N), T = B.formatValue(O, "candle.bar.downBorderColor", U), W = B.formatValue(O, "candle.bar.noChangeBorderColor", q), Z = B.formatValue(O, "candle.bar.upWickColor", N), j = B.formatValue(O, "candle.bar.downWickColor", U), oe = B.formatValue(O, "candle.bar.noChangeWickColor", q);
    return {
      chart: {
        backgroundColor: B.formatValue(O, B1, Tn)
      },
      candle: {
        ...
        bar: {
          ...
          upBorderColor: M,
          downBorderColor: T,
          noChangeBorderColor: W,
          upWickColor: Z,
          downWickColor: j,
          noChangeWickColor: oe,
          borderUpColor: M,
          borderDownColor: T,
          borderNoChangeColor: W,
          wickUpColor: Z,
          wickDownColor: j,
    ...
    if (O) {
      const U = B.clone(n());
      Hi.forEach((q) => {
        Fe(U, q.key, sy(O, q.key, e.defaultBackgroundColor));
      }), l(U), r(B.clone(U)), e.onChange(he(U));
    } else
      e.onRestoreDefault(Hi), l(B.clone(e.currentStyles));
  }, ue = (O, N = O) => {
    const U = X(O, "#ffffff");
    return (() => {
      const q = Vg.cloneNode(!0), M = q.firstChild;
      return le(q, `chart-style-color-picker chart-style-color-picker-${N}`), M.$$click = (T) => {
        const W = V() === N ? null : N;
        if (W && L()) {
          const Z = T.currentTarget.closest(".klinecharts-pro-modal .inner"), j = Z == null ? void 0 : Z.getBoundingClientRect();
          if (j) {
            const k = T.currentTarget.getBoundingClientRect().bottom + 10;
            ne({
              position: "fixed",
              left: `${j.left + 16}px`,
              right: `${window.innerWidth - j.right + 16}px`,
              top: `${k}px`,
              width: "auto",
              "max-width": `${j.width - 16 * 2}px`,
          ...
          ne({});
        S(W);
      }, le(M, `chart-style-color-swatch chart-style-color-swatch-${N}`), M.style.setProperty("background", U), C(q, (() => {
        const T = ee(() => V() === N);
        return () => T() && (() => {
          const W = Rg.cloneNode(!0), Z = W.firstChild;
          return le(W, `chart-style-color-popover chart-style-color-popover-${N}`), C(Z, A(n1, {
            each: oy,
            children: (j) => (() => {
              const oe = Kg.cloneNode(!0);
              return oe.$$click = () => {
                ae(O, j), S(null);
              }, oe.style.setProperty("background", j), z(() => oe.classList.toggle("selected", j.toLowerCase() === U.toLowerCase())), oe;
            })()
          })), z((j) => Ct(W, E(), j)), W;
        })();
      })(), null), q;
    ...
    const N = `${O}.style`, U = `${O}.color`, q = `${O}.size`, M = X(N, Ke.Dashed), T = Math.max(1, Number(X(q, 1)));
    return (() => {
      const W = jg.cloneNode(!0), Z = W.firstChild, j = Z.firstChild, oe = j.firstChild;
      return C(W, A(pn, {
        get style() {
          return {
            width: L() ? "100%" : "134px"
        ...
        get value() {
          return M === Ke.Solid ? "Solid" : "Dashed";
        },
        dataSource: iy,
        onSelected: (k) => {
          const me = k.key;
          ae(N, me), ae(`${O}.dashedValue`, me === Ke.Solid ? [] : [2, 2]);
        }
      }), Z), j.$$click = () => {
        Q(F() === q ? null : q);
      }, oe.style.setProperty("height", `${T}px`), C(Z, (() => {
        const k = ee(() => F() === q);
        return () => k() && (() => {
          const me = Qg.cloneNode(!0);
          return C(me, A(n1, {
            each: ay,
            children: ($e) => (() => {
              const Ve = Zg.cloneNode(!0), Ce = Ve.firstChild;
              return Ve.$$click = () => {
                ae(q, $e), Q(null);
              }, Ve.classList.toggle("selected", T === $e), Ce.style.setProperty("height", `${$e}px`), Ve;
            })()
          })), me;
        })();
      })(), null), C(W, () => ue(U), null), W;
    })();
  }, ve = (() => {
    const O = Hg.cloneNode(!0), N = O.firstChild, U = N.nextSibling;
    return N.$$click = () => R("settings"), C(N, () => d("setting", e.locale)), U.$$click = () => R("chartStyle"), z((q) => {
      const M = w() === "settings", T = w() === "chartStyle";
      return M !== q._v$ && N.classList.toggle("active", q._v$ = M), T !== q._v$2 && U.classList.toggle("active", q._v$2 = T), q;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), O;
    ...
    get buttons() {
      return ee(() => w() === "settings")() ? [{
        ...
        onClick: () => {
          ...
          p(N), (U = e.onTimezoneChange) == null || U.call(e, N), e.onClose();
        }
      }] : [{
        type: "cancel",
    ...
    get children() {
      return ee(() => w() === "settings")() ? (() => {
        ...
        return C(O, A(n1, {
          ...
          children: (N) => {
            let U;
            const q = B.formatValue(t(), N.key);
            switch (N.component) {
              case "select": {
                const M = N.key === "candle.type" ? "170px" : "120px", T = `klinecharts-pro-setting-select klinecharts-pro-setting-select-${N.key.replace(/[^a-zA-Z0-9_-]/g, "-")}`, W = `klinecharts-pro-setting-dropdown klinecharts-pro-setting-dropdown-${N.key.replace(/[^a-zA-Z0-9_-]/g, "-")}`;
                U = A(pn, {
                  class: T,
                  dropdownClass: W,
                  get style() {
            ...
            return (() => {
              const M = Zi.cloneNode(!0), T = M.firstChild, W = T.nextSibling;
              return C(T, () => N.text), C(W, U), z(() => M.classList.toggle("mobile-item", !!L())), M;
            })();
          }
        }), null), C(O, (() => {
          const N = ee(() => !!e.timezone);
          return () => N() && (() => {
            const U = Zi.cloneNode(!0), q = U.firstChild, M = q.nextSibling;
            return C(q, () => d("timezone", e.locale)), C(M, A(pn, {
              ...
              onSelected: (T) => {
                var Z;
                const W = T;
                p(W), (Z = e.onTimezoneChange) == null || Z.call(e, W);
              }
            })), z(() => U.classList.toggle("mobile-item", !!L())), U;
          })();
        })(), null), z(() => O.classList.toggle("mobile-layout", !!L())), O;
      })() : (() => {
        const O = Yg.cloneNode(!0), N = O.firstChild, U = N.firstChild, q = U.nextSibling, M = N.nextSibling, T = M.firstChild;
        return U.$$click = () => ye("symbol"), q.$$click = () => ye("background"), C(M, (() => {
          const W = ee(() => Y() === "symbol");
          return () => W() ? [qg.cloneNode(!0), (() => {
            const Z = Gg.cloneNode(!0), j = Z.firstChild, oe = j.nextSibling;
            return C(oe, () => ue("candle.bar.upColor", "candle-stick-up"), null), C(oe, () => ue("candle.bar.downColor", "candle-stick-down"), null), Z;
          })(), (() => {
            const Z = Xg.cloneNode(!0), j = Z.firstChild, oe = j.nextSibling;
            return C(oe, () => ue("candle.bar.upBorderColor", "border-up"), null), C(oe, () => ue("candle.bar.downBorderColor", "border-down"), null), Z;
          })(), (() => {
            const Z = Jg.cloneNode(!0), j = Z.firstChild, oe = j.nextSibling;
            return C(oe, () => ue("candle.bar.upWickColor", "wick-up"), null), C(oe, () => ue("candle.bar.downWickColor", "wick-down"), null), Z;
          })()] : [ey.cloneNode(!0), (() => {
            const Z = ty.cloneNode(!0);
            return Z.firstChild, C(Z, () => ue(B1, "chart-background"), null), Z;
          })(), (() => {
            const Z = ny.cloneNode(!0), j = Z.firstChild, oe = j.firstChild;
            return oe.addEventListener("change", (k) => ae("grid.vertical.show", k.currentTarget.checked)), C(Z, () => Pe("grid.vertical"), null), z(() => oe.checked = !!X("grid.vertical.show")), Z;
          })(), (() => {
            const Z = ry.cloneNode(!0), j = Z.firstChild, oe = j.firstChild;
            return oe.addEventListener("change", (k) => ae("grid.horizontal.show", k.currentTarget.checked)), C(Z, () => Pe("grid.horizontal"), null), z(() => oe.checked = !!X("grid.horizontal.show")), Z;
          })()];
        })(), T), z((W) => {
          const Z = !!L(), j = Y() === "symbol", oe = Y() === "background";
          return Z !== W._v$3 && O.classList.toggle("mobile-layout", W._v$3 = Z), j !== W._v$4 && U.classList.toggle("active", W._v$4 = j), oe !== W._v$5 && q.classList.toggle("active", W._v$5 = oe), W;
        }, {
          _v$3: void 0,
          _v$4: void 0,
          _v$5: void 0
...
Ye(["click"]);
const cy = /* @__PURE__ */ $('<img style="width:500px;margin-top: 20px">'), uy = (e) => A(St, {
  get title() {
  ...
  const [t, r] = D(B.clone(e.params.calcParams)), n = (l) => dy[l];
  return A(St, {
    get title() {
  ...
  return A(St, {
    ...
    get children() {
      return [A(E0, {
        ...
        renderItem: (l) => (() => {
          const c = py.cloneNode(!0), f = c.firstChild, m = f.firstChild;
          return c.$$click = () => {
            ...
            get children() {
              const p = yy.cloneNode(!0);
              return z(() => Ie(p, "src", l.logo)), p;
            }
          }), m), C(m, () => l.shortName ?? l.ticker, null), C(m, () => `${l.name ? `(${l.name})` : ""}`, null), C(c, () => l.exchange ?? "", null), z(() => Ie(m, "title", l.name ?? "")), c;
        })()
      })];
    }
  });
...
const vy = /* @__PURE__ */ $('<div class="klinecharts-pro-mobile-more-modal-content"><div class="item"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="20" height="20" rx="4" ry="4" fill="none" stroke="currentColor" stroke-width="2"></rect><path d="m15.92 13.9-3.65-3.55a.773.773 0 0 1 0-1.12c.32-.33.79-.33 1.11 0l3.02 3.38c.31.32.31.81 0 1.13-.16.16-.48.16-.48.16Z" fill="currentColor" stroke="1"></path><path d="m12.43 14.23-.48-.17q-.48-.48 0-.96l4.13-4.36c.31-.32.63-.32.95 0s.32.65 0 .97l-4.13 4.35c-.15.17-.31.17-.47.17Zm-1.11-9.52c.31 0 1.11.16 1.11.97 0 .64-.95.48-1.27.48-1.43 0-1.91.81-2.07 1.45l-.31 1.94h1.58c.32 0 .64.32.64.64 0 .33-.32.65-.64.65H8.62l-1.11 4.99c-.16 1.46-1.11 1.46-1.59 0L7.03 11H5.6c-.31 0-.63-.32-.63-.65 0-.64.32-.8.63-.8h1.75l.48-2.1c.31-2.74 2.69-2.9 3.49-2.74Z" fill="noncurrentColore" stroke="1"></path></svg><span></span></div><div class="item"><svg width="20" height="20" viewBox="0 0 20 20"><path d="M18.5446,9.09091C18.3333,6.61616,17.2887,4.31818,15.5751,2.63889C13.8498,0.94697,11.6197,0,9.28404,0C8.02817,0,6.81925,0.265151,5.66901,0.782828C5.65728,0.782828,5.65728,0.795454,5.64554,0.795454C5.6338,0.795454,5.6338,0.808081,5.62207,0.808081C4.53052,1.31313,3.55634,2.0202,2.71127,2.92929C1.85446,3.85101,1.18545,4.91162,0.715963,6.11111C0.246479,7.33586,0,8.64899,0,10C0,10.8712,0.105634,11.7172,0.305164,12.5379C0.305164,12.5631,0.316901,12.5884,0.328638,12.6136C0.739437,14.2298,1.51408,15.7197,2.62911,16.9571C4.07277,18.548,5.92723,19.5581,7.93427,19.8737C7.95775,19.8737,7.96948,19.8864,7.99296,19.8864C8.3216,19.9369,8.66197,19.9747,9.00235,19.9747L9.21362,19.9747C9.61268,19.9747,10.3756,19.9369,11.0094,19.697C11.1737,19.6338,11.3028,19.5076,11.3732,19.3434C11.4437,19.1793,11.4554,18.9899,11.3967,18.8131C11.3028,18.5354,11.0563,18.346,10.7864,18.346C10.716,18.346,10.6338,18.3586,10.5634,18.3838C10.0939,18.5606,9.46009,18.5859,9.20188,18.5859L9.09624,18.5859C9.20188,18.2702,9.23709,17.9167,9.15493,17.5505C9.00235,16.8939,8.50939,16.3384,7.58216,15.7955L7.19484,15.5682C6.57277,15.2146,6.23239,15.0253,6.03286,14.7348C5.83333,14.4444,5.69249,13.9899,5.51643,12.9798C5.38732,12.298,5.04695,11.7677,4.50704,11.4646C4.14319,11.2626,3.70892,11.149,3.19249,11.149C2.82864,11.149,2.42958,11.1995,2.00704,11.3005C1.79578,11.351,1.59624,11.4141,1.42019,11.4646C1.33803,10.9848,1.30282,10.4798,1.30282,9.97475C1.30282,6.93182,2.76995,4.26768,4.98826,2.72727C5,3.00505,5.05869,3.29545,5.17606,3.57323C5.48122,4.26768,6.10329,4.7096,7.01878,4.89899C7.06573,4.91162,7.10094,4.91162,7.13615,4.91162L7.1831,4.91162C7.26526,4.91162,7.57042,4.92424,7.88732,5.0505C8.3216,5.2399,8.56808,5.55555,8.65023,6.04798C8.84977,7.61364,9.07277,10.4293,8.79108,11.3384C8.76761,11.4141,8.75587,11.4899,8.75587,11.5657C8.75587,11.9444,9.0493,12.2601,9.40141,12.2601C9.57747,12.2601,9.74179,12.1843,9.85915,12.0581C9.97653,11.9318,12.6174,9.05303,13.3216,8.09343C13.4038,7.97979,13.4859,7.87878,13.5798,7.76515C13.9202,7.33586,14.2723,6.90656,14.4014,6.26262C14.554,5.56818,14.4014,4.79798,13.9437,3.85101C13.615,3.16919,13.5563,2.86616,13.5446,2.75252C13.5563,2.7399,13.5798,2.72727,13.6033,2.71464C15.6221,4.10353,17.0188,6.43939,17.2535,9.19192C17.2887,9.55808,17.5587,9.82323,17.8991,9.82323L17.9577,9.82323C18.3099,9.8106,18.5681,9.48232,18.5446,9.09091ZM3.19249,12.5631C3.48592,12.5631,3.72066,12.6136,3.89671,12.7146C4.08451,12.8283,4.19014,12.9924,4.23709,13.2702C4.43662,14.3434,4.61268,15.0631,5,15.6061C5.37559,16.1364,5.85681,16.4015,6.58451,16.8182L6.60798,16.8308C6.71362,16.8939,6.84272,16.9571,6.96009,17.0328C7.69953,17.4621,7.86385,17.7525,7.89906,17.8914C7.93427,18.0303,7.85211,18.2323,7.74648,18.4343C4.91784,17.8535,2.65258,15.6944,1.73709,12.8283C2.15962,12.702,2.71127,12.5631,3.19249,12.5631ZM12.7934,4.5202C13.4272,5.83333,13.1455,6.18687,12.5822,6.89394C12.4883,7.00758,12.3944,7.12121,12.3005,7.24747C11.9484,7.72727,11.0211,8.77525,10.2113,9.68434C10.2113,9.24242,10.1878,8.73737,10.1526,8.19444C10.0704,6.95707,9.92958,5.90909,9.92958,5.87121L9.92958,5.83333C9.75352,4.83586,9.20188,4.11616,8.3216,3.76263C7.82864,3.56061,7.37089,3.53535,7.19484,3.53535C6.73709,3.43434,6.4554,3.24495,6.33803,2.99242C6.19718,2.68939,6.29108,2.24747,6.38498,1.9697C7.28873,1.59091,8.26291,1.37626,9.28404,1.37626C10.3873,1.37626,11.4437,1.61616,12.4061,2.04545C12.3357,2.18434,12.277,2.34848,12.2535,2.5505C12.2066,3.04293,12.3709,3.64899,12.7934,4.5202Z"></path></svg><span></span></div><div class="item"><svg viewBox="0 0 20 20"><rect x="3" y="4" width="14" height="14" rx="2" fill="none" stroke="currentColor" stroke-width="1.8"></rect><path d="M6 2.5v4M14 2.5v4M3 8h14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path><path d="M10 11v3l2.2 1.3" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path></svg><span>Time Tools</span></div><div class="item"><svg viewBox="0 0 20 20"><path d="M19.7361,12.542L18.1916,11.2919C18.2647,10.8678,18.3025,10.4347,18.3025,10.0017C18.3025,9.56861,18.2647,9.13555,18.1916,8.71142L19.7361,7.46135C19.9743,7.26938,20.0615,6.95686,19.9554,6.6756L19.9342,6.61756C19.5074,5.49026,18.8755,4.45449,18.0549,3.53926L18.0124,3.49238C17.8096,3.26692,17.4819,3.1821,17.1848,3.28032L15.2677,3.92544C14.5603,3.3763,13.7704,2.94324,12.9168,2.63966L12.5466,0.742229C12.49,0.449802,12.2472,0.222111,11.9383,0.168536L11.8746,0.157375C10.6461,-0.0524583,9.35391,-0.0524583,8.1254,0.157375L8.06174,0.168536C7.75284,0.222111,7.50997,0.449802,7.45338,0.742229L7.08082,2.64859C6.2343,2.95217,5.44909,3.383,4.74641,3.92991L2.81522,3.28032C2.52047,3.1821,2.19036,3.26469,1.98757,3.49238L1.94513,3.53926C1.12455,4.45672,0.492609,5.49249,0.0658141,6.61756L0.0445921,6.6756C-0.0615171,6.95463,0.0257283,7.26715,0.263885,7.46135L1.82723,8.72482C1.75413,9.14448,1.71876,9.57308,1.71876,9.99944C1.71876,10.428,1.75413,10.8566,1.82723,11.2741L0.263885,12.5375C0.025729,12.7295,-0.0615164,13.042,0.0445929,13.3233L0.0658148,13.3813C0.49261,14.5064,1.12455,15.5444,1.94513,16.4596L1.98757,16.5065C2.19036,16.732,2.51812,16.8168,2.81522,16.7186L4.74641,16.069C5.44909,16.6159,6.2343,17.0489,7.08082,17.3503L7.45338,19.2567C7.50997,19.5491,7.75284,19.7768,8.06174,19.8303L8.1254,19.8415C8.74084,19.9464,9.37042,20,10,20C10.6296,20,11.2615,19.9464,11.8746,19.8415L11.9383,19.8303C12.2472,19.7768,12.49,19.5491,12.5466,19.2567L12.9168,17.3592C13.7704,17.0556,14.5603,16.6248,15.2677,16.0734L17.1848,16.7186C17.4795,16.8168,17.8096,16.7342,18.0124,16.5065L18.0549,16.4596C18.8755,15.5422,19.5074,14.5064,19.9342,13.3813L19.9554,13.3233C20.0615,13.0487,19.9743,12.7362,19.7361,12.542ZM16.5175,8.97483C16.5764,9.3119,16.6071,9.65791,16.6071,10.0039C16.6071,10.3499,16.5764,10.6959,16.5175,11.033L16.3618,11.9281L18.1233,13.3545C17.8568,13.9372,17.5196,14.4863,17.1188,14.9975L14.9305,14.2631L14.1901,14.839C13.6266,15.2765,12.9994,15.6203,12.3203,15.8614L11.4219,16.1806L10.9998,18.3459C10.3372,18.4173,9.66045,18.4173,8.9955,18.3459L8.57342,16.1761L7.6821,15.8524C7.01008,15.6114,6.38521,15.2676,5.82637,14.8323L5.08596,14.2541L2.88361,14.9953C2.48275,14.4841,2.14791,13.9327,1.8791,13.3523L3.65938,11.9125L3.50611,11.0196C3.44952,10.687,3.41887,10.3432,3.41887,10.0039C3.41887,9.66237,3.44716,9.32083,3.50611,8.98822L3.65938,8.09531L1.8791,6.6555C2.14556,6.07288,2.48275,5.52374,2.88361,5.01255L5.08596,5.75367L5.82637,5.17551C6.38521,4.74022,7.01008,4.39645,7.6821,4.15536L8.57578,3.83615L8.99786,1.66638C9.66045,1.59495,10.3372,1.59495,11.0021,1.66638L11.4242,3.83168L12.3226,4.1509C12.9994,4.39198,13.6289,4.73575,14.1925,5.17328L14.9329,5.7492L17.1211,5.01479C17.522,5.52598,17.8568,6.07734,18.1256,6.65773L16.3642,8.08416L16.5175,8.97483ZM10.0024,5.85189C7.7104,5.85189,5.85231,7.61092,5.85231,9.78068C5.85231,11.9504,7.7104,13.7095,10.0024,13.7095C12.2943,13.7095,14.1524,11.9504,14.1524,9.78068C14.1524,7.61092,12.2943,5.85189,10.0024,5.85189ZM11.8699,11.5486C11.37,12.0196,10.7074,12.2808,10.0024,12.2808C9.29732,12.2808,8.63473,12.0196,8.13483,11.5486C7.6373,11.0754,7.36142,10.4481,7.36142,9.78068C7.36142,9.11323,7.6373,8.48596,8.13483,8.01272C8.63473,7.53948,9.29732,7.28054,10.0024,7.28054C10.7074,7.28054,11.37,7.53948,11.8699,8.01272C12.3674,8.48596,12.6433,9.11323,12.6433,9.78068C12.6433,10.4481,12.3674,11.0754,11.8699,11.5486Z"></path></svg><span></span></div></div>'), by = (e) => A(St, {
  ...
  get children() {
    const t = vy.cloneNode(!0), r = t.firstChild, n = r.firstChild, l = n.nextSibling, c = r.nextSibling, f = c.firstChild, m = f.nextSibling, p = c.nextSibling, L = p.nextSibling, x = L.firstChild, w = x.nextSibling;
    return r.$$click = () => {
...
const $y = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-picker"></div>'), _y = /* @__PURE__ */ $('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), ky = /* @__PURE__ */ $("<span></span>"), xy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), Ly = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-grid"></div>'), wy = /* @__PURE__ */ $('<span class="weekday"></span>'), zt = /* @__PURE__ */ $('<button type="button"></button>'), Ay = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid"></div>'), Ty = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), Sy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), My = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-content"></div>'), Py = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-tabs"></div>'), Dy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), Ny = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), Oy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), Iy = [{
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], Ey = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], Wi = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], t1 = (e) => String(e).padStart(2, "0"), Yi = (e, t, r) => Math.min(r, new Date(e, t + 1, 0).getDate()), ur = (e) => {
  const t = new Date(e);
  return {
    year: t.getFullYear(),
    month: t.getMonth(),
...
}, hn = (e) => new Date(e.year, e.month, e.day, e.hour, e.minute, 0, 0).getTime(), dr = (e) => e.year * 1e4 + (e.month + 1) * 100 + e.day, Lr = (e) => {
  ...
  const [t, r] = D(!0), [n, l] = D("date"), [c, f] = D(e.value.year), [m, p] = D(e.value.month), L = ee(() => By(c(), m())), x = ee(() => Math.floor(c() / 10) * 10), w = ee(() => Array.from({
    length: 12
  }, (G, H) => x() - 1 + H)), R = ee(() => e.value.hour % 12 || 12), Y = ee(() => e.value.hour >= 12 ? "PM" : "AM"), ye = Array.from({
    length: 12
  }, (G, H) => H + 1), V = Array.from({
    length: 60
  }, (G, H) => H), S = (G) => {
    const H = new Date(c(), m() + G, 1);
    ...
    e.onChange({
      ...
      month: G.getMonth(),
      day: G.getDate()
    }), (H = e.onDateSelect) == null || H.call(e), f(G.getFullYear()), p(G.getMonth());
  }, F = (G) => {
    p(G), e.onChange({
      ...e.value,
      year: c(),
      month: G,
      day: Yi(c(), G, e.value.day)
    }), l("date");
  }, Q = (G) => {
    f(G), e.onChange({
      ...e.value,
      year: G,
      day: Yi(G, e.value.month, e.value.day)
    }), l("month");
  }, K = (G) => {
    const H = Y() === "PM";
    e.onChange({
      ...e.value,
      hour: H ? G === 12 ? 12 : G + 12 : G === 12 ? 0 : G
    });
  }, ce = (G) => {
    const H = R();
    e.onChange({
      ...e.value,
      hour: G === "PM" ? H === 12 ? 12 : H + 12 : H === 12 ? 0 : H
    });
  };
  return (() => {
    ...
    return C(G, (() => {
      ...
      return () => H() && (() => {
        const X = _y.cloneNode(!0), ae = X.firstChild, he = ae.firstChild;
        return C(X, (() => {
          const be = ee(() => !!e.label);
          return () => be() && (() => {
            const Le = ky.cloneNode(!0);
            return C(Le, () => e.label), Le;
          })();
        })(), ae), ae.$$click = () => r(!t()), C(he, () => Lr(e.value)), X;
      })();
    })(), null), C(G, (() => {
      const H = ee(() => !!t());
      return () => H() && (() => {
        const X = xy.cloneNode(!0), ae = X.firstChild, he = ae.firstChild, be = he.nextSibling, Le = be.nextSibling, ue = Le.nextSibling, Pe = ue.nextSibling;
        return he.$$click = () => {
          ...
          const ve = ee(() => n() === "date");
          return () => ve() && (() => {
            const O = Ly.cloneNode(!0);
            return C(O, () => Ey.map((N) => (() => {
              const U = wy.cloneNode(!0);
              return C(U, N), U;
            })()), null), C(O, () => L().map(({
              date: N,
              current: U
              ...
              const q = dr({
                ...
                month: N.getMonth(),
                day: N.getDate()
              }), M = e.range ? dr(e.range.from) : NaN, T = e.range ? dr(e.range.to) : NaN, W = Math.min(M, T), Z = Math.max(M, T), j = Number.isFinite(W) && q >= W && q <= Z, oe = Number.isFinite(W) && (q === W || q === Z), k = N.getFullYear() === e.value.year && N.getMonth() === e.value.month && N.getDate() === e.value.day;
              return (() => {
                const me = zt.cloneNode(!0);
                return me.$$click = () => ne(N), le(me, `${U ? "" : "muted"} ${j ? "in-range" : ""} ${oe || k ? "selected" : ""}`), C(me, () => N.getDate()), me;
              })();
            }), null), O;
          })();
        })(), null), C(X, (() => {
          const ve = ee(() => n() === "month");
          return () => ve() && (() => {
            const O = Ay.cloneNode(!0);
            return C(O, () => Wi.map((N, U) => (() => {
              const q = zt.cloneNode(!0);
              return q.$$click = () => F(U), C(q, N), z(() => le(q, U === e.value.month && c() === e.value.year ? "selected" : "")), q;
            })())), O;
          })();
        })(), null), C(X, (() => {
          const ve = ee(() => n() === "year");
          return () => ve() && (() => {
            ...
            return C(O, () => w().map((N) => (() => {
              const U = zt.cloneNode(!0);
              return U.$$click = () => Q(N), C(U, N), z(() => le(U, `${N < x() || N > x() + 9 ? "muted" : ""} ${N === e.value.year ? "selected" : ""}`)), U;
            })())), O;
          })();
        })(), null), C(X, (() => {
          const ve = ee(() => n() === "date");
          return () => ve() && (() => {
            const O = Sy.cloneNode(!0), N = O.firstChild, U = N.nextSibling, q = U.nextSibling;
            return C(N, () => ye.map((M) => (() => {
              const T = zt.cloneNode(!0);
              return T.$$click = () => K(M), C(T, () => t1(M)), z(() => le(T, M === R() ? "selected" : "")), T;
            })())), C(U, () => V.map((M) => (() => {
              const T = zt.cloneNode(!0);
              return T.$$click = () => e.onChange({
                ...e.value,
                minute: M
              }), C(T, () => t1(M)), z(() => le(T, M === e.value.minute ? "selected" : "")), T;
            })())), C(q, () => ["AM", "PM"].map((M) => (() => {
              const T = zt.cloneNode(!0);
              return T.$$click = () => ce(M), C(T, M), z(() => le(T, M === Y() ? "selected" : "")), T;
            })())), O;
          })();
        })(), null), X;
      })();
  ...
  const [t, r] = D(e.initialTab ?? "goToDate"), [n, l] = D(ur(e.initialTimestamp)), [c, f] = D(ur(e.initialRange.from)), [m, p] = D(ur(e.initialRange.to)), [L, x] = D("from"), [w, R] = D({
    ...e.anchorSettings,
    ...
    if (V === "goToDate")
      ...
      e.onTimeAnchorChange({
        ...S,
        timestamp: S.anchorPoint === "date" ? hn(n()) : S.timestamp
      });
    }
    e.onClose();
  };
  return A(St, {
    ...
    get title() {
      return (() => {
        ...
        return C(V, () => Iy.map((S) => (() => {
          const E = zt.cloneNode(!0);
          return E.$$click = () => r(S.key), C(E, () => S.label), z(() => le(E, t() === S.key ? "active" : "")), E;
        })())), V;
      })();
    },
    get buttons() {
    ...
    get children() {
      ...
      return C(V, (() => {
        ...
        return () => S() && (() => {
          const E = Dy.cloneNode(!0), ne = E.firstChild, F = ne.firstChild, Q = F.nextSibling, K = Q.nextSibling;
          return F.$$click = () => x("from"), C(F, () => Lr(c())), K.$$click = () => x("to"), C(K, () => Lr(m())), C(E, (() => {
            const ce = ee(() => L() === "from");
            return () => ce() ? A(fn, {
              label: "Start",
              get value() {
            ...
            const G = L() === "from" ? "active" : "", H = L() === "to" ? "active" : "";
            return G !== ce._v$ && le(F, ce._v$ = G), H !== ce._v$2 && le(K, ce._v$2 = H), ce;
          }, {
            _v$: void 0,
            _v$2: void 0
          }), E;
        ...
        return () => S() && (() => {
          const E = Ny.cloneNode(!0), ne = E.firstChild, F = ne.firstChild, Q = F.nextSibling, K = ne.nextSibling, ce = K.firstChild, G = ce.nextSibling, H = K.nextSibling, X = H.firstChild, ae = X.nextSibling, he = H.nextSibling, be = he.firstChild, Le = be.nextSibling;
          return Q.$$click = () => Y({
            enabled: !w().enabled
          }), G.addEventListener("change", (ue) => Y({
            anchorPoint: ue.currentTarget.value
          })), C(E, (() => {
            const ue = ee(() => !!(w().enabled && w().anchorPoint === "date"));
            return () => ue() && (() => {
              const Pe = Oy.cloneNode(!0);
              return C(Pe, A(fn, {
                label: "Anchor date",
                get value() {
                  return n();
            ...
            const Pe = `klinecharts-pro-time-tools-switch${w().enabled ? " on" : ""}`, ve = `klinecharts-pro-time-tools-row${w().enabled ? "" : " disabled"}`, O = !w().enabled, N = `klinecharts-pro-time-tools-row with-divider${w().enabled ? "" : " disabled"}`, U = `klinecharts-pro-time-tools-switch${w().anchorLine ? " on" : ""}`, q = !w().enabled, M = `klinecharts-pro-time-tools-row with-divider${w().enabled ? "" : " disabled"}`, T = `klinecharts-pro-time-tools-switch${w().acrossTokens ? " on" : ""}`, W = !w().enabled;
            return Pe !== ue._v$3 && le(Q, ue._v$3 = Pe), ve !== ue._v$4 && le(K, ue._v$4 = ve), O !== ue._v$5 && (G.disabled = ue._v$5 = O), N !== ue._v$6 && le(H, ue._v$6 = N), U !== ue._v$7 && le(ae, ue._v$7 = U), q !== ue._v$8 && (ae.disabled = ue._v$8 = q), M !== ue._v$9 && le(he, ue._v$9 = M), T !== ue._v$10 && le(Le, ue._v$10 = T), W !== ue._v$11 && (Le.disabled = ue._v$11 = W), ue;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
function Ry({
  ...
  const c = [];
  e.forEach((w) => {
    const R = Cn(w.high), Y = Cn(w.low);
    R != null && c.push(R), Y != null && c.push(Y);
  }), t.forEach((w) => {
    Sn(w, c);
  }), r.forEach((w) => {
    Sn(w, c);
  ...
  if (c.forEach((w) => {
    ...
    return null;
  const L = Math.min(Math.max(l, 0), 0.25), x = Vy(m, p, L);
  return {
    minPrice: m - x,
    maxPrice: p + x
  };
}
const Ky = (e = !0) => e !== !1, jy = /* @__PURE__ */ $('<i class="icon-close klinecharts-pro-load-icon"></i>'), Qy = /* @__PURE__ */ $('<div class="klinecharts-pro-content"><button type="button">auto</button><div class="klinecharts-pro-widget"></div></div>'), Zy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-anchor-line"></div>'), Hy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-navigation-tooltip"></div>'), Wy = /* @__PURE__ */ $('<div class="klinecharts-pro-mobile-candle-tooltip"></div>'), Yy = /* @__PURE__ */ $('<div class="klinecharts-pro-mobile-candle-tooltip-row"><span class="label"></span><span class="value"></span></div>'), qy = /* @__PURE__ */ $('<div class="klinecharts-pro-countdown-price-mark"><span class="klinecharts-pro-countdown-price-mark-price"></span><span class="klinecharts-pro-countdown-price-mark-timer"></span></div>'), Gy = /* @__PURE__ */ $('<div class="overlay-toolbar-color-popover"><div class="overlay-toolbar-color-grid"></div><div class="overlay-toolbar-color-footer"><button type="button" class="overlay-toolbar-add-color">+</button><div class="overlay-toolbar-color-slider"><span></span></div></div></div>'), Xy = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown width-menu"></div>'), Jy = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown style-menu"><button type="button"><span class="overlay-toolbar-style-sample solid"></span></button><button type="button"><span class="overlay-toolbar-style-sample dashed"></span></button><button type="button"><span class="overlay-toolbar-style-sample dotted"></span></button></div>'), ep = /* @__PURE__ */ $('<div class="klinecharts-pro-overlay-toolbar"><button type="button" class="overlay-toolbar-icon drag" title="Move"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="6" r="1.5"></circle><circle cx="15" cy="6" r="1.5"></circle><circle cx="9" cy="12" r="1.5"></circle><circle cx="15" cy="12" r="1.5"></circle><circle cx="9" cy="18" r="1.5"></circle><circle cx="15" cy="18" r="1.5"></circle></svg></button><button type="button" class="overlay-toolbar-icon refresh" title="Reset"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 0 1 15.4-6.36L21 8"></path><path d="M21 3v5h-5"></path><path d="M21 12a9 9 0 0 1-15.4 6.36L3 16"></path><path d="M3 21v-5h5"></path></svg></button><div class="overlay-toolbar-picker"><button type="button" title="Color"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line width"><span class="overlay-toolbar-line-preview"></span><span>px</span></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line style"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 12h16"></path></svg></button></div><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="5" width="14" height="14" rx="2"></rect><path d="M20 4 4 20"></path></svg></button><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="10" width="14" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></button><button type="button" class="overlay-toolbar-icon delete" title="Delete"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"></path><path d="M8 6V4h8v2"></path><path d="M19 6 18 20H6L5 6"></path><path d="M10 11v5"></path><path d="M14 11v5"></path></svg></button></div>'), tp = /* @__PURE__ */ $('<button type="button"></button>'), np = /* @__PURE__ */ $('<button type="button"><span class="overlay-toolbar-width-sample"></span></button>'), rp = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-marker"><button type="button" class="klinecharts-pro-quick-order-plus"></button></div>'), op = /* @__PURE__ */ $('<span class="klinecharts-pro-quick-order-plus-icon"></span>'), ip = /* @__PURE__ */ $('<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3" aria-hidden="true"><path d="M460-300h40v-160h160v-40H500v-160h-40v160H300v40h160v160ZM224.62-160q-27.62 0-46.12-18.5Q160-197 160-224.62v-510.76q0-27.62 18.5-46.12Q197-800 224.62-800h510.76q27.62 0 46.12 18.5Q800-763 800-735.38v510.76q0 27.62-18.5 46.12Q763-160 735.38-160H224.62Zm0-40h510.76q9.24 0 16.93-7.69 7.69-7.69 7.69-16.93v-510.76q0-9.24-7.69-16.93-7.69-7.69-16.93-7.69H224.62q-9.24 0-16.93 7.69-7.69 7.69-7.69 16.93v510.76q0 9.24 7.69 16.93 7.69 7.69 16.93 7.69ZM200-760v560-560Z"></path></svg>'), ap = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-menu-anchor"><div class="klinecharts-pro-quick-order-menu"><button type="button">Trade <!> @ <!> Limit</button><button type="button">Trade <!> @ <!> Stop</button><button type="button">Create new order...</button><button type="button">Copy Price (<!>)</button><button type="button">Draw horizontal line on </button></div></div>');
k4();
const hr = "klinecharts_pro_chart_style", fr = "klinecharts_pro_chart_background_color", wr = "klinecharts_pro_time_anchor_settings", e1 = "candle_pane", sp = 4, lp = /* @__PURE__ */ new Set(["rect", "circle", "straightLine", "rayLine", "segment", "arrow", "fibonacciLine", "fibonacciSegment", "fibonacciCircle", "fibonacciSpiral", "fibonacciSpeedResistanceFan", "gannBox", "priceLine", "horizontalRayLine", "horizontalSegment", "verticalRayLine", "verticalSegment"]), cp = 0.08, up = 80, qi = 2e-3, dp = /* @__PURE__ */ new Set(["horizontalRayLine", "horizontalSegment", "horizontalStraightLine", "orderLine", "priceLine"]);
function U0() {
  return {
    enabled: !1,
    timestamp: Date.now(),
...
function Gi(e) {
  try {
    if (!e.enabled || !e.acrossTokens) {
      window.localStorage.removeItem(wr);
      return;
    }
...
const mp = (e) => {
  var xo, Lo, wo, Ao, To, So, Mo, Po, Do, No, Oo, Io, Eo, Bo, Fo, zo, Uo, Vo, Ro, Ko, jo, Qo, Zo, Ho, Wo, Yo, qo, Go, Xo, Jo, ei;
  let t, r, n = null, l, c = null, f = null;
  const [m, p] = D(!1), [L, x] = D(e.theme), [w, R] = D(e.styles), [Y, ye] = D(e.locale), [V, S] = D(e.symbol), [E, ne] = D(e.period), F = () => {
    var o, i, a, s;
    return {
  ...
  }, [Q, K] = D(!1), [ce, G] = D([...e.mainIndicators]), [H, X] = D({}), [ae, he] = D(!1), [be, Le] = D({
    key: e.timezone,
  ...
  }, W = () => t ? getComputedStyle(t).getPropertyValue("--klinecharts-pro-chart-background-color").trim() || M() || T() : M() ?? T(), Z = (o) => {
    var a;
    ...
    return a;
  }, [oe, k] = D(""), [me, $e] = D(!1), [Ve, Ce] = D(Date.now()), [bt, $t] = D({
    from: Date.now() - 30 * 24 * 60 * 60 * 1e3,
    to: Date.now()
  }), [Rt, Kt] = D(hp() ?? U0()), [Mt, Fn] = D(e.drawingBarVisible), [h1, z1] = D(!1), [U1, jt] = D(!1), [zn, f1] = D(!1), Pt = ((xo = e.orderTools) == null ? void 0 : xo.quickOrder) ?? !0, [Ee, Un] = D({
    quickOrder: Pt,
    quickOrderFloatingWindow: ((Lo = e.orderTools) == null ? void 0 : Lo.quickOrderFloatingWindow) ?? Pt,
    quickOrderPlusButton: ((wo = e.orderTools) == null ? void 0 : wo.quickOrderPlusButton) ?? Pt,
    openOrders: ((Ao = e.orderTools) == null ? void 0 : Ao.openOrders) ?? !0,
    openOrdersExtendedPriceLine: ((To = e.orderTools) == null ? void 0 : To.openOrdersExtendedPriceLine) ?? !0,
    openOrdersDisplay: ((So = e.orderTools) == null ? void 0 : So.openOrdersDisplay) ?? "right",
    confirmAfterDrag: ((Mo = e.orderTools) == null ? void 0 : Mo.confirmAfterDrag) ?? !0,
    positions: ((Po = e.orderTools) == null ? void 0 : Po.positions) ?? !0,
    breakevenPrice: ((Do = e.orderTools) == null ? void 0 : Do.breakevenPrice) ?? !0,
    liquidationPrice: ((No = e.orderTools) == null ? void 0 : No.liquidationPrice) ?? !0,
    priceLine: ((Oo = e.orderTools) == null ? void 0 : Oo.priceLine) ?? !0,
    marketPriceLine: ((Io = e.orderTools) == null ? void 0 : Io.marketPriceLine) ?? !0,
    countDown: ((Eo = e.orderTools) == null ? void 0 : Eo.countDown) ?? !0,
    bidAskPrice: ((Bo = e.orderTools) == null ? void 0 : Bo.bidAskPrice) ?? !0,
    orderPreviewLine: ((Fo = e.orderTools) == null ? void 0 : Fo.orderPreviewLine) ?? !0,
    orderHistory: ((zo = e.orderTools) == null ? void 0 : zo.orderHistory) ?? !0
  }), [_t, Dt] = D(null), [Nt, nt] = D(!1), [m1, Xe] = D(!1), [g1, y1] = D(64), [Ot, kt] = D(null), [p1, C1] = D(null), [Vn, V1] = D("buy"), Rn = 6, [R1, Qt] = D(null), [v1, K1] = D(null), [b1, j1] = D(null), [Q1, It] = D(null), [Ze, He] = D(null), [qe, We] = D(null), Kn = ["#000000", "#2b3342", "#3f4653", "#565d69", "#6f7580", "#8a9099", "#a7acb3", "#c4c8ce", "#ffffff", "#ff4d67", "#ffa629", "#f7ed4a", "#2fc58d", "#4ab09c", "#52c4d3", "#3157f6", "#6a36b8", "#a644b9", "#d83972", "#f2a3a6", "#f5c879", "#f7ee97", "#a6d29f", "#7fc9b9", "#91d7df", "#8fb2ee", "#b09ad2", "#c89ccf", "#d987ab", "#e8757a", "#efb34f", "#efe36e", "#86c17d", "#66b7a8", "#68c4d0", "#5f91e4", "#8059c9", "#aa62c2", "#d34d83", "#b9353d", "#ea8527", "#e8c245", "#4b8c43", "#2f6f60", "#47919b", "#2646c6", "#56309c", "#892f95", "#a82563", "#8e2528", "#de5c1f", "#dc8527", "#255a22", "#164b34", "#225b63", "#15309b", "#442180", "#6b1f74", "#86154e"];
  let Zt = null;
  const [$1, _1] = D({
    visible: !1,
    indicatorName: "",
  ...
  let _e = /* @__PURE__ */ new Map(), k1 = /* @__PURE__ */ new Map(), lt, ft, Ht = null, xt;
  const [Je, Z1] = D(!0), [H1, W1] = D(null), [jn, Y1] = D(null);
  ...
  const I = (o, i, a) => {
    ...
    var s, u;
    const o = (u = (s = Ge()) == null ? void 0 : s.getExtremum) == null ? void 0 : u.call(s), i = Number(o == null ? void 0 : o.min), a = Number(o == null ? void 0 : o.max);
    ...
    const o = [], i = (u) => {
      ...
      dp.has(y) && ((h = u.points) == null || h.forEach((g) => {
    ...
    visibleCandles: q1(),
    visibleIndicators: V0(),
    visiblePriceLines: R0(),
    latestPrice: K0(),
    paddingPercent: cp
  }), Q0 = (o, i) => {
    const a = Math.max(Math.abs(i.maxPrice - i.minPrice), 1);
    return Math.abs(o.minPrice - i.minPrice) <= a * qi && Math.abs(o.maxPrice - i.maxPrice) <= a * qi;
  }, Vr = (o, i) => {
    var g, v, _, P;
    const a = Ge();
    ...
    a.setExtremum({
      ...
      realMax: h,
      realRange: h - y
    }), (_ = n.adjustPaneViewport) == null || _.call(n, !1, !0, !0, !0), i && ((P = a.setAutoCalcTickFlag) == null || P.call(a, !0)), Y1(o);
  }, Z0 = (o = !1) => {
    var a, s, u;
    if (!n || !Je())
      return;
    const i = j0();
    if (!i) {
      (s = (a = Ge()) == null ? void 0 : a.setAutoCalcTickFlag) == null || s.call(a, !0), (u = n.resize) == null || u.call(n), Ht = null;
      return;
    }
    !o && Ht && Q0(i, Ht) || (Vr(i, !0), Ht = i, rt());
  }, ke = (o = !1) => {
    !Je() || typeof window > "u" || (lt && window.clearTimeout(lt), lt = window.setTimeout(() => {
    ...
    var o, i;
    W1(null), Z1(!0), (i = (o = Ge()) == null ? void 0 : o.setAutoCalcTickFlag) == null || i.call(o, !0), ke(!0);
  }, Qn = () => {
    const o = Lt();
    o && (W1(o), Vr(o, !1)), Z1(!1);
  }, H0 = () => {
    ...
    var g;
    const o = (g = n == null ? void 0 : n.getDom) == null ? void 0 : g.call(n, e1, et.YAxis);
    ...
    document.addEventListener("mouseup", s), document.addEventListener("touchend", s), setTimeout(() => {
      ...
      if (u && !u.complete) {
        ...
        const h = _e.get(o);
        if (h) {
          const g = L1(h.type), v = ((y = h.points) == null ? void 0 : y.length) || 0;
      ...
      try {
        const a = `kline_drawings_${o}`, u = {
          drawings: i.map((y) => {
            ...
            const g = L1(y.type), v = ((_ = y.points) == null ? void 0 : _.length) || 0;
  ...
  const w1 = () => {
    ...
    }), _e.clear(), b.clear(), He(null), We(null), w1(), ke(!0);
  }, G0 = (o) => typeof o.name == "string" && lp.has(o.name), Zn = (o, i = !1) => {
    var v, _, P;
    if (!n)
      return null;
    const a = (v = n.getDom) == null ? void 0 : v.call(n, e1, et.Main), s = (_ = a == null ? void 0 : a.getBoundingClientRect) == null ? void 0 : _.call(a);
    ...
    }), _e.clear(), b.clear(), He(null), We(null), Bt.loadDrawings(o).forEach((a) => {
      var s;
      try {
        const u = qt({
          name: a.type,
    ...
    o && ((i = n == null ? void 0 : n.removeOverlay) == null || i.call(n, {
      id: o
    }), _e.delete(o), b.delete(o), C1(null));
  }, na = (o) => {
    var g, v;
    ...
    const y = (v = n.createOverlay) == null ? void 0 : v.call(n, {
      ...
      extendData: s,
      lock: !1,
      onPressedMoving: (_) => (jr(_.overlay), !1),
      onPressedMoveEnd: (_) => (jr(_.overlay), !1)
    }), h = typeof y == "string" ? y : null;
    h && (_e.delete(h), b.delete(h), C1(h));
  }, X1 = (o) => {
    var a;
    const i = Math.min(Math.max(((a = V()) == null ? void 0 : a.pricePrecision) ?? 2, 0), 8);
    ...
    const v = Math.min(Math.max(((P1 = V()) == null ? void 0 : P1.pricePrecision) ?? 2, 0), 8), _ = s.toLocaleString(void 0, {
      minimumFractionDigits: v,
      maximumFractionDigits: v
    }), P = (ti = n.getSize) == null ? void 0 : ti.call(n, "candle_pane", et.YAxis), te = P != null && P.width && Number.isFinite(P.width) ? Math.max(74, Math.floor(P.width) - 2) : 96, ie = gn(E()), se = o % ie, ge = se === 0 ? ie : ie - se, J = Number(a.close), we = Number(a.open), Ae = n.getStyles().candle.priceMark.last, Ne = Ae.text, re = Number(Ne.size) || 12, Te = Number(Ne.paddingTop) || 2, pe = Number(Ne.paddingBottom) || 2, Oe = Math.min(Number(Ne.paddingLeft) || 4, 3), Be = Math.min(Number(Ne.paddingRight) || 4, 3), ot = Math.max(34, re * 2 + Te + pe + 6), ct = Math.max(0, Math.min(y - ot / 2, g - ot));
    Qt({
      top: ct,
      width: Math.min(te, Math.max(62, _.length * (re * 0.56) + Oe + Be + 4)),
      priceText: _,
      text: fp(ge),
      ...
      if (Number.isFinite(o == null ? void 0 : o.pageX) ? y = o.pageX - i.left : Number.isFinite(o == null ? void 0 : o.x) && a && (y = a.left - i.left + o.x), Number.isFinite(o == null ? void 0 : o.pageY))
        ...
        try {
          const se = (te = n == null ? void 0 : n.convertToPixel) == null ? void 0 : te.call(n, [{
            ...
            paneId: "candle_pane",
            absolute: !0
          }), ge = Number((ie = se == null ? void 0 : se[0]) == null ? void 0 : ie.y);
    ...
    var g, v, _, P, te, ie, se, ge;
    const i = o == null ? void 0 : o.overlay;
    if (!(i != null && i.id) || i.name !== "horizontalStraightLine")
      return !1;
    const a = sa(o), s = Number((v = (g = i.styles) == null ? void 0 : g.line) == null ? void 0 : v.size) || 2, u = ((P = (_ = i.styles) == null ? void 0 : _.line) == null ? void 0 : P.style) ?? Ke.Solid, y = Array.isArray((ie = (te = i.styles) == null ? void 0 : te.line) == null ? void 0 : ie.dashedValue) ? i.styles.line.dashedValue : [], h = ((ge = (se = i.styles) == null ? void 0 : se.line) == null ? void 0 : ge.color) ?? "#2f6df6";
    return He({
      id: i.id,
      x: a.x,
      y: a.y,
    ...
    return (!i || ((s = Ze()) == null ? void 0 : s.id) === i) && (He(null), We(null)), !1;
  }, qt = (o) => {
    var h, g, v, _, P, te, ie, se, ge;
    ...
    return {
      ...
      styles: {
        ...
        line: {
          ...
          style: ((P = (_ = o.styles) == null ? void 0 : _.line) == null ? void 0 : P.style) ?? Ke.Solid,
          dashedValue: ((ie = (te = o.styles) == null ? void 0 : te.line) == null ? void 0 : ie.dashedValue) ?? [6, 4],
          color: ((ge = (se = o.styles) == null ? void 0 : se.line) == null ? void 0 : ge.color) ?? "#2f6df6"
        }
      },
      onClick: (J) => (Gn(J), (i == null ? void 0 : i(J)) ?? !1),
      onSelected: (J) => (Gn(J), (a == null ? void 0 : a(J)) ?? !1),
      onPressedMoveEnd: (J) => (Gn(J), (y == null ? void 0 : y(J)) ?? !1),
      onDeselected: (J) => (Zr(J), (s == null ? void 0 : s(J)) ?? !1),
      onRemoved: (J) => (Zr(J), (u == null ? void 0 : u(J)) ?? !1)
    };
  }, la = () => {
    var i;
    const o = Ze();
    ...
    if (!o)
      return;
    const i = 1, a = Ke.Solid, s = [6, 4], u = "#2f6df6";
    Gt({
      styles: {
        line: {
          size: i,
    ...
    const s = o.clientX, u = o.clientY, y = i.x, h = i.y, g = (te) => {
      te.preventDefault();
      const ie = y + te.clientX - s, se = h + te.clientY - u;
      He({
        ...i,
  ...
  let Wr = (Uo = e.orderTools) == null ? void 0 : Uo.quickOrder, Yr = (Vo = e.orderTools) == null ? void 0 : Vo.quickOrderFloatingWindow, qr = (Ro = e.orderTools) == null ? void 0 : Ro.quickOrderPlusButton, Gr = (Ko = e.orderTools) == null ? void 0 : Ko.openOrders, Xr = (jo = e.orderTools) == null ? void 0 : jo.openOrdersExtendedPriceLine, Jr = (Qo = e.orderTools) == null ? void 0 : Qo.openOrdersDisplay, eo = (Zo = e.orderTools) == null ? void 0 : Zo.confirmAfterDrag, to = (Ho = e.orderTools) == null ? void 0 : Ho.positions, no = (Wo = e.orderTools) == null ? void 0 : Wo.breakevenPrice, ro = (Yo = e.orderTools) == null ? void 0 : Yo.liquidationPrice, oo = (qo = e.orderTools) == null ? void 0 : qo.priceLine, io = (Go = e.orderTools) == null ? void 0 : Go.marketPriceLine, ao = (Xo = e.orderTools) == null ? void 0 : Xo.countDown, so = (Jo = e.orderTools) == null ? void 0 : Jo.bidAskPrice, lo = (ei = e.orderTools) == null ? void 0 : ei.orderHistory;
  je(() => {
    var we, Ae, Ne, re, Te, pe, Oe, Be, ot, ct, it, at, st, M1, P1;
    const o = (we = e.orderTools) == null ? void 0 : we.quickOrder, i = (Ae = e.orderTools) == null ? void 0 : Ae.quickOrderFloatingWindow, a = (Ne = e.orderTools) == null ? void 0 : Ne.quickOrderPlusButton, s = (re = e.orderTools) == null ? void 0 : re.openOrders, u = (Te = e.orderTools) == null ? void 0 : Te.openOrdersExtendedPriceLine, y = (pe = e.orderTools) == null ? void 0 : pe.openOrdersDisplay, h = (Oe = e.orderTools) == null ? void 0 : Oe.confirmAfterDrag, g = (Be = e.orderTools) == null ? void 0 : Be.positions, v = (ot = e.orderTools) == null ? void 0 : ot.breakevenPrice, _ = (ct = e.orderTools) == null ? void 0 : ct.liquidationPrice, P = (it = e.orderTools) == null ? void 0 : it.priceLine, te = (at = e.orderTools) == null ? void 0 : at.marketPriceLine, ie = (st = e.orderTools) == null ? void 0 : st.countDown, se = (M1 = e.orderTools) == null ? void 0 : M1.bidAskPrice, ge = (P1 = e.orderTools) == null ? void 0 : P1.orderHistory, J = {};
    typeof o == "boolean" && o !== Wr && (Wr = o, J.quickOrder = o, typeof i != "boolean" && (J.quickOrderFloatingWindow = o), typeof a != "boolean" && (J.quickOrderPlusButton = o)), typeof i == "boolean" && i !== Yr && (Yr = i, J.quickOrderFloatingWindow = i), typeof a == "boolean" && a !== qr && (qr = a, J.quickOrderPlusButton = a), typeof s == "boolean" && s !== Gr && (Gr = s, J.openOrders = s), typeof u == "boolean" && u !== Xr && (Xr = u, J.openOrdersExtendedPriceLine = u), y !== void 0 && y !== Jr && (Jr = y, J.openOrdersDisplay = y), typeof h == "boolean" && h !== eo && (eo = h, J.confirmAfterDrag = h), typeof g == "boolean" && g !== to && (to = g, J.positions = g), typeof v == "boolean" && v !== no && (no = v, J.breakevenPrice = v), typeof _ == "boolean" && _ !== ro && (ro = _, J.liquidationPrice = _), typeof P == "boolean" && P !== oo && (oo = P, J.priceLine = P, typeof te != "boolean" && (J.marketPriceLine = P), typeof ie != "boolean" && (J.countDown = P), typeof se != "boolean" && (J.bidAskPrice = P)), typeof te == "boolean" && te !== io && (io = te, J.marketPriceLine = te), typeof ie == "boolean" && ie !== ao && (ao = ie, J.countDown = ie), typeof se == "boolean" && se !== so && (so = se, J.bidAskPrice = se), typeof ge == "boolean" && ge !== lo && (lo = ge, J.orderHistory = ge), Object.keys(J).length > 0 && Wn(J);
  }), je(() => {
    Ee().marketPriceLine, Ee().countDown, E(), V(), n == null || n.setStyles({
      candle: {
        priceMark: {
          last: {
            show: !0,
    ...
    getSettings: () => {
      var a, s, u, y, h, g, v, _, P, te, ie, se, ge, J, we, Ae;
      if (!n)
        return {};
      ...
      return {
        ...
        showLowestPrice: (ie = (te = (P = o.candle) == null ? void 0 : P.priceMark) == null ? void 0 : te.low) == null ? void 0 : ie.show,
        // Indicator settings
        showIndicatorLastValue: (ge = (se = o.indicator) == null ? void 0 : se.lastValueMark) == null ? void 0 : ge.show,
    ...
    setSettings: (o) => {
      var a, s, u, y, h, g, v, _, P, te, ie, se, ge, J;
      if (!n)
        return;
      const i = {};
      ...
      o.showLastPrice !== void 0 && (i.candle = {
        ...
        priceMark: {
          ...
          low: {
            ...(ge = (se = i.candle) == null ? void 0 : se.priceMark) == null ? void 0 : ge.low,
    ...
    getAutoScaleEnabled: () => Je(),
    getCurrentPriceRange: () => jn() ?? Lt(),
  ...
  const co = () => {
    n == null || n.resize(), S1(), on() || T1(), ke(!0), rt(), go(), wt();
  };
  let J1, Jn = !1, en, tn, A1 = !1, uo = 0;
  const ya = () => {
    if (A1 || Date.now() < uo)
      return;
    const o = Rt();
    if (!o.enabled || o.anchorPoint === "date")
      return;
    const i = po(o.anchorPoint, o.timestamp);
    ...
    ke(), rt(), go(), wt(), pa();
  }, fo = [mt.OnVisibleRangeChange, mt.OnZoom, mt.OnScroll], Ca = (o) => {
    ...
    const i = va(o), a = i == null ? void 0 : i.candle, s = Number((a == null ? void 0 : a.timestamp) ?? o), u = Number((a == null ? void 0 : a.high) ?? (a == null ? void 0 : a.close) ?? (a == null ? void 0 : a.open)), y = i ? nn(i.dataIndex) : void 0, h = i && Number.isFinite(u) ? {
      ...
      paneId: "candle_pane",
      absolute: !0
    }), v = Number((se = g == null ? void 0 : g[0]) == null ? void 0 : se.x), _ = Number((ge = g == null ? void 0 : g[0]) == null ? void 0 : ge.y), P = t.clientWidth, te = t.clientHeight;
    ...
    const a = gn(E()), s = Math.max(1, Math.floor(i / 2)) * a;
    return {
      from: o - s,
      to: o + s
    };
    ...
    const u = (P = n.convertFromPixel) == null ? void 0 : P.call(n, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((te = u == null ? void 0 : u[0]) == null ? void 0 : te.dataIndex), h = Math.max(0, Math.min(s.length - 1, Number.isFinite(y) ? Math.round(y) : -1)), g = ba(i);
    if (g) {
      const J = nn(g.dataIndex), we = (ie = n.convertToPixel) == null ? void 0 : ie.call(n, [{
        dataIndex: J
      }], {
        paneId: "candle_pane",
        absolute: !0
      }), Ae = Number((se = we == null ? void 0 : we[0]) == null ? void 0 : se.x), Ne = n.getBarSpace, re = typeof Ne == "function" ? Ne.call(n) : void 0, Te = Number(typeof re == "object" ? re == null ? void 0 : re.bar : re), pe = Number.isFinite(Te) ? Math.max(2, Te / 2) : 8;
    ...
    if (!n || !Number.isFinite(o.timestamp))
      return;
    if (A1 = !0, uo = Date.now() + 1e3, o.anchorPoint === "date") {
      tr(o.timestamp), window.setTimeout(() => {
        A1 = !1;
      }, 1e3);
      return;
    }
    const i = yo(o.timestamp, "nearest"), a = nn(i), s = nr(o.anchorPoint);
    if (a < 0 || s === null) {
      tr(o.timestamp), window.setTimeout(() => {
        A1 = !1;
      }, 1e3);
    ...
    n.scrollToDataIndex(a, 0), requestAnimationFrame(() => {
      ...
      Number.isFinite(y) && (n == null || n.scrollByDistance(s - y, 0)), requestAnimationFrame(() => {
        wt(o), rn(o.timestamp), window.setTimeout(() => {
          A1 = !1;
        }, 1e3);
      });
    }), rt();
    ...
    if (i !== null)
      return i;
    const a = nn(yo(o.timestamp, "nearest")), s = a >= 0 ? {
      dataIndex: a
    } : {
    ...
    const a = Sa(i), s = (P = n.getDom) == null ? void 0 : P.call(n, "candle_pane", et.Main), u = (te = s == null ? void 0 : s.getBoundingClientRect) == null ? void 0 : te.call(s), y = (ie = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : ie.call(r), h = (se = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : se.call(t), g = n.getSize("candle_pane", et.Main), v = u && Number.isFinite(u.top) ? u.top - ((y == null ? void 0 : y.top) ?? (h == null ? void 0 : h.top) ?? 0) : 0, _ = Math.max(1, (u == null ? void 0 : u.height) ?? (g == null ? void 0 : g.height) ?? 0);
    if (a === null) {
      It(null);
      return;
    }
    ...
    if (n) {
      ...
      try {
        const a = E(), s = o.from <= o.to ? o : {
          from: o.to,
          to: o.from
        }, u = ka(s), y = i ? u : Aa(u, a), h = await e.datafeed.getHistoryKLineData(V(), a, y.from, y.to), g = xa(h, u);
        n.applyNewData(h, h.length > 0), ke(!0), $t(u), requestAnimationFrame(() => {
          const v = wa(h, u);
          i ? tr(i) : (Ta(g), n == null || n.scrollToDataIndex(v, 0), rn(La(g, u))), wt();
        });
      } finally {
        p(!1), jt(!1);
      }
    ...
    const a = {
      ...o,
      timestamp: (() => !n || o.anchorPoint === "date" ? o.timestamp : po(o.anchorPoint, o.timestamp))()
    };
    Kt(a), Gi(a), a.enabled ? (Ce(a.timestamp), requestAnimationFrame(() => {
      Co(a), wt(a);
    })) : requestAnimationFrame(() => wt(a));
  };
  Tr(() => {
    if (window.addEventListener("resize", co), n = Fa(t, {
      customApi: {
        formatDate: (h, g, v, _) => {
          switch (E().timespan) {
            case "minute":
              return _ === sn.XAxis ? B.formatDate(h, g, "HH:mm") : B.formatDate(h, g, "YYYY-MM-DD HH:mm");
            case "hour":
              return _ === sn.XAxis ? B.formatDate(h, g, "MM-DD HH:mm") : B.formatDate(h, g, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return B.formatDate(h, g, "YYYY-MM-DD");
            case "month":
              return _ === sn.XAxis ? B.formatDate(h, g, "YYYY-MM") : B.formatDate(h, g, "YYYY-MM-DD");
            case "year":
              return _ === sn.XAxis ? B.formatDate(h, g, "YYYY") : B.formatDate(h, g, "YYYY-MM-DD");
          }
      ...
      l = document.createElement("span"), l.className = "klinecharts-pro-price-unit", g == null || g.appendChild(l), xt = W0(), ke(!0);
    }
    let o = !1;
    const i = () => {
      const h = V();
    ...
    e.subIndicators.forEach((h) => {
      ...
      p(!0), (async () => {
        try {
          const v = E(), [_] = er(v, h, 1), [P] = er(v, _, 500), te = await e.datafeed.getHistoryKLineData(V(), v, P, _);
      ...
      if (h.indicatorName)
        switch (h.iconId) {
          case "visible": {
            ...
            De(h.indicatorName, h.paneId, g, "change");
            break;
          }
          case "invisible": {
            n == null || n.overrideIndicator({
          ...
          case "close":
            if (h.paneId === "candle_pane") {
              const g = [...ce()];
              n == null || n.removeIndicator("candle_pane", h.indicatorName), ke(!0), g.splice(g.indexOf(h.indicatorName), 1), G(g), De(h.indicatorName, "candle_pane", "main", "remove");
            } else {
              const g = {
                ...H()
              };
              n == null || n.removeIndicator(h.paneId, h.indicatorName), ke(!0), delete g[h.indicatorName], X(g), De(h.indicatorName, h.paneId, "sub", "remove");
            }
        }
    }), n == null || n.subscribeAction(mt.OnCrosshairChange, Qr), n == null || n.subscribeAction(mt.OnCrosshairChange, ko), fo.forEach((h) => {
      n == null || n.subscribeAction(h, ho);
    }), J1 = window.setInterval(() => rt(), 1e3), rt(), document.addEventListener("mousedown", Hr);
    const y = n == null ? void 0 : n.createOverlay;
    n && y && (n.createOverlay = function(...h) {
      var P;
      const g = qt(h[0]), v = y.apply(this, [g, ...h.slice(1)]), _ = typeof v == "string" ? v : null;
      return _ && !((P = g.extendData) != null && P.isOrderPreviewLine) && (Y0(_, g.name || "unknown"), Et(_), w1(), ke(!0)), v;
    });
  }), pt(() => {
    var o, i, a;
    if (window.removeEventListener("resize", co), n == null || n.unsubscribeAction(mt.OnCrosshairChange, Qr), n == null || n.unsubscribeAction(mt.OnCrosshairChange, ko), T1(), fo.forEach((s) => {
      n == null || n.unsubscribeAction(s, ho);
    }), J1 && (window.clearInterval(J1), J1 = void 0), en && (window.clearTimeout(en), en = void 0), lt && (window.clearTimeout(lt), lt = void 0), ft && (window.cancelAnimationFrame(ft), ft = void 0), xt == null || xt(), xt = void 0, document.removeEventListener("mousedown", Hr), f) {
      const s = f;
  ...
  const Da = (o) => {
    ...
    const {
      current: a
    } = o, s = i.tooltip.text.color, u = a.close > a.open ? i.bar.upColor : a.close < a.open ? i.bar.downColor : i.bar.noChangeColor, y = Math.min(Math.max(((v = V()) == null ? void 0 : v.pricePrecision) ?? 2, 0), 8), h = Math.min(Math.max(((_ = V()) == null ? void 0 : _.volumePrecision) ?? 0, 0), 8), g = (P) => ({
  ...
  }, on = () => typeof window < "u" && window.innerWidth < 768, $o = (o) => typeof o == "string" ? o : o.text, _o = (o) => typeof o == "string" ? void 0 : o.color, Na = (o) => o.map((i) => ({
    title: $o(i.title).replace(/:$/, "").replace(/^\w/, (a) => a.toUpperCase()),
    value: $o(i.value),
    titleColor: _o(i.title),
    valueColor: _o(i.value)
  })), T1 = () => {
    j1(null);
  }, Oa = () => {
    !on() || !b1() || (Jn = !0, T1());
    ...
    const y = an("--klinecharts-pro-mobile-candle-tooltip-width", 132), h = an("--klinecharts-pro-mobile-candle-tooltip-height", 124), g = an("--klinecharts-pro-mobile-candle-tooltip-offset-x", 10), v = an("--klinecharts-pro-mobile-candle-tooltip-offset-y", 10), _ = 8, P = Math.min(Math.max(i + g, _), Math.max(_, s - y - _)), te = Math.min(Math.max(a - h - v, _), Math.max(_, u - h - _)), ie = n.getStyles().candle, se = Na(bo({
      current: o.kLineData
    }, ie));
    j1({
      left: P,
  ...
  return je((o) => {
    ...
    return pt(() => {
      s = !1;
    }), o && e.datafeed.unsubscribe(o.symbol, o.period), p(!0), jt(!0), (async () => {
      try {
        const y = dt(Rt), h = y.enabled && (!o || o.symbol.ticker === i.ticker || y.acrossTokens), g = h ? _a(y, a) : null, [v, _] = g ? [g.from, g.to] : er(a, (/* @__PURE__ */ new Date()).getTime(), 500), P = await e.datafeed.getHistoryKLineData(i, a, v, _);
        if (!s)
          return;
    ...
    if (w()) {
      At(w()), n == null || n.setStyles(w()), O(H7(n.getStyles()));
      const o = N();
      if (o) {
        Z(o);
        const i = j(o);
        At(i), n == null || n.setStyles(i);
      }
      S1();
    }
  }), [jy.cloneNode(!0), A(sm, {
    ...
    onMenuClick: async () => {
      try {
        await us(() => Fn(!Mt())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    return o.addEventListener("mouseleave", () => {
      ...
      children: (s) => (() => {
        ...
        return C(u, A(n1, {
          ...
          children: (y) => (() => {
            const h = Yy.cloneNode(!0), g = h.firstChild, v = g.nextSibling;
            return C(g, () => y.title), C(v, () => y.value), z((_) => {
              const P = y.title.toLowerCase() === "time", te = y.titleColor ?? "var(--klinecharts-pro-text-second-color)", ie = y.valueColor ?? "var(--klinecharts-pro-text-color)";
              return P !== _._v$13 && h.classList.toggle("time", _._v$13 = P), te !== _._v$14 && g.style.setProperty("color", _._v$14 = te), ie !== _._v$15 && v.style.setProperty("color", _._v$15 = ie), _;
            }, {
              _v$13: void 0,
              _v$14: void 0,
              _v$15: void 0
      ...
      children: (s) => (() => {
        ...
        return u.style.setProperty("right", "0px"), C(y, () => s.priceText), C(h, () => s.text), z((g) => {
          const v = `${s.top}px`, _ = `${s.width}px`, P = s.color, te = `${s.borderRadius}px`, ie = s.textFamily, se = s.textWeight, ge = `${s.paddingLeft}px`, J = `${s.paddingRight}px`, we = `${s.paddingTop}px`, Ae = `${s.paddingBottom}px`, Ne = `${s.textSize}px`, re = `${Math.max(10, s.textSize - 1)}px`;
          return v !== g._v$16 && u.style.setProperty("top", g._v$16 = v), _ !== g._v$17 && u.style.setProperty("width", g._v$17 = _), P !== g._v$18 && u.style.setProperty("background", g._v$18 = P), te !== g._v$19 && u.style.setProperty("border-radius", g._v$19 = te), ie !== g._v$20 && u.style.setProperty("font-family", g._v$20 = ie), se !== g._v$21 && u.style.setProperty("font-weight", g._v$21 = se), ge !== g._v$22 && u.style.setProperty("padding-left", g._v$22 = ge), J !== g._v$23 && u.style.setProperty("padding-right", g._v$23 = J), we !== g._v$24 && u.style.setProperty("padding-top", g._v$24 = we), Ae !== g._v$25 && u.style.setProperty("padding-bottom", g._v$25 = Ae), Ne !== g._v$26 && y.style.setProperty("font-size", g._v$26 = Ne), re !== g._v$27 && h.style.setProperty("font-size", g._v$27 = re), g;
        }, {
          _v$16: void 0,
          _v$17: void 0,
          _v$18: void 0,
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = ep.cloneNode(!0), y = u.firstChild, h = y.nextSibling, g = h.nextSibling, v = g.firstChild, _ = g.nextSibling, P = _.firstChild, te = P.firstChild, ie = te.nextSibling, se = ie.firstChild, ge = _.nextSibling, J = ge.firstChild, we = ge.nextSibling, Ae = we.nextSibling, Ne = Ae.nextSibling;
        return u.$$click = (re) => {
          re.stopPropagation();
        }, u.$$mousedown = (re) => {
          re.preventDefault(), re.stopPropagation();
        }, y.$$mousedown = ma, h.$$click = ha, v.$$click = () => We(qe() === "color" ? null : "color"), C(g, A(de, {
          get when() {
            return qe() === "color";
          },
          get children() {
            const re = Gy.cloneNode(!0), Te = re.firstChild;
            return C(Te, A(n1, {
              each: Kn,
              children: (pe) => (() => {
                const Oe = tp.cloneNode(!0);
                return Oe.$$click = () => fa(pe), Oe.style.setProperty("background", pe), z(() => le(Oe, `overlay-toolbar-color-swatch ${s.color.toLowerCase() === pe.toLowerCase() ? "selected" : ""}`)), Oe;
              })()
            })), re;
          }
        }), null), P.$$click = () => We(qe() === "width" ? null : "width"), C(ie, () => s.lineSize, se), C(_, A(de, {
          get when() {
            return qe() === "width";
          },
          get children() {
            const re = Xy.cloneNode(!0);
            return C(re, A(n1, {
              each: [1, 2, 3, 4],
              children: (Te) => (() => {
                const pe = np.cloneNode(!0), Oe = pe.firstChild;
                return pe.$$click = () => da(Te), Oe.style.setProperty("height", `${Te}px`), z(() => le(pe, s.lineSize === Te ? "selected" : "")), pe;
              })()
            })), re;
          }
        }), null), J.$$click = () => We(qe() === "style" ? null : "style"), C(ge, A(de, {
          get when() {
            return qe() === "style";
          },
          get children() {
            const re = Jy.cloneNode(!0), Te = re.firstChild, pe = Te.nextSibling, Oe = pe.nextSibling;
            return Te.$$click = () => Xn(Ke.Solid, []), pe.$$click = () => Xn(Ke.Dashed, [6, 4]), Oe.$$click = () => Xn(Ke.Dashed, [2, 4]), z((Be) => {
              var at, st;
              const ot = s.lineStyle === Ke.Solid ? "selected" : "", ct = s.lineStyle === Ke.Dashed && ((at = s.dashedValue) == null ? void 0 : at[0]) === 6 ? "selected" : "", it = s.lineStyle === Ke.Dashed && ((st = s.dashedValue) == null ? void 0 : st[0]) === 2 ? "selected" : "";
              return ot !== Be._v$28 && le(Te, Be._v$28 = ot), ct !== Be._v$29 && le(pe, Be._v$29 = ct), it !== Be._v$30 && le(Oe, Be._v$30 = it), Be;
            }, {
              _v$28: void 0,
              _v$29: void 0,
              _v$30: void 0
        ...
        }), null), we.$$click = ua, Ae.$$click = ca, Ne.$$click = la, z((re) => {
          const Te = `${s.x}px`, pe = `${s.y}px`, Oe = `overlay-toolbar-icon edit ${qe() === "color" ? "active" : ""}`, Be = `overlay-toolbar-line-size ${qe() === "width" ? "active" : ""}`, ot = `overlay-toolbar-icon minus ${qe() === "style" ? "active" : ""}`, ct = `overlay-toolbar-icon visibility ${s.visible ? "" : "muted"}`, it = s.visible ? "Hide" : "Show", at = `overlay-toolbar-icon lock ${s.locked ? "active" : ""}`, st = s.locked ? "Unlock" : "Lock";
          return Te !== re._v$31 && u.style.setProperty("left", re._v$31 = Te), pe !== re._v$32 && u.style.setProperty("top", re._v$32 = pe), Oe !== re._v$33 && le(v, re._v$33 = Oe), Be !== re._v$34 && le(P, re._v$34 = Be), ot !== re._v$35 && le(J, re._v$35 = ot), ct !== re._v$36 && le(we, re._v$36 = ct), it !== re._v$37 && Ie(we, "title", re._v$37 = it), at !== re._v$38 && le(Ae, re._v$38 = at), st !== re._v$39 && Ie(Ae, "title", re._v$39 = st), re;
        }, {
          _v$31: void 0,
          _v$32: void 0,
          _v$33: void 0,
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = rp.cloneNode(!0), y = u.firstChild;
        return u.addEventListener("mouseleave", () => {
          ...
          h.stopPropagation(), Xe(!0), kt({
            y: s.y,
            price: s.price,
            yAxisWidth: g1()
          }), nt(!0), Yt();
        }, y.$$mousedown = (h) => {
          h.preventDefault(), h.stopPropagation(), Yt();
        }, C(y, (() => {
          const h = ee(() => {
            var g;
          ...
          return () => h() ? (() => {
            const g = op.cloneNode(!0);
            return z(() => g.innerHTML = e.orderTools.quickOrderPlusIcon), g;
          })() : ip.cloneNode(!0);
        })()), z((h) => {
          const g = `${Math.max(0, s.y - 12)}px`, v = `${g1()}px`, _ = Ee().quickOrderPlusButton ? "block" : "none";
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = ap.cloneNode(!0), y = u.firstChild, h = y.firstChild, g = h.firstChild, v = g.nextSibling, _ = v.nextSibling, P = _.nextSibling;
        P.nextSibling;
        const te = h.nextSibling, ie = te.firstChild, se = ie.nextSibling, ge = se.nextSibling, J = ge.nextSibling;
        J.nextSibling;
        const we = te.nextSibling, Ae = we.nextSibling, Ne = Ae.firstChild, re = Ne.nextSibling;
        re.nextSibling;
        const Te = Ae.nextSibling;
        return Te.firstChild, u.addEventListener("mouseleave", () => Xe(!1)), u.addEventListener("mouseenter", () => Xe(!0)), y.$$mousemove = () => {
          Yt();
        }, y.$$mousedown = (pe) => {
          pe.preventDefault(), pe.stopPropagation(), Yt();
        }, h.$$click = () => qn("limit"), C(h, () => V().shortName ?? V().name ?? V().ticker, v), C(h, () => X1(s.price), P), te.$$click = () => qn("stop"), C(te, () => V().shortName ?? V().name ?? V().ticker, se), C(te, () => X1(s.price), J), we.$$click = () => qn("create"), Ae.$$click = ia, C(Ae, () => X1(s.price), re), Te.$$click = aa, C(Te, () => X1(s.price), null), z((pe) => {
          const Oe = `${Math.max(0, s.y + 24)}px`, Be = `${s.yAxisWidth + Rn}px`;
          return Oe !== pe._v$43 && u.style.setProperty("top", pe._v$43 = Oe), Be !== pe._v$44 && u.style.setProperty("right", pe._v$44 = Be), pe;
        }, {
          _v$43: void 0,
          _v$44: void 0
        }), u;
      ...
      const u = `klinecharts-pro-auto-scale-button${Je() ? " active" : ""}`, y = Je(), h = Je(), g = Je() ? "Auto scale on" : "Auto scale off", v = Mt();
      return u !== s._v$ && le(i, s._v$ = u), y !== s._v$2 && Ie(i, "data-active", s._v$2 = y), h !== s._v$3 && Ie(i, "aria-pressed", s._v$3 = h), g !== s._v$4 && Ie(i, "title", s._v$4 = g), v !== s._v$5 && Ie(a, "data-drawing-bar-visible", s._v$5 = v), s;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
      ...
      return A(zg, {
        ...
        onMainIndicatorChange: (o) => {
          ...
          o.added ? (mn(n, o.name, !0, {
            id: "candle_pane"
          }), i.push(o.name), De(o.name, "candle_pane", "main", "add")) : (n == null || n.removeIndicator("candle_pane", o.name), i.splice(i.indexOf(o.name), 1), De(o.name, "candle_pane", "main", "remove")), G(i), ke(!0);
        },
        onSubIndicatorChange: (o) => {
          ...
          if (o.added) {
            const a = mn(n, o.name);
            a && (i[o.name] = a, De(o.name, a, "sub", "add"));
          } else
            o.paneId && (n == null || n.removeIndicator(o.paneId, o.name), delete i[o.name], De(o.name, o.paneId, "sub", "remove"));
          X(i), ke(!0);
        }
      });
    }
    ...
    get children() {
      return A(ly, {
        ...
        onChange: (o) => {
          ...
          Z(i);
          const a = j(i);
          At(a), n == null || n.setStyles(a), n == null || n.resize(), S1();
        },
        onSaveChartStyle: (o) => {
          U(o);
        },
        onResetChartStyle: () => {
          q(), t == null || t.style.removeProperty("--klinecharts-pro-chart-background-color");
        },
        onRestoreDefault: (o) => {
          const i = {};
          o.forEach((s) => {
    ...
    get children() {
      return A(my, {
        ...
        onConfirm: (o) => {
          ...
          De(i.indicatorName, i.paneId, a, "change");
        }
      });
    }
  }), A(de, {
...
class $p {
  ...
  setStyles(t) {
    var r, n;
    At(t), this._chartApi.setStyles(t), (n = (r = this._chartApi).resize) == null || n.call(r);
  }
  getStyles() {

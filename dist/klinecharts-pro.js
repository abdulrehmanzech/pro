...
const Z9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    ...
    if (e.length > 1) {
      ...
      l.forEach((u) => {
        const m = e[1].y + o * u, v = (f[1].value + h * u).toFixed(n.price);
    ...
    if (e.length > 1) {
      ...
      for (let m = 2; m < 9; m++) {
        ...
        switch (m % 4) {
          ...
          case 1: {
            L = s + Math.PI / 2, u -= f[m - 2].r;
            break;
          }
          case 2: {
            L = s + Math.PI, h += f[m - 2].r;
            break;
          }
          case 3: {
            L = s + Math.PI / 2 * 3, u += f[m - 2].r;
            break;
          }
        }
        const w = L + Math.PI / 2, I = Y1({ x: h, y: u }, e[0], s);
        f.push({
          ...I,
          r: v,
          startAngle: L,
...
var V = null;
let b1 = null, j = null, W = null, f1 = null, Ue = 0;
function ie(e, t) {
...
function l5(e, t, n) {
  ...
  let l = null, o = Ae, f = null, h = !1, u = "initialValue" in s, m = typeof r == "function" && z(r);
  const v = /* @__PURE__ */ new Set(), [L, w] = (s.storage || M)(s.initialValue), [I, b] = M(void 0), [P, D] = M(void 0, {
    equals: !1
  ...
  function u1(E, R) {
    p1(() => {
      R === void 0 && w(() => E), N(R !== void 0 ? "errored" : "ready"), b(R);
  ...
  function s1(E = !0) {
    ...
    return typeof Y != "object" || !(Y && "then" in Y) ? (U(l, Y, void 0, R), Y) : (l = Y, h = !0, queueMicrotask(() => h = !1), p1(() => {
...
function J0(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && p1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      l && b1.disposed.has(s), (l && !s.tState || !l && !s.state) && (s.pure ? W.push(s) : f1.push(s), s.observers && q0(s)), l || (s.state = h1);
    }
    if (W.length > 1e6)
      throw W = [], new Error();
  }, !1)), t;
...
function g5(e, t, n = {}) {
  ...
  return H1(() => c0(s)), () => {
    let f = e() || [], h, u;
    return f[c5], y1(() => {
      let v = f.length, L, w, I, b, P, D, S, N, U;
      if (v === 0)
        l !== 0 && (c0(s), s = [], r = [], a = [], l = 0, o && (o = [])), n.fallback && (r = [C5], a[0] = ie((u1) => (s[0] = u1, n.fallback())), l = 1);
      else if (l === 0) {
        for (a = new Array(v), u = 0; u < v; u++)
          r[u] = f[u], a[u] = ie(m);
        l = v;
      } else {
        for (I = new Array(v), b = new Array(v), o && (P = new Array(v)), D = 0, S = Math.min(l, v); D < S && r[D] === f[D]; D++)
          ;
        for (S = l - 1, N = v - 1; S >= D && N >= D && r[S] === f[N]; S--, N--)
          I[N] = a[S], b[N] = s[S], o && (P[N] = o[S]);
        for (L = /* @__PURE__ */ new Map(), w = new Array(N + 1), u = N; u >= D; u--)
          U = f[u], h = L.get(U), w[u] = h === void 0 ? -1 : h, L.set(U, u);
        for (h = D; h <= S; h++)
          U = r[h], u = L.get(U), u !== void 0 && u !== -1 ? (I[u] = a[h], b[u] = s[h], o && (P[u] = o[h]), u = w[u], L.set(U, u)) : s[h]();
        for (u = D; u < v; u++)
          u in I ? (a[u] = I[u], s[u] = b[u], o && (o[u] = P[u], o[u](u))) : a[u] = ie(m);
  ...
  for (; l < a || o < s; ) {
    ...
    if (a === l) {
      ...
      if (u != null)
        if (o < u && u < s) {
          let m = l, v = 1, L;
          for (; ++m < a && m < s && !((L = h.get(t[m])) == null || L !== u + v); )
            v++;
          if (v > u - o) {
            const w = t[l];
            for (; o < u; )
...
var b5 = typeof re == "object" && re && re.Object === Object && re, a9 = b5, L5 = a9, x5 = typeof self == "object" && self && self.Object === Object && self, k5 = L5 || x5 || Function("return this")(), l1 = k5, A5 = l1, w5 = A5.Symbol, pe = w5, d0 = pe, i9 = Object.prototype, M5 = i9.hasOwnProperty, S5 = i9.toString, R1 = d0 ? d0.toStringTag : void 0;
function T5(e) {
...
var s9 = V5, G5 = l1, X5 = G5["__core-js_shared__"], J5 = X5, Me = J5, h0 = function() {
...
var m6 = g6, p6 = C6, v6 = m6;
function _6(e, t) {
  var n = v6(e, t);
  return p6(n) ? n : void 0;
}
var k1 = _6, $6 = k1, b6 = function() {
  try {
...
var lt = ct, ut = Y6, dt = V6, ft = et, yt = it, ht = lt;
function N1(e) {
...
var _e = vt, _t = _e, $t = Array.prototype, bt = $t.splice;
function Lt(e) {
...
E1.prototype.has = Ot;
E1.prototype.set = Ut;
var $e = E1, Kt = k1, Ft = l1, jt = Kt(Ft, "Map"), Ze = jt, m0 = Ct, Zt = $e, Qt = Ze;
function zt() {
...
var D2 = P2, N2 = P1, E2 = Z6, B2 = L2, O2 = D2;
function U2(e, t) {
...
var Re = ye.exports, $8 = v8, b8 = ze, L0 = Re, x0 = L0 && L0.isTypedArray, L8 = x0 ? b8(x0) : $8, x8 = L8, k8 = T3, A8 = F3, w8 = P1, M8 = C9, S8 = y9, T8 = x8, I8 = Object.prototype, P8 = I8.hasOwnProperty;
function D8(e, t) {
  var n = w8(e), r = !n && A8(e), a = !n && !r && M8(e), s = !n && !r && !a && T8(e), l = n || r || a || s, o = l ? k8(e.length, String) : [], f = o.length;
  for (var h in e)
    (t || P8.call(e, h)) && !(l && // Safari 9 has enumerable `arguments.length` in strict mode.
...
(function(e, t) {
  ...
  function f(h, u) {
    if (u)
      return h.slice();
    var m = h.length, v = o ? o(m) : new h.constructor(m);
    return h.copy(v), v;
  }
  e.exports = f;
})(he, he.exports);
...
var $9 = E7, B7 = p9, O7 = B7(Object.getPrototypeOf, Object), b9 = O7, U7 = $9, K7 = b9, F7 = Ge, j7 = _9, Z7 = Object.getOwnPropertySymbols, Q7 = Z7 ? function(e) {
  for (var t = []; e; )
    U7(t, F7(e)), e = K7(e);
  return t;
} : j7, L9 = Q7, z7 = Le, R7 = L9;
function Y7(e, t) {
  return z7(e, R7(e), t);
}
...
var _r = vr, $r = I1, E0 = Object.create, br = function() {
  function e() {
  }
  return function(t) {
    if (!$r(t))
...
var Zr = jr, Qr = Zr, zr = ze, U0 = Re, K0 = U0 && U0.isSet, Rr = K0 ? zr(K0) : Qr, Yr = Rr, Hr = L3, Vr = k3, Gr = Fe, Xr = n7, Jr = v7, Wr = _7, qr = b7, e4 = N7, t4 = H7, n4 = tn, r4 = on, a4 = Xe, i4 = Dn, s4 = _r, o4 = Mr, c4 = P1, l4 = C9, u4 = Or, d4 = I1, f4 = Yr, y4 = He, h4 = Ve, C4 = 1, g4 = 2, m4 = 4, A9 = "[object Arguments]", p4 = "[object Array]", v4 = "[object Boolean]", _4 = "[object Date]", $4 = "[object Error]", w9 = "[object Function]", b4 = "[object GeneratorFunction]", L4 = "[object Map]", x4 = "[object Number]", M9 = "[object Object]", k4 = "[object RegExp]", A4 = "[object Set]", w4 = "[object String]", M4 = "[object Symbol]", S4 = "[object WeakMap]", T4 = "[object ArrayBuffer]", I4 = "[object DataView]", P4 = "[object Float32Array]", D4 = "[object Float64Array]", N4 = "[object Int8Array]", E4 = "[object Int16Array]", B4 = "[object Int32Array]", O4 = "[object Uint8Array]", U4 = "[object Uint8ClampedArray]", K4 = "[object Uint16Array]", F4 = "[object Uint32Array]", K = {};
K[A9] = K[p4] = K[T4] = K[I4] = K[v4] = K[_4] = K[P4] = K[D4] = K[N4] = K[E4] = K[B4] = K[L4] = K[x4] = K[M9] = K[k4] = K[A4] = K[w4] = K[M4] = K[O4] = K[U4] = K[K4] = K[F4] = !0;
K[$4] = K[w9] = K[S4] = !1;
function se(e, t, n, r, a, s) {
  ...
  if (L)
    return L;
  s.set(e, l), f4(e) ? e.forEach(function(b) {
    l.add(se(b, t, n, b, e, s));
  }) : u4(e) && e.forEach(function(b, P) {
    l.set(P, se(b, t, n, P, e, s));
  });
  var w = h ? f ? r4 : n4 : f ? h4 : y4, I = u ? void 0 : w(e);
  return Vr(I || e, function(b, P) {
    I && (P = b, b = e[P]), Gr(l, P, se(b, t, n, P, e, s));
  }), l;
}
...
const na = /* @__PURE__ */ p('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), S9 = () => na.cloneNode(!0), ra = /* @__PURE__ */ p('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), aa = () => ra.cloneNode(!0), ia = /* @__PURE__ */ p("<ul></ul>"), sa = /* @__PURE__ */ p("<li></li>"), Ce = (e) => (() => {
  ...
  return t.$$click = (l) => {
    ...
    const o = !!e.isMobile, f = e.isMobile ? "100%" : `${e.width ?? 400}px`, h = e.isMobile ? "100%" : "auto", u = e.isMobile ? "100vh" : "90vh", m = !!e.isMobile, v = !!e.isMobile, L = !!e.isMobile;
    return o !== l._v$ && t.classList.toggle("mobile-modal", l._v$ = o), f !== l._v$2 && n.style.setProperty("width", l._v$2 = f), h !== l._v$3 && n.style.setProperty("height", l._v$3 = h), u !== l._v$4 && n.style.setProperty("max-height", l._v$4 = u), m !== l._v$5 && n.classList.toggle("mobile-inner", l._v$5 = m), v !== l._v$6 && r.classList.toggle("mobile-title", l._v$6 = v), L !== l._v$7 && s.classList.toggle("mobile-content", l._v$7 = L), l;
  }, {
    _v$: void 0,
    _v$2: void 0,
    _v$3: void 0,
...
const la = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ua = /* @__PURE__ */ p('<div class="drop-down-container"><ul></ul></div>'), da = /* @__PURE__ */ p('<div><input type="text"></div>'), fa = /* @__PURE__ */ p("<li></li>"), T9 = (e) => {
  ...
  const o = z(() => {
    ...
    return u ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((v) => v.toLowerCase().includes(u)) : e.dataSource.filter((v) => {
      var I, b;
      const L = ((I = v.text) == null ? void 0 : I.toString().toLowerCase()) || "", w = ((b = v.key) == null ? void 0 : b.toLowerCase()) || "";
      return L.includes(u) || w.includes(u);
    }) : e.dataSource;
  }), f = () => {
    const u = !t();
  ...
  return (() => {
    ...
    const L = l;
    return typeof L == "function" ? V1(L, u) : l = u, x(v, () => e.value), x(u, (() => {
      const w = z(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => w() && (() => {
        const I = ua.cloneNode(!0), b = I.firstChild;
      ...
      const I = e.style, b = `klinecharts-pro-select ${e.class ?? ""} ${t() ? "klinecharts-pro-select-show" : ""}`;
      return w._v$ = x1(u, I, w._v$), b !== w._v$2 && L1(u, w._v$2 = b), w;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), u;
...
const ya = /* @__PURE__ */ p('<span class="prefix"></span>'), ha = /* @__PURE__ */ p('<span class="suffix"></span>'), Ca = /* @__PURE__ */ p('<div><input class="value"></div>'), I9 = (e) => {
  const t = n9({
  ...
  return (() => {
    ...
    return s.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        v <= 0 ? m = new RegExp(/^[1-9]\d*$/) : m = new RegExp("^\\d+\\.?\\d{0," + v + "}$"), (f === "" || m.test(f) && +f >= t.min && +f <= t.max) && ((h = t.onChange) == null || h.call(t, f === "" ? f : +f));
      } else
      ...
      const f = t.style, h = `klinecharts-pro-input ${t.class ?? ""}`, u = r(), m = t.placeholder ?? "";
      return o._v$ = x1(s, f, o._v$), h !== o._v$2 && L1(s, o._v$2 = h), u !== o._v$3 && n1(s, "data-status", o._v$3 = u), m !== o._v$4 && n1(l, "placeholder", o._v$4 = m), o;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
const i = (e, t) => {
  ...
  return Ke(() => {
    ...
    const s = Ec.cloneNode(!0), l = s.firstChild, o = l.firstChild, f = l.nextSibling, h = f.firstChild, u = h.nextSibling, m = f.nextSibling, v = m.firstChild, L = v.nextSibling, w = L.nextSibling, I = w.nextSibling;
    return V1((b) => {
      t = b;
      ...
      get children() {
        const b = Nc.cloneNode(!0), P = b.firstChild;
        return m1(b, "click", e.onSymbolClick, !0), x(b, $(X, {
          get when() {
        ...
        }), P), x(P, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), b;
      }
    }), f), x(s, () => e.periods.map((b) => (() => {
      const P = Bc.cloneNode(!0);
      return P.$$click = () => {
        e.onPeriodChange(b);
      }, x(P, () => b.text), Z(() => L1(P, `item period ${b.text === e.period.text ? "selected" : ""}`)), P;
    })()), f), m1(f, "click", e.onIndicatorClick, !0), x(u, () => i("indicator", e.locale)), m.style.setProperty("display", "flex"), m.style.setProperty("gap", "4px"), m.style.setProperty("margin-left", "auto"), m.style.setProperty("align-items", "center"), m1(v, "click", e.onTimezoneClick, !0), m1(L, "click", e.onSettingClick, !0), m1(w, "click", e.onScreenshotClick, !0), I.$$click = () => {
      if (n())
...
const i1 = (e) => su[e.name](e.class), yu = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), hu = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), j0 = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), Z0 = "drawing_tools", Cu = (e) => {
  ...
  return (() => {
    ...
    return x(r1, () => U().map((O) => (() => {
      const G = hu.cloneNode(!0), a1 = G.firstChild, C1 = a1.nextSibling, J = C1.firstChild;
      ...
      let O = m();
      L() !== "normal" && (O = "normal"), w(O), e.onModeChange(O);
    }, x(R, (() => {
      const O = z(() => m() === "weak_magnet");
      return () => O() ? (() => {
        const G = z(() => L() === "weak_magnet");
        return () => G() ? $(i1, {
          name: "weak_magnet",
          class: "selected"
        }) : $(i1, {
      ...
      return () => O() && $(Ce, {
        ...
        get children() {
          return u1().map((G) => (() => {
            const a1 = j0.cloneNode(!0), C1 = a1.firstChild;
            return a1.$$click = () => {
    ...
    get children() {
      ...
      return x(h, $(p5, {
        ...
        children: (u) => {
          ...
          return (() => {
            const L = _u.cloneNode(!0), w = L.firstChild, I = w.nextSibling;
            return x(w, () => u.text), x(I, m), Z(() => L.classList.toggle("mobile-item", !!s())), L;
          })();
        }
      })), Z(() => h.classList.toggle("mobile-layout", !!s())), h;
    }
  });
}, bu = /* @__PURE__ */ p('<img style="width:500px;margin-top: 20px">'), Lu = (e) => $(K1, {
  get title() {
...
const Nu = (e) => {
  let t, n = null, r;
  const [a, s] = M(!1), [l, o] = M(e.theme), [f, h] = M(e.styles), [u, m] = M(e.locale), [v, L] = M(e.symbol), [w, I] = M(e.period), [b, P] = M(!1), [D, S] = M([...e.mainIndicators]), [N, U] = M({}), [u1, r1] = M(!1), [s1, E] = M({
    key: e.timezone,
    text: R0(e.timezone, e.locale)
  }), [R, Y] = M(!1), [o1, X1] = M(), [F1, j1] = M(""), [v1, xe] = M(e.drawingBarVisible), [J1, Z1] = M(!1), [O, G] = M(!1), [a1, C1] = M({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const A1 = (c, d, C) => {
    ...
    try {
      ...
      const T = D9(k);
      if (T) {
        const y = J.get(c), _ = ((C = y == null ? void 0 : y.points) == null ? void 0 : C.length) || 0, A = ((g = T.points) == null ? void 0 : g.length) || 0;
        J.set(c, T);
        const B = _1(T.type);
        if (A >= B) {
          const H = e1.get(c);
  ...
  e.ref({
    ...
    removeOverlay: (c) => {
      ...
      if ((d = n == null ? void 0 : n.removeOverlay) == null || d.call(n, c), c.id) {
        J.delete(c.id);
        const C = e1.get(c.id);
        C && (C.checkInterval && clearInterval(C.checkInterval), C.mouseUpHandler && (document.removeEventListener("mouseup", C.mouseUpHandler), document.removeEventListener("touchend", C.mouseUpHandler)), e1.delete(c.id)), We();
      }
    },
    removeAllOverlay: () => {
      J.forEach((c, d) => {
    ...
    getSettings: () => {
      var C, g, k, T, y, _, A, B, H, g1, Q1, q1, e0, t0, n0, r0;
      if (!n)
        return {};
    ...
    saveDrawings: (c) => {
      ...
      d.forEach((C, g) => {
        var y;
        const k = _1(C.type), T = ((y = C.points) == null ? void 0 : y.length) || 0;
        T < k && console.warn(`⚠️ ${C.type} ${C.id} has only ${T} point(s), should have ${k}`);
      }), M1.saveDrawings(c, d);
    },
    loadDrawings: (c) => {
      M1.loadDrawings(c).forEach((C, g) => {
        ...
        try {
          ...
          console.error(`   ❌ Error restoring ${C.type}:`, T);
        }
      });
    },
  ...
  const qe = () => {
    ...
    switch (c.timespan) {
      ...
      case "week": {
        ...
        g = g - _ * 60 * 60 * 24;
        const A = new Date(g);
        g = (/* @__PURE__ */ new Date(`${A.getFullYear()}-${A.getMonth() + 1}-${A.getDate()}`)).getTime(), k = C * c.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const T = new Date(g), y = T.getFullYear(), _ = T.getMonth() + 1;
        g = (/* @__PURE__ */ new Date(`${y}-${_}-01`)).getTime(), k = C * c.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const A = new Date(k);
      ...
      case "year": {
        ...
        g = (/* @__PURE__ */ new Date(`${y}-01-01`)).getTime(), k = C * c.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const _ = new Date(k);
  ...
  return Ke(() => {
    ...
    return H1(() => {
      ...
      try {
        const [T, y] = ke(C, (/* @__PURE__ */ new Date()).getTime(), 500), _ = await e.datafeed.getHistoryKLineData(d, C, T, y);
        if (!g)
          return;
        n == null || n.applyNewData(_, _.length > 0), e.datafeed.subscribe(d, C, (A) => {
    ...
    get children() {
      return $(gu, {
        ...
        onSubIndicatorChange: (c) => {
          ...
          if (c.added) {
            const C = ae(n, c.name);
            C && (d[c.name] = C, t1(c.name, C, "sub", "add"));
          } else
    ...
    get children() {
      return $(wu, {
        ...
        onConfirm: (c) => {
          ...
          t1(d.indicatorName, d.paneId, C, "change");
        }
      });
    }
  }), $(Kc, {
    ...
    }), d), V1((C) => t = C, d), Z(() => n1(d, "data-drawing-bar-visible", v1())), c;
  })()];

...
import { utils as B, registerFigure as Ra, PolygonType as e1, LineType as Ve, OverlayMode as ir, ActionType as yt, init as Va, FormatDateType as cn, DomPosition as et, dispose as ii, TooltipIconPosition as un, CandleType as Ka, YAxisType as ja, TooltipShowRule as ai, registerOverlay as Qa } from "klinecharts";
function E1(e, t, r) {
...
const Za = {
  ...
  createPointFigures: ({ coordinates: e }) => {
    if (e.length > 1) {
      ...
      const l = E1({ x: e[1].x - 8, y: e[1].y + 4 }, e[1], n), c = E1({ x: e[1].x - 8, y: e[1].y - 4 }, e[1], n);
      return [
        {
          type: "line",
          attrs: { coordinates: e }
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    const n = [], l = [];
    if (e.length > 1) {
      const c = e[1].x > e[0].x ? e[0].x : e[1].x, f = [1, 0.786, 0.618, 0.5, 0.382, 0.236, 0], m = e[0].y - e[1].y, p = t.points, L = p[0].value - p[1].value;
      f.forEach((x) => {
    ...
    if (e.length > 1) {
      ...
      for (let w = 2; w < 9; w++) {
        ...
        switch (w % 4) {
          ...
          case 1: {
            W = c + Math.PI / 2, x -= p[w - 2].r;
            break;
          }
          case 2: {
            W = c + Math.PI, L += p[w - 2].r;
            break;
          }
          case 3: {
            W = c + Math.PI / 2 * 3, x += p[w - 2].r;
            break;
          }
        }
        const ye = W + Math.PI / 2, R = E1({ x: L, y: x }, e[0], c);
        p.push({
          ...R,
          r: K,
          startAngle: W,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    const l = [];
    if (e.length > 1) {
      const c = e[1].x > e[0].x ? -38 : 4, f = e[1].y > e[0].y ? -2 : 20, m = e[1].x - e[0].x, p = e[1].y - e[0].y;
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    const n = [], l = [];
    if (e.length > 2) {
      const c = t.points, f = c[1].value - c[0].value, m = e[1].y - e[0].y, p = [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1], L = e[2].x > e[1].x ? e[1].x : e[2].x;
      p.forEach((x) => {
        const w = e[2].y + m * x, K = (c[2].value + f * x).toFixed(r.price);
...
var ze = null;
let Kt = null, Me = null, je = null, pt = null, Sr = 0;
function B1(e, t) {
  const r = Me, n = ze, l = e.length === 0, c = l ? r0 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? n : t
...
function fs(e, t, r) {
  ...
  let f = null, m = ar, p = null, L = !1, x = "initialValue" in c, w = typeof n == "function" && ee(n);
  const K = /* @__PURE__ */ new Set(), [W, ye] = (c.storage || D)(c.initialValue), [R, S] = D(void 0), [E, ne] = D(void 0, {
    equals: !1
  }), [F, z] = D(x ? "ready" : "unresolved");
  if (Re.context) {
    p = `${Re.context.id}${Re.context.count++}`;
    let X;
    c.ssrLoadFrom === "initial" ? m = c.initialValue : Re.load && (X = Re.load(p)) && (m = X[0]);
  }
  function j(X, ie, he, be) {
    return f === X && (f = null, x = !0, (X === m || ie === m) && c.onHydrated && queueMicrotask(() => c.onHydrated(be, {
      value: ie
    })), m = ar, se(ie, he)), ie;
  }
  function se(X, ie) {
    Tt(() => {
      ie === void 0 && ye(() => X), z(ie !== void 0 ? "errored" : "ready"), S(ie);
  ...
  function q() {
    const X = gs, ie = W(), he = R();
    if (he !== void 0 && !f)
      throw he;
    return Me && !Me.user && X && si(() => {
  ...
  function H(X = !0) {
    ...
    const he = m !== ar ? m : ht(() => l(ie, {
      value: W(),
      refetching: X
    }));
    return typeof he != "object" || !(he && "then" in he) ? (j(f, he, void 0, ie), he) : (f = he, L = !0, queueMicrotask(() => L = !1), Tt(() => {
      z(x ? "refreshing" : "pending"), ne();
    }, !1), he.then((be) => j(he, be, void 0, ie), (be) => j(he, void 0, l0(be), ie)));
  }
...
function ms(e) {
  ...
  return Promise.resolve().then(() => {
    Me = t, ze = r;
    let n;
    return Tt(e, !1), Me = ze = null, n ? n.done : void 0;
  });
}
let gs;
function o0() {
  ...
  if (this.sources && (this.state || e))
    if (this.state === $t || e)
      ...
      const t = je;
      je = null, Tt(() => xn(this), !1), je = t;
    }
  if (Me) {
    const t = this.observers ? this.observers.length : 0;
    Me.sources ? (Me.sources.push(this), Me.sourceSlots.push(t)) : (Me.sources = [this], Me.sourceSlots = [t]), this.observers ? (this.observers.push(Me), this.observerSlots.push(Me.sources.length - 1)) : (this.observers = [Me], this.observerSlots = [Me.sources.length - 1]);
  }
  return this.value;
}
function i0(e, t, r) {
  let n = e.value;
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && Tt(() => {
    for (let l = 0; l < e.observers.length; l += 1) {
      const c = e.observers[l], f = Kt && Kt.running;
      f && Kt.disposed.has(c), (f && !c.tState || !f && !c.state) && (c.pure ? je.push(c) : pt.push(c), c.observers && s0(c)), f || (c.state = $t);
    }
    if (je.length > 1e6)
      throw je = [], new Error();
  }, !1)), t;
...
function o1(e) {
  if (!e.fn)
    return;
  Nn(e);
  const t = ze, r = Me, n = Sr;
  Me = ze = e, ys(e, e.value, n), Me = r, ze = t;
}
function ys(e, t, r) {
  let n;
  try {
...
function Dn(e, t, r, n = $t, l) {
  ...
  return ze === null || ze !== r0 && (ze.owned ? ze.owned.push(c) : ze.owned = [c]), c;
}
function kn(e) {
  const t = Kt;
  if (e.state === 0 || t)
  ...
  for (let n = r.length - 1; n >= 0; n--)
    if (e = r[n], e.state === $t || t)
      o1(e);
    else if (e.state === _n || t) {
      const l = je;
      je = null, Tt(() => xn(e, r[0]), !1), je = l;
    }
}
function Tt(e, t) {
  if (je)
...
function xn(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    const l = e.sources[n];
    l.sources && (l.state === $t || r ? l !== t && kn(l) : (l.state === _n || r) && xn(l, t));
  }
}
function s0(e) {
  const t = Kt;
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = _n, n.pure ? je.push(n) : pt.push(n), n.observers && s0(n));
  }
}
function Nn(e) {
  let t;
...
function bs(e, t, r = {}) {
  ...
  return vt(() => li(c)), () => {
    let p = e() || [], L, x;
    return p[hs], ht(() => {
      let K = p.length, W, ye, R, S, E, ne, F, z, j;
      if (K === 0)
        f !== 0 && (li(c), c = [], n = [], l = [], f = 0, m && (m = [])), r.fallback && (n = [vs], l[0] = B1((se) => (c[0] = se, r.fallback())), f = 1);
      else if (f === 0) {
        for (l = new Array(K), x = 0; x < K; x++)
          n[x] = p[x], l[x] = B1(w);
        f = K;
      } else {
        for (R = new Array(K), S = new Array(K), m && (E = new Array(K)), ne = 0, F = Math.min(f, K); ne < F && n[ne] === p[ne]; ne++)
          ;
        for (F = f - 1, z = K - 1; F >= ne && z >= ne && n[F] === p[z]; F--, z--)
          R[z] = l[F], S[z] = c[F], m && (E[z] = m[F]);
        for (W = /* @__PURE__ */ new Map(), ye = new Array(z + 1), x = z; x >= ne; x--)
          j = p[x], L = W.get(j), ye[x] = L === void 0 ? -1 : L, W.set(j, x);
        for (L = ne; L <= F; L++)
          j = n[L], x = W.get(j), x !== void 0 && x !== -1 ? (R[x] = l[L], S[x] = c[L], m && (E[x] = m[L]), x = ye[x], W.set(j, x)) : c[L]();
        for (x = ne; x < K; x++)
          x in R ? (l[x] = R[x], c[x] = S[x], m && (m[x] = E[x], m[x](x))) : l[x] = B1(w);
...
function fe(e) {
  ...
  return ee(() => {
    ...
    if (l) {
      ...
      return t = r || f, f ? ht(() => c(l)) : c;
    }
    return e.fallback;
  }, void 0, void 0);
}
function _s(e, t, r) {
  let n = r.length, l = t.length, c = n, f = 0, m = 0, p = t[l - 1].nextSibling, L = null;
  for (; f < l || m < c; ) {
    if (t[f] === r[m]) {
      f++, m++;
      continue;
    ...
    for (; t[l - 1] === r[c - 1]; )
      l--, c--;
    if (l === f) {
      const x = c < n ? m ? r[m - 1].nextSibling : r[c - m] : p;
      for (; m < c; )
      ...
      e.insertBefore(r[m++], t[f++].nextSibling), e.insertBefore(r[--c], x), t[l] = r[c];
    } else {
      if (!L) {
        L = /* @__PURE__ */ new Map();
        let w = m;
      ...
      if (x != null)
        if (m < x && x < c) {
          let w = f, K = 1, W;
          for (; ++w < l && w < c && !((W = L.get(t[w])) == null || W !== x + K); )
            K++;
          if (K > x - m) {
            const ye = t[f];
            for (; m < x; )
...
function Ye(e, t = window.document) {
  ...
  for (let n = 0, l = e.length; n < l; n++) {
    const c = e[n];
    r.has(c) || (r.add(c), t.addEventListener(c, xs));
  }
}
function Oe(e, t, r) {
  ...
  if (t.length) {
    ...
    for (let f = t.length - 1; f >= 0; f--) {
      ...
      if (l !== m) {
        ...
        !c && !f ? p ? e.replaceChild(l, m) : e.insertBefore(l, r) : p && m.remove();
      } else
        c = !0;
    }
  } else
...
function d0(e) {
  ...
  if (n instanceof HTMLHeadElement) {
    const [c, f] = D(!1), m = () => f(!0);
    B1((p) => C(n, () => c() ? p() : l()(), null)), vt(() => {
      Re.context ? queueMicrotask(m) : m();
    });
  } else {
    const c = ws(e.isSVG ? "g" : "div", e.isSVG), f = t && c.attachShadow ? c.attachShadow({
      mode: "open"
    }) : c;
    Object.defineProperty(c, "_$host", {
      ...
      configurable: !0
    }), C(f, l()), n.appendChild(c), e.ref && e.ref(c), vt(() => n.removeChild(c));
  }
  return r;
}
...
var As = typeof hn == "object" && hn && hn.Object === Object && hn, f0 = As, Ss = f0, Ts = typeof self == "object" && self && self.Object === Object && self, Ms = Ss || Ts || Function("return this")(), ft = Ms, Ps = ft, Ds = Ps.Symbol, On = Ds, di = On, m0 = Object.prototype, Ns = m0.hasOwnProperty, Os = m0.toString, O1 = di ? di.toStringTag : void 0;
function Is(e) {
...
var g0 = Js, e9 = ft, t9 = e9["__core-js_shared__"], n9 = t9, lr = n9, mi = function() {
...
var H9 = Z9, W9 = jt, Y9 = W9(Object, "create"), In = Y9, yi = In;
function q9() {
...
var F5 = B5, z5 = _5, U5 = T5, R5 = D5, V5 = I5, K5 = F5;
function c1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
c1.prototype.has = V5;
c1.prototype.set = K5;
var Bn = c1, j5 = jt, Q5 = ft, Z5 = j5(Q5, "Map"), Dr = Z5, pi = b5, H5 = Bn, W5 = Dr;
function Y5() {
...
var kl = _l, xl = kl, Ll = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, wl = /\\(\\)?/g, Al = xl(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(Ll, function(r, n, l, c) {
    t.push(l ? c.replace(wl, "$1") : n || r);
  }), t;
}), Sl = Al;
function Tl(e, t) {
...
var Ml = Tl, Ci = On, Pl = Ml, Dl = a1, Nl = Pr, Ol = 1 / 0, vi = Ci ? Ci.prototype : void 0, bi = vi ? vi.toString : void 0;
function $0(e) {
  if (typeof e == "string")
    return e;
  if (Dl(e))
...
var Fl = Bl, zl = a1, Ul = H9, Rl = Sl, Vl = Fl;
function Kl(e, t) {
...
var M2 = T2, P2 = Mr, D2 = p0;
function N2(e, t, r, n) {
  var l = !r;
  r || (r = {});
  for (var c = -1, f = t.length; ++c < f; ) {
    var m = t[c], p = n ? n(r[m], e[m], m, r, e) : void 0;
...
wn.exports;
(function(e, t) {
  var r = ft, n = H2, l = t && !t.nodeType && t, c = l && !0 && e && !e.nodeType && e, f = c && c.exports === l, m = f ? r.Buffer : void 0, p = m ? m.isBuffer : void 0, L = p || n;
  e.exports = L;
})(wn, wn.exports);
...
An.exports;
(function(e, t) {
  var r = f0, n = t && !t.nodeType && t, l = n && !0 && e && !e.nodeType && e, c = l && l.exports === n, f = c && r.process, m = function() {
    try {
...
var Ir = An.exports, w6 = x6, A6 = Or, ki = Ir, xi = ki && ki.isTypedArray, S6 = xi ? A6(xi) : w6, T6 = S6, M6 = I2, P6 = Q2, D6 = a1, N6 = x0, O6 = _0, I6 = T6, E6 = Object.prototype, B6 = E6.hasOwnProperty;
function F6(e, t) {
  var r = D6(e), n = !r && P6(e), l = !r && !n && N6(e), c = !r && !n && !l && I6(e), f = r || n || l || c, m = f ? M6(e.length, String) : [], p = m.length;
  for (var L in e)
...
var x3 = k3, Sn = { exports: {} };
Sn.exports;
(function(e, t) {
  var r = ft, n = t && !t.nodeType && t, l = n && !0 && e && !e.nodeType && e, c = l && l.exports === n, f = c ? r.Buffer : void 0, m = f ? f.allocUnsafe : void 0;
  function p(L, x) {
    if (x)
      return L.slice();
...
var T0 = M3, P3 = T3, D3 = T0, N3 = Object.prototype, O3 = N3.propertyIsEnumerable, Li = Object.getOwnPropertySymbols, I3 = Li ? function(e) {
...
var M0 = U3, R3 = A0, V3 = R3(Object.getPrototypeOf, Object), P0 = V3, K3 = M0, j3 = P0, Q3 = zr, Z3 = T0, H3 = Object.getOwnPropertySymbols, W3 = H3 ? function(e) {
  for (var t = []; e; )
    K3(t, Q3(e)), e = j3(e);
  return t;
...
var dc = uc, hc = jt, fc = ft, mc = hc(fc, "DataView"), gc = mc, yc = jt, pc = ft, Cc = yc(pc, "Promise"), vc = Cc, bc = jt, $c = ft, _c = bc($c, "Set"), kc = _c, xc = jt, Lc = ft, wc = xc(Lc, "WeakMap"), Ac = wc, Cr = gc, vr = Dr, br = vc, $r = kc, _r = Ac, O0 = z1, h1 = y0, wi = "[object Map]", Sc = "[object Object]", Ai = "[object Promise]", Si = "[object Set]", Ti = "[object WeakMap]", Mi = "[object DataView]", Tc = h1(Cr), Mc = h1(vr), Pc = h1(br), Dc = h1($r), Nc = h1(_r), Rt = O0;
(Cr && Rt(new Cr(new ArrayBuffer(1))) != Mi || vr && Rt(new vr()) != wi || br && Rt(br.resolve()) != Ai || $r && Rt(new $r()) != Si || _r && Rt(new _r()) != Ti) && (Rt = function(e) {
  var t = O0(e), r = t == Sc ? e.constructor : void 0, n = r ? h1(r) : "";
  if (n)
    switch (n) {
      case Tc:
        return Mi;
...
var Ur = Rt, Oc = Object.prototype, Ic = Oc.hasOwnProperty;
function Ec(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && Ic.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
var Bc = Ec, Fc = ft, zc = Fc.Uint8Array, Uc = zc, Pi = Uc;
function Rc(e) {
...
}(), A8 = w8, S8 = A8, T8 = P0, M8 = Er;
function P8(e) {
  return typeof e.constructor == "function" && !M8(e) ? S8(T8(e)) : {};
}
...
var Z8 = Q8, H8 = Z8, W8 = Or, Fi = Ir, zi = Fi && Fi.isSet, Y8 = zi ? W8(zi) : H8, q8 = Y8, G8 = S2, X8 = M2, J8 = Mr, e7 = s3, t7 = x3, n7 = L3, r7 = A3, o7 = z3, i7 = X3, a7 = ac, s7 = dc, l7 = Ur, c7 = Bc, u7 = x8, d7 = D8, h7 = a1, f7 = x0, m7 = R8, g7 = i1, y7 = q8, p7 = Br, C7 = Fr, v7 = 1, b7 = 2, $7 = 4, I0 = "[object Arguments]", _7 = "[object Array]", k7 = "[object Boolean]", x7 = "[object Date]", L7 = "[object Error]", E0 = "[object Function]", w7 = "[object GeneratorFunction]", A7 = "[object Map]", S7 = "[object Number]", B0 = "[object Object]", T7 = "[object RegExp]", M7 = "[object Set]", P7 = "[object String]", D7 = "[object Symbol]", N7 = "[object WeakMap]", O7 = "[object ArrayBuffer]", I7 = "[object DataView]", E7 = "[object Float32Array]", B7 = "[object Float64Array]", F7 = "[object Int8Array]", z7 = "[object Int16Array]", U7 = "[object Int32Array]", R7 = "[object Uint8Array]", V7 = "[object Uint8ClampedArray]", K7 = "[object Uint16Array]", j7 = "[object Uint32Array]", xe = {};
xe[I0] = xe[_7] = xe[O7] = xe[I7] = xe[k7] = xe[x7] = xe[E7] = xe[B7] = xe[F7] = xe[z7] = xe[U7] = xe[A7] = xe[S7] = xe[B0] = xe[T7] = xe[M7] = xe[P7] = xe[D7] = xe[R7] = xe[V7] = xe[K7] = xe[j7] = !0;
xe[L7] = xe[E0] = xe[N7] = !1;
function Cn(e, t, r, n, l, c) {
  ...
  if (W)
    return W;
  c.set(e, f), y7(e) ? e.forEach(function(S) {
    f.add(Cn(S, t, r, S, e, c));
  }) : m7(e) && e.forEach(function(S, E) {
    f.set(E, Cn(S, t, r, E, e, c));
  });
  var ye = L ? p ? s7 : a7 : p ? C7 : p7, R = x ? void 0 : ye(e);
  return X8(R || e, function(S, E) {
    R && (E = S, S = e[E]), J8(f, E, Cn(S, t, r, E, e, c));
  }), f;
}
...
const G7 = /* @__PURE__ */ h0(q7), X7 = /* @__PURE__ */ $("<button></button>"), J7 = (e) => (() => {
  ...
  return dt(t, "click", e.onClick, !0), C(t, () => e.children), U((r) => {
    const n = e.style, l = `klinecharts-pro-button ${e.type ?? "confirm"} ${e.class ?? ""}`;
    return r._v$ = bt(t, n, r._v$), l !== r._v$2 && ce(t, r._v$2 = l), r;
  }, {
    _v$: void 0,
    _v$2: void 0
  }), t;
  ...
  return t.$$click = (f) => {
    ...
    return () => f() && (() => {
      ...
      return C(m, () => e.buttons.map((p) => A(J7, u0(p, {
        ...
        return L !== p._v$11 && ce(m, p._v$11 = L), p._v$12 = bt(m, x, p._v$12), w !== p._v$13 && m.classList.toggle("mobile-buttons", p._v$13 = w), p;
      }, {
        _v$11: void 0,
        _v$12: void 0,
        _v$13: void 0
    ...
    const m = `klinecharts-pro-modal ${e.class ?? ""}`, p = !!e.isMobile, L = e.isMobile ? "100%" : `${e.width ?? 400}px`, x = (e.isMobile, "auto"), w = e.isMobile ? "60vh" : "90vh", K = `inner ${e.innerClass ?? ""}`, W = !!e.isMobile, ye = !!e.isMobile, R = `content-container ${e.contentClass ?? ""}`, S = !!e.isMobile;
    return m !== f._v$ && ce(t, f._v$ = m), p !== f._v$2 && t.classList.toggle("mobile-modal", f._v$2 = p), L !== f._v$3 && r.style.setProperty("width", f._v$3 = L), x !== f._v$4 && r.style.setProperty("height", f._v$4 = x), w !== f._v$5 && r.style.setProperty("max-height", f._v$5 = w), K !== f._v$6 && ce(r, f._v$6 = K), W !== f._v$7 && r.classList.toggle("mobile-inner", f._v$7 = W), ye !== f._v$8 && n.classList.toggle("mobile-title", f._v$8 = ye), R !== f._v$9 && ce(c, f._v$9 = R), S !== f._v$10 && c.classList.toggle("mobile-content", f._v$10 = S), f;
  }, {
    _v$: void 0,
    _v$2: void 0,
    _v$3: void 0,
...
const f4 = /* @__PURE__ */ $("<div><ul></ul></div>"), m4 = /* @__PURE__ */ $('<div><input type="text"></div>'), g4 = /* @__PURE__ */ $("<li></li>"), y4 = /* @__PURE__ */ $('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), vn = (e) => {
  const [t, r] = D(!1), [n, l] = D(""), [c, f] = D({});
  let m, p, L;
  const x = (S, E, ne) => {
    const F = parseFloat(S.getPropertyValue(E));
    return Number.isFinite(F) ? F : ne;
  }, w = () => {
    var Ie;
    if (!p)
      return;
    const S = p.getBoundingClientRect(), E = window.getComputedStyle(p), ne = x(E, "--klinecharts-pro-select-dropdown-gap", 4), F = p.closest(".klinecharts-pro-modal .inner"), z = F == null ? void 0 : F.getBoundingClientRect(), j = (z == null ? void 0 : z.left) ?? 0, se = (z == null ? void 0 : z.right) ?? window.innerWidth, q = (z == null ? void 0 : z.top) ?? 0, H = (z == null ? void 0 : z.bottom) ?? window.innerHeight, ie = !!p.closest(".klinecharts-pro-setting-modal") || ((Ie = e.dropdownClass) == null ? void 0 : Ie.includes("klinecharts-pro-timezone-dropdown")), he = x(E, ie ? "--klinecharts-pro-setting-dropdown-boundary-padding" : "--klinecharts-pro-select-dropdown-boundary-padding", ie ? 16 : 12), be = x(E, "--klinecharts-pro-setting-dropdown-mobile-breakpoint", 768), Le = window.innerWidth <= be, ue = E.getPropertyValue("--klinecharts-pro-setting-dropdown-mobile-width-mode").trim() || "trigger", Pe = Math.max(S.width, se - j - he * 2), $e = x(E, "--klinecharts-pro-setting-dropdown-max-width", 280), O = x(E, "--klinecharts-pro-select-dropdown-width", Number.NaN), N = ie ? Number.isFinite(O) ? Math.max(S.width, Math.min(O, Pe)) : Le && ue !== "expanded" ? S.width : Math.max(S.width, Math.min($e, Pe)) : S.width, V = Math.min(Math.max(S.left, j + he), se - N - he), Y = x(E, "--klinecharts-pro-select-dropdown-min-height", 140), M = x(E, "--klinecharts-pro-select-dropdown-max-height", 260), T = x(E, "--klinecharts-pro-select-dropdown-viewport-padding-y", 32), G = x(E, "--klinecharts-pro-select-dropdown-open-up-threshold", 180), Q = x(E, "--klinecharts-pro-select-dropdown-z-index", 1e4), Z = Math.min(M, Math.max(Y, H - q - T)), oe = H - S.bottom - ne, k = S.top - q - ne, de = oe < G && k > oe, Ce = Math.max(Y, Math.min(Z, de ? k - ne : oe - ne));
    f({
      position: "fixed",
      left: `${V}px`,
      top: de ? "auto" : `${S.bottom + ne}px`,
      bottom: de ? `${window.innerHeight - S.top + ne}px` : "auto",
      width: `${N}px`,
      "max-height": `${Ce}px`,
      "transform-origin": de ? "bottom" : "top",
      opacity: 1,
      transform: "scaleY(1)",
      "z-index": Q
    });
    ...
    return S ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((ne) => ne.toLowerCase().includes(S)) : e.dataSource.filter((ne) => {
      var j, se;
      const F = ((j = ne.text) == null ? void 0 : j.toString().toLowerCase()) || "", z = ((se = ne.key) == null ? void 0 : se.toLowerCase()) || "";
      return F.includes(S) || z.includes(S);
    }) : e.dataSource;
  }), W = () => {
    const S = !t();
    r(S), l(""), S && e.searchable && setTimeout(() => m == null ? void 0 : m.focus(), 50);
  }, ye = (S) => {
  ...
  Ke(() => {
    ...
    document.addEventListener("mousedown", S), window.addEventListener("resize", E), window.addEventListener("scroll", E, !0), vt(() => {
      document.removeEventListener("mousedown", S), window.removeEventListener("resize", E), window.removeEventListener("scroll", E, !0);
    });
  });
  const R = () => (() => {
    const S = f4.cloneNode(!0), E = S.firstChild;
    S.$$click = (F) => F.stopPropagation(), S.$$mousedown = (F) => {
      F.preventDefault(), F.stopPropagation();
    };
    const ne = L;
    return typeof ne == "function" ? Ct(ne, S) : L = S, C(S, (() => {
      const F = ee(() => !!e.searchable);
      return () => F() && (() => {
        const z = m4.cloneNode(!0), j = z.firstChild;
        z.style.setProperty("padding", "8px"), z.style.setProperty("border-bottom", "1px solid #333"), j.$$click = (q) => q.stopPropagation(), j.$$input = (q) => l(q.currentTarget.value);
        const se = m;
        return typeof se == "function" ? Ct(se, j) : m = j, j.style.setProperty("width", "100%"), j.style.setProperty("padding", "6px 10px"), j.style.setProperty("border", "1px solid var(--klinecharts-pro-border-color)"), j.style.setProperty("border-radius", "4px"), j.style.setProperty("background-color", "var(--klinecharts-pro-popover-background-color)"), j.style.setProperty("color", "#fff"), j.style.setProperty("font-size", "13px"), j.style.setProperty("outline", "none"), U(() => Oe(j, "placeholder", e.searchPlaceholder || "Search...")), U(() => j.value = n()), z;
      })();
    })(), E), C(E, () => {
      var F;
      return (F = K()) == null ? void 0 : F.map((z) => {
        const se = z[e.valueKey ?? "text"] ?? z;
        return (() => {
          const q = g4.cloneNode(!0);
          return q.$$click = (H) => {
            var X;
            H.stopPropagation(), e.value !== se && ((X = e.onSelected) == null || X.call(e, z)), r(!1), l("");
          }, C(q, se), U(() => q.classList.toggle("selected", e.value === se)), q;
        })();
      });
    }), U((F) => {
      const z = `drop-down-container klinecharts-pro-select-dropdown-portal ${e.dropdownClass ?? ""}`, j = c();
      return z !== F._v$ && ce(S, F._v$ = z), F._v$2 = bt(S, j, F._v$2), F;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), S;
  ...
  return (() => {
    const S = y4.cloneNode(!0), E = S.firstChild, ne = E.firstChild;
    S.addEventListener("blur", ye), S.$$click = (z) => {
      z.stopPropagation(), !z.target.closest(".drop-down-container") && W();
    };
    const F = p;
    return typeof F == "function" ? Ct(F, S) : p = S, C(ne, () => e.value), C(S, (() => {
      const z = ee(() => !!(e.dataSource && e.dataSource.length > 0 && t()));
      return () => z() && A(d0, {
        get children() {
          return R();
        }
      ...
      const j = e.style, se = `klinecharts-pro-select ${e.class ?? ""} ${t() ? "klinecharts-pro-select-show" : ""}`;
      return z._v$3 = bt(S, j, z._v$3), se !== z._v$4 && ce(S, z._v$4 = se), z;
    }, {
      _v$3: void 0,
      _v$4: void 0
    }), S;
...
const p4 = /* @__PURE__ */ $('<span class="prefix"></span>'), C4 = /* @__PURE__ */ $('<span class="suffix"></span>'), v4 = /* @__PURE__ */ $('<div><input class="value"></div>'), z0 = (e) => {
  ...
  const [n, l] = D("normal");
  return (() => {
    const c = v4.cloneNode(!0), f = c.firstChild;
    return c.$$click = () => {
      r == null || r.focus();
    }, C(c, A(fe, {
      get when() {
      ...
      return m._v$ = bt(c, p, m._v$), L !== m._v$2 && ce(c, m._v$2 = L), x !== m._v$3 && Oe(c, "data-status", m._v$3 = x), w !== m._v$4 && Oe(f, "placeholder", m._v$4 = w), m;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
function w4(e, t, r) {
  const n = r.style ?? e1.Fill, l = r.color ?? "currentColor", c = xr(r.color) ?? xr(r.borderColor), f = n === e1.Stroke, m = c ? L4(t, f) : !1, p = cr(l, m ? "wick" : "body", c), L = r.borderSize ?? 1, x = cr(r.borderColor ?? l, "border", c), w = r.borderStyle ?? Ve.Solid, K = r.borderRadius ?? 0, W = r.borderDashedValue ?? [2, 2], ye = n === e1.Fill || r.style === e1.StrokeFill, R = n === e1.Stroke || r.style === e1.StrokeFill;
  if (ye) {
    e.fillStyle = p, ur(e, t, K), e.fill();
    const S = cr(l, "border", c);
    !m && c && S && (e.strokeStyle = S, e.lineWidth = Math.max(1, L), e.setLineDash([]), ur(e, t, K), e.stroke());
  }
...
const d = (e, t) => {
  ...
  const [l, c] = D(window.innerWidth < 768), [f, m] = D(localStorage.getItem("klinechart_secondary_period") || ""), [p, L] = D(!1), [x, w] = D(!1), [K, W] = D(!1), [ye, R] = D(!1), [S, E] = D(!1), [ne, F] = D({
    ...
    L((M) => {
      const T = !M;
      return T ? queueMicrotask(Le) : ue(), T;
    });
  }, $e = (M) => {
    if (!p())
      return;
    const T = M.target;
    T && (r != null && r.contains(T) || n != null && n.contains(T) || (ue(), L(!1)));
  }, O = () => {
    p() && Le();
  }, N = () => {
    if (!t) {
    ...
    const M = t, T = M.scrollWidth > M.clientWidth + 2;
    ie(T && M.scrollLeft > 2), be(T && M.scrollLeft + M.clientWidth < M.scrollWidth - 2);
  };
  Tr(() => {
    window.addEventListener("resize", z), document.addEventListener("fullscreenchange", H), document.addEventListener("pointerdown", $e, !0), document.addEventListener("mousedown", $e), window.addEventListener("scroll", O, !0), document.addEventListener("mozfullscreenchange", H), document.addEventListener("webkitfullscreenchange", H), document.addEventListener("msfullscreenchange", H), t && (t.addEventListener("scroll", N), setTimeout(N, 100));
  }), vt(() => {
    window.removeEventListener("resize", z), document.removeEventListener("fullscreenchange", H), document.removeEventListener("pointerdown", $e, !0), document.removeEventListener("mousedown", $e), window.removeEventListener("scroll", O, !0), document.removeEventListener("mozfullscreenchange", H), document.removeEventListener("webkitfullscreenchange", H), document.removeEventListener("msfullscreenchange", H), t && t.removeEventListener("scroll", N);
  });
  const V = ee(() => {
    const M = e.periods.filter((T) => {
      if (!l() || j())
        return !0;
      const G = e.period.text, Q = f();
      if (T.text === G || Q && T.text === Q)
        return !0;
      if (!Q || Q === G) {
        const Z = e.periods.find((oe) => oe.text !== G);
        return T.text === (Z == null ? void 0 : Z.text);
      }
      return !1;
  ...
  return Ke(() => {
    ...
    const M = am.cloneNode(!0), T = M.firstChild, G = T.firstChild, Q = G.firstChild, Z = G.nextSibling, oe = Z.firstChild;
    return M.style.setProperty("position", "relative"), M.style.setProperty("width", "100%"), M.style.setProperty("display", "flex"), M.style.setProperty("align-items", "center"), C(M, A(fe, {
      ...
      t = k;
    }, T), T.style.setProperty("width", "100%"), T.style.setProperty("overflow", "auto"), dt(Q, "click", e.onMenuClick, !0), C(T, A(fe, {
      get when() {
        return e.symbol;
      },
      get children() {
        const k = Hf.cloneNode(!0), de = k.firstChild;
        return dt(k, "click", e.onSymbolClick, !0), C(k, A(fe, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const Ce = Zf.cloneNode(!0);
            return U(() => Oe(Ce, "src", e.symbol.logo)), Ce;
          }
        }), de), C(de, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), k;
      }
    }), Z), C(T, () => V().map((k, de) => {
      const Ce = k.text === e.period.text;
      return (() => {
        const Ie = sm.cloneNode(!0);
        return Ie.$$click = (ve) => {
          l() && Ce && !j() ? (e.onMobilePeriodClick ? e.onMobilePeriodClick(k) : e.onMenuClick(), ve.stopPropagation()) : e.onPeriodChange(k);
        }, ce(Ie, `item period ${Ce ? "selected" : ""}`), C(Ie, () => k.text), Ie;
      })();
    }), Z), C(T, A(fe, {
      get when() {
      ...
      get children() {
        ...
        return k.$$click = (de) => {
          var Ce;
          de.stopPropagation(), (Ce = e.onMobileMoreClick) == null || Ce.call(e);
      ...
      get children() {
        const k = Gf.cloneNode(!0), de = k.firstChild, Ce = de.nextSibling;
        return dt(k, "click", e.onIndicatorClick, !0), C(Ce, () => d("indicator", e.locale)), k;
      }
    }), Z), Z.style.setProperty("display", "flex"), Z.style.setProperty("height", "100%"), Z.style.setProperty("margin-left", "auto"), Z.style.setProperty("align-items", "center"), Z.style.setProperty("flex", "0 0 auto"), C(Z, A(fe, {
      get when() {
        return e.showOrderToolsMenu;
      },
      get children() {
        const k = em.cloneNode(!0), de = k.firstChild, Ce = de.firstChild, Ie = Ce.nextSibling;
        return Ct((ve) => {
          r = ve;
        }, k), k.style.setProperty("display", "flex"), k.style.setProperty("align-items", "center"), k.style.setProperty("height", "100%"), de.$$click = (ve) => {
          ve.stopPropagation(), Pe();
        }, de.style.setProperty("gap", "6px"), Ie.style.setProperty("transition", "transform 0.2s ease"), C(k, A(fe, {
          get when() {
            return p();
          },
          get children() {
            return A(d0, {
              ...
              get children() {
                const ve = Jf.cloneNode(!0), mt = ve.firstChild, _t = mt.firstChild, Pt = _t.firstChild, Qt = Pt.firstChild, kt = Qt.firstChild, Un = _t.nextSibling, f1 = Un.firstChild, U1 = f1.firstChild, R1 = U1.firstChild, Zt = f1.nextSibling, Rn = Zt.firstChild, m1 = Rn.firstChild, Dt = mt.nextSibling, Ee = Dt.firstChild, Vn = Ee.firstChild, xt = Vn.firstChild, Nt = xt.firstChild, Ot = Ee.nextSibling, nt = Ot.firstChild;
                nt.firstChild;
                const g1 = nt.nextSibling, Xe = g1.firstChild, y1 = Xe.nextSibling, p1 = y1.firstChild, It = p1.firstChild, Lt = g1.nextSibling, C1 = Lt.firstChild, v1 = Dt.nextSibling, Kn = v1.firstChild, V1 = Kn.firstChild, jn = v1.nextSibling, K1 = jn.nextSibling, Ht = K1.firstChild, b1 = Ht.firstChild, j1 = K1.nextSibling, $1 = j1.nextSibling, Q1 = $1.firstChild, Z1 = Q1.firstChild, Et = $1.nextSibling, Qe = Et.firstChild, He = Qe.firstChild, qe = He.firstChild, We = qe.firstChild, Qn = Qe.nextSibling, Wt = Qn.firstChild, _1 = Wt.firstChild, k1 = _1.firstChild, _e = Wt.nextSibling, x1 = _e.firstChild, ct = x1.firstChild, gt = _e.nextSibling, Yt = gt.firstChild, wt = Yt.firstChild, Ge = Et.nextSibling, H1 = Ge.firstChild, L1 = H1.firstChild, W1 = Ge.nextSibling, Y1 = W1.firstChild, q1 = Y1.firstChild;
                return ve.$$mousedown = (b) => b.stopPropagation(), Ct((b) => {
                  n = b;
                }, ve), ve.style.setProperty("position", "fixed"), ve.style.setProperty("z-index", "9999"), _t.$$click = (b) => {
                  b.preventDefault(), b.stopPropagation(), w((I) => !I);
                }, Qt.$$mousedown = (b) => b.stopPropagation(), Qt.$$click = (b) => b.stopPropagation(), kt.addEventListener("change", (b) => {
                  var I;
                ...
                }, xt.$$mousedown = (b) => b.stopPropagation(), xt.$$click = (b) => b.stopPropagation(), Nt.addEventListener("change", (b) => {
                  var I;
                  b.stopPropagation(), W(!0), (I = e.onOrderToolsStateChange) == null || I.call(e, {
                  ...
                  get children() {
                    ...
                    return C(b, () => ["left", "center", "right"].map((I) => (() => {
                      ...
                      return Ze.$$click = (Ue) => {
                        var rt;
                        Ue.preventDefault(), Ue.stopPropagation(), (rt = e.onOrderToolsStateChange) == null || rt.call(e, {
                          openOrdersDisplay: I
                        }), R(!1);
                      }, C(Ze, () => ji(I)), U(() => {
                        var Ue;
                        return ce(Ze, (((Ue = e.orderToolsState) == null ? void 0 : Ue.openOrdersDisplay) ?? "right") === I ? "selected" : "");
                      }), Ze;
                    })())), b;
                  }
                }), null), C(C1, () => e.orderToolsConfirmAfterDragLabel ?? "Confirm After Drag"), C(Lt, A(kr, {
                  get open() {
                    var b;
                  ...
                  const I = `${ne().top}px`, Ze = `${ne().left}px`, Ue = `${ne().minWidth}px`, rt = `klinecharts-pro-order-tools-group${x() ? " klinecharts-pro-order-tools-group-open" : ""}`, Bt = `klinecharts-pro-order-tools-group${K() ? " klinecharts-pro-order-tools-group-open" : ""}`, Je = `klinecharts-pro-order-tools-display-arrow${ye() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, G1 = `klinecharts-pro-order-tools-group${S() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return I !== b._v$ && ve.style.setProperty("top", b._v$ = I), Ze !== b._v$2 && ve.style.setProperty("left", b._v$2 = Ze), Ue !== b._v$3 && ve.style.setProperty("width", b._v$3 = Ue), rt !== b._v$4 && ce(mt, b._v$4 = rt), Bt !== b._v$5 && ce(Dt, b._v$5 = Bt), Je !== b._v$6 && Oe(It, "class", b._v$6 = Je), G1 !== b._v$7 && ce(Et, b._v$7 = G1), b;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var b, I, Ze, Ue;
                  return kt.checked = (((b = e.orderToolsState) == null ? void 0 : b.quickOrderFloatingWindow) ?? ((I = e.orderToolsState) == null ? void 0 : I.quickOrder) ?? !0) || (((Ze = e.orderToolsState) == null ? void 0 : Ze.quickOrderPlusButton) ?? ((Ue = e.orderToolsState) == null ? void 0 : Ue.quickOrder) ?? !0);
                }), U(() => {
                  var b, I;
                  ...
                  var b;
                  return Nt.checked = ((b = e.orderToolsState) == null ? void 0 : b.openOrders) ?? !0;
                }), U(() => {
                  var b;
                  ...
                  var b, I, Ze, Ue, rt, Bt;
                  return We.checked = (((b = e.orderToolsState) == null ? void 0 : b.marketPriceLine) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0) || (((Ze = e.orderToolsState) == null ? void 0 : Ze.countDown) ?? ((Ue = e.orderToolsState) == null ? void 0 : Ue.priceLine) ?? !0) || (((rt = e.orderToolsState) == null ? void 0 : rt.bidAskPrice) ?? ((Bt = e.orderToolsState) == null ? void 0 : Bt.priceLine) ?? !0);
                }), U(() => {
                  var b, I;
                  return k1.checked = ((b = e.orderToolsState) == null ? void 0 : b.marketPriceLine) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0;
                }), U(() => {
                  var b, I;
                  return ct.checked = ((b = e.orderToolsState) == null ? void 0 : b.countDown) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0;
                }), U(() => {
                  var b, I;
                  return wt.checked = ((b = e.orderToolsState) == null ? void 0 : b.bidAskPrice) ?? ((I = e.orderToolsState) == null ? void 0 : I.priceLine) ?? !0;
                }), U(() => {
                  var b;
          ...
          const mt = l() ? "0 8px" : "0 10px", _t = p() ? "rotate(180deg)" : "rotate(0deg)";
          return mt !== ve._v$8 && de.style.setProperty("padding", ve._v$8 = mt), _t !== ve._v$9 && Ie.style.setProperty("transform", ve._v$9 = _t), ve;
        }, {
          _v$8: void 0,
          _v$9: void 0
        }), k;
      ...
      const k = ee(() => !!j());
      return () => (k(), Ki.cloneNode(!0));
    })()), C(Z, A(fe, {
      get when() {
        return ee(() => !!e.chartViewToggle)() && !j();
      },
      get children() {
        const k = om.cloneNode(!0);
        return dt(k, "click", e.chartViewToggle.onToggle, !0), C(k, (() => {
          const de = ee(() => e.chartViewToggle.view === "chart");
          return () => de() ? cm.cloneNode(!0) : um.cloneNode(!0);
        })()), U(() => Oe(k, "title", e.chartViewToggle.view === "chart" ? "View Depth" : "View Chart")), k;
      }
    }), null), C(M, A(fe, {
      get when() {
        return he();
      ...
      const de = e.spread ? "" : "rotate", Ce = j() ? "0px" : "var(--klinecharts-pro-period-bar-padding-right)";
      return de !== k._v$10 && Oe(Q, "class", k._v$10 = de), Ce !== k._v$11 && Z.style.setProperty("padding-right", k._v$11 = Ce), k;
    }, {
      _v$10: void 0,
      _v$11: void 0
    }), M;
...
Ye(["click", "mousedown"]);
const hm = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M12.41465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L12.41465,12C12.20873,12.5826,11.65311,13,11,13C10.34689,13,9.79127,12.5826,9.58535,12L3.5,12C3.223857,12,3,11.77614,3,11.5C3,11.22386,3.223857,11,3.5,11L9.58535,11C9.79127,10.417404,10.34689,10,11,10C11.65311,10,12.20873,10.417404,12.41465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), fm = () => hm.cloneNode(!0), mm = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465,11L11.08535,11C11.29127,10.417404,11.84689,10,12.5,10C13.15311,10,13.70873,10.417404,13.91465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L13.91465,12C13.70873,12.5826,13.15311,13,12.5,13C11.84689,13,11.29127,12.5826,11.08535,12L6.91465,12C6.70873,12.5826,6.15311,13,5.5,13C4.671573,13,4,12.32843,4,11.5C4,10.671573,4.671573,10,5.5,10C6.15311,10,6.70873,10.417404,6.91465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), gm = () => mm.cloneNode(!0), ym = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465
z" stroke-opacity="0" fill-rule="evenodd" fill-opacity="1"></path></svg>'), Hm = () => Zm.cloneNode(!0), Wm = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M17,4.5C17,5.32843,16.328400000000002,6,15.5,6C15.0931,6,14.7241,5.83802,14.4539,5.57503L5.98992,8.32515C5.99658,8.38251,6,8.440850000000001,6,8.5C6,9.15311,5.582599999999999,9.70873,5,9.91465L5,11.08535C5.42621,11.236,5.763999999999999,11.57379,5.91465,12L19.5,12C19.7761,12,20,12.22386,20,12.5C20,12.77614,19.7761,13,19.5,13L5.91465,13C5.70873,13.5826,5.15311,14,4.5,14C3.671573,14,3,13.3284,3,12.5C3,11.84689,3.417404,11.29127,4,11.08535L4,9.91465C3.417404,9.70873,3,9.15311,3,8.5C3,7.67157,3.671573,7,4.5,7C4.90411,7,5.2709,7.15981,5.5406200000000005,7.41967L14.0093,4.66802C14.0032,4.6128599999999995,14,4.5568,14,4.5C14,3.671573,14.6716,3,15.5,3C16.328400000000002,3,17,3.671573,17,4.5ZM4,15.5C4,15.2239,4.22386,15,4.5,15L19.5,15C19.7761,15,20,15.2239,20,15.5C20,15.7761,19.7761,16,19.5,16L4.5,16C4.22386,16,4,15.7761,4,15.5ZM4,18.5C4,18.2239,4.22386,18,4.5,18L19.5,18C19.7761,18,20,18.2239,20,18.5C20,18.7761,19.7761,19,19.5,19L4.5,19C4.22386,19,4,18.7761,4,18.5Z" stroke-opacity="0" stroke="none"></path></svg>'), Ym = () => Wm.cloneNode(!0), qm = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M20,3.5C20,4.15311,19.5826,4.70873,19,4.91465L19,18.5C19,18.7761,18.7761,19,18.5,19L4.91465,19C4.70873,19.5826,4.15311,20,3.5,20C2.671573,20,2,19.3284,2,18.5C2,17.846899999999998,2.417404,17.2913,3,17.0854L3,3.5C3,3.22386,3.22386,3,3.5,3L17.0854,3C17.2913,2.417404,17.846899999999998,2,18.5,2C19.3284,2,20,2.671573,20,3.5ZM17.0854,4C17.236,4.42621,17.5738,4.763999999999999,18,4.91465L18,8L14,8L14,4L17.0854,4ZM13,4L13,8L9,8L9,4L13,4ZM13,9L9,9L9,13L13,13L13,9ZM13,14L9,14L9,18L13,18L13,14ZM14,18L14,14L18,14L18,18L14,18ZM18,13L14,13L14,9L18,9L18,13ZM4.91465,18C4.763999999999999,17.5738,4.42621,17.236,4,17.0854L4,14L8,14L8,18L4.91465,18ZM4,8L4,4L8,4L8,8L4,8ZM8,9L8,13L4,13L4,9L8,9Z" stroke-opacity="0" fill-rule="evenodd" fill-opacity="1"></path></svg>'), Gm = () => qm.cloneNode(!0), Xm = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><ellipse cx="10.5" cy="11.5" rx="1.5" ry="1.5" stroke-opacity="0" stroke="none"></ellipse><ellipse cx="17.5" cy="11.5" rx="1.5" ry="1.5" stroke-opacity="0" stroke="none"></ellipse><ellipse cx="10.5" cy="11.5" rx="7" ry="7" fill-opacity="0" fill="none" stroke-opacity="1" stroke-width="1"></ellipse></svg>'), Jm = () => Xm.cloneNode(!0), eg = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M11
  horizontalStraightLine: fm,
  horizontalRayLine: gm,
  horizontalSegment: pm,
  verticalStraightLine: vm,
  verticalRayLine: $m,
  verticalSegment: km,
  straightLine: Lm,
  rayLine: Am,
  ...
  priceLine: Nm,
  priceChannelLine: Im,
  parallelStraightLine: Bm,
  fibonacciLine: zm,
  fibonacciSegment: Rm,
  fibonacciCircle: Km,
  fibonacciSpiral: Qm,
  fibonacciSpeedResistanceFan: Hm,
  fibonacciExtension: Ym,
  gannBox: Gm,
  circle: Jm,
  triangle: tg,
  rect: rg,
...
const tt = (e) => Dg[e.name](e.class), zg = /* @__PURE__ */ $('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item magnet-mode" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Ug = /* @__PURE__ */ $('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Qi = /* @__PURE__ */ $('<li><span style="padding-left:8px"></span></li>'), Rg = "drawing_tools", Vg = (e) => {
  const [t, r] = D("horizontalStraightLine"), [n, l] = D("priceChannelLine"), [c, f] = D("circle"), [m, p] = D("fibonacciLine"), [L, x] = D("xabcd"), [w, K] = D("weak_magnet"), [W, ye] = D("normal"), [R, S] = D(!1), [E, ne] = D(!0), [F, z] = D(""), j = (H) => {
    z((X) => X === H ? "" : H);
  }, se = ee(() => [{
    key: "singleLine",
    icon: t(),
  ...
  return (() => {
    const H = zg.cloneNode(!0), X = H.firstChild, ie = X.nextSibling, he = ie.firstChild, be = he.nextSibling, Le = be.firstChild, ue = ie.nextSibling, Pe = ue.firstChild, $e = ue.nextSibling, O = $e.firstChild, N = $e.nextSibling, V = N.nextSibling, Y = V.firstChild;
    return C(H, () => se().map((M) => (() => {
      const T = Ug.cloneNode(!0), G = T.firstChild, Q = G.nextSibling, Z = Q.firstChild;
      return T.addEventListener("blur", () => {
        ...
        return () => oe() && A(Tn, {
          ...
          get children() {
            return M.list.map((k) => (() => {
              const de = Qi.cloneNode(!0), Ce = de.firstChild;
              return de.$$click = (Ie) => {
                Ie.stopPropagation(), M.setter(k.key), e.onDrawingItemClick({
                  name: k.key,
                  lock: R(),
                  mode: W()
                }), z("");
      ...
      })(), null), U(() => Oe(Z, "class", M.key === F() ? "rotate" : "")), T;
    })()), X), ie.addEventListener("blur", () => {
      z("");
    }), ie.$$click = () => {
      j("mode");
    }, C(he, (() => {
      ...
      return () => M() && A(Tn, {
        ...
        get children() {
          return q().map((T) => (() => {
            const G = Qi.cloneNode(!0), Q = G.firstChild;
            return G.$$click = (Z) => {
              Z.stopPropagation();
              const oe = W() === T.key ? "normal" : T.key;
              K(T.key), ye(oe), e.onModeChange(oe), z("");
            }, C(G, A(tt, {
              get name() {
                return T.key;
              },
              get class() {
                return W() === T.key ? "selected" : "";
              }
            }), Q), C(Q, () => T.text), U(() => ce(G, W() === T.key ? "selected" : "")), G;
          })());
        }
      });
    })(), null), Pe.$$click = () => {
      const M = !R();
      S(M), e.onLockChange(M);
    }, C(Pe, (() => {
      const M = ee(() => !!R());
      return () => M() ? A(tt, {
        name: "lock"
      ...
      name: "remove"
    })), U(() => Oe(Le, "class", F() === "mode" ? "rotate" : "")), H;
  })();
};
Ye(["click"]);
const Zi = /* @__PURE__ */ $('<li class="title"></li>'), Hi = /* @__PURE__ */ $('<li class="row"></li>'), Kg = (e) => A(Mt, {
  get title() {
...
const Qg = /* @__PURE__ */ $('<div><button type="button"></button></div>'), Zg = /* @__PURE__ */ $('<div><div class="chart-style-color-grid"></div></div>'), Hg = /* @__PURE__ */ $('<button type="button" class="chart-style-palette-color"></button>'), Wg = /* @__PURE__ */ $('<div class="chart-style-line-control"><div class="chart-style-width-picker"><button type="button" class="chart-style-size-button"><span></span></button></div></div>'), Yg = /* @__PURE__ */ $('<div class="chart-style-width-popover"></div>'), qg = /* @__PURE__ */ $('<button type="button"><span></span></button>'), Gg = /* @__PURE__ */ $('<div class="klinecharts-pro-setting-modal-title-tabs"><button type="button"></button><button type="button">Chart Style</button></div>'), Xg = /* @__PURE__ */ $('<div class="klinecharts-pro-setting-modal-content"></div>'), Yi = /* @__PURE__ */ $('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), Jg = /* @__PURE__ */ $('<div class="klinecharts-pro-chart-style-content"><div class="chart-style-sidebar"><button type="button">Symbol</button><button type="button">Background</button></div><div class="chart-style-panel"><p class="chart-style-note">* Chart Style takes precedence over default chart settings. Click Reset to align with the default theme.</p></div></div>'), ey = /* @__PURE__ */ $("<h3>Symbol</h3>"), ty = /* @__PURE__ */ $('<div class="chart-style-row"><span>Candle Stick</span><div class="chart-style-color-pair"></div></div>'), ny = /* @__PURE__ */ $('<div class="chart-style-row"><span>Borders</span><div class="chart-style-color-pair"></div></div>'), ry = /* @__PURE__ */ $('<div class="chart-style-row"><span>Wick</span><div class="chart-style-color-pair"></div></div>'), oy = /* @__PURE__ */ $("<h3>Background</h3>"), iy = /* @__PURE__ */ $('<div class="chart-style-row"><span>Color</span></div>'), ay = /* @__PURE__ */ $('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Vert Grid Lines</span></label></div>'), sy = /* @__PURE__ */ $('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Horz Grid Lines</span></label></div>'), F1 = "chart.backgroundColor", Mn = "#171a27", ly = ["#f6465d", "#f59e0b", "#fcd535", "#2ebd85", "#4098a8", "#22c1dc", "#3861fb", "#7b3fe4", "#ec8aa4", "#f7c56b", "#fff0a3", "#9ed4a4", "#83c7bb", "#8bdce6", "#8bb9f7", "#b7a1dc", "#c9343e", "#e76f20", "#f0b93a", "#3f8d3a", "#236e5a", "#237c88", "#1d3fbf", "#3a209f", "#ffffff", "#cbd5e1", "#9ca3af", "#6b7280", "#374151", "#111827", "#000000"], cy = [{
  key: Ve.Solid,
  text: "Solid"
}, {
  key: Ve.Dashed,
  ...
  const r = B.clone(e), n = B.formatValue(r, "candle.bar.upColor"), l = B.formatValue(r, "candle.bar.downColor"), c = B.formatValue(r, "candle.bar.noChangeColor");
  return Fe(r, "candle.bar.upBorderColor", B.formatValue(r, "candle.bar.upBorderColor", n)), Fe(r, "candle.bar.downBorderColor", B.formatValue(r, "candle.bar.downBorderColor", l)), Fe(r, "candle.bar.noChangeBorderColor", B.formatValue(r, "candle.bar.noChangeBorderColor", c)), Fe(r, "candle.bar.upWickColor", B.formatValue(r, "candle.bar.upWickColor", n)), Fe(r, "candle.bar.downWickColor", B.formatValue(r, "candle.bar.downWickColor", l)), Fe(r, "candle.bar.noChangeWickColor", B.formatValue(r, "candle.bar.noChangeWickColor", c)), Fe(r, "candle.bar.borderUpColor", B.formatValue(r, "candle.bar.borderUpColor", B.formatValue(r, "candle.bar.upBorderColor"))), Fe(r, "candle.bar.borderDownColor", B.formatValue(r, "candle.bar.borderDownColor", B.formatValue(r, "candle.bar.downBorderColor"))), Fe(r, "candle.bar.borderNoChangeColor", B.formatValue(r, "candle.bar.borderNoChangeColor", B.formatValue(r, "candle.bar.noChangeBorderColor"))), Fe(r, "candle.bar.wickUpColor", B.formatValue(r, "candle.bar.wickUpColor", B.formatValue(r, "candle.bar.upWickColor"))), Fe(r, "candle.bar.wickDownColor", B.formatValue(r, "candle.bar.wickDownColor", B.formatValue(r, "candle.bar.downWickColor"))), Fe(r, "candle.bar.wickNoChangeColor", B.formatValue(r, "candle.bar.wickNoChangeColor", B.formatValue(r, "candle.bar.noChangeWickColor"))), Fe(r, F1, t), r;
}, dy = (e, t, r) => {
  if (t === F1)
    return r ?? Mn;
  const l = {
  ...
  const [t, r] = D(e.currentStyles), [n, l] = D(V0(e.currentStyles, e.currentBackgroundColor ?? Mn)), [c, f] = D(Wi(e.locale)), [m, p] = D(e.timezone), [L, x] = D(!1), [w, K] = D("settings"), [W, ye] = D("symbol"), [R, S] = D(null), [E, ne] = D({}), [F, z] = D(null), j = () => Intl.DateTimeFormat().resolvedOptions().timeZone, se = () => {
    x(window.innerWidth <= 768);
  };
  Tr(() => {
    const O = (N) => {
      const V = N.target;
      V instanceof Element && (V.closest(".chart-style-color-picker") || V.closest(".chart-style-width-picker") || V.closest(".klinecharts-pro-select") || (S(null), z(null)));
    };
    se(), window.addEventListener("resize", se), document.addEventListener("mousedown", O), vt(() => {
  ...
  const q = () => R0(e.locale), H = (O, N) => {
    const V = {};
    Fe(V, O.key, N);
    const Y = B.clone(t());
    Fe(Y, O.key, N), r(Y), f(c().map((M) => ({
      ...M
    }))), e.onChange(V);
  }, X = (O, N) => B.formatValue(n(), O, N), ie = (O, N) => {
    const V = B.clone(n());
    Fe(V, O, N), l(V), e.onChange(he(V));
  }, he = (O) => {
    const N = B.formatValue(O, "candle.bar.upColor"), V = B.formatValue(O, "candle.bar.downColor"), Y = B.formatValue(O, "candle.bar.noChangeColor"), M = B.formatValue(O, "candle.bar.upBorderColor", N), T = B.formatValue(O, "candle.bar.downBorderColor", V), G = B.formatValue(O, "candle.bar.noChangeBorderColor", Y), Q = B.formatValue(O, "candle.bar.upWickColor", N), Z = B.formatValue(O, "candle.bar.downWickColor", V), oe = B.formatValue(O, "candle.bar.noChangeWickColor", Y);
    return {
      chart: {
      ...
      candle: {
        ...
        bar: {
          ...
          upWickColor: Q,
          downWickColor: Z,
          noChangeWickColor: oe,
          borderUpColor: M,
          borderDownColor: T,
          borderNoChangeColor: G,
          wickUpColor: Q,
          wickDownColor: Z,
          wickNoChangeColor: oe
        }
      },
      grid: {
        horizontal: {
    ...
    if (O) {
      const V = B.clone(n());
      qi.forEach((Y) => {
        Fe(V, Y.key, dy(O, Y.key, e.defaultBackgroundColor));
    ...
    const V = X(O, "#ffffff");
    return (() => {
      const Y = Qg.cloneNode(!0), M = Y.firstChild;
      return ce(Y, `chart-style-color-picker chart-style-color-picker-${N}`), M.$$click = (T) => {
        const G = R() === N ? null : N;
        if (G && L()) {
          const Q = T.currentTarget.closest(".klinecharts-pro-modal .inner"), Z = Q == null ? void 0 : Q.getBoundingClientRect();
          if (Z) {
            const k = T.currentTarget.getBoundingClientRect().bottom + 10;
            ne({
              position: "fixed",
              left: `${Z.left + 16}px`,
              right: `${window.innerWidth - Z.right + 16}px`,
              top: `${k}px`,
              width: "auto",
              "max-width": `${Z.width - 16 * 2}px`,
              "max-height": `${Math.max(150, window.innerHeight - k - 96)}px`,
              "overflow-y": "auto"
            });
          }
        } else
          ne({});
        S(G);
      }, ce(M, `chart-style-color-swatch chart-style-color-swatch-${N}`), M.style.setProperty("background", V), C(Y, (() => {
        const T = ee(() => R() === N);
        return () => T() && (() => {
          const G = Zg.cloneNode(!0), Q = G.firstChild;
          return ce(G, `chart-style-color-popover chart-style-color-popover-${N}`), C(Q, A(r1, {
            each: ly,
            children: (Z) => (() => {
              const oe = Hg.cloneNode(!0);
              return oe.$$click = () => {
                ie(O, Z), S(null);
              }, oe.style.setProperty("background", Z), U(() => oe.classList.toggle("selected", Z.toLowerCase() === V.toLowerCase())), oe;
            })()
          })), U((Z) => bt(G, E(), Z)), G;
        })();
      })(), null), Y;
    ...
    const N = `${O}.style`, V = `${O}.color`, Y = `${O}.size`, M = X(N, Ve.Dashed), T = Math.max(1, Number(X(Y, 1)));
    return (() => {
      const G = Wg.cloneNode(!0), Q = G.firstChild, Z = Q.firstChild, oe = Z.firstChild;
      return C(G, A(vn, {
        get style() {
          return {
            width: L() ? "100%" : "134px"
        ...
        onSelected: (k) => {
          const de = k.key;
          ie(N, de), ie(`${O}.dashedValue`, de === Ve.Solid ? [] : [2, 2]);
        }
      }), Q), Z.$$click = () => {
        z(F() === Y ? null : Y);
      }, oe.style.setProperty("height", `${T}px`), C(Q, (() => {
        const k = ee(() => F() === Y);
        return () => k() && (() => {
          const de = Yg.cloneNode(!0);
          return C(de, A(r1, {
            each: uy,
            children: (Ce) => (() => {
              const Ie = qg.cloneNode(!0), ve = Ie.firstChild;
              return Ie.$$click = () => {
                ie(Y, Ce), z(null);
              }, Ie.classList.toggle("selected", T === Ce), ve.style.setProperty("height", `${Ce}px`), Ie;
            })()
          })), de;
        })();
      })(), null), C(G, () => ue(V), null), G;
    })();
  }, $e = (() => {
    const O = Gg.cloneNode(!0), N = O.firstChild, V = N.nextSibling;
    return N.$$click = () => K("settings"), C(N, () => d("setting", e.locale)), V.$$click = () => K("chartStyle"), U((Y) => {
      const M = w() === "settings", T = w() === "chartStyle";
      return M !== Y._v$ && N.classList.toggle("active", Y._v$ = M), T !== Y._v$2 && V.classList.toggle("active", Y._v$2 = T), Y;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), O;
      ...
      return ee(() => w() === "settings")() ? (() => {
        ...
        return C(O, A(r1, {
          ...
          children: (N) => {
            ...
            switch (N.component) {
              case "select": {
                const M = N.key === "candle.type" ? "170px" : "120px", T = `klinecharts-pro-setting-select klinecharts-pro-setting-select-${N.key.replace(/[^a-zA-Z0-9_-]/g, "-")}`, G = `klinecharts-pro-setting-dropdown klinecharts-pro-setting-dropdown-${N.key.replace(/[^a-zA-Z0-9_-]/g, "-")}`;
                V = A(vn, {
                  class: T,
                  dropdownClass: G,
                  get style() {
            ...
            return (() => {
              const M = Yi.cloneNode(!0), T = M.firstChild, G = T.nextSibling;
              return C(T, () => N.text), C(G, V), U(() => M.classList.toggle("mobile-item", !!L())), M;
            })();
          }
        }), null), C(O, (() => {
          ...
          return () => N() && (() => {
            ...
            return C(Y, () => d("timezone", e.locale)), C(M, A(vn, {
              ...
              get value() {
                var T;
                return ((T = m()) == null ? void 0 : T.text) ?? e.timezone.text;
              },
              get dataSource() {
                return q();
              },
              ...
              onSelected: (T) => {
                var Q;
                const G = T;
                p(G), (Q = e.onTimezoneChange) == null || Q.call(e, G);
              }
            })), U(() => V.classList.toggle("mobile-item", !!L())), V;
          })();
        })(), null), U(() => O.classList.toggle("mobile-layout", !!L())), O;
      })() : (() => {
        const O = Jg.cloneNode(!0), N = O.firstChild, V = N.firstChild, Y = V.nextSibling, M = N.nextSibling, T = M.firstChild;
        return V.$$click = () => ye("symbol"), Y.$$click = () => ye("background"), C(M, (() => {
          const G = ee(() => W() === "symbol");
          return () => G() ? [ey.cloneNode(!0), (() => {
            const Q = ty.cloneNode(!0), Z = Q.firstChild, oe = Z.nextSibling;
            return C(oe, () => ue("candle.bar.upColor", "candle-stick-up"), null), C(oe, () => ue("candle.bar.downColor", "candle-stick-down"), null), Q;
          })(), (() => {
            const Q = ny.cloneNode(!0), Z = Q.firstChild, oe = Z.nextSibling;
            return C(oe, () => ue("candle.bar.upBorderColor", "border-up"), null), C(oe, () => ue("candle.bar.downBorderColor", "border-down"), null), Q;
          })(), (() => {
            const Q = ry.cloneNode(!0), Z = Q.firstChild, oe = Z.nextSibling;
            return C(oe, () => ue("candle.bar.upWickColor", "wick-up"), null), C(oe, () => ue("candle.bar.downWickColor", "wick-down"), null), Q;
          })()] : [oy.cloneNode(!0), (() => {
            const Q = iy.cloneNode(!0);
            return Q.firstChild, C(Q, () => ue(F1, "chart-background"), null), Q;
          })(), (() => {
            const Q = ay.cloneNode(!0), Z = Q.firstChild, oe = Z.firstChild;
            return oe.addEventListener("change", (k) => ie("grid.vertical.show", k.currentTarget.checked)), C(Q, () => Pe("grid.vertical"), null), U(() => oe.checked = !!X("grid.vertical.show")), Q;
          })(), (() => {
            const Q = sy.cloneNode(!0), Z = Q.firstChild, oe = Z.firstChild;
            return oe.addEventListener("change", (k) => ie("grid.horizontal.show", k.currentTarget.checked)), C(Q, () => Pe("grid.horizontal"), null), U(() => oe.checked = !!X("grid.horizontal.show")), Q;
          })()];
        })(), T), U((G) => {
          const Q = !!L(), Z = W() === "symbol", oe = W() === "background";
          return Q !== G._v$3 && O.classList.toggle("mobile-layout", G._v$3 = Q), Z !== G._v$4 && V.classList.toggle("active", G._v$4 = Z), oe !== G._v$5 && Y.classList.toggle("active", G._v$5 = oe), G;
        }, {
          _v$3: void 0,
          _v$4: void 0,
          _v$5: void 0
...
Ye(["click"]);
const fy = /* @__PURE__ */ $('<img style="width:500px;margin-top: 20px">'), my = (e) => A(Mt, {
  get title() {
...
}, yy = /* @__PURE__ */ $('<div class="klinecharts-pro-indicator-setting-modal-content"></div>'), py = /* @__PURE__ */ $("<span></span>"), Cy = (e) => {
  const [t, r] = D(B.clone(e.params.calcParams)), n = (l) => gy[l];
  return A(Mt, {
    get title() {
      ...
      return [{
        ...
        onClick: () => {
          ...
          B.clone(t()).forEach((f, m) => {
            !B.isValid(f) || f === "" ? "default" in l[m] && c.push(l[m].default) : c.push(f);
    ...
    get children() {
      const l = yy.cloneNode(!0);
      return C(l, () => n(e.params.indicatorName).map((c, f) => [(() => {
        const m = py.cloneNode(!0);
        return C(m, () => d(c.paramNameKey, e.locale)), m;
      })(), A(z0, {
        style: {
          width: "200px"
        },
...
}, vy = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z"></path></svg>'), by = /* @__PURE__ */ $('<img alt="symbol">'), $y = /* @__PURE__ */ $("<li><div><span></span></div></li>"), _y = (e) => {
  ...
  return A(Mt, {
    ...
    get children() {
      return [A(z0, {
        ...
        renderItem: (l) => (() => {
          const c = $y.cloneNode(!0), f = c.firstChild, m = f.firstChild;
          return c.$$click = () => {
            ...
            get children() {
              const p = by.cloneNode(!0);
              return U(() => Oe(p, "src", l.logo)), p;
            }
          }), m), C(m, () => l.shortName ?? l.ticker, null), C(m, () => `${l.name ? `(${l.name})` : ""}`, null), C(c, () => l.exchange ?? "", null), U(() => Oe(m, "title", l.name ?? "")), c;
        })()
      })];
    }
  });
...
const ky = /* @__PURE__ */ $('<div class="klinecharts-pro-mobile-more-modal-content"><div class="item"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="20" height="20" rx="4" ry="4" fill="none" stroke="currentColor" stroke-width="2"></rect><path d="m15.92 13.9-3.65-3.55a.773.773 0 0 1 0-1.12c.32-.33.79-.33 1.11 0l3.02 3.38c.31.32.31.81 0 1.13-.16.16-.48.16-.48.16Z" fill="currentColor" stroke="1"></path><path d="m12.43 14.23-.48-.17q-.48-.48 0-.96l4.13-4.36c.31-.32.63-.32.95 0s.32.65 0 .97l-4.13 4.35c-.15.17-.31.17-.47.17Zm-1.11-9
  ...
  get children() {
    const t = ky.cloneNode(!0), r = t.firstChild, n = r.firstChild, l = n.nextSibling, c = r.nextSibling, f = c.firstChild, m = f.nextSibling, p = c.nextSibling, L = p.nextSibling, x = L.firstChild, w = x.nextSibling;
    return r.$$click = () => {
...
Ye(["click"]);
const Ly = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-picker"></div>'), wy = /* @__PURE__ */ $('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), Ay = /* @__PURE__ */ $("<span></span>"), Sy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), Ty = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-grid"></div>'), My = /* @__PURE__ */ $('<span class="weekday"></span>'), Vt = /* @__PURE__ */ $('<button type="button"></button>'), Py = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid"></div>'), Dy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), Ny = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), Oy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-content"></div>'), Iy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-tabs"></div>'), Ey = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), By = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), Fy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), zy = [{
  key: "goToDate",
  label: "Go to Date"
}, {
  key: "timeRange",
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], Uy = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], Gi = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], n1 = (e) => String(e).padStart(2, "0"), Xi = (e, t, r) => Math.min(r, new Date(e, t + 1, 0).getDate()), dr = (e) => {
  const t = new Date(e);
  return {
    year: t.getFullYear(),
    month: t.getMonth(),
  ...
  const [t, r] = D(!0), [n, l] = D("date"), [c, f] = D(e.value.year), [m, p] = D(e.value.month), L = ee(() => Ry(c(), m())), x = ee(() => Math.floor(c() / 10) * 10), w = ee(() => Array.from({
    length: 12
  }, (q, H) => x() - 1 + H)), K = ee(() => e.value.hour % 12 || 12), W = ee(() => e.value.hour >= 12 ? "PM" : "AM"), ye = Array.from({
    length: 12
  }, (q, H) => H + 1), R = Array.from({
    length: 60
  }, (q, H) => H), S = (q) => {
    const H = new Date(c(), m() + q, 1);
    f(H.getFullYear()), p(H.getMonth());
  }, E = () => {
    ...
    e.onChange({
      ...
      month: q.getMonth(),
      day: q.getDate()
    }), (H = e.onDateSelect) == null || H.call(e), f(q.getFullYear()), p(q.getMonth());
  }, F = (q) => {
    p(q), e.onChange({
      ...e.value,
      year: c(),
      month: q,
      day: Xi(c(), q, e.value.day)
    }), l("date");
  }, z = (q) => {
    f(q), e.onChange({
      ...e.value,
      year: q,
      day: Xi(q, e.value.month, e.value.day)
    }), l("month");
  }, j = (q) => {
    const H = W() === "PM";
    e.onChange({
      ...e.value,
      hour: H ? q === 12 ? 12 : q + 12 : q === 12 ? 0 : q
    });
  }, se = (q) => {
    const H = K();
    e.onChange({
      ...e.value,
      hour: q === "PM" ? H === 12 ? 12 : H + 12 : H === 12 ? 0 : H
    });
  };
  return (() => {
    const q = Ly.cloneNode(!0);
    return C(q, (() => {
      const H = ee(() => e.showInput !== !1);
      return () => H() && (() => {
        const X = wy.cloneNode(!0), ie = X.firstChild, he = ie.firstChild;
        return C(X, (() => {
          const be = ee(() => !!e.label);
          return () => be() && (() => {
            const Le = Ay.cloneNode(!0);
            return C(Le, () => e.label), Le;
          })();
        })(), ie), ie.$$click = () => r(!t()), C(he, () => wr(e.value)), X;
      })();
    })(), null), C(q, (() => {
      const H = ee(() => !!t());
      return () => H() && (() => {
        const X = Sy.cloneNode(!0), ie = X.firstChild, he = ie.firstChild, be = he.nextSibling, Le = be.nextSibling, ue = Le.nextSibling, Pe = ue.nextSibling;
        return he.$$click = () => {
          n() === "year" ? f(c() - 10) : n() === "month" ? f(c() - 1) : S(-12);
        }, be.$$click = () => {
          n() === "year" ? f(c() - 10) : n() === "month" ? f(c() - 1) : S(-1);
        }, Le.$$click = E, C(Le, (() => {
          const $e = ee(() => n() === "year");
          return () => $e() ? `${x()}-${x() + 9}` : (() => {
            const O = ee(() => n() === "month");
          ...
          const $e = ee(() => n() === "date");
          return () => $e() && (() => {
            const O = Ty.cloneNode(!0);
            return C(O, () => Uy.map((N) => (() => {
              const V = My.cloneNode(!0);
              return C(V, N), V;
            })()), null), C(O, () => L().map(({
              date: N,
              current: V
              ...
              const Y = hr({
                ...
                month: N.getMonth(),
                day: N.getDate()
              }), M = e.range ? hr(e.range.from) : NaN, T = e.range ? hr(e.range.to) : NaN, G = Math.min(M, T), Q = Math.max(M, T), Z = Number.isFinite(G) && Y >= G && Y <= Q, oe = Number.isFinite(G) && (Y === G || Y === Q), k = N.getFullYear() === e.value.year && N.getMonth() === e.value.month && N.getDate() === e.value.day;
              return (() => {
                const de = Vt.cloneNode(!0);
                return de.$$click = () => ne(N), ce(de, `${V ? "" : "muted"} ${Z ? "in-range" : ""} ${oe || k ? "selected" : ""}`), C(de, () => N.getDate()), de;
              })();
            }), null), O;
          })();
        })(), null), C(X, (() => {
          const $e = ee(() => n() === "month");
          return () => $e() && (() => {
            const O = Py.cloneNode(!0);
            return C(O, () => Gi.map((N, V) => (() => {
              const Y = Vt.cloneNode(!0);
              return Y.$$click = () => F(V), C(Y, N), U(() => ce(Y, V === e.value.month && c() === e.value.year ? "selected" : "")), Y;
            })())), O;
          })();
        })(), null), C(X, (() => {
          const $e = ee(() => n() === "year");
          return () => $e() && (() => {
            ...
            return C(O, () => w().map((N) => (() => {
              const V = Vt.cloneNode(!0);
              return V.$$click = () => z(N), C(V, N), U(() => ce(V, `${N < x() || N > x() + 9 ? "muted" : ""} ${N === e.value.year ? "selected" : ""}`)), V;
            })())), O;
          })();
        })(), null), C(X, (() => {
          const $e = ee(() => n() === "date");
          return () => $e() && (() => {
            const O = Ny.cloneNode(!0), N = O.firstChild, V = N.nextSibling, Y = V.nextSibling;
            return C(N, () => ye.map((M) => (() => {
              const T = Vt.cloneNode(!0);
              return T.$$click = () => j(M), C(T, () => n1(M)), U(() => ce(T, M === K() ? "selected" : "")), T;
            })())), C(V, () => R.map((M) => (() => {
              const T = Vt.cloneNode(!0);
              return T.$$click = () => e.onChange({
                ...e.value,
                minute: M
              }), C(T, () => n1(M)), U(() => ce(T, M === e.value.minute ? "selected" : "")), T;
            })())), C(Y, () => ["AM", "PM"].map((M) => (() => {
              const T = Vt.cloneNode(!0);
              return T.$$click = () => se(M), C(T, M), U(() => ce(T, M === W() ? "selected" : "")), T;
            })())), O;
          })();
        })(), null), X;
      })();
  ...
  const [t, r] = D(e.initialTab ?? "goToDate"), [n, l] = D(dr(e.initialTimestamp)), [c, f] = D(dr(e.initialRange.from)), [m, p] = D(dr(e.initialRange.to)), [L, x] = D("from"), [w, K] = D({
    ...e.anchorSettings,
    ...
    if (R === "goToDate")
      ...
      e.onTimeAnchorChange({
        ...S,
        timestamp: S.anchorPoint === "date" ? mn(n()) : S.timestamp
      });
    }
    e.onClose();
  };
  return A(Mt, {
    ...
    get title() {
      return (() => {
        ...
        return C(R, () => zy.map((S) => (() => {
          ...
          return E.$$click = () => r(S.key), C(E, () => S.label), U(() => ce(E, t() === S.key ? "active" : "")), E;
        })())), R;
      })();
    },
    get buttons() {
    ...
    get children() {
      ...
      return C(R, (() => {
        ...
        const S = ee(() => t() === "timeRange");
        return () => S() && (() => {
          const E = Ey.cloneNode(!0), ne = E.firstChild, F = ne.firstChild, z = F.nextSibling, j = z.nextSibling;
          return F.$$click = () => x("from"), C(F, () => wr(c())), j.$$click = () => x("to"), C(j, () => wr(m())), C(E, (() => {
            const se = ee(() => L() === "from");
            return () => se() ? A(gn, {
              label: "Start",
              get value() {
            ...
            const q = L() === "from" ? "active" : "", H = L() === "to" ? "active" : "";
            return q !== se._v$ && ce(F, se._v$ = q), H !== se._v$2 && ce(j, se._v$2 = H), se;
          }, {
            _v$: void 0,
            _v$2: void 0
          }), E;
        ...
        const S = ee(() => t() === "timeAnchor");
        return () => S() && (() => {
          const E = By.cloneNode(!0), ne = E.firstChild, F = ne.firstChild, z = F.nextSibling, j = ne.nextSibling, se = j.firstChild, q = se.nextSibling, H = j.nextSibling, X = H.firstChild, ie = X.nextSibling, he = H.nextSibling, be = he.firstChild, Le = be.nextSibling;
          return z.$$click = () => W({
            enabled: !w().enabled
          }), q.addEventListener("change", (ue) => W({
            anchorPoint: ue.currentTarget.value
          })), C(E, (() => {
            const ue = ee(() => !!(w().enabled && w().anchorPoint === "date"));
            return () => ue() && (() => {
              const Pe = Fy.cloneNode(!0);
              return C(Pe, A(gn, {
                label: "Anchor date",
                get value() {
                  return n();
            ...
            const Pe = `klinecharts-pro-time-tools-switch${w().enabled ? " on" : ""}`, $e = `klinecharts-pro-time-tools-row${w().enabled ? "" : " disabled"}`, O = !w().enabled, N = `klinecharts-pro-time-tools-row with-divider${w().enabled ? "" : " disabled"}`, V = `klinecharts-pro-time-tools-switch${w().anchorLine ? " on" : ""}`, Y = !w().enabled, M = `klinecharts-pro-time-tools-row with-divider${w().enabled ? "" : " disabled"}`, T = `klinecharts-pro-time-tools-switch${w().acrossTokens ? " on" : ""}`, G = !w().enabled;
            return Pe !== ue._v$3 && ce(z, ue._v$3 = Pe), $e !== ue._v$4 && ce(j, ue._v$4 = $e), O !== ue._v$5 && (q.disabled = ue._v$5 = O), N !== ue._v$6 && ce(H, ue._v$6 = N), V !== ue._v$7 && ce(ie, ue._v$7 = V), Y !== ue._v$8 && (ie.disabled = ue._v$8 = Y), M !== ue._v$9 && ce(he, ue._v$9 = M), T !== ue._v$10 && ce(Le, ue._v$10 = T), G !== ue._v$11 && (Le.disabled = ue._v$11 = G), ue;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
function Qy(e, t, r) {
  ...
  return Math.max(l * jy, Number.EPSILON);
}
function Zy({
  visibleCandles: e = [],
  visibleIndicators: t = [],
  ...
  e.forEach((w) => {
    ...
    K != null && c.push(K), W != null && c.push(W);
  }), t.forEach((w) => {
    Pn(w, c);
  }), r.forEach((w) => {
    Pn(w, c);
  ...
  if (c.forEach((w) => {
    ...
    return null;
  const L = Math.min(Math.max(l, 0), 0.25), x = Qy(m, p, L);
  return {
    minPrice: m - x,
    maxPrice: p + x
  };
}
const Hy = (e = !0) => e !== !1, Wy = /* @__PURE__ */ $('<i class="icon-close klinecharts-pro-load-icon"></i>'), Yy = /* @__PURE__ */ $('<div class="klinecharts-pro-content"><button type="button">auto</button><div class="klinecharts-pro-widget"></div></div>'), qy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-anchor-line"></div>'), Gy = /* @__PURE__ */ $('<div class="klinecharts-pro-time-navigation-tooltip"></div>'), Xy = /* @__PURE__ */ $('<div class="klinecharts-pro-mobile-candle-tooltip"></div>'), Jy = /* @__PURE__ */ $('<div class="klinecharts-pro-mobile-candle-tooltip-row"><span class="label"></span><span class="value"></span></div>'), ep = /* @__PURE__ */ $('<div class="klinecharts-pro-countdown-price-mark"><span class="klinecharts-pro-countdown-price-mark-price"></span><span class="klinecharts-pro-countdown-price-mark-timer"></span></div>'), tp = /* @__PURE__ */ $('<div class="overlay-toolbar-color-popover"><div class="overlay-toolbar-color-grid"></div><div class="overlay-toolbar-color-footer"><button type="button" class="overlay-toolbar-add-color">+</button><div class="overlay-toolbar-color-slider"><span></span></div></div></div>'), np = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown width-menu"></div>'), rp = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown style-menu"><button type="button"><span class="overlay-toolbar-style-sample solid"></span></button><button type="button"><span class="overlay-toolbar-style-sample dashed"></span></button><button type="button"><span class="overlay-toolbar-style-sample dotted"></span></button></div>'), op = /* @__PURE__ */ $('<div class="klinecharts-pro-overlay-toolbar"><button type="button" class="overlay-toolbar-icon drag" title="Move"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="6" r="1.5"></circle><circle cx="15" cy="6" r="1.5"></circle><circle cx="9" cy="12" r="1.5"></circle><circle cx="15" cy="12" r="1.5"></circle><circle cx="9" cy="18" r="1.5"></circle><circle cx="15" cy="18" r="1.5"></circle></svg></button><button type="button" class="overlay-toolbar-icon refresh" title="Reset"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 0 1 15.4-6.36L21 8"></path><path d="M21 3v5h-5"></path><path d="M21 12a9 9 0 0 1-15.4 6.36L3 16"></path><path d="M3 21v-5h5"></path></svg></button><div class="overlay-toolbar-picker"><button type="button" title="Color"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line width"><span class="overlay-toolbar-line-preview"></span><span>px</span></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line style"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 12h16"></path></svg></button></div><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="5" width="14" height="14" rx="2"></rect><path d="M20 4 4 20"></path></svg></button><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="10" width="14" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></button><button type="button" class="overlay-toolbar-icon delete" title="Delete"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"></path><path d="M8 6V4h8v2"></path><path d="M19 6 18 20H6L5 6"></path><path d="M10 11v5"></path><path d="M14 11v5"></path></svg></button></div>'), ip = /* @__PURE__ */ $('<button type="button"></button>'), ap = /* @__PURE__ */ $('<button type="button"><span class="overlay-toolbar-width-sample"></span></button>'), sp = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-marker"><button type="button" class="klinecharts-pro-quick-order-plus"></button></div>'), lp = /* @__PURE__ */ $('<span class="klinecharts-pro-quick-order-plus-icon"></span>'), cp = /* @__PURE__ */ $('<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3" aria-hidden="true"><path d="M460-300h40v-160h160v-40H500v-160h-40v160H300v40h160v160ZM224.62-160q-27.62 0-46.12-18.5Q160-197 160-224.62v-510.76q0-27.62 18.5-46.12Q197-800 224.62-800h510.76q27.62 0 46.12 18.5Q800-763 800-735.38v510.76q0 27.62-18.5 46.12Q763-160 735.38-160H224.62Zm0-40h510.76q9.24 0 16.93-7.69 7.69-7.69 7.69-16.93v-510.76q0-9.24-7.69-16.93-7.69-7.69-16.93-7.69H224.62q-9.24 0-16.93 7.69-7.69 7.69-7.69 16.93v510.76q0 9.24 7.69 16.93 7.69 7.69 16.93 7.69ZM200-760v560-560Z"></path></svg>'), up = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-menu-anchor"><div class="klinecharts-pro-quick-order-menu"><button type="button">Trade <!> @ <!> Limit</button><button type="button">Trade <!> @ <!> Stop</button><button type="button">Create new order...</button><button type="button">Copy Price (<!>)</button><button type="button">Draw horizontal line on </button></div></div>');
A4();
const fr = "klinecharts_pro_chart_style", mr = "klinecharts_pro_chart_background_color", Ar = "klinecharts_pro_time_anchor_settings", Ut = "candle_pane", dp = 4, hp = /* @__PURE__ */ new Set(["rect", "circle", "straightLine", "rayLine", "segment", "arrow", "fibonacciLine", "fibonacciSegment", "fibonacciCircle", "fibonacciSpiral", "fibonacciSpeedResistanceFan", "gannBox", "priceLine", "horizontalRayLine", "horizontalSegment", "verticalRayLine", "verticalSegment"]), fp = 0.08, mp = 80, Ji = 2e-3, gp = /* @__PURE__ */ new Set(["horizontalRayLine", "horizontalSegment", "horizontalStraightLine", "orderLine", "priceLine"]);
function K0() {
  return {
    enabled: !1,
    timestamp: Date.now(),
...
const Cp = (e) => {
  var Ao, So, To, Mo, Po, Do, No, Oo, Io, Eo, Bo, Fo, zo, Uo, Ro, Vo, Ko, jo, Qo, Zo, Ho, Wo, Yo, qo, Go, Xo, Jo, ei, ti, ni, ri;
  let t, r, n = null, l, c = null, f = null;
  const [m, p] = D(!1), [L, x] = D(e.theme), [w, K] = D(e.styles), [W, ye] = D(e.locale), [R, S] = D(e.symbol), [E, ne] = D(e.period), F = () => {
    var o, i, a, s;
    return {
  ...
  }, [z, j] = D(!1), [se, q] = D([...e.mainIndicators]), [H, X] = D({}), [ie, he] = D(!1), [be, Le] = D({
    key: e.timezone,
  ...
  }, G = () => t ? getComputedStyle(t).getPropertyValue("--klinecharts-pro-chart-background-color").trim() || M() || T() : M() ?? T(), Q = (o) => {
    var a;
    ...
    return a;
  }, [oe, k] = D(""), [de, Ce] = D(!1), [Ie, ve] = D(Date.now()), [mt, _t] = D({
    from: Date.now() - 30 * 24 * 60 * 60 * 1e3,
    to: Date.now()
  }), [Pt, Qt] = D(yp() ?? K0()), [kt, Un] = D(e.drawingBarVisible), [f1, U1] = D(!1), [R1, Zt] = D(!1), [Rn, m1] = D(!1), Dt = ((Ao = e.orderTools) == null ? void 0 : Ao.quickOrder) ?? !0, [Ee, Vn] = D({
    quickOrder: Dt,
    quickOrderFloatingWindow: ((So = e.orderTools) == null ? void 0 : So.quickOrderFloatingWindow) ?? Dt,
    quickOrderPlusButton: ((To = e.orderTools) == null ? void 0 : To.quickOrderPlusButton) ?? Dt,
  ...
  let _e = /* @__PURE__ */ new Map(), x1 = /* @__PURE__ */ new Map(), ct, gt, Yt = null, wt;
  ...
  const I = (o, i, a) => {
    ...
    const o = se().map((a) => I(a, Ut, "main")), i = Object.entries(H()).map(([a, s]) => I(a, s, "sub"));
    return {
      main: o,
      sub: i
    };
  }, Ue = () => {
    var a, s, u, y, h, g, v, _, P, te, ae, le, ge, J, we, Ae;
    if (!n)
      return {};
    ...
    return {
      ...
      showHighestPrice: (_ = (v = (g = o.candle) == null ? void 0 : g.priceMark) == null ? void 0 : v.high) == null ? void 0 : _.show,
      showLowestPrice: (ae = (te = (P = o.candle) == null ? void 0 : P.priceMark) == null ? void 0 : te.low) == null ? void 0 : ae.show,
      showIndicatorLastValue: (ge = (le = o.indicator) == null ? void 0 : le.lastValueMark) == null ? void 0 : ge.show,
      priceAxisType: (J = o.yAxis) == null ? void 0 : J.type,
      reverseCoordinate: (we = o.yAxis) == null ? void 0 : we.reverse,
      showGrids: (Ae = o.grid) == null ? void 0 : Ae.show,
      timezone: be().key,
      timestamp: Date.now()
    };
  }, rt = () => {
    ...
    return {
      ...
      period: E(),
      timezone: be().key,
      styles: ((o = n == null ? void 0 : n.getStyles) == null ? void 0 : o.call(n)) ?? {},
      settings: Ue(),
      indicators: Ze(),
      drawings: Array.from(_e.values()),
      orderTools: Ee(),
      drawingBarVisible: kt(),
      autoScale: {
        enabled: Ge(),
    ...
    const i = rt(), a = `chart-configuration-${i.symbol.ticker.replace(/[^a-z0-9_-]/gi, "_")}-${Date.now()}.json`, s = new Blob([JSON.stringify(i, null, 2)], {
      type: "application/json"
    }), u = URL.createObjectURL(s), y = document.createElement("a");
    y.href = u, y.download = o || a, y.click(), URL.revokeObjectURL(u);
  }, Je = (o, i, a, s) => {
    ...
    var o;
    return (o = n == null ? void 0 : n.getPaneById) == null ? void 0 : o.call(n, Ut);
  }, X1 = () => {
    var o, i;
    return (i = (o = G1()) == null ? void 0 : o.getAxisComponent) == null ? void 0 : i.call(o);
  }, Vr = () => {
    var s, u;
    const o = (u = (s = X1()) == null ? void 0 : s.getExtremum) == null ? void 0 : u.call(s), i = Number(o == null ? void 0 : o.min), a = Number(o == null ? void 0 : o.max);
    ...
    if (!o || !(n != null && n.getIndicatorByPaneId))
      return [];
    const i = n.getIndicatorByPaneId(Ut), a = i instanceof Map ? Array.from(i.values()) : i ? [i] : [], s = [];
    return a.forEach((u) => {
      ...
      for (let g = o.from; g <= o.to; g += 1) {
        const v = h[g];
        v && y.forEach((_) => {
          (_ == null ? void 0 : _.key) != null && s.push(v[_.key]);
        });
      }
    }), s;
  }, Z0 = () => {
    ...
    const o = [], i = (u) => {
      ...
      gp.has(y) && ((h = u.points) == null || h.forEach((g) => {
    ...
    _e.forEach(i);
    const a = C1();
    return a && i(Qr((s = n == null ? void 0 : n.getOverlayById) == null ? void 0 : s.call(n, a))), x1.forEach((u) => {
      u.forEach((y) => {
    ...
    if (!n || !(a != null && a.setExtremum))
      return;
    const s = o.minPrice, u = o.maxPrice, y = ((g = a.convertToRealValue) == null ? void 0 : g.call(a, s)) ?? s, h = ((v = a.convertToRealValue) == null ? void 0 : v.call(a, u)) ?? u;
    a.setExtremum({
      min: s,
      max: u,
      range: u - s,
      ...
      realMax: h,
      realRange: h - y
    }), (_ = n.adjustPaneViewport) == null || _.call(n, !1, !0, !0, !0), i && ((P = a.setAutoCalcTickFlag) == null || P.call(a, !0)), q1(o);
  }, q0 = (o = !1) => {
    var a, s, u;
    if (!n || !Ge())
      return;
    const i = W0();
    if (!i) {
      (s = (a = X1()) == null ? void 0 : a.setAutoCalcTickFlag) == null || s.call(a, !0), (u = n.resize) == null || u.call(n), Yt = null;
      return;
    }
    !o && Yt && Y0(i, Yt) || (jr(i, !0), Yt = i, ot());
  }, ke = (o = !1) => {
    !Ge() || typeof window > "u" || (ct && window.clearTimeout(ct), ct = window.setTimeout(() => {
      ct = void 0, gt && window.cancelAnimationFrame(gt), gt = window.requestAnimationFrame(() => {
        gt = void 0, q0(o);
      });
    }, o ? 0 : mp));
  }, J1 = () => {
    var o, i;
    W1(null), H1(!0), (i = (o = X1()) == null ? void 0 : o.setAutoCalcTickFlag) == null || i.call(o, !0), ke(!0);
  }, Zn = () => {
    const o = Vr();
    o && (W1(o), jr(o, !1)), H1(!1);
  }, G0 = () => {
    ...
    var g;
    const o = (g = n == null ? void 0 : n.getDom) == null ? void 0 : g.call(n, Ut, et.YAxis);
    ...
    const s = () => {
      ...
      var _;
      i = !0, a = "touches" in v ? ((_ = v.touches[0]) == null ? void 0 : _.clientY) ?? 0 : v.clientY;
    }, y = (v) => {
      var P;
      if (!i || !Ge())
        return;
      const _ = "touches" in v ? ((P = v.touches[0]) == null ? void 0 : P.clientY) ?? a : v.clientY;
      Math.abs(_ - a) > 2 && Zn();
    }, h = () => {
    ...
    try {
      ...
      const y = Qr(u);
      if (y) {
        const h = _e.get(o), g = ((a = h == null ? void 0 : h.points) == null ? void 0 : a.length) || 0, v = ((s = y.points) == null ? void 0 : s.length) || 0;
        _e.set(o, y);
        const _ = w1(y.type);
        if (v >= _) {
          const P = b.get(o);
    ...
    document.addEventListener("mouseup", s), document.addEventListener("touchend", s), setTimeout(() => {
      ...
      const u = b.get(o);
      if (u && !u.complete) {
        u.checkInterval && clearInterval(u.checkInterval), u.mouseUpHandler && (document.removeEventListener("mouseup", u.mouseUpHandler), document.removeEventListener("touchend", u.mouseUpHandler)), Ft(o);
        const h = _e.get(o);
        if (h) {
      ...
      try {
        const a = `kline_drawings_${o}`, u = {
          drawings: i.map((y) => {
            ...
            const g = w1(y.type), v = ((_ = y.points) == null ? void 0 : _.length) || 0;
      ...
      try {
        ...
        if (a) {
          ...
          return Array.isArray(s.drawings) && s.drawings.forEach((y) => {
            var v;
            const h = w1(y.type);
            (((v = y.points) == null ? void 0 : v.length) || 0) >= h && u.push(y);
          }), u;
        }
      } catch (i) {
  ...
  const A1 = () => {
    ...
    }), _e.clear(), b.clear(), He(null), We(null), A1(), ke(!0);
  }, ta = (o) => typeof o.name == "string" && hp.has(o.name), Hn = (o, i = !1) => {
    var v, _, P;
    if (!n)
      return null;
    const a = (v = n.getDom) == null ? void 0 : v.call(n, Ut, et.Main), s = (_ = a == null ? void 0 : a.getBoundingClientRect) == null ? void 0 : _.call(a);
    ...
    if (!(!i.overlayId && s < dp)) {
      if (o.preventDefault(), o.stopPropagation(), !i.overlayId) {
        na(!1);
        const h = (u = n.createOverlay) == null ? void 0 : u.call(n, Xt({
          ...i.overlay,
    ...
    }), _e.clear(), b.clear(), He(null), We(null), zt.loadDrawings(o).forEach((a) => {
      var s;
      try {
        const u = Xt({
          name: a.type,
    ...
    o && ((i = n == null ? void 0 : n.removeOverlay) == null || i.call(n, {
      id: o
    }), _e.delete(o), b.delete(o), v1(null));
  }, aa = (o) => {
    var g, v;
    ...
    const y = (v = n.createOverlay) == null ? void 0 : v.call(n, {
      ...
      extendData: s,
      lock: !1,
      onPressedMoving: (_) => (Hr(_.overlay), !1),
      onPressedMoveEnd: (_) => (Hr(_.overlay), !1)
    }), h = typeof y == "string" ? y : null;
    h && (_e.delete(h), b.delete(h), v1(h));
  }, en = (o) => {
    var a;
    ...
    const i = ((at = n.getDataList) == null ? void 0 : at.call(n)) ?? [], a = i[i.length - 1], s = Number(a == null ? void 0 : a.close);
    ...
    const u = (st = n.convertToPixel) == null ? void 0 : st.call(n, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((lt = u == null ? void 0 : u[0]) == null ? void 0 : lt.y), h = (P1 = n.getSize) == null ? void 0 : P1.call(n, "candle_pane"), g = (h == null ? void 0 : h.height) ?? t.clientHeight;
    if (!Number.isFinite(y) || y < 0 || y > g) {
      Ht(null);
      return;
    }
    const v = Math.min(Math.max(((D1 = R()) == null ? void 0 : D1.pricePrecision) ?? 2, 0), 8), _ = s.toLocaleString(void 0, {
      minimumFractionDigits: v,
      maximumFractionDigits: v
    }), P = (oi = n.getSize) == null ? void 0 : oi.call(n, "candle_pane", et.YAxis), te = P != null && P.width && Number.isFinite(P.width) ? Math.max(74, Math.floor(P.width) - 2) : 96, ae = pn(E()), le = o % ae, ge = le === 0 ? ae : ae - le, J = Number(a.close), we = Number(a.open), Ae = n.getStyles().candle.priceMark.last, De = Ae.text, re = Number(De.size) || 12, Se = Number(De.paddingTop) || 2, pe = Number(De.paddingBottom) || 2, Ne = Math.min(Number(De.paddingLeft) || 4, 3), Be = Math.min(Number(De.paddingRight) || 4, 3), it = Math.max(34, re * 2 + Se + pe + 6), ut = Math.max(0, Math.min(y - it / 2, g - it));
    Ht({
      top: ut,
      width: Math.min(te, Math.max(62, _.length * (re * 0.56) + Ne + Be + 4)),
      priceText: _,
      text: pp(ge),
      color: Number.isFinite(J) && Number.isFinite(we) && J < we ? Ae.downColor : Ae.upColor,
      textSize: re,
    ...
    const i = (y = n == null ? void 0 : n.getSize) == null ? void 0 : y.call(n, "candle_pane", et.YAxis);
    i != null && i.width && Number.isFinite(i.width) && p1(Math.max(44, Math.ceil(i.width)));
    const a = Number(o.y), s = la(o), u = t.clientHeight;
    ...
    if (Wt)
      try {
        (o = n == null ? void 0 : n.executeAction) == null || o.call(n, yt.OnCrosshairChange, Wt);
      } catch {
      }
  }, Gn = (o) => {
    var a, s;
    ...
    var g, v, _, P, te, ae;
    const i = (v = (g = t == null ? void 0 : t.parentElement) == null ? void 0 : g.getBoundingClientRect) == null ? void 0 : v.call(g), a = (_ = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : _.call(t), s = o == null ? void 0 : o.overlay, u = (P = s == null ? void 0 : s.points) == null ? void 0 : P[0];
    let y = 72, h = 40;
    if (i) {
      if (Number.isFinite(o == null ? void 0 : o.pageX) ? y = o.pageX - i.left : Number.isFinite(o == null ? void 0 : o.x) && a && (y = a.left - i.left + o.x), Number.isFinite(o == null ? void 0 : o.pageY))
        ...
        try {
          const le = (te = n == null ? void 0 : n.convertToPixel) == null ? void 0 : te.call(n, [{
            value: u.value
          }], {
            paneId: "candle_pane",
            absolute: !0
          }), ge = Number((ae = le == null ? void 0 : le[0]) == null ? void 0 : ae.y);
    ...
    var g, v, _, P, te, ae, le, ge;
    const i = o == null ? void 0 : o.overlay;
    if (!(i != null && i.id) || i.name !== "horizontalStraightLine")
      return !1;
    const a = da(o), s = Number((v = (g = i.styles) == null ? void 0 : g.line) == null ? void 0 : v.size) || 2, u = ((P = (_ = i.styles) == null ? void 0 : _.line) == null ? void 0 : P.style) ?? Ve.Solid, y = Array.isArray((ae = (te = i.styles) == null ? void 0 : te.line) == null ? void 0 : ae.dashedValue) ? i.styles.line.dashedValue : [], h = ((ge = (le = i.styles) == null ? void 0 : le.line) == null ? void 0 : ge.color) ?? "#2f6df6";
    return He({
      id: i.id,
      x: a.x,
      y: a.y,
    ...
    return {
      ...
      styles: {
        ...
        line: {
          ...
          style: ((P = (_ = o.styles) == null ? void 0 : _.line) == null ? void 0 : P.style) ?? Ve.Solid,
          dashedValue: ((ae = (te = o.styles) == null ? void 0 : te.line) == null ? void 0 : ae.dashedValue) ?? [6, 4],
          color: ((ge = (le = o.styles) == null ? void 0 : le.line) == null ? void 0 : ge.color) ?? "#2f6df6"
        }
      },
      ...
      onRemoved: (J) => (Yr(J), (u == null ? void 0 : u(J)) ?? !1)
    };
  }, ha = () => {
    var i;
    const o = Qe();
    ...
    if (!o)
      return;
    const i = 1, a = Ve.Solid, s = [6, 4], u = "#2f6df6";
    Jt({
      styles: {
        line: {
          size: i,
    ...
    const a = (P = (_ = t.parentElement) == null ? void 0 : _.getBoundingClientRect) == null ? void 0 : P.call(_);
    if (!a)
      return;
    const s = o.clientX, u = o.clientY, y = i.x, h = i.y, g = (te) => {
      te.preventDefault();
      const ae = y + te.clientX - s, le = h + te.clientY - u;
      He({
        ...i,
        x: Math.max(8, Math.min(ae, a.width - 320)),
        y: Math.max(8, Math.min(le, a.height - 48))
      });
    }, v = () => {
  ...
  Ke(() => {
    var we, Ae, De, re, Se, pe, Ne, Be, it, ut, at, st, lt, P1, D1;
    const o = (we = e.orderTools) == null ? void 0 : we.quickOrder, i = (Ae = e.orderTools) == null ? void 0 : Ae.quickOrderFloatingWindow, a = (De = e.orderTools) == null ? void 0 : De.quickOrderPlusButton, s = (re = e.orderTools) == null ? void 0 : re.openOrders, u = (Se = e.orderTools) == null ? void 0 : Se.openOrdersExtendedPriceLine, y = (pe = e.orderTools) == null ? void 0 : pe.openOrdersDisplay, h = (Ne = e.orderTools) == null ? void 0 : Ne.confirmAfterDrag, g = (Be = e.orderTools) == null ? void 0 : Be.positions, v = (it = e.orderTools) == null ? void 0 : it.breakevenPrice, _ = (ut = e.orderTools) == null ? void 0 : ut.liquidationPrice, P = (at = e.orderTools) == null ? void 0 : at.priceLine, te = (st = e.orderTools) == null ? void 0 : st.marketPriceLine, ae = (lt = e.orderTools) == null ? void 0 : lt.countDown, le = (P1 = e.orderTools) == null ? void 0 : P1.bidAskPrice, ge = (D1 = e.orderTools) == null ? void 0 : D1.orderHistory, J = {};
    typeof o == "boolean" && o !== Gr && (Gr = o, J.quickOrder = o, typeof i != "boolean" && (J.quickOrderFloatingWindow = o), typeof a != "boolean" && (J.quickOrderPlusButton = o)), typeof i == "boolean" && i !== Xr && (Xr = i, J.quickOrderFloatingWindow = i), typeof a == "boolean" && a !== Jr && (Jr = a, J.quickOrderPlusButton = a), typeof s == "boolean" && s !== eo && (eo = s, J.openOrders = s), typeof u == "boolean" && u !== to && (to = u, J.openOrdersExtendedPriceLine = u), y !== void 0 && y !== no && (no = y, J.openOrdersDisplay = y), typeof h == "boolean" && h !== ro && (ro = h, J.confirmAfterDrag = h), typeof g == "boolean" && g !== oo && (oo = g, J.positions = g), typeof v == "boolean" && v !== io && (io = v, J.breakevenPrice = v), typeof _ == "boolean" && _ !== ao && (ao = _, J.liquidationPrice = _), typeof P == "boolean" && P !== so && (so = P, J.priceLine = P, typeof te != "boolean" && (J.marketPriceLine = P), typeof ae != "boolean" && (J.countDown = P), typeof le != "boolean" && (J.bidAskPrice = P)), typeof te == "boolean" && te !== lo && (lo = te, J.marketPriceLine = te), typeof ae == "boolean" && ae !== co && (co = ae, J.countDown = ae), typeof le == "boolean" && le !== uo && (uo = le, J.bidAskPrice = le), typeof ge == "boolean" && ge !== ho && (ho = ge, J.orderHistory = ge), Object.keys(J).length > 0 && Yn(J);
  }), Ke(() => {
    ...
    getSettings: Ue,
    setSettings: (o) => {
      var a, s, u, y, h, g, v, _, P, te, ae, le, ge, J;
      if (!n)
        return;
      const i = {};
      if (o.candleType !== void 0 && (i.candle = {
        ...
        const we = ((a = i.candle) == null ? void 0 : a.bar) || {};
        i.candle = {
          ...i.candle,
          bar: {
            ...we,
      ...
      o.showLastPrice !== void 0 && (i.candle = {
        ...
        priceMark: {
          ...
          low: {
            ...(ge = (le = i.candle) == null ? void 0 : le.priceMark) == null ? void 0 : ge.low,
    ...
    getDrawings: (o) => zt.loadDrawings(o),
    clearDrawings: (o) => {
      zt.clearDrawings(o);
    },
  ...
  const fo = () => {
    n == null || n.resize(), M1(), sn() || T1(), ke(!0), ot(), Co(), At();
  };
  let tn, er = !1, nn, rn, S1 = !1, mo = 0;
  const ba = () => {
    if (S1 || Date.now() < mo)
      return;
    const o = Pt();
    ...
    ke(), ot(), Co(), At(), $a();
  }, yo = [yt.OnVisibleRangeChange, yt.OnZoom, yt.OnScroll], _a = (o) => {
    ...
    for (let g = 1; g < i.length; g += 1) {
      const v = i[g], _ = Number(v == null ? void 0 : v.timestamp);
      if (!Number.isFinite(_))
        continue;
      const P = Math.abs(_ - o);
      P < y && (a = v, s = g, u = _, y = P);
    }
    ...
    if (!n || !t)
      return null;
    const i = ka(o), a = i == null ? void 0 : i.candle, s = Number((a == null ? void 0 : a.timestamp) ?? o), u = Number((a == null ? void 0 : a.high) ?? (a == null ? void 0 : a.close) ?? (a == null ? void 0 : a.open)), y = i ? on(i.dataIndex) : void 0, h = i && Number.isFinite(u) ? {
      dataIndex: y,
      value: u
    } : {
      timestamp: s
      ...
      paneId: "candle_pane",
      absolute: !0
    }), v = Number((le = g == null ? void 0 : g[0]) == null ? void 0 : le.x), _ = Number((ge = g == null ? void 0 : g[0]) == null ? void 0 : ge.y), P = t.clientWidth, te = t.clientHeight;
    return !Number.isFinite(v) || v < -80 || v > P + 80 ? null : {
      timestamp: s,
      text: _a(s),
      left: Math.max(58, Math.min(v, P - 58)),
      top: Number.isFinite(_) ? Math.max(8, Math.min(_ - 42, te - 38)) : 10
    };
  }, Co = () => {
    const o = b1();
    if (!o || !n || !t)
    ...
    switch (o.timespan) {
      ...
      case "week": {
        ...
        s = s - g * 60 * 60 * 24;
        const v = new Date(s);
        s = (/* @__PURE__ */ new Date(`${v.getFullYear()}-${v.getMonth() + 1}-${v.getDate()}`)).getTime(), u = a * o.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        ...
        const v = new Date(u);
        u = (/* @__PURE__ */ new Date(`${v.getFullYear()}-${v.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
    ...
    const a = pn(i), s = Math.abs(o.to - o.from), u = Math.max(1, Math.ceil(s / a) + 1), y = Math.max(u, 120) * a;
    return {
      from: o.from,
    ...
    if (!n || !t || o.length === 0)
      return;
    const i = ((y = n.getSize("candle_pane", et.YAxis)) == null ? void 0 : y.width) ?? 0, a = ((h = n.getSize("candle_pane", et.Main)) == null ? void 0 : h.width) ?? t.clientWidth - i, s = Math.max(1, a - 8), u = Math.max(2, s / Math.max(1, o.length));
    n.setOffsetRightDistance(0), n.setLeftMinVisibleBarCount(0), n.setRightMinVisibleBarCount(0), n.setBarSpace(u);
  }, nr = (o) => {
    var i;
    !n || !Number.isFinite(o) || ((i = n.scrollToTimestamp) == null || i.call(n, o, 250), requestAnimationFrame(() => an(o)), ot());
  }, vo = (o, i = "floor") => {
    var y, h, g;
    ...
    if (i === "floor")
      for (let v = a.length - 1; v >= 0; v -= 1) {
        const _ = Number((h = a[v]) == null ? void 0 : h.timestamp);
        if (Number.isFinite(_) && _ <= o)
          return v;
      }
    let s = 0, u = 1 / 0;
    for (let v = 0; v < a.length; v += 1) {
      const _ = Number((g = a[v]) == null ? void 0 : g.timestamp);
      if (!Number.isFinite(_))
        continue;
      const P = Math.abs(_ - o);
      (P < u || P === u && _ > o) && (u = P, s = v);
    ...
    if (!n || !t)
      return null;
    const i = (v = n.getDom) == null ? void 0 : v.call(n, "candle_pane", et.Main), a = (_ = i == null ? void 0 : i.getBoundingClientRect) == null ? void 0 : _.call(i), s = (P = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : P.call(r), u = t.getBoundingClientRect(), y = a && Number.isFinite(a.left) ? a.left - ((s == null ? void 0 : s.left) ?? u.left) : u.left - ((s == null ? void 0 : s.left) ?? u.left), h = n.getSize("candle_pane", et.Main), g = (a == null ? void 0 : a.width) ?? (h == null ? void 0 : h.width) ?? t.clientWidth;
    return o === "left" ? Math.max(8, y) : o === "center" ? y + g / 2 : o === "right" ? y + g : null;
  }, bo = (o, i) => {
    var _, P, te, ae, le, ge;
    const a = rr(o), s = ((_ = n == null ? void 0 : n.getDataList) == null ? void 0 : _.call(n)) ?? [];
    if (!n || a === null || s.length === 0)
      return i;
    const u = (P = n.convertFromPixel) == null ? void 0 : P.call(n, [{
      x: a,
      y: 0
    }], {
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((te = u == null ? void 0 : u[0]) == null ? void 0 : te.dataIndex), h = Math.max(0, Math.min(s.length - 1, Number.isFinite(y) ? Math.round(y) : -1)), g = xa(i);
    if (g) {
      const J = on(g.dataIndex), we = (ae = n.convertToPixel) == null ? void 0 : ae.call(n, [{
        dataIndex: J
      }], {
        paneId: "candle_pane",
        absolute: !0
      }), Ae = Number((le = we == null ? void 0 : we[0]) == null ? void 0 : le.x), De = n.getBarSpace, re = typeof De == "function" ? De.call(n) : void 0, Se = Number(typeof re == "object" ? re == null ? void 0 : re.bar : re), pe = Number.isFinite(Se) ? Math.max(2, Se / 2) : 8;
      if (Number.isFinite(Ae) && Math.abs(Ae - a) <= pe)
        return i;
    }
    ...
    if (!n || !Number.isFinite(o.timestamp))
      return;
    if (S1 = !0, mo = Date.now() + 1e3, o.anchorPoint === "date") {
    ...
    n.scrollToDataIndex(a, 0), requestAnimationFrame(() => {
      ...
      Number.isFinite(y) && (n == null || n.scrollByDistance(s - y, 0)), requestAnimationFrame(() => {
        At(o), an(o.timestamp), window.setTimeout(() => {
          S1 = !1;
        }, 1e3);
      });
    }), ot();
    ...
    const a = Na(i), s = (P = n.getDom) == null ? void 0 : P.call(n, "candle_pane", et.Main), u = (te = s == null ? void 0 : s.getBoundingClientRect) == null ? void 0 : te.call(s), y = (ae = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : ae.call(r), h = (le = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : le.call(t), g = n.getSize("candle_pane", et.Main), v = u && Number.isFinite(u.top) ? u.top - ((y == null ? void 0 : y.top) ?? (h == null ? void 0 : h.top) ?? 0) : 0, _ = Math.max(1, (u == null ? void 0 : u.height) ?? (g == null ? void 0 : g.height) ?? 0);
    if (a === null) {
      Et(null);
      return;
    }
    ...
    if (n) {
      ...
      try {
        const a = E(), s = o.from <= o.to ? o : {
          from: o.to,
          to: o.from
        }, u = Aa(s), y = i ? u : Pa(u, a), h = await e.datafeed.getHistoryKLineData(R(), a, y.from, y.to), g = Sa(h, u);
        n.applyNewData(h, h.length > 0), ke(!0), _t(u), requestAnimationFrame(() => {
          const v = Ma(h, u);
          i ? nr(i) : (Da(g), n == null || n.scrollToDataIndex(v, 0), an(Ta(g, u))), At();
        });
      } finally {
        p(!1), Zt(!1);
      }
    ...
    ve(o), await _o(La(o), o);
  }, Ia = (o) => {
    const a = {
      ...o,
      timestamp: (() => !n || o.anchorPoint === "date" ? o.timestamp : bo(o.anchorPoint, o.timestamp))()
    };
    Qt(a), e0(a), a.enabled ? (ve(a.timestamp), requestAnimationFrame(() => {
      $o(a), At(a);
    })) : requestAnimationFrame(() => At(a));
  };
  Tr(() => {
    if (window.addEventListener("resize", fo), n = Va(t, {
      customApi: {
        formatDate: (h, g, v, _) => {
          switch (E().timespan) {
            case "minute":
              return _ === cn.XAxis ? B.formatDate(h, g, "HH:mm") : B.formatDate(h, g, "YYYY-MM-DD HH:mm");
            case "hour":
              return _ === cn.XAxis ? B.formatDate(h, g, "MM-DD HH:mm") : B.formatDate(h, g, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return B.formatDate(h, g, "YYYY-MM-DD");
            case "month":
              return _ === cn.XAxis ? B.formatDate(h, g, "YYYY-MM") : B.formatDate(h, g, "YYYY-MM-DD");
            case "year":
              return _ === cn.XAxis ? B.formatDate(h, g, "YYYY") : B.formatDate(h, g, "YYYY-MM-DD");
          }
          return B.formatDate(h, g, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      const h = n.getDom("candle_pane", et.Main);
      if (h) {
      ...
      const g = n.getDom("candle_pane", et.YAxis);
      l = document.createElement("span"), l.className = "klinecharts-pro-price-unit", g == null || g.appendChild(l), wt = X0(), ke(!0);
    }
    let o = !1;
    const i = () => {
      const h = R();
    ...
    n && s && (n.removeOverlay = function(...h) {
      ...
      let _;
      if (typeof v == "string" ? _ = v : v && typeof v == "object" && v.id && (_ = v.id), _) {
        _e.delete(_);
        const P = b.get(_);
        P && (P.checkInterval && clearInterval(P.checkInterval), P.mouseUpHandler && (document.removeEventListener("mouseup", P.mouseUpHandler), document.removeEventListener("touchend", P.mouseUpHandler)), b.delete(_)), i(), ke(!0);
      }
      return g;
    }), se().forEach((h) => {
      yn(n, h, !0, {
    ...
    e.subIndicators.forEach((h) => {
      const g = yn(n, h, !0);
      g && (u[h] = g);
    }), X(u), n == null || n.loadMore((h) => {
      p(!0), (async () => {
        try {
          const v = E(), [_] = tr(v, h, 1), [P] = tr(v, _, 500), te = await e.datafeed.getHistoryKLineData(R(), v, P, _);
          n == null || n.applyMoreData(te, te.length > 0), ke(!0);
        } finally {
          p(!1);
        }
      })();
    }), n == null || n.subscribeAction(yt.OnTooltipIconClick, (h) => {
      if (h.indicatorName)
        switch (h.iconId) {
          case "visible": {
            ...
            Je(h.indicatorName, h.paneId, g, "change");
            break;
          }
          case "invisible": {
            n == null || n.overrideIndicator({
          ...
          case "close":
            if (h.paneId === "candle_pane") {
              const g = [...se()];
              n == null || n.removeIndicator("candle_pane", h.indicatorName), ke(!0), g.splice(g.indexOf(h.indicatorName), 1), q(g), Je(h.indicatorName, "candle_pane", "main", "remove");
            } else {
              const g = {
                ...H()
              };
              n == null || n.removeIndicator(h.paneId, h.indicatorName), ke(!0), delete g[h.indicatorName], X(g), Je(h.indicatorName, h.paneId, "sub", "remove");
            }
        }
    }), n == null || n.subscribeAction(yt.OnCrosshairChange, Wr), n == null || n.subscribeAction(yt.OnCrosshairChange, wo), yo.forEach((h) => {
      n == null || n.subscribeAction(h, go);
    }), tn = window.setInterval(() => ot(), 1e3), ot(), document.addEventListener("mousedown", qr);
    const y = n == null ? void 0 : n.createOverlay;
    n && y && (n.createOverlay = function(...h) {
      var P;
      const g = Xt(h[0]), v = y.apply(this, [g, ...h.slice(1)]), _ = typeof v == "string" ? v : null;
      return _ && !((P = g.extendData) != null && P.isOrderPreviewLine) && (J0(_, g.name || "unknown"), Ft(_), A1(), ke(!0)), v;
    });
  }), vt(() => {
    var o, i, a;
    if (window.removeEventListener("resize", fo), n == null || n.unsubscribeAction(yt.OnCrosshairChange, Wr), n == null || n.unsubscribeAction(yt.OnCrosshairChange, wo), T1(), yo.forEach((s) => {
      n == null || n.unsubscribeAction(s, go);
    }), tn && (window.clearInterval(tn), tn = void 0), nn && (window.clearTimeout(nn), nn = void 0), ct && (window.clearTimeout(ct), ct = void 0), gt && (window.cancelAnimationFrame(gt), gt = void 0), wt == null || wt(), wt = void 0, document.removeEventListener("mousedown", qr), f) {
      const s = f;
  ...
  const Ea = (o) => {
    ...
    const {
      current: a
    } = o, s = i.tooltip.text.color, u = a.close > a.open ? i.bar.upColor : a.close < a.open ? i.bar.downColor : i.bar.noChangeColor, y = Math.min(Math.max(((v = R()) == null ? void 0 : v.pricePrecision) ?? 2, 0), 8), h = Math.min(Math.max(((_ = R()) == null ? void 0 : _.volumePrecision) ?? 0, 0), 8), g = (P) => ({
    ...
    if (er)
      return;
    if (!sn() || (o == null ? void 0 : o.paneId) !== Ut || !(o != null && o.kLineData) || !t || !n) {
      T1();
      return;
    }
  ...
  return Ke((o) => {
    ...
    return vt(() => {
      ...
      try {
        const y = ht(Pt), h = y.enabled && (!o || o.symbol.ticker === i.ticker || y.acrossTokens), g = h ? wa(y, a) : null, [v, _] = g ? [g.from, g.to] : tr(a, (/* @__PURE__ */ new Date()).getTime(), 500), P = await e.datafeed.getHistoryKLineData(i, a, v, _);
        if (!s)
          return;
        n == null || n.applyNewData(P, P.length > 0), ke(!0), h ? requestAnimationFrame(() => {
          $o(y), At(y);
        }) : At(), ot(), setTimeout(() => {
          s && (ia(i == null ? void 0 : i.ticker), ot());
        }, 0), e.datafeed.subscribe(i, a, (te) => {
          n == null || n.updateData(te), ke(), ot();
        });
      } finally {
        s && (p(!1), Zt(!1));
      }
    ...
    if (w()) {
      St(w()), n == null || n.setStyles(w()), O(G7(n.getStyles()));
      const o = N();
      if (o) {
        Q(o);
        const i = Z(o);
        St(i), n == null || n.setStyles(i);
      }
      M1();
    }
  }), [Wy.cloneNode(!0), A(dm, {
    ...
    onMenuClick: async () => {
      try {
        await ms(() => Un(!kt())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    const o = Yy.cloneNode(!0), i = o.firstChild, a = i.nextSibling;
    return o.addEventListener("mouseleave", () => {
      Nt(null), Xe(!1);
    }), Ct((s) => r = s, o), i.$$click = (s) => {
      ...
      get children() {
        return A(Vg, {
          ...
          onDrawingItemClick: (s) => {
            ...
            c = null, n == null || n.createOverlay(Xt(s));
          },
          onModeChange: (s) => {
      ...
      children: (s) => (() => {
        ...
        return U((y) => {
          ...
          return h !== y._v$6 && u.style.setProperty("left", y._v$6 = h), g !== y._v$7 && u.style.setProperty("top", y._v$7 = g), v !== y._v$8 && u.style.setProperty("height", y._v$8 = v), y;
        }, {
          _v$6: void 0,
          _v$7: void 0,
          _v$8: void 0
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = Gy.cloneNode(!0);
        return C(u, () => s.text), U((y) => {
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = Xy.cloneNode(!0);
        return C(u, A(r1, {
          get each() {
            return s.rows;
          },
          children: (y) => (() => {
            const h = Jy.cloneNode(!0), g = h.firstChild, v = g.nextSibling;
            return C(g, () => y.title), C(v, () => y.value), U((_) => {
              const P = y.title.toLowerCase() === "time", te = y.titleColor ?? "var(--klinecharts-pro-text-second-color)", ae = y.valueColor ?? "var(--klinecharts-pro-text-color)";
              return P !== _._v$13 && h.classList.toggle("time", _._v$13 = P), te !== _._v$14 && g.style.setProperty("color", _._v$14 = te), ae !== _._v$15 && v.style.setProperty("color", _._v$15 = ae), _;
            }, {
              _v$13: void 0,
              _v$14: void 0,
              _v$15: void 0
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = ep.cloneNode(!0), y = u.firstChild, h = y.nextSibling;
        return u.style.setProperty("right", "0px"), C(y, () => s.priceText), C(h, () => s.text), U((g) => {
          const v = `${s.top}px`, _ = `${s.width}px`, P = s.color, te = `${s.borderRadius}px`, ae = s.textFamily, le = s.textWeight, ge = `${s.paddingLeft}px`, J = `${s.paddingRight}px`, we = `${s.paddingTop}px`, Ae = `${s.paddingBottom}px`, De = `${s.textSize}px`, re = `${Math.max(10, s.textSize - 1)}px`;
          return v !== g._v$16 && u.style.setProperty("top", g._v$16 = v), _ !== g._v$17 && u.style.setProperty("width", g._v$17 = _), P !== g._v$18 && u.style.setProperty("background", g._v$18 = P), te !== g._v$19 && u.style.setProperty("border-radius", g._v$19 = te), ae !== g._v$20 && u.style.setProperty("font-family", g._v$20 = ae), le !== g._v$21 && u.style.setProperty("font-weight", g._v$21 = le), ge !== g._v$22 && u.style.setProperty("padding-left", g._v$22 = ge), J !== g._v$23 && u.style.setProperty("padding-right", g._v$23 = J), we !== g._v$24 && u.style.setProperty("padding-top", g._v$24 = we), Ae !== g._v$25 && u.style.setProperty("padding-bottom", g._v$25 = Ae), De !== g._v$26 && y.style.setProperty("font-size", g._v$26 = De), re !== g._v$27 && h.style.setProperty("font-size", g._v$27 = re), g;
        }, {
          _v$16: void 0,
          _v$17: void 0,
          _v$18: void 0,
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = op.cloneNode(!0), y = u.firstChild, h = y.nextSibling, g = h.nextSibling, v = g.firstChild, _ = g.nextSibling, P = _.firstChild, te = P.firstChild, ae = te.nextSibling, le = ae.firstChild, ge = _.nextSibling, J = ge.firstChild, we = ge.nextSibling, Ae = we.nextSibling, De = Ae.nextSibling;
        return u.$$click = (re) => {
          re.stopPropagation();
        }, u.$$mousedown = (re) => {
          ...
          get children() {
            const re = tp.cloneNode(!0), Se = re.firstChild;
            return C(Se, A(r1, {
              each: Qn,
              children: (pe) => (() => {
                const Ne = ip.cloneNode(!0);
                return Ne.$$click = () => pa(pe), Ne.style.setProperty("background", pe), U(() => ce(Ne, `overlay-toolbar-color-swatch ${s.color.toLowerCase() === pe.toLowerCase() ? "selected" : ""}`)), Ne;
              })()
            })), re;
          }
        }), null), P.$$click = () => We(qe() === "width" ? null : "width"), C(ae, () => s.lineSize, le), C(_, A(fe, {
          get when() {
            return qe() === "width";
          },
          get children() {
            const re = np.cloneNode(!0);
            return C(re, A(r1, {
              each: [1, 2, 3, 4],
              children: (Se) => (() => {
                const pe = ap.cloneNode(!0), Ne = pe.firstChild;
                return pe.$$click = () => ga(Se), Ne.style.setProperty("height", `${Se}px`), U(() => ce(pe, s.lineSize === Se ? "selected" : "")), pe;
              })()
            })), re;
          }
          ...
          get children() {
            const re = rp.cloneNode(!0), Se = re.firstChild, pe = Se.nextSibling, Ne = pe.nextSibling;
            return Se.$$click = () => Jn(Ve.Solid, []), pe.$$click = () => Jn(Ve.Dashed, [6, 4]), Ne.$$click = () => Jn(Ve.Dashed, [2, 4]), U((Be) => {
              var st, lt;
              const it = s.lineStyle === Ve.Solid ? "selected" : "", ut = s.lineStyle === Ve.Dashed && ((st = s.dashedValue) == null ? void 0 : st[0]) === 6 ? "selected" : "", at = s.lineStyle === Ve.Dashed && ((lt = s.dashedValue) == null ? void 0 : lt[0]) === 2 ? "selected" : "";
              return it !== Be._v$28 && ce(Se, Be._v$28 = it), ut !== Be._v$29 && ce(pe, Be._v$29 = ut), at !== Be._v$30 && ce(Ne, Be._v$30 = at), Be;
            }, {
              _v$28: void 0,
              _v$29: void 0,
              _v$30: void 0
        ...
        }), null), we.$$click = ma, Ae.$$click = fa, De.$$click = ha, U((re) => {
          const Se = `${s.x}px`, pe = `${s.y}px`, Ne = `overlay-toolbar-icon edit ${qe() === "color" ? "active" : ""}`, Be = `overlay-toolbar-line-size ${qe() === "width" ? "active" : ""}`, it = `overlay-toolbar-icon minus ${qe() === "style" ? "active" : ""}`, ut = `overlay-toolbar-icon visibility ${s.visible ? "" : "muted"}`, at = s.visible ? "Hide" : "Show", st = `overlay-toolbar-icon lock ${s.locked ? "active" : ""}`, lt = s.locked ? "Unlock" : "Lock";
          return Se !== re._v$31 && u.style.setProperty("left", re._v$31 = Se), pe !== re._v$32 && u.style.setProperty("top", re._v$32 = pe), Ne !== re._v$33 && ce(v, re._v$33 = Ne), Be !== re._v$34 && ce(P, re._v$34 = Be), it !== re._v$35 && ce(J, re._v$35 = it), ut !== re._v$36 && ce(we, re._v$36 = ut), at !== re._v$37 && Oe(we, "title", re._v$37 = at), st !== re._v$38 && ce(Ae, re._v$38 = st), lt !== re._v$39 && Oe(Ae, "title", re._v$39 = lt), re;
        }, {
          _v$31: void 0,
          _v$32: void 0,
          _v$33: void 0,
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = sp.cloneNode(!0), y = u.firstChild;
        return u.addEventListener("mouseleave", () => {
          ...
          return () => h() ? (() => {
            const g = lp.cloneNode(!0);
            return U(() => g.innerHTML = e.orderTools.quickOrderPlusIcon), g;
          })() : cp.cloneNode(!0);
        })()), U((h) => {
          const g = `${Math.max(0, s.y - 12)}px`, v = `${y1()}px`, _ = Ee().quickOrderPlusButton ? "block" : "none";
          return g !== h._v$40 && u.style.setProperty("top", h._v$40 = g), v !== h._v$41 && u.style.setProperty("right", h._v$41 = v), _ !== h._v$42 && u.style.setProperty("display", h._v$42 = _), h;
        }, {
          _v$40: void 0,
          _v$41: void 0,
          _v$42: void 0
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = up.cloneNode(!0), y = u.firstChild, h = y.firstChild, g = h.firstChild, v = g.nextSibling, _ = v.nextSibling, P = _.nextSibling;
        P.nextSibling;
        const te = h.nextSibling, ae = te.firstChild, le = ae.nextSibling, ge = le.nextSibling, J = ge.nextSibling;
        J.nextSibling;
        const we = te.nextSibling, Ae = we.nextSibling, De = Ae.firstChild, re = De.nextSibling;
        re.nextSibling;
        const Se = Ae.nextSibling;
        return Se.firstChild, u.addEventListener("mouseleave", () => Xe(!1)), u.addEventListener("mouseenter", () => Xe(!0)), y.$$mousemove = () => {
          Gt();
        }, y.$$mousedown = (pe) => {
          pe.preventDefault(), pe.stopPropagation(), Gt();
        }, h.$$click = () => Gn("limit"), C(h, () => R().shortName ?? R().name ?? R().ticker, v), C(h, () => en(s.price), P), te.$$click = () => Gn("stop"), C(te, () => R().shortName ?? R().name ?? R().ticker, le), C(te, () => en(s.price), J), we.$$click = () => Gn("create"), Ae.$$click = ca, C(Ae, () => en(s.price), re), Se.$$click = ua, C(Se, () => en(s.price), null), U((pe) => {
          const Ne = `${Math.max(0, s.y + 24)}px`, Be = `${s.yAxisWidth + jn}px`;
          return Ne !== pe._v$43 && u.style.setProperty("top", pe._v$43 = Ne), Be !== pe._v$44 && u.style.setProperty("right", pe._v$44 = Be), pe;
        }, {
          _v$43: void 0,
          _v$44: void 0
        }), u;
      ...
      const u = `klinecharts-pro-auto-scale-button${Ge() ? " active" : ""}`, y = Ge(), h = Ge(), g = Ge() ? "Auto scale on" : "Auto scale off", v = kt();
      return u !== s._v$ && ce(i, s._v$ = u), y !== s._v$2 && Oe(i, "data-active", s._v$2 = y), h !== s._v$3 && Oe(i, "aria-pressed", s._v$3 = h), g !== s._v$4 && Oe(i, "title", s._v$4 = g), v !== s._v$5 && Oe(a, "data-drawing-bar-visible", s._v$5 = v), s;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
      ...
      return A(Kg, {
        ...
        onMainIndicatorChange: (o) => {
          ...
          o.added ? (yn(n, o.name, !0, {
            id: "candle_pane"
          }), i.push(o.name), Je(o.name, "candle_pane", "main", "add")) : (n == null || n.removeIndicator("candle_pane", o.name), i.splice(i.indexOf(o.name), 1), Je(o.name, "candle_pane", "main", "remove")), q(i), ke(!0);
        },
        onSubIndicatorChange: (o) => {
          ...
          if (o.added) {
            const a = yn(n, o.name);
            a && (i[o.name] = a, Je(o.name, a, "sub", "add"));
          } else
            o.paneId && (n == null || n.removeIndicator(o.paneId, o.name), delete i[o.name], Je(o.name, o.paneId, "sub", "remove"));
          X(i), ke(!0);
        }
      });
    }
    ...
    get children() {
      return A(hy, {
        ...
        onTimezoneChange: (o) => {
          Le(o), window.dispatchEvent(new CustomEvent("klinecharts-pro-timezone-change", {
            detail: {
              timezone: o.key
            }
          }));
        ...
        onChange: (o) => {
          ...
          Q(i);
          const a = Z(i);
          St(a), n == null || n.setStyles(a), n == null || n.resize(), M1();
        },
        onSaveChartStyle: (o) => {
          V(o);
        },
    ...
    get children() {
      return A(Cy, {
        ...
        onConfirm: (o) => {
          ...
          Je(i.indicatorName, i.paneId, a, "change");
        }
      });
    }
  }), A(fe, {
...
class Lp {
  ...
  setStyles(t) {
    var r, n;
    St(t), this._chartApi.setStyles(t), (n = (r = this._chartApi).resize) == null || n.call(r);
  }
  getStyles() {

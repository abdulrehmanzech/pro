...
const F9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: n, precision: t }) => {
    const r = [], a = [];
    if (e.length > 1) {
      const l = e[1].x > e[0].x ? e[0].x : e[1].x, h = [1, 0.786, 0.618, 0.5, 0.382, 0.236, 0], d = e[0].y - e[1].y, p = n.points, x = p[0].value - p[1].value;
      h.forEach((y) => {
        const w = e[1].y + d * y, A = (p[1].value + x * y).toFixed(t.price);
    ...
    if (e.length > 1) {
      ...
      for (let w = 2; w < 9; w++) {
        ...
        switch (w % 4) {
          ...
          case 1: {
            D = l + Math.PI / 2, y -= p[w - 2].r;
            break;
          }
          case 2: {
            D = l + Math.PI, x += p[w - 2].r;
            break;
          }
          case 3: {
            D = l + Math.PI / 2 * 3, y += p[w - 2].r;
            break;
          }
        }
  ...
  createPointFigures: ({ coordinates: e, overlay: n, precision: t }) => {
    const r = [], a = [];
    if (e.length > 2) {
      const l = n.points, h = l[1].value - l[0].value, d = e[1].y - e[0].y, p = [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1], x = e[2].x > e[1].x ? e[1].x : e[2].x;
      p.forEach((y) => {
...
class Nm {
  ...
  subscribe(n, t, r) {
    ...
    this._prevSymbolMarket !== n.market ? ((a = this._ws) == null || a.close(), this._ws = new WebSocket(`wss://delayed.polygon.io/${n.market}`), this._ws.onopen = () => {
      ...
      d[0].ev === "status" ? d[0].status === "auth_success" && ((p = this._ws) == null || p.send(JSON.stringify({ action: "subscribe", params: `T.${n.ticker}` }))) : "sym" in d && r({
        timestamp: d.s,
        open: d.o,
        high: d.h,
        low: d.l,
...
function m5(e, n, t) {
  ...
  for (; h < a || d < l; ) {
    ...
    for (; n[a - 1] === t[l - 1]; )
      a--, l--;
    if (a === h) {
      const y = l < r ? d ? t[d - 1].nextSibling : t[l - d] : p;
      for (; d < l; )
    ...
    if (d instanceof Node)
      ...
      if (Array.isArray(d))
        ...
        if (r) {
          for (; typeof d == "function"; )
            d = d();
          a = _n(e, Array.isArray(d) ? d : [d], Array.isArray(p) ? p : [p]) || a;
        } else
          e.push(d), a = !0;
      else {
        const x = String(d);
  ...
  if (n.length) {
    ...
    for (let h = n.length - 1; h >= 0; h--) {
      ...
      if (a !== d) {
        ...
        !l && !h ? p ? e.replaceChild(a, d) : e.insertBefore(a, t) : p && d.remove();
      } else
        l = !0;
    }
  } else
...
const el = /* @__PURE__ */ b('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), g9 = () => el.cloneNode(!0), tl = /* @__PURE__ */ b('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), nl = () => tl.cloneNode(!0), rl = /* @__PURE__ */ b("<ul></ul>"), ol = /* @__PURE__ */ b("<li></li>"), qt = (e) => (() => {
  ...
  return n.$$click = (h) => {
    ...
    const d = !!e.isMobile, p = e.isMobile ? "100%" : `${e.width ?? 400}px`, x = (e.isMobile, "auto"), y = e.isMobile ? "60vh" : "90vh", w = !!e.isMobile, A = !!e.isMobile, D = !!e.isMobile;
  ...
  return (() => {
    ...
    return l.$$click = () => {
      ...
      if ("precision" in n) {
        ...
        A <= 0 ? w = new RegExp(/^[1-9]\d*$/) : w = new RegExp("^\\d+\\.?\\d{0," + A + "}$"), (p === "" || w.test(p) && +p >= n.min && +p <= n.max) && ((x = n.onChange) == null || x.call(n, p === "" ? p : +p));
      } else

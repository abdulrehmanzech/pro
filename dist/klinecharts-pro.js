...
import { utils as E, registerFigure as c9, PolygonType as jt, LineType as ze, OverlayMode as Ln, ActionType as Nt, init as u9, FormatDateType as Z1, DomPosition as at, dispose as a0, TooltipIconPosition as H1, CandleType as d9, YAxisType as h9, registerOverlay as f9 } from "klinecharts";
function v1(e, t, r) {
...
function I9(e, t, r) {
  ...
  const B = /* @__PURE__ */ new Set(), [N, oe] = (l.storage || T)(l.initialValue), [U, K] = T(void 0), [z, ce] = T(void 0, {
    equals: !1
...
function K9(e, t, r = {}) {
  ...
  return Lt(() => l0(l)), () => {
    let b = e() || [], x, v;
    return b[O9], lt(() => {
      let B = b.length, N, oe, U, K, z, ce, j, X, ee;
      if (B === 0)
        h !== 0 && (l0(l), l = [], n = [], a = [], h = 0, d && (d = [])), r.fallback && (n = [V9], a[0] = b1((pe) => (l[0] = pe, r.fallback())), h = 1);
      else if (h === 0) {
        for (a = new Array(B), v = 0; v < B; v++)
          n[v] = b[v], a[v] = b1(L);
        h = B;
      } else {
        for (U = new Array(B), K = new Array(B), d && (z = new Array(B)), ce = 0, j = Math.min(h, B); ce < j && n[ce] === b[ce]; ce++)
          ;
...
var W9 = typeof Y1 == "object" && Y1 && Y1.Object === Object && Y1, mo = W9, G9 = mo, X9 = typeof self == "object" && self && self.Object === Object && self, J9 = G9 || X9 || Function("return this")(), ct = J9, ei = ct, ti = ei.Symbol, mn = ti, d0 = mn, go = Object.prototype, ni = go.hasOwnProperty, ri = go.toString, y1 = d0 ? d0.toStringTag : void 0;
function oi(e) {
...
var Wt = a5, s5 = _1, l5 = Wt, c5 = "[object Symbol]";
function u5(e) {
...
var o2 = r2, i2 = _1, a2 = Wt, s2 = "[object Arguments]";
function l2(e) {
  return a2(e) && i2(e) == s2;
}
...
var O3 = N3, I3 = Ut, E3 = ct, B3 = I3(E3, "DataView"), F3 = B3, U3 = Ut, z3 = ct, V3 = U3(z3, "Promise"), K3 = V3, R3 = Ut, j3 = ct, Q3 = R3(j3, "Set"), Z3 = Q3, H3 = Ut, q3 = ct, Y3 = H3(q3, "WeakMap"), W3 = Y3, En = F3, Bn = qn, Fn = K3, Un = Z3, zn = W3, Io = _1, t1 = Co, w0 = "[object Map]", G3 = "[object Object]", A0 = "[object Promise]", M0 = "[object Set]", T0 = "[object WeakMap]", S0 = "[object DataView]", X3 = t1(En), J3 = t1(Bn), e8 = t1(Fn), t8 = t1(Un), n8 = t1(zn), Ot = Io;
...
je(["click"]);
const El = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), Bl = /* @__PURE__ */ p('<div class="drop-down-container"><ul></ul></div>'), Fl = /* @__PURE__ */ p('<div><input type="text"></div>'), Ul = /* @__PURE__ */ p("<li></li>"), p1 = (e) => {
  const [t, r] = T(!1), [n, a] = T("");
  let l, h;
  const d = W(() => {
    ...
    return v ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((B) => B.toLowerCase().includes(v)) : e.dataSource.filter((B) => {
      var U, K;
      const N = ((U = B.text) == null ? void 0 : U.toString().toLowerCase()) || "", oe = ((K = B.key) == null ? void 0 : K.toLowerCase()) || "";
  ...
  return (() => {
    ...
    return typeof N == "function" ? xt(N, v) : h = v, C(B, () => e.value), C(v, (() => {
      ...
      return () => oe() && (() => {
        const U = Bl.cloneNode(!0), K = U.firstChild;
      ...
      return oe._v$ = Ft(v, U, oe._v$), K !== oe._v$2 && fe(v, oe._v$2 = K), oe;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), v;
...
function Wl(e, t, r) {
  const n = r.style ?? jt.Fill, a = r.color ?? "currentColor", l = Vn(r.color) ?? Vn(r.borderColor), h = n === jt.Stroke, d = l ? Yl(t, h) : !1, b = Tn(a, d ? "wick" : "body", l), x = r.borderSize ?? 1, v = Tn(r.borderColor ?? a, "border", l), L = r.borderStyle ?? ze.Solid, B = r.borderRadius ?? 0, N = r.borderDashedValue ?? [2, 2], oe = n === jt.Fill || r.style === jt.StrokeFill, U = n === jt.Stroke || r.style === jt.StrokeFill;
  if (oe) {
    e.fillStyle = b, Sn(e, t, B), e.fill();
    const K = Tn(a, "border", l);
    !d && l && K && (e.strokeStyle = K, e.lineWidth = Math.max(1, x), e.setLineDash([]), Sn(e, t, B), e.stroke());
  }
  U && (e.strokeStyle = v, e.lineWidth = x, e.setLineDash(L === ze.Dashed ? N : []), Sn(e, t, B), e.stroke());
}
function Gl() {
  V0 || (V0 = !0, c9({
    name: "rect",
...
const Xl = "指标", Jl = "更多", ec = "主图指标", tc = "副图指标", nc = "设置", rc = "时区", oc = "截屏", ic = "全屏", ac = "退出全屏", sc = "保存", lc = "确定", cc = "取消", uc = "MA(移动平均线)", dc = "EMA(指数平滑移动平均线)", hc = "SMA", fc = "BOLL(布林线)", mc = "BBI(多空指数)", gc = "SAR(停损点指向指标)", yc = "VOL(成交量)", Cc = "MACD(指数平滑异同移动平均线)", pc = "KDJ(随机指标)", vc = "RSI(相对强弱指标)", bc = "BIAS(乖离率)", $c = "BRAR(情绪指标)", _c = "CCI(顺势指标)", kc = "DMI(动向指标)", xc = "CR(能量指标)", Lc = "PSY(心理线)", wc = "DMA(平行线差指标)", Ac = "TRIX(三重指数平滑平均线)", Mc = "OBV(能量潮指标)", Tc = "VR(成交量变异率)", Sc = "WR(威廉指标)", Pc = "MTM(动量指标)", Dc = "EMV(简易波动指标)", Nc = "ROC(变动率指标)", Oc = "PVT(价量趋势指标)", Ic = "AO(动量震荡指标)", Ec = "世界统一时间", Bc = "(UTC-10) 檀香山", Fc = "(UTC-8) 朱诺", Uc = "(UTC-7) 洛杉矶", zc = "(UTC-5) 芝加哥", Vc = "(UTC-4) 多伦多", Kc = "(UTC-3) 圣保罗", Rc = "(UTC+1) 伦敦", jc = "(UTC+2) 柏林", Qc = "(UTC+3) 巴林", Zc = "(UTC+4) 迪拜", Hc = "(UTC+5) 阿什哈巴德", qc = "(UTC+6) 阿拉木图", Yc = "(UTC+7) 曼谷", Wc = "(UTC+8) 上海", Gc = "(UTC+9) 东京", Xc = "(UTC+10) 悉尼", Jc = "(UTC+12) 诺福克岛", e4 = "水平直线", t4 = "水平射线", n4 = "水平线段", r4 = "垂直直线", o4 = "垂直射线", i4 = "垂直线段", a4 = "直线", s4 = "射线", l4 = "线段", c4 = "箭头", u4 = "价格线", d4 = "价格通道线", h4 = "平行直线", f4 = "斐波那契回调直线", m4 = "斐波那契回调线段", g4 = "斐波那契圆环", y4 = "斐波那契螺旋", C4 = "斐波那契速度阻力扇", p4 = "斐波那契趋势扩展", v4 = "江恩箱", b4 = "矩形", $4 = "平行四边形", _4 = "圆", k4 = "三角形", x4 = "三浪", L4 = "五浪", w4 = "八浪", A4 = "任意浪", M4 = "ABCD形态", T4 = "XABCD形态", S4 = "弱磁模式", P4 = "强磁模式", D4 = "商品搜索", N4 = "商品代码", O4 = "参数1", I4 = "参数2", E4 = "参数3", B4 = "参数4", F4 = "参数5", U4 = "周期", z4 = "标准差", V4 = "蜡烛图类型", K4 = "全实心", R4 = "全空心", j4 = "涨空心", Q4 = "跌空心", Z4 = "OHLC", H4 = "面积图", q4 = "最新价显示", Y4 = "最高价显示", W4 = "最低价显示", G4 = "指标最新值显示", X4 = "价格轴类型", J4 = "线性轴", eu = "百分比轴", tu = "对数轴", nu = "倒置坐标", ru = "网格线显示", ou = "恢复默认", iu = {
  indicator: Xl,
  more: Jl,
  main_indicator: ec,
  sub_indicator: tc,
  ...
  grid_show: ru,
  restore_default: ou
}, au = "Indicator", su = "More", lu = "Main Indicator", cu = "Sub Indicator", uu = "Setting", du = "Timezone", hu = "Screenshot", fu = "Full Screen", mu = "Exit", gu = "Save", yu = "Confirm", Cu = "Cancel", pu = "MA(Moving Average)", vu = "EMA(Exponential Moving Average)", bu = "SMA", $u = "BOLL(Bolinger Bands)", _u = "BBI(Bull And Bearlndex)", ku = "SAR(Stop and Reverse)", xu = "VOL(Volume)", Lu = "MACD(Moving Average Convergence / Divergence)", wu = "KDJ(KDJ Index)", Au = "RSI(Relative Strength Index)", Mu = "BIAS(Bias Ratio)", Tu = "BRAR(情绪指标)", Su = "CCI(Commodity Channel Index)", Pu = "DMI(Directional Movement Index)", Du = "CR(能量指标)", Nu = "PSY(Psychological Line)", Ou = "DMA(Different of Moving Average)", Iu = "TRIX(Triple Exponentially Smoothed Moving Average)", Eu = "OBV(On Balance Volume)", Bu = "VR(Volatility Volume Ratio)", Fu = "WR(Williams %R)", Uu = "MTM(Momentum Index)", zu = "EMV(Ease of Movement Value)", Vu = "ROC(Price Rate of Change)", Ku = "PVT(Price and Volume Trend)", Ru = "AO(Awesome Oscillator)", ju = "UTC", Qu = "(UTC-10) Honolulu", Zu = "(UTC-8) Juneau", Hu = "(UTC-7) Los Angeles", qu = "(UTC-5) Chicago", Yu = "(UTC-4) Toronto", Wu = "(UTC-3) Sao Paulo", Gu = "(UTC+1) London", Xu = "(UTC+2) Berlin", Ju = "(UTC+3) Bahrain", ed = "(UTC+4) Dubai", td = "(UTC+5) Ashkhabad", nd = "(UTC+6) Almaty", rd = "(UTC+7) Bangkok", od = "(UTC+8) Shanghai", id = "(UTC+9) Tokyo", ad = "(UTC+10) Sydney", sd = "(UTC+12) Norfolk", ld = "Horizontal Line", cd = "Horizontal Ray", ud = "Horizontal Segment", dd = "Vertical Line", hd = "Vertical Ray", fd = "Vertical Segment", md = "Trend Line", gd = "Ray", yd = "Segment", Cd = "Arrow", pd = "Price Line", vd = "Price Channel Line", bd = "Parallel Line", $d = "Fibonacci Line", _d = "Fibonacci Segment", kd = "Fibonacci Circle", xd = "Fibonacci Spiral", Ld = "Fibonacci Sector", wd = "Fibonacci Extension", Ad = "Gann Box", Md = "Rect", Td = "Parallelogram", Sd = "Circle", Pd = "Triangle", Dd = "Three Waves", Nd = "Five Waves", Od = "Eight Waves", Id = "Any Waves", Ed = "ABCD Pattern", Bd = "XABCD Pattern", Fd = "Weak Magnet", Ud = "Strong Magnet", zd = "Symbol Search", Vd = "Symbol Code", Kd = "Parameter 1", Rd = "Parameter 2", jd = "Parameter 3", Qd = "Parameter 4", Zd = "Parameter 5", Hd = "Period", qd = "Standard Deviation", Yd = "Candle Type", Wd = "Candle Solid", Gd = "Candle Stroke", Xd = "Candle Up Stroke", Jd = "Candle Down Stroke", eh = "OHLC", th = "Area", nh = "Show Last Price", rh = "Show Highest Price", oh = "Show Lowest Price", ih = "Show indicator's last value", ah = "Price Axis Type", sh = "Normal", lh = "Percentage", ch = "Log", uh = "Reverse Coordinate", dh = "Show Grids", hh = "Restore Defaults", fh = {
  indicator: au,
  more: su,
  main_indicator: lu,
  sub_indicator: cu,
...
const c = (e, t) => {
  ...
  let t, r, n;
  const [a, l] = T(window.innerWidth < 768), [h, d] = T(localStorage.getItem("klinechart_secondary_period") || ""), [b, x] = T(!1), [v, L] = T(!1), [B, N] = T(!1), [oe, U] = T(!1), [K, z] = T(!1), [ce, j] = T({
    top: 0,
    left: 0,
    minWidth: 220
  }), X = () => {
  ...
  return Re(() => {
    ...
    const O = Th.cloneNode(!0), F = O.firstChild, ve = F.firstChild, Le = ve.firstChild, ye = ve.nextSibling, Te = ye.firstChild;
    return O.style.setProperty("position", "relative"), O.style.setProperty("width", "100%"), O.style.setProperty("display", "flex"), O.style.setProperty("align-items", "center"), C(O, w(le, {
      ...
      get children() {
        const _ = yh.cloneNode(!0), ge = _.firstChild;
      ...
      get children() {
        const _ = bh.cloneNode(!0), ge = _.firstChild, Ne = ge.nextSibling;
      ...
      get children() {
        const _ = kh.cloneNode(!0), ge = _.firstChild, Ne = ge.firstChild, ut = Ne.nextSibling;
        return xt(($e) => {
          r = $e;
            ...
            return w(Y9, {
              ...
              get children() {
                ...
                return $e.$$mousedown = ($) => $.stopPropagation(), xt(($) => {
                  ...
                  var U1;
                  const S = `${ce().top}px`, Oe = `${ce().left}px`, Ue = `${ce().minWidth}px`, ot = `klinecharts-pro-order-tools-group${v() ? " klinecharts-pro-order-tools-group-open" : ""}`, mt = `klinecharts-pro-order-tools-group${B() ? " klinecharts-pro-order-tools-group-open" : ""}`, E1 = `klinecharts-pro-order-tools-switch${((U1 = e.orderToolsState) == null ? void 0 : U1.openOrdersExtendedPriceLine) ?? !0 ? " klinecharts-pro-order-tools-switch-on" : ""}`, B1 = `klinecharts-pro-order-tools-display-arrow${oe() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, F1 = `klinecharts-pro-order-tools-group${K() ? " klinecharts-pro-order-tools-group-open" : ""}`;
      ...
      get children() {
        ...
        return st(_, "click", e.chartViewToggle.onToggle, !0), C(_, (() => {
          ...
          return () => ge() ? Oh.cloneNode(!0) : Ih.cloneNode(!0);
...
const We = (e) => om[e.name](e.class), dm = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), hm = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), j0 = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), Q0 = "drawing_tools", fm = (e) => {
  const [t, r] = T("horizontalStraightLine"), [n, a] = T("priceChannelLine"), [l, h] = T("circle"), [d, b] = T("fibonacciLine"), [x, v] = T("xabcd"), [L, B] = T("weak_magnet"), [N, oe] = T("normal"), [U, K] = T(!1), [z, ce] = T(!0), [j, X] = T(""), ee = W(() => [{
    key: "singleLine",
    icon: t(),
    list: im(e.locale),
    setter: r
  ...
  return (() => {
    const Z = dm.cloneNode(!0), H = Z.firstChild, te = H.nextSibling, se = te.firstChild, M = se.nextSibling, q = M.firstChild, Y = te.nextSibling, R = Y.firstChild, de = Y.nextSibling, he = de.firstChild, ne = de.nextSibling, I = ne.nextSibling, Q = I.firstChild;
    return C(Z, () => ee().map((D) => (() => {
      const O = hm.cloneNode(!0), F = O.firstChild, ve = F.nextSibling, Le = ve.firstChild;
...
const ym = (e) => {
  const [t, r] = T(e.timezone), n = W(() => gm(e.locale));
  return w(At, {
    get title() {
...
const Cm = /* @__PURE__ */ p('<div class="chart-style-color-picker"><button type="button" class="chart-style-color-swatch"></button></div>'), pm = /* @__PURE__ */ p('<div class="chart-style-color-popover"><div class="chart-style-color-grid"></div></div>'), vm = /* @__PURE__ */ p('<button type="button" class="chart-style-palette-color"></button>'), bm = /* @__PURE__ */ p('<div class="chart-style-line-control"><div class="chart-style-width-picker"><button type="button" class="chart-style-size-button"><span></span></button></div></div>'), $m = /* @__PURE__ */ p('<div class="chart-style-width-popover"></div>'), _m = /* @__PURE__ */ p('<button type="button"><span></span></button>'), km = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-title-tabs"><button type="button"></button><button type="button">Chart Style</button></div>'), xm = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), Lm = /* @__PURE__ */ p('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), wm = /* @__PURE__ */ p('<div class="klinecharts-pro-chart-style-content"><div class="chart-style-sidebar"><button type="button">Symbol</button><button type="button">Background</button></div><div class="chart-style-panel"><p class="chart-style-note">* Chart Style takes precedence over default chart settings. Click Reset to align with the default theme.</p></div></div>'), Am = /* @__PURE__ */ p("<h3>Symbol</h3>"), Mm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Chart</span></div>'), Tm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Bullish Candle Stick</span></div>'), Sm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Candle Stick</span><div class="chart-style-color-pair"></div></div>'), Pm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Borders</span><div class="chart-style-color-pair"></div></div>'), Dm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Wick</span><div class="chart-style-color-pair"></div></div>'), Nm = /* @__PURE__ */ p("<h3>Background</h3>"), Om = /* @__PURE__ */ p('<div class="chart-style-row"><span>Color</span><button type="button" class="chart-style-color-swatch disabled" title="Chart background is controlled by the active app theme."></button></div>'), Im = /* @__PURE__ */ p('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Vert Grid Lines</span></label></div>'), Em = /* @__PURE__ */ p('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Horz Grid Lines</span></label></div>'), Bm = ["#f6465d", "#f59e0b", "#fcd535", "#2ebd85", "#4098a8", "#22c1dc", "#3861fb", "#7b3fe4", "#ec8aa4", "#f7c56b", "#fff0a3", "#9ed4a4", "#83c7bb", "#8bdce6", "#8bb9f7", "#b7a1dc", "#c9343e", "#e76f20", "#f0b93a", "#3f8d3a", "#236e5a", "#237c88", "#1d3fbf", "#3a209f", "#ffffff", "#cbd5e1", "#9ca3af", "#6b7280", "#374151", "#111827", "#000000"], W0 = [{
  ...
  const [t, r] = T(e.currentStyles), [n, a] = T(zm(e.currentStyles)), [l, h] = T(Y0(e.locale)), [d, b] = T(!1), [x, v] = T("settings"), [L, B] = T("symbol"), [N, oe] = T(null), [U, K] = T(null), z = () => {
    b(window.innerWidth <= 768);
  };
  Qn(() => {
    const M = (q) => {
      const Y = q.target;
      Y instanceof Element && (Y.closest(".chart-style-color-picker") || Y.closest(".chart-style-width-picker") || Y.closest(".klinecharts-pro-select") || (oe(null), K(null)));
    };
  ...
  const ce = (M, q) => {
    ...
    if (M) {
      const q = E.clone(n());
      X0.forEach((Y) => {
        const R = Y.key.includes("downColor") ? "candle.bar.downColor" : Y.key.includes("NoChangeColor") ? "candle.bar.noChangeColor" : "candle.bar.upColor";
        nt(q, Y.key, E.formatValue(M, Y.key, E.formatValue(M, R)));
    ...
    const Y = j(M, "#ffffff");
    return (() => {
      const R = Cm.cloneNode(!0), de = R.firstChild;
      return de.$$click = () => {
        oe(N() === q ? null : q);
      }, de.style.setProperty("background", Y), C(R, (() => {
        const he = W(() => N() === q);
        return () => he() && (() => {
    ...
    const q = `${M}.style`, Y = `${M}.color`, R = `${M}.size`, de = j(q, ze.Dashed), he = Math.max(1, Number(j(R, 1)));
    return (() => {
      ...
      return C(ne, w(p1, {
        ...
        return () => O() && (() => {
          ...
          return C(F, w($1, {
            each: Um,
            children: (ve) => (() => {
              const Le = _m.cloneNode(!0), ye = Le.firstChild;
              return Le.$$click = () => {
                X(R, ve), K(null);
    ...
    const M = km.cloneNode(!0), q = M.firstChild, Y = q.nextSibling;
    return q.$$click = () => v("settings"), C(q, () => c("setting", e.locale)), Y.$$click = () => v("chartStyle"), V((R) => {
      const de = x() === "settings", he = x() === "chartStyle";
      return de !== R._v$ && q.classList.toggle("active", R._v$ = de), he !== R._v$2 && Y.classList.toggle("active", R._v$2 = he), R;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), M;
      ...
      return W(() => x() === "settings")() ? (() => {
        ...
        return C(M, w($1, {
          ...
          children: (q) => {
            ...
            return (() => {
              const de = Lm.cloneNode(!0), he = de.firstChild, ne = he.nextSibling;
              return C(he, () => q.text), C(ne, Y), V(() => de.classList.toggle("mobile-item", !!d())), de;
            })();
          }
        })), V(() => M.classList.toggle("mobile-layout", !!d())), M;
      })() : (() => {
        const M = wm.cloneNode(!0), q = M.firstChild, Y = q.firstChild, R = Y.nextSibling, de = q.nextSibling, he = de.firstChild;
        return Y.$$click = () => B("symbol"), R.$$click = () => B("background"), C(de, (() => {
          const ne = W(() => L() === "symbol");
          return () => ne() ? [Am.cloneNode(!0), (() => {
            ...
            const I = Em.cloneNode(!0), Q = I.firstChild, D = Q.firstChild;
          ...
          return I !== ne._v$3 && M.classList.toggle("mobile-layout", ne._v$3 = I), Q !== ne._v$4 && Y.classList.toggle("active", ne._v$4 = Q), D !== ne._v$5 && R.classList.toggle("active", ne._v$5 = D), ne;
        }, {
          _v$3: void 0,
          _v$4: void 0,
          _v$5: void 0
...
const Km = /* @__PURE__ */ p('<img style="width:500px;margin-top: 20px">'), Rm = (e) => w(At, {
  ...
  const [t, r] = T(E.clone(e.params.calcParams)), n = (a) => jm[a];
  return w(At, {
    get title() {
  ...
  return w(At, {
    ...
    get children() {
      return [w(zo, {
        ...
        renderItem: (a) => (() => {
          const l = Wm.cloneNode(!0), h = l.firstChild, d = h.firstChild;
          return l.$$click = () => {
...
const eg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-picker"></div>'), tg = /* @__PURE__ */ p('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), ng = /* @__PURE__ */ p("<span></span>"), rg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), og = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-grid"></div>'), ig = /* @__PURE__ */ p('<span class="weekday"></span>'), Et = /* @__PURE__ */ p('<button type="button"></button>'), ag = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-month-grid"></div>'), sg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), lg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), cg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-content"></div>'), ug = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-tabs"></div>'), dg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), hg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), fg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), mg = [{
  ...
  const [t, r] = T(!0), [n, a] = T("date"), [l, h] = T(e.value.year), [d, b] = T(e.value.month), x = W(() => yg(l(), d())), v = W(() => Math.floor(l() / 10) * 10), L = W(() => Array.from({
    length: 12
  ...
  return (() => {
    ...
    return C(Z, (() => {
      ...
      const H = W(() => !!t());
      return () => H() && (() => {
        const te = rg.cloneNode(!0), se = te.firstChild, M = se.firstChild, q = M.nextSibling, Y = q.nextSibling, R = Y.nextSibling, de = R.nextSibling;
        return M.$$click = () => {
          ...
          return () => he() && (() => {
            ...
            return C(I, () => oe.map((O) => (() => {
              ...
              return F.$$click = () => ee(O), C(F, () => Zt(O)), V(() => fe(F, O === B() ? "selected" : "")), F;
            })())), C(Q, () => U.map((O) => (() => {
              const F = Et.cloneNode(!0);
              return F.$$click = () => e.onChange({
                ...e.value,
                minute: O
              }), C(F, () => Zt(O)), V(() => fe(F, O === e.value.minute ? "selected" : "")), F;
            })())), C(D, () => ["AM", "PM"].map((O) => (() => {
              const F = Et.cloneNode(!0);
  ...
  return w(At, {
    ...
    get children() {
      ...
      return C(U, (() => {
        ...
        return () => K() && (() => {
          const z = dg.cloneNode(!0), ce = z.firstChild, j = ce.firstChild, X = j.nextSibling, ee = X.nextSibling;
        ...
        return () => K() && (() => {
          const z = hg.cloneNode(!0), ce = z.firstChild, j = ce.firstChild, X = j.nextSibling, ee = ce.nextSibling, pe = ee.firstChild, Z = pe.nextSibling, H = ee.nextSibling, te = H.firstChild, se = te.nextSibling, M = H.nextSibling, q = M.firstChild, Y = q.nextSibling;
          return X.$$click = () => N({
            enabled: !L().enabled
            ...
            return de !== R._v$3 && fe(X, R._v$3 = de), he !== R._v$4 && fe(ee, R._v$4 = he), ne !== R._v$5 && (Z.disabled = R._v$5 = ne), I !== R._v$6 && fe(H, R._v$6 = I), Q !== R._v$7 && fe(se, R._v$7 = Q), D !== R._v$8 && (se.disabled = R._v$8 = D), O !== R._v$9 && fe(M, R._v$9 = O), F !== R._v$10 && fe(Y, R._v$10 = F), ve !== R._v$11 && (Y.disabled = R._v$11 = ve), R;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
const Ig = (e) => {
  ...
  let t, r, n = null, a;
  const [l, h] = T(!1), [d, b] = T(e.theme), [x, v] = T(e.styles), [L, B] = T(e.locale), [N, oe] = T(e.symbol), [U, K] = T(e.period), z = () => {
    var o, i, s, u;
    return {
  ...
  }), [q, Y] = T(!1), [R, de] = T(), [he, ne] = T(""), [I, Q] = T(!1), [D, O] = T(Date.now()), [F, ve] = T({
    from: Date.now() - 30 * 24 * 60 * 60 * 1e3,
    to: Date.now()
  }), [Le, ye] = T(Ng() ?? Ko()), [Te, _] = T(e.drawingBarVisible), [ge, Ne] = T(!1), [ut, $e] = T(!1), [Ct, dt] = T(!1), n1 = ((Tr = e.orderTools) == null ? void 0 : Tr.quickOrder) ?? !0, [Be, k1] = T({
    quickOrder: n1,
  ...
  Qn(() => {
    ...
    }), z1 = window.setInterval(() => Ye(), 1e3), Ye(), document.addEventListener("mousedown", or);
  ...
  return Re((o) => {
    ...
    x() && (It(x()), n == null || n.setStyles(x()), Q1(), de(bl(n.getStyles())));
  }), [pg.cloneNode(!0), w(Eh, {
    get locale() {
      return e.locale;
    },
    ...
    return o.addEventListener("mouseleave", () => {
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = wg.cloneNode(!0), m = u.firstChild, g = m.nextSibling, f = g.nextSibling, y = f.firstChild, k = f.nextSibling, A = k.firstChild, P = A.firstChild, re = P.nextSibling, ae = re.firstChild, ie = k.nextSibling, J = ie.firstChild, ue = ie.nextSibling, be = ue.nextSibling, Se = be.nextSibling;
        return u.$$click = (G) => {
          G.stopPropagation();
        }, u.$$mousedown = (G) => {
          ...
          get children() {
            const G = kg.cloneNode(!0), Ce = G.firstChild;
            return C(Ce, w($1, {
              each: M1,
              children: (me) => (() => {
                const we = Ag.cloneNode(!0);
                return we.$$click = () => B1(me), we.style.setProperty("background", me), V(() => fe(we, `overlay-toolbar-color-swatch ${s.color.toLowerCase() === me.toLowerCase() ? "selected" : ""}`)), we;
              })()
            })), G;
          }
          ...
          get children() {
            ...
            return C(G, w($1, {
              each: [1, 2, 3, 4],
              children: (Ce) => (() => {
                const me = Mg.cloneNode(!0), we = me.firstChild;
          ...
          get children() {
            const G = Lg.cloneNode(!0), Ce = G.firstChild, me = Ce.nextSibling, we = me.nextSibling;

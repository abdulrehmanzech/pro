...
var x9 = (e, n, t) => n in e ? k9(e, n, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[n] = t;
var ut = (e, n, t) => (x9(e, typeof n != "symbol" ? n + "" : n, t), t);
import { utils as ce, OverlayMode as u0, ActionType as T1, LineType as o1, init as L9, FormatDateType as Ot, DomPosition as Dt, dispose as zn, TooltipIconPosition as Nt, CandleType as w9, YAxisType as A9, registerOverlay as M9 } from "klinecharts";
function ht(e, n, t) {
...
const T9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: n, precision: t }) => {
    ...
    if (e.length > 1) {
      ...
      d.forEach((y) => {
        const w = e[1].y + u * y, A = (m[1].value + k * y).toFixed(t.price);
    ...
    if (e.length > 1) {
      ...
      for (let w = 2; w < 9; w++) {
        ...
        switch (w % 4) {
          ...
          case 3: {
            O = s + Math.PI / 2 * 3, y += m[w - 2].r;
            break;
          }
        }
        const F = O + Math.PI / 2, B = ht({ x: k, y }, e[0], s);
        m.push({
          ...B,
          r: A,
          startAngle: O,
  ...
  createPointFigures: ({ coordinates: e, bounding: n }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((y) => {
        const w = e[1].x - u * y, A = e[1].y - m * y;
        t.push({ coordinates: [{ x: w, y: e[0].y }, { x: w, y: e[1].y }] }), t.push({ coordinates: [{ x: e[0].x, y: A }, { x: e[1].x, y: A }] }), r = r.concat(p0([e[0], { x: w, y: e[1].y }], n)), r = r.concat(p0([e[0], { x: e[1].x, y: A }], n)), a.unshift({
          x: e[0].x + s,
          y: A + 10,
          text: `${y.toFixed(3)}`
        }), a.unshift({
  ...
  createPointFigures: ({ coordinates: e, overlay: n, precision: t }) => {
    ...
    if (e.length > 2) {
      ...
      m.forEach((y) => {
        const w = e[2].y + u * y, A = (s[2].value + d * y).toFixed(t.price);
...
const q9 = (e, n) => e === n, v0 = Symbol("solid-proxy"), Y9 = Symbol("solid-track"), Kt = {
  equals: q9
};
let Pr = Ir;
const f1 = 1, jt = 2, Or = {
...
function ft(e, n) {
  const t = ye, r = Ae, a = e.length === 0, s = a ? Or : {
    owned: null,
    cleanups: null,
    context: null,
    owner: n === void 0 ? r : n
...
function Z(e, n, t) {
  ...
  const r = Gt(e, n, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = t.equals || void 0, R1(r), Dr.bind(r);
}
function G9(e, n, t) {
  let r, a, s;
  arguments.length === 2 && typeof n == "object" || arguments.length === 1 ? (r = !0, a = e, s = n || {}) : (r = e, a = n, s = t || {});
  let d = null, u = d0, m = null, k = !1, y = "initialValue" in s, w = typeof r == "function" && Z(r);
  ...
  if (De.context) {
    ...
    let q;
    s.ssrLoadFrom === "initial" ? u = s.initialValue : De.load && (q = De.load(m)) && (u = q[0]);
  }
...
function R1(e) {
  if (!e.fn)
    return;
  Wt(e);
  const n = Ae, t = ye, r = M0;
  ye = Ae = e, J9(e, e.value, r), ye = t, Ae = n;
}
function J9(e, n, t) {
  let r;
  try {
    ...
    e.pure && (e.state = f1, e.owned && e.owned.forEach(Wt), e.owned = null), Fr(a);
  }
...
function r5(e, n, t = {}) {
  ...
  return N1(() => jn(s)), () => {
    let m = e() || [], k, y;
    return m[Y9], h1(() => {
      let A = m.length, O, F, B, D, K, X, U, Y, V;
      if (A === 0)
        d !== 0 && (jn(s), s = [], r = [], a = [], d = 0, u && (u = [])), t.fallback && (r = [n5], a[0] = ft((ue) => (s[0] = ue, t.fallback())), d = 1);
      else if (d === 0) {
        for (a = new Array(A), y = 0; y < A; y++)
          r[y] = m[y], a[y] = ft(w);
        d = A;
      } else {
        for (B = new Array(A), D = new Array(A), u && (K = new Array(A)), X = 0, U = Math.min(d, A); X < U && r[X] === m[X]; X++)
          ;
        for (U = d - 1, Y = A - 1; U >= X && Y >= X && r[U] === m[Y]; U--, Y--)
          B[Y] = a[U], D[Y] = s[U], u && (K[Y] = u[U]);
        for (O = /* @__PURE__ */ new Map(), F = new Array(Y + 1), y = Y; y >= X; y--)
          V = m[y], k = O.get(V), F[y] = k === void 0 ? -1 : k, O.set(V, y);
        for (k = X; k <= U; k++)
          V = r[k], y = O.get(V), y !== void 0 && y !== -1 ? (B[y] = a[k], D[y] = s[k], u && (K[y] = u[k]), y = F[y], O.set(V, y)) : s[k]();
        for (y = X; y < A; y++)
          y in B ? (a[y] = B[y], s[y] = D[y], u && (u[y] = K[y], u[y](y))) : a[y] = ft(w);
...
const o5 = {
  get(e, n, t) {
    return n === v0 ? t : e.get(n);
  },
  has(e, n) {
    return n === v0 ? !0 : e.has(n);
  },
  set: It,
  deleteProperty: It,
...
function Ur(...e) {
  ...
  for (let r = 0; r < e.length; r++) {
    const a = e[r];
    n = n || !!a && v0 in a, e[r] = typeof a == "function" ? (n = !0, Z(a)) : a;
  }
  if (n)
    return new Proxy({
      get(r) {
...
function C0(e) {
  ...
  return Z(r5(() => e.each, e.children, n || void 0));
}
function J(e) {
  let n = !1;
...
function i5(e, n, t) {
  ...
  for (; d < a || u < s; ) {
    ...
    for (; n[a - 1] === t[s - 1]; )
      a--, s--;
    if (a === d) {
      const y = s < r ? u ? t[u - 1].nextSibling : t[s - u] : m;
      for (; u < s; )
      ...
      e.insertBefore(t[u++], n[d++].nextSibling), e.insertBefore(t[--s], y), n[a] = t[s];
    } else {
      if (!k) {
        k = /* @__PURE__ */ new Map();
        let w = u;
      ...
      if (y != null)
        if (u < y && y < s) {
          let w = d, A = 1, O;
          for (; ++w < a && w < s && !((O = k.get(n[w])) == null || O !== y + A); )
            A++;
          if (A > y - u) {
            const F = n[d];
            for (; u < y; )
...
function Qe(e, n = window.document) {
  const t = n[Qn] || (n[Qn] = /* @__PURE__ */ new Set());
  for (let r = 0, a = e.length; r < a; r++) {
    const s = e[r];
    t.has(s) || (t.add(s), n.addEventListener(s, s5));
  }
}
function Pe(e, n, t) {
  ...
  if (e = d && t[0] && t[0].parentNode || e, s === "string" || s === "number") {
    ...
    if (Array.isArray(n)) {
      ...
      if (u.length === 0) {
        ...
        m ? t.length === 0 ? Rn(e, u, r) : i5(e, t, u) : (t && j1(e), Rn(e, u));
      t = u;
    ...
    if (u instanceof Node)
      ...
      if (Array.isArray(u))
        ...
        if (r) {
          for (; typeof u == "function"; )
            u = u();
          a = $0(e, Array.isArray(u) ? u : [u], Array.isArray(m) ? m : [m]) || a;
        } else
          e.push(u), a = !0;
      else {
        const k = String(u);
...
function u5(e) {
  ...
  if (r instanceof HTMLHeadElement) {
    ...
    const s = c5(e.isSVG ? "g" : "div", e.isSVG), d = n && s.attachShadow ? s.attachShadow({
      mode: "open"
    }) : s;
...
var d5 = typeof Et == "object" && Et && Et.Object === Object && Et, Kr = d5, h5 = Kr, f5 = typeof self == "object" && self && self.Object === Object && self, g5 = h5 || f5 || Function("return this")(), a1 = g5, y5 = a1, m5 = y5.Symbol, Xt = m5, Zn = Xt, jr = Object.prototype, p5 = jr.hasOwnProperty, v5 = jr.toString, dt = Zn ? Zn.toStringTag : void 0;
function C5(e) {
  var n = p5.call(e, dt), t = e[dt];
  try {
    e[dt] = void 0;
    var r = !0;
  } catch {
...
var $5 = C5, b5 = Object.prototype, _5 = b5.toString;
function k5(e) {
  return _5.call(e);
}
var x5 = k5, Vn = Xt, L5 = $5, w5 = x5, A5 = "[object Null]", M5 = "[object Undefined]", Hn = Vn ? Vn.toStringTag : void 0;
function T5(e) {
  return e == null ? e === void 0 ? M5 : A5 : Hn && Hn in Object(e) ? L5(e) : w5(e);
}
var gt = T5;
function S5(e) {
  var n = typeof e;
...
var Z1 = S5, P5 = gt, O5 = Z1, D5 = "[object AsyncFunction]", N5 = "[object Function]", I5 = "[object GeneratorFunction]", E5 = "[object Proxy]";
function B5(e) {
  if (!O5(e))
    return !1;
  var n = P5(e);
  return n == N5 || n == I5 || n == D5 || n == E5;
}
var Qr = B5, F5 = a1, U5 = F5["__core-js_shared__"], z5 = U5, f0 = z5, qn = function() {
...
var j5 = K5, Q5 = Function.prototype, R5 = Q5.toString;
function Z5(e) {
  if (e != null) {
    try {
      return R5.call(e);
...
var Rr = Z5, V5 = Qr, H5 = j5, q5 = Z1, Y5 = Rr, G5 = /[\\^$.*+?()[\]{}|]/g, W5 = /^\[object .+?Constructor\]$/, X5 = Function.prototype, J5 = Object.prototype, e6 = X5.toString, t6 = J5.hasOwnProperty, n6 = RegExp(
  "^" + e6.call(t6).replace(G5, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function r6(e) {
  if (!q5(e) || H5(e))
    return !1;
...
var a6 = i6, s6 = o6, l6 = a6;
function c6(e, n) {
  var t = l6(e, n);
  return s6(t) ? t : void 0;
}
var E1 = c6, u6 = E1, d6 = function() {
  try {
...
var Vr = g6, y6 = Zr, m6 = Vr, p6 = Object.prototype, v6 = p6.hasOwnProperty;
function C6(e, n, t) {
  var r = e[n];
  (!(v6.call(e, n) && m6(r, t)) || t === void 0 && !(n in e)) && y6(e, n, t);
}
var S0 = C6, $6 = Array.isArray, V1 = $6;
function b6(e) {
  return e != null && typeof e == "object";
}
var H1 = b6, _6 = gt, k6 = H1, x6 = "[object Symbol]";
function L6(e) {
  return typeof e == "symbol" || k6(e) && _6(e) == x6;
}
var P0 = L6, w6 = V1, A6 = P0, M6 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, T6 = /^\w*$/;
function S6(e, n) {
  if (w6(e))
    return !1;
  var t = typeof e;
  return t == "number" || t == "symbol" || t == "boolean" || e == null || A6(e) ? !0 : T6.test(e) || !M6.test(e) || n != null && e in Object(n);
}
var P6 = S6, O6 = E1, D6 = O6(Object, "create"), Jt = D6, Gn = Jt;
function N6() {
...
var B6 = E6, F6 = Jt, U6 = "__lodash_hash_undefined__", z6 = Object.prototype, K6 = z6.hasOwnProperty;
function j6(e) {
  var n = this.__data__;
  if (F6) {
    var t = n[e];
    return t === U6 ? void 0 : t;
  }
  return K6.call(n, e) ? n[e] : void 0;
}
var Q6 = j6, R6 = Jt, Z6 = Object.prototype, V6 = Z6.hasOwnProperty;
function H6(e) {
  var n = this.__data__;
  return R6 ? n[e] !== void 0 : V6.call(n, e);
}
var q6 = H6, Y6 = Jt, G6 = "__lodash_hash_undefined__";
function W6(e, n) {
  var t = this.__data__;
  return this.size += this.has(e) ? 0 : 1, t[e] = Y6 && n === void 0 ? G6 : n, this;
}
var X6 = W6, J6 = I6, e2 = B6, t2 = Q6, n2 = q6, r2 = X6;
function q1(e) {
...
q1.prototype.clear = J6;
q1.prototype.delete = e2;
q1.prototype.get = t2;
q1.prototype.has = n2;
q1.prototype.set = r2;
var o2 = q1;
...
var e0 = l2, c2 = e0, u2 = Array.prototype, d2 = u2.splice;
function h2(e) {
  var n = this.__data__, t = c2(n, e);
  if (t < 0)
    return !1;
  var r = n.length - 1;
  return t == r ? n.pop() : d2.call(n, t, 1), --this.size, !0;
}
var f2 = h2, g2 = e0;
function y2(e) {
...
var C2 = v2, $2 = e0;
function b2(e, n) {
  var t = this.__data__, r = $2(t, e);
  return r < 0 ? (++this.size, t.push([e, n])) : t[r][1] = n, this;
}
var _2 = b2, k2 = a2, x2 = f2, L2 = m2, w2 = C2, A2 = _2;
function Y1(e) {
  var n = -1, t = e == null ? 0 : e.length;
  for (this.clear(); ++n < t; ) {
    var r = e[n];
...
Y1.prototype.delete = x2;
Y1.prototype.get = L2;
Y1.prototype.has = w2;
Y1.prototype.set = A2;
var t0 = Y1, M2 = E1, T2 = a1, S2 = M2(T2, "Map"), O0 = S2, Wn = o2, P2 = t0, O2 = O0;
function D2() {
...
function F2(e, n) {
  var t = e.__data__;
  return B2(n) ? t[typeof n == "string" ? "string" : "hash"] : t.map;
}
var n0 = F2, U2 = n0;
function z2(e) {
  var n = U2(this, e).delete(e);
  return this.size -= n ? 1 : 0, n;
}
var K2 = z2, j2 = n0;
function Q2(e) {
...
var H2 = V2, q2 = n0;
function Y2(e, n) {
  var t = q2(this, e), r = t.size;
  return t.set(e, n), this.size += t.size == r ? 0 : 1, this;
}
var G2 = Y2, W2 = N2, X2 = K2, J2 = R2, e3 = H2, t3 = G2;
function G1(e) {
  var n = -1, t = e == null ? 0 : e.length;
  for (this.clear(); ++n < t; ) {
    var r = e[n];
...
G1.prototype.clear = W2;
G1.prototype.delete = X2;
G1.prototype.get = J2;
G1.prototype.has = e3;
G1.prototype.set = t3;
var Hr = G1, qr = Hr, n3 = "Expected a function";
function D0(e, n) {
  ...
  return t.cache = new (D0.Cache || qr)(), t;
}
D0.Cache = qr;
var r3 = D0, o3 = r3, i3 = 500;
function a3(e) {
  var n = o3(e, function(r) {
    return t.size === i3 && t.clear(), r;
  }), t = n.cache;
  return n;
}
var s3 = a3, l3 = s3, c3 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, u3 = /\\(\\)?/g, d3 = l3(function(e) {
  var n = [];
  return e.charCodeAt(0) === 46 && n.push(""), e.replace(c3, function(t, r, a, s) {
    n.push(a ? s.replace(u3, "$1") : r || t);
  }), n;
}), h3 = d3;
function f3(e, n) {
...
var g3 = f3, Xn = Xt, y3 = g3, m3 = V1, p3 = P0, v3 = 1 / 0, Jn = Xn ? Xn.prototype : void 0, er = Jn ? Jn.toString : void 0;
function Yr(e) {
  if (typeof e == "string")
    return e;
  if (m3(e))
  ...
  if (p3(e))
    return er ? er.call(e) : "";
  var n = e + "";
  return n == "0" && 1 / e == -v3 ? "-0" : n;
}
var C3 = Yr, $3 = C3;
function b3(e) {
  return e == null ? "" : $3(e);
}
var _3 = b3, k3 = V1, x3 = P6, L3 = h3, w3 = _3;
function A3(e, n) {
  return k3(e) ? e : x3(e, n) ? [e] : L3(w3(e));
}
var M3 = A3, T3 = 9007199254740991, S3 = /^(?:0|[1-9]\d*)$/;
function P3(e, n) {
  var t = typeof e;
  return n = n ?? T3, !!n && (t == "number" || t != "symbol" && S3.test(e)) && e > -1 && e % 1 == 0 && e < n;
}
var Gr = P3, O3 = P0, D3 = 1 / 0;
function N3(e) {
  if (typeof e == "string" || O3(e))
    return e;
  var n = e + "";
  return n == "0" && 1 / e == -D3 ? "-0" : n;
}
var I3 = N3, E3 = S0, B3 = M3, F3 = Gr, tr = Z1, U3 = I3;
function z3(e, n, t, r) {
  if (!tr(e))
    return e;
  n = B3(n, e);
  for (var a = -1, s = n.length, d = s - 1, u = e; u != null && ++a < s; ) {
    ...
    if (a != d) {
      var y = u[m];
      k = r ? r(y, m, u) : void 0, k === void 0 && (k = tr(y) ? y : F3(n[a + 1]) ? [] : {});
    }
    E3(u, m, k), u = u[m];
  }
  return e;
...
var K3 = z3, j3 = K3;
function Q3(e, n, t) {
  return e == null ? e : j3(e, n, t);
}
var R3 = Q3;
const b0 = /* @__PURE__ */ zr(R3);
var Z3 = t0;
function V3() {
...
var J3 = X3, eo = t0, to = O0, no = Hr, ro = 200;
function oo(e, n) {
  var t = this.__data__;
  if (t instanceof eo) {
    var r = t.__data__;
    ...
    t = this.__data__ = new no(r);
  }
  return t.set(e, n), this.size = t.size, this;
}
var io = oo, ao = t0, so = H3, lo = Y3, co = W3, uo = J3, ho = io;
function W1(e) {
  var n = this.__data__ = new ao(e);
  this.size = n.size;
}
W1.prototype.clear = so;
W1.prototype.delete = lo;
W1.prototype.get = co;
W1.prototype.has = uo;
W1.prototype.set = ho;
var fo = W1;
...
var $o = Co, bo = gt, _o = H1, ko = "[object Arguments]";
function xo(e) {
  return _o(e) && bo(e) == ko;
}
var Lo = xo, nr = Lo, wo = H1, Wr = Object.prototype, Ao = Wr.hasOwnProperty, Mo = Wr.propertyIsEnumerable, To = nr(function() {
  return arguments;
}()) ? nr : function(e) {
  return wo(e) && Ao.call(e, "callee") && !Mo.call(e, "callee");
}, So = To, Vt = { exports: {} };
function Po() {
  return !1;
}
...
Vt.exports;
(function(e, n) {
  var t = a1, r = Oo, a = n && !n.nodeType && n, s = a && !0 && e && !e.nodeType && e, d = s && s.exports === a, u = d ? t.Buffer : void 0, m = u ? u.isBuffer : void 0, k = m || r;
  e.exports = k;
})(Vt, Vt.exports);
var Xr = Vt.exports, Do = 9007199254740991;
function No(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= Do;
}
var Jr = No, Io = gt, Eo = Jr, Bo = H1, Fo = "[object Arguments]", Uo = "[object Array]", zo = "[object Boolean]", Ko = "[object Date]", jo = "[object Error]", Qo = "[object Function]", Ro = "[object Map]", Zo = "[object Number]", Vo = "[object Object]", Ho = "[object RegExp]", qo = "[object Set]", Yo = "[object String]", Go = "[object WeakMap]", Wo = "[object ArrayBuffer]", Xo = "[object DataView]", Jo = "[object Float32Array]", ei = "[object Float64Array]", ti = "[object Int8Array]", ni = "[object Int16Array]", ri = "[object Int32Array]", oi = "[object Uint8Array]", ii = "[object Uint8ClampedArray]", ai = "[object Uint16Array]", si = "[object Uint32Array]", ge = {};
ge[Jo] = ge[ei] = ge[ti] = ge[ni] = ge[ri] = ge[oi] = ge[ii] = ge[ai] = ge[si] = !0;
ge[Fo] = ge[Uo] = ge[Wo] = ge[zo] = ge[Xo] = ge[Ko] = ge[jo] = ge[Qo] = ge[Ro] = ge[Zo] = ge[Vo] = ge[Ho] = ge[qo] = ge[Yo] = ge[Go] = !1;
function li(e) {
  return Bo(e) && Eo(e.length) && !!ge[Io(e)];
}
var ci = li;
function ui(e) {
  return function(n) {
...
var N0 = ui, Ht = { exports: {} };
Ht.exports;
(function(e, n) {
  var t = Kr, r = n && !n.nodeType && n, a = r && !0 && e && !e.nodeType && e, s = a && a.exports === r, d = s && t.process, u = function() {
    try {
...
var I0 = Ht.exports, di = ci, hi = N0, rr = I0, or = rr && rr.isTypedArray, fi = or ? hi(or) : di, gi = fi, yi = $o, mi = So, pi = V1, vi = Xr, Ci = Gr, $i = gi, bi = Object.prototype, _i = bi.hasOwnProperty;
function ki(e, n) {
  var t = pi(e), r = !t && mi(e), a = !t && !r && vi(e), s = !t && !r && !a && $i(e), d = t || r || a || s, u = d ? yi(e.length, String) : [], m = u.length;
  for (var k in e)
    (n || _i.call(e, k)) && !(d && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var e9 = ki, xi = Object.prototype;
function Li(e) {
  var n = e && e.constructor, t = typeof n == "function" && n.prototype || xi;
  return e === t;
}
var E0 = Li;
function wi(e, n) {
...
var t9 = wi, Ai = t9, Mi = Ai(Object.keys, Object), Ti = Mi, Si = E0, Pi = Ti, Oi = Object.prototype, Di = Oi.hasOwnProperty;
function Ni(e) {
  if (!Si(e))
    return Pi(e);
  var n = [];
  for (var t in Object(e))
    Di.call(e, t) && t != "constructor" && n.push(t);
  return n;
}
var Ii = Ni, Ei = Qr, Bi = Jr;
function Fi(e) {
  return e != null && Bi(e.length) && !Ei(e);
}
var n9 = Fi, Ui = e9, zi = Ii, Ki = n9;
function ji(e) {
  return Ki(e) ? Ui(e) : zi(e);
}
var B0 = ji, Qi = r0, Ri = B0;
function Zi(e, n) {
  return e && Qi(n, Ri(n), e);
}
var Vi = Zi;
function Hi(e) {
  var n = [];
...
var qi = Hi, Yi = Z1, Gi = E0, Wi = qi, Xi = Object.prototype, Ji = Xi.hasOwnProperty;
function e8(e) {
  if (!Yi(e))
    return Wi(e);
  var n = Gi(e), t = [];
  for (var r in e)
    r == "constructor" && (n || !Ji.call(e, r)) || t.push(r);
  return t;
}
var t8 = e8, n8 = e9, r8 = t8, o8 = n9;
function i8(e) {
  return o8(e) ? n8(e, !0) : r8(e);
}
var F0 = i8, a8 = r0, s8 = F0;
function l8(e, n) {
  return e && a8(n, s8(n), e);
}
var c8 = l8, qt = { exports: {} };
qt.exports;
(function(e, n) {
...
var r9 = y8, m8 = g8, p8 = r9, v8 = Object.prototype, C8 = v8.propertyIsEnumerable, ir = Object.getOwnPropertySymbols, $8 = ir ? function(e) {
  return e == null ? [] : (e = Object(e), m8(ir(e), function(n) {
    return C8.call(e, n);
  }));
} : p8, U0 = $8, b8 = r0, _8 = U0;
function k8(e, n) {
...
var o9 = L8, w8 = t9, A8 = w8(Object.getPrototypeOf, Object), i9 = A8, M8 = o9, T8 = i9, S8 = U0, P8 = r9, O8 = Object.getOwnPropertySymbols, D8 = O8 ? function(e) {
  for (var n = []; e; )
    M8(n, S8(e)), e = T8(e);
  return n;
} : P8, a9 = D8, N8 = r0, I8 = a9;
function E8(e, n) {
  return N8(e, I8(e), n);
}
var B8 = E8, F8 = o9, U8 = V1;
function z8(e, n, t) {
  var r = n(e);
  return U8(e) ? r : F8(r, t(e));
}
var s9 = z8, K8 = s9, j8 = U0, Q8 = B0;
function R8(e) {
  return K8(e, Q8, j8);
}
var Z8 = R8, V8 = s9, H8 = a9, q8 = F0;
function Y8(e) {
  return V8(e, q8, H8);
}
var G8 = Y8, W8 = E1, X8 = a1, J8 = W8(X8, "DataView"), ea = J8, ta = E1, na = a1, ra = ta(na, "Promise"), oa = ra, ia = E1, aa = a1, sa = ia(aa, "Set"), la = sa, ca = E1, ua = a1, da = ca(ua, "WeakMap"), ha = da, _0 = ea, k0 = O0, x0 = oa, L0 = la, w0 = ha, l9 = gt, X1 = Rr, ar = "[object Map]", fa = "[object Object]", sr = "[object Promise]", lr = "[object Set]", cr = "[object WeakMap]", ur = "[object DataView]", ga = X1(_0), ya = X1(k0), ma = X1(x0), pa = X1(L0), va = X1(w0), S1 = l9;
(_0 && S1(new _0(new ArrayBuffer(1))) != ur || k0 && S1(new k0()) != ar || x0 && S1(x0.resolve()) != sr || L0 && S1(new L0()) != lr || w0 && S1(new w0()) != cr) && (S1 = function(e) {
  var n = l9(e), t = n == fa ? e.constructor : void 0, r = t ? X1(t) : "";
  if (r)
    switch (r) {
      case ga:
        return ur;
...
var z0 = S1, Ca = Object.prototype, $a = Ca.hasOwnProperty;
function ba(e) {
  var n = e.length, t = new e.constructor(n);
  return n && typeof e[0] == "string" && $a.call(e, "index") && (t.index = e.index, t.input = e.input), t;
}
var _a = ba, ka = a1, xa = ka.Uint8Array, La = xa, dr = La;
function wa(e) {
...
var Oa = Pa, hr = Xt, fr = hr ? hr.prototype : void 0, gr = fr ? fr.valueOf : void 0;
function Da(e) {
...
var Ba = Ea, Fa = K0, Ua = Ta, za = Oa, Ka = Na, ja = Ba, Qa = "[object Boolean]", Ra = "[object Date]", Za = "[object Map]", Va = "[object Number]", Ha = "[object RegExp]", qa = "[object Set]", Ya = "[object String]", Ga = "[object Symbol]", Wa = "[object ArrayBuffer]", Xa = "[object DataView]", Ja = "[object Float32Array]", e7 = "[object Float64Array]", t7 = "[object Int8Array]", n7 = "[object Int16Array]", r7 = "[object Int32Array]", o7 = "[object Uint8Array]", i7 = "[object Uint8ClampedArray]", a7 = "[object Uint16Array]", s7 = "[object Uint32Array]";
function l7(e, n, t) {
  var r = e.constructor;
  switch (n) {
    case Wa:
...
var c7 = l7, u7 = Z1, yr = Object.create, d7 = function() {
  function e() {
  }
  return function(n) {
    if (!u7(n))
...
}(), h7 = d7, f7 = h7, g7 = i9, y7 = E0;
function m7(e) {
  return typeof e.constructor == "function" && !y7(e) ? f7(g7(e)) : {};
}
var p7 = m7, v7 = z0, C7 = H1, $7 = "[object Map]";
function b7(e) {
  return C7(e) && v7(e) == $7;
}
var _7 = b7, k7 = _7, x7 = N0, mr = I0, pr = mr && mr.isMap, L7 = pr ? x7(pr) : k7, w7 = L7, A7 = z0, M7 = H1, T7 = "[object Set]";
function S7(e) {
  return M7(e) && A7(e) == T7;
}
var P7 = S7, O7 = P7, D7 = N0, vr = I0, Cr = vr && vr.isSet, N7 = Cr ? D7(Cr) : O7, I7 = N7, E7 = fo, B7 = yo, F7 = S0, U7 = Vi, z7 = c8, K7 = u8, j7 = h8, Q7 = x8, R7 = B8, Z7 = Z8, V7 = G8, H7 = z0, q7 = _a, Y7 = c7, G7 = p7, W7 = V1, X7 = Xr, J7 = w7, es = Z1, ts = I7, ns = B0, rs = F0, os = 1, is = 2, as = 4, c9 = "[object Arguments]", ss = "[object Array]", ls = "[object Boolean]", cs = "[object Date]", us = "[object Error]", u9 = "[object Function]", ds = "[object GeneratorFunction]", hs = "[object Map]", fs = "[object Number]", d9 = "[object Object]", gs = "[object RegExp]", ys = "[object Set]", ms = "[object String]", ps = "[object Symbol]", vs = "[object WeakMap]", Cs = "[object ArrayBuffer]", $s = "[object DataView]", bs = "[object Float32Array]", _s = "[object Float64Array]", ks = "[object Int8Array]", xs = "[object Int16Array]", Ls = "[object Int32Array]", ws = "[object Uint8Array]", As = "[object Uint8ClampedArray]", Ms = "[object Uint16Array]", Ts = "[object Uint32Array]", fe = {};
fe[c9] = fe[ss] = fe[Cs] = fe[$s] = fe[ls] = fe[cs] = fe[bs] = fe[_s] = fe[ks] = fe[xs] = fe[Ls] = fe[hs] = fe[fs] = fe[d9] = fe[gs] = fe[ys] = fe[ms] = fe[ps] = fe[ws] = fe[As] = fe[Ms] = fe[Ts] = !0;
fe[us] = fe[u9] = fe[vs] = !1;
function zt(e, n, t, r, a, s) {
  var d, u = n & os, m = n & is, k = n & as;
  ...
  if (y) {
    ...
    var w = H7(e), A = w == u9 || w == ds;
    if (X7(e))
      return K7(e, u);
    if (w == d9 || w == c9 || A && !a) {
      if (d = m || A ? {} : G7(e), !u)
        return m ? R7(e, z7(d, e)) : Q7(e, U7(d, e));
    } else {
      if (!fe[w])
        return a ? e : {};
      d = Y7(e, w, u);
  ...
  if (O)
    return O;
  s.set(e, d), ts(e) ? e.forEach(function(D) {
    d.add(zt(D, n, t, D, e, s));
  }) : J7(e) && e.forEach(function(D, K) {
    d.set(K, zt(D, n, t, K, e, s));
  });
  var F = k ? m ? V7 : Z7 : m ? rs : ns, B = y ? void 0 : F(e);
  return B7(B || e, function(D, K) {
    B && (K = D, D = e[K]), F7(d, K, zt(D, n, t, K, e, s));
  }), d;
}
var Ss = zt, Ps = Ss, Os = 1, Ds = 4;
function Ns(e) {
  return Ps(e, Os | Ds);
}
var Is = Ns;
const Es = /* @__PURE__ */ zr(Is), Bs = /* @__PURE__ */ $("<button></button>"), Fs = (e) => (() => {
  const n = Bs.cloneNode(!0);
  return i1(n, "click", e.onClick, !0), p(n, () => e.children), E((t) => {
...
Qe(["click"]);
const Us = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), zs = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), Ks = /* @__PURE__ */ $("<div></div>"), js = /* @__PURE__ */ $('<span class="label"></span>'), Qs = () => Us.cloneNode(!0), Rs = () => zs.cloneNode(!0), $r = (e) => {
  const [n, t] = T(e.checked ?? !1);
  return ze(() => {
    "checked" in e && t(e.checked);
  }), (() => {
    const r = Ks.cloneNode(!0);
    return r.$$click = (a) => {
      const s = !n();
...
Qe(["click"]);
const Zs = /* @__PURE__ */ $('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), h9 = () => Zs.cloneNode(!0), Vs = /* @__PURE__ */ $('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), Hs = () => Vs.cloneNode(!0), qs = /* @__PURE__ */ $("<ul></ul>"), Ys = /* @__PURE__ */ $("<li></li>"), Yt = (e) => (() => {
  ...
  return p(n, L(J, {
    ...
    get children() {
      ...
      return (t = e.dataSource) == null ? void 0 : t.map((r) => {
        var a;
        return ((a = e.renderItem) == null ? void 0 : a.call(e, r)) ?? Ys.cloneNode(!0);
      });
    }
  }), null), E((t) => {
  ...
  return n.$$click = (d) => {
    ...
    return () => d() && (() => {
      ...
      return p(u, () => e.buttons.map((m) => L(Fs, Ur(m, {
        get style() {
          return {
            ...e.minButtonWidth ? {
    ...
    const u = !!e.isMobile, m = e.isMobile ? "100%" : `${e.width ?? 400}px`, k = (e.isMobile, "auto"), y = e.isMobile ? "60vh" : "90vh", w = !!e.isMobile, A = !!e.isMobile, O = !!e.isMobile;
    return u !== d._v$ && n.classList.toggle("mobile-modal", d._v$ = u), m !== d._v$2 && t.style.setProperty("width", d._v$2 = m), k !== d._v$3 && t.style.setProperty("height", d._v$3 = k), y !== d._v$4 && t.style.setProperty("max-height", d._v$4 = y), w !== d._v$5 && t.classList.toggle("mobile-inner", d._v$5 = w), A !== d._v$6 && r.classList.toggle("mobile-title", d._v$6 = A), O !== d._v$7 && s.classList.toggle("mobile-content", d._v$7 = O), d;
  }, {
    _v$: void 0,
    _v$2: void 0,
    _v$3: void 0,
...
Qe(["click"]);
const Xs = /* @__PURE__ */ $('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), Js = /* @__PURE__ */ $('<div class="drop-down-container"><ul></ul></div>'), e4 = /* @__PURE__ */ $('<div><input type="text"></div>'), t4 = /* @__PURE__ */ $("<li></li>"), f9 = (e) => {
  const [n, t] = T(!1), [r, a] = T("");
  let s, d;
  const u = Z(() => {
    ...
    const y = !n();
    t(y), a(""), y && e.searchable && setTimeout(() => s == null ? void 0 : s.focus(), 50);
  }, k = (y) => {
    const w = y.relatedTarget;
    d && w && d.contains(w) || (t(!1), a(""));
  };
  return (() => {
    const y = Xs.cloneNode(!0), w = y.firstChild, A = w.firstChild;
    y.addEventListener("blur", k), y.$$click = (F) => {
      F.stopPropagation(), m();
    };
    const O = d;
    return typeof O == "function" ? D1(O, y) : d = y, p(A, () => e.value), p(y, (() => {
      const F = Z(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => F() && (() => {
        const B = Js.cloneNode(!0), D = B.firstChild;
        return B.$$mousedown = (K) => K.preventDefault(), p(B, (() => {
          const K = Z(() => !!e.searchable);
          return () => K() && (() => {
            const X = e4.cloneNode(!0), U = X.firstChild;
            ...
            const Y = s;
            return typeof Y == "function" ? D1(Y, U) : s = U, U.style.setProperty("width", "100%"), U.style.setProperty("padding", "6px 10px"), U.style.setProperty("border", "1px solid var(--klinecharts-pro-border-color)"), U.style.setProperty("border-radius", "4px"), U.style.setProperty("background-color", "var(--klinecharts-pro-popover-background-color)"), U.style.setProperty("color", "#fff"), U.style.setProperty("font-size", "13px"), U.style.setProperty("outline", "none"), E(() => Pe(U, "placeholder", e.searchPlaceholder || "Search...")), E(() => U.value = r()), X;
          })();
        })(), D), p(D, () => {
          var K;
          return (K = u()) == null ? void 0 : K.map((X) => {
            ...
            return (() => {
              const V = t4.cloneNode(!0);
              return V.$$click = (ue) => {
                var j;
                ue.stopPropagation(), e.value !== Y && ((j = e.onSelected) == null || j.call(e, X)), t(!1), a("");
              }, p(V, Y), E(() => V.classList.toggle("selected", e.value === Y)), V;
            })();
          });
        }), B;
      })();
...
const n4 = /* @__PURE__ */ $('<span class="prefix"></span>'), r4 = /* @__PURE__ */ $('<span class="suffix"></span>'), o4 = /* @__PURE__ */ $('<div><input class="value"></div>'), g9 = (e) => {
  const n = Ur({
  ...
  const [r, a] = T("normal");
  return (() => {
    const s = o4.cloneNode(!0), d = s.firstChild;
    return s.$$click = () => {
      t == null || t.focus();
    }, p(s, L(J, {
      get when() {
      ...
      const m = n.style, k = `klinecharts-pro-input ${n.class ?? ""}`, y = r(), w = n.placeholder ?? "";
      return u._v$ = I1(s, m, u._v$), k !== u._v$2 && oe(s, u._v$2 = k), y !== u._v$3 && Pe(s, "data-status", u._v$3 = y), w !== u._v$4 && Pe(d, "placeholder", u._v$4 = w), u;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
Qe(["click"]);
const i4 = /* @__PURE__ */ $('<div><i class="thumb"></i></div>'), a4 = (e) => (() => {
  const n = i4.cloneNode(!0);
  return n.$$click = (t) => {
...
Qe(["click"]);
const s4 = "指标", l4 = "更多", c4 = "主图指标", u4 = "副图指标", d4 = "设置", h4 = "时区", f4 = "截屏", g4 = "全屏", y4 = "退出全屏", m4 = "保存", p4 = "确定", v4 = "取消", C4 = "MA(移动平均线)", $4 = "EMA(指数平滑移动平均线)", b4 = "SMA", _4 = "BOLL(布林线)", k4 = "BBI(多空指数)", x4 = "SAR(停损点指向指标)", L4 = "VOL(成交量)", w4 = "MACD(指数平滑异同移动平均线)", A4 = "KDJ(随机指标)", M4 = "RSI(相对强弱指标)", T4 = "BIAS(乖离率)", S4 = "BRAR(情绪指标)", P4 = "CCI(顺势指标)", O4 = "DMI(动向指标)", D4 = "CR(能量指标)", N4 = "PSY(心理线)", I4 = "DMA(平行线差指标)", E4 = "TRIX(三重指数平滑平均线)", B4 = "OBV(能量潮指标)", F4 = "VR(成交量变异率)", U4 = "WR(威廉指标)", z4 = "MTM(动量指标)", K4 = "EMV(简易波动指标)", j4 = "ROC(变动率指标)", Q4 = "PVT(价量趋势指标)", R4 = "AO(动量震荡指标)", Z4 = "世界统一时间", V4 = "(UTC-10) 檀香山", H4 = "(UTC-8) 朱诺", q4 = "(UTC-7) 洛杉矶", Y4 = "(UTC-5) 芝加哥", G4 = "(UTC-4) 多伦多", W4 = "(UTC-3) 圣保罗", X4 = "(UTC+1) 伦敦", J4 = "(UTC+2) 柏林", el = "(UTC+3) 巴林", tl = "(UTC+4) 迪拜", nl = "(UTC+5) 阿什哈巴德", rl = "(UTC+6) 阿拉木图", ol = "(UTC+7) 曼谷", il = "(UTC+8) 上海", al = "(UTC+9) 东京", sl = "(UTC+10) 悉尼", ll = "(UTC+12) 诺福克岛", cl = "水平直线", ul = "水平射线", dl = "水平线段", hl = "垂直直线", fl = "垂直射线", gl = "垂直线段", yl = "直线", ml = "射线", pl = "线段", vl = "箭头", Cl = "价格线", $l = "价格通道线", bl = "平行直线", _l = "斐波那契回调直线", kl = "斐波那契回调线段", xl = "斐波那契圆环", Ll = "斐波那契螺旋", wl = "斐波那契速度阻力扇", Al = "斐波那契趋势扩展", Ml = "江恩箱", Tl = "矩形", Sl = "平行四边形", Pl = "圆", Ol = "三角形", Dl = "三浪", Nl = "五浪", Il = "八浪", El = "任意浪", Bl = "ABCD形态", Fl = "XABCD形态", Ul = "弱磁模式", zl = "强磁模式", Kl = "商品搜索", jl = "商品代码", Ql = "参数1", Rl = "参数2", Zl = "参数3", Vl = "参数4", Hl = "参数5", ql = "周期", Yl = "标准差", Gl = "蜡烛图类型", Wl = "全实心", Xl = "全空心", Jl = "涨空心", ec = "跌空心", tc = "OHLC", nc = "面积图", rc = "最新价显示", oc = "最高价显示", ic = "最低价显示", ac = "指标最新值显示", sc = "价格轴类型", lc = "线性轴", cc = "百分比轴", uc = "对数轴", dc = "倒置坐标", hc = "网格线显示", fc = "恢复默认", gc = {
  indicator: s4,
  more: l4,
  main_indicator: c4,
  sub_indicator: u4,
  ...
  sydney: sl,
  norfolk: ll,
  horizontal_straight_line: cl,
  horizontal_ray_line: ul,
  horizontal_segment: dl,
  vertical_straight_line: hl,
  vertical_ray_line: fl,
  vertical_segment: gl,
  straight_line: yl,
  ray_line: ml,
  segment: pl,
  arrow: vl,
  price_line: Cl,
  price_channel_line: $l,
  parallel_straight_line: bl,
  fibonacci_line: _l,
  fibonacci_segment: kl,
  fibonacci_circle: xl,
  fibonacci_spiral: Ll,
  fibonacci_speed_resistance_fan: wl,
  fibonacci_extension: Al,
  gann_box: Ml,
  rect: Tl,
  parallelogram: Sl,
  circle: Pl,
  ...
  grid_show: hc,
  restore_default: fc
}, yc = "Indicator", mc = "More", pc = "Main Indicator", vc = "Sub Indicator", Cc = "Setting", $c = "Timezone", bc = "Screenshot", _c = "Full Screen", kc = "Exit", xc = "Save", Lc = "Confirm", wc = "Cancel", Ac = "MA(Moving Average)", Mc = "EMA(Exponential Moving Average)", Tc = "SMA", Sc = "BOLL(Bolinger Bands)", Pc = "BBI(Bull And Bearlndex)", Oc = "SAR(Stop and Reverse)", Dc = "VOL(Volume)", Nc = "MACD(Moving Average Convergence / Divergence)", Ic = "KDJ(KDJ Index)", Ec = "RSI(Relative Strength Index)", Bc = "BIAS(Bias Ratio)", Fc = "BRAR(情绪指标)", Uc = "CCI(Commodity Channel Index)", zc = "DMI(Directional Movement Index)", Kc = "CR(能量指标)", jc = "PSY(Psychological Line)", Qc = "DMA(Different of Moving Average)", Rc = "TRIX(Triple Exponentially Smoothed Moving Average)", Zc = "OBV(On Balance Volume)", Vc = "VR(Volatility Volume Ratio)", Hc = "WR(Williams %R)", qc = "MTM(Momentum Index)", Yc = "EMV(Ease of Movement Value)", Gc = "ROC(Price Rate of Change)", Wc = "PVT(Price and Volume Trend)", Xc = "AO(Awesome Oscillator)", Jc = "UTC", eu = "(UTC-10) Honolulu", tu = "(UTC-8) Juneau", nu = "(UTC-7) Los Angeles", ru = "(UTC-5) Chicago", ou = "(UTC-4) Toronto", iu = "(UTC-3) Sao Paulo", au = "(UTC+1) London", su = "(UTC+2) Berlin", lu = "(UTC+3) Bahrain", cu = "(UTC+4) Dubai", uu = "(UTC+5) Ashkhabad", du = "(UTC+6) Almaty", hu = "(UTC+7) Bangkok", fu = "(UTC+8) Shanghai", gu = "(UTC+9) Tokyo", yu = "(UTC+10) Sydney", mu = "(UTC+12) Norfolk", pu = "Horizontal Line", vu = "Horizontal Ray", Cu = "Horizontal Segment", $u = "Vertical Line", bu = "Vertical Ray", _u = "Vertical Segment", ku = "Trend Line", xu = "Ray", Lu = "Segment", wu = "Arrow", Au = "Price Line", Mu = "Price Channel Line", Tu = "Parallel Line", Su = "Fibonacci Line", Pu = "Fibonacci Segment", Ou = "Fibonacci Circle", Du = "Fibonacci Spiral", Nu = "Fibonacci Sector", Iu = "Fibonacci Extension", Eu = "Gann Box", Bu = "Rect", Fu = "Parallelogram", Uu = "Circle", zu = "Triangle", Ku = "Three Waves", ju = "Five Waves", Qu = "Eight Waves", Ru = "Any Waves", Zu = "ABCD Pattern", Vu = "XABCD Pattern", Hu = "Weak Magnet", qu = "Strong Magnet", Yu = "Symbol Search", Gu = "Symbol Code", Wu = "Parameter 1", Xu = "Parameter 2", Ju = "Parameter 3", ed = "Parameter 4", td = "Parameter 5", nd = "Period", rd = "Standard Deviation", od = "Candle Type", id = "Candle Solid", ad = "Candle Stroke", sd = "Candle Up Stroke", ld = "Candle Down Stroke", cd = "OHLC", ud = "Area", dd = "Show Last Price", hd = "Show Highest Price", fd = "Show Lowest Price", gd = "Show indicator's last value", yd = "Price Axis Type", md = "Normal", pd = "Percentage", vd = "Log", Cd = "Reverse Coordinate", $d = "Show Grids", bd = "Restore Defaults", _d = {
  indicator: yc,
  more: mc,
  main_indicator: pc,
  sub_indicator: vc,
  ...
  sydney: yu,
  norfolk: mu,
  horizontal_straight_line: pu,
  horizontal_ray_line: vu,
  horizontal_segment: Cu,
  vertical_straight_line: $u,
  vertical_ray_line: bu,
  vertical_segment: _u,
  straight_line: ku,
  ray_line: xu,
  segment: Lu,
  arrow: wu,
  price_line: Au,
  price_channel_line: Mu,
  parallel_straight_line: Tu,
  fibonacci_line: Su,
  fibonacci_segment: Pu,
  fibonacci_circle: Ou,
  fibonacci_spiral: Du,
  fibonacci_speed_resistance_fan: Nu,
  fibonacci_extension: Iu,
  gann_box: Eu,
  rect: Bu,
  parallelogram: Fu,
  circle: Uu,
...
const c = (e, n) => {
  ...
  const [a, s] = T(window.innerWidth < 768), [d, u] = T(localStorage.getItem("klinechart_secondary_period") || ""), [m, k] = T(!1), [y, w] = T(!1), [A, O] = T(!1), [F, B] = T(!1), [D, K] = T(!1), [X, U] = T({
    ...
    k((N) => {
      const I = !N;
      return I ? queueMicrotask(Oe) : be(), I;
    });
  }, _e = (N) => {
    if (!m())
      return;
    const I = N.target;
    I && (t != null && t.contains(I) || r != null && r.contains(I) || (be(), k(!1)));
  }, me = () => {
    m() && Oe();
  }, re = () => {
    if (!n) {
    ...
    const N = n, I = N.scrollWidth > N.clientWidth + 2;
    ne(I && N.scrollLeft > 2), $e(I && N.scrollLeft + N.clientWidth < N.scrollWidth - 2);
  };
  T0(() => {
    window.addEventListener("resize", Y), document.addEventListener("fullscreenchange", Q), document.addEventListener("mousedown", _e), window.addEventListener("scroll", me, !0), document.addEventListener("mozfullscreenchange", Q), document.addEventListener("webkitfullscreenchange", Q), document.addEventListener("msfullscreenchange", Q), n && (n.addEventListener("scroll", re), setTimeout(re, 100));
  }), N1(() => {
    window.removeEventListener("resize", Y), document.removeEventListener("fullscreenchange", Q), document.removeEventListener("mousedown", _e), window.removeEventListener("scroll", me, !0), document.removeEventListener("mozfullscreenchange", Q), document.removeEventListener("webkitfullscreenchange", Q), document.removeEventListener("msfullscreenchange", Q), n && n.removeEventListener("scroll", re);
  });
  const pe = Z(() => {
    const N = e.periods.filter((I) => {
      if (!a() || V())
        return !0;
      const ve = e.period.text, Ne = d();
      if (I.text === ve || Ne && I.text === Ne)
        return !0;
      if (!Ne || Ne === ve) {
        const se = e.periods.find((Le) => Le.text !== ve);
        return I.text === (se == null ? void 0 : se.text);
      }
      return !1;
  ...
  return ze(() => {
    ...
    const N = Fd.cloneNode(!0), I = N.firstChild, ve = I.firstChild, Ne = ve.firstChild, se = ve.nextSibling, Le = se.firstChild;
    return N.style.setProperty("position", "relative"), N.style.setProperty("width", "100%"), N.style.setProperty("display", "flex"), N.style.setProperty("align-items", "center"), p(N, L(J, {
      ...
      n = _;
    }, I), I.style.setProperty("width", "100%"), I.style.setProperty("overflow", "auto"), i1(Ne, "click", e.onMenuClick, !0), p(I, L(J, {
      get when() {
        return e.symbol;
      },
      get children() {
        const _ = Ld.cloneNode(!0), ae = _.firstChild;
        return i1(_, "click", e.onSymbolClick, !0), p(_, L(J, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const Me = xd.cloneNode(!0);
            return E(() => Pe(Me, "src", e.symbol.logo)), Me;
          }
        }), ae), p(ae, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), _;
      }
    }), se), p(I, () => pe().map((_, ae) => {
      const Me = _.text === e.period.text;
      return (() => {
        const s1 = Ud.cloneNode(!0);
        return s1.$$click = (de) => {
          a() && Me && !V() ? (e.onMobilePeriodClick ? e.onMobilePeriodClick(_) : e.onMenuClick(), de.stopPropagation()) : e.onPeriodChange(_);
        }, oe(s1, `item period ${Me ? "selected" : ""}`), p(s1, () => _.text), s1;
      })();
    }), se), p(I, L(J, {
      get when() {
      ...
      get children() {
        const _ = Td.cloneNode(!0), ae = _.firstChild, Me = ae.nextSibling;
        return i1(_, "click", e.onIndicatorClick, !0), p(Me, () => c("indicator", e.locale)), _;
      }
      ...
      get children() {
        const _ = Od.cloneNode(!0), ae = _.firstChild, Me = ae.firstChild, s1 = Me.nextSibling;
        return D1((de) => {
          t = de;
        }, _), _.style.setProperty("display", "flex"), _.style.setProperty("align-items", "center"), ae.$$click = (de) => {
          de.stopPropagation(), Re();
        }, ae.style.setProperty("gap", "6px"), s1.style.setProperty("transition", "transform 0.2s ease"), p(_, L(J, {
          get when() {
            return m();
          },
          get children() {
            return L(u5, {
              ...
              get children() {
                const de = Pd.cloneNode(!0), g1 = de.firstChild, l1 = g1.firstChild, J1 = l1.firstChild, Ie = J1.firstChild, yt = Ie.firstChild, B1 = l1.nextSibling, $1 = B1.firstChild, b1 = $1.firstChild, t1 = b1.firstChild, mt = $1.nextSibling, Ze = mt.firstChild, et = Ze.firstChild, tt = g1.nextSibling, y1 = tt.firstChild, _1 = y1.firstChild, nt = _1.firstChild, pt = nt.firstChild, F1 = y1.nextSibling, rt = F1.firstChild, vt = rt.firstChild, Ue = vt.nextSibling, Ke = rt.nextSibling, He = Ke.firstChild, je = He.nextSibling, ot = je.firstChild, U1 = ot.firstChild, z1 = tt.nextSibling, Ct = z1.firstChild, xe = Ct.firstChild, Ee = z1.nextSibling, $t = Ee.nextSibling, qe = $t.firstChild, m1 = qe.firstChild, p1 = $t.nextSibling, bt = p1.nextSibling, k1 = bt.firstChild, _t = k1.firstChild, Ye = bt.nextSibling, x1 = Ye.firstChild, o0 = x1.firstChild, L1 = o0.firstChild, w1 = L1.firstChild, Ge = x1.nextSibling, kt = Ge.firstChild, xt = kt.firstChild, c1 = xt.firstChild, K1 = kt.nextSibling, i0 = K1.firstChild, Lt = i0.firstChild, a0 = K1.nextSibling, it = a0.firstChild, at = it.firstChild, A1 = Ye.nextSibling, s0 = A1.firstChild, u1 = s0.firstChild;
                return de.$$mousedown = (b) => b.stopPropagation(), D1((b) => {
                  ...
                  get children() {
                    const b = Sd.cloneNode(!0);
                    return p(b, () => ["left", "center", "right"].map((S) => (() => {
                      const Te = zd.cloneNode(!0);
                      return Te.$$click = (Se) => {
                        var n1;
                  ...
                  return S !== b._v$ && de.style.setProperty("top", b._v$ = S), Te !== b._v$2 && de.style.setProperty("left", b._v$2 = Te), Se !== b._v$3 && de.style.setProperty("width", b._v$3 = Se), n1 !== b._v$4 && oe(g1, b._v$4 = n1), M1 !== b._v$5 && oe(tt, b._v$5 = M1), wt !== b._v$6 && oe(Ue, b._v$6 = wt), At !== b._v$7 && Pe(U1, "class", b._v$7 = At), st !== b._v$8 && oe(Ye, b._v$8 = st), b;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
          ...
          const g1 = a() ? "0 8px" : "0 10px", l1 = m() ? "rotate(180deg)" : "rotate(0deg)";
      ...
      const _ = Z(() => !!V());
      return () => _() ? Kd.cloneNode(!0) : jd.cloneNode(!0);
    })()), p(se, L(J, {
      get when() {
      ...
      get children() {
        ...
        return i1(_, "click", e.chartViewToggle.onToggle, !0), p(_, (() => {
          ...
          return () => ae() ? Qd.cloneNode(!0) : Rd.cloneNode(!0);
        })()), E(() => Pe(_, "title", e.chartViewToggle.view === "chart" ? "View Depth" : "View Chart")), _;
      }
    }), null), p(N, L(J, {
      get when() {
        return ie();
...
Qe(["click", "mousedown"]);
const Vd = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M12.41465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L12.41465,12C12.20873,12.5826,11.65311,13,11,13C10.34689,13,9.79127,12.5826,9.58535,12L3.5,12C3.223857,12,3,11.77614,3,11.5C3,11.22386,3.223857,11,3.5,11L9.58535,11C9.79127,10.417404,10.34689,10,11,10C11.65311,10,12.20873,10.417404,12.41465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), Hd = () => Vd.cloneNode(!0), qd = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465,11L11.08535,11C11.29127,10.417404,11.84689,10,12.5,10C13.15311,10,13.70873,10.417404,13.91465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L13.91465,12C13.70873,12.5826,13.15311,13,12.5,13C11.84689,13,11.29127,12.5826,11.08535,12L6.91465,12C6.70873,12.5826,6.15311,13,5.5,13C4.671573,13,4,12.32843,4,11.5C4,10.671573,4.671573,10,5.5,10C6.15311,10,6.70873,10.417404,6.91465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), Yd = () => qd.cloneNode(!0), Gd = /* @__PURE__ */ $('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465
  rayLine: sh,
  ...
  priceLine: fh,
  priceChannelLine: yh,
  parallelStraightLine: ph,
  fibonacciLine: Ch,
  fibonacciSegment: bh,
  fibonacciCircle: kh,
  fibonacciSpiral: Lh,
  fibonacciSpeedResistanceFan: Ah,
  fibonacciExtension: Th,
  gannBox: Ph,
  circle: Dh,
  triangle: Ih,
  rect: Bh,
...
const Ve = (e) => ff[e.name](e.class), $f = /* @__PURE__ */ $('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), bf = /* @__PURE__ */ $('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), _r = /* @__PURE__ */ $('<li><span style="padding-left:8px"></span></li>'), kr = "drawing_tools", _f = (e) => {
  const [n, t] = T("horizontalStraightLine"), [r, a] = T("priceChannelLine"), [s, d] = T("circle"), [u, m] = T("fibonacciLine"), [k, y] = T("xabcd"), [w, A] = T("weak_magnet"), [O, F] = T("normal"), [B, D] = T(!1), [K, X] = T(!0), [U, Y] = T(""), V = Z(() => [{
    key: "singleLine",
    icon: n(),
    list: gf(e.locale),
    setter: t
  ...
  return (() => {
    const j = $f.cloneNode(!0), Q = j.firstChild, q = Q.nextSibling, ne = q.firstChild, ie = ne.nextSibling, $e = ie.firstChild, Oe = q.nextSibling, be = Oe.firstChild, Re = Oe.nextSibling, _e = Re.firstChild, me = Re.nextSibling, re = me.nextSibling, pe = re.firstChild;
    return p(j, () => V().map((H) => (() => {
      const N = bf.cloneNode(!0), I = N.firstChild, ve = I.nextSibling, Ne = ve.firstChild;
      ...
      })(), null), E(() => Pe(Ne, "class", H.key === U() ? "rotate" : "")), N;
      ...
      return () => H() && L(Yt, {
        ...
        get children() {
          return ue().map((N) => (() => {
            const I = _r.cloneNode(!0), ve = I.firstChild;
            return I.$$click = () => {
      ...
      name: "remove"
    })), E(() => Pe($e, "class", U() === "mode" ? "rotate" : "")), j;
  })();
};
Qe(["click"]);
const xr = /* @__PURE__ */ $('<li class="title"></li>'), Lr = /* @__PURE__ */ $('<li class="row"></li>'), kf = (e) => L(C1, {
  get title() {
...
const Lf = (e) => {
  const [n, t] = T(e.timezone), r = Z(() => xf(e.locale));
  return L(C1, {
    get title() {
...
const wf = /* @__PURE__ */ $('<div class="klinecharts-pro-setting-modal-content"></div>'), Af = /* @__PURE__ */ $('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), Mf = (e) => {
  const [n, t] = T(e.currentStyles), [r, a] = T(Ar(e.locale)), [s, d] = T(!1), u = () => {
    ...
    get children() {
      ...
      return p(k, L(C0, {
        ...
        children: (y) => {
          ...
          return (() => {
            const O = Af.cloneNode(!0), F = O.firstChild, B = F.nextSibling;
            return p(F, () => y.text), p(B, w), E(() => O.classList.toggle("mobile-item", !!s())), O;
          })();
        }
      })), E(() => k.classList.toggle("mobile-layout", !!s())), k;
    }
  });
}, Tf = /* @__PURE__ */ $('<img style="width:500px;margin-top: 20px">'), Sf = (e) => L(C1, {
  get title() {
  ...
  get children() {
    const n = Tf.cloneNode(!0);
    return E(() => Pe(n, "src", e.url)), n;
  }
}), Pf = {
  AO: [
...
}, Of = /* @__PURE__ */ $('<div class="klinecharts-pro-indicator-setting-modal-content"></div>'), Df = /* @__PURE__ */ $("<span></span>"), Nf = (e) => {
  const [n, t] = T(ce.clone(e.params.calcParams)), r = (a) => Pf[a];
  return L(C1, {
    get title() {
    ...
    get children() {
      const a = Of.cloneNode(!0);
      return p(a, () => r(e.params.indicatorName).map((s, d) => [(() => {
        const u = Df.cloneNode(!0);
...
}, If = /* @__PURE__ */ $('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z"></path></svg>'), Ef = /* @__PURE__ */ $('<img alt="symbol">'), Bf = /* @__PURE__ */ $("<li><div><span></span></div></li>"), Ff = (e) => {
  const [n, t] = T(""), [r] = G9(n, e.datafeed.searchSymbols.bind(e.datafeed));
  return L(C1, {
    get title() {
    ...
    get children() {
      return [L(g9, {
        ...
        renderItem: (a) => (() => {
          const s = Bf.cloneNode(!0), d = s.firstChild, u = d.firstChild;
          return s.$$click = () => {
            ...
            get children() {
              const m = Ef.cloneNode(!0);
              return E(() => Pe(m, "src", a.logo)), m;
            }
          }), u), p(u, () => a.shortName ?? a.ticker, null), p(u, () => `${a.name ? `(${a.name})` : ""}`, null), p(s, () => a.exchange ?? "", null), E(() => Pe(u, "title", a.name ?? "")), s;
        })()
      })];
    }
  });
...
const Uf = /* @__PURE__ */ $('<div class="klinecharts-pro-mobile-more-modal-content"><div class="item"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="20" height="20" rx="4" ry="4" fill="none" stroke="currentColor" stroke-width="2"></rect><path d="m15.92 13.9-3.65-3.55a.773.773 0 0 1 0-1.12c.32-.33.79-.33 1.11 0l3.02 3.38c.31.32.31.81 0 1.13-.16.16-.48.16-.48.16Z" fill="currentColor" stroke="1"></path><path d="m12.43 14.23-.48-.17q-.48-.48 0-.96l4.13-4.36c.31-.32.63-.32.95 0s.32.65 0 .97l-4.13 4.35c-.15.17-.31.17-.47.17Zm-1.11-9.52c.31 0 1.11.16 1.11.97 0 .64-.95.48-1.27.48-1.43 0-1.91.81-2.07 1.45l-.31 1.94h1.58c.32 0 .64.32.64.64 0 .33-.32.65-.64.65H8.62l-1.11 4.99c-.16 1.46-1.11 1.46-1.59 0L7.03 11H5.6c-.31 0-.63-.32-.63-.65 0-.64.32-.8.63-.8h1.75l.48-2.1c.31-2.74 2.69-2.9 3.49-2.74Z" fill="noncurrentColore" stroke="1"></path></svg><span></span></div><div class="item"><svg width="20" height="20" viewBox="0 0 20 20"><path d="M18.5446,9.09091C18.3333,6.61616,17.2887,4.31818,15.5751,2.63889C13.8498,0.94697,11.6197,0,9
.7186C17.4795,16.8168,17.8096,16.7342,18.0124,16.5065L18.0549,16.4596C18.8755,15.5422,19.5074,14.5064,19.9342,13.3813L19.9554,13.3233C20.0615,13.0487,19.9743,12.7362,19.7361,12.542ZM16.5175,8.97483C16.5764,9.3119,16.6071,9.65791,16.6071,10.0039C16.6071,10.3499,16.5764,10.6959,16.5175,11.033L16.3618,11.9281L18.1233,13.3545C17.8568,13.9372,17.5196,14.4863,17.1188,14.9975L14.9305,14.2631L14.1901,14.839C13.6266,15.2765,12.9994,15.6203,12.3203,15.8614L11.4219,16.1806L10.9998,18.3459C10.3372,18.4173,9.66045,18.4173,8.9955,18.3459L8.57342,16.1761L7.6821,15.8524C7.01008,15.6114,6.38521,15.2676,5.82637,14.8323L5.08596,14.2541L2.88361,14.9953C2.48275,14.4841,2.14791,13.9327,1.8791,13.3523L3.65938,11.9125L3.50611,11.0196C3.44952,10.687,3.41887,10.3432,3.41887,10.0039C3.41887,9.66237,3.44716,9.32083,3.50611,8.98822L3.65938,8.09531L1.8791,6.6555C2.14556,6.07288,2.48275,5.52374,2.88361,5.01255L5.08596,5.75367L5.82637,5.17551C6.38521,4.74022,7.01008,4.39645,7.6821,4.15536L8.57578,3.83615L8.99786,1.66638C9.66045,1.59495,10.3372,1.59495,11.0021,1.66638L11.4242,3.83168L12.3226,4.1509C12.9994,4.39198,13.6289,4.73575,14.1925,5.17328L14.9329,5.7492L17.1211,5.01479C17.522,5.52598,17.8568,6.07734,18.1256,6.65773L16.3642,8.08416L16.5175,8.97483ZM10.0024,5.85189C7.7104,5.85189,5.85231,7.61092,5.85231,9.78068C5.85231,11.9504,7.7104,13.7095,10.0024,13.7095C12.2943,13.7095,14.1524,11.9504,14.1524,9.78068C14.1524,7.61092,12.2943,5.85189,10.0024,5.85189ZM11.8699,11.5486C11.37,12.0196,10.7074,12.2808,10.0024,12.2808C9.29732,12.2808,8.63473,12.0196,8.13483,11.5486C7.6373,11.0754,7.36142,10.4481,7.36142,9.78068C7.36142,9.11323,7.6373,8.48596,8.13483,8.01272C8.63473,7.53948,9.29732,7.28054,10.0024,7.28054C10.7074,7.28054,11.37,7.53948,11.8699,8.01272C12.3674,8.48596,12.6433,9.11323,12.6433,9.78068C12.6433,10.4481,12.3674,11.0754,11.8699,11.5486Z"></path></svg><span></span></div></div>'), zf = (e) => L(C1, {
  ...
  get children() {
    const n = Uf.cloneNode(!0), t = n.firstChild, r = t.firstChild, a = r.nextSibling, s = t.nextSibling, d = s.firstChild, u = d.nextSibling, m = s.nextSibling, k = m.firstChild, y = k.nextSibling;
    return t.$$click = () => {
    ...
    }, p(y, () => c("setting", e.locale)), n;
  }
});
Qe(["click"]);
const Kf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-picker"></div>'), jf = /* @__PURE__ */ $('<label class="klinecharts-pro-time-tools-field"><span></span><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), Qf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), Rf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-grid"></div>'), Zf = /* @__PURE__ */ $('<span class="weekday"></span>'), P1 = /* @__PURE__ */ $('<button type="button"></button>'), Vf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid"></div>'), Hf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), qf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), Yf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-content"></div>'), Gf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-tabs"></div>'), Wf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow">-></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), Xf = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div class="klinecharts-pro-time-tools-row"><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="current">Current</option></select></div><div class="klinecharts-pro-time-tools-row with-divider"><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div class="klinecharts-pro-time-tools-row with-divider"><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), Jf = [{
  key: "goToDate",
  label: "Go to Date"
}, {
  key: "timeRange",
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], eg = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], Mr = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], Q1 = (e) => String(e).padStart(2, "0"), Tr = (e, n, t) => Math.min(t, new Date(e, n + 1, 0).getDate()), g0 = (e) => {
  const n = new Date(e);
  return {
    year: n.getFullYear(),
    month: n.getMonth(),
  ...
  const [n, t] = T(!0), [r, a] = T("date"), [s, d] = T(e.value.year), [u, m] = T(e.value.month), k = Z(() => tg(s(), u())), y = Z(() => Math.floor(s() / 10) * 10), w = Z(() => Array.from({
    length: 12
  }, (j, Q) => y() - 1 + Q)), A = Z(() => e.value.hour % 12 || 12), O = Z(() => e.value.hour >= 12 ? "PM" : "AM"), F = Array.from({
    length: 12
  }, (j, Q) => Q + 1), B = Array.from({
    length: 60
  }, (j, Q) => Q), D = (j) => {
    const Q = new Date(s(), u() + j, 1);
    ...
    e.onChange({
      ...
      month: j.getMonth(),
      day: j.getDate()
    }), (Q = e.onDateSelect) == null || Q.call(e), d(j.getFullYear()), m(j.getMonth());
  }, U = (j) => {
    m(j), e.onChange({
      ...e.value,
      year: s(),
    ...
    e.onChange({
      ...e.value,
      hour: Q ? j === 12 ? 12 : j + 12 : j === 12 ? 0 : j
    });
  }, ue = (j) => {
    const Q = A();
    e.onChange({
      ...e.value,
      hour: j === "PM" ? Q === 12 ? 12 : Q + 12 : Q === 12 ? 0 : Q
    });
  };
  return (() => {
    const j = Kf.cloneNode(!0);
    return p(j, (() => {
      const Q = Z(() => e.showInput !== !1);
      return () => Q() && (() => {
        const q = jf.cloneNode(!0), ne = q.firstChild, ie = ne.nextSibling, $e = ie.firstChild;
        return p(ne, () => e.label), ie.$$click = () => t(!n()), p($e, () => A0(e.value)), q;
      })();
    })(), null), p(j, (() => {
      const Q = Z(() => !!n());
      return () => Q() && (() => {
        const q = Qf.cloneNode(!0), ne = q.firstChild, ie = ne.firstChild, $e = ie.nextSibling, Oe = $e.nextSibling, be = Oe.nextSibling, Re = be.nextSibling;
        return ie.$$click = () => {
          ...
          return () => _e() && (() => {
            ...
            return p(me, () => eg.map((re) => (() => {
              const pe = Zf.cloneNode(!0);
              return p(pe, re), pe;
            })()), null), p(me, () => k().map(({
              date: re,
              current: pe
              ...
              const H = y0({
                ...
                month: re.getMonth(),
                day: re.getDate()
              }), N = e.range ? y0(e.range.from) : NaN, I = e.range ? y0(e.range.to) : NaN, ve = Math.min(N, I), Ne = Math.max(N, I), se = Number.isFinite(ve) && H >= ve && H <= Ne, Le = Number.isFinite(ve) && (H === ve || H === Ne), _ = re.getFullYear() === e.value.year && re.getMonth() === e.value.month && re.getDate() === e.value.day;
              return (() => {
                const ae = P1.cloneNode(!0);
                return ae.$$click = () => X(re), oe(ae, `${pe ? "" : "muted"} ${se ? "in-range" : ""} ${Le || _ ? "selected" : ""}`), p(ae, () => re.getDate()), ae;
              })();
            }), null), me;
          })();
        })(), null), p(q, (() => {
          ...
          return () => _e() && (() => {
            ...
            return p(me, () => Mr.map((re, pe) => (() => {
              const H = P1.cloneNode(!0);
              return H.$$click = () => U(pe), p(H, re), E(() => oe(H, pe === e.value.month && s() === e.value.year ? "selected" : "")), H;
            })())), me;
          })();
        })(), null), p(q, (() => {
          const _e = Z(() => r() === "year");
          return () => _e() && (() => {
            const me = Hf.cloneNode(!0);
            return p(me, () => w().map((re) => (() => {
              const pe = P1.cloneNode(!0);
              return pe.$$click = () => Y(re), p(pe, re), E(() => oe(pe, `${re < y() || re > y() + 9 ? "muted" : ""} ${re === e.value.year ? "selected" : ""}`)), pe;
            })())), me;
          })();
        })(), null), p(q, (() => {
          const _e = Z(() => r() === "date");
          return () => _e() && (() => {
            const me = qf.cloneNode(!0), re = me.firstChild, pe = re.nextSibling, H = pe.nextSibling;
            return p(re, () => F.map((N) => (() => {
              const I = P1.cloneNode(!0);
              return I.$$click = () => V(N), p(I, () => Q1(N)), E(() => oe(I, N === A() ? "selected" : "")), I;
            })())), p(pe, () => B.map((N) => (() => {
              const I = P1.cloneNode(!0);
              return I.$$click = () => e.onChange({
                ...e.value,
                minute: N
              }), p(I, () => Q1(N)), E(() => oe(I, N === e.value.minute ? "selected" : "")), I;
            })())), p(H, () => ["AM", "PM"].map((N) => (() => {
              const I = P1.cloneNode(!0);
              return I.$$click = () => ue(N), p(I, N), E(() => oe(I, N === O() ? "selected" : "")), I;
            })())), me;
          })();
        })(), null), q;
      })();
  ...
  const [n, t] = T(e.initialTab ?? "goToDate"), [r, a] = T(g0(e.initialTimestamp)), [s, d] = T(g0(e.initialRange.from)), [u, m] = T(g0(e.initialRange.to)), [k, y] = T("from"), [w, A] = T({
    ...e.anchorSettings
  }), O = (B) => {
    A((D) => ({
      ...D,
  ...
  return L(C1, {
    ...
    get title() {
      return (() => {
        const B = Gf.cloneNode(!0);
        return p(B, () => Jf.map((D) => (() => {
          const K = P1.cloneNode(!0);
          return K.$$click = () => t(D.key), p(K, () => D.label), E(() => oe(K, n() === D.key ? "active" : "")), K;
        })())), B;
      })();
    },
    get buttons() {
    ...
    get children() {
      ...
      return p(B, (() => {
        ...
        return () => D() && (() => {
          const K = Wf.cloneNode(!0), X = K.firstChild, U = X.firstChild, Y = U.nextSibling, V = Y.nextSibling;
          return U.$$click = () => y("from"), p(U, () => A0(s())), V.$$click = () => y("to"), p(V, () => A0(u())), p(K, (() => {
            const ue = Z(() => k() === "from");
            return () => ue() ? L(Ft, {
              label: "Start",
              get value() {
            ...
            const j = k() === "from" ? "active" : "", Q = k() === "to" ? "active" : "";
            return j !== ue._v$ && oe(U, ue._v$ = j), Q !== ue._v$2 && oe(V, ue._v$2 = Q), ue;
          }, {
            _v$: void 0,
            _v$2: void 0
          }), K;
        ...
        return () => D() && (() => {
          const K = Xf.cloneNode(!0), X = K.firstChild, U = X.firstChild, Y = U.nextSibling, V = X.nextSibling, ue = V.firstChild, j = ue.nextSibling, Q = V.nextSibling, q = Q.firstChild, ne = q.nextSibling, ie = Q.nextSibling, $e = ie.firstChild, Oe = $e.nextSibling;
          return Y.$$click = () => O({
            enabled: !w().enabled
            ...
            const Re = `klinecharts-pro-time-tools-switch${w().enabled ? " on" : ""}`, _e = `klinecharts-pro-time-tools-switch${w().anchorLine ? " on" : ""}`, me = `klinecharts-pro-time-tools-switch${w().acrossTokens ? " on" : ""}`;
            return Re !== be._v$3 && oe(Y, be._v$3 = Re), _e !== be._v$4 && oe(ne, be._v$4 = _e), me !== be._v$5 && oe(Oe, be._v$5 = me), be;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0
          }), E(() => j.value = w().anchorPoint), K;
        })();
      })(), null), B;
    }
  });
...
Qe(["click"]);
const rg = /* @__PURE__ */ $('<i class="icon-close klinecharts-pro-load-icon"></i>'), og = /* @__PURE__ */ $('<div class="klinecharts-pro-content"><div class="klinecharts-pro-widget"></div></div>'), ig = /* @__PURE__ */ $('<div class="klinecharts-pro-time-navigation-tooltip"></div>'), ag = /* @__PURE__ */ $('<div class="klinecharts-pro-countdown-price-mark"><span class="klinecharts-pro-countdown-price-mark-price"></span><span class="klinecharts-pro-countdown-price-mark-timer"></span></div>'), sg = /* @__PURE__ */ $('<div class="overlay-toolbar-color-popover"><div class="overlay-toolbar-color-grid"></div><div class="overlay-toolbar-color-footer"><button type="button" class="overlay-toolbar-add-color">+</button><div class="overlay-toolbar-color-slider"><span></span></div></div></div>'), lg = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown width-menu"></div>'), cg = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown style-menu"><button type="button"><span class="overlay-toolbar-style-sample solid"></span></button><button type="button"><span class="overlay-toolbar-style-sample dashed"></span></button><button type="button"><span class="overlay-toolbar-style-sample dotted"></span></button></div>'), ug = /* @__PURE__ */ $('<div class="klinecharts-pro-overlay-toolbar"><button type="button" class="overlay-toolbar-icon drag" title="Move"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="6" r="1.5"></circle><circle cx="15" cy="6" r="1.5"></circle><circle cx="9" cy="12" r="1.5"></circle><circle cx="15" cy="12" r="1.5"></circle><circle cx="9" cy="18" r="1.5"></circle><circle cx="15" cy="18" r="1.5"></circle></svg></button><button type="button" class="overlay-toolbar-icon refresh" title="Reset"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 0 1 15.4-6.36L21 8"></path><path d="M21 3v5h-5"></path><path d="M21 12a9 9 0 0 1-15.4 6.36L3 16"></path><path d="M3 21v-5h5"></path></svg></button><div class="overlay-toolbar-picker"><button type="button" title="Color"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line width"><span class="overlay-toolbar-line-preview"></span><span>px</span></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line style"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 12h16"></path></svg></button></div><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="5" width="14" height="14" rx="2"></rect><path d="M20 4 4 20"></path></svg></button><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="10" width="14" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></button><button type="button" class="overlay-toolbar-icon delete" title="Delete"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"></path><path d="M8 6V4h8v2"></path><path d="M19 6 18 20H6L5 6"></path><path d="M10 11v5"></path><path d="M14 11v5"></path></svg></button></div>'), dg = /* @__PURE__ */ $('<button type="button"></button>'), hg = /* @__PURE__ */ $('<button type="button"><span class="overlay-toolbar-width-sample"></span></button>'), fg = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-marker"><button type="button" class="klinecharts-pro-quick-order-plus"></button></div>'), gg = /* @__PURE__ */ $('<span class="klinecharts-pro-quick-order-plus-icon"></span>'), yg = /* @__PURE__ */ $('<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3" aria-hidden="true"><path d="M460-300h40v-160h160v-40H500v-160h-40v160H300v40h160v160ZM224.62-160q-27.62 0-46.12-18.5Q160-197 160-224.62v-510.76q0-27.62 18.5-46.12Q197-800 224.62-800h510.76q27.62 0 46.12 18.5Q800-763 800-735.38v510.76q0 27.62-18.5 46.12Q763-160 735.38-160H224.62Zm0-40h510.76q9.24 0 16.93-7.69 7.69-7.69 7.69-16.93v-510.76q0-9.24-7.69-16.93-7.69-7.69-16.93-7.69H224.62q-9.24 0-16.93 7.69-7.69 7.69-7.69 16.93v510.76q0 9.24 7.69 16.93 7.69 7.69 16.93 7.69ZM200-760v560-560Z"></path></svg>'), mg = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-menu-anchor"><div class="klinecharts-pro-quick-order-menu"><button type="button">Trade <!> @ <!> Limit</button><button type="button">Trade <!> @ <!> Stop</button><button type="button">Create new order...</button><button type="button">Copy Price (<!>)</button><button type="button">Draw horizontal line on </button></div></div>');
function Ut(e, n, t, r) {
  n === "VOL" && (r = {
    gap: {
      bottom: 2
...
const vg = (e) => {
  ...
  let n, t = null, r;
  const [a, s] = T(!1), [d, u] = T(e.theme), [m, k] = T(e.styles), [y, w] = T(e.locale), [A, O] = T(e.symbol), [F, B] = T(e.period), D = () => {
    var o, i, l, h;
    return {
  ...
  }, [K, X] = T(!1), [U, Y] = T([...e.mainIndicators]), [V, ue] = T({}), [j, Q] = T(!1), [q, ne] = T({
    key: e.timezone,
    text: wr(e.timezone, e.locale)
  }), [ie, $e] = T(!1), [Oe, be] = T(), [Re, _e] = T(""), [me, re] = T(!1), [pe, H] = T(Date.now()), [N, I] = T({
  ...
  let se = null;
  const [Le, _] = T(e.drawingBarVisible), [ae, Me] = T(!1), [s1, de] = T(!1), [g1, l1] = T(!1), J1 = ((cn = e.orderTools) == null ? void 0 : cn.quickOrder) ?? !0, [Ie, yt] = T({
    quickOrder: J1,
    quickOrderFloatingWindow: ((un = e.orderTools) == null ? void 0 : un.quickOrderFloatingWindow) ?? J1,
    quickOrderPlusButton: ((dn = e.orderTools) == null ? void 0 : dn.quickOrderPlusButton) ?? J1,
  ...
  const $t = (o, i, l) => {
    ...
    var i, l, h;
    try {
      const g = (i = t == null ? void 0 : t.getOverlayById) == null ? void 0 : i.call(t, o);
      if (!g)
        return;
      const v = bt(g);
      if (v) {
        const f = xe.get(o), C = ((l = f == null ? void 0 : f.points) == null ? void 0 : l.length) || 0, x = ((h = v.points) == null ? void 0 : h.length) || 0;
        xe.set(o, v);
        const M = m1(v.type);
        if (x >= M) {
          const P = Ee.get(o);
  ...
  const x1 = () => {
    ...
    xe.forEach((l, h) => {
      var g;
      (g = t == null ? void 0 : t.removeOverlay) == null || g.call(t, {
        id: h
      });
      ...
      try {
        ...
        }), v = t == null ? void 0 : t.createOverlay(g), f = typeof v == "string" ? v : null;
        f && (xe.set(f, {
          ...l,
          id: f
        }), Ee.set(f, {
    ...
    yt(i), (h = (l = e.orderTools) == null ? void 0 : l.onChange) == null || h.call(l, i);
  }, w1 = (o) => {
    var l;
    ...
    const g = (e1 = t.convertToPixel) == null ? void 0 : e1.call(t, [{
      value: h
    }], {
      paneId: "candle_pane",
      absolute: !0
    }), v = Number((ct = g == null ? void 0 : g[0]) == null ? void 0 : ct.y), f = (Bn = t.getSize) == null ? void 0 : Bn.call(t, "candle_pane"), C = (f == null ? void 0 : f.height) ?? n.clientHeight;
    ...
    }), P = (Un = t.getSize) == null ? void 0 : Un.call(t, "candle_pane", Dt.YAxis), G = P != null && P.width && Number.isFinite(P.width) ? Math.max(74, Math.floor(P.width) - 2) : 96, te = m0(F()), ee = o % te, R = ee === 0 ? te : te - ee, W = Number(l.close), he = Number(l.open), Be = t.getStyles().candle.priceMark.last, z = Be.text, Ce = Number(z.size) || 12, le = Number(z.paddingTop) || 2, ke = Number(z.paddingBottom) || 2, we = Math.min(Number(z.paddingLeft) || 4, 3), We = Math.min(Number(z.paddingRight) || 4, 3), Xe = Math.max(34, Ce * 2 + le + ke + 6), r1 = Math.max(0, Math.min(v - Xe / 2, C - Xe));
    F1({
      top: r1,
      width: Math.min(G, Math.max(62, M.length * (Ce * 0.56) + we + We + 4)),
      priceText: M,
      text: pg(R),
      color: Number.isFinite(W) && Number.isFinite(he) && W < he ? Be.downColor : Be.upColor,
      textSize: Ce,
      textFamily: z.family,
      textWeight: z.weight,
      paddingLeft: we,
    ...
    if (!Number.isFinite(i))
      return NaN;
    try {
      const g = t == null ? void 0 : t.convertFromPixel([{
        x: (o == null ? void 0 : o.x) ?? 0,
        y: i
      }], {
        paneId: "candle_pane"
      }), v = Number((l = g == null ? void 0 : g[0]) == null ? void 0 : l.value);
    ...
    const l = Number(o.y), h = kt(o), g = n.clientHeight;
    ...
    var C, x, M, P, G, te;
    const i = (x = (C = n == null ? void 0 : n.parentElement) == null ? void 0 : C.getBoundingClientRect) == null ? void 0 : x.call(C), l = (M = n == null ? void 0 : n.getBoundingClientRect) == null ? void 0 : M.call(n), h = o == null ? void 0 : o.overlay, g = (P = h == null ? void 0 : h.points) == null ? void 0 : P[0];
    let v = 72, f = 40;
    if (i) {
      if (Number.isFinite(o == null ? void 0 : o.pageX) ? v = o.pageX - i.left : Number.isFinite(o == null ? void 0 : o.x) && l && (v = l.left - i.left + o.x), Number.isFinite(o == null ? void 0 : o.pageY))
        ...
        try {
          const ee = (G = t == null ? void 0 : t.convertToPixel) == null ? void 0 : G.call(t, [{
            ...
            paneId: "candle_pane",
            absolute: !0
          }), R = Number((te = ee == null ? void 0 : ee[0]) == null ? void 0 : te.y);
          Number.isFinite(R) && (f = R - i.top);
        } catch {
        }
    }
    return {
    ...
    var f, C, x, M, P, G, te, ee, R;
    if (o.name !== "horizontalStraightLine")
      return o;
    const i = o.onClick, l = o.onSelected, h = o.onDeselected, g = o.onRemoved, v = o.onPressedMoveEnd;
    return {
      ...o,
      styles: {
        ...o.styles,
        line: {
          ...
          color: ((R = (ee = o.styles) == null ? void 0 : ee.line) == null ? void 0 : R.color) ?? "#2f6df6"
        }
      },
      ...
      onRemoved: (W) => (at(W), (g == null ? void 0 : g(W)) ?? !1)
    };
  }, s0 = () => {
    var i;
    const o = Ue();
    ...
    if (!l)
      return;
    const h = o.clientX, g = o.clientY, v = i.x, f = i.y, C = (G) => {
      G.preventDefault();
      const te = v + G.clientX - h, ee = f + G.clientY - g;
      Ke({
        ...i,
  ...
  let lt = (kn = e.orderTools) == null ? void 0 : kn.quickOrder, j0 = (xn = e.orderTools) == null ? void 0 : xn.quickOrderFloatingWindow, Q0 = (Ln = e.orderTools) == null ? void 0 : Ln.quickOrderPlusButton, R0 = (wn = e.orderTools) == null ? void 0 : wn.openOrders, Z0 = (An = e.orderTools) == null ? void 0 : An.openOrdersExtendedPriceLine, V0 = (Mn = e.orderTools) == null ? void 0 : Mn.openOrdersDisplay, H0 = (Tn = e.orderTools) == null ? void 0 : Tn.positions, q0 = (Sn = e.orderTools) == null ? void 0 : Sn.breakevenPrice, Y0 = (Pn = e.orderTools) == null ? void 0 : Pn.liquidationPrice, G0 = (On = e.orderTools) == null ? void 0 : On.priceLine, W0 = (Dn = e.orderTools) == null ? void 0 : Dn.marketPriceLine, X0 = (Nn = e.orderTools) == null ? void 0 : Nn.countDown, J0 = (In = e.orderTools) == null ? void 0 : In.bidAskPrice, en = (En = e.orderTools) == null ? void 0 : En.orderHistory;
  ze(() => {
    var W, he, Be, z, Ce, le, ke, we, We, Xe, r1, Je, e1, ct;
    const o = (W = e.orderTools) == null ? void 0 : W.quickOrder, i = (he = e.orderTools) == null ? void 0 : he.quickOrderFloatingWindow, l = (Be = e.orderTools) == null ? void 0 : Be.quickOrderPlusButton, h = (z = e.orderTools) == null ? void 0 : z.openOrders, g = (Ce = e.orderTools) == null ? void 0 : Ce.openOrdersExtendedPriceLine, v = (le = e.orderTools) == null ? void 0 : le.openOrdersDisplay, f = (ke = e.orderTools) == null ? void 0 : ke.positions, C = (we = e.orderTools) == null ? void 0 : we.breakevenPrice, x = (We = e.orderTools) == null ? void 0 : We.liquidationPrice, M = (Xe = e.orderTools) == null ? void 0 : Xe.priceLine, P = (r1 = e.orderTools) == null ? void 0 : r1.marketPriceLine, G = (Je = e.orderTools) == null ? void 0 : Je.countDown, te = (e1 = e.orderTools) == null ? void 0 : e1.bidAskPrice, ee = (ct = e.orderTools) == null ? void 0 : ct.orderHistory, R = {};
    typeof o == "boolean" && o !== lt && (lt = o, R.quickOrder = o, typeof i != "boolean" && (R.quickOrderFloatingWindow = o), typeof l != "boolean" && (R.quickOrderPlusButton = o)), typeof i == "boolean" && i !== j0 && (j0 = i, R.quickOrderFloatingWindow = i), typeof l == "boolean" && l !== Q0 && (Q0 = l, R.quickOrderPlusButton = l), typeof h == "boolean" && h !== R0 && (R0 = h, R.openOrders = h), typeof g == "boolean" && g !== Z0 && (Z0 = g, R.openOrdersExtendedPriceLine = g), v !== void 0 && v !== V0 && (V0 = v, R.openOrdersDisplay = v), typeof f == "boolean" && f !== H0 && (H0 = f, R.positions = f), typeof C == "boolean" && C !== q0 && (q0 = C, R.breakevenPrice = C), typeof x == "boolean" && x !== Y0 && (Y0 = x, R.liquidationPrice = x), typeof M == "boolean" && M !== G0 && (G0 = M, R.priceLine = M, typeof P != "boolean" && (R.marketPriceLine = M), typeof G != "boolean" && (R.countDown = M), typeof te != "boolean" && (R.bidAskPrice = M)), typeof P == "boolean" && P !== W0 && (W0 = P, R.marketPriceLine = P), typeof G == "boolean" && G !== X0 && (X0 = G, R.countDown = G), typeof te == "boolean" && te !== J0 && (J0 = te, R.bidAskPrice = te), typeof ee == "boolean" && ee !== en && (en = ee, R.orderHistory = ee), Object.keys(R).length > 0 && L1(R);
  }), ze(() => {
    ...
    getSettings: () => {
      var l, h, g, v, f, C, x, M, P, G, te, ee, R, W, he, Be;
      if (!t)
        return {};
      ...
      return {
        ...
        showLastPrice: (f = (v = (g = o.candle) == null ? void 0 : g.priceMark) == null ? void 0 : v.last) == null ? void 0 : f.show,
        ...
        // Indicator settings
        showIndicatorLastValue: (R = (ee = o.indicator) == null ? void 0 : ee.lastValueMark) == null ? void 0 : R.show,
    ...
    setSettings: (o) => {
      var l, h, g, v, f, C, x, M, P, G, te, ee, R, W;
      if (!t)
        return;
      const i = {};
      ...
      o.showLastPrice !== void 0 && (i.candle = {
        ...
        priceMark: {
          ...
          last: {
            ...(v = (g = i.candle) == null ? void 0 : g.priceMark) == null ? void 0 : v.last,
        ...
        priceMark: {
          ...
          low: {
            ...(R = (ee = i.candle) == null ? void 0 : ee.priceMark) == null ? void 0 : R.low,
    ...
    saveDrawings: (o) => {
      ...
      i.forEach((l, h) => {
        var f;
        const g = m1(l.type), v = ((f = l.points) == null ? void 0 : f.length) || 0;
        v < g && console.warn(`âš ï¸ ${l.type} ${l.id} has only ${v} point(s), should have ${g}`);
      }), Ye.saveDrawings(o, i);
    },
    loadDrawings: (o) => {
  ...
  const tn = () => {
    t == null || t.resize(), Ge(), an();
  }, nn = () => {
    Ge(), an();
  }, rn = [T1.OnVisibleRangeChange, T1.OnZoom, T1.OnScroll];
  let Mt, Tt;
  const m9 = (o) => {
    const i = new Date(o), l = i.getFullYear(), h = `${i.getMonth() + 1}`.padStart(2, "0"), g = `${i.getDate()}`.padStart(2, "0"), v = `${i.getHours()}`.padStart(2, "0"), f = `${i.getMinutes()}`.padStart(2, "0");
    return `${l}/${h}/${g} ${v}:${f}`;
  }, p9 = (o) => {
    var f;
    ...
    if (i.length === 0)
      return null;
    let l = i[0], h = 0, g = Number(l == null ? void 0 : l.timestamp), v = Math.abs(g - o);
    ...
    if (!t || !n)
      return null;
    const i = p9(o), l = i == null ? void 0 : i.candle, h = Number((l == null ? void 0 : l.timestamp) ?? o), g = Number((l == null ? void 0 : l.high) ?? (l == null ? void 0 : l.close) ?? (l == null ? void 0 : l.open)), v = ((ee = t == null ? void 0 : t.getDataList) == null ? void 0 : ee.call(t)) ?? [], f = i && i.dataIndex < v.length - 1 ? i.dataIndex + 1 : i == null ? void 0 : i.dataIndex, C = i && Number.isFinite(g) ? {
      dataIndex: f,
      value: g
    } : {
      timestamp: h
    }, x = (R = t.convertToPixel) == null ? void 0 : R.call(t, [C], {
      paneId: "candle_pane",
      absolute: !0
    ...
    i < 6 && (Tt = window.setTimeout(() => sn(o, i + 1), 80));
  }, l0 = (o, i, l) => {
    let h = i, g = h;
    switch (o.timespan) {
      case "minute": {
    ...
    var i;
    !t || !Number.isFinite(o) || ((i = t.scrollToTimestamp) == null || i.call(t, o, 250), requestAnimationFrame(() => sn(o)), Ge());
  }, St = () => {
    var l, h;
    ...
    if (t) {
      ...
      try {
        const l = F(), h = o.from <= o.to ? o : {
          from: o.to,
          to: o.from
        }, g = await e.datafeed.getHistoryKLineData(A(), l, h.from, h.to);
        t.applyNewData(g, g.length > 0), I(h), requestAnimationFrame(() => {
          c0(i ?? h.to), St();
        });
      } finally {
        s(!1), de(!1);
    ...
    Ne(o), o.enabled && (H(o.timestamp), requestAnimationFrame(() => c0(o.timestamp))), requestAnimationFrame(St);
  };
  T0(() => {
    if (window.addEventListener("resize", tn), t = L9(n, {
      customApi: {
        formatDate: (f, C, x, M) => {
          switch (F().timespan) {
            case "minute":
              return M === Ot.XAxis ? ce.formatDate(f, C, "HH:mm") : ce.formatDate(f, C, "YYYY-MM-DD HH:mm");
            case "hour":
              return M === Ot.XAxis ? ce.formatDate(f, C, "MM-DD HH:mm") : ce.formatDate(f, C, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return ce.formatDate(f, C, "YYYY-MM-DD");
            case "month":
              return M === Ot.XAxis ? ce.formatDate(f, C, "YYYY-MM") : ce.formatDate(f, C, "YYYY-MM-DD");
            case "year":
              return M === Ot.XAxis ? ce.formatDate(f, C, "YYYY") : ce.formatDate(f, C, "YYYY-MM-DD");
          }
    ...
    }), t == null || t.subscribeAction(T1.OnCrosshairChange, xt), rn.forEach((f) => {
      t == null || t.subscribeAction(f, nn);
    ...
    window.removeEventListener("resize", tn), t == null || t.unsubscribeAction(T1.OnCrosshairChange, xt), rn.forEach((o) => {
      t == null || t.unsubscribeAction(o, nn);
    }), Mt && (window.clearInterval(Mt), Mt = void 0), Tt && (window.clearTimeout(Tt), Tt = void 0), document.removeEventListener("mousedown", st), Ee.clear(), xe.clear(), zn(n);
  }), ze(() => {
    const o = A();
  ...
  const b9 = (o) => {
    const i = new Date(o), l = i.getFullYear(), h = `${i.getMonth() + 1}`.padStart(2, "0"), g = `${i.getDate()}`.padStart(2, "0"), v = `${i.getHours()}`.padStart(2, "0"), f = `${i.getMinutes()}`.padStart(2, "0"), C = `${l}-${h}-${g}`;
    switch (F().timespan) {
      case "minute":
      case "hour":
        return `${C} ${v}:${f}`;
    ...
    const {
      current: l
    } = o, h = i.tooltip.text.color, g = l.close > l.open ? i.bar.upColor : l.close < l.open ? i.bar.downColor : i.bar.noChangeColor, v = Math.min(Math.max(((x = A()) == null ? void 0 : x.pricePrecision) ?? 2, 0), 8), f = Math.min(Math.max(((M = A()) == null ? void 0 : M.volumePrecision) ?? 0, 0), 8), C = (P) => ({
      text: ce.formatPrecision(P, v),
      color: g
    });
    return [{
      title: "time",
  ...
  return ze((o) => {
    ...
    return N1(() => {
      ...
      try {
        const v = ve(), f = v.enabled && (!o || o.symbol.ticker === i.ticker || v.acrossTokens), C = f ? v.timestamp + m0(l) * 250 : (/* @__PURE__ */ new Date()).getTime(), [x, M] = l0(l, C, 500), P = await e.datafeed.getHistoryKLineData(i, l, x, M);
        if (!h)
          return;
    ...
    m() && (t == null || t.setStyles(m()), Pt(), be(Es(t.getStyles())));
  }), [rg.cloneNode(!0), L(Zd, {
    get locale() {
      return e.locale;
    },
    ...
    onTimeToolsClick: () => {
      var f, C, x, M;
      const o = ((f = t == null ? void 0 : t.getDataList) == null ? void 0 : f.call(t)) ?? [], i = (C = t == null ? void 0 : t.getVisibleRange) == null ? void 0 : C.call(t), l = Math.max(0, Math.floor((i == null ? void 0 : i.from) ?? 0)), h = Math.min(o.length - 1, Math.ceil((i == null ? void 0 : i.to) ?? o.length - 1)), g = (x = o[l]) == null ? void 0 : x.timestamp, v = (M = o[h]) == null ? void 0 : M.timestamp;
      H(Date.now()), Number.isFinite(g) && Number.isFinite(v) && I({
        from: g,
        to: v
      }), re(!0);
    },
    ...
    const o = og.cloneNode(!0), i = o.firstChild;
    return o.addEventListener("mouseleave", () => {
      ...
      keyed: !0,
      children: (l) => (() => {
        const h = ig.cloneNode(!0);
        return p(h, () => l.text), E((g) => {
          const v = `${l.left}px`, f = `${l.top}px`;
          return v !== g._v$ && h.style.setProperty("left", g._v$ = v), f !== g._v$2 && h.style.setProperty("top", g._v$2 = f), g;
        }, {
          _v$: void 0,
          _v$2: void 0
        }), h;
      ...
      keyed: !0,
      children: (l) => (() => {
        const h = ag.cloneNode(!0), g = h.firstChild, v = g.nextSibling;
        return h.style.setProperty("right", "0px"), p(g, () => l.priceText), p(v, () => l.text), E((f) => {
          const C = `${l.top}px`, x = `${l.width}px`, M = l.color, P = `${l.borderRadius}px`, G = l.textFamily, te = l.textWeight, ee = `${l.paddingLeft}px`, R = `${l.paddingRight}px`, W = `${l.paddingTop}px`, he = `${l.paddingBottom}px`, Be = `${l.textSize}px`, z = `${Math.max(10, l.textSize - 1)}px`;
          return C !== f._v$3 && h.style.setProperty("top", f._v$3 = C), x !== f._v$4 && h.style.setProperty("width", f._v$4 = x), M !== f._v$5 && h.style.setProperty("background", f._v$5 = M), P !== f._v$6 && h.style.setProperty("border-radius", f._v$6 = P), G !== f._v$7 && h.style.setProperty("font-family", f._v$7 = G), te !== f._v$8 && h.style.setProperty("font-weight", f._v$8 = te), ee !== f._v$9 && h.style.setProperty("padding-left", f._v$9 = ee), R !== f._v$10 && h.style.setProperty("padding-right", f._v$10 = R), W !== f._v$11 && h.style.setProperty("padding-top", f._v$11 = W), he !== f._v$12 && h.style.setProperty("padding-bottom", f._v$12 = he), Be !== f._v$13 && g.style.setProperty("font-size", f._v$13 = Be), z !== f._v$14 && v.style.setProperty("font-size", f._v$14 = z), f;
        }, {
          _v$3: void 0,
          _v$4: void 0,
          _v$5: void 0,
      ...
      keyed: !0,
      children: (l) => (() => {
        const h = ug.cloneNode(!0), g = h.firstChild, v = g.nextSibling, f = v.nextSibling, C = f.firstChild, x = f.nextSibling, M = x.firstChild, P = M.firstChild, G = P.nextSibling, te = G.firstChild, ee = x.nextSibling, R = ee.firstChild, W = ee.nextSibling, he = W.nextSibling, Be = he.nextSibling;
        return h.$$click = (z) => {
          z.stopPropagation();
        }, h.$$mousedown = (z) => {
          z.preventDefault(), z.stopPropagation();
        }, g.$$mousedown = wt, v.$$click = n1, C.$$click = () => je(He() === "color" ? null : "color"), p(f, L(J, {
          get when() {
            return He() === "color";
          },
          get children() {
            const z = sg.cloneNode(!0), Ce = z.firstChild;
            return p(Ce, L(C0, {
              each: ot,
              children: (le) => (() => {
                const ke = dg.cloneNode(!0);
                return ke.$$click = () => M1(le), ke.style.setProperty("background", le), E(() => oe(ke, `overlay-toolbar-color-swatch ${l.color.toLowerCase() === le.toLowerCase() ? "selected" : ""}`)), ke;
              })()
            })), z;
          }
          ...
          get children() {
            const z = lg.cloneNode(!0);
            return p(z, L(C0, {
              each: [1, 2, 3, 4],
              children: (Ce) => (() => {
                const le = hg.cloneNode(!0), ke = le.firstChild;
                return le.$$click = () => Te(Ce), ke.style.setProperty("height", `${Ce}px`), E(() => oe(le, l.lineSize === Ce ? "selected" : "")), le;
              })()
            })), z;
          }
        }), null), R.$$click = () => je(He() === "style" ? null : "style"), p(ee, L(J, {
          get when() {
            return He() === "style";
          },
          get children() {
            const z = cg.cloneNode(!0), Ce = z.firstChild, le = Ce.nextSibling, ke = le.nextSibling;
            return Ce.$$click = () => Se(o1.Solid, []), le.$$click = () => Se(o1.Dashed, [6, 4]), ke.$$click = () => Se(o1.Dashed, [2, 4]), E((we) => {
              var Je, e1;
              ...
              return We !== we._v$15 && oe(Ce, we._v$15 = We), Xe !== we._v$16 && oe(le, we._v$16 = Xe), r1 !== we._v$17 && oe(ke, we._v$17 = r1), we;
            }, {
              _v$15: void 0,
              _v$16: void 0,
              _v$17: void 0
        ...
        }), null), W.$$click = S, he.$$click = b, Be.$$click = s0, E((z) => {
          const Ce = `${l.x}px`, le = `${l.y}px`, ke = `overlay-toolbar-icon edit ${He() === "color" ? "active" : ""}`, we = `overlay-toolbar-line-size ${He() === "width" ? "active" : ""}`, We = `overlay-toolbar-icon minus ${He() === "style" ? "active" : ""}`, Xe = `overlay-toolbar-icon visibility ${l.visible ? "" : "muted"}`, r1 = l.visible ? "Hide" : "Show", Je = `overlay-toolbar-icon lock ${l.locked ? "active" : ""}`, e1 = l.locked ? "Unlock" : "Lock";
          return Ce !== z._v$18 && h.style.setProperty("left", z._v$18 = Ce), le !== z._v$19 && h.style.setProperty("top", z._v$19 = le), ke !== z._v$20 && oe(C, z._v$20 = ke), we !== z._v$21 && oe(M, z._v$21 = we), We !== z._v$22 && oe(R, z._v$22 = We), Xe !== z._v$23 && oe(W, z._v$23 = Xe), r1 !== z._v$24 && Pe(W, "title", z._v$24 = r1), Je !== z._v$25 && oe(he, z._v$25 = Je), e1 !== z._v$26 && Pe(he, "title", z._v$26 = e1), z;
        }, {
          _v$18: void 0,
          _v$19: void 0,
          _v$20: void 0,
      ...
      keyed: !0,
      children: (l) => (() => {
        const h = fg.cloneNode(!0), g = h.firstChild;
        return h.addEventListener("mouseleave", () => {
          ...
          return () => v() ? (() => {
            const f = gg.cloneNode(!0);
            return E(() => f.innerHTML = e.orderTools.quickOrderPlusIcon), f;
          })() : yg.cloneNode(!0);
        })()), E((v) => {
          const f = `${Math.max(0, l.y - 12)}px`, C = `${et()}px`, x = Ie().quickOrderPlusButton ? "block" : "none";
      ...
      keyed: !0,
      children: (l) => (() => {
        const h = mg.cloneNode(!0), g = h.firstChild, v = g.firstChild, f = v.firstChild, C = f.nextSibling, x = C.nextSibling, M = x.nextSibling;
        M.nextSibling;
        const P = v.nextSibling, G = P.firstChild, te = G.nextSibling, ee = te.nextSibling, R = ee.nextSibling;
        R.nextSibling;
        const W = P.nextSibling, he = W.nextSibling, Be = he.firstChild, z = Be.nextSibling;
        z.nextSibling;
        ...
        }, v.$$click = () => K1("limit"), p(v, () => A().shortName ?? A().name ?? A().ticker, C), p(v, () => w1(l.price), M), P.$$click = () => K1("stop"), p(P, () => A().shortName ?? A().name ?? A().ticker, te), p(P, () => w1(l.price), R), W.$$click = () => K1("create"), he.$$click = i0, p(he, () => w1(l.price), z), Ce.$$click = Lt, p(Ce, () => w1(l.price), null), E((le) => {
          const ke = `${Math.max(0, l.y + 24)}px`, we = `${l.yAxisWidth + nt}px`;
    ...
    }), null), E(() => Pe(i, "data-drawing-bar-visible", Le())), o;
  })(), L(J, {
    get when() {
      return ae();
    },

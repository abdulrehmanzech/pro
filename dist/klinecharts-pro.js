...
import { utils as o1, OverlayMode as bt, LineType as V1, init as o5, FormatDateType as ze, DomPosition as $t, ActionType as Qe, dispose as m0, TooltipIconPosition as Ze, CandleType as s5, YAxisType as l5, registerOverlay as c5 } from "klinecharts";
function Ne(e, t, r) {
...
const u5 = {
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const r = i9(e[0], e[1]) / Math.sqrt(24), n = e[1].x > e[0].x ? 0 : 1, a = o1.getLinearSlopeIntercept(e[0], e[1]);
      let l;
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((f) => {
        ...
        r.push({ coordinates: [{ x, y: e[0].y }, { x, y: e[1].y }] }), r.push({ coordinates: [{ x: e[0].x, y: L }, { x: e[1].x, y: L }] }), n = n.concat(xt([e[0], { x, y: e[1].y }], t)), n = n.concat(xt([e[0], { x: e[1].x, y: L }], t)), a.unshift({
          x: e[0].x + l,
          y: L + 10,
          text: `${f.toFixed(3)}`
        }), a.unshift({
...
const S5 = (e, t) => e === t, At = Symbol("solid-proxy"), T5 = Symbol("solid-track"), qe = {
  equals: S5
};
let a9 = c9;
const q1 = 1, Ge = 2, o9 = {
...
var h1 = null;
let re = null, n1 = null, v1 = null, H1 = null, Nt = 0;
function Ee(e, t) {
  const r = n1, n = h1, a = e.length === 0, l = a ? o9 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? n : t
...
function w(e, t) {
  ...
  }, n = (a) => (typeof a == "function" && (a = a(r.value)), l9(r, a));
  return [s9.bind(r), n];
}
function p0(e, t, r) {
  const n = it(e, t, !0, q1);
...
function P1(e, t, r) {
  a9 = E5;
  const n = it(e, t, !1, q1);
  n.user = !0, H1 ? H1.push(n) : fe(n);
}
function Y(e, t, r) {
  r = r ? Object.assign({}, qe, r) : qe;
  const n = it(e, t, !0, 0);
  return n.observers = null, n.observerSlots = null, n.comparator = r.equals || void 0, fe(n), s9.bind(n);
}
function P5(e, t, r) {
  let n, a, l;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (n = !0, a = e, l = t || {}) : (n = e, a = t, l = r || {});
  let u = null, c = _t, g = null, $ = !1, f = "initialValue" in l, x = typeof n == "function" && Y(n);
  const L = /* @__PURE__ */ new Set(), [S, O] = (l.storage || w)(l.initialValue), [I, H] = w(void 0), [Q, E] = w(void 0, {
    equals: !1
  ...
  function I1(j = !0) {
    ...
    const R = c !== _t ? c : Y1(() => a(X, {
      value: S(),
      refetching: j
    }));
    return typeof R != "object" || !(R && "then" in R) ? (G(u, R, void 0, X), R) : (u = R, $ = !0, queueMicrotask(() => $ = !1), J1(() => {
      K(f ? "refreshing" : "pending"), E();
    }, !1), R.then((L1) => G(R, L1, void 0, X), (L1) => G(R, void 0, d9(L1), X)));
  }
...
function O5(e) {
  ...
  return Promise.resolve().then(() => {
    n1 = t, h1 = r;
    let n;
    return J1(e, !1), n1 = h1 = null, n ? n.done : void 0;
  });
}
let I5;
function s9() {
...
function l9(e, t, r) {
  let n = e.value;
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && J1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      const l = e.observers[a], u = re && re.running;
      u && re.disposed.has(l), (u && !l.tState || !u && !l.state) && (l.pure ? v1.push(l) : H1.push(l), l.observers && u9(l)), u || (l.state = q1);
    }
    if (v1.length > 1e6)
      throw v1 = [], new Error();
  }, !1)), t;
...
function fe(e) {
  if (!e.fn)
    return;
  at(e);
  const t = h1, r = n1, n = Nt;
  n1 = h1 = e, D5(e, e.value, n), n1 = r, h1 = t;
}
function D5(e, t, r) {
  let n;
  try {
    ...
    e.pure && (e.state = q1, e.owned && e.owned.forEach(at), e.owned = null), h9(a);
  }
  (!e.updatedAt || e.updatedAt <= r) && (e.updatedAt != null && "observers" in e ? l9(e, n) : e.value = n, e.updatedAt = r);
}
function it(e, t, r, n = q1, a) {
  const l = {
    fn: e,
    state: n,
    updatedAt: null,
  ...
  return h1 === null || h1 !== o9 && (h1.owned ? h1.owned.push(l) : h1.owned = [l]), l;
}
function We(e) {
  const t = re;
  if (e.state === 0 || t)
  ...
  for (let n = r.length - 1; n >= 0; n--)
    if (e = r[n], e.state === q1 || t)
      fe(e);
    else if (e.state === Ge || t) {
      const a = v1;
      v1 = null, J1(() => Xe(e, r[0]), !1), v1 = a;
    }
}
function J1(e, t) {
  if (v1)
  ...
  try {
    ...
    r || (H1 = null), v1 = null, h9(n);
  }
}
function N5(e) {
  if (v1 && (c9(v1), v1 = null), e)
    return;
  const t = H1;
  H1 = null, t.length && J1(() => a9(t), !1);
}
function c9(e) {
...
function Xe(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    const a = e.sources[n];
    a.sources && (a.state === q1 || r ? a !== t && We(a) : (a.state === Ge || r) && Xe(a, t));
  }
}
function u9(e) {
  const t = re;
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = Ge, n.pure ? v1.push(n) : H1.push(n), n.observers && u9(n));
  }
}
function at(e) {
  let t;
...
function U5(e, t, r = {}) {
  ...
  return ie(() => v0(l)), () => {
    let g = e() || [], $, f;
    return g[T5], Y1(() => {
      let L = g.length, S, O, I, H, Q, E, D, K, G;
      if (L === 0)
        u !== 0 && (v0(l), l = [], n = [], a = [], u = 0, c && (c = [])), r.fallback && (n = [B5], a[0] = Ee((O1) => (l[0] = O1, r.fallback())), u = 1);
      else if (u === 0) {
        for (a = new Array(L), f = 0; f < L; f++)
          n[f] = g[f], a[f] = Ee(x);
        u = L;
      } else {
        for (I = new Array(L), H = new Array(L), c && (Q = new Array(L)), E = 0, D = Math.min(u, L); E < D && n[E] === g[E]; E++)
          ;
        for (D = u - 1, K = L - 1; D >= E && K >= E && n[D] === g[K]; D--, K--)
          I[K] = a[D], H[K] = l[D], c && (Q[K] = c[D]);
        for (S = /* @__PURE__ */ new Map(), O = new Array(K + 1), f = K; f >= E; f--)
          G = g[f], $ = S.get(G), O[f] = $ === void 0 ? -1 : $, S.set(G, f);
        for ($ = E; $ <= D; $++)
          G = n[$], f = S.get(G), f !== void 0 && f !== -1 ? (I[f] = a[$], H[f] = l[$], c && (Q[f] = c[$]), f = O[f], S.set(G, f)) : l[$]();
        for (f = E; f < L; f++)
          f in I ? (a[f] = I[f], l[f] = H[f], c && (c[f] = Q[f], c[f](f))) : a[f] = Ee(x);
...
function y9(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const a = e[n];
    t = t || !!a && At in a, e[n] = typeof a == "function" ? (t = !0, Y(a)) : a;
  }
  if (t)
    return new Proxy({
      get(n) {
  ...
  for (; u < a || c < l; ) {
    ...
    if (a === u) {
      ...
      if (f != null)
        if (c < f && f < l) {
          let x = u, L = 1, S;
          for (; ++x < a && x < l && !((S = $.get(t[x])) == null || S !== f + L); )
            L++;
          if (L > f - c) {
            const O = t[u];
            for (; c < f; )
...
function U1(e, t = window.document) {
  const r = t[b0] || (t[b0] = /* @__PURE__ */ new Set());
  ...
  if (e = u && r[0] && r[0].parentNode || e, l === "string" || l === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (c.length === 0) {
        ...
        g ? r.length === 0 ? $0(e, c, n) : K5(e, r, c) : (r && ye(e), $0(e, c));
      r = c;
    ...
    if (c instanceof Node)
      ...
      if (Array.isArray(c))
        ...
        if (n) {
          for (; typeof c == "function"; )
            c = c();
          a = Mt(e, Array.isArray(c) ? c : [c], Array.isArray(g) ? g : [g]) || a;
        } else
          e.push(c), a = !0;
      else {
        const $ = String(c);
...
function R5(e) {
  ...
  if (n instanceof HTMLHeadElement) {
    ...
    Object.defineProperty(l, "_$host", {
      ...
      configurable: !0
    }), _(u, a()), n.appendChild(l), e.ref && e.ref(l), ie(() => n.removeChild(l));
  }
  return r;
}
...
var V5 = typeof Ve == "object" && Ve && Ve.Object === Object && Ve, C9 = V5, H5 = C9, Y5 = typeof self == "object" && self && self.Object === Object && self, q5 = H5 || Y5 || Function("return this")(), Q1 = q5, G5 = Q1, W5 = G5.Symbol, ot = W5, _0 = ot, g9 = Object.prototype, X5 = g9.hasOwnProperty, J5 = g9.toString, De = _0 ? _0.toStringTag : void 0;
function e6(e) {
...
var a6 = i6, k0 = ot, o6 = t6, s6 = a6, l6 = "[object Null]", c6 = "[object Undefined]", L0 = k0 ? k0.toStringTag : void 0;
function u6(e) {
...
var Ce = d6, h6 = Be, y6 = Ce, f6 = "[object AsyncFunction]", C6 = "[object Function]", g6 = "[object GeneratorFunction]", m6 = "[object Proxy]";
function p6(e) {
  if (!y6(e))
    return !1;
  var t = h6(e);
...
var m9 = p6, v6 = Q1, b6 = v6["__core-js_shared__"], $6 = b6, Lt = $6, x0 = function() {
...
var k6 = _6, L6 = Function.prototype, x6 = L6.toString;
function A6(e) {
  if (e != null) {
    try {
      return x6.call(e);
...
var p9 = A6, w6 = m9, M6 = k6, S6 = Ce, T6 = p9, P6 = /[\\^$.*+?()[\]{}|]/g, O6 = /^\[object .+?Constructor\]$/, I6 = Function.prototype, D6 = Object.prototype, N6 = I6.toString, E6 = D6.hasOwnProperty, B6 = RegExp(
...
var b9 = q6, G6 = v9, W6 = b9, X6 = Object.prototype, J6 = X6.hasOwnProperty;
function e2(e, t, r) {
  var n = e[t];
  (!(J6.call(e, t) && W6(n, r)) || r === void 0 && !(t in e)) && G6(e, t, r);
}
var Bt = e2, t2 = Array.isArray, ge = t2;
function r2(e) {
  return e != null && typeof e == "object";
}
var me = r2, n2 = Be, i2 = me, a2 = "[object Symbol]";
function o2(e) {
  return typeof e == "symbol" || i2(e) && n2(e) == a2;
}
var Ut = o2, s2 = ge, l2 = Ut, c2 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, u2 = /^\w*$/;
function d2(e, t) {
  if (s2(e))
    return !1;
  var r = typeof e;
...
var h2 = d2, y2 = oe, f2 = y2(Object, "create"), st = f2, w0 = st;
function C2() {
...
var p2 = m2, v2 = st, b2 = "__lodash_hash_undefined__", $2 = Object.prototype, _2 = $2.hasOwnProperty;
function k2(e) {
  var t = this.__data__;
  if (v2) {
    var r = t[e];
...
var L2 = k2, x2 = st, A2 = Object.prototype, w2 = A2.hasOwnProperty;
function M2(e) {
  var t = this.__data__;
  return x2 ? t[e] !== void 0 : w2.call(t, e);
}
var S2 = M2, T2 = st, P2 = "__lodash_hash_undefined__";
function O2(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = T2 && t === void 0 ? P2 : t, this;
}
var I2 = O2, D2 = g2, N2 = p2, E2 = L2, B2 = S2, U2 = I2;
function pe(e) {
...
var lt = Q2, Z2 = lt, R2 = Array.prototype, V2 = R2.splice;
function H2(e) {
...
ve.prototype.has = s3;
ve.prototype.set = l3;
var ct = ve, c3 = oe, u3 = Q1, d3 = c3(u3, "Map"), Ft = d3, M0 = F2, h3 = ct, y3 = Ft;
function f3() {
...
be.prototype.has = N3;
be.prototype.set = E3;
var $9 = be, _9 = $9, B3 = "Expected a function";
function Kt(e, t) {
  ...
  return r.cache = new (Kt.Cache || _9)(), r;
}
Kt.Cache = _9;
var U3 = Kt, F3 = U3, K3 = 500;
function j3(e) {
...
var q3 = Y3, S0 = ot, G3 = q3, W3 = ge, X3 = Ut, J3 = 1 / 0, T0 = S0 ? S0.prototype : void 0, P0 = T0 ? T0.toString : void 0;
function k9(e) {
  if (typeof e == "string")
    return e;
  if (W3(e))
...
var gr = Cr, mr = Bt, pr = cr, vr = L9, O0 = Ce, br = gr;
function $r(e, t, r, n) {
  if (!O0(e))
    return e;
  t = pr(t, e);
  for (var a = -1, l = t.length, u = l - 1, c = e; c != null && ++a < l; ) {
    ...
    if (a != u) {
      var f = c[g];
      $ = n ? n(f, g, c) : void 0, $ === void 0 && ($ = O0(f) ? f : vr(t[a + 1]) ? [] : {});
    }
    mr(c, g, $), c = c[g];
  }
  return e;
...
var Dr = Ir, Nr = ct, Er = Ft, Br = $9, Ur = 200;
function Fr(e, t) {
  var r = this.__data__;
  if (r instanceof Nr) {
    var n = r.__data__;
...
var Kr = Fr, jr = ct, zr = Mr, Qr = Tr, Zr = Or, Rr = Dr, Vr = Kr;
function $e(e) {
...
var en = Jr, tn = Be, rn = me, nn = "[object Arguments]";
function an(e) {
  return rn(e) && tn(e) == nn;
}
var on = an, I0 = on, sn = me, x9 = Object.prototype, ln = x9.hasOwnProperty, cn = x9.propertyIsEnumerable, un = I0(function() {
  return arguments;
}()) ? I0 : function(e) {
...
et.exports;
(function(e, t) {
  var r = Q1, n = yn, a = t && !t.nodeType && t, l = a && !0 && e && !e.nodeType && e, u = l && l.exports === a, c = u ? r.Buffer : void 0, g = c ? c.isBuffer : void 0, $ = g || n;
  e.exports = $;
})(et, et.exports);
var A9 = et.exports, fn = 9007199254740991;
function Cn(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= fn;
}
var w9 = Cn, gn = Be, mn = w9, pn = me, vn = "[object Arguments]", bn = "[object Array]", $n = "[object Boolean]", _n = "[object Date]", kn = "[object Error]", Ln = "[object Function]", xn = "[object Map]", An = "[object Number]", wn = "[object Object]", Mn = "[object RegExp]", Sn = "[object Set]", Tn = "[object String]", Pn = "[object WeakMap]", On = "[object ArrayBuffer]", In = "[object DataView]", Dn = "[object Float32Array]", Nn = "[object Float64Array]", En = "[object Int8Array]", Bn = "[object Int16Array]", Un = "[object Int32Array]", Fn = "[object Uint8Array]", Kn = "[object Uint8ClampedArray]", jn = "[object Uint16Array]", zn = "[object Uint32Array]", r1 = {};
r1[Dn] = r1[Nn] = r1[En] = r1[Bn] = r1[Un] = r1[Fn] = r1[Kn] = r1[jn] = r1[zn] = !0;
r1[vn] = r1[bn] = r1[On] = r1[$n] = r1[In] = r1[_n] = r1[kn] = r1[Ln] = r1[xn] = r1[An] = r1[wn] = r1[Mn] = r1[Sn] = r1[Tn] = r1[Pn] = !1;
function Qn(e) {
...
var jt = Rn, tt = { exports: {} };
tt.exports;
(function(e, t) {
  var r = C9, n = t && !t.nodeType && t, a = n && !0 && e && !e.nodeType && e, l = a && a.exports === n, u = l && r.process, c = function() {
    try {
...
var zt = tt.exports, Vn = Zn, Hn = jt, D0 = zt, N0 = D0 && D0.isTypedArray, Yn = N0 ? Hn(N0) : Vn, qn = Yn, Gn = en, Wn = dn, Xn = ge, Jn = A9, e8 = L9, t8 = qn, r8 = Object.prototype, n8 = r8.hasOwnProperty;
function i8(e, t) {
...
var S9 = s8, l8 = S9, c8 = l8(Object.keys, Object), u8 = c8, d8 = Qt, h8 = u8, y8 = Object.prototype, f8 = y8.hasOwnProperty;
function C8(e) {
  if (!d8(e))
    return h8(e);
  var t = [];
...
var g8 = C8, m8 = m9, p8 = w9;
function v8(e) {
  return e != null && p8(e.length) && !m8(e);
}
var T9 = v8, b8 = M9, $8 = g8, _8 = T9;
function k8(e) {
  return _8(e) ? b8(e) : $8(e);
}
var Zt = k8, L8 = dt, x8 = Zt;
function A8(e, t) {
  return e && L8(t, x8(t), e);
}
var w8 = A8;
function M8(e) {
  var t = [];
...
var S8 = M8, T8 = Ce, P8 = Qt, O8 = S8, I8 = Object.prototype, D8 = I8.hasOwnProperty;
function N8(e) {
  if (!T8(e))
    return O8(e);
  var t = P8(e), r = [];
...
var E8 = N8, B8 = M9, U8 = E8, F8 = T9;
function K8(e) {
  return F8(e) ? B8(e, !0) : U8(e);
}
var Rt = K8, j8 = dt, z8 = Rt;
function Q8(e, t) {
  return e && j8(t, z8(t), e);
}
var Z8 = Q8, rt = { exports: {} };
rt.exports;
(function(e, t) {
...
var P9 = G8, W8 = q8, X8 = P9, J8 = Object.prototype, e7 = J8.propertyIsEnumerable, E0 = Object.getOwnPropertySymbols, t7 = E0 ? function(e) {
  return e == null ? [] : (e = Object(e), W8(E0(e), function(t) {
    return e7.call(e, t);
  }));
} : X8, Vt = t7, r7 = dt, n7 = Vt;
function i7(e, t) {
  return r7(e, n7(e), t);
}
var a7 = i7;
...
var O9 = o7, s7 = S9, l7 = s7(Object.getPrototypeOf, Object), I9 = l7, c7 = O9, u7 = I9, d7 = Vt, h7 = P9, y7 = Object.getOwnPropertySymbols, f7 = y7 ? function(e) {
  for (var t = []; e; )
    c7(t, d7(e)), e = u7(e);
  return t;
} : h7, D9 = f7, C7 = dt, g7 = D9;
function m7(e, t) {
  return C7(e, g7(e), t);
}
var p7 = m7, v7 = O9, b7 = ge;
function $7(e, t, r) {
  var n = t(e);
  return b7(e) ? n : v7(n, r(e));
}
var N9 = $7, _7 = N9, k7 = Vt, L7 = Zt;
function x7(e) {
  return _7(e, L7, k7);
}
var A7 = x7, w7 = N9, M7 = D9, S7 = Rt;
function T7(e) {
  return w7(e, S7, M7);
}
var P7 = T7, O7 = oe, I7 = Q1, D7 = O7(I7, "DataView"), N7 = D7, E7 = oe, B7 = Q1, U7 = E7(B7, "Promise"), F7 = U7, K7 = oe, j7 = Q1, z7 = K7(j7, "Set"), Q7 = z7, Z7 = oe, R7 = Q1, V7 = Z7(R7, "WeakMap"), H7 = V7, Tt = N7, Pt = Ft, Ot = F7, It = Q7, Dt = H7, E9 = Be, _e = p9, B0 = "[object Map]", Y7 = "[object Object]", U0 = "[object Promise]", F0 = "[object Set]", K0 = "[object WeakMap]", j0 = "[object DataView]", q7 = _e(Tt), G7 = _e(Pt), W7 = _e(Ot), X7 = _e(It), J7 = _e(Dt), te = E9;
(Tt && te(new Tt(new ArrayBuffer(1))) != j0 || Pt && te(new Pt()) != B0 || Ot && te(Ot.resolve()) != U0 || It && te(new It()) != F0 || Dt && te(new Dt()) != K0) && (te = function(e) {
  var t = E9(e), r = t == Y7 ? e.constructor : void 0, n = r ? _e(r) : "";
  if (n)
    switch (n) {
      case q7:
        return j0;
...
var Ht = te, ei = Object.prototype, ti = ei.hasOwnProperty;
function ri(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && ti.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
var ni = ri, ii = Q1, ai = ii.Uint8Array, oi = ai, z0 = oi;
function si(e) {
...
var yi = hi, Q0 = ot, Z0 = Q0 ? Q0.prototype : void 0, R0 = Z0 ? Z0.valueOf : void 0;
function fi(e) {
...
var Zi = Qi, Ri = Ce, V0 = Object.create, Vi = function() {
  function e() {
  }
  return function(t) {
    if (!Ri(t))
...
}(), Hi = Vi, Yi = Hi, qi = I9, Gi = Qt;
function Wi(e) {
  return typeof e.constructor == "function" && !Gi(e) ? Yi(qi(e)) : {};
}
var Xi = Wi, Ji = Ht, ea = me, ta = "[object Map]";
function ra(e) {
  return ea(e) && Ji(e) == ta;
}
var na = ra, ia = na, aa = jt, H0 = zt, Y0 = H0 && H0.isMap, oa = Y0 ? aa(Y0) : ia, sa = oa, la = Ht, ca = me, ua = "[object Set]";
function da(e) {
  return ca(e) && la(e) == ua;
}
var ha = da, ya = ha, fa = jt, q0 = zt, G0 = q0 && q0.isSet, Ca = G0 ? fa(G0) : ya, ga = Ca, ma = Hr, pa = qr, va = Bt, ba = w8, $a = Z8, _a = R8, ka = H8, La = a7, xa = p7, Aa = A7, wa = P7, Ma = Ht, Sa = ni, Ta = Zi, Pa = Xi, Oa = ge, Ia = A9, Da = sa, Na = Ce, Ea = ga, Ba = Zt, Ua = Rt, Fa = 1, Ka = 2, ja = 4, B9 = "[object Arguments]", za = "[object Array]", Qa = "[object Boolean]", Za = "[object Date]", Ra = "[object Error]", U9 = "[object Function]", Va = "[object GeneratorFunction]", Ha = "[object Map]", Ya = "[object Number]", F9 = "[object Object]", qa = "[object RegExp]", Ga = "[object Set]", Wa = "[object String]", Xa = "[object Symbol]", Ja = "[object WeakMap]", e4 = "[object ArrayBuffer]", t4 = "[object DataView]", r4 = "[object Float32Array]", n4 = "[object Float64Array]", i4 = "[object Int8Array]", a4 = "[object Int16Array]", o4 = "[object Int32Array]", s4 = "[object Uint8Array]", l4 = "[object Uint8ClampedArray]", c4 = "[object Uint16Array]", u4 = "[object Uint32Array]", e1 = {};
e1[B9] = e1[za] = e1[e4] = e1[t4] = e1[Qa] = e1[Za] = e1[r4] = e1[n4] = e1[i4] = e1[a4] = e1[o4] = e1[Ha] = e1[Ya] = e1[F9] = e1[qa] = e1[Ga] = e1[Wa] = e1[Xa] = e1[s4] = e1[l4] = e1[c4] = e1[u4] = !0;
e1[Ra] = e1[U9] = e1[Ja] = !1;
function Ye(e, t, r, n, a, l) {
  ...
  if (f) {
    ...
    var x = Ma(e), L = x == U9 || x == Va;
    if (Ia(e))
      return _a(e, c);
    if (x == F9 || x == B9 || L && !a) {
      if (u = g || L ? {} : Pa(e), !c)
        return g ? xa(e, $a(u, e)) : La(e, ba(u, e));
    } else {
      if (!e1[x])
        return a ? e : {};
      u = Ta(e, x, c);
  ...
  return pa(I || e, function(H, Q) {
    I && (Q = H, H = e[Q]), va(u, Q, Ye(H, t, r, Q, e, l));
  }), u;
}
var d4 = Ye, h4 = d4, y4 = 1, f4 = 4;
function C4(e) {
  return h4(e, y4 | f4);
}
var g4 = C4;
const m4 = /* @__PURE__ */ f9(g4), p4 = /* @__PURE__ */ b("<button></button>"), v4 = (e) => (() => {
  const t = p4.cloneNode(!0);
  return X1(t, "click", e.onClick, !0), _(t, () => e.children), B((r) => {
    const n = e.style, a = `klinecharts-pro-button ${e.type ?? "confirm"} ${e.class ?? ""}`;
    return r._v$ = ae(t, n, r._v$), a !== r._v$2 && y1(t, r._v$2 = a), r;
  }, {
    _v$: void 0,
    _v$2: void 0
  }), t;
...
U1(["click"]);
const A4 = /* @__PURE__ */ b('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), K9 = () => A4.cloneNode(!0), w4 = /* @__PURE__ */ b('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), M4 = () => w4.cloneNode(!0), S4 = /* @__PURE__ */ b("<ul></ul>"), T4 = /* @__PURE__ */ b("<li></li>"), nt = (e) => (() => {
  ...
  return t.$$click = (u) => {
  ...
  }, _(n, () => e.title, a), X1(a, "click", e.onClose, !0), _(l, () => e.children), _(r, (() => {
    const u = Y(() => !!(e.buttons && e.buttons.length > 0));
    return () => u() && (() => {
      const c = O4.cloneNode(!0);
      return _(c, () => e.buttons.map((g) => k(v4, y9(g, {
        get style() {
          return {
            ...e.minButtonWidth ? {
        ...
        return g._v$8 = ae(c, $, g._v$8), f !== g._v$9 && c.classList.toggle("mobile-buttons", g._v$9 = f), g;
      }, {
        _v$8: void 0,
        _v$9: void 0
      }), c;
    ...
    const c = !!e.isMobile, g = e.isMobile ? "100%" : `${e.width ?? 400}px`, $ = (e.isMobile, "auto"), f = e.isMobile ? "60vh" : "90vh", x = !!e.isMobile, L = !!e.isMobile, S = !!e.isMobile;
    return c !== u._v$ && t.classList.toggle("mobile-modal", u._v$ = c), g !== u._v$2 && r.style.setProperty("width", u._v$2 = g), $ !== u._v$3 && r.style.setProperty("height", u._v$3 = $), f !== u._v$4 && r.style.setProperty("max-height", u._v$4 = f), x !== u._v$5 && r.classList.toggle("mobile-inner", u._v$5 = x), L !== u._v$6 && n.classList.toggle("mobile-title", u._v$6 = L), S !== u._v$7 && l.classList.toggle("mobile-content", u._v$7 = S), u;
  }, {
    _v$: void 0,
    _v$2: void 0,
    _v$3: void 0,
...
U1(["click"]);
const I4 = /* @__PURE__ */ b('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), D4 = /* @__PURE__ */ b('<div class="drop-down-container"><ul></ul></div>'), N4 = /* @__PURE__ */ b('<div><input type="text"></div>'), E4 = /* @__PURE__ */ b("<li></li>"), j9 = (e) => {
  const [t, r] = w(!1), [n, a] = w("");
  let l, u;
  const c = Y(() => {
    ...
    return f ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((L) => L.toLowerCase().includes(f)) : e.dataSource.filter((L) => {
      var I, H;
      const S = ((I = L.text) == null ? void 0 : I.toString().toLowerCase()) || "", O = ((H = L.key) == null ? void 0 : H.toLowerCase()) || "";
  ...
  return (() => {
    const f = I4.cloneNode(!0), x = f.firstChild, L = x.firstChild;
    f.addEventListener("blur", $), f.$$click = (O) => {
      O.stopPropagation(), g();
    };
    const S = u;
    return typeof S == "function" ? ne(S, f) : u = f, _(L, () => e.value), _(f, (() => {
      const O = Y(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => O() && (() => {
        const I = D4.cloneNode(!0), H = I.firstChild;
        return I.$$mousedown = (Q) => Q.preventDefault(), _(I, (() => {
          const Q = Y(() => !!e.searchable);
          return () => Q() && (() => {
            const E = N4.cloneNode(!0), D = E.firstChild;
            E.style.setProperty("padding", "8px"), E.style.setProperty("border-bottom", "1px solid #333"), D.$$click = (G) => G.stopPropagation(), D.$$input = (G) => a(G.currentTarget.value);
            const K = l;
            return typeof K == "function" ? ne(K, D) : l = D, D.style.setProperty("width", "100%"), D.style.setProperty("padding", "6px 10px"), D.style.setProperty("border", "1px solid var(--klinecharts-pro-border-color)"), D.style.setProperty("border-radius", "4px"), D.style.setProperty("background-color", "var(--klinecharts-pro-popover-background-color)"), D.style.setProperty("color", "#fff"), D.style.setProperty("font-size", "13px"), D.style.setProperty("outline", "none"), B(() => b1(D, "placeholder", e.searchPlaceholder || "Search...")), B(() => D.value = n()), E;
          })();
        })(), H), _(H, () => {
          var Q;
          return (Q = c()) == null ? void 0 : Q.map((E) => {
            ...
            return (() => {
              ...
              return G.$$click = (O1) => {
                var c1;
                O1.stopPropagation(), e.value !== K && ((c1 = e.onSelected) == null || c1.call(e, E)), r(!1), a("");
              }, _(G, K), G;
            })();
          });
        }), I;
      ...
      return O._v$ = ae(f, I, O._v$), H !== O._v$2 && y1(f, O._v$2 = H), O;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), f;
...
const B4 = /* @__PURE__ */ b('<span class="prefix"></span>'), U4 = /* @__PURE__ */ b('<span class="suffix"></span>'), F4 = /* @__PURE__ */ b('<div><input class="value"></div>'), z9 = (e) => {
  const t = y9({
  ...
  return (() => {
    ...
    return l.$$click = () => {
      ...
      return c._v$ = ae(l, g, c._v$), $ !== c._v$2 && y1(l, c._v$2 = $), f !== c._v$3 && b1(l, "data-status", c._v$3 = f), x !== c._v$4 && b1(u, "placeholder", c._v$4 = x), c;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
const o = (e, t) => {
  ...
  const [a, l] = w(window.innerWidth < 768), [u, c] = w(localStorage.getItem("klinechart_secondary_period") || ""), [g, $] = w(!1), [f, x] = w(!1), [L, S] = w({
    ...
    if (t && a()) {
      const Z = t;
      K(Z.scrollLeft > 10), O1(Z.scrollLeft + Z.clientWidth < Z.scrollWidth - 10);
    } else
      K(!1), O1(!1);
  };
  Et(() => {
    window.addEventListener("resize", O), document.addEventListener("fullscreenchange", E), document.addEventListener("mousedown", j), window.addEventListener("scroll", X, !0), document.addEventListener("mozfullscreenchange", E), document.addEventListener("webkitfullscreenchange", E), document.addEventListener("msfullscreenchange", E), t && (t.addEventListener("scroll", R), setTimeout(R, 100));
  }), ie(() => {
    window.removeEventListener("resize", O), document.removeEventListener("fullscreenchange", E), document.removeEventListener("mousedown", j), window.removeEventListener("scroll", X, !0), document.removeEventListener("mozfullscreenchange", E), document.removeEventListener("webkitfullscreenchange", E), document.removeEventListener("msfullscreenchange", E), t && t.removeEventListener("scroll", R);
  });
  const L1 = Y(() => {
    const Z = e.periods.filter((V) => {
      ...
      if (V.text === m1 || x1 && V.text === x1)
        return !0;
      if (!x1 || x1 === m1) {
        const s1 = e.periods.find((A1) => A1.text !== m1);
  ...
  return P1(() => {
    ...
    const Z = mu.cloneNode(!0), V = Z.firstChild, m1 = V.firstChild, x1 = m1.firstChild, s1 = m1.nextSibling, A1 = s1.firstChild;
    return Z.style.setProperty("position", "relative"), Z.style.setProperty("width", "100%"), Z.style.setProperty("display", "flex"), Z.style.setProperty("align-items", "center"), _(Z, k(z, {
      ...
      t = C;
    }, V), V.style.setProperty("width", "100%"), X1(x1, "click", e.onMenuClick, !0), _(V, k(z, {
      get when() {
        return e.symbol;
      },
      get children() {
        const C = su.cloneNode(!0), U = C.firstChild;
        return X1(C, "click", e.onSymbolClick, !0), _(C, k(z, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const J = ou.cloneNode(!0);
            return B(() => b1(J, "src", e.symbol.logo)), J;
          }
      ...
      return (() => {
        ...
        }, y1(u1, `item period ${J ? "selected" : ""}`), _(u1, () => C.text), u1;
      })();
    }), s1), _(V, k(z, {
      get when() {
        return Y(() => !!(a() && !I()))() && L1().length > 1;
      },
      get children() {
      ...
      get children() {
        ...
        return X1(C, "click", e.onIndicatorClick, !0), _(J, () => o("indicator", e.locale)), C;
      }
        ...
        return ne((W) => {
          ...
          get children() {
            return k(R5, {
              ...
              get children() {
                const W = du.cloneNode(!0), _1 = W.firstChild, w1 = _1.firstChild, F1 = w1.firstChild, K1 = F1.firstChild, G1 = K1.firstChild, R1 = w1.nextSibling, ke = R1.firstChild, D1 = ke.firstChild, Le = D1.firstChild, ht = ke.nextSibling, le = ht.firstChild, W1 = le.firstChild, Ue = _1.nextSibling, M1 = Ue.firstChild, k1 = M1.firstChild, j1 = Ue.nextSibling, S1 = j1.nextSibling, yt = S1.firstChild, ce = yt.firstChild, xe = S1.nextSibling, Fe = xe.nextSibling, d1 = Fe.firstChild, f1 = d1.firstChild;
                return W.$$mousedown = (T) => T.stopPropagation(), ne((T) => {
                  n = T;
                }, W), W.style.setProperty("position", "fixed"), W.style.setProperty("z-index", "9999"), w1.$$click = (T) => {
                  T.preventDefault(), T.stopPropagation(), x((N) => !N);
                }, K1.$$mousedown = (T) => T.stopPropagation(), K1.$$click = (T) => T.stopPropagation(), G1.addEventListener("change", (T) => {
                  var N;
                  T.stopPropagation(), (N = e.onOrderToolsStateChange) == null || N.call(e, {
                    quickOrder: T.currentTarget.checked
                  });
                }), Le.addEventListener("change", (T) => {
                  var N;
                  (N = e.onOrderToolsStateChange) == null || N.call(e, {
                    quickOrderFloatingWindow: T.currentTarget.checked
                  });
                }), W1.addEventListener("change", (T) => {
                  var N;
                  (N = e.onOrderToolsStateChange) == null || N.call(e, {
                    quickOrderPlusButton: T.currentTarget.checked
                  });
                }), k1.addEventListener("change", (T) => {
                  var N;
                  (N = e.onOrderToolsStateChange) == null || N.call(e, {
                    openOrders: T.currentTarget.checked
                  });
                }), ce.addEventListener("change", (T) => {
                  var N;
                  (N = e.onOrderToolsStateChange) == null || N.call(e, {
                    positions: T.currentTarget.checked
                  });
                }), f1.addEventListener("change", (T) => {
                  var N;
                  (N = e.onOrderToolsStateChange) == null || N.call(e, {
                    orderHistory: T.currentTarget.checked
                  });
                }), B((T) => {
                  const N = `${L().top}px`, z1 = `${L().left}px`, N1 = `${L().minWidth}px`, Ke = `klinecharts-pro-order-tools-group${f() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return N !== T._v$ && W.style.setProperty("top", T._v$ = N), z1 !== T._v$2 && W.style.setProperty("left", T._v$2 = z1), N1 !== T._v$3 && W.style.setProperty("width", T._v$3 = N1), Ke !== T._v$4 && y1(_1, T._v$4 = Ke), T;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var T, N, z1, N1;
                  return G1.checked = (((T = e.orderToolsState) == null ? void 0 : T.quickOrderFloatingWindow) ?? ((N = e.orderToolsState) == null ? void 0 : N.quickOrder) ?? !0) || (((z1 = e.orderToolsState) == null ? void 0 : z1.quickOrderPlusButton) ?? ((N1 = e.orderToolsState) == null ? void 0 : N1.quickOrder) ?? !0);
                }), B(() => {
                  var T, N;
                  return Le.checked = ((T = e.orderToolsState) == null ? void 0 : T.quickOrderFloatingWindow) ?? ((N = e.orderToolsState) == null ? void 0 : N.quickOrder) ?? !0;
                }), B(() => {
                  var T, N;
                  return W1.checked = ((T = e.orderToolsState) == null ? void 0 : T.quickOrderPlusButton) ?? ((N = e.orderToolsState) == null ? void 0 : N.quickOrder) ?? !0;
                }), B(() => {
                  var T;
                  return k1.checked = ((T = e.orderToolsState) == null ? void 0 : T.openOrders) ?? !0;
                }), B(() => {
                  var T;
                  return ce.checked = ((T = e.orderToolsState) == null ? void 0 : T.positions) ?? !0;
                }), B(() => {
                  var T;
                  return f1.checked = ((T = e.orderToolsState) == null ? void 0 : T.orderHistory) ?? !0;
                }), W;
              }
            });
          }
          ...
          return _1 !== W._v$5 && U.style.setProperty("padding", W._v$5 = _1), w1 !== W._v$6 && u1.style.setProperty("transform", W._v$6 = w1), W;
        }, {
          _v$5: void 0,
          _v$6: void 0
        }), C;
      ...
      get children() {
        return [(() => {
          ...
          return X1(C, "click", e.onTimezoneClick, !0), C;
        })(), (() => {
          const C = fu.cloneNode(!0);
          return X1(C, "click", e.onSettingClick, !0), C;
        })()];
      }
    }), A1), _(s1, k(z, {
      get when() {
      ...
      get children() {
        const C = Cu.cloneNode(!0);
        return X1(C, "click", e.onScreenshotClick, !0), C;
      }
    }), A1), A1.$$click = () => {
      if (I())
      ...
      const U = a() ? "auto" : "visible", J = e.spread ? "" : "rotate", u1 = I() ? "0px" : "var(--klinecharts-pro-period-bar-padding-right)";
      return U !== C._v$7 && V.style.setProperty("overflow", C._v$7 = U), J !== C._v$8 && b1(x1, "class", C._v$8 = J), u1 !== C._v$9 && s1.style.setProperty("padding-right", C._v$9 = u1), C;
    }, {
      _v$7: void 0,
      _v$8: void 0,
      _v$9: void 0
...
const B1 = (e) => zd[e.name](e.class), qd = /* @__PURE__ */ b('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Gd = /* @__PURE__ */ b('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), X0 = /* @__PURE__ */ b('<li><span style="padding-left:8px"></span></li>'), J0 = "drawing_tools", Wd = (e) => {
  const [t, r] = w("horizontalStraightLine"), [n, a] = w("priceChannelLine"), [l, u] = w("circle"), [c, g] = w("fibonacciLine"), [$, f] = w("xabcd"), [x, L] = w("weak_magnet"), [S, O] = w("normal"), [I, H] = w(!1), [Q, E] = w(!0), [D, K] = w(""), G = Y(() => [{
    key: "singleLine",
    icon: t(),
    list: Qd(e.locale),
    setter: r
  ...
  return (() => {
    const c1 = qd.cloneNode(!0), I1 = c1.firstChild, j = I1.nextSibling, X = j.firstChild, R = X.nextSibling, L1 = R.firstChild, Z1 = j.nextSibling, Z = Z1.firstChild, V = Z1.nextSibling, m1 = V.firstChild, x1 = V.nextSibling, s1 = x1.nextSibling, A1 = s1.firstChild;
    return _(c1, () => G().map((C) => (() => {
        ...
        return () => _1() && k(nt, {
          ...
          get children() {
            return C.list.map((w1) => (() => {
              const F1 = X0.cloneNode(!0), K1 = F1.firstChild;
              return F1.$$click = () => {
      ...
      })(), null), B(() => b1(W, "class", C.key === D() ? "rotate" : "")), U;
    })()), I1), j.addEventListener("blur", () => {
      K("");
    }), X.$$click = () => {
      let C = x();
      S() !== "normal" && (C = "normal"), O(C), e.onModeChange(C);
    }, _(X, (() => {
      const C = Y(() => x() === "weak_magnet");
      return () => C() ? (() => {
      ...
      return () => C() && k(nt, {
        ...
        get children() {
          return O1().map((U) => (() => {
            const J = X0.cloneNode(!0), u1 = J.firstChild;
            return J.$$click = () => {
      ...
      name: "remove"
    })), B(() => b1(L1, "class", D() === "mode" ? "rotate" : "")), c1;
  })();
};
U1(["click"]);
const e9 = /* @__PURE__ */ b('<li class="title"></li>'), t9 = /* @__PURE__ */ b('<li class="row"></li>'), Xd = (e) => k(se, {
  get title() {
...
const th = /* @__PURE__ */ b('<div class="klinecharts-pro-setting-modal-content"></div>'), rh = /* @__PURE__ */ b('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), nh = (e) => {
  const [t, r] = w(e.currentStyles), [n, a] = w(n9(e.locale)), [l, u] = w(!1), c = () => {
  ...
  return k(se, {
    ...
    get children() {
      ...
      return _($, k(wt, {
        ...
        children: (f) => {
          let x;
          const L = o1.formatValue(t(), f.key);
          switch (f.component) {
            case "select": {
              x = k(j9, {
                get style() {
          ...
          return (() => {
            const S = rh.cloneNode(!0), O = S.firstChild, I = O.nextSibling;
            return _(O, () => f.text), _(I, x), B(() => S.classList.toggle("mobile-item", !!l())), S;
          })();
        }
      })), B(() => $.classList.toggle("mobile-layout", !!l())), $;
    }
  });
}, ih = /* @__PURE__ */ b('<img style="width:500px;margin-top: 20px">'), ah = (e) => k(se, {
  get title() {
        ...
        renderItem: (a) => (() => {
          ...
          return l.$$click = () => {
            ...
            get children() {
              ...
              return B(() => b1(g, "src", a.logo)), g;
            }
          }), c), _(c, () => a.shortName ?? a.ticker, null), _(c, () => `${a.name ? `(${a.name})` : ""}`, null), _(l, () => a.exchange ?? "", null), B(() => b1(c, "title", a.name ?? "")), l;
        })()
      })];
    }
  });
...
const Ah = (e) => {
  var a0, o0, s0, l0, c0, u0, d0, h0, y0, f0, C0, g0;
  let t, r = null, n;
  const [a, l] = w(!1), [u, c] = w(e.theme), [g, $] = w(e.styles), [f, x] = w(e.locale), [L, S] = w(e.symbol), [O, I] = w(e.period), [H, Q] = w(!1), [E, D] = w([...e.mainIndicators]), [K, G] = w({}), [O1, c1] = w(!1), [I1, j] = w({
    key: e.timezone,
    text: r9(e.timezone, e.locale)
  }), [X, R] = w(!1), [L1, Z1] = w(), [Z, V] = w(""), [m1, x1] = w(e.drawingBarVisible), [s1, A1] = w(!1), [C, U] = w(!1), [J, u1] = w(!1), W = ((a0 = e.orderTools) == null ? void 0 : a0.quickOrder) ?? !0, [_1, w1] = w({
    quickOrder: W,
    quickOrderFloatingWindow: ((o0 = e.orderTools) == null ? void 0 : o0.quickOrderFloatingWindow) ?? W,
    quickOrderPlusButton: ((s0 = e.orderTools) == null ? void 0 : s0.quickOrderPlusButton) ?? W,
    openOrders: ((l0 = e.orderTools) == null ? void 0 : l0.openOrders) ?? !0,
    positions: ((c0 = e.orderTools) == null ? void 0 : c0.positions) ?? !0,
    orderHistory: ((u0 = e.orderTools) == null ? void 0 : u0.orderHistory) ?? !0
  }), [F1, K1] = w(null), [G1, R1] = w(!1), [ke, D1] = w(!1), [Le, ht] = w(64), [le, W1] = w(null), Ue = 6, [M1, k1] = w(null), [j1, S1] = w(null), yt = ["#000000", "#2b3342", "#3f4653", "#565d69", "#6f7580", "#8a9099", "#a7acb3", "#c4c8ce", "#ffffff", "#ff4d67", "#ffa629", "#f7ed4a", "#2fc58d", "#4ab09c", "#52c4d3", "#3157f6", "#6a36b8", "#a644b9", "#d83972", "#f2a3a6", "#f5c879", "#f7ee97", "#a6d29f", "#7fc9b9", "#91d7df", "#8fb2ee", "#b09ad2", "#c89ccf", "#d987ab", "#e8757a", "#efb34f", "#efe36e", "#86c17d", "#66b7a8", "#68c4d0", "#5f91e4", "#8059c9", "#aa62c2", "#d34d83", "#b9353d", "#ea8527", "#e8c245", "#4b8c43", "#2f6f60", "#47919b", "#2646c6", "#56309c", "#892f95", "#a82563", "#8e2528", "#de5c1f", "#dc8527", "#255a22", "#164b34", "#225b63", "#15309b", "#442180", "#6b1f74", "#86154e"];
  let ce = null;
  const [xe, Fe] = w({
    visible: !1,
    indicatorName: "",
  ...
  let d1 = /* @__PURE__ */ new Map(), f1 = /* @__PURE__ */ new Map();
  const T = (i, s, d) => {
    ...
    priceLine: 1,
    priceChannelLine: 3
  })[i] || 1, N1 = (i, s = /* @__PURE__ */ new WeakSet()) => {
    if (i == null)
      return i;
    if (s.has(i))
      return "[Circular]";
    ...
    try {
      ...
      const p = Ke(m);
      if (p) {
        const y = d1.get(i), v = ((d = y == null ? void 0 : y.points) == null ? void 0 : d.length) || 0, A = ((h = p.points) == null ? void 0 : h.length) || 0;
        d1.set(i, p);
        const M = z1(p.type);
        if (A >= M) {
          const P = f1.get(i);
    ...
    document.addEventListener("mouseup", h), document.addEventListener("touchend", h), setTimeout(() => {
      ...
      if (m && !m.complete) {
        ...
        const y = d1.get(i);
        if (y) {
          const v = z1(y.type), A = ((p = y.points) == null ? void 0 : p.length) || 0;
      ...
      try {
        const d = `kline_drawings_${i}`, m = {
          drawings: s.map((p) => {
            ...
            y.extendData && (y.extendData = N1(y.extendData)), y.styles && (y.styles = N1(y.styles));
            const v = z1(p.type), A = ((M = p.points) == null ? void 0 : M.length) || 0;
  ...
  const ft = () => {
    ...
    }), d1.clear(), f1.clear(), k1(null), S1(null), ee.loadDrawings(i).forEach((d) => {
      var h;
      try {
        const m = we({
          name: d.type,
    ...
    const s = (p = r == null ? void 0 : r.getSize) == null ? void 0 : p.call(r, "candle_pane", $t.YAxis);
    s != null && s.width && Number.isFinite(s.width) && ht(Math.max(44, Math.ceil(s.width)));
    ...
    if (ce)
      try {
        (i = r == null ? void 0 : r.executeAction) == null || i.call(r, Qe.OnCrosshairChange, ce);
      } catch {
      }
  }, gt = (i) => {
    var d, h;
    ...
    var v, A, M, P, q, i1;
    const s = (A = (v = t == null ? void 0 : t.parentElement) == null ? void 0 : v.getBoundingClientRect) == null ? void 0 : A.call(v), d = (M = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : M.call(t), h = i == null ? void 0 : i.overlay, m = (P = h == null ? void 0 : h.points) == null ? void 0 : P[0];
    let p = 72, y = 40;
    if (s) {
      if (Number.isFinite(i == null ? void 0 : i.pageX) ? p = i.pageX - s.left : Number.isFinite(i == null ? void 0 : i.x) && d && (p = d.left - s.left + i.x), Number.isFinite(i == null ? void 0 : i.pageY))
        ...
        try {
          const l1 = (q = r == null ? void 0 : r.convertToPixel) == null ? void 0 : q.call(r, [{
            ...
            paneId: "candle_pane",
            absolute: !0
          }), C1 = Number((i1 = l1 == null ? void 0 : l1[0]) == null ? void 0 : i1.y);
          Number.isFinite(C1) && (y = C1 - s.top);
        } catch {
        }
    }
    return {
    ...
    var v, A, M, P, q, i1, l1, C1;
    const s = i == null ? void 0 : i.overlay;
    if (!(s != null && s.id) || s.name !== "horizontalStraightLine")
      return !1;
    const d = q9(i), h = Number((A = (v = s.styles) == null ? void 0 : v.line) == null ? void 0 : A.size) || 3, m = ((P = (M = s.styles) == null ? void 0 : M.line) == null ? void 0 : P.style) ?? V1.Solid, p = Array.isArray((i1 = (q = s.styles) == null ? void 0 : q.line) == null ? void 0 : i1.dashedValue) ? s.styles.line.dashedValue : [], y = ((C1 = (l1 = s.styles) == null ? void 0 : l1.line) == null ? void 0 : C1.color) ?? "#2f6df6";
    return k1({
      id: s.id,
      x: d.x,
      y: d.y,
    ...
    return {
      ...
      styles: {
        ...
        line: {
          ...
          style: ((P = (M = i.styles) == null ? void 0 : M.line) == null ? void 0 : P.style) ?? V1.Solid,
          dashedValue: ((i1 = (q = i.styles) == null ? void 0 : q.line) == null ? void 0 : i1.dashedValue) ?? [6, 4],
          color: ((C1 = (l1 = i.styles) == null ? void 0 : l1.line) == null ? void 0 : C1.color) ?? "#2f6df6"
        }
      },
      onClick: (t1) => (mt(t1), (s == null ? void 0 : s(t1)) ?? !1),
      onSelected: (t1) => (mt(t1), (d == null ? void 0 : d(t1)) ?? !1),
      onPressedMoveEnd: (t1) => (mt(t1), (p == null ? void 0 : p(t1)) ?? !1),
      onDeselected: (t1) => (Gt(t1), (h == null ? void 0 : h(t1)) ?? !1),
      onRemoved: (t1) => (Gt(t1), (m == null ? void 0 : m(t1)) ?? !1)
    };
  }, G9 = () => {
    var s;
    const i = M1();
    ...
    if (!i)
      return;
    const s = 1, d = V1.Solid, h = [6, 4], m = "#2f6df6";
    de({
      styles: {
        line: {
          size: s,
  ...
  let Xt = (d0 = e.orderTools) == null ? void 0 : d0.quickOrder, Jt = (h0 = e.orderTools) == null ? void 0 : h0.quickOrderFloatingWindow, e0 = (y0 = e.orderTools) == null ? void 0 : y0.quickOrderPlusButton, t0 = (f0 = e.orderTools) == null ? void 0 : f0.openOrders, r0 = (C0 = e.orderTools) == null ? void 0 : C0.positions, n0 = (g0 = e.orderTools) == null ? void 0 : g0.orderHistory;
  P1(() => {
    var v, A, M, P, q, i1;
    const i = (v = e.orderTools) == null ? void 0 : v.quickOrder, s = (A = e.orderTools) == null ? void 0 : A.quickOrderFloatingWindow, d = (M = e.orderTools) == null ? void 0 : M.quickOrderPlusButton, h = (P = e.orderTools) == null ? void 0 : P.openOrders, m = (q = e.orderTools) == null ? void 0 : q.positions, p = (i1 = e.orderTools) == null ? void 0 : i1.orderHistory, y = {};
    typeof i == "boolean" && i !== Xt && (Xt = i, y.quickOrder = i, typeof s != "boolean" && (y.quickOrderFloatingWindow = i), typeof d != "boolean" && (y.quickOrderPlusButton = i)), typeof s == "boolean" && s !== Jt && (Jt = s, y.quickOrderFloatingWindow = s), typeof d == "boolean" && d !== e0 && (e0 = d, y.quickOrderPlusButton = d), typeof h == "boolean" && h !== t0 && (t0 = h, y.openOrders = h), typeof m == "boolean" && m !== r0 && (r0 = m, y.positions = m), typeof p == "boolean" && p !== n0 && (n0 = p, y.orderHistory = p), Object.keys(y).length > 0 && Ct(y);
  }), e.ref({
    setTheme: c,
    getTheme: () => u(),
    setStyles: $,
    ...
    removeOverlay: (i) => {
      ...
      if ((s = r == null ? void 0 : r.removeOverlay) == null || s.call(r, i), i.id) {
        d1.delete(i.id);
        const d = f1.get(i.id);
        d && (d.checkInterval && clearInterval(d.checkInterval), d.mouseUpHandler && (document.removeEventListener("mouseup", d.mouseUpHandler), document.removeEventListener("touchend", d.mouseUpHandler)), f1.delete(i.id)), ft();
      }
    },
    removeAllOverlay: () => {
      d1.forEach((i, s) => {
    ...
    getSettings: () => {
      var d, h, m, p, y, v, A, M, P, q, i1, l1, C1, t1, E1, he;
      if (!r)
        return {};
      ...
      return {
        ...
        showLowestPrice: (i1 = (q = (P = i.candle) == null ? void 0 : P.priceMark) == null ? void 0 : q.low) == null ? void 0 : i1.show,
        // Indicator settings
        showIndicatorLastValue: (C1 = (l1 = i.indicator) == null ? void 0 : l1.lastValueMark) == null ? void 0 : C1.show,
    ...
    saveDrawings: (i) => {
      ...
      s.forEach((d, h) => {
        var y;
        const m = z1(d.type), p = ((y = d.points) == null ? void 0 : y.length) || 0;
  ...
  return Et(() => {
    if (window.addEventListener("resize", i0), r = o5(t, {
      customApi: {
        formatDate: (y, v, A, M) => {
          switch (O().timespan) {
            case "minute":
              return M === ze.XAxis ? o1.formatDate(y, v, "HH:mm") : o1.formatDate(y, v, "YYYY-MM-DD HH:mm");
            case "hour":
              return M === ze.XAxis ? o1.formatDate(y, v, "MM-DD HH:mm") : o1.formatDate(y, v, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return o1.formatDate(y, v, "YYYY-MM-DD");
            case "month":
              return M === ze.XAxis ? o1.formatDate(y, v, "YYYY-MM") : o1.formatDate(y, v, "YYYY-MM-DD");
            case "year":
              return M === ze.XAxis ? o1.formatDate(y, v, "YYYY") : o1.formatDate(y, v, "YYYY-MM-DD");
          }
          return o1.formatDate(y, v, "YYYY-MM-DD HH:mm");
        }
      }
    }), r) {
      const y = r.getDom("candle_pane", $t.Main);
      if (y) {
      ...
      const v = r.getDom("candle_pane", $t.YAxis);
    ...
    r && h && (r.removeOverlay = function(...y) {
      ...
      if (typeof A == "string" ? M = A : A && typeof A == "object" && A.id && (M = A.id), M) {
        d1.delete(M);
        const P = f1.get(M);
        P && (P.checkInterval && clearInterval(P.checkInterval), P.mouseUpHandler && (document.removeEventListener("mouseup", P.mouseUpHandler), document.removeEventListener("touchend", P.mouseUpHandler)), f1.delete(M)), s();
      }
      return v;
    }), E().forEach((y) => {
      He(r, y, !0, {
    ...
    e.subIndicators.forEach((y) => {
      ...
      l(!0), (async () => {
        try {
          const A = O(), [M] = vt(A, y, 1), [P] = vt(A, M, 500), q = await e.datafeed.getHistoryKLineData(L(), A, P, M);
          r == null || r.applyMoreData(q, q.length > 0);
        } finally {
          l(!1);
        }
      })();
    }), r == null || r.subscribeAction(Qe.OnTooltipIconClick, (y) => {
      if (y.indicatorName)
        switch (y.iconId) {
          case "visible": {
            ...
            N(y.indicatorName, y.paneId, v, "change");
            break;
          }
          case "invisible": {
            r == null || r.overrideIndicator({
          ...
          case "close":
            if (y.paneId === "candle_pane") {
              const v = [...E()];
              r == null || r.removeIndicator("candle_pane", y.indicatorName), v.splice(v.indexOf(y.indicatorName), 1), D(v), N(y.indicatorName, "candle_pane", "main", "remove");
            } else {
              const v = {
                ...K()
              };
              r == null || r.removeIndicator(y.paneId, y.indicatorName), delete v[y.indicatorName], G(v), N(y.indicatorName, y.paneId, "sub", "remove");
            }
        }
    }), r == null || r.subscribeAction(Qe.OnCrosshairChange, qt), document.addEventListener("mousedown", Wt);
    const p = r == null ? void 0 : r.createOverlay;
    r && p && (r.createOverlay = function(...y) {
      const v = we(y[0]), A = p.apply(this, [v, ...y.slice(1)]), M = typeof A == "string" ? A : null;
      return M && (Z9(M, v.name || "unknown"), Ae(M), ft()), A;
    });
  }), ie(() => {
    window.removeEventListener("resize", i0), r == null || r.unsubscribeAction(Qe.OnCrosshairChange, qt), document.removeEventListener("mousedown", Wt), f1.clear(), d1.clear(), m0(t);
  }), P1(() => {
    const i = L();
    ...
    return ie(() => {
      ...
      try {
        const [p, y] = vt(d, (/* @__PURE__ */ new Date()).getTime(), 500), v = await e.datafeed.getHistoryKLineData(s, d, p, y);
        if (!h)
          return;
    ...
    g() && (r == null || r.setStyles(g()), Z1(m4(r.getStyles())));
  }), [gh.cloneNode(!0), k($u, {
    get locale() {
      return e.locale;
    },
    ...
    onMenuClick: async () => {
      try {
        await O5(() => x1(!m1())), r == null || r.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    return i.addEventListener("mouseleave", () => {
    ...
    }), s), ne((d) => t = d, s), _(i, k(z, {
      get when() {
        return M1();
      },
      keyed: !0,
      children: (d) => (() => {
        const h = $h.cloneNode(!0), m = h.firstChild, p = m.nextSibling, y = p.nextSibling, v = y.firstChild, A = y.nextSibling, M = A.firstChild, P = M.firstChild, q = P.nextSibling, i1 = q.firstChild, l1 = A.nextSibling, C1 = l1.firstChild, t1 = l1.nextSibling, E1 = t1.nextSibling, he = E1.nextSibling;
        return h.$$click = (F) => {
          F.stopPropagation();
        }, h.$$mousedown = (F) => {
          F.preventDefault(), F.stopPropagation();
        }, m.$$mousedown = r5, p.$$click = e5, v.$$click = () => S1(j1() === "color" ? null : "color"), _(y, k(z, {
          get when() {
            return j1() === "color";
          },
          get children() {
            const F = ph.cloneNode(!0), p1 = F.firstChild;
            return _(p1, k(wt, {
              each: yt,
              children: (a1) => (() => {
                const $1 = _h.cloneNode(!0);
                return $1.$$click = () => t5(a1), $1.style.setProperty("background", a1), B(() => y1($1, `overlay-toolbar-color-swatch ${d.color.toLowerCase() === a1.toLowerCase() ? "selected" : ""}`)), $1;
              })()
            })), F;
          }
        }), null), M.$$click = () => S1(j1() === "width" ? null : "width"), _(q, () => d.lineSize, i1), _(A, k(z, {
          get when() {
            return j1() === "width";
          },
          get children() {
            ...
            return _(F, k(wt, {
              each: [1, 2, 3, 4],
              children: (p1) => (() => {
                const a1 = kh.cloneNode(!0), $1 = a1.firstChild;
                return a1.$$click = () => J9(p1), $1.style.setProperty("height", `${p1}px`), B(() => y1(a1, d.lineSize === p1 ? "selected" : "")), a1;
              })()
            })), F;
          }
        }), null), C1.$$click = () => S1(j1() === "style" ? null : "style"), _(l1, k(z, {
          get when() {
            return j1() === "style";
          },
          get children() {
            const F = bh.cloneNode(!0), p1 = F.firstChild, a1 = p1.nextSibling, $1 = a1.nextSibling;
            return p1.$$click = () => pt(V1.Solid, []), a1.$$click = () => pt(V1.Dashed, [6, 4]), $1.$$click = () => pt(V1.Dashed, [2, 4]), B((T1) => {
              var Pe, Oe;
              const Me = d.lineStyle === V1.Solid ? "selected" : "", Se = d.lineStyle === V1.Dashed && ((Pe = d.dashedValue) == null ? void 0 : Pe[0]) === 6 ? "selected" : "", Te = d.lineStyle === V1.Dashed && ((Oe = d.dashedValue) == null ? void 0 : Oe[0]) === 2 ? "selected" : "";
              return Me !== T1._v$ && y1(p1, T1._v$ = Me), Se !== T1._v$2 && y1(a1, T1._v$2 = Se), Te !== T1._v$3 && y1($1, T1._v$3 = Te), T1;
            }, {
              _v$: void 0,
              _v$2: void 0,
              _v$3: void 0
        ...
        }), null), t1.$$click = X9, E1.$$click = W9, he.$$click = G9, B((F) => {
          const p1 = `${d.x}px`, a1 = `${d.y}px`, $1 = `overlay-toolbar-icon edit ${j1() === "color" ? "active" : ""}`, T1 = `overlay-toolbar-line-size ${j1() === "width" ? "active" : ""}`, Me = `overlay-toolbar-icon minus ${j1() === "style" ? "active" : ""}`, Se = `overlay-toolbar-icon visibility ${d.visible ? "" : "muted"}`, Te = d.visible ? "Hide" : "Show", Pe = `overlay-toolbar-icon lock ${d.locked ? "active" : ""}`, Oe = d.locked ? "Unlock" : "Lock";
          return p1 !== F._v$4 && h.style.setProperty("left", F._v$4 = p1), a1 !== F._v$5 && h.style.setProperty("top", F._v$5 = a1), $1 !== F._v$6 && y1(v, F._v$6 = $1), T1 !== F._v$7 && y1(M, F._v$7 = T1), Me !== F._v$8 && y1(C1, F._v$8 = Me), Se !== F._v$9 && y1(t1, F._v$9 = Se), Te !== F._v$10 && b1(t1, "title", F._v$10 = Te), Pe !== F._v$11 && y1(E1, F._v$11 = Pe), Oe !== F._v$12 && b1(E1, "title", F._v$12 = Oe), F;
        }, {
          _v$4: void 0,
          _v$5: void 0,
          _v$6: void 0,
      ...
      keyed: !0,
      children: (d) => (() => {
        const h = Lh.cloneNode(!0), m = h.firstChild;
        return h.addEventListener("mouseleave", () => {
          ...
          const y = `${Math.max(0, d.y - 12)}px`, v = `${Le()}px`, A = _1().quickOrderPlusButton ? "block" : "none";
      ...
      children: (d) => (() => {
        ...
        M.nextSibling;
        const P = p.nextSibling, q = P.firstChild, i1 = q.nextSibling, l1 = i1.nextSibling, C1 = l1.nextSibling;
        C1.nextSibling;
        const t1 = P.nextSibling, E1 = t1.nextSibling, he = E1.firstChild, F = he.nextSibling;
        F.nextSibling;
        const p1 = E1.nextSibling;
        return p1.firstChild, h.addEventListener("mouseleave", () => D1(!1)), h.addEventListener("mouseenter", () => D1(!0)), m.$$mousemove = () => {
          ue();
        }, m.$$mousedown = (a1) => {
          a1.preventDefault(), a1.stopPropagation(), ue();
        }, p.$$click = () => gt("limit"), _(p, () => L().shortName ?? L().name ?? L().ticker, v), _(p, () => je(d.price), M), P.$$click = () => gt("stop"), _(P, () => L().shortName ?? L().name ?? L().ticker, i1), _(P, () => je(d.price), C1), t1.$$click = () => gt("create"), E1.$$click = H9, _(E1, () => je(d.price), F), p1.$$click = Y9, _(p1, () => je(d.price), null), B((a1) => {
          const $1 = `${Math.max(0, d.y + 24)}px`, T1 = `${d.yAxisWidth + Ue}px`;
          return $1 !== a1._v$16 && h.style.setProperty("top", a1._v$16 = $1), T1 !== a1._v$17 && h.style.setProperty("right", a1._v$17 = T1), a1;
        }, {
          _v$16: void 0,
          _v$17: void 0
        }), h;
      })()
    }), null), B(() => b1(s, "data-drawing-bar-visible", m1())), i;
  })(), k(z, {
    get when() {
      return s1();
    },
    ...
    get children() {
      return k(Xd, {
        ...
        onMainIndicatorChange: (i) => {
          const s = [...E()];
          i.added ? (He(r, i.name, !0, {
            id: "candle_pane"
          }), s.push(i.name), N(i.name, "candle_pane", "main", "add")) : (r == null || r.removeIndicator("candle_pane", i.name), s.splice(s.indexOf(i.name), 1), N(i.name, "candle_pane", "main", "remove")), D(s);
        },
        onSubIndicatorChange: (i) => {
          ...
          if (i.added) {
            const d = He(r, i.name);
            d && (s[i.name] = d, N(i.name, d, "sub", "add"));
          } else
            i.paneId && (r == null || r.removeIndicator(i.paneId, i.name), delete s[i.name], N(i.name, i.paneId, "sub", "remove"));
          G(s);
        }
      });
    }
    ...
    get children() {
      return k(ch, {
        ...
        onConfirm: (i) => {
          ...
          N(s.indicatorName, s.paneId, d, "change");
        }
      });
    }
  }), k(z, {

...
import { utils as fe, OverlayMode as pn, ActionType as S1, LineType as d1, init as Y9, FormatDateType as Ut, DomPosition as h1, dispose as G0, TooltipIconPosition as zt, CandleType as W9, YAxisType as G9, registerOverlay as X9 } from "klinecharts";
function ft(e, t, r) {
...
const J9 = {
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const r = Rr(e[0], e[1]) / Math.sqrt(24), n = e[1].x > e[0].x ? 0 : 1, s = fe.getLinearSlopeIntercept(e[0], e[1]);
      let l;
      ...
      for (let L = 2; L < 9; L++) {
        ...
        const q = M + Math.PI / 2, N = ft({ x, y: p }, e[0], l);
        v.push({
          ...N,
          r: D,
          startAngle: M,
...
function j(e, t, r) {
  ...
  const n = rn(e, t, !0, 0);
  return n.observers = null, n.observerSlots = null, n.comparator = r.equals || void 0, j1(n), Zr.bind(n);
}
function b5(e, t, r) {
  let n, s, l;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (n = !0, s = e, l = t || {}) : (n = e, s = t, l = r || {});
  let h = null, d = vn, v = null, x = !1, p = "initialValue" in l, L = typeof n == "function" && j(n);
  const D = /* @__PURE__ */ new Set(), [M, q] = (l.storage || T)(l.initialValue), [N, F] = T(void 0), [I, re] = T(void 0, {
    equals: !1
  }), [R, Y] = T(p ? "ready" : "unresolved");
  if (Ne.context) {
...
function A5(e, t, r = {}) {
  ...
  return N1(() => J0(l)), () => {
    let v = e() || [], x, p;
    return v[C5], o1(() => {
      let D = v.length, M, q, N, F, I, re, R, Y, V;
      if (D === 0)
        ...
        for (N = new Array(D), F = new Array(D), d && (I = new Array(D)), re = 0, R = Math.min(h, D); re < R && n[re] === v[re]; re++)
          ;
        for (R = h - 1, Y = D - 1; R >= re && Y >= re && n[R] === v[Y]; R--, Y--)
          N[Y] = s[R], F[Y] = l[R], d && (I[Y] = d[R]);
        for (M = /* @__PURE__ */ new Map(), q = new Array(Y + 1), p = Y; p >= re; p--)
          V = v[p], x = M.get(V), q[p] = x === void 0 ? -1 : x, M.set(V, p);
        for (x = re; x <= R; x++)
          V = n[x], p = M.get(V), p !== void 0 && p !== -1 ? (N[p] = s[x], F[p] = l[x], d && (I[p] = d[x]), p = q[p], M.set(V, p)) : l[x]();
        for (p = re; p < D; p++)
...
function Ln(e) {
  ...
  return j(A5(() => e.each, e.children, t || void 0));
}
function J(e) {
  let t = !1;
...
var I5 = typeof Rt == "object" && Rt && Rt.Object === Object && Rt, Jr = I5, E5 = Jr, B5 = typeof self == "object" && self && self.Object === Object && self, F5 = E5 || B5 || Function("return this")(), i1 = F5, U5 = i1, z5 = U5.Symbol, an = z5, nr = an, e9 = Object.prototype, K5 = e9.hasOwnProperty, R5 = e9.toString, ht = nr ? nr.toStringTag : void 0;
function j5(e) {
...
var Q5 = j5, Z5 = Object.prototype, V5 = Z5.toString;
function H5(e) {
  return V5.call(e);
}
...
var Q1 = e6, t6 = gt, n6 = Q1, r6 = "[object AsyncFunction]", o6 = "[object Function]", i6 = "[object GeneratorFunction]", a6 = "[object Proxy]";
function s6(e) {
  if (!n6(e))
    return !1;
  var t = t6(e);
  return t == o6 || t == i6 || t == r6 || t == a6;
}
var t9 = s6, l6 = i1, c6 = l6["__core-js_shared__"], u6 = c6, bn = u6, ir = function() {
...
var h6 = d6, f6 = Function.prototype, m6 = f6.toString;
function g6(e) {
  if (e != null) {
    try {
      return m6.call(e);
...
var n9 = g6, y6 = t9, p6 = h6, v6 = Q1, C6 = n9, b6 = /[\\^$.*+?()[\]{}|]/g, $6 = /^\[object .+?Constructor\]$/, _6 = Function.prototype, k6 = Object.prototype, x6 = _6.toString, L6 = k6.hasOwnProperty, w6 = RegExp(
  "^" + x6.call(L6).replace(b6, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function A6(e) {
  if (!v6(e) || p6(e))
    return !1;
...
var S6 = T6, P6 = M6, D6 = S6;
function O6(e, t) {
  var r = D6(e, t);
  return P6(r) ? r : void 0;
}
var E1 = O6, N6 = E1, I6 = function() {
  try {
...
var o9 = F6, U6 = r9, z6 = o9, K6 = Object.prototype, R6 = K6.hasOwnProperty;
function j6(e, t, r) {
  var n = e[t];
  (!(R6.call(e, t) && z6(n, r)) || r === void 0 && !(t in e)) && U6(e, t, r);
}
var Bn = j6, Q6 = Array.isArray, Z1 = Q6;
function Z6(e) {
  return e != null && typeof e == "object";
}
var V1 = Z6, V6 = gt, H6 = V1, q6 = "[object Symbol]";
function Y6(e) {
  return typeof e == "symbol" || H6(e) && V6(e) == q6;
}
var Fn = Y6, W6 = Z1, G6 = Fn, X6 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, J6 = /^\w*$/;
function eo(e, t) {
  if (W6(e))
    return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || G6(e) ? !0 : J6.test(e) || !X6.test(e) || t != null && e in Object(t);
}
var to = eo, no = E1, ro = no(Object, "create"), sn = ro, sr = sn;
function oo() {
...
var so = ao, lo = sn, co = "__lodash_hash_undefined__", uo = Object.prototype, ho = uo.hasOwnProperty;
function fo(e) {
  var t = this.__data__;
  if (lo) {
    var r = t[e];
...
var mo = fo, go = sn, yo = Object.prototype, po = yo.hasOwnProperty;
function vo(e) {
  var t = this.__data__;
  return go ? t[e] !== void 0 : po.call(t, e);
}
var Co = vo, bo = sn, $o = "__lodash_hash_undefined__";
function _o(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = bo && t === void 0 ? $o : t, this;
}
var ko = _o, xo = io, Lo = so, wo = mo, Ao = Co, Mo = ko;
function H1(e) {
...
H1.prototype.clear = xo;
H1.prototype.delete = Lo;
H1.prototype.get = wo;
H1.prototype.has = Ao;
H1.prototype.set = Mo;
var To = H1;
...
var ln = Oo, No = ln, Io = Array.prototype, Eo = Io.splice;
function Bo(e) {
...
var Ho = Vo, qo = Po, Yo = Fo, Wo = Ko, Go = Qo, Xo = Ho;
function q1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
q1.prototype.clear = qo;
q1.prototype.delete = Yo;
q1.prototype.get = Wo;
q1.prototype.has = Go;
q1.prototype.set = Xo;
var cn = q1, Jo = E1, e2 = i1, t2 = Jo(e2, "Map"), Un = t2, lr = To, n2 = cn, r2 = Un;
function o2() {
...
var U2 = F2, cr = an, z2 = U2, K2 = Z1, R2 = Fn, j2 = 1 / 0, ur = cr ? cr.prototype : void 0, dr = ur ? ur.toString : void 0;
function s9(e) {
  if (typeof e == "string")
    return e;
  if (K2(e))
...
var H2 = V2, q2 = Z1, Y2 = to, W2 = B2, G2 = H2;
function X2(e, t) {
...
var Qi = ji, Zi = gt, Vi = V1, Hi = "[object Arguments]";
function qi(e) {
  return Vi(e) && Zi(e) == Hi;
}
...
Jt.exports;
(function(e, t) {
  var r = i1, n = n3, s = t && !t.nodeType && t, l = s && !0 && e && !e.nodeType && e, h = l && l.exports === s, d = h ? r.Buffer : void 0, v = d ? d.isBuffer : void 0, x = v || n;
  e.exports = x;
})(Jt, Jt.exports);
...
var Rn = en.exports, I3 = O3, E3 = Kn, mr = Rn, gr = mr && mr.isTypedArray, B3 = gr ? E3(gr) : I3, F3 = B3, U3 = Qi, z3 = e3, K3 = Z1, R3 = u9, j3 = l9, Q3 = F3, Z3 = Object.prototype, V3 = Z3.hasOwnProperty;
function H3(e, t) {
  var r = K3(e), n = !r && z3(e), s = !r && !n && R3(e), l = !r && !n && !s && Q3(e), h = r || n || s || l, d = h ? U3(e.length, String) : [], v = d.length;
  for (var x in e)
...
var f9 = W3, G3 = f9, X3 = G3(Object.keys, Object), J3 = X3, ea = jn, ta = J3, na = Object.prototype, ra = na.hasOwnProperty;
function oa(e) {
  if (!ea(e))
    return ta(e);
  var t = [];
...
var va = pa, Ca = Q1, ba = jn, $a = va, _a = Object.prototype, ka = _a.hasOwnProperty;
function xa(e) {
  if (!Ca(e))
    return $a(e);
  var t = ba(e), r = [];
...
var g9 = Ua, za = Fa, Ka = g9, Ra = Object.prototype, ja = Ra.propertyIsEnumerable, yr = Object.getOwnPropertySymbols, Qa = yr ? function(e) {
...
var b8 = C8, $8 = E1, _8 = i1, k8 = $8(_8, "DataView"), x8 = k8, L8 = E1, w8 = i1, A8 = L8(w8, "Promise"), M8 = A8, T8 = E1, S8 = i1, P8 = T8(S8, "Set"), D8 = P8, O8 = E1, N8 = i1, I8 = O8(N8, "WeakMap"), E8 = I8, Mn = x8, Tn = Un, Sn = M8, Pn = D8, Dn = E8, b9 = gt, G1 = n9, pr = "[object Map]", B8 = "[object Object]", vr = "[object Promise]", Cr = "[object Set]", br = "[object WeakMap]", $r = "[object DataView]", F8 = G1(Mn), U8 = G1(Tn), z8 = G1(Sn), K8 = G1(Pn), R8 = G1(Dn), P1 = b9;
...
var Hn = P1, j8 = Object.prototype, Q8 = j8.hasOwnProperty;
function Z8(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && Q8.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
var V8 = Z8, H8 = i1, q8 = H8.Uint8Array, Y8 = q8, _r = Y8;
function W8(e) {
...
}(), Es = Is, Bs = Es, Fs = p9, Us = jn;
function zs(e) {
  return typeof e.constructor == "function" && !Us(e) ? Bs(Fs(e)) : {};
}
var Ks = zs, Rs = Hn, js = V1, Qs = "[object Map]";
function Zs(e) {
  return js(e) && Rs(e) == Qs;
}
var Vs = Zs, Hs = Vs, qs = Kn, Ar = Rn, Mr = Ar && Ar.isMap, Ys = Mr ? qs(Mr) : Hs, Ws = Ys, Gs = Hn, Xs = V1, Js = "[object Set]";
function e7(e) {
  return Xs(e) && Gs(e) == Js;
}
var t7 = e7, n7 = t7, r7 = Kn, Tr = Rn, Sr = Tr && Tr.isSet, o7 = Sr ? r7(Sr) : n7, i7 = o7, a7 = Bi, s7 = Ui, l7 = Bn, c7 = ya, u7 = Oa, d7 = Na, h7 = Ea, f7 = qa, m7 = s8, g7 = g8, y7 = b8, p7 = Hn, v7 = V8, C7 = Os, b7 = Ks, $7 = Z1, _7 = u9, k7 = Ws, x7 = Q1, L7 = i7, w7 = Qn, A7 = Zn, M7 = 1, T7 = 2, S7 = 4, $9 = "[object Arguments]", P7 = "[object Array]", D7 = "[object Boolean]", O7 = "[object Date]", N7 = "[object Error]", _9 = "[object Function]", I7 = "[object GeneratorFunction]", E7 = "[object Map]", B7 = "[object Number]", k9 = "[object Object]", F7 = "[object RegExp]", U7 = "[object Set]", z7 = "[object String]", K7 = "[object Symbol]", R7 = "[object WeakMap]", j7 = "[object ArrayBuffer]", Q7 = "[object DataView]", Z7 = "[object Float32Array]", V7 = "[object Float64Array]", H7 = "[object Int8Array]", q7 = "[object Int16Array]", Y7 = "[object Int32Array]", W7 = "[object Uint8Array]", G7 = "[object Uint8ClampedArray]", X7 = "[object Uint16Array]", J7 = "[object Uint32Array]", ye = {};
ye[$9] = ye[P7] = ye[j7] = ye[Q7] = ye[D7] = ye[O7] = ye[Z7] = ye[V7] = ye[H7] = ye[q7] = ye[Y7] = ye[E7] = ye[B7] = ye[k9] = ye[F7] = ye[U7] = ye[z7] = ye[K7] = ye[W7] = ye[G7] = ye[X7] = ye[J7] = !0;
ye[N7] = ye[_9] = ye[R7] = !1;
function Ht(e, t, r, n, s, l) {
  ...
  var q = x ? v ? y7 : g7 : v ? A7 : w7, N = p ? void 0 : q(e);
...
const _l = /* @__PURE__ */ b('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), kl = /* @__PURE__ */ b('<div class="drop-down-container"><ul></ul></div>'), xl = /* @__PURE__ */ b('<div><input type="text"></div>'), Ll = /* @__PURE__ */ b("<li></li>"), L9 = (e) => {
  ...
  const d = j(() => {
    ...
    return p ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((D) => D.toLowerCase().includes(p)) : e.dataSource.filter((D) => {
      ...
      return M.includes(p) || q.includes(p);
    }) : e.dataSource;
  }), v = () => {
    const p = !t();
  ...
  return (() => {
    ...
    p.addEventListener("blur", x), p.$$click = (q) => {
      q.stopPropagation(), v();
    };
    const M = h;
    return typeof M == "function" ? _1(M, p) : h = p, C(D, () => e.value), C(p, (() => {
      ...
      return () => q() && (() => {
        ...
        return N.$$mousedown = (I) => I.preventDefault(), C(N, (() => {
          ...
          return () => I() && (() => {
            const re = xl.cloneNode(!0), R = re.firstChild;
      ...
      return q._v$ = I1(p, N, q._v$), F !== q._v$2 && ne(p, q._v$2 = F), q;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), p;
...
const Pl = "指标", Dl = "更多", Ol = "主图指标", Nl = "副图指标", Il = "设置", El = "时区", Bl = "截屏", Fl = "全屏", Ul = "退出全屏", zl = "保存", Kl = "确定", Rl = "取消", jl = "MA(移动平均线)", Ql = "EMA(指数平滑移动平均线)", Zl = "SMA", Vl = "BOLL(布林线)", Hl = "BBI(多空指数)", ql = "SAR(停损点指向指标)", Yl = "VOL(成交量)", Wl = "MACD(指数平滑异同移动平均线)", Gl = "KDJ(随机指标)", Xl = "RSI(相对强弱指标)", Jl = "BIAS(乖离率)", e4 = "BRAR(情绪指标)", t4 = "CCI(顺势指标)", n4 = "DMI(动向指标)", r4 = "CR(能量指标)", o4 = "PSY(心理线)", i4 = "DMA(平行线差指标)", a4 = "TRIX(三重指数平滑平均线)", s4 = "OBV(能量潮指标)", l4 = "VR(成交量变异率)", c4 = "WR(威廉指标)", u4 = "MTM(动量指标)", d4 = "EMV(简易波动指标)", h4 = "ROC(变动率指标)", f4 = "PVT(价量趋势指标)", m4 = "AO(动量震荡指标)", g4 = "世界统一时间", y4 = "(UTC-10) 檀香山", p4 = "(UTC-8) 朱诺", v4 = "(UTC-7) 洛杉矶", C4 = "(UTC-5) 芝加哥", b4 = "(UTC-4) 多伦多", $4 = "(UTC-3) 圣保罗", _4 = "(UTC+1) 伦敦", k4 = "(UTC+2) 柏林", x4 = "(UTC+3) 巴林", L4 = "(UTC+4) 迪拜", w4 = "(UTC+5) 阿什哈巴德", A4 = "(UTC+6) 阿拉木图", M4 = "(UTC+7) 曼谷", T4 = "(UTC+8) 上海", S4 = "(UTC+9) 东京", P4 = "(UTC+10) 悉尼", D4 = "(UTC+12) 诺福克岛", O4 = "水平直线", N4 = "水平射线", I4 = "水平线段", E4 = "垂直直线", B4 = "垂直射线", F4 = "垂直线段", U4 = "直线", z4 = "射线", K4 = "线段", R4 = "箭头", j4 = "价格线", Q4 = "价格通道线", Z4 = "平行直线", V4 = "斐波那契回调直线", H4 = "斐波那契回调线段", q4 = "斐波那契圆环", Y4 = "斐波那契螺旋", W4 = "斐波那契速度阻力扇", G4 = "斐波那契趋势扩展", X4 = "江恩箱", J4 = "矩形", ec = "平行四边形", tc = "圆", nc = "三角形", rc = "三浪", oc = "五浪", ic = "八浪", ac = "任意浪", sc = "ABCD形态", lc = "XABCD形态", cc = "弱磁模式", uc = "强磁模式", dc = "商品搜索", hc = "商品代码", fc = "参数1", mc = "参数2", gc = "参数3", yc = "参数4", pc = "参数5", vc = "周期", Cc = "标准差", bc = "蜡烛图类型", $c = "全实心", _c = "全空心", kc = "涨空心", xc = "跌空心", Lc = "OHLC", wc = "面积图", Ac = "最新价显示", Mc = "最高价显示", Tc = "最低价显示", Sc = "指标最新值显示", Pc = "价格轴类型", Dc = "线性轴", Oc = "百分比轴", Nc = "对数轴", Ic = "倒置坐标", Ec = "网格线显示", Bc = "恢复默认", Fc = {
  ...
  horizontal_ray_line: Ru,
  horizontal_segment: ju,
...
const c = (e, t) => {
  ...
  let t, r, n;
  const [s, l] = T(window.innerWidth < 768), [h, d] = T(localStorage.getItem("klinechart_secondary_period") || ""), [v, x] = T(!1), [p, L] = T(!1), [D, M] = T(!1), [q, N] = T(!1), [F, I] = T(!1), [re, R] = T({
    top: 0,
    left: 0,
    minWidth: 220
  }), Y = () => {
  ...
  return Ke(() => {
    ...
    return O.style.setProperty("position", "relative"), O.style.setProperty("width", "100%"), O.style.setProperty("display", "flex"), O.style.setProperty("align-items", "center"), C(O, w(J, {
      ...
      get children() {
        const _ = nh.cloneNode(!0), le = _.firstChild, Pe = le.firstChild, a1 = Pe.nextSibling;
        return _1((ge) => {
          r = ge;
            ...
            return w(N5, {
              ...
              get children() {
                ...
                return ge.$$mousedown = ($) => $.stopPropagation(), _1(($) => {
                  ...
                  var Dt;
                  const S = `${re().top}px`, De = `${re().left}px`, Be = `${re().minWidth}px`, t1 = `klinecharts-pro-order-tools-group${p() ? " klinecharts-pro-order-tools-group-open" : ""}`, u1 = `klinecharts-pro-order-tools-group${D() ? " klinecharts-pro-order-tools-group-open" : ""}`, Tt = `klinecharts-pro-order-tools-switch${((Dt = e.orderToolsState) == null ? void 0 : Dt.openOrdersExtendedPriceLine) ?? !0 ? " klinecharts-pro-order-tools-switch-on" : ""}`, St = `klinecharts-pro-order-tools-display-arrow${q() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, Pt = `klinecharts-pro-order-tools-group${F() ? " klinecharts-pro-order-tools-group-open" : ""}`;
          ...
          const g1 = s() ? "0 8px" : "0 10px", s1 = v() ? "rotate(180deg)" : "rotate(0deg)";
...
const qe = (e) => Bf[e.name](e.class), Qf = /* @__PURE__ */ b('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Zf = /* @__PURE__ */ b('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Or = /* @__PURE__ */ b('<li><span style="padding-left:8px"></span></li>'), Nr = "drawing_tools", Vf = (e) => {
  const [t, r] = T("horizontalStraightLine"), [n, s] = T("priceChannelLine"), [l, h] = T("circle"), [d, v] = T("fibonacciLine"), [x, p] = T("xabcd"), [L, D] = T("weak_magnet"), [M, q] = T("normal"), [N, F] = T(!1), [I, re] = T(!0), [R, Y] = T(""), V = j(() => [{
    key: "singleLine",
    icon: t(),
    list: Ff(e.locale),
    setter: r
...
const Yf = (e) => {
  const [t, r] = T(e.timezone), n = j(() => qf(e.locale));
  return w(x1, {
    get title() {
    ...
    get children() {
      ...
      return C(x, w(Ln, {
        ...
        children: (p) => {
          ...
          return (() => {
            const M = Gf.cloneNode(!0), q = M.firstChild, N = q.nextSibling;
            return C(q, () => p.text), C(N, L), B(() => M.classList.toggle("mobile-item", !!l())), M;
          })();
        }
...
const dm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-picker"></div>'), hm = /* @__PURE__ */ b('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), fm = /* @__PURE__ */ b("<span></span>"), mm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), gm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-grid"></div>'), ym = /* @__PURE__ */ b('<span class="weekday"></span>'), D1 = /* @__PURE__ */ b('<button type="button"></button>'), pm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-month-grid"></div>'), vm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), Cm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), bm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-content"></div>'), $m = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-tabs"></div>'), _m = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), km = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), xm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), Lm = [{
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], wm = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], Ur = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], R1 = (e) => String(e).padStart(2, "0"), zr = (e, t, r) => Math.min(r, new Date(e, t + 1, 0).getDate()), $n = (e) => {
  const t = new Date(e);
  return {
    year: t.getFullYear(),
    month: t.getMonth(),
  ...
  const [t, r] = T(!0), [n, s] = T("date"), [l, h] = T(e.value.year), [d, v] = T(e.value.month), x = j(() => Am(l(), d())), p = j(() => Math.floor(l() / 10) * 10), L = j(() => Array.from({
    length: 12
  }, (U, Q) => p() - 1 + Q)), D = j(() => e.value.hour % 12 || 12), M = j(() => e.value.hour >= 12 ? "PM" : "AM"), q = Array.from({
    length: 12
        ...
        return se.$$click = () => {
          ...
          return () => ke() && (() => {
            ...
            return C(pe, () => L().map((oe) => (() => {
              ...
              return ce.$$click = () => Y(oe), C(ce, oe), B(() => ne(ce, `${oe < p() || oe > p() + 9 ? "muted" : ""} ${oe === e.value.year ? "selected" : ""}`)), ce;
            })())), pe;
          })();
        })(), null), C(H, (() => {
          const ke = j(() => n() === "date");
  ...
  return w(x1, {
    ...
    get children() {
      ...
      return C(N, (() => {
        ...
        return () => F() && (() => {
          const I = _m.cloneNode(!0), re = I.firstChild, R = re.firstChild, Y = R.nextSibling, V = Y.nextSibling;
          return R.$$click = () => p("from"), C(R, () => On(l())), V.$$click = () => p("to"), C(V, () => On(d())), C(I, (() => {
            const me = j(() => x() === "from");
            return () => me() ? w(Qt, {
              label: "Start",
              get value() {
        ...
        return () => F() && (() => {
          const I = km.cloneNode(!0), re = I.firstChild, R = re.firstChild, Y = R.nextSibling, V = re.nextSibling, me = V.firstChild, U = me.nextSibling, Q = V.nextSibling, H = Q.firstChild, te = H.nextSibling, se = Q.nextSibling, Le = se.firstChild, $e = Le.nextSibling;
          return Y.$$click = () => M({
            enabled: !L().enabled
            ...
            return Ue !== ie._v$3 && ne(Y, ie._v$3 = Ue), ke !== ie._v$4 && ne(V, ie._v$4 = ke), pe !== ie._v$5 && (U.disabled = ie._v$5 = pe), oe !== ie._v$6 && ne(Q, ie._v$6 = oe), ce !== ie._v$7 && ne(te, ie._v$7 = ce), Z !== ie._v$8 && (te.disabled = ie._v$8 = Z), O !== ie._v$9 && ne(se, ie._v$9 = O), E !== ie._v$10 && ne($e, ie._v$10 = E), be !== ie._v$11 && ($e.disabled = ie._v$11 = be), ie;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
const Vm = (e) => {
  var b0, $0, _0, k0, x0, L0, w0, A0, M0, T0, S0, P0, D0, O0, N0, I0, E0, B0, F0, U0, z0, K0, R0, j0, Q0, Z0, V0, H0;
  let t, r, n = null, s;
  const [l, h] = T(!1), [d, v] = T(e.theme), [x, p] = T(e.styles), [L, D] = T(e.locale), [M, q] = T(e.symbol), [N, F] = T(e.period), I = () => {
    var o, i, a, u;
    return {
    ...
    to: Date.now()
  }), [we, de] = T(Qm() ?? M9()), [Ae, _] = T(e.drawingBarVisible), [le, Pe] = T(!1), [a1, ge] = T(!1), [g1, s1] = T(!1), X1 = ((b0 = e.orderTools) == null ? void 0 : b0.quickOrder) ?? !0, [Ie, yt] = T({
    quickOrder: X1,
  ...
  Ke(() => {
    ...
    typeof o == "boolean" && o !== Wn && (Wn = o, K.quickOrder = o, typeof i != "boolean" && (K.quickOrderFloatingWindow = o), typeof a != "boolean" && (K.quickOrderPlusButton = o)), typeof i == "boolean" && i !== Gn && (Gn = i, K.quickOrderFloatingWindow = i), typeof a == "boolean" && a !== Xn && (Xn = a, K.quickOrderPlusButton = a), typeof u == "boolean" && u !== Jn && (Jn = u, K.openOrders = u), typeof m == "boolean" && m !== e0 && (e0 = m, K.openOrdersExtendedPriceLine = m), g !== void 0 && g !== t0 && (t0 = g, K.openOrdersDisplay = g), typeof f == "boolean" && f !== n0 && (n0 = f, K.positions = f), typeof y == "boolean" && y !== r0 && (r0 = y, K.breakevenPrice = y), typeof k == "boolean" && k !== o0 && (o0 = k, K.liquidationPrice = k), typeof A == "boolean" && A !== i0 && (i0 = A, K.priceLine = A, typeof P != "boolean" && (K.marketPriceLine = A), typeof W != "boolean" && (K.countDown = A), typeof X != "boolean" && (K.bidAskPrice = A)), typeof P == "boolean" && P !== a0 && (a0 = P, K.marketPriceLine = P), typeof W == "boolean" && W !== s0 && (s0 = W, K.countDown = W), typeof X == "boolean" && X !== l0 && (l0 = X, K.bidAskPrice = X), typeof G == "boolean" && G !== c0 && (c0 = G, K.orderHistory = G), Object.keys(K).length > 0 && at(K);
  }), Ke(() => {
  ...
  const T9 = () => {
    ...
    const m = (P = n.convertFromPixel) == null ? void 0 : P.call(n, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), g = Number((W = m == null ? void 0 : m[0]) == null ? void 0 : W.dataIndex), f = Math.max(0, Math.min(u.length - 1, Number.isFinite(g) ? Math.round(g) : -1)), y = O9(i);
    if (y) {
    ...
    const a = R9(i), u = n.getSize("candle_pane", h1.Main), m = Math.max(1, (t == null ? void 0 : t.clientHeight) ?? (u == null ? void 0 : u.height) ?? 0);
    if (a === null) {
      rt(null);
      return;
    }
  ...
  return Ke((o) => {
    ...
    return N1(() => {
      ...
      try {
        const g = o1(we), f = g.enabled && (!o || o.symbol.ticker === i.ticker || g.acrossTokens), y = f ? I9(g, a) : null, [k, A] = y ? [y.from, y.to] : mn(a, (/* @__PURE__ */ new Date()).getTime(), 500), P = await e.datafeed.getHistoryKLineData(i, a, k, A);
        if (!u)
          return;
    ...
    return o.addEventListener("mouseleave", () => {
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Bm.cloneNode(!0), m = u.firstChild, g = m.nextSibling, f = g.nextSibling, y = f.firstChild, k = f.nextSibling, A = k.firstChild, P = A.firstChild, W = P.nextSibling, X = W.firstChild, G = k.nextSibling, K = G.firstChild, ee = G.nextSibling, he = ee.nextSibling, Me = he.nextSibling;
        return u.$$click = (z) => {
          z.stopPropagation();
        }, u.$$mousedown = (z) => {
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = jm.cloneNode(!0), m = u.firstChild, g = m.firstChild, f = g.firstChild, y = f.nextSibling, k = y.nextSibling, A = k.nextSibling;
        A.nextSibling;

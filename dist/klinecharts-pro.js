...
var be = null;
let x1 = null, ce = null, Te = null, a1 = null, C0 = 0;
function lt(e, t) {
...
function p5(e, t, r) {
  ...
  let d = null, u = i0, g = null, _ = !1, y = "initialValue" in l, A = typeof n == "function" && X(n);
  const w = /* @__PURE__ */ new Set(), [O, N] = (l.storage || S)(l.initialValue), [F, K] = S(void 0), [J, W] = S(void 0, {
    equals: !1
  }), [B, V] = S(y ? "ready" : "unresolved");
  if (xe.context) {
    g = `${xe.context.id}${xe.context.count++}`;
    let G;
    l.ssrLoadFrom === "initial" ? u = l.initialValue : xe.load && (G = xe.load(g)) && (u = G[0]);
  }
  function z(G, ne, ue, Se) {
    return d === G && (d = null, y = !0, (G === u || ne === u) && l.onHydrated && queueMicrotask(() => l.onHydrated(Se, {
      value: ne
    })), u = i0, Pe(ne, ue)), ne;
  }
  function Pe(G, ne) {
    y1(() => {
      ne === void 0 && N(() => G), V(ne !== void 0 ? "errored" : "ready"), K(ne);
  ...
  function Oe() {
    ...
    return ce && !ce.user && G && y9(() => {
      J(), d && (G.resolved || w.has(G) || (G.increment(), w.add(G)));
    }), ne;
  }
  function ge(G = !0) {
    if (G !== !1 && _)
    ...
    return typeof ue != "object" || !(ue && "then" in ue) ? (z(d, ue, void 0, ne), ue) : (d = ue, _ = !0, queueMicrotask(() => _ = !1), y1(() => {
      V(y ? "refreshing" : "pending"), W();
    }, !1), ue.then((Se) => z(ue, Se, void 0, ne), (Se) => z(ue, void 0, lr(Se), ne)));
  }
...
function or(e, t, r) {
  ...
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && y1(() => {
    for (let o = 0; o < e.observers.length; o += 1) {
      ...
      d && x1.disposed.has(l), (d && !l.tState || !d && !l.state) && (l.pure ? Te.push(l) : a1.push(l), l.observers && sr(l)), d || (l.state = l1);
    }
    if (Te.length > 1e6)
      throw Te = [], new Error();
  }, !1)), t;
...
function y1(e, t) {
  ...
  try {
    ...
    r || (a1 = null), Te = null, cr(n);
  }
}
function b5(e) {
  if (Te && (ar(Te), Te = null), e)
    return;
  const t = a1;
...
function sr(e) {
  ...
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = It, n.pure ? Te.push(n) : a1.push(n), n.observers && sr(n));
  }
}
function Qt(e) {
  let t;
...
function k5(e, t, r = {}) {
  ...
  return A1(() => g9(l)), () => {
    let g = e() || [], _, y;
    return g[g5], s1(() => {
      let w = g.length, O, N, F, K, J, W, B, V, z;
      if (w === 0)
        ...
        for (F = new Array(w), K = new Array(w), u && (J = new Array(w)), W = 0, B = Math.min(d, w); W < B && n[W] === g[W]; W++)
          ;
        for (B = d - 1, V = w - 1; B >= W && V >= W && n[B] === g[V]; B--, V--)
          F[V] = o[B], K[V] = l[B], u && (J[V] = u[B]);
        for (O = /* @__PURE__ */ new Map(), N = new Array(V + 1), y = V; y >= W; y--)
          z = g[y], _ = O.get(z), N[y] = _ === void 0 ? -1 : _, O.set(z, y);
        for (_ = W; _ <= B; _++)
          z = n[_], y = O.get(z), y !== void 0 && y !== -1 ? (F[y] = o[_], K[y] = l[_], u && (J[y] = u[_]), y = N[y], O.set(z, y)) : l[_]();
        for (y = W; y < w; y++)
          y in F ? (o[y] = F[y], l[y] = K[y], u && (u[y] = J[y], u[y](y))) : o[y] = lt(A);
...
function ur(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const o = e[n];
    t = t || !!o && l0 in o, e[n] = typeof o == "function" ? (t = !0, X(o)) : o;
  }
  if (t)
    return new Proxy({
      get(n) {
...
function c0(e) {
  ...
  return X(k5(() => e.each, e.children, t || void 0));
}
function R(e) {
  let t = !1;
...
var Z5 = Q5, v9 = Zt, R5 = K5, V5 = Z5, H5 = "[object Null]", q5 = "[object Undefined]", b9 = v9 ? v9.toStringTag : void 0;
function Y5(e) {
...
var Q6 = j6, Z6 = A6, R6 = I6, V6 = B6, H6 = K6, q6 = Q6;
function U1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
var L0 = Ft.exports, P8 = T8, O8 = k0, S9 = L0, P9 = S9 && S9.isTypedArray, D8 = P9 ? O8(P9) : P8, I8 = D8, N8 = K3, E8 = G3, B8 = N1, U8 = kr, F8 = $r, K8 = I8, z8 = Object.prototype, j8 = z8.hasOwnProperty;
function Q8(e, t) {
...
var T0 = L1, Fi = Object.prototype, Ki = Fi.hasOwnProperty;
function zi(e) {
...
var Uo = Bo, Fo = T0, Ko = E1, zo = "[object Map]";
function jo(e) {
  return Ko(e) && Fo(e) == zo;
}
...
function Ot(e, t, r, n, o, l) {
  ...
  }) : ba(e) && e.forEach(function(K, J) {
    d.set(J, Ot(K, t, r, J, e, l));
  });
  var N = _ ? g ? fa : ha : g ? La : ka, F = y ? void 0 : N(e);
  return ia(F || e, function(K, J) {
    F && (J = K, K = e[J]), oa(d, J, Ot(K, t, r, J, e, l));
  }), d;
}
...
const vs = /* @__PURE__ */ $('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), bs = /* @__PURE__ */ $('<div class="drop-down-container"><ul></ul></div>'), $s = /* @__PURE__ */ $('<div><input type="text"></div>'), _s = /* @__PURE__ */ $("<li></li>"), Ur = (e) => {
  ...
  const u = X(() => {
    ...
    return y ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((w) => w.toLowerCase().includes(y)) : e.dataSource.filter((w) => {
      var F, K;
      const O = ((F = w.text) == null ? void 0 : F.toString().toLowerCase()) || "", N = ((K = w.key) == null ? void 0 : K.toLowerCase()) || "";
  ...
  return (() => {
    ...
    return typeof O == "function" ? w1(O, y) : d = y, k(w, () => e.value), k(y, (() => {
      const N = X(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => N() && (() => {
        const F = bs.cloneNode(!0), K = F.firstChild;
        return F.$$mousedown = (J) => J.preventDefault(), k(F, (() => {
          const J = X(() => !!e.searchable);
          return () => J() && (() => {
...
const s = (e, t) => {
  ...
  const [o, l] = S(window.innerWidth < 768), [d, u] = S(localStorage.getItem("klinechart_secondary_period") || ""), [g, _] = S(!1), [y, A] = S(!1), [w, O] = S(!1), [N, F] = S(!1), [K, J] = S(!1), [W, B] = S({
    ...
    _((U) => {
      const j = !U;
      return j ? queueMicrotask(He) : g1(), j;
    });
  }, c1 = (U) => {
    if (!g())
      return;
    ...
    if (t && o()) {
      const U = t;
      ne(U.scrollLeft > 10), Se(U.scrollLeft + U.clientWidth < U.scrollWidth - 10);
    } else
      ne(!1), Se(!1);
  };
  m0(() => {
  ...
  const u1 = X(() => {
    const U = e.periods.filter((j) => {
      if (!o() || z())
        return !0;
      const we = e.period.text, De = d();
      if (j.text === we || De && j.text === De)
        return !0;
      if (!De || De === we) {
        const ae = e.periods.find((se) => se.text !== we);
        return j.text === (ae == null ? void 0 : ae.text);
      }
      return !1;
    }).slice(0, o() && !z() ? 2 : e.periods.length);
    return setTimeout(qe, 50), U;
  });
  let q = e.period.text;
  return Ne(() => {
    const U = e.period.text;
    U !== q && (o() && (u(q), localStorage.setItem("klinechart_secondary_period", q)), q = U), setTimeout(qe, 50);
  }), Ne(() => {
    z(), setTimeout(qe, 100);
  }), Ne(() => {
    ...
    const U = id.cloneNode(!0), j = U.firstChild, we = j.firstChild, De = we.firstChild, ae = we.nextSibling, se = ae.firstChild;
    return U.style.setProperty("position", "relative"), U.style.setProperty("width", "100%"), U.style.setProperty("display", "flex"), U.style.setProperty("align-items", "center"), k(U, L(R, {
      get when() {
        return X(() => !!o())() && G();
      },
      get children() {
        const v = Zu.cloneNode(!0);
      ...
      t = v;
    }, j), j.style.setProperty("width", "100%"), o1(De, "click", e.onMenuClick, !0), k(j, L(R, {
      get when() {
        return e.symbol;
      },
      get children() {
        const v = Vu.cloneNode(!0), re = v.firstChild;
        return o1(v, "click", e.onSymbolClick, !0), k(v, L(R, {
          get when() {
        ...
        }), re), k(re, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), v;
      }
    }), ae), k(j, () => u1().map((v, re) => {
      const pe = v.text === e.period.text;
      return (() => {
        const Ae = od.cloneNode(!0);
        return Ae.$$click = (te) => {
          o() && pe && !z() ? (e.onMobilePeriodClick ? e.onMobilePeriodClick(v) : e.onMenuClick(), te.stopPropagation()) : e.onPeriodChange(v);
        }, fe(Ae, `item period ${pe ? "selected" : ""}`), k(Ae, () => v.text), Ae;
      })();
    }), ae), k(j, L(R, {
      get when() {
        return X(() => !!(o() && !z()))() && u1().length > 1;
      },
      get children() {
        const v = Hu.cloneNode(!0);
        return v.$$click = (re) => {
      ...
      get children() {
        const v = Yu.cloneNode(!0), re = v.firstChild, pe = re.nextSibling;
        return o1(v, "click", e.onIndicatorClick, !0), k(pe, () => s("indicator", e.locale)), v;
      }
    }), ae), ae.style.setProperty("display", "flex"), ae.style.setProperty("gap", "4px"), ae.style.setProperty("margin-left", "auto"), ae.style.setProperty("align-items", "center"), k(ae, L(R, {
      get when() {
        return e.showOrderToolsMenu;
      },
      get children() {
        const v = Xu.cloneNode(!0), re = v.firstChild, pe = re.firstChild, Ae = pe.nextSibling;
        return w1((te) => {
          r = te;
        }, v), v.style.setProperty("display", "flex"), v.style.setProperty("align-items", "center"), re.$$click = (te) => {
          te.stopPropagation(), p1();
        }, re.style.setProperty("gap", "6px"), Ae.style.setProperty("transition", "transform 0.2s ease"), k(v, L(R, {
          get when() {
            return g();
          },
          get children() {
                ...
                return te.$$mousedown = (C) => C.stopPropagation(), w1((C) => {
                  ...
                  get children() {
                    ...
                    return k(C, () => ["left", "center", "right"].map((M) => (() => {
                      ...
                      return me.$$click = (Le) => {
                        var je;
                        Le.preventDefault(), Le.stopPropagation(), (je = e.onOrderToolsStateChange) == null || je.call(e, {
                          openOrdersDisplay: M
                        }), F(!1);
                      }, k(me, () => q9(M)), I(() => {
                        var Le;
                  ...
                  C.preventDefault(), C.stopPropagation(), J((M) => !M);
                }, P1.$$mousedown = (C) => C.stopPropagation(), P1.$$click = (C) => C.stopPropagation(), h1.addEventListener("change", (C) => {
                  var M;
                  C.stopPropagation(), J(!0), (M = e.onOrderToolsStateChange) == null || M.call(e, {
                  ...
                  var nt;
                  const M = `${W().top}px`, me = `${W().left}px`, Le = `${W().minWidth}px`, je = `klinecharts-pro-order-tools-group${y() ? " klinecharts-pro-order-tools-group-open" : ""}`, f1 = `klinecharts-pro-order-tools-group${w() ? " klinecharts-pro-order-tools-group-open" : ""}`, et = `klinecharts-pro-order-tools-switch${((nt = e.orderToolsState) == null ? void 0 : nt.openOrdersExtendedPriceLine) ?? !0 ? " klinecharts-pro-order-tools-switch-on" : ""}`, tt = `klinecharts-pro-order-tools-display-arrow${N() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, rt = `klinecharts-pro-order-tools-group${K() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return M !== C._v$ && te.style.setProperty("top", C._v$ = M), me !== C._v$2 && te.style.setProperty("left", C._v$2 = me), Le !== C._v$3 && te.style.setProperty("width", C._v$3 = Le), je !== C._v$4 && fe(e1, C._v$4 = je), f1 !== C._v$5 && fe(Ie, C._v$5 = f1), et !== C._v$6 && fe(Fe, C._v$6 = et), tt !== C._v$7 && $e(ft, "class", C._v$7 = tt), rt !== C._v$8 && fe(Y1, C._v$8 = rt), C;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var C, M, me, Le, je, f1;
                  return h1.checked = (((C = e.orderToolsState) == null ? void 0 : C.marketPriceLine) ?? ((M = e.orderToolsState) == null ? void 0 : M.priceLine) ?? !0) || (((me = e.orderToolsState) == null ? void 0 : me.countDown) ?? ((Le = e.orderToolsState) == null ? void 0 : Le.priceLine) ?? !0) || (((je = e.orderToolsState) == null ? void 0 : je.bidAskPrice) ?? ((f1 = e.orderToolsState) == null ? void 0 : f1.priceLine) ?? !0);
                }), I(() => {
                  var C, M;
          ...
          return e1 !== te._v$9 && re.style.setProperty("padding", te._v$9 = e1), _e !== te._v$10 && Ae.style.setProperty("transform", te._v$10 = _e), te;
        }, {
          _v$9: void 0,
          _v$10: void 0
        }), v;
      ...
      get children() {
        return [(() => {
          const v = Ju.cloneNode(!0);
          return o1(v, "click", e.onTimezoneClick, !0), v;
        })(), (() => {
          const v = ed.cloneNode(!0);
      ...
      const v = X(() => !!z());
      return () => v() ? sd.cloneNode(!0) : ld.cloneNode(!0);
    })()), k(ae, L(R, {
      get when() {
        return !o() && e.chartViewToggle;
      },
      get children() {
        const v = rd.cloneNode(!0);
        return o1(v, "click", e.chartViewToggle.onToggle, !0), k(v, (() => {
          const re = X(() => e.chartViewToggle.view === "chart");
          return () => re() ? cd.cloneNode(!0) : ud.cloneNode(!0);
        })()), I(() => $e(v, "title", e.chartViewToggle.view === "chart" ? "View Depth" : "View Chart")), v;
      }
    }), null), k(U, L(R, {
      get when() {
        return X(() => !!o())() && ue();
      ...
      const re = o() ? "auto" : "visible", pe = e.spread ? "" : "rotate", Ae = z() ? "0px" : "var(--klinecharts-pro-period-bar-padding-right)";
      return re !== v._v$11 && j.style.setProperty("overflow", v._v$11 = re), pe !== v._v$12 && $e(De, "class", v._v$12 = pe), Ae !== v._v$13 && ae.style.setProperty("padding-right", v._v$13 = Ae), v;
    }, {
      _v$11: void 0,
      _v$12: void 0,
      _v$13: void 0
...
const Ke = (e) => Oh[e.name](e.class), Fh = /* @__PURE__ */ $('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Kh = /* @__PURE__ */ $('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Y9 = /* @__PURE__ */ $('<li><span style="padding-left:8px"></span></li>'), G9 = "drawing_tools", zh = (e) => {
  const [t, r] = S("horizontalStraightLine"), [n, o] = S("priceChannelLine"), [l, d] = S("circle"), [u, g] = S("fibonacciLine"), [_, y] = S("xabcd"), [A, w] = S("weak_magnet"), [O, N] = S("normal"), [F, K] = S(!1), [J, W] = S(!0), [B, V] = S(""), z = X(() => [{
    key: "singleLine",
    icon: t(),
    list: Dh(e.locale),
    setter: r
  ...
  return (() => {
    const Oe = Fh.cloneNode(!0), ge = Oe.firstChild, G = ge.nextSibling, ne = G.firstChild, ue = ne.nextSibling, Se = ue.firstChild, He = G.nextSibling, g1 = He.firstChild, p1 = He.nextSibling, c1 = p1.firstChild, Je = p1.nextSibling, qe = Je.nextSibling, u1 = qe.firstChild;
    return k(Oe, () => z().map((q) => (() => {
      const U = Kh.cloneNode(!0), j = U.firstChild, we = j.nextSibling, De = we.firstChild;
        ...
        return () => ae() && L(zt, {
          ...
          get children() {
            return q.list.map((se) => (() => {
              const v = Y9.cloneNode(!0), re = v.firstChild;
              return v.$$click = () => {
      ...
      })(), null), I(() => $e(De, "class", q.key === B() ? "rotate" : "")), U;
      ...
      const q = X(() => A() === "weak_magnet");
      return () => q() ? (() => {
        const U = X(() => O() === "weak_magnet");
        return () => U() ? L(Ke, {
          name: "weak_magnet",
          class: "selected"
        }) : L(Ke, {
      ...
      return () => q() && L(zt, {
        ...
        get children() {
          return Pe().map((U) => (() => {
            const j = Y9.cloneNode(!0), we = j.firstChild;
            return j.$$click = () => {
              w(U.key), N(U.key), e.onModeChange(U.key), V("");
            }, k(j, L(Ke, {
              get name() {
                return U.key;
              }
...
const Zh = (e) => {
  const [t, r] = S(e.timezone), n = X(() => Qh(e.locale));
  return L(S1, {
    get title() {
...
const _f = (e) => {
  var E0, B0, U0, F0, K0, z0, j0, Q0, Z0, R0, V0, H0, q0, Y0, G0, W0, X0, J0, e9, t9, r9, n9, i9, o9, a9, s9, l9, c9;
  let t, r = null, n;
  const [o, l] = S(!1), [d, u] = S(e.theme), [g, _] = S(e.styles), [y, A] = S(e.locale), [w, O] = S(e.symbol), [N, F] = S(e.period), K = () => {
    var i, a, c, h;
    return {
  ...
  }, [J, W] = S(!1), [B, V] = S([...e.mainIndicators]), [z, Pe] = S({}), [Oe, ge] = S(!1), [G, ne] = S({
    key: e.timezone,
    text: J9(e.timezone, e.locale)
  }), [ue, Se] = S(!1), [He, g1] = S(), [p1, c1] = S(""), [Je, qe] = S(e.drawingBarVisible), [u1, q] = S(!1), [U, j] = S(!1), [we, De] = S(!1), ae = ((E0 = e.orderTools) == null ? void 0 : E0.quickOrder) ?? !0, [se, v] = S({
    quickOrder: ae,
    quickOrderFloatingWindow: ((B0 = e.orderTools) == null ? void 0 : B0.quickOrderFloatingWindow) ?? ae,
    quickOrderPlusButton: ((U0 = e.orderTools) == null ? void 0 : U0.quickOrderPlusButton) ?? ae,
  ...
  const Wt = (i, a, c) => {
    ...
    try {
      ...
      const b = ht(p);
      if (b) {
        const f = Ce.get(i), m = ((c = f == null ? void 0 : f.points) == null ? void 0 : c.length) || 0, x = ((h = b.points) == null ? void 0 : h.length) || 0;
        Ce.set(i, b);
        const T = $1(b.type);
        if (x >= T) {
          const P = ke.get(i);
    ...
    document.addEventListener("mouseup", h), document.addEventListener("touchend", h), setTimeout(() => {
      ...
      if (p && !p.complete) {
        ...
        const f = Ce.get(i);
        if (f) {
          const m = $1(f.type), x = ((b = f.points) == null ? void 0 : b.length) || 0;
      ...
      try {
        const c = `kline_drawings_${i}`, p = {
          drawings: a.map((b) => {
            ...
            const m = $1(b.type), x = ((T = b.points) == null ? void 0 : T.length) || 0;
            return x < m && console.warn(`âš ï¸ Saving ${b.type} with only ${x} point(s), needs ${m}`), f;
          }),
          timestamp: Date.now()
        };
      ...
      try {
        ...
        if (c) {
          ...
          return Array.isArray(h.drawings) && h.drawings.forEach((b) => {
            var x;
            const f = $1(b.type);
            (((x = b.points) == null ? void 0 : x.length) || 0) >= f && p.push(b);
          }), p;
        }
      } catch (a) {
  ...
  const V1 = () => {
    ...
    }), Ce.clear(), ke.clear(), Be(null), Ie(null), Ye.loadDrawings(i).forEach((c) => {
      var h;
      try {
        const p = h1({
          name: c.type,
    ...
    v(a), (h = (c = e.orderTools) == null ? void 0 : c.onChange) == null || h.call(c, a);
  }, _1 = (i) => {
    var c;
    ...
    const p = (Ve = r.convertToPixel) == null ? void 0 : Ve.call(r, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), b = Number((it = p == null ? void 0 : p[0]) == null ? void 0 : it.y), f = (u9 = r.getSize) == null ? void 0 : u9.call(r, "candle_pane"), m = (f == null ? void 0 : f.height) ?? t.clientHeight;
    if (!Number.isFinite(b) || b < 0 || b > m) {
      v1(null);
      return;
    }
    ...
    const a = (b = r == null ? void 0 : r.getSize) == null ? void 0 : b.call(r, "candle_pane", At.YAxis);
    ...
    if (!(a != null && a.id) || a.name !== "horizontalStraightLine")
      return !1;
    const c = G1(i), h = Number((x = (m = a.styles) == null ? void 0 : m.line) == null ? void 0 : x.size) || 3, p = ((P = (T = a.styles) == null ? void 0 : T.line) == null ? void 0 : P.style) ?? i1.Solid, b = Array.isArray((Y = (Q = a.styles) == null ? void 0 : Q.line) == null ? void 0 : Y.dashedValue) ? a.styles.line.dashedValue : [], f = ((E = (H = a.styles) == null ? void 0 : H.line) == null ? void 0 : E.color) ?? "#2f6df6";
    return Be({
      id: a.id,
      x: c.x,
      y: c.y,
    ...
    return {
      ...
      onPressedMoveEnd: (Z) => (W1(Z), (b == null ? void 0 : b(Z)) ?? !1),
    ...
    if (!c)
      return;
    const h = i.clientX, p = i.clientY, b = a.x, f = a.y, m = (Q) => {
      Q.preventDefault();
      const Y = b + Q.clientX - h, H = f + Q.clientY - p;
      Be({
        ...a,
  ...
  Ne(() => {
    ...
    getSettings: () => {
      var c, h, p, b, f, m, x, T, P, Q, Y, H, E, Z, de, Me;
      if (!r)
        return {};
    ...
    setSettings: (i) => {
      var c, h, p, b, f, m, x, T, P, Q, Y, H, E, Z;
      if (!r)
        return;
      const a = {};
    ...
    saveDrawings: (i) => {
      ...
      a.forEach((c, h) => {
        var f;
        const p = $1(c.type), b = ((f = c.points) == null ? void 0 : f.length) || 0;
      ...
      Ye.loadDrawings(i).forEach((c, h) => {
        ...
        try {
          const b = {
            ...
            lock: c.lock ?? !1,
            mode: c.mode ?? n0.Normal
          }, f = r == null ? void 0 : r.createOverlay(b), m = typeof f == "string" ? f : null;
          m && (Ce.set(m, {
            ...c,
            id: m
          }), ke.set(m, {
  ...
  const r0 = (i, a, c) => {
    ...
    switch (i.timespan) {
      ...
      case "month": {
        const b = new Date(h), f = b.getFullYear(), m = b.getMonth() + 1;
  ...
  m0(() => {
    ...
    r && b && (r.createOverlay = function(...f) {
      const m = h1(f[0]), x = b.apply(this, [m, ...f.slice(1)]), T = typeof x == "string" ? x : null;
  ...
  const zr = (i) => {
    const a = new Date(i), c = a.getFullYear(), h = `${a.getMonth() + 1}`.padStart(2, "0"), p = `${a.getDate()}`.padStart(2, "0"), b = `${a.getHours()}`.padStart(2, "0"), f = `${a.getMinutes()}`.padStart(2, "0"), m = `${c}-${h}-${p}`;
    switch (N().timespan) {
      case "minute":
      case "hour":
        return `${m} ${b}:${f}`;
    ...
    const {
      current: c
    } = i, h = a.tooltip.text.color, p = c.close > c.open ? a.bar.upColor : c.close < c.open ? a.bar.downColor : a.bar.noChangeColor, b = Math.min(Math.max(((x = w()) == null ? void 0 : x.pricePrecision) ?? 2, 0), 8), f = Math.min(Math.max(((T = w()) == null ? void 0 : T.volumePrecision) ?? 0, 0), 8), m = (P) => ({
      text: ie.formatPrecision(P, b),
      color: p
    });
    return [{
      title: "time",
  ...
  return Ne((i) => {
    ...
    return A1(() => {
      ...
      try {
        const [b, f] = r0(c, (/* @__PURE__ */ new Date()).getTime(), 500), m = await e.datafeed.getHistoryKLineData(a, c, b, f);
        if (!h)
          return;
    ...
    onMenuClick: async () => {
      try {
        await C5(() => qe(!Je())), r == null || r.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    return i.addEventListener("mouseleave", () => {
      ...
      keyed: !0,
      children: (c) => (() => {
        const h = cf.cloneNode(!0), p = h.firstChild, b = p.nextSibling;
        return h.style.setProperty("right", "0px"), k(p, () => c.priceText), k(b, () => c.text), I((f) => {
          const m = `${c.top}px`, x = `${c.width}px`, T = c.color, P = `${c.borderRadius}px`, Q = c.textFamily, Y = c.textWeight, H = `${c.paddingLeft}px`, E = `${c.paddingRight}px`, Z = `${c.paddingTop}px`, de = `${c.paddingBottom}px`, Me = `${c.textSize}px`, D = `${Math.max(10, c.textSize - 1)}px`;
          return m !== f._v$ && h.style.setProperty("top", f._v$ = m), x !== f._v$2 && h.style.setProperty("width", f._v$2 = x), T !== f._v$3 && h.style.setProperty("background", f._v$3 = T), P !== f._v$4 && h.style.setProperty("border-radius", f._v$4 = P), Q !== f._v$5 && h.style.setProperty("font-family", f._v$5 = Q), Y !== f._v$6 && h.style.setProperty("font-weight", f._v$6 = Y), H !== f._v$7 && h.style.setProperty("padding-left", f._v$7 = H), E !== f._v$8 && h.style.setProperty("padding-right", f._v$8 = E), Z !== f._v$9 && h.style.setProperty("padding-top", f._v$9 = Z), de !== f._v$10 && h.style.setProperty("padding-bottom", f._v$10 = de), Me !== f._v$11 && p.style.setProperty("font-size", f._v$11 = Me), D !== f._v$12 && b.style.setProperty("font-size", f._v$12 = D), f;
        }, {
          _v$: void 0,
          _v$2: void 0,
          _v$3: void 0,
      ...
      keyed: !0,
      children: (c) => (() => {
        const h = ff.cloneNode(!0), p = h.firstChild, b = p.nextSibling, f = b.nextSibling, m = f.firstChild, x = f.nextSibling, T = x.firstChild, P = T.firstChild, Q = P.nextSibling, Y = Q.firstChild, H = x.nextSibling, E = H.firstChild, Z = H.nextSibling, de = Z.nextSibling, Me = de.nextSibling;
        return h.$$click = (D) => {
          D.stopPropagation();
        }, h.$$mousedown = (D) => {
          D.preventDefault(), D.stopPropagation();
        }, p.$$mousedown = t0, b.$$click = bt, m.$$click = () => Ie(Ue() === "color" ? null : "color"), k(f, L(R, {
          get when() {
            return Ue() === "color";
          },
          get children() {
        ...
        }), null), T.$$click = () => Ie(Ue() === "width" ? null : "width"), k(Q, () => c.lineSize, Y), k(x, L(R, {
          get when() {
            return Ue() === "width";
          },
          get children() {
        ...
        }), null), E.$$click = () => Ie(Ue() === "style" ? null : "style"), k(H, L(R, {
          get when() {
            return Ue() === "style";
          },
          get children() {
          ...
          return he !== D._v$16 && h.style.setProperty("left", D._v$16 = he), ee !== D._v$17 && h.style.setProperty("top", D._v$17 = ee), ye !== D._v$18 && fe(m, D._v$18 = ye), ve !== D._v$19 && fe(T, D._v$19 = ve), Qe !== D._v$20 && fe(E, D._v$20 = Qe), Ze !== D._v$21 && fe(Z, D._v$21 = Ze), We !== D._v$22 && $e(Z, "title", D._v$22 = We), Re !== D._v$23 && fe(de, D._v$23 = Re), Ve !== D._v$24 && $e(de, "title", D._v$24 = Ve), D;
        }, {
          _v$16: void 0,
          _v$17: void 0,
          _v$18: void 0,
      ...
      children: (c) => (() => {
        ...
        return h.addEventListener("mouseleave", () => {
          ...
          b.stopPropagation(), r1();
        }, h.addEventListener("mouseenter", () => {
          _e(!0), r1();
        }), p.$$click = (b) => {
          b.stopPropagation(), _e(!0), m1({
            y: c.y,
            price: c.price,
            yAxisWidth: ut()
          }), te(!0), r1();
        }, p.$$mousedown = (b) => {
          b.preventDefault(), b.stopPropagation(), r1();
        }, k(p, (() => {
          const b = X(() => {
            var f;
          ...
          return f !== b._v$25 && h.style.setProperty("top", b._v$25 = f), m !== b._v$26 && h.style.setProperty("right", b._v$26 = m), x !== b._v$27 && h.style.setProperty("display", b._v$27 = x), b;
        }, {
          _v$25: void 0,
          _v$26: void 0,
          _v$27: void 0
      ...
      keyed: !0,
      children: (c) => (() => {
        const h = vf.cloneNode(!0), p = h.firstChild, b = p.firstChild, f = b.firstChild, m = f.nextSibling, x = m.nextSibling, T = x.nextSibling;
        T.nextSibling;
        const P = b.nextSibling, Q = P.firstChild, Y = Q.nextSibling, H = Y.nextSibling, E = H.nextSibling;
        E.nextSibling;
        ...
        }, b.$$click = () => q1("limit"), k(b, () => w().shortName ?? w().name ?? w().ticker, m), k(b, () => _1(c.price), T), P.$$click = () => q1("stop"), k(P, () => w().shortName ?? w().name ?? w().ticker, Y), k(P, () => _1(c.price), E), Z.$$click = () => q1("create"), de.$$click = Ct, k(de, () => _1(c.price), D), he.$$click = Y1, k(he, () => _1(c.price), null), I((ee) => {

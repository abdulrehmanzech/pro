...
import { utils as E, registerFigure as c9, PolygonType as jt, LineType as ze, OverlayMode as Ln, ActionType as Nt, init as u9, FormatDateType as Q1, DomPosition as at, dispose as a0, TooltipIconPosition as Z1, CandleType as d9, YAxisType as h9, registerOverlay as f9 } from "klinecharts";
function p1(e, t, r) {
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      ...
      for (let L = 2; L < 9; L++) {
        ...
        const ne = N + Math.PI / 2, z = p1({ x, y: v }, e[0], l);
        b.push({
          ...z,
          r: B,
          startAngle: N,
...
function I9(e, t, r) {
  ...
  let h = null, d = wn, b = null, x = !1, v = "initialValue" in l, L = typeof n == "function" && W(n);
  const B = /* @__PURE__ */ new Set(), [N, ne] = (l.storage || T)(l.initialValue), [z, R] = T(void 0), [F, se] = T(void 0, {
    equals: !1
  ...
  function ee(te, le, M, q) {
    return h === te && (h = null, v = !0, (te === d || le === d) && l.onHydrated && queueMicrotask(() => l.onHydrated(q, {
      value: le
    })), d = wn, pe(le, M)), le;
  }
  function pe(te, le) {
    wt(() => {
      le === void 0 && ne(() => te), X(le !== void 0 ? "errored" : "ready"), R(le);
  ...
  function Z() {
    const te = B9, le = N(), M = z();
    if (M !== void 0 && !h)
      throw M;
    return xe && !xe.user && te && s0(() => {
      F(), h && (te.resolved || B.has(te) || (te.increment(), B.add(te)));
    }), le;
  }
  function H(te = !0) {
    if (te !== !1 && x)
    ...
    const M = d !== wn ? d : lt(() => a(le, {
      value: N(),
      refetching: te
    }));
    return typeof M != "object" || !(M && "then" in M) ? (ee(h, M, void 0, le), M) : (h = M, x = !0, queueMicrotask(() => x = !1), wt(() => {
      X(v ? "refreshing" : "pending"), se();
    }, !1), M.then((q) => ee(M, q, void 0, le), (q) => ee(M, void 0, co(q), le)));
  }
...
function K9(e, t, r = {}) {
  ...
  return Lt(() => l0(l)), () => {
    let b = e() || [], x, v;
    return b[O9], lt(() => {
      let B = b.length, N, ne, z, R, F, se, j, X, ee;
      if (B === 0)
        ...
        for (z = new Array(B), R = new Array(B), d && (F = new Array(B)), se = 0, j = Math.min(h, B); se < j && n[se] === b[se]; se++)
          ;
        for (j = h - 1, X = B - 1; j >= se && X >= se && n[j] === b[X]; j--, X--)
          z[X] = a[j], R[X] = l[j], d && (F[X] = d[j]);
        for (N = /* @__PURE__ */ new Map(), ne = new Array(X + 1), v = X; v >= se; v--)
          ee = b[v], x = N.get(ee), ne[v] = x === void 0 ? -1 : x, N.set(ee, v);
        for (x = se; x <= j; x++)
          ee = n[x], v = N.get(ee), v !== void 0 && v !== -1 ? (z[v] = a[x], R[v] = l[x], d && (F[v] = d[x]), v = ne[v], N.set(ee, v)) : l[x]();
        for (v = se; v < B; v++)
          v in z ? (a[v] = z[v], l[v] = R[v], d && (d[v] = F[v], d[v](v))) : a[v] = v1(L);
...
function ho(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const a = e[n];
    t = t || !!a && On in a, e[n] = typeof a == "function" ? (t = !0, W(a)) : a;
  }
  if (t)
    return new Proxy({
      get(n) {
...
function b1(e) {
  ...
  return W(K9(() => e.each, e.children, t || void 0));
}
function ce(e) {
  let t = !1;
...
var W9 = typeof q1 == "object" && q1 && q1.Object === Object && q1, mo = W9, G9 = mo, X9 = typeof self == "object" && self && self.Object === Object && self, J9 = G9 || X9 || Function("return this")(), ct = J9, ei = ct, ti = ei.Symbol, mn = ti, d0 = mn, go = Object.prototype, ni = go.hasOwnProperty, ri = go.toString, y1 = d0 ? d0.toStringTag : void 0;
function oi(e) {
...
var qt = gi, yi = $1, Ci = qt, pi = "[object AsyncFunction]", vi = "[object Function]", bi = "[object GeneratorFunction]", $i = "[object Proxy]";
function _i(e) {
  if (!Ci(e))
    return !1;
  var t = yi(e);
...
var Co = Si, Pi = yo, Di = Ai, Ni = qt, Oi = Co, Ii = /[\\^$.*+?()[\]{}|]/g, Ei = /^\[object .+?Constructor\]$/, Bi = Function.prototype, Fi = Object.prototype, Ui = Bi.toString, zi = Fi.hasOwnProperty, Vi = RegExp(
...
var Zn = o5, i5 = Array.isArray, Yt = i5;
function a5(e) {
  return e != null && typeof e == "object";
}
var Wt = a5, s5 = $1, l5 = Wt, c5 = "[object Symbol]";
function u5(e) {
  return typeof e == "symbol" || l5(e) && s5(e) == c5;
}
var Hn = u5, d5 = Yt, h5 = Hn, f5 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, m5 = /^\w*$/;
function g5(e, t) {
  if (d5(e))
    return !1;
  var r = typeof e;
...
var yn = H5, q5 = yn, Y5 = Array.prototype, W5 = Y5.splice;
function G5(e) {
...
var Za = Qa, Ha = Za, qa = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Ya = /\\(\\)?/g, Wa = Ha(function(e) {
  var t = [];
...
var Ja = Xa, p0 = mn, e6 = Ja, t6 = Yt, n6 = Hn, r6 = 1 / 0, v0 = p0 ? p0.prototype : void 0, b0 = v0 ? v0.toString : void 0;
function _o(e) {
  if (typeof e == "string")
    return e;
  if (t6(e))
...
var s6 = a6, l6 = Yt, c6 = y5, u6 = Ga, d6 = s6;
function h6(e, t) {
...
var j6 = R6, Q6 = Cn, Z6 = D6, H6 = O6, q6 = E6, Y6 = F6, W6 = j6;
function e1(e) {
...
var o2 = r2, i2 = $1, a2 = Wt, s2 = "[object Arguments]";
function l2(e) {
  return a2(e) && i2(e) == s2;
}
var c2 = l2, _0 = c2, u2 = Wt, xo = Object.prototype, d2 = xo.hasOwnProperty, h2 = xo.propertyIsEnumerable, f2 = _0(function() {
  return arguments;
}()) ? _0 : function(e) {
...
var Gn = cn.exports, Y2 = H2, W2 = Wn, k0 = Gn, x0 = k0 && k0.isTypedArray, G2 = x0 ? W2(x0) : Y2, X2 = G2, J2 = o2, es = m2, ts = Yt, ns = Lo, rs = ko, os = X2, is = Object.prototype, as = is.hasOwnProperty;
function ss(e, t) {
...
var Ds = Ps, Ns = qt, Os = Xn, Is = Ds, Es = Object.prototype, Bs = Es.hasOwnProperty;
function Fs(e) {
  if (!Ns(e))
    return Is(e);
  var t = Os(e), r = [];
...
var O3 = N3, I3 = Ut, E3 = ct, B3 = I3(E3, "DataView"), F3 = B3, U3 = Ut, z3 = ct, V3 = U3(z3, "Promise"), K3 = V3, R3 = Ut, j3 = ct, Q3 = R3(j3, "Set"), Z3 = Q3, H3 = Ut, q3 = ct, Y3 = H3(q3, "WeakMap"), W3 = Y3, En = F3, Bn = qn, Fn = K3, Un = Z3, zn = W3, Io = $1, t1 = Co, w0 = "[object Map]", G3 = "[object Object]", A0 = "[object Promise]", M0 = "[object Set]", T0 = "[object WeakMap]", S0 = "[object DataView]", X3 = t1(En), J3 = t1(Bn), e8 = t1(Fn), t8 = t1(Un), n8 = t1(zn), Ot = Io;
...
var H8 = Z8, q8 = qt, I0 = Object.create, Y8 = function() {
  function e() {
  }
  return function(t) {
    if (!q8(t))
...
}(), W8 = Y8, G8 = W8, X8 = Do, J8 = Xn;
function e7(e) {
  return typeof e.constructor == "function" && !J8(e) ? G8(X8(e)) : {};
}
var t7 = e7, n7 = nr, r7 = Wt, o7 = "[object Map]";
function i7(e) {
  return r7(e) && n7(e) == o7;
}
var a7 = i7, s7 = a7, l7 = Wn, E0 = Gn, B0 = E0 && E0.isMap, c7 = B0 ? l7(B0) : s7, u7 = c7, d7 = nr, h7 = Wt, f7 = "[object Set]";
function m7(e) {
  return h7(e) && d7(e) == f7;
}
var g7 = m7, y7 = g7, C7 = Wn, F0 = Gn, U0 = F0 && F0.isSet, p7 = U0 ? C7(U0) : y7, v7 = p7, b7 = G6, $7 = J6, _7 = Zn, k7 = Ss, x7 = Hs, L7 = qs, w7 = Ws, A7 = l3, M7 = $3, T7 = T3, S7 = O3, P7 = nr, D7 = a8, N7 = H8, O7 = t7, I7 = Yt, E7 = Lo, B7 = u7, F7 = qt, U7 = v7, z7 = Jn, V7 = er, K7 = 1, R7 = 2, j7 = 4, Eo = "[object Arguments]", Q7 = "[object Array]", Z7 = "[object Boolean]", H7 = "[object Date]", q7 = "[object Error]", Bo = "[object Function]", Y7 = "[object GeneratorFunction]", W7 = "[object Map]", G7 = "[object Number]", Fo = "[object Object]", X7 = "[object RegExp]", J7 = "[object Set]", el = "[object String]", tl = "[object Symbol]", nl = "[object WeakMap]", rl = "[object ArrayBuffer]", ol = "[object DataView]", il = "[object Float32Array]", al = "[object Float64Array]", sl = "[object Int8Array]", ll = "[object Int16Array]", cl = "[object Int32Array]", ul = "[object Uint8Array]", dl = "[object Uint8ClampedArray]", hl = "[object Uint16Array]", fl = "[object Uint32Array]", _e = {};
_e[Eo] = _e[Q7] = _e[rl] = _e[ol] = _e[Z7] = _e[H7] = _e[il] = _e[al] = _e[sl] = _e[ll] = _e[cl] = _e[W7] = _e[G7] = _e[Fo] = _e[X7] = _e[J7] = _e[el] = _e[tl] = _e[ul] = _e[dl] = _e[hl] = _e[fl] = !0;
_e[q7] = _e[Bo] = _e[nl] = !1;
function tn(e, t, r, n, a, l) {
  ...
  }) : B7(e) && e.forEach(function(R, F) {
    h.set(F, tn(R, t, r, F, e, l));
  });
  var ne = x ? b ? S7 : T7 : b ? V7 : z7, z = v ? void 0 : ne(e);
  return $7(z || e, function(R, F) {
    z && (F = R, R = e[F]), _7(h, F, tn(R, t, r, F, e, l));
  }), h;
}
...
const El = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), Bl = /* @__PURE__ */ p('<div class="drop-down-container"><ul></ul></div>'), Fl = /* @__PURE__ */ p('<div><input type="text"></div>'), Ul = /* @__PURE__ */ p("<li></li>"), C1 = (e) => {
  ...
  const d = W(() => {
    ...
    return v ? typeof e.dataSource[0] == "string" ? e.dataSource.filter((B) => B.toLowerCase().includes(v)) : e.dataSource.filter((B) => {
      var z, R;
      const N = ((z = B.text) == null ? void 0 : z.toString().toLowerCase()) || "", ne = ((R = B.key) == null ? void 0 : R.toLowerCase()) || "";
      return N.includes(v) || ne.includes(v);
    }) : e.dataSource;
  }), b = () => {
    const v = !t();
  ...
  return (() => {
    const v = El.cloneNode(!0), L = v.firstChild, B = L.firstChild;
    v.addEventListener("blur", x), v.$$click = (ne) => {
      ne.stopPropagation(), b();
    };
    const N = h;
    return typeof N == "function" ? xt(N, v) : h = v, C(B, () => e.value), C(v, (() => {
      const ne = W(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => ne() && (() => {
        const z = Bl.cloneNode(!0), R = z.firstChild;
        return z.$$mousedown = (F) => F.preventDefault(), C(z, (() => {
          const F = W(() => !!e.searchable);
          return () => F() && (() => {
            const se = Fl.cloneNode(!0), j = se.firstChild;
            se.style.setProperty("padding", "8px"), se.style.setProperty("border-bottom", "1px solid #333"), j.$$click = (ee) => ee.stopPropagation(), j.$$input = (ee) => a(ee.currentTarget.value);
            const X = l;
            return typeof X == "function" ? xt(X, j) : l = j, j.style.setProperty("width", "100%"), j.style.setProperty("padding", "6px 10px"), j.style.setProperty("border", "1px solid var(--klinecharts-pro-border-color)"), j.style.setProperty("border-radius", "4px"), j.style.setProperty("background-color", "var(--klinecharts-pro-popover-background-color)"), j.style.setProperty("color", "#fff"), j.style.setProperty("font-size", "13px"), j.style.setProperty("outline", "none"), V(() => Ie(j, "placeholder", e.searchPlaceholder || "Search...")), V(() => j.value = n()), se;
          })();
        })(), R), C(R, () => {
          var F;
          return (F = d()) == null ? void 0 : F.map((se) => {
            const X = se[e.valueKey ?? "text"] ?? se;
            return (() => {
              const ee = Ul.cloneNode(!0);
              return ee.$$click = (pe) => {
                var Z;
                pe.stopPropagation(), e.value !== X && ((Z = e.onSelected) == null || Z.call(e, se)), r(!1), a("");
      ...
      return ne._v$ = Ft(v, z, ne._v$), R !== ne._v$2 && fe(v, ne._v$2 = R), ne;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), v;
...
const zl = /* @__PURE__ */ p('<span class="prefix"></span>'), Vl = /* @__PURE__ */ p('<span class="suffix"></span>'), Kl = /* @__PURE__ */ p('<div><input class="value"></div>'), zo = (e) => {
  ...
  return (() => {
    ...
    return l.$$click = () => {
      ...
      return d._v$ = Ft(l, b, d._v$), x !== d._v$2 && fe(l, d._v$2 = x), v !== d._v$3 && Ie(l, "data-status", d._v$3 = v), L !== d._v$4 && Ie(h, "placeholder", d._v$4 = L), d;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
function Hl(e) {
  const t = Zl(e);
  return (K0 !== t || Y1 >= 3) && (K0 = t, Y1 = 0), Y1 += 1, Y1;
}
function Sn(e, t, r) {
...
function ql(e, t, r) {
  const n = r.style ?? jt.Fill, a = r.color ?? "currentColor", l = Vn(r.color) ?? Vn(r.borderColor), h = n === jt.Stroke, d = Math.abs(t.width) <= 1.5, b = l ? Hl(t) : 0, x = !h && d && b !== 2, v = Tn(a, x ? "wick" : "body", l), L = r.borderSize ?? 1, B = Tn(r.borderColor ?? a, "border", l), N = r.borderStyle ?? ze.Solid, ne = r.borderRadius ?? 0, z = r.borderDashedValue ?? [2, 2], R = n === jt.Fill || r.style === jt.StrokeFill, F = n === jt.Stroke || r.style === jt.StrokeFill;
  if (R) {
    e.fillStyle = v, Sn(e, t, ne), e.fill();
    const se = Tn(a, "border", l);
    !x && l && se && (e.strokeStyle = se, e.lineWidth = Math.max(1, L), e.setLineDash([]), Sn(e, t, ne), e.stroke());
  }
  F && (e.strokeStyle = B, e.lineWidth = L, e.setLineDash(N === ze.Dashed ? z : []), Sn(e, t, ne), e.stroke());
}
function Yl() {
  V0 || (V0 = !0, c9({
    name: "rect",
...
const Wl = "指标", Gl = "更多", Xl = "主图指标", Jl = "副图指标", ec = "设置", tc = "时区", nc = "截屏", rc = "全屏", oc = "退出全屏", ic = "保存", ac = "确定", sc = "取消", lc = "MA(移动平均线)", cc = "EMA(指数平滑移动平均线)", uc = "SMA", dc = "BOLL(布林线)", hc = "BBI(多空指数)", fc = "SAR(停损点指向指标)", mc = "VOL(成交量)", gc = "MACD(指数平滑异同移动平均线)", yc = "KDJ(随机指标)", Cc = "RSI(相对强弱指标)", pc = "BIAS(乖离率)", vc = "BRAR(情绪指标)", bc = "CCI(顺势指标)", $c = "DMI(动向指标)", _c = "CR(能量指标)", kc = "PSY(心理线)", xc = "DMA(平行线差指标)", Lc = "TRIX(三重指数平滑平均线)", wc = "OBV(能量潮指标)", Ac = "VR(成交量变异率)", Mc = "WR(威廉指标)", Tc = "MTM(动量指标)", Sc = "EMV(简易波动指标)", Pc = "ROC(变动率指标)", Dc = "PVT(价量趋势指标)", Nc = "AO(动量震荡指标)", Oc = "世界统一时间", Ic = "(UTC-10) 檀香山", Ec = "(UTC-8) 朱诺", Bc = "(UTC-7) 洛杉矶", Fc = "(UTC-5) 芝加哥", Uc = "(UTC-4) 多伦多", zc = "(UTC-3) 圣保罗", Vc = "(UTC+1) 伦敦", Kc = "(UTC+2) 柏林", Rc = "(UTC+3) 巴林", jc = "(UTC+4) 迪拜", Qc = "(UTC+5) 阿什哈巴德", Zc = "(UTC+6) 阿拉木图", Hc = "(UTC+7) 曼谷", qc = "(UTC+8) 上海", Yc = "(UTC+9) 东京", Wc = "(UTC+10) 悉尼", Gc = "(UTC+12) 诺福克岛", Xc = "水平直线", Jc = "水平射线", e4 = "水平线段", t4 = "垂直直线", n4 = "垂直射线", r4 = "垂直线段", o4 = "直线", i4 = "射线", a4 = "线段", s4 = "箭头", l4 = "价格线", c4 = "价格通道线", u4 = "平行直线", d4 = "斐波那契回调直线", h4 = "斐波那契回调线段", f4 = "斐波那契圆环", m4 = "斐波那契螺旋", g4 = "斐波那契速度阻力扇", y4 = "斐波那契趋势扩展", C4 = "江恩箱", p4 = "矩形", v4 = "平行四边形", b4 = "圆", $4 = "三角形", _4 = "三浪", k4 = "五浪", x4 = "八浪", L4 = "任意浪", w4 = "ABCD形态", A4 = "XABCD形态", M4 = "弱磁模式", T4 = "强磁模式", S4 = "商品搜索", P4 = "商品代码", D4 = "参数1", N4 = "参数2", O4 = "参数3", I4 = "参数4", E4 = "参数5", B4 = "周期", F4 = "标准差", U4 = "蜡烛图类型", z4 = "全实心", V4 = "全空心", K4 = "涨空心", R4 = "跌空心", j4 = "OHLC", Q4 = "面积图", Z4 = "最新价显示", H4 = "最高价显示", q4 = "最低价显示", Y4 = "指标最新值显示", W4 = "价格轴类型", G4 = "线性轴", X4 = "百分比轴", J4 = "对数轴", eu = "倒置坐标", tu = "网格线显示", nu = "恢复默认", ru = {
  indicator: Wl,
  more: Gl,
  main_indicator: Xl,
  sub_indicator: Jl,
...
const c = (e, t) => {
  ...
  let t, r, n;
  const [a, l] = T(window.innerWidth < 768), [h, d] = T(localStorage.getItem("klinechart_secondary_period") || ""), [b, x] = T(!1), [v, L] = T(!1), [B, N] = T(!1), [ne, z] = T(!1), [R, F] = T(!1), [se, j] = T({
    top: 0,
    left: 0,
    minWidth: 220
  }), X = () => {
    ...
    if (!r)
      return;
    const O = r.getBoundingClientRect(), U = Math.max(220, Math.ceil(O.width)), ve = window.innerWidth, Le = Math.min(Math.max(8, O.right - U), Math.max(8, ve - U - 8));
    j({
    ...
    x((O) => {
      const U = !O;
      return U ? queueMicrotask(Y) : K(), U;
    });
  }, he = (O) => {
    if (!b())
      return;
    const U = O.target;
    U && (r != null && r.contains(U) || n != null && n.contains(U) || (K(), x(!1)));
  }, re = () => {
    b() && Y();
  }, I = () => {
    if (!t) {
    ...
    le(U && O.scrollLeft > 2), q(U && O.scrollLeft + O.clientWidth < O.scrollWidth - 2);
  };
  Qn(() => {
    window.addEventListener("resize", X), document.addEventListener("fullscreenchange", H), document.addEventListener("mousedown", he), window.addEventListener("scroll", re, !0), document.addEventListener("mozfullscreenchange", H), document.addEventListener("webkitfullscreenchange", H), document.addEventListener("msfullscreenchange", H), t && (t.addEventListener("scroll", I), setTimeout(I, 100));
  }), Lt(() => {
    window.removeEventListener("resize", X), document.removeEventListener("fullscreenchange", H), document.removeEventListener("mousedown", he), window.removeEventListener("scroll", re, !0), document.removeEventListener("mozfullscreenchange", H), document.removeEventListener("webkitfullscreenchange", H), document.removeEventListener("msfullscreenchange", H), t && t.removeEventListener("scroll", I);
  });
  const Q = W(() => {
    const O = e.periods.filter((U) => {
      ...
      if (U.text === ve || Le && U.text === Le)
        return !0;
      if (!Le || Le === ve) {
        const ye = e.periods.find((Te) => Te.text !== ve);
        return U.text === (ye == null ? void 0 : ye.text);
      }
      return !1;
  ...
  return Re(() => {
    ...
    const O = Ah.cloneNode(!0), U = O.firstChild, ve = U.firstChild, Le = ve.firstChild, ye = ve.nextSibling, Te = ye.firstChild;
    return O.style.setProperty("position", "relative"), O.style.setProperty("width", "100%"), O.style.setProperty("display", "flex"), O.style.setProperty("align-items", "center"), C(O, w(ce, {
      ...
      t = _;
    }, U), U.style.setProperty("width", "100%"), U.style.setProperty("overflow", "auto"), st(Le, "click", e.onMenuClick, !0), C(U, w(ce, {
      get when() {
        return e.symbol;
      },
      get children() {
        const _ = mh.cloneNode(!0), ge = _.firstChild;
      ...
      get children() {
        const _ = ph.cloneNode(!0), ge = _.firstChild, Ne = ge.nextSibling;
        return st(_, "click", e.onIndicatorClick, !0), C(Ne, () => c("indicator", e.locale)), _;
      }
    }), ye), ye.style.setProperty("display", "flex"), ye.style.setProperty("gap", "4px"), ye.style.setProperty("margin-left", "auto"), ye.style.setProperty("align-items", "center"), ye.style.setProperty("flex", "0 0 auto"), C(ye, w(ce, {
      get when() {
        return e.showOrderToolsMenu;
      },
      get children() {
        const _ = $h.cloneNode(!0), ge = _.firstChild, Ne = ge.firstChild, ut = Ne.nextSibling;
        return xt(($e) => {
          r = $e;
        }, _), _.style.setProperty("display", "flex"), _.style.setProperty("align-items", "center"), ge.$$click = ($e) => {
          $e.stopPropagation(), de();
        }, ge.style.setProperty("gap", "6px"), ut.style.setProperty("transition", "transform 0.2s ease"), C(_, w(ce, {
          get when() {
            return b();
          },
          get children() {
            return w(Y9, {
              ...
              get children() {
                ...
                return $e.$$mousedown = ($) => $.stopPropagation(), xt(($) => {
                  ...
                  $.preventDefault(), $.stopPropagation(), N((S) => !S), z(!1);
                  ...
                  var F1;
                  const S = `${se().top}px`, Oe = `${se().left}px`, Ue = `${se().minWidth}px`, ot = `klinecharts-pro-order-tools-group${v() ? " klinecharts-pro-order-tools-group-open" : ""}`, mt = `klinecharts-pro-order-tools-group${B() ? " klinecharts-pro-order-tools-group-open" : ""}`, I1 = `klinecharts-pro-order-tools-switch${((F1 = e.orderToolsState) == null ? void 0 : F1.openOrdersExtendedPriceLine) ?? !0 ? " klinecharts-pro-order-tools-switch-on" : ""}`, E1 = `klinecharts-pro-order-tools-display-arrow${ne() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, B1 = `klinecharts-pro-order-tools-group${R() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return S !== $._v$ && $e.style.setProperty("top", $._v$ = S), Oe !== $._v$2 && $e.style.setProperty("left", $._v$2 = Oe), Ue !== $._v$3 && $e.style.setProperty("width", $._v$3 = Ue), ot !== $._v$4 && fe(Ct, $._v$4 = ot), mt !== $._v$5 && fe(o1, $._v$5 = mt), I1 !== $._v$6 && fe(w1, $._v$6 = I1), E1 !== $._v$7 && Ie(He, "class", $._v$7 = E1), B1 !== $._v$8 && fe(ht, $._v$8 = B1), $;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
      ...
      get children() {
        ...
        return st(_, "click", e.chartViewToggle.onToggle, !0), C(_, (() => {
          ...
          return () => ge() ? Dh.cloneNode(!0) : Nh.cloneNode(!0);
...
const We = (e) => nm[e.name](e.class), cm = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), um = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), j0 = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), Q0 = "drawing_tools", dm = (e) => {
  ...
  return (() => {
    const Z = cm.cloneNode(!0), H = Z.firstChild, te = H.nextSibling, le = te.firstChild, M = le.nextSibling, q = M.firstChild, Y = te.nextSibling, K = Y.firstChild, de = Y.nextSibling, he = de.firstChild, re = de.nextSibling, I = re.nextSibling, Q = I.firstChild;
    return C(Z, () => ee().map((D) => (() => {
      const O = um.cloneNode(!0), U = O.firstChild, ve = U.nextSibling, Le = ve.firstChild;
      ...
      let D = L();
      N() !== "normal" && (D = "normal"), ne(D), e.onModeChange(D);
    }, C(le, (() => {
      ...
      return () => D() && w(dn, {
        ...
        get children() {
          return pe().map((O) => (() => {
            const U = j0.cloneNode(!0), ve = U.firstChild;
            return U.$$click = () => {
              B(O.key), ne(O.key), e.onModeChange(O.key), X("");
            }, C(U, w(We, {
              get name() {
                return O.key;
              }
...
const gm = /* @__PURE__ */ p('<div class="chart-style-color-picker"><button type="button" class="chart-style-color-swatch"></button></div>'), ym = /* @__PURE__ */ p('<div class="chart-style-color-popover"><div class="chart-style-color-grid"></div></div>'), Cm = /* @__PURE__ */ p('<button type="button" class="chart-style-palette-color"></button>'), pm = /* @__PURE__ */ p('<div class="chart-style-line-control"><div class="chart-style-width-picker"><button type="button" class="chart-style-size-button"><span></span></button></div></div>'), vm = /* @__PURE__ */ p('<div class="chart-style-width-popover"></div>'), bm = /* @__PURE__ */ p('<button type="button"><span></span></button>'), $m = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-title-tabs"><button type="button"></button><button type="button">Chart Style</button></div>'), _m = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), km = /* @__PURE__ */ p('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), xm = /* @__PURE__ */ p('<div class="klinecharts-pro-chart-style-content"><div class="chart-style-sidebar"><button type="button">Symbol</button><button type="button">Background</button></div><div class="chart-style-panel"><p class="chart-style-note">* Chart Style takes precedence over default chart settings. Click Reset to align with the default theme.</p></div></div>'), Lm = /* @__PURE__ */ p("<h3>Symbol</h3>"), wm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Chart</span></div>'), Am = /* @__PURE__ */ p('<div class="chart-style-row"><span>Bullish Candle Stick</span></div>'), Mm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Candle Stick</span><div class="chart-style-color-pair"></div></div>'), Tm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Borders</span><div class="chart-style-color-pair"></div></div>'), Sm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Wick</span><div class="chart-style-color-pair"></div></div>'), Pm = /* @__PURE__ */ p("<h3>Background</h3>"), Dm = /* @__PURE__ */ p('<div class="chart-style-row"><span>Color</span><button type="button" class="chart-style-color-swatch disabled" title="Chart background is controlled by the active app theme."></button></div>'), Nm = /* @__PURE__ */ p('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Vert Grid Lines</span></label></div>'), Om = /* @__PURE__ */ p('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Horz Grid Lines</span></label></div>'), Im = ["#f6465d", "#f59e0b", "#fcd535", "#2ebd85", "#4098a8", "#22c1dc", "#3861fb", "#7b3fe4", "#ec8aa4", "#f7c56b", "#fff0a3", "#9ed4a4", "#83c7bb", "#8bdce6", "#8bb9f7", "#b7a1dc", "#c9343e", "#e76f20", "#f0b93a", "#3f8d3a", "#236e5a", "#237c88", "#1d3fbf", "#3a209f", "#ffffff", "#cbd5e1", "#9ca3af", "#6b7280", "#374151", "#111827", "#000000"], W0 = [{
  key: "candle_solid",
  text: "Candle"
}, {
  key: "ohlc",
  ...
  const [t, r] = T(e.currentStyles), [n, a] = T(Fm(e.currentStyles)), [l, h] = T(Y0(e.locale)), [d, b] = T(!1), [x, v] = T("settings"), [L, B] = T("symbol"), [N, ne] = T(null), [z, R] = T(null), F = () => {
    b(window.innerWidth <= 768);
  };
  Qn(() => {
    const M = (q) => {
      const Y = q.target;
      Y instanceof Element && (Y.closest(".chart-style-color-picker") || Y.closest(".chart-style-width-picker") || Y.closest(".klinecharts-pro-select") || (ne(null), R(null)));
    };
    F(), window.addEventListener("resize", F), document.addEventListener("mousedown", M), Lt(() => {
  ...
  const se = (M, q) => {
    ...
    const Y = j(M, "#ffffff");
    return (() => {
      const K = gm.cloneNode(!0), de = K.firstChild;
      return de.$$click = () => {
        ne(N() === q ? null : q);
      }, de.style.setProperty("background", Y), C(K, (() => {
        const he = W(() => N() === q);
        return () => he() && (() => {
          const re = ym.cloneNode(!0), I = re.firstChild;
          return C(I, w(b1, {
            each: Im,
            children: (Q) => (() => {
              const D = Cm.cloneNode(!0);
              return D.$$click = () => {
                X(M, Q), ne(null);
    ...
    return (() => {
      const re = pm.cloneNode(!0), I = re.firstChild, Q = I.firstChild, D = Q.firstChild;
      return C(re, w(C1, {
        get style() {
          return {
            width: d() ? "100%" : "134px"
        ...
        onSelected: (O) => {
          const U = O.key;
          X(q, U), X(`${M}.dashedValue`, U === ze.Solid ? [] : [2, 2]);
        }
      }), I), Q.$$click = () => {
        R(z() === K ? null : K);
        ...
        return () => O() && (() => {
          ...
          return C(U, w(b1, {
            each: Bm,
            children: (ve) => (() => {
              const Le = bm.cloneNode(!0), ye = Le.firstChild;
              return Le.$$click = () => {
                X(K, ve), R(null);
      ...
      })(), null), C(re, () => H(Y), null), re;
    })();
  }, le = (() => {
    const M = $m.cloneNode(!0), q = M.firstChild, Y = q.nextSibling;
    return q.$$click = () => v("settings"), C(q, () => c("setting", e.locale)), Y.$$click = () => v("chartStyle"), V((K) => {
      ...
      return W(() => x() === "settings")() ? (() => {
        ...
        return C(M, w(b1, {
          ...
          children: (q) => {
            ...
            return (() => {
              const de = km.cloneNode(!0), he = de.firstChild, re = he.nextSibling;
              return C(he, () => q.text), C(re, Y), V(() => de.classList.toggle("mobile-item", !!d())), de;
            })();
          }
        })), V(() => M.classList.toggle("mobile-layout", !!d())), M;
      })() : (() => {
        const M = xm.cloneNode(!0), q = M.firstChild, Y = q.firstChild, K = Y.nextSibling, de = q.nextSibling, he = de.firstChild;
        return Y.$$click = () => B("symbol"), K.$$click = () => B("background"), C(de, (() => {
          const re = W(() => L() === "symbol");
          return () => re() ? [Lm.cloneNode(!0), (() => {
            ...
            return I.firstChild, C(I, w(C1, {
              ...
              get value() {
                var Q;
                return ((Q = W0.find((D) => D.key === j("candle.type"))) == null ? void 0 : Q.text) ?? "Candle";
              },
              dataSource: W0,
              onSelected: (Q) => {
                X("candle.type", Q.key);
            ...
            const I = Om.cloneNode(!0), Q = I.firstChild, D = Q.firstChild;
          ...
          return I !== re._v$3 && M.classList.toggle("mobile-layout", re._v$3 = I), Q !== re._v$4 && Y.classList.toggle("active", re._v$4 = Q), D !== re._v$5 && K.classList.toggle("active", re._v$5 = D), re;
        }, {
          _v$3: void 0,
          _v$4: void 0,
          _v$5: void 0
...
je(["click"]);
const zm = /* @__PURE__ */ p('<img style="width:500px;margin-top: 20px">'), Vm = (e) => w(At, {
  get title() {
...
}, Rm = /* @__PURE__ */ p('<div class="klinecharts-pro-indicator-setting-modal-content"></div>'), jm = /* @__PURE__ */ p("<span></span>"), Qm = (e) => {
  const [t, r] = T(E.clone(e.params.calcParams)), n = (a) => Km[a];
  return w(At, {
    get title() {
    ...
    get children() {
      const a = Rm.cloneNode(!0);
      return C(a, () => n(e.params.indicatorName).map((l, h) => [(() => {
        const d = jm.cloneNode(!0);
...
}, Zm = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z"></path></svg>'), Hm = /* @__PURE__ */ p('<img alt="symbol">'), qm = /* @__PURE__ */ p("<li><div><span></span></div></li>"), Ym = (e) => {
  ...
  return w(At, {
    ...
    get children() {
      return [w(zo, {
        ...
        renderItem: (a) => (() => {
          const l = qm.cloneNode(!0), h = l.firstChild, d = h.firstChild;
          return l.$$click = () => {
...
const Wm = /* @__PURE__ */ p('<div class="klinecharts-pro-mobile-more-modal-content"><div class="item"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="20" height="20" rx="4" ry="4" fill="none" stroke="currentColor" stroke-width="2"></rect><path d="m15.92 13.9-3.65-3.55a.773.773 0 0 1 0-1.12c.32-.33.79-.33 1.11 0l3.02 3.38c.31.32.31.81 0 1.13-.16.16-.48.16-.48.16Z" fill="currentColor" stroke="1"></path><path d="m12.43 14.23-.48-.17q-.48-.48 0-.96l4.13-4.36c.31-.32.63-.32.95 0s.32.65 0 .97l-4.13 4.35c-.15.17-.31.17-.47.17Zm-1.11-9.52c.31 0 1.11.16 1.11.97 0 .64-.95.48-1.27.48-1.43 0-1.91.81-2.07 1.45l-.31 1.94h1.58c.32 0 .64.32.64.64 0 .33-.32.65-.64.65H8.62l-1.11 4.99c-.16 1.46-1.11 1.46-1.59 0L7.03 11H5.6c-.31 0-.63-.32-.63-.65 0-.64.32-.8.63-.8h1.75l.48-2.1c.31-2.74 2.69-2.9 3.49-2.74Z" fill="noncurrentColore" stroke="1"></path></svg><span></span></div><div class="item"><svg width="20" height="20" viewBox="0 0 20 20"><path d="M18.5446,9.09091C18.3333,6.61616,17.2887,4.31818,15.5751,2.63889C13.8498,0.94697,11.6197,0,9.28404,0C8.02817,0,6.81925,0.265151,5.66901,0.782828C5.65728,0.782828,5.65728,0.795454,5.64554,0.795454C5.6338,0.795454,5.6338,0.808081,5.62207,0.808081C4.53052,1.31313,3.55634,2.0202,2.71127,2.92929C1.85446,3.85101,1.18545,4.91162,0.715963,6.11111C0.246479,7.33586,0,8.64899,0,10C0,10.8712,0.105634,11.7172,0.305164,12.5379C0.305164,12.5631,0.316901,12.5884,0.328638,12.6136C0.739437,14.2298,1.51408,15.7197,2.62911,16.9571C4.07277,18.548,5.92723,19.5581,7.93427,19.8737C7.95775,19.8737,7.96948,19.8864,7.99296,19.8864C8.3216,19.9369,8.66197,19.9747,9.00235,19.9747L9.21362,19.9747C9.61268,19.9747,10.3756,19.9369,11.0094,19.697C11.1737,19.6338,11.3028,19.5076,11.3732,19.3434C11.4437,19.1793,11.4554,18.9899,11.3967,18.8131C11.3028,18.5354,11.0563,18.346,10.7864,18.346C10.716,18.346,10.6338,18.3586,10.5634,18.3838C10.0939,18.5606,9.46009,18.5859,9.20188,18.5859L9.09624,18.5859C9.20188,18.2702,9.23709,17.9167,9.15493,17.5505C9.00235,16.8939,8.50939,16.3384,7.58216,15.7955L7.19484,15.5682C6.57277,15.2146,6.23239,15.0253,6.03286,14.7348C5.83333,14.4444,5.69249,13.9899,5.51643,12.9798C5.38732,12.298,5.04695,11.7677,4.50704,11.4646C4.14319,11.2626,3.70892,11.149,3.19249,11.149C2.82864,11.149,2.42958,11.1995,2.00704,11.3005C1.79578,11.351,1.59624,11.4141,1.42019,11.4646C1.33803,10.9848,1.30282,10.4798,1.30282,9.97475C1.30282,6.93182,2.76995,4.26768,4.98826,2.72727C5,3.00505,5.05869,3.29545,5.17606,3.57323C5.48122,4.26768,6.10329,4.7096,7.01878,4.89899C7.06573,4.91162,7.10094,4.91162,7.13615,4.91162L7.1831,4.91162C7.26526,4.91162,7.57042,4.92424,7.88732,5.0505C8.3216,5.2399,8.56808,5.55555,8.65023,6.04798C8.84977,7.61364,9.07277,10.4293,8.79108,11.3384C8.76761,11.4141,8.75587,11.4899,8.75587,11.5657C8.75587,11.9444,9.0493,12.2601,9.40141,12.2601C9.57747,12.2601,9.74179,12.1843,9.85915,12.0581C9.97653,11.9318,12.6174,9.05303,13.3216,8.09343C13.4038,7.97979,13.4859,7.87878,13.5798,7.76515C13.9202,7.33586,14.2723,6.90656,14.4014,6.26262C14.554,5.56818,14.4014,4.79798,13.9437,3.85101C13.615,3.16919,13.5563,2.86616,13.5446,2.75252C13.5563,2.7399,13.5798,2.72727,13.6033,2.71464C15.6221,4.10353,17.0188,6.43939,17.2535,9.19192C17.2887,9.55808,17.5587,9.82323,17.8991,9.82323L17.9577,9.82323C18.3099,9.8106,18.5681,9.48232,18.5446,9.09091ZM3.19249,12.5631C3.48592,12.5631,3.72066,12.6136,3.89671,12.7146C4.08451,12.8283,4.19014,12.9924,4.23709,13.2702C4.43662,14.3434,4.61268,15.0631,5,15.6061C5.37559,16.1364,5.85681,16.4015,6.58451,16.8182L6.60798,16.8308C6.71362,16.8939,6.84272,16.9571,6.96009,17.0328C7.69953,17.4621,7.86385,17.7525,7.89906,17.8914C7.93427,18.0303,7.85211,18.2323,7.74648,18.4343C4.91784,17.8535,2.65258,15.6944,1.73709,12.8283C2.15962,12.702,2.71127,12.5631,3.19249,12.5631ZM12.7934,4.5202C13.4272,5.83333,13.1455,6.18687,12.5822,6.89394C12.4883,7.00758,12.3944,7.12121,12.3005,7.24747C11.9484,7.72727,11.0211,8.77525,10.2113,9.68434C10.2113,9.24242,10.1878,8.73737,10.1526,8.19444C10.0704,6.95707,9.92958,5.90909,9.92958,5.87121L9.92958,5.83333C9.75352,4.83586,9.20188,4.11616,8.3216,3.76263C7.82864,3.56061,7.37089,3.53535,7.19484,3.53535C6.73709,3.43434,6.4554,3.24495,6.33803,2.99242C6.19718,2.68939,6.29108,2.24747,6.38498,1.9697C7.28873,1.59091,8.26291,1.37626,9.28404,1.37626C10.3873,1.37626,11.4437,1.61616,12.4061,2.04545C12.3357,2.18434,12.277,2.34848,12.2535,2.5505C12.2066,3.04293,12.3709,3.64899,12.7934,4.5202Z"></path></svg><span></span></div><div class="item"><svg viewBox="0 0 20 20"><rect x="3" y="4" width="14" height="14" rx="2" fill="none" stroke="currentColor" stroke-width="1.8"></rect><path d="M6 2.5v4M14 2.5v4M3 8h14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path><path d="M10 11v3l2.2 1.3" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path></svg><span>Time Tools</span></div><div class="item"><svg viewBox="0 0 20 20"><path d="M19.7361,12.542L18.1916,11.2919C18.2647,10.8678,18.3025,10.4347,18.3025,10.0017C18.3025,9.56861,18.2647,9.13555,18.1916,8.71142L19.7361,7.46135C19.9743,7.26938,20.0615,6.95686,19.9554,6.6756L19.9342,6.61756C19.5074,5.49026,18.8755,4.45449,18.0549,3.53926L18.0124,3.49238C17.8096,3.26692,17.4819,3.1821,17.1848,3.28032L15.2677,3.92544C14.5603,3.3763,13.7704,2.94324,12.9168,2.63966L12.5466,0.742229C12.49,0.449802,12.2472,0.222111,11.9383,0.168536L11.8746,0.157375C10.6461,-0.0524583,9.35391,-0.0524583,8.1254,0.157375L8.06174,0.168536C7.75284,0.222111,7.50997,0.449802,7.45338,0.742229L7.08082,2.64859C6.2343,2.95217,5.44909,3.383,4.74641,3.92991L2.81522,3.28032C2.52047,3.1821,2.19036,3.26469,1.98757,3.49238L1.94513,3.53926C1.12455,4.45672,0.492609,5.49249,0.0658141,6.61756L0.0445921,6.6756C-0.0615171,6.95463,0.0257283,7.26715,0.263885,7.46135L1.82723,8.72482C1.75413,9.14448,1.71876,9.57308,1.71876,9.99944C1.71876,10.428,1.75413,10.8566,1.82723,11.2741L0.263885,12.5375C0.025729,12.7295,-0.0615164,13.042,0.0445929,13.3233L0.0658148,13.3813C0.49261,14.5064,1.12455,15.5444,1.94513,16.4596L1.98757,16.5065C2.19036,16.732,2.51812,16.8168,2.81522,16.7186L4.74641,16.069C5.44909,16.6159,6.2343,17.0489,7.08082,17.3503L7.45338,19.2567C7.50997,19.5491,7.75284,19.7768,8.06174,19.8303L8.1254,19.8415C8.74084,19.9464,9.37042,20,10,20C10.6296,20,11.2615,19.9464,11.8746,19.8415L11.9383,19.8303C12.2472,19.7768,12.49,19.5491,12.5466,19.2567L12.9168,17.3592C13.7704,17.0556,14.5603,16.6248,15.2677,16.0734L17.1848,16.7186C17.4795,16.8168,17.8096,16.7342,18.0124,16.5065L18.0549,16.4596C18.8755,15.5422,19.5074,14.5064,19.9342,13.3813L19.9554,13.3233C20.0615,13.0487,19.9743,12.7362,19.7361,12.542ZM16.5175,8.97483C16.5764,9.3119,16.6071,9.65791,16.6071,10.0039C16.6071,10.3499,16.5764,10.6959,16.5175,11.033L16.3618,11.9281L18.1233,13.3545C17.8568,13.9372,17.5196,14.4863,17.1188,14.9975L14.9305,14.2631L14.1901,14.839C13.6266,15.2765,12.9994,15.6203,12.3203,15.8614L11.4219,16.1806L10.9998,18.3459C10.3372,18.4173,9.66045,18.4173,8.9955,18.3459L8.57342,16.1761L7.6821,15.8524C7.01008,15.6114,6.38521,15.2676,5.82637,14.8323L5.08596,14.2541L2.88361,14.9953C2.48275,14.4841,2.14791,13.9327,1.8791,13.3523L3.65938,11.9125L3.50611,11.0196C3.44952,10.687,3.41887,10.3432,3.41887,10.0039C3.41887,9.66237,3.44716,9.32083,3.50611,8.98822L3.65938,8.09531L1.8791,6.6555C2.14556,6.07288,2.48275,5.52374,2.88361,5.01255L5.08596,5.75367L5.82637,5.17551C6.38521,4.74022,7.01008,4.39645,7.6821,4.15536L8.57578,3.83615L8.99786,1.66638C9.66045,1.59495,10.3372,1.59495,11.0021,1.66638L11.4242,3.83168L12.3226,4.1509C12.9994,4.39198,13.6289,4.73575,14.1925,5.17328L14.9329,5.7492L17.1211,5.01479C17.522,5.52598,17.8568,6.07734,18.1256,6.65773L16.3642,8.08416L16.5175,8.97483ZM10.0024,5.85189C7.7104,5.85189,5.85231,7.61092,5.85231,9.78068C5.85231,11.9504,7.7104,13.7095,10.0024,13.7095C12.2943,13.7095,14.1524,11.9504,14.1524,9.78068C14.1524,7.61092,12.2943,5.85189,10.0024,5.85189ZM11.8699,11.5486C11.37,12.0196,10.7074,12.2808,10.0024,12.2808C9.29732,12.2808,8.63473,12.0196,8.13483,11.5486C7.6373,11.0754,7.36142,10.4481,7.36142,9.78068C7.36142,9.11323,7.6373,8.48596,8.13483,8.01272C8.63473,7.53948,9.29732,7.28054,10.0024,7.28054C10.7074,7.28054,11.37,7.53948,11.8699,8.01272C12.3674,8.48596,12.6433,9.11323,12.6433,9.78068C12.6433,10.4481,12.3674,11.0754,11.8699,11.5486Z"></path></svg><span></span></div></div>'), Gm = (e) => w(At, {
  ...
  get children() {
    const t = Wm.cloneNode(!0), r = t.firstChild, n = r.firstChild, a = n.nextSibling, l = r.nextSibling, h = l.firstChild, d = h.nextSibling, b = l.nextSibling, x = b.nextSibling, v = x.firstChild, L = v.nextSibling;
    return r.$$click = () => {
...
je(["click"]);
const Xm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-picker"></div>'), Jm = /* @__PURE__ */ p('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), eg = /* @__PURE__ */ p("<span></span>"), tg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), ng = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-grid"></div>'), rg = /* @__PURE__ */ p('<span class="weekday"></span>'), Et = /* @__PURE__ */ p('<button type="button"></button>'), og = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-month-grid"></div>'), ig = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), ag = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), sg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-content"></div>'), lg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-tabs"></div>'), cg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), ug = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), dg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), hg = [{
  key: "goToDate",
  label: "Go to Date"
}, {
  key: "timeRange",
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], fg = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], J0 = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], Zt = (e) => String(e).padStart(2, "0"), eo = (e, t, r) => Math.min(r, new Date(e, t + 1, 0).getDate()), Pn = (e) => {
  const t = new Date(e);
  return {
    year: t.getFullYear(),
    month: t.getMonth(),
  ...
  const [t, r] = T(!0), [n, a] = T("date"), [l, h] = T(e.value.year), [d, b] = T(e.value.month), x = W(() => mg(l(), d())), v = W(() => Math.floor(l() / 10) * 10), L = W(() => Array.from({
    length: 12
  }, (Z, H) => v() - 1 + H)), B = W(() => e.value.hour % 12 || 12), N = W(() => e.value.hour >= 12 ? "PM" : "AM"), ne = Array.from({
    length: 12
  }, (Z, H) => H + 1), z = Array.from({
    length: 60
  }, (Z, H) => H), R = (Z) => {
  ...
  return (() => {
    const Z = Xm.cloneNode(!0);
    return C(Z, (() => {
      const H = W(() => e.showInput !== !1);
      return () => H() && (() => {
        const te = Jm.cloneNode(!0), le = te.firstChild, M = le.firstChild;
        return C(te, (() => {
          const q = W(() => !!e.label);
          return () => q() && (() => {
            const Y = eg.cloneNode(!0);
            return C(Y, () => e.label), Y;
          })();
        })(), le), le.$$click = () => r(!t()), C(M, () => Kn(e.value)), te;
      })();
    })(), null), C(Z, (() => {
      const H = W(() => !!t());
      return () => H() && (() => {
        const te = tg.cloneNode(!0), le = te.firstChild, M = le.firstChild, q = M.nextSibling, Y = q.nextSibling, K = Y.nextSibling, de = K.nextSibling;
        return M.$$click = () => {
          ...
          const he = W(() => n() === "date");
          return () => he() && (() => {
            const re = ng.cloneNode(!0);
            return C(re, () => fg.map((I) => (() => {
              const Q = rg.cloneNode(!0);
              return C(Q, I), Q;
            })()), null), C(re, () => x().map(({
              date: I,
              current: Q
              ...
              const D = Dn({
                ...
                month: I.getMonth(),
                day: I.getDate()
              }), O = e.range ? Dn(e.range.from) : NaN, U = e.range ? Dn(e.range.to) : NaN, ve = Math.min(O, U), Le = Math.max(O, U), ye = Number.isFinite(ve) && D >= ve && D <= Le, Te = Number.isFinite(ve) && (D === ve || D === Le), _ = I.getFullYear() === e.value.year && I.getMonth() === e.value.month && I.getDate() === e.value.day;
              return (() => {
                const ge = Et.cloneNode(!0);
                return ge.$$click = () => se(I), fe(ge, `${Q ? "" : "muted"} ${ye ? "in-range" : ""} ${Te || _ ? "selected" : ""}`), C(ge, () => I.getDate()), ge;
              })();
            }), null), re;
          })();
        })(), null), C(te, (() => {
          const he = W(() => n() === "month");
          return () => he() && (() => {
            const re = og.cloneNode(!0);
            return C(re, () => J0.map((I, Q) => (() => {
          ...
          const he = W(() => n() === "year");
          return () => he() && (() => {
            const re = ig.cloneNode(!0);
            return C(re, () => L().map((I) => (() => {
              const Q = Et.cloneNode(!0);
              return Q.$$click = () => X(I), C(Q, I), V(() => fe(Q, `${I < v() || I > v() + 9 ? "muted" : ""} ${I === e.value.year ? "selected" : ""}`)), Q;
            })())), re;
          })();
        })(), null), C(te, (() => {
          const he = W(() => n() === "date");
          return () => he() && (() => {
            const re = ag.cloneNode(!0), I = re.firstChild, Q = I.nextSibling, D = Q.nextSibling;
            return C(I, () => ne.map((O) => (() => {
              const U = Et.cloneNode(!0);
              return U.$$click = () => ee(O), C(U, () => Zt(O)), V(() => fe(U, O === B() ? "selected" : "")), U;
            })())), C(Q, () => z.map((O) => (() => {
              const U = Et.cloneNode(!0);
              return U.$$click = () => e.onChange({
                ...e.value,
                minute: O
              }), C(U, () => Zt(O)), V(() => fe(U, O === e.value.minute ? "selected" : "")), U;
            })())), C(D, () => ["AM", "PM"].map((O) => (() => {
              const U = Et.cloneNode(!0);
              return U.$$click = () => pe(O), C(U, O), V(() => fe(U, O === N() ? "selected" : "")), U;
            })())), re;
          })();
        })(), null), te;
      })();
  ...
  const [t, r] = T(e.initialTab ?? "goToDate"), [n, a] = T(Pn(e.initialTimestamp)), [l, h] = T(Pn(e.initialRange.from)), [d, b] = T(Pn(e.initialRange.to)), [x, v] = T("from"), [L, B] = T({
    ...e.anchorSettings,
    ...
    if (z === "goToDate")
      ...
      e.onTimeAnchorChange({
        ...R,
        timestamp: R.anchorPoint === "date" ? G1(n()) : R.timestamp
      });
    }
    e.onClose();
  };
  return w(At, {
    ...
    get title() {
      return (() => {
        ...
        return C(z, () => hg.map((R) => (() => {
          ...
          return F.$$click = () => r(R.key), C(F, () => R.label), V(() => fe(F, t() === R.key ? "active" : "")), F;
        })())), z;
      })();
    },
    get buttons() {
    ...
    get children() {
      ...
      return C(z, (() => {
        ...
        return () => R() && (() => {
          const F = cg.cloneNode(!0), se = F.firstChild, j = se.firstChild, X = j.nextSibling, ee = X.nextSibling;
          return j.$$click = () => v("from"), C(j, () => Kn(l())), ee.$$click = () => v("to"), C(ee, () => Kn(d())), C(F, (() => {
            const pe = W(() => x() === "from");
            return () => pe() ? w(X1, {
              label: "Start",
              get value() {
        ...
        return () => R() && (() => {
          const F = ug.cloneNode(!0), se = F.firstChild, j = se.firstChild, X = j.nextSibling, ee = se.nextSibling, pe = ee.firstChild, Z = pe.nextSibling, H = ee.nextSibling, te = H.firstChild, le = te.nextSibling, M = H.nextSibling, q = M.firstChild, Y = q.nextSibling;
          return X.$$click = () => N({
            enabled: !L().enabled
            ...
            const de = `klinecharts-pro-time-tools-switch${L().enabled ? " on" : ""}`, he = `klinecharts-pro-time-tools-row${L().enabled ? "" : " disabled"}`, re = !L().enabled, I = `klinecharts-pro-time-tools-row with-divider${L().enabled ? "" : " disabled"}`, Q = `klinecharts-pro-time-tools-switch${L().anchorLine ? " on" : ""}`, D = !L().enabled, O = `klinecharts-pro-time-tools-row with-divider${L().enabled ? "" : " disabled"}`, U = `klinecharts-pro-time-tools-switch${L().acrossTokens ? " on" : ""}`, ve = !L().enabled;
            return de !== K._v$3 && fe(X, K._v$3 = de), he !== K._v$4 && fe(ee, K._v$4 = he), re !== K._v$5 && (Z.disabled = K._v$5 = re), I !== K._v$6 && fe(H, K._v$6 = I), Q !== K._v$7 && fe(le, K._v$7 = Q), D !== K._v$8 && (le.disabled = K._v$8 = D), O !== K._v$9 && fe(M, K._v$9 = O), U !== K._v$10 && fe(Y, K._v$10 = U), ve !== K._v$11 && (Y.disabled = K._v$11 = ve), K;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
je(["click"]);
const yg = /* @__PURE__ */ p('<i class="icon-close klinecharts-pro-load-icon"></i>'), Cg = /* @__PURE__ */ p('<div class="klinecharts-pro-content"><div class="klinecharts-pro-widget"></div></div>'), pg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-anchor-line"></div>'), vg = /* @__PURE__ */ p('<div class="klinecharts-pro-time-navigation-tooltip"></div>'), bg = /* @__PURE__ */ p('<div class="klinecharts-pro-countdown-price-mark"><span class="klinecharts-pro-countdown-price-mark-price"></span><span class="klinecharts-pro-countdown-price-mark-timer"></span></div>'), $g = /* @__PURE__ */ p('<div class="overlay-toolbar-color-popover"><div class="overlay-toolbar-color-grid"></div><div class="overlay-toolbar-color-footer"><button type="button" class="overlay-toolbar-add-color">+</button><div class="overlay-toolbar-color-slider"><span></span></div></div></div>'), _g = /* @__PURE__ */ p('<div class="overlay-toolbar-dropdown width-menu"></div>'), kg = /* @__PURE__ */ p('<div class="overlay-toolbar-dropdown style-menu"><button type="button"><span class="overlay-toolbar-style-sample solid"></span></button><button type="button"><span class="overlay-toolbar-style-sample dashed"></span></button><button type="button"><span class="overlay-toolbar-style-sample dotted"></span></button></div>'), xg = /* @__PURE__ */ p('<div class="klinecharts-pro-overlay-toolbar"><button type="button" class="overlay-toolbar-icon drag" title="Move"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="6" r="1.5"></circle><circle cx="15" cy="6" r="1.5"></circle><circle cx="9" cy="12" r="1.5"></circle><circle cx="15" cy="12" r="1.5"></circle><circle cx="9" cy="18" r="1.5"></circle><circle cx="15" cy="18" r="1.5"></circle></svg></button><button type="button" class="overlay-toolbar-icon refresh" title="Reset"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 0 1 15.4-6.36L21 8"></path><path d="M21 3v5h-5"></path><path d="M21 12a9 9 0 0 1-15.4 6.36L3 16"></path><path d="M3 21v-5h5"></path></svg></button><div class="overlay-toolbar-picker"><button type="button" title="Color"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line width"><span class="overlay-toolbar-line-preview"></span><span>px</span></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line style"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 12h16"></path></svg></button></div><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="5" width="14" height="14" rx="2"></rect><path d="M20 4 4 20"></path></svg></button><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="10" width="14" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></button><button type="button" class="overlay-toolbar-icon delete" title="Delete"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"></path><path d="M8 6V4h8v2"></path><path d="M19 6 18 20H6L5 6"></path><path d="M10 11v5"></path><path d="M14 11v5"></path></svg></button></div>'), Lg = /* @__PURE__ */ p('<button type="button"></button>'), wg = /* @__PURE__ */ p('<button type="button"><span class="overlay-toolbar-width-sample"></span></button>'), Ag = /* @__PURE__ */ p('<div class="klinecharts-pro-quick-order-marker"><button type="button" class="klinecharts-pro-quick-order-plus"></button></div>'), Mg = /* @__PURE__ */ p('<span class="klinecharts-pro-quick-order-plus-icon"></span>'), Tg = /* @__PURE__ */ p('<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3" aria-hidden="true"><path d="M460-300h40v-160h160v-40H500v-160h-40v160H300v40h160v160ZM224.62-160q-27.62 0-46.12-18.5Q160-197 160-224.62v-510.76q0-27.62 18.5-46.12Q197-800 224.62-800h510.76q27.62 0 46.12 18.5Q800-763 800-735.38v510.76q0 27.62-18.5 46.12Q763-160 735.38-160H224.62Zm0-40h510.76q9.24 0 16.93-7.69 7.69-7.69 7.69-16.93v-510.76q0-9.24-7.69-16.93-7.69-7.69-16.93-7.69H224.62q-9.24 0-16.93 7.69-7.69 7.69-7.69 16.93v510.76q0 9.24 7.69 16.93 7.69 7.69 16.93 7.69ZM200-760v560-560Z"></path></svg>'), Sg = /* @__PURE__ */ p('<div class="klinecharts-pro-quick-order-menu-anchor"><div class="klinecharts-pro-quick-order-menu"><button type="button">Trade <!> @ <!> Limit</button><button type="button">Trade <!> @ <!> Stop</button><button type="button">Create new order...</button><button type="button">Copy Price (<!>)</button><button type="button">Draw horizontal line on </button></div></div>');
Yl();
...
const Ng = (e) => {
  var Tr, Sr, Pr, Dr, Nr, Or, Ir, Er, Br, Fr, Ur, zr, Vr, Kr, Rr, jr, Qr, Zr, Hr, qr, Yr, Wr, Gr, Xr, Jr, e0, t0, n0;
  let t, r, n = null, a;
  const [l, h] = T(!1), [d, b] = T(e.theme), [x, v] = T(e.styles), [L, B] = T(e.locale), [N, ne] = T(e.symbol), [z, R] = T(e.period), F = () => {
    var o, i, s, u;
    return {
  ...
  }, [se, j] = T(!1), [X, ee] = T([...e.mainIndicators]), [pe, Z] = T({}), [H, te] = T(!1), [le, M] = T({
    key: e.timezone,
    text: q0(e.timezone, e.locale)
  }), [q, Y] = T(!1), [K, de] = T(), [he, re] = T(""), [I, Q] = T(!1), [D, O] = T(Date.now()), [U, ve] = T({
    from: Date.now() - 30 * 24 * 60 * 60 * 1e3,
    to: Date.now()
  }), [Le, ye] = T(Pg() ?? Ko()), [Te, _] = T(e.drawingBarVisible), [ge, Ne] = T(!1), [ut, $e] = T(!1), [Ct, dt] = T(!1), n1 = ((Tr = e.orderTools) == null ? void 0 : Tr.quickOrder) ?? !0, [Be, _1] = T({
    quickOrder: n1,
  ...
  const Pt = () => {
    ...
    }), P = (i0 = n.getSize) == null ? void 0 : i0.call(n, "candle_pane", at.YAxis), oe = P != null && P.width && Number.isFinite(P.width) ? Math.max(74, Math.floor(P.width) - 2) : 96, ae = en(z()), ie = o % ae, J = ie === 0 ? ae : ae - ie, ue = Number(s.close), be = Number(s.open), Se = n.getStyles().candle.priceMark.last, G = Se.text, Ce = Number(G.size) || 12, me = Number(G.paddingTop) || 2, we = Number(G.paddingBottom) || 2, Pe = Math.min(Number(G.paddingLeft) || 4, 3), Xe = Math.min(Number(G.paddingRight) || 4, 3), Je = Math.max(34, Ce * 2 + me + we + 6), it = Math.max(0, Math.min(g - Je / 2, y - Je));
    Vt({
      top: it,
      width: Math.min(oe, Math.max(62, A.length * (Ce * 0.56) + Pe + Xe + 4)),
      priceText: A,
      text: Dg(J),
    ...
    if (!s)
      return;
    const u = o.clientX, m = o.clientY, g = i.x, f = i.y, y = (oe) => {
      oe.preventDefault();
      const ae = g + oe.clientX - u, ie = f + oe.clientY - m;
      Ke({
        ...i,
  ...
  let ir = (Rr = e.orderTools) == null ? void 0 : Rr.quickOrder, ar = (jr = e.orderTools) == null ? void 0 : jr.quickOrderFloatingWindow, sr = (Qr = e.orderTools) == null ? void 0 : Qr.quickOrderPlusButton, lr = (Zr = e.orderTools) == null ? void 0 : Zr.openOrders, cr = (Hr = e.orderTools) == null ? void 0 : Hr.openOrdersExtendedPriceLine, ur = (qr = e.orderTools) == null ? void 0 : qr.openOrdersDisplay, dr = (Yr = e.orderTools) == null ? void 0 : Yr.positions, hr = (Wr = e.orderTools) == null ? void 0 : Wr.breakevenPrice, fr = (Gr = e.orderTools) == null ? void 0 : Gr.liquidationPrice, mr = (Xr = e.orderTools) == null ? void 0 : Xr.priceLine, gr = (Jr = e.orderTools) == null ? void 0 : Jr.marketPriceLine, yr = (e0 = e.orderTools) == null ? void 0 : e0.countDown, Cr = (t0 = e.orderTools) == null ? void 0 : t0.bidAskPrice, pr = (n0 = e.orderTools) == null ? void 0 : n0.orderHistory;
  Re(() => {
    var ue, be, Se, G, Ce, me, we, Pe, Xe, Je, it, et, tt, m1;
    const o = (ue = e.orderTools) == null ? void 0 : ue.quickOrder, i = (be = e.orderTools) == null ? void 0 : be.quickOrderFloatingWindow, s = (Se = e.orderTools) == null ? void 0 : Se.quickOrderPlusButton, u = (G = e.orderTools) == null ? void 0 : G.openOrders, m = (Ce = e.orderTools) == null ? void 0 : Ce.openOrdersExtendedPriceLine, g = (me = e.orderTools) == null ? void 0 : me.openOrdersDisplay, f = (we = e.orderTools) == null ? void 0 : we.positions, y = (Pe = e.orderTools) == null ? void 0 : Pe.breakevenPrice, k = (Xe = e.orderTools) == null ? void 0 : Xe.liquidationPrice, A = (Je = e.orderTools) == null ? void 0 : Je.priceLine, P = (it = e.orderTools) == null ? void 0 : it.marketPriceLine, oe = (et = e.orderTools) == null ? void 0 : et.countDown, ae = (tt = e.orderTools) == null ? void 0 : tt.bidAskPrice, ie = (m1 = e.orderTools) == null ? void 0 : m1.orderHistory, J = {};
    typeof o == "boolean" && o !== ir && (ir = o, J.quickOrder = o, typeof i != "boolean" && (J.quickOrderFloatingWindow = o), typeof s != "boolean" && (J.quickOrderPlusButton = o)), typeof i == "boolean" && i !== ar && (ar = i, J.quickOrderFloatingWindow = i), typeof s == "boolean" && s !== sr && (sr = s, J.quickOrderPlusButton = s), typeof u == "boolean" && u !== lr && (lr = u, J.openOrders = u), typeof m == "boolean" && m !== cr && (cr = m, J.openOrdersExtendedPriceLine = m), g !== void 0 && g !== ur && (ur = g, J.openOrdersDisplay = g), typeof f == "boolean" && f !== dr && (dr = f, J.positions = f), typeof y == "boolean" && y !== hr && (hr = y, J.breakevenPrice = y), typeof k == "boolean" && k !== fr && (fr = k, J.liquidationPrice = k), typeof A == "boolean" && A !== mr && (mr = A, J.priceLine = A, typeof P != "boolean" && (J.marketPriceLine = A), typeof oe != "boolean" && (J.countDown = A), typeof ae != "boolean" && (J.bidAskPrice = A)), typeof P == "boolean" && P !== gr && (gr = P, J.marketPriceLine = P), typeof oe == "boolean" && oe !== yr && (yr = oe, J.countDown = oe), typeof ae == "boolean" && ae !== Cr && (Cr = ae, J.bidAskPrice = ae), typeof ie == "boolean" && ie !== pr && (pr = ie, J.orderHistory = ie), Object.keys(J).length > 0 && u1(J);
  }), Re(() => {
    Be().marketPriceLine, Be().countDown, z(), N(), n == null || n.setStyles({
      candle: {
        priceMark: {
          last: {
            show: !0,
    ...
    getSettings: () => {
      var s, u, m, g, f, y, k, A, P, oe, ae, ie, J, ue, be, Se;
      if (!n)
        return {};
    ...
    setSettings: (o) => {
      var s, u, m, g, f, y, k, A, P, oe, ae, ie, J, ue;
      if (!n)
        return;
      const i = {};
  ...
  const Ro = () => {
    ...
    const i = Zo(o), s = i == null ? void 0 : i.candle, u = Number((s == null ? void 0 : s.timestamp) ?? o), m = Number((s == null ? void 0 : s.high) ?? (s == null ? void 0 : s.close) ?? (s == null ? void 0 : s.open)), g = i ? K1(i.dataIndex) : void 0, f = i && Number.isFinite(m) ? {
      ...
      paneId: "candle_pane",
      absolute: !0
    }), k = Number((ie = y == null ? void 0 : y[0]) == null ? void 0 : ie.x), A = Number((J = y == null ? void 0 : y[0]) == null ? void 0 : J.y), P = t.clientWidth, oe = t.clientHeight;
    return !Number.isFinite(k) || k < -80 || k > P + 80 ? null : {
      timestamp: u,
      text: Qo(u),
      left: Math.max(58, Math.min(k, P - 58)),
      top: Number.isFinite(A) ? Math.max(8, Math.min(A - 42, oe - 38)) : 10
    };
  }, xr = () => {
    const o = a1();
    if (!o || !n || !t)
    ...
    const s = en(z()), u = Math.max(1, Math.floor(i / 2)) * s;
    return {
      from: o - u,
      to: o + u
    };
    ...
    const m = (P = n.convertFromPixel) == null ? void 0 : P.call(n, [{
      ...
      paneId: "candle_pane",
      absolute: !0
    }), g = Number((oe = m == null ? void 0 : m[0]) == null ? void 0 : oe.dataIndex), f = Math.max(0, Math.min(u.length - 1, Number.isFinite(g) ? Math.round(g) : -1)), y = Ho(i);
    if (y) {
    ...
    const s = n9(i), u = (P = n.getDom) == null ? void 0 : P.call(n, "candle_pane", at.Main), m = (oe = u == null ? void 0 : u.getBoundingClientRect) == null ? void 0 : oe.call(u), g = (ae = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : ae.call(r), f = (ie = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : ie.call(t), y = n.getSize("candle_pane", at.Main), k = m && Number.isFinite(m.top) ? m.top - ((g == null ? void 0 : g.top) ?? (f == null ? void 0 : f.top) ?? 0) : 0, A = Math.max(1, (m == null ? void 0 : m.height) ?? (y == null ? void 0 : y.height) ?? 0);
    if (s === null) {
      s1(null);
      return;
    }
    ...
    if (n) {
      ...
      try {
        const s = z(), u = o.from <= o.to ? o : {
          from: o.to,
          to: o.from
        }, m = Wo(u), g = i ? m : e9(m, s), f = await e.datafeed.getHistoryKLineData(N(), s, g.from, g.to), y = Go(f, m);
  ...
  Qn(() => {
    ...
    e.subIndicators.forEach((f) => {
      ...
      h(!0), (async () => {
        try {
          const k = z(), [A] = _n(k, f, 1), [P] = _n(k, A, 500), oe = await e.datafeed.getHistoryKLineData(N(), k, P, A);
  ...
  return Re((o) => {
    ...
    const o = Cg.cloneNode(!0), i = o.firstChild;
    return o.addEventListener("mouseleave", () => {
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = bg.cloneNode(!0), m = u.firstChild, g = m.nextSibling;
        return u.style.setProperty("right", "0px"), C(m, () => s.priceText), C(g, () => s.text), V((f) => {
          const y = `${s.top}px`, k = `${s.width}px`, A = s.color, P = `${s.borderRadius}px`, oe = s.textFamily, ae = s.textWeight, ie = `${s.paddingLeft}px`, J = `${s.paddingRight}px`, ue = `${s.paddingTop}px`, be = `${s.paddingBottom}px`, Se = `${s.textSize}px`, G = `${Math.max(10, s.textSize - 1)}px`;
          return y !== f._v$6 && u.style.setProperty("top", f._v$6 = y), k !== f._v$7 && u.style.setProperty("width", f._v$7 = k), A !== f._v$8 && u.style.setProperty("background", f._v$8 = A), P !== f._v$9 && u.style.setProperty("border-radius", f._v$9 = P), oe !== f._v$10 && u.style.setProperty("font-family", f._v$10 = oe), ae !== f._v$11 && u.style.setProperty("font-weight", f._v$11 = ae), ie !== f._v$12 && u.style.setProperty("padding-left", f._v$12 = ie), J !== f._v$13 && u.style.setProperty("padding-right", f._v$13 = J), ue !== f._v$14 && u.style.setProperty("padding-top", f._v$14 = ue), be !== f._v$15 && u.style.setProperty("padding-bottom", f._v$15 = be), Se !== f._v$16 && m.style.setProperty("font-size", f._v$16 = Se), G !== f._v$17 && g.style.setProperty("font-size", f._v$17 = G), f;
        }, {
          _v$6: void 0,
          _v$7: void 0,
          _v$8: void 0,
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = xg.cloneNode(!0), m = u.firstChild, g = m.nextSibling, f = g.nextSibling, y = f.firstChild, k = f.nextSibling, A = k.firstChild, P = A.firstChild, oe = P.nextSibling, ae = oe.firstChild, ie = k.nextSibling, J = ie.firstChild, ue = ie.nextSibling, be = ue.nextSibling, Se = be.nextSibling;
        return u.$$click = (G) => {
          G.stopPropagation();
        }, u.$$mousedown = (G) => {
          G.preventDefault(), G.stopPropagation();
        }, m.$$mousedown = B1, g.$$click = I1, y.$$click = () => He(Ze() === "color" ? null : "color"), C(f, w(ce, {
          get when() {
            return Ze() === "color";
          },
          get children() {
            const G = $g.cloneNode(!0), Ce = G.firstChild;
            return C(Ce, w(b1, {
              each: A1,
              children: (me) => (() => {
                const we = Lg.cloneNode(!0);
        ...
        }), null), A.$$click = () => He(Ze() === "width" ? null : "width"), C(oe, () => s.lineSize, ae), C(k, w(ce, {
          get when() {
            return Ze() === "width";
          },
          get children() {
            const G = _g.cloneNode(!0);
            return C(G, w(b1, {
              each: [1, 2, 3, 4],
              children: (Ce) => (() => {
                const me = wg.cloneNode(!0), we = me.firstChild;
          ...
          get children() {
            const G = kg.cloneNode(!0), Ce = G.firstChild, me = Ce.nextSibling, we = me.nextSibling;
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = Ag.cloneNode(!0), m = u.firstChild;
      ...
      keyed: !0,
      children: (s) => (() => {
        const u = Sg.cloneNode(!0), m = u.firstChild, g = m.firstChild, f = g.firstChild, y = f.nextSibling, k = y.nextSibling, A = k.nextSibling;
        A.nextSibling;
        const P = g.nextSibling, oe = P.firstChild, ae = oe.nextSibling, ie = ae.nextSibling, J = ie.nextSibling;
        J.nextSibling;
        ...
        }, g.$$click = () => Rt("limit"), C(g, () => N().shortName ?? N().name ?? N().ticker, y), C(g, () => Dt(s.price), A), P.$$click = () => Rt("stop"), C(P, () => N().shortName ?? N().name ?? N().ticker, ae), C(P, () => Dt(s.price), J), ue.$$click = () => Rt("create"), be.$$click = bn, C(be, () => Dt(s.price), G), Ce.$$click = $n, C(Ce, () => Dt(s.price), null), V((me) => {

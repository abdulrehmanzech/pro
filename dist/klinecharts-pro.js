...
import { utils as o1, OverlayMode as bt, LineType as H1, init as o5, FormatDateType as ze, DomPosition as $t, ActionType as Qe, dispose as m0, TooltipIconPosition as Ze, CandleType as s5, YAxisType as l5, registerOverlay as c5 } from "klinecharts";
function Ne(e, t, r) {
...
var h1 = null;
let re = null, n1 = null, v1 = null, Y1 = null, Nt = 0;
function Ee(e, t) {
...
function l9(e, t, r) {
  ...
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && J1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      u && re.disposed.has(l), (u && !l.tState || !u && !l.state) && (l.pure ? v1.push(l) : Y1.push(l), l.observers && u9(l)), u || (l.state = G1);
    }
    if (v1.length > 1e6)
      throw v1 = [], new Error();
  }, !1)), t;
...
function We(e) {
  ...
  if (e.state === Ge || t)
    return Xe(e);
  if (e.suspense && q1(e.suspense.inFallback))
...
function Xe(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    const a = e.sources[n];
    a.sources && (a.state === G1 || r ? a !== t && We(a) : (a.state === Ge || r) && Xe(a, t));
  }
}
function u9(e) {
  const t = re;
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = Ge, n.pure ? v1.push(n) : Y1.push(n), n.observers && u9(n));
  }
}
function at(e) {
  let t;
        ...
        return ne((W) => {
          ...
          get children() {
            return k(R5, {
              ...
              get children() {
                const W = du.cloneNode(!0), _1 = W.firstChild, w1 = _1.firstChild, F1 = w1.firstChild, z1 = F1.firstChild, R1 = z1.firstChild, V1 = w1.nextSibling, ke = V1.firstChild, D1 = ke.firstChild, Le = D1.firstChild, ht = ke.nextSibling, le = ht.firstChild, W1 = le.firstChild, Ue = _1.nextSibling, M1 = Ue.firstChild, k1 = M1.firstChild, K1 = Ue.nextSibling, S1 = K1.nextSibling, yt = S1.firstChild, ce = yt.firstChild, xe = S1.nextSibling, Fe = xe.nextSibling, d1 = Fe.firstChild, f1 = d1.firstChild;
                return W.$$mousedown = (T) => T.stopPropagation(), ne((T) => {
                ...
                }, z1.$$click = (T) => T.stopPropagation(), R1.addEventListener("change", (T) => {
                  var N;
                  (N = e.onOrderToolsStateChange) == null || N.call(e, {
                    quickOrder: T.currentTarget.checked
                  });
                }), R1.$$click = (T) => T.stopPropagation(), Le.addEventListener("change", (T) => {
                  var N;
                  (N = e.onOrderToolsStateChange) == null || N.call(e, {
                  ...
                  const N = `${L().top}px`, j1 = `${L().left}px`, N1 = `${L().minWidth}px`, Ke = `klinecharts-pro-order-tools-group${f() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return N !== T._v$ && W.style.setProperty("top", T._v$ = N), j1 !== T._v$2 && W.style.setProperty("left", T._v$2 = j1), N1 !== T._v$3 && W.style.setProperty("width", T._v$3 = N1), Ke !== T._v$4 && y1(_1, T._v$4 = Ke), T;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var T, N, j1, N1;
                  return R1.checked = (((T = e.orderToolsState) == null ? void 0 : T.quickOrderFloatingWindow) ?? ((N = e.orderToolsState) == null ? void 0 : N.quickOrder) ?? !0) || (((j1 = e.orderToolsState) == null ? void 0 : j1.quickOrderPlusButton) ?? ((N1 = e.orderToolsState) == null ? void 0 : N1.quickOrder) ?? !0);
                }), B(() => {
                  var T, N;
        ...
        return () => _1() && k(nt, {
          ...
          get children() {
            return C.list.map((w1) => (() => {
              const F1 = X0.cloneNode(!0), z1 = F1.firstChild;
              return F1.$$click = () => {
...
const Ah = (e) => {
  ...
  const T = (i, s, d) => {
    ...
    document.addEventListener("mouseup", h), document.addEventListener("touchend", h), setTimeout(() => {
      ...
      if (m && !m.complete) {
        ...
        const y = d1.get(i);
        if (y) {
          const v = j1(y.type), A = ((p = y.points) == null ? void 0 : p.length) || 0;
      ...
      try {
        const d = `kline_drawings_${i}`, m = {
          drawings: s.map((p) => {
            ...
            const v = j1(p.type), A = ((M = p.points) == null ? void 0 : M.length) || 0;
    ...
    return {
      ...
      styles: {
        ...
        line: {
          ...
          style: ((P = (M = i.styles) == null ? void 0 : M.line) == null ? void 0 : P.style) ?? H1.Solid,
  ...
  P1(() => {
    ...
    saveDrawings: (i) => {
      ...
      s.forEach((d, h) => {
        var y;
        const m = j1(d.type), p = ((y = d.points) == null ? void 0 : y.length) || 0;
  ...
  return Et(() => {
    ...
    return i.addEventListener("mouseleave", () => {
      ...
      children: (d) => (() => {
        ...
        return h.$$click = (F) => {
        ...
        }, m.$$mousedown = r5, p.$$click = e5, v.$$click = () => S1(K1() === "color" ? null : "color"), _(y, k(z, {
          get when() {
            return K1() === "color";
          },
          get children() {
        ...
        }), null), M.$$click = () => S1(K1() === "width" ? null : "width"), _(q, () => d.lineSize, i1), _(A, k(z, {
          get when() {
            return K1() === "width";
          },
          get children() {
        ...
        }), null), C1.$$click = () => S1(K1() === "style" ? null : "style"), _(l1, k(z, {
          get when() {
            return K1() === "style";
          },
          get children() {
            const F = bh.cloneNode(!0), p1 = F.firstChild, a1 = p1.nextSibling, $1 = a1.nextSibling;
            return p1.$$click = () => pt(H1.Solid, []), a1.$$click = () => pt(H1.Dashed, [6, 4]), $1.$$click = () => pt(H1.Dashed, [2, 4]), B((T1) => {
              var Pe, Oe;
              const Me = d.lineStyle === H1.Solid ? "selected" : "", Se = d.lineStyle === H1.Dashed && ((Pe = d.dashedValue) == null ? void 0 : Pe[0]) === 6 ? "selected" : "", Te = d.lineStyle === H1.Dashed && ((Oe = d.dashedValue) == null ? void 0 : Oe[0]) === 2 ? "selected" : "";
          ...
          const p1 = `${d.x}px`, a1 = `${d.y}px`, $1 = `overlay-toolbar-icon edit ${K1() === "color" ? "active" : ""}`, T1 = `overlay-toolbar-line-size ${K1() === "width" ? "active" : ""}`, Me = `overlay-toolbar-icon minus ${K1() === "style" ? "active" : ""}`, Se = `overlay-toolbar-icon visibility ${d.visible ? "" : "muted"}`, Te = d.visible ? "Hide" : "Show", Pe = `overlay-toolbar-icon lock ${d.locked ? "active" : ""}`, Oe = d.locked ? "Unlock" : "Lock";

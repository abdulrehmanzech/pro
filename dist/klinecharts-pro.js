...
import { utils as j, OverlayMode as ne, init as O9, FormatDateType as J1, DomPosition as re, ActionType as B9, dispose as ae, TooltipIconPosition as W1, CandleType as E9, YAxisType as F9, registerOverlay as K9 } from "klinecharts";
function R1(e, t, n) {
...
const j9 = {
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    ...
    if (e.length > 1) {
      ...
      c.forEach((d) => {
        const p = e[1].y + s * d, b = (u[1].value + h * d).toFixed(n.price);
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = Ue(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = j.getLinearSlopeIntercept(e[0], e[1]);
      let i;
      ...
      for (let p = 2; p < 9; p++) {
        ...
        const P = A + Math.PI / 2, Z = R1({ x: h, y: d }, e[0], i);
        u.push({
          ...Z,
          r: b,
          startAngle: A,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((d) => {
        const p = e[1].x - s * d, b = e[1].y - u * d;
        n.push({ coordinates: [{ x: p, y: e[0].y }, { x: p, y: e[1].y }] }), n.push({ coordinates: [{ x: e[0].x, y: b }, { x: e[1].x, y: b }] }), r = r.concat(A0([e[0], { x: p, y: e[1].y }], t)), r = r.concat(A0([e[0], { x: e[1].x, y: b }], t)), a.unshift({
          x: e[0].x + i,
          y: b + 10,
          text: `${d.toFixed(3)}`
        }), a.unshift({
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: n }) => {
    ...
    if (e.length > 2) {
      ...
      u.forEach((d) => {
        const p = e[2].y + s * d, b = (i[2].value + c * d).toFixed(n.price);
...
var X = null;
let b1 = null, F = null, q = null, d1 = null, O0 = 0;
function n0(e, t) {
  const n = F, r = X, a = e.length === 0, i = a ? He : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function o5(e, t, n) {
  ...
  let c = null, s = $0, u = null, h = !1, d = "initialValue" in i, p = typeof r == "function" && Y(r);
  const b = /* @__PURE__ */ new Set(), [A, P] = (i.storage || w)(i.initialValue), [Z, z] = w(void 0), [N, V] = w(void 0, {
    equals: !1
  }), [O, I] = w(d ? "ready" : "unresolved");
  if (t1.context) {
  ...
  function M(T, K, R, u1) {
    return c === T && (c = null, d = !0, (T === s || K === s) && i.onHydrated && queueMicrotask(() => i.onHydrated(u1, {
      value: K
    })), s = $0, Q(K, R)), K;
  }
  function Q(T, K) {
    p1(() => {
      K === void 0 && P(() => T), I(K !== void 0 ? "errored" : "ready"), z(K);
  ...
  function n1() {
    ...
    if (R !== void 0 && !c)
      throw R;
    return F && !F.user && T && ie(() => {
      N(), c && (T.resolved || b.has(T) || (T.increment(), b.add(T)));
    }), K;
  }
  function l1(T = !0) {
    if (T !== !1 && h)
    ...
    return typeof R != "object" || !(R && "then" in R) ? (M(c, R, void 0, K), R) : (c = R, h = !0, queueMicrotask(() => h = !1), p1(() => {
      I(d ? "refreshing" : "pending"), V();
    }, !1), R.then((u1) => M(R, u1, void 0, K), (u1) => M(R, void 0, qe(u1), K)));
  }
...
function Xe(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && p1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      c && b1.disposed.has(i), (c && !i.tState || !c && !i.state) && (i.pure ? q.push(i) : d1.push(i), i.observers && We(i)), c || (i.state = h1);
    }
    if (q.length > 1e6)
      throw q = [], new Error();
  }, !1)), t;
...
function h5(e, t, n = {}) {
  ...
  return B0(() => se(i)), () => {
    let u = e() || [], h, d;
    return u[s5], C1(() => {
      let b = u.length, A, P, Z, z, N, V, O, I, M;
      if (b === 0)
        c !== 0 && (se(i), i = [], r = [], a = [], c = 0, s && (s = [])), n.fallback && (r = [C5], a[0] = n0((Q) => (i[0] = Q, n.fallback())), c = 1);
      else if (c === 0) {
        for (a = new Array(b), d = 0; d < b; d++)
          r[d] = u[d], a[d] = n0(p);
        c = b;
      } else {
        for (Z = new Array(b), z = new Array(b), s && (N = new Array(b)), V = 0, O = Math.min(c, b); V < O && r[V] === u[V]; V++)
          ;
        for (O = c - 1, I = b - 1; O >= V && I >= V && r[O] === u[I]; O--, I--)
          Z[I] = a[O], z[I] = i[O], s && (N[I] = s[O]);
        for (A = /* @__PURE__ */ new Map(), P = new Array(I + 1), d = I; d >= V; d--)
          M = u[d], h = A.get(M), P[d] = h === void 0 ? -1 : h, A.set(M, d);
        for (h = V; h <= O; h++)
          M = r[h], d = A.get(M), d !== void 0 && d !== -1 ? (Z[d] = a[h], z[d] = i[h], s && (N[d] = s[h]), d = P[d], A.set(M, d)) : i[h]();
        for (d = V; d < b; d++)
  ...
  for (; c < a || s < i; ) {
    ...
    if (a === c) {
      ...
      if (d != null)
        if (s < d && d < i) {
          let p = c, b = 1, A;
          for (; ++p < a && p < i && !((A = h.get(t[p])) == null || A !== d + b); )
            b++;
          if (b > d - s) {
            const P = t[c];
            for (; s < d; )
...
var I1 = K5, j5 = U1, Z5 = I1, Q5 = "[object AsyncFunction]", z5 = "[object Function]", R5 = "[object GeneratorFunction]", U5 = "[object Proxy]";
function Y5(e) {
  if (!Z5(e))
    return !1;
  var t = j5(e);
...
var K0 = P6, O6 = T1, B6 = K0, E6 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, F6 = /^\w*$/;
function K6(e, t) {
  if (O6(e))
    return !1;
  var n = typeof e;
...
var j6 = K6, Z6 = k1, Q6 = Z6(Object, "create"), y0 = Q6, he = y0;
function z6() {
...
P1.prototype.has = O2;
P1.prototype.set = B2;
var m0 = P1, E2 = k1, F2 = c1, K2 = E2(F2, "Map"), j0 = K2, ge = C2, j2 = m0, Z2 = j0;
function Q2() {
...
var b3 = $3, ye = g0, x3 = b3, k3 = T1, A3 = K0, w3 = 1 / 0, pe = ye ? ye.prototype : void 0, me = pe ? pe.toString : void 0;
function f9(e) {
  if (typeof e == "string")
    return e;
  if (k3(e))
...
var R3 = z3, U3 = F0, Y3 = E3, H3 = d9, ve = I1, V3 = R3;
function G3(e, t, n, r) {
  if (!ve(e))
    return e;
  t = Y3(t, e);
  for (var a = -1, i = t.length, c = i - 1, s = e; s != null && ++a < i; ) {
    ...
    if (a != c) {
      var d = s[u];
      h = r ? r(d, u, s) : void 0, h === void 0 && (h = ve(d) ? d : H3(t[a + 1]) ? [] : {});
    }
    U3(s, u, h), s = s[u];
  }
  return e;
...
var N8 = D8, _e = N8, P8 = D1, C9 = Object.prototype, O8 = C9.hasOwnProperty, B8 = C9.propertyIsEnumerable, E8 = _e(function() {
  return arguments;
}()) ? _e : function(e) {
...
var g9 = Q8, z8 = U1, R8 = g9, U8 = D1, Y8 = "[object Arguments]", H8 = "[object Array]", V8 = "[object Boolean]", G8 = "[object Date]", X8 = "[object Error]", J8 = "[object Function]", W8 = "[object Map]", q8 = "[object Number]", et = "[object Object]", tt = "[object RegExp]", nt = "[object Set]", rt = "[object String]", at = "[object WeakMap]", it = "[object ArrayBuffer]", st = "[object DataView]", ot = "[object Float32Array]", ct = "[object Float64Array]", lt = "[object Int8Array]", ut = "[object Int16Array]", ft = "[object Int32Array]", dt = "[object Uint8Array]", Ct = "[object Uint8ClampedArray]", ht = "[object Uint16Array]", gt = "[object Uint32Array]", E = {};
E[ot] = E[ct] = E[lt] = E[ut] = E[ft] = E[dt] = E[Ct] = E[ht] = E[gt] = !0;
E[Y8] = E[H8] = E[it] = E[V8] = E[st] = E[G8] = E[X8] = E[J8] = E[W8] = E[q8] = E[et] = E[tt] = E[nt] = E[rt] = E[at] = !1;
function yt(e) {
...
var z0 = u0.exports, vt = pt, _t = Q0, Le = z0, $e = Le && Le.isTypedArray, Lt = $e ? _t($e) : vt, $t = Lt, bt = M8, xt = F8, kt = T1, At = h9, wt = d9, Mt = $t, St = Object.prototype, It = St.hasOwnProperty;
function Tt(e, t) {
...
var p9 = Pt, Ot = p9, Bt = Ot(Object.keys, Object), Et = Bt, Ft = R0, Kt = Et, jt = Object.prototype, Zt = jt.hasOwnProperty;
function Qt(e) {
  if (!Ft(e))
    return Kt(e);
  var t = [];
...
var zt = Qt, Rt = i9, Ut = g9;
function Yt(e) {
  return e != null && Ut(e.length) && !Rt(e);
}
...
var n7 = t7, r7 = I1, a7 = R0, i7 = n7, s7 = Object.prototype, o7 = s7.hasOwnProperty;
function c7(e) {
  if (!r7(e))
    return i7(e);
  var t = a7(e), n = [];
...
(function(e, t) {
  ...
  function u(h, d) {
    if (d)
      return h.slice();
    var p = h.length, b = s ? s(p) : new h.constructor(p);
    return h.copy(b), b;
  }
  e.exports = u;
})(f0, f0.exports);
...
var an = rn, sn = k1, on = c1, cn = sn(on, "DataView"), ln = cn, un = k1, fn = c1, dn = un(fn, "Promise"), Cn = dn, hn = k1, gn = c1, yn = hn(gn, "Set"), pn = yn, mn = k1, vn = c1, _n = mn(vn, "WeakMap"), Ln = _n, I0 = ln, T0 = j0, D0 = Cn, N0 = pn, P0 = Ln, x9 = U1, E1 = s9, xe = "[object Map]", $n = "[object Object]", ke = "[object Promise]", Ae = "[object Set]", we = "[object WeakMap]", Me = "[object DataView]", bn = E1(I0), xn = E1(T0), kn = E1(D0), An = E1(N0), wn = E1(P0), $1 = x9;
(I0 && $1(new I0(new ArrayBuffer(1))) != Me || T0 && $1(new T0()) != xe || D0 && $1(D0.resolve()) != ke || N0 && $1(new N0()) != Ae || P0 && $1(new P0()) != we) && ($1 = function(e) {
  var t = x9(e), n = t == $n ? e.constructor : void 0, r = n ? E1(n) : "";
  if (r)
    switch (r) {
      case bn:
        return Me;
...
var T4 = I4, D4 = T4, N4 = Q0, Pe = z0, Oe = Pe && Pe.isMap, P4 = Oe ? N4(Oe) : D4, O4 = P4, B4 = V0, E4 = D1, F4 = "[object Set]";
function K4(e) {
  return E4(e) && B4(e) == F4;
}
var j4 = K4, Z4 = j4, Q4 = Q0, Be = z0, Ee = Be && Be.isSet, z4 = Ee ? Q4(Ee) : Z4, R4 = z4, U4 = L8, Y4 = b8, H4 = F0, V4 = e7, G4 = p7, X4 = m7, J4 = _7, W4 = D7, q4 = U7, er = q7, tr = an, nr = V0, rr = Tn, ar = m4, ir = A4, sr = T1, or = h9, cr = O4, lr = I1, ur = R4, fr = U0, dr = Y0, Cr = 1, hr = 2, gr = 4, k9 = "[object Arguments]", yr = "[object Array]", pr = "[object Boolean]", mr = "[object Date]", vr = "[object Error]", A9 = "[object Function]", _r = "[object GeneratorFunction]", Lr = "[object Map]", $r = "[object Number]", w9 = "[object Object]", br = "[object RegExp]", xr = "[object Set]", kr = "[object String]", Ar = "[object Symbol]", wr = "[object WeakMap]", Mr = "[object ArrayBuffer]", Sr = "[object DataView]", Ir = "[object Float32Array]", Tr = "[object Float64Array]", Dr = "[object Int8Array]", Nr = "[object Int16Array]", Pr = "[object Int32Array]", Or = "[object Uint8Array]", Br = "[object Uint8ClampedArray]", Er = "[object Uint16Array]", Fr = "[object Uint32Array]", B = {};
B[k9] = B[yr] = B[Mr] = B[Sr] = B[pr] = B[mr] = B[Ir] = B[Tr] = B[Dr] = B[Nr] = B[Pr] = B[Lr] = B[$r] = B[w9] = B[br] = B[xr] = B[kr] = B[Ar] = B[Or] = B[Br] = B[Er] = B[Fr] = !0;
B[vr] = B[A9] = B[wr] = !1;
function r0(e, t, n, r, a, i) {
  var c, s = t & Cr, u = t & hr, h = t & gr;
  ...
  var P = h ? u ? tr : er : u ? dr : fr, Z = d ? void 0 : P(e);
  return Y4(Z || e, function(z, N) {
    Z && (N = z, z = e[N]), H4(c, N, r0(z, t, n, N, e, i));
  }), c;
}
...
var Rr = zr;
const Ur = /* @__PURE__ */ n9(Rr), Yr = /* @__PURE__ */ y("<button></button>"), Hr = (e) => (() => {
...
o1(["click"]);
const oa = /* @__PURE__ */ y('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), ca = /* @__PURE__ */ y('<div class="drop-down-container"><ul></ul></div>'), la = /* @__PURE__ */ y("<li></li>"), S9 = (e) => {
  const [t, n] = w(!1);
  return (() => {
      ...
      return () => c() && (() => {
        ...
        return L(u, () => e.dataSource.map((h) => {
          ...
          return (() => {
            ...
            return b.$$click = (A) => {
              var P;
              A.stopPropagation(), e.value !== p && ((P = e.onSelected) == null || P.call(e, h)), n(!1);
            }, L(b, p), b;
          })();
        })), s;
      })();
...
o1(["click"]);
const ua = /* @__PURE__ */ y('<span class="prefix"></span>'), fa = /* @__PURE__ */ y('<span class="suffix"></span>'), da = /* @__PURE__ */ y('<div><input class="value"></div>'), I9 = (e) => {
  const t = t9({
  ...
  return (() => {
    ...
    return i.$$click = () => {
      ...
      if ("precision" in t) {
        ...
        b <= 0 ? p = new RegExp(/^[1-9]\d*$/) : p = new RegExp("^\\d+\\.?\\d{0," + b + "}$"), (u === "" || p.test(u) && +u >= t.min && +u <= t.max) && ((h = t.onChange) == null || h.call(t, u === "" ? u : +u));
      } else
      ...
      const u = t.style, h = `klinecharts-pro-input ${t.class ?? ""}`, d = r(), p = t.placeholder ?? "";
      return s._v$ = S1(i, u, s._v$), h !== s._v$2 && x1(i, s._v$2 = h), d !== s._v$3 && r1(i, "data-status", s._v$3 = d), p !== s._v$4 && r1(c, "placeholder", s._v$4 = p), s;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
const f = (e, t) => {
  ...
  return Ve(() => {
    ...
    const i = Dc.cloneNode(!0), c = i.firstChild, s = c.firstChild, u = c.nextSibling, h = u.firstChild, d = h.nextSibling, p = u.nextSibling, b = p.firstChild, A = b.nextSibling, P = p.nextSibling, Z = P.firstChild, z = Z.nextSibling, N = P.nextSibling, V = N.firstChild, O = V.nextSibling, I = N.nextSibling;
    return E0((M) => {
      t = M;
      ...
      get children() {
        const M = Tc.cloneNode(!0), Q = M.firstChild;
      ...
      return Q.$$click = () => {
        e.onPeriodChange(M);
      }, L(Q, () => M.text), G(() => x1(Q, `item period ${M.text === e.period.text ? "selected" : ""}`)), Q;
    })()), u), y1(u, "click", e.onIndicatorClick, !0), L(d, () => f("indicator", e.locale)), y1(p, "click", e.onTimezoneClick, !0), L(A, () => f("timezone", e.locale)), y1(P, "click", e.onSettingClick, !0), L(z, () => f("setting", e.locale)), y1(N, "click", e.onScreenshotClick, !0), L(O, () => f("screenshot", e.locale)), I.$$click = () => {
      if (n())
...
const a1 = (e) => nu[e.name](e.class), lu = /* @__PURE__ */ y('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), uu = /* @__PURE__ */ y('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Ke = /* @__PURE__ */ y('<li><span style="padding-left:8px"></span></li>'), je = "drawing_tools", fu = (e) => {
  ...
  return (() => {
    const n1 = lu.cloneNode(!0), l1 = n1.firstChild, T = l1.nextSibling, K = T.firstChild, R = K.nextSibling, u1 = R.firstChild, K1 = T.nextSibling, j1 = K1.firstChild, m1 = K1.nextSibling, Y1 = m1.firstChild, H1 = m1.nextSibling, V1 = H1.nextSibling, G1 = V1.firstChild;
    return L(n1, () => M().map((D) => (() => {
      ...
      return () => D() && _(d0, {
        ...
        get children() {
          return Q().map((J) => (() => {
            ...
            return i1.$$click = () => {
              b(J.key), P(J.key), e.onModeChange(J.key), I("");
            }, L(i1, _(a1, {
              get name() {
                return J.key;
              }
...
o1(["click"]);
const Ze = /* @__PURE__ */ y('<li class="title"></li>'), Qe = /* @__PURE__ */ y('<li class="row"></li>'), du = (e) => _(F1, {
  get title() {
...
const hu = (e) => {
  const [t, n] = w(e.timezone), r = Y(() => Cu(e.locale));
  return _(F1, {
    get title() {
...
const gu = /* @__PURE__ */ y('<div class="klinecharts-pro-setting-modal-content"></div>'), yu = /* @__PURE__ */ y("<span></span>"), pu = (e) => {
  const [t, n] = w(e.currentStyles), [r, a] = w(Re(e.locale));
  f1(() => {
    a(Re(e.locale));
  });
  const i = (c, s) => {
...
}, mu = /* @__PURE__ */ y('<img style="width:500px;margin-top: 20px">'), vu = (e) => _(F1, {
  get title() {
  ...
  const [t, n] = w(j.clone(e.params.calcParams)), r = (a) => _u[a];
  return _(F1, {
    get title() {
    ...
    get buttons() {
      return [{
        ...
        onClick: () => {
          ...
          j.clone(t()).forEach((c, s) => {
            !j.isValid(c) || c === "" ? "default" in a[s] && i.push(a[s].default) : i.push(c);
...
const Iu = (e) => {
  let t, n = null, r, a = !1;
  const [i, c] = w(e.theme), [s, u] = w(e.styles), [h, d] = w(e.locale), [p, b] = w(e.symbol), [A, P] = w(e.period), [Z, z] = w(!1), [N, V] = w([...e.mainIndicators]), [O, I] = w({}), [M, Q] = w(!1), [n1, l1] = w({
    key: e.timezone,
    text: ze(e.timezone, e.locale)
  }), [T, K] = w(!1), [R, u1] = w(), [K1, j1] = w(""), [m1, Y1] = w(e.drawingBarVisible), [H1, V1] = w(!1), [G1, D] = w(!1), [J, i1] = w({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const v1 = (o) => ({
    ...
    try {
      ...
      const k = A1($);
      if (k) {
        const C = H.get(o), v = ((g = C == null ? void 0 : C.points) == null ? void 0 : g.length) || 0, x = ((m = k.points) == null ? void 0 : m.length) || 0;
        H.set(o, k);
        const S = v1(k.type);
        if (x >= S) {
          const U = e1.get(o);
    ...
    document.addEventListener("mouseup", m), document.addEventListener("touchend", m), setTimeout(() => {
      ...
      const $ = e1.get(o);
      if ($ && !$.complete) {
        $.checkInterval && clearInterval($.checkInterval), $.mouseUpHandler && (document.removeEventListener("mouseup", $.mouseUpHandler), document.removeEventListener("touchend", $.mouseUpHandler)), _1(o);
        const C = H.get(o);
        if (C) {
          const v = v1(C.type), x = ((k = C.points) == null ? void 0 : k.length) || 0;
          x < v && console.warn(`⚠️ ${C.type} ${o} has only ${x} point(s), should have ${v}`);
        }
      }
    }, 3e4);
  };
  let L1 = {
      ...
      try {
        const g = `kline_drawings_${o}`, $ = {
          drawings: l.map((k) => {
            ...
            const v = v1(k.type), x = ((S = k.points) == null ? void 0 : S.length) || 0;
            return x < v && console.warn(`⚠️ Saving ${k.type} with only ${x} point(s), needs ${v}`), C;
          }),
          timestamp: Date.now()
        };
        localStorage.setItem(g, JSON.stringify($, null, 2));
      } catch (g) {
    ...
    loadDrawings: (o) => {
      try {
        const l = `kline_drawings_${o}`, g = localStorage.getItem(l);
        if (g) {
          const m = JSON.parse(g), $ = [];
          return m.drawings && m.drawings.forEach((k, C) => {
            var S;
            const v = v1(k.type), x = ((S = k.points) == null ? void 0 : S.length) || 0;
            x >= v ? $.push(k) : console.warn(`📥 Skipping ${k.type}: Only ${x} point(s), need ${v}`);
          }), $;
        }
      } catch (l) {
  ...
  e.ref({
    ...
    removeOverlay: (o) => {
      ...
      if ((l = n == null ? void 0 : n.removeOverlay) == null || l.call(n, o), o.id) {
        H.delete(o.id);
        const g = e1.get(o.id);
        g && (g.checkInterval && clearInterval(g.checkInterval), g.mouseUpHandler && (document.removeEventListener("mouseup", g.mouseUpHandler), document.removeEventListener("touchend", g.mouseUpHandler)), e1.delete(o.id)), X0();
      }
    },
    removeAllOverlay: () => {
      H.forEach((o, l) => {
    ...
    getSettings: () => {
      var g, m, $, k, C, v, x, S, U, g1, Z1, X1, W0, q0, ee, te;
      if (!n)
        return {};
      const o = n.getStyles(), l = (g = o.candle) == null ? void 0 : g.bar;
      return {
        // Candle settings
        candleType: (m = o.candle) == null ? void 0 : m.type,
        candleBarStyle: l == null ? void 0 : l.style,
        // bar.style might be LineType
        showLastPrice: (C = (k = ($ = o.candle) == null ? void 0 : $.priceMark) == null ? void 0 : k.last) == null ? void 0 : C.show,
        showHighestPrice: (S = (x = (v = o.candle) == null ? void 0 : v.priceMark) == null ? void 0 : x.high) == null ? void 0 : S.show,
        showLowestPrice: (Z1 = (g1 = (U = o.candle) == null ? void 0 : U.priceMark) == null ? void 0 : g1.low) == null ? void 0 : Z1.show,
        // Indicator settings
    ...
    setSettings: (o) => {
      ...
      if (o.candleType !== void 0 && (l.candle = {
        ...
        const X1 = ((g = l.candle) == null ? void 0 : g.bar) || {};
        l.candle = {
          ...l.candle,
          bar: {
            ...X1,
      ...
      o.showLastPrice !== void 0 && (l.candle = {
        ...l.candle,
        priceMark: {
          ...(m = l.candle) == null ? void 0 : m.priceMark,
          last: {
            ...(k = ($ = l.candle) == null ? void 0 : $.priceMark) == null ? void 0 : k.last,
        ...
        priceMark: {
          ...
          high: {
            ...(x = (v = l.candle) == null ? void 0 : v.priceMark) == null ? void 0 : x.high,
        ...
        priceMark: {
          ...
          low: {
            ...(g1 = (U = l.candle) == null ? void 0 : U.priceMark) == null ? void 0 : g1.low,
    ...
    resetSettings: () => {
      ...
      if (l) {
        const S = {
          candle: {
            type: (g = l.candle) == null ? void 0 : g.type,
            bar: (m = l.candle) == null ? void 0 : m.bar,
          ...
          grid: {
            show: (x = l.grid) == null ? void 0 : x.show
          }
        };
        n.setStyles(S);
      } else
    ...
    saveDrawings: (o) => {
      ...
      l.forEach((g, m) => {
        var C;
        const $ = v1(g.type), k = ((C = g.points) == null ? void 0 : C.length) || 0;
        k < $ && console.warn(`⚠️ ${g.type} ${g.id} has only ${k} point(s), should have ${$}`);
      }), L1.saveDrawings(o, l);
    },
    loadDrawings: (o) => {
      L1.loadDrawings(o).forEach((g, m) => {
        var $;
        try {
          const k = {
            name: g.type,
            ...
            visible: g.visible ?? !0,
            lock: g.lock ?? !1,
            mode: g.mode ?? ne.Normal
          }, C = n == null ? void 0 : n.createOverlay(k);
          C && (H.set(C, {
            ...g,
            id: C
          }), e1.set(C, {
            monitoring: !1,
            complete: !0,
            lastPointCount: (($ = g.points) == null ? void 0 : $.length) || 0
          }));
        } catch (k) {
          console.error(`   ❌ Error restoring ${g.type}:`, k);
        }
      });
    },
    ...
    enableAutoSave: (o, l = !0) => {
      if (l) {
        const g = setInterval(() => {
          ...
          m.length > 0 && L1.saveDrawings(o, m);
        }, 3e4);
        return () => {
          clearInterval(g);
        };
  ...
  const J0 = () => {
    ...
    switch (o.timespan) {
      case "minute": {
        m = m - m % (60 * 1e3), $ = m - g * o.multiplier * 60 * 1e3;
        break;
      }
      case "hour": {
        m = m - m % (60 * 60 * 1e3), $ = m - g * o.multiplier * 60 * 60 * 1e3;
        break;
      }
      case "day": {
        m = m - m % (60 * 60 * 1e3), $ = m - g * o.multiplier * 24 * 60 * 60 * 1e3;
        break;
      }
      case "week": {
        const C = new Date(m).getDay(), v = C === 0 ? 6 : C - 1;
        m = m - v * 60 * 60 * 24;
        const x = new Date(m);
        m = (/* @__PURE__ */ new Date(`${x.getFullYear()}-${x.getMonth() + 1}-${x.getDate()}`)).getTime(), $ = g * o.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const k = new Date(m), C = k.getFullYear(), v = k.getMonth() + 1;
        m = (/* @__PURE__ */ new Date(`${C}-${v}-01`)).getTime(), $ = g * o.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const x = new Date($);
        $ = (/* @__PURE__ */ new Date(`${x.getFullYear()}-${x.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const C = new Date(m).getFullYear();
        m = (/* @__PURE__ */ new Date(`${C}-01-01`)).getTime(), $ = g * o.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const v = new Date($);
  ...
  return Ve(() => {
    if (window.addEventListener("resize", J0), n = O9(t, {
      customApi: {
        formatDate: (C, v, x, S) => {
          switch (A().timespan) {
            case "minute":
              return S === J1.XAxis ? j.formatDate(C, v, "HH:mm") : j.formatDate(C, v, "YYYY-MM-DD HH:mm");
            case "hour":
              return S === J1.XAxis ? j.formatDate(C, v, "MM-DD HH:mm") : j.formatDate(C, v, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return j.formatDate(C, v, "YYYY-MM-DD");
            case "month":
              return S === J1.XAxis ? j.formatDate(C, v, "YYYY-MM") : j.formatDate(C, v, "YYYY-MM-DD");
            case "year":
              return S === J1.XAxis ? j.formatDate(C, v, "YYYY") : j.formatDate(C, v, "YYYY-MM-DD");
          }
          return j.formatDate(C, v, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      const C = n.getDom("candle_pane", re.Main);
      if (C) {
      ...
      const v = n.getDom("candle_pane", re.YAxis);
    ...
    const l = () => {
      ...
      if (C != null && C.ticker)
        try {
          ...
          L1.saveDrawings(C.ticker, v);
        } catch (v) {
          console.error("❌ Error refreshing local storage:", v);
        }
    }, g = (C) => {
      o || (o = !0, C.preventDefault(), setTimeout(() => {
        l(), o = !1;
      }, 100));
    };
    setTimeout(() => {
    ...
    n && m && (n.removeOverlay = function(...C) {
      const v = m.apply(this, C), x = C[0];
      let S;
      if (typeof x == "string" ? S = x : x && typeof x == "object" && x.id && (S = x.id), S) {
        H.delete(S);
        const U = e1.get(S);
        U && (U.checkInterval && clearInterval(U.checkInterval), U.mouseUpHandler && (document.removeEventListener("mouseup", U.mouseUpHandler), document.removeEventListener("touchend", U.mouseUpHandler)), e1.delete(S)), l();
      }
      return v;
    }), N().forEach((C) => {
      t0(n, C, !0, {
    ...
    e.subIndicators.forEach((C) => {
      const v = t0(n, C, !0);
      v && ($[C] = v);
    }), I($), n == null || n.loadMore((C) => {
      a = !0, (async () => {
        const x = A(), [S] = L0(x, C, 1), [U] = L0(x, S, 500), g1 = await e.datafeed.getHistoryKLineData(p(), x, U, S);
        n == null || n.applyMoreData(g1, g1.length > 0), a = !1;
      })();
    }), n == null || n.subscribeAction(B9.OnTooltipIconClick, (C) => {
      if (C.indicatorName)
        switch (C.iconId) {
          case "visible": {
          ...
          case "close":
            if (C.paneId === "candle_pane") {
              const v = [...N()];
              n == null || n.removeIndicator("candle_pane", C.indicatorName), v.splice(v.indexOf(C.indicatorName), 1), V(v);
            } else {
              const v = {
                ...O()
              };
              n == null || n.removeIndicator(C.paneId, C.indicatorName), delete v[C.indicatorName], I(v);
            }
        }
    });
    const k = n == null ? void 0 : n.createOverlay;
    n && k && (n.createOverlay = function(...C) {
      const v = C[0], x = k.apply(this, C);
      return x && (D9(x, v.name || "unknown"), _1(x), X0()), x;
    });
  }), B0(() => {
    ...
    if (!a) {
      ...
      return a = !0, D(!0), (async () => {
        const [$, k] = L0(g, (/* @__PURE__ */ new Date()).getTime(), 500), C = await e.datafeed.getHistoryKLineData(l, g, $, k);
        n == null || n.applyNewData(C, C.length > 0), e.datafeed.subscribe(l, g, (v) => {
          n == null || n.updateData(v);
        }), a = !1, D(!1);
      })(), {
        symbol: l,
        period: g

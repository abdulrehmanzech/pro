...
var T9 = (e, t, r) => t in e ? A9(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var C1 = (e, t, r) => (T9(e, typeof t != "symbol" ? t + "" : t, r), r);
import { utils as O, registerFigure as M9, PolygonType as Zt, LineType as Ke, OverlayMode as Dn, ActionType as St, init as S9, FormatDateType as q1, DomPosition as lt, dispose as v0, TooltipIconPosition as Y1, YAxisType as On, CandleType as P9, registerOverlay as D9 } from "klinecharts";
function b1(e, t, r) {
...
const O9 = {
  ...
  createPointFigures: ({ coordinates: e }) => {
    if (e.length > 1) {
      const t = Math.abs(e[0].x - e[1].x), r = Math.abs(e[0].y - e[1].y), n = Math.sqrt(t * t + r * r), a = [0.236, 0.382, 0.5, 0.618, 0.786, 1], s = [], h = [];
      return a.forEach((f) => {
        const b = n * f;
        s.push(
          { ...e[0], r: b }
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    const n = [], a = [];
    if (e.length > 1) {
      const s = e[1].x > e[0].x ? e[0].x : e[1].x, h = [1, 0.786, 0.618, 0.5, 0.382, 0.236, 0], f = e[0].y - e[1].y, b = t.points, x = b[0].value - b[1].value;
      h.forEach((v) => {
        const w = e[1].y + f * v, B = (b[1].value + x * v).toFixed(r.price);
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const r = go(e[0], e[1]) / Math.sqrt(24), n = e[1].x > e[0].x ? 0 : 1, a = O.getLinearSlopeIntercept(e[0], e[1]);
      let s;
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    const a = [];
    if (e.length > 1) {
      const s = e[1].x > e[0].x ? -38 : 4, h = e[1].y > e[0].y ? -2 : 20, f = e[1].x - e[0].x, b = e[1].y - e[0].y;
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((v) => {
        const w = e[1].x - f * v, B = e[1].y - b * v;
  ...
  createPointFigures: ({ coordinates: e, overlay: t, precision: r }) => {
    const n = [], a = [];
    if (e.length > 2) {
      const s = t.points, h = s[1].value - s[0].value, f = e[1].y - e[0].y, b = [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1], x = e[2].x > e[1].x ? e[1].x : e[2].x;
      b.forEach((v) => {
        const w = e[2].y + f * v, B = (s[2].value + h * v).toFixed(r.price);
  ...
  createPointFigures: ({ coordinates: e, overlay: t }) => {
    const r = [], n = [], a = ["X", "A", "B", "C", "D"], s = e.map((h, f) => ({
      ...h,
      baseline: "bottom",
      text: `(${a[f]})`
    }));
...
class ry {
  ...
  async getHistoryKLineData(t, r, n, a) {
    return await ((await (await fetch(`https://api.polygon.io/v2/aggs/ticker/${t.ticker}/range/${r.multiplier}/${r.timespan}/${n}/${a}?apiKey=${this._apiKey}`)).json()).results || []).map((f) => ({
      timestamp: f.t,
      open: f.o,
      high: f.h,
      low: f.l,
  ...
  subscribe(t, r, n) {
    ...
    this._prevSymbolMarket !== t.market ? ((a = this._ws) == null || a.close(), this._ws = new WebSocket(`wss://delayed.polygon.io/${t.market}`), this._ws.onopen = () => {
      ...
      f[0].ev === "status" ? f[0].status === "auth_success" && ((b = this._ws) == null || b.send(JSON.stringify({ action: "subscribe", params: `T.${t.ticker}` }))) : "sym" in f && n({
        timestamp: f.s,
        open: f.o,
        high: f.h,
        low: f.l,
...
const X9 = (e, t) => e === t, jn = Symbol("solid-proxy"), J9 = Symbol("solid-track"), an = {
  equals: X9
};
let mo = vo;
const Ct = 1, sn = 2, yo = {
...
var Ie = null;
let Ot = null, Le = null, Re = null, yt = null, tr = 0;
function $1(e, t) {
  const r = Le, n = Ie, a = e.length === 0, s = a ? yo : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? n : t
...
function M(e, t) {
  ...
  }, n = (a) => (typeof a == "function" && (a = a(r.value)), po(r, a));
  return [Co.bind(r), n];
}
function b0(e, t, r) {
  const n = yn(e, t, !0, Ct);
...
function q(e, t, r) {
  ...
  const n = yn(e, t, !0, 0);
  return n.observers = null, n.observerSlots = null, n.comparator = r.equals || void 0, qt(n), Co.bind(n);
}
function ei(e, t, r) {
  let n, a, s;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (n = !0, a = e, s = t || {}) : (n = e, a = t, s = r || {});
  let h = null, f = Nn, b = null, x = !1, v = "initialValue" in s, w = typeof n == "function" && q(n);
  const B = /* @__PURE__ */ new Set(), [N, oe] = (s.storage || M)(s.initialValue), [V, R] = M(void 0), [U, he] = M(void 0, {
    equals: !1
  }), [Z, X] = M(v ? "ready" : "unresolved");
  if (Ue.context) {
    b = `${Ue.context.id}${Ue.context.count++}`;
    let ee;
    s.ssrLoadFrom === "initial" ? f = s.initialValue : Ue.load && (ee = Ue.load(b)) && (f = ee[0]);
  }
  function J(ee, se, T, j) {
    return h === ee && (h = null, v = !0, (ee === f || se === f) && s.onHydrated && queueMicrotask(() => s.onHydrated(j, {
      value: se
    })), f = Nn, ve(se, T)), se;
  }
  function ve(ee, se) {
  ...
  function W() {
    ...
    if (T !== void 0 && !h)
      throw T;
    return Le && !Le.user && ee && b0(() => {
      U(), h && (ee.resolved || B.has(ee) || (ee.increment(), B.add(ee)));
    }), se;
  }
  function H(ee = !0) {
    if (ee !== !1 && x)
    ...
    const T = f !== Nn ? f : ut(() => a(se, {
      value: N(),
      refetching: ee
    }));
    return typeof T != "object" || !(T && "then" in T) ? (J(h, T, void 0, se), T) : (h = T, x = !0, queueMicrotask(() => x = !1), Lt(() => {
      X(v ? "refreshing" : "pending"), he();
    }, !1), T.then((j) => J(T, j, void 0, se), (j) => J(T, void 0, $o(j), se)));
  }
...
function ti(e) {
  ...
  return Promise.resolve().then(() => {
    Le = t, Ie = r;
    let n;
    return Lt(e, !1), Le = Ie = null, n ? n.done : void 0;
  });
}
let ni;
function Co() {
...
function po(e, t, r) {
  ...
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && Lt(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      const s = e.observers[a], h = Ot && Ot.running;
      h && Ot.disposed.has(s), (h && !s.tState || !h && !s.state) && (s.pure ? Re.push(s) : yt.push(s), s.observers && bo(s)), h || (s.state = Ct);
    }
    if (Re.length > 1e6)
      throw Re = [], new Error();
  }, !1)), t;
...
function qt(e) {
  if (!e.fn)
    return;
  Cn(e);
  const t = Ie, r = Le, n = tr;
  Le = Ie = e, ri(e, e.value, n), Le = r, Ie = t;
}
function ri(e, t, r) {
  let n;
  try {
    ...
    e.pure && (e.state = Ct, e.owned && e.owned.forEach(Cn), e.owned = null), _o(a);
  }
  (!e.updatedAt || e.updatedAt <= r) && (e.updatedAt != null && "observers" in e ? po(e, n) : e.value = n, e.updatedAt = r);
}
function yn(e, t, r, n = Ct, a) {
  ...
  return Ie === null || Ie !== yo && (Ie.owned ? Ie.owned.push(s) : Ie.owned = [s]), s;
}
function ln(e) {
  const t = Ot;
  if (e.state === 0 || t)
  ...
  if (e.state === sn || t)
    return cn(e);
  if (e.suspense && ut(e.suspense.inFallback))
...
function Lt(e, t) {
  ...
  try {
    ...
    r || (yt = null), Re = null, _o(n);
  }
}
function oi(e) {
  if (Re && (vo(Re), Re = null), e)
    return;
  const t = yt;
  yt = null, t.length && Lt(() => mo(t), !1);
}
function vo(e) {
...
function bo(e) {
  ...
  for (let r = 0; r < e.observers.length; r += 1) {
    ...
    (!n.state || t) && (n.state = sn, n.pure ? Re.push(n) : yt.push(n), n.observers && bo(n));
  }
}
function Cn(e) {
  let t;
  if (e.sources)
    for (; e.sources.length; ) {
      ...
      if (a && a.length) {
        const s = a.pop(), h = r.observerSlots.pop();
        n < a.length && (s.sourceSlots[h] = n, a[n] = s, r.observerSlots[n] = h);
      }
    }
  if (e.owned) {
...
function si(e, t, r = {}) {
  let n = [], a = [], s = [], h = 0, f = t.length > 1 ? [] : null;
  return xt(() => $0(s)), () => {
    let b = e() || [], x, v;
    return b[J9], ut(() => {
      let B = b.length, N, oe, V, R, U, he, Z, X, J;
      if (B === 0)
        h !== 0 && ($0(s), s = [], n = [], a = [], h = 0, f && (f = [])), r.fallback && (n = [ai], a[0] = $1((ve) => (s[0] = ve, r.fallback())), h = 1);
      else if (h === 0) {
        for (a = new Array(B), v = 0; v < B; v++)
          n[v] = b[v], a[v] = $1(w);
        h = B;
      } else {
        for (V = new Array(B), R = new Array(B), f && (U = new Array(B)), he = 0, Z = Math.min(h, B); he < Z && n[he] === b[he]; he++)
          ;
        for (Z = h - 1, X = B - 1; Z >= he && X >= he && n[Z] === b[X]; Z--, X--)
          V[X] = a[Z], R[X] = s[Z], f && (U[X] = f[Z]);
        for (N = /* @__PURE__ */ new Map(), oe = new Array(X + 1), v = X; v >= he; v--)
          J = b[v], x = N.get(J), oe[v] = x === void 0 ? -1 : x, N.set(J, v);
        for (x = he; x <= Z; x++)
          J = n[x], v = N.get(J), v !== void 0 && v !== -1 ? (V[v] = a[x], R[v] = s[x], f && (U[v] = f[x]), v = oe[v], N.set(J, v)) : s[x]();
        for (v = he; v < B; v++)
          v in V ? (a[v] = V[v], s[v] = R[v], f && (f[v] = U[v], f[v](v))) : a[v] = $1(w);
        a = a.slice(0, h = B), n = b.slice(0);
      }
      return a;
    });
    function w(B) {
...
function de(e) {
  ...
  return q(() => {
    const a = n();
    if (a) {
      const s = e.children, h = typeof s == "function" && s.length > 0;
      return t = r || h, h ? ut(() => s(a)) : s;
    }
    return e.fallback;
  }, void 0, void 0);
}
function ci(e, t, r) {
  let n = r.length, a = t.length, s = n, h = 0, f = 0, b = t[a - 1].nextSibling, x = null;
  for (; h < a || f < s; ) {
    if (t[h] === r[f]) {
      h++, f++;
      continue;
    ...
    for (; t[a - 1] === r[s - 1]; )
      a--, s--;
    if (a === h) {
      const v = s < n ? f ? r[f - 1].nextSibling : r[s - f] : b;
      for (; f < s; )
        e.insertBefore(r[f++], v);
    } else if (s === f)
      for (; h < a; )
        (!x || !x.has(t[h])) && t[h].remove(), h++;
    else if (t[h] === r[s - 1] && r[f] === t[a - 1]) {
      const v = t[--a].nextSibling;
      e.insertBefore(r[f++], t[h++].nextSibling), e.insertBefore(r[--s], v), t[a] = r[s];
    } else {
      if (!x) {
        x = /* @__PURE__ */ new Map();
        let w = f;
      ...
      if (v != null)
        if (f < v && v < s) {
          ...
          if (B > v - f) {
            const oe = t[h];
            for (; f < v; )
              e.insertBefore(r[f++], oe);
          } else
            e.replaceChild(r[f++], t[h++]);
        } else
          h++;
      else
        t[h++].remove();
...
function We(e, t = window.document) {
  const r = t[_0] || (t[_0] = /* @__PURE__ */ new Set());
  for (let n = 0, a = e.length; n < a; n++) {
    const s = e[n];
    r.has(s) || (r.add(s), t.addEventListener(s, di));
  }
}
function Ee(e, t, r) {
...
function un(e, t, r, n, a) {
  ...
  if (t === r)
    return r;
  const s = typeof t, h = n !== void 0;
  if (e = h && r[0] && r[0].parentNode || e, s === "string" || s === "number") {
    if (Ue.context)
      return r;
    if (s === "number" && (t = t.toString()), h) {
      let f = r[0];
      f && f.nodeType === 3 ? f.data = t : f = document.createTextNode(t), r = Ht(e, r, n, f);
    } else
    ...
    if (Array.isArray(t)) {
      ...
      if (f.length === 0) {
        ...
        b ? r.length === 0 ? k0(e, f, n) : ci(e, r, f) : (r && Ht(e), k0(e, f));
      r = f;
    ...
    if (f instanceof Node)
      ...
      if (Array.isArray(f))
        ...
        if (n) {
          for (; typeof f == "function"; )
            f = f();
          a = Qn(e, Array.isArray(f) ? f : [f], Array.isArray(b) ? b : [b]) || a;
        } else
          e.push(f), a = !0;
      else {
        const x = String(f);
...
function Ht(e, t, r, n) {
  ...
  if (t.length) {
    ...
    for (let h = t.length - 1; h >= 0; h--) {
      const f = t[h];
      if (a !== f) {
        const b = f.parentNode === e;
        !s && !h ? b ? e.replaceChild(a, f) : e.insertBefore(a, r) : b && f.remove();
      } else
        s = !0;
    }
  } else
...
function gi(e) {
  ...
  function a() {
    if (Ue.context) {
      const [s, h] = M(!1);
      return queueMicrotask(() => h(!0)), () => s() && e.children;
    } else
      return () => e.children;
  }
  if (n instanceof HTMLHeadElement) {
    ...
    $1((b) => C(n, () => s() ? b() : a()(), null)), xt(() => {
      Ue.context ? queueMicrotask(f) : f();
    });
  } else {
    const s = fi(e.isSVG ? "g" : "div", e.isSVG), h = t && s.attachShadow ? s.attachShadow({
      mode: "open"
    }) : s;
    Object.defineProperty(s, "_$host", {
      ...
      configurable: !0
    }), C(h, a()), n.appendChild(s), e.ref && e.ref(s), xt(() => n.removeChild(s));
  }
  return r;
}
...
var mi = typeof X1 == "object" && X1 && X1.Object === Object && X1, Lo = mi, yi = Lo, Ci = typeof self == "object" && self && self.Object === Object && self, pi = yi || Ci || Function("return this")(), dt = pi, vi = dt, bi = vi.Symbol, pn = bi, x0 = pn, wo = Object.prototype, $i = wo.hasOwnProperty, _i = wo.toString, p1 = x0 ? x0.toStringTag : void 0;
function ki(e) {
...
var Ti = Ai, L0 = pn, Mi = xi, Si = Ti, Pi = "[object Null]", Di = "[object Undefined]", w0 = L0 ? L0.toStringTag : void 0;
function Oi(e) {
  return e == null ? e === void 0 ? Di : Pi : w0 && w0 in Object(e) ? Mi(e) : Si(e);
}
var x1 = Oi;
function Ni(e) {
  var t = typeof e;
...
var Yt = Ni, Ii = x1, Bi = Yt, Ei = "[object AsyncFunction]", Fi = "[object Function]", Ui = "[object GeneratorFunction]", zi = "[object Proxy]";
function Vi(e) {
  if (!Bi(e))
    return !1;
  var t = Ii(e);
...
var Ao = Vi, Ki = dt, Ri = Ki["__core-js_shared__"], ji = Ri, Bn = ji, A0 = function() {
...
var To = qi, Yi = Ao, Gi = Zi, Xi = Yt, Ji = To, ea = /[\\^$.*+?()[\]{}|]/g, ta = /^\[object .+?Constructor\]$/, na = Function.prototype, ra = Object.prototype, oa = na.toString, ia = ra.hasOwnProperty, aa = RegExp(
...
var So = pa, va = Mo, ba = So, $a = Object.prototype, _a = $a.hasOwnProperty;
function ka(e, t, r) {
  var n = e[t];
  (!(_a.call(e, t) && ba(n, r)) || r === void 0 && !(t in e)) && va(e, t, r);
}
var rr = ka, xa = Array.isArray, Gt = xa;
function La(e) {
  return e != null && typeof e == "object";
}
var Xt = La, wa = x1, Aa = Xt, Ta = "[object Symbol]";
function Ma(e) {
  return typeof e == "symbol" || Aa(e) && wa(e) == Ta;
}
var or = Ma, Sa = Gt, Pa = or, Da = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Oa = /^\w*$/;
function Na(e, t) {
  if (Sa(e))
    return !1;
  var r = typeof e;
...
var Ia = Na, Ba = It, Ea = Ba(Object, "create"), vn = Ea, M0 = vn;
function Fa() {
  this.__data__ = M0 ? M0(null) : {}, this.size = 0;
}
var Ua = Fa;
function za(e) {
...
Jt.prototype.clear = r5;
Jt.prototype.delete = o5;
Jt.prototype.get = i5;
Jt.prototype.has = a5;
Jt.prototype.set = s5;
var l5 = Jt;
...
e1.prototype.clear = A5;
e1.prototype.delete = T5;
e1.prototype.get = M5;
e1.prototype.has = S5;
e1.prototype.set = P5;
var $n = e1, D5 = It, O5 = dt, N5 = D5(O5, "Map"), ir = N5, S0 = l5, I5 = $n, B5 = ir;
function E5() {
...
t1.prototype.clear = t2;
t1.prototype.delete = n2;
t1.prototype.get = r2;
t1.prototype.has = o2;
t1.prototype.set = i2;
var Po = t1, Do = Po, a2 = "Expected a function";
function ar(e, t) {
  ...
  var r = function() {
    ...
    return r.cache = s.set(a, h) || s, h;
  };
  return r.cache = new (ar.Cache || Do)(), r;
}
ar.Cache = Do;
var s2 = ar, l2 = s2, c2 = 500;
function u2(e) {
...
var d2 = u2, h2 = d2, f2 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, g2 = /\\(\\)?/g, m2 = h2(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(f2, function(r, n, a, s) {
    t.push(a ? s.replace(g2, "$1") : n || r);
  }), t;
}), y2 = m2;
function C2(e, t) {
...
var p2 = C2, P0 = pn, v2 = p2, b2 = Gt, $2 = or, _2 = 1 / 0, D0 = P0 ? P0.prototype : void 0, O0 = D0 ? D0.toString : void 0;
function Oo(e) {
  if (typeof e == "string")
    return e;
  if (b2(e))
...
var w2 = L2, A2 = Gt, T2 = Ia, M2 = y2, S2 = w2;
function P2(e, t) {
...
var U2 = F2, z2 = rr, V2 = D2, K2 = No, N0 = Yt, R2 = U2;
function j2(e, t, r, n) {
  if (!N0(e))
    return e;
  t = V2(t, e);
  for (var a = -1, s = t.length, h = s - 1, f = e; f != null && ++a < s; ) {
    var b = R2(t[a]), x = r;
    if (b === "__proto__" || b === "constructor" || b === "prototype")
      return e;
    if (a != h) {
      var v = f[b];
      x = n ? n(v, b, f) : void 0, x === void 0 && (x = N0(v) ? v : K2(t[a + 1]) ? [] : {});
    }
    z2(f, b, x), f = f[b];
  }
  return e;
...
var r6 = n6, o6 = $n, i6 = ir, a6 = Po, s6 = 200;
function l6(e, t) {
  var r = this.__data__;
  if (r instanceof o6) {
    var n = r.__data__;
...
n1.prototype.clear = d6;
n1.prototype.delete = h6;
n1.prototype.get = f6;
n1.prototype.has = g6;
n1.prototype.set = m6;
var y6 = n1;
...
var p6 = C6, v6 = rr, b6 = Mo;
function $6(e, t, r, n) {
  var a = !r;
  r || (r = {});
  for (var s = -1, h = t.length; ++s < h; ) {
    var f = t[s], b = n ? n(r[f], e[f], f, r, e) : void 0;
    b === void 0 && (b = e[f]), a ? b6(r, f, b) : v6(r, f, b);
  }
  return r;
}
var kn = $6;
...
var k6 = _6, x6 = x1, L6 = Xt, w6 = "[object Arguments]";
function A6(e) {
  return L6(e) && x6(e) == w6;
}
var T6 = A6, I0 = T6, M6 = Xt, Io = Object.prototype, S6 = Io.hasOwnProperty, P6 = Io.propertyIsEnumerable, D6 = I0(function() {
  return arguments;
}()) ? I0 : function(e) {
...
dn.exports;
(function(e, t) {
  var r = dt, n = I6, a = t && !t.nodeType && t, s = a && !0 && e && !e.nodeType && e, h = s && s.exports === a, f = h ? r.Buffer : void 0, b = f ? f.isBuffer : void 0, x = b || n;
  e.exports = x;
})(dn, dn.exports);
var Bo = dn.exports, B6 = 9007199254740991;
function E6(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= B6;
}
var Eo = E6, F6 = x1, U6 = Eo, z6 = Xt, V6 = "[object Arguments]", K6 = "[object Array]", R6 = "[object Boolean]", j6 = "[object Date]", Q6 = "[object Error]", Z6 = "[object Function]", H6 = "[object Map]", W6 = "[object Number]", q6 = "[object Object]", Y6 = "[object RegExp]", G6 = "[object Set]", X6 = "[object String]", J6 = "[object WeakMap]", es = "[object ArrayBuffer]", ts = "[object DataView]", ns = "[object Float32Array]", rs = "[object Float64Array]", os = "[object Int8Array]", is = "[object Int16Array]", as = "[object Int32Array]", ss = "[object Uint8Array]", ls = "[object Uint8ClampedArray]", cs = "[object Uint16Array]", us = "[object Uint32Array]", xe = {};
xe[ns] = xe[rs] = xe[os] = xe[is] = xe[as] = xe[ss] = xe[ls] = xe[cs] = xe[us] = !0;
xe[V6] = xe[K6] = xe[es] = xe[R6] = xe[ts] = xe[j6] = xe[Q6] = xe[Z6] = xe[H6] = xe[W6] = xe[q6] = xe[Y6] = xe[G6] = xe[X6] = xe[J6] = !1;
function ds(e) {
  return z6(e) && U6(e.length) && !!xe[F6(e)];
}
var hs = ds;
function fs(e) {
  return function(t) {
...
var sr = fs, hn = { exports: {} };
hn.exports;
(function(e, t) {
  var r = Lo, n = t && !t.nodeType && t, a = n && !0 && e && !e.nodeType && e, s = a && a.exports === n, h = s && r.process, f = function() {
    try {
...
var lr = hn.exports, gs = hs, ms = sr, B0 = lr, E0 = B0 && B0.isTypedArray, ys = E0 ? ms(E0) : gs, Cs = ys, ps = k6, vs = O6, bs = Gt, $s = Bo, _s = No, ks = Cs, xs = Object.prototype, Ls = xs.hasOwnProperty;
function ws(e, t) {
  var r = bs(e), n = !r && vs(e), a = !r && !n && $s(e), s = !r && !n && !a && ks(e), h = r || n || a || s, f = h ? ps(e.length, String) : [], b = f.length;
  for (var x in e)
    (t || Ls.call(e, x)) && !(h && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var Uo = Ms, Ss = Uo, Ps = Ss(Object.keys, Object), Ds = Ps, Os = cr, Ns = Ds, Is = Object.prototype, Bs = Is.hasOwnProperty;
function Es(e) {
  if (!Os(e))
    return Ns(e);
  var t = [];
...
var Fs = Es, Us = Ao, zs = Eo;
function Vs(e) {
  return e != null && zs(e.length) && !Us(e);
}
var zo = Vs, Ks = Fo, Rs = Fs, js = zo;
function Qs(e) {
  return js(e) ? Ks(e) : Rs(e);
}
var ur = Qs, Zs = kn, Hs = ur;
function Ws(e, t) {
...
var Gs = Ys, Xs = Yt, Js = cr, e3 = Gs, t3 = Object.prototype, n3 = t3.hasOwnProperty;
function r3(e) {
  if (!Xs(e))
    return e3(e);
  var t = Js(e), r = [];
...
var o3 = r3, i3 = Fo, a3 = o3, s3 = zo;
function l3(e) {
  return s3(e) ? i3(e, !0) : a3(e);
}
var dr = l3, c3 = kn, u3 = dr;
function d3(e, t) {
...
fn.exports;
(function(e, t) {
  var r = dt, n = t && !t.nodeType && t, a = n && !0 && e && !e.nodeType && e, s = a && a.exports === n, h = s ? r.Buffer : void 0, f = h ? h.allocUnsafe : void 0;
  function b(x, v) {
    if (v)
      return x.slice();
    var w = x.length, B = f ? f(w) : new x.constructor(w);
    return x.copy(B), B;
  }
  e.exports = b;
})(fn, fn.exports);
...
var Vo = p3, v3 = C3, b3 = Vo, $3 = Object.prototype, _3 = $3.propertyIsEnumerable, F0 = Object.getOwnPropertySymbols, k3 = F0 ? function(e) {
  return e == null ? [] : (e = Object(e), v3(F0(e), function(t) {
    return _3.call(e, t);
  }));
} : b3, hr = k3, x3 = kn, L3 = hr;
function w3(e, t) {
  return x3(e, L3(e), t);
}
var A3 = w3;
...
var Ko = T3, M3 = Uo, S3 = M3(Object.getPrototypeOf, Object), Ro = S3, P3 = Ko, D3 = Ro, O3 = hr, N3 = Vo, I3 = Object.getOwnPropertySymbols, B3 = I3 ? function(e) {
  for (var t = []; e; )
    P3(t, O3(e)), e = D3(e);
  return t;
} : N3, jo = B3, E3 = kn, F3 = jo;
function U3(e, t) {
  return E3(e, F3(e), t);
}
var z3 = U3, V3 = Ko, K3 = Gt;
function R3(e, t, r) {
  var n = t(e);
  return K3(e) ? n : V3(n, r(e));
}
var Qo = R3, j3 = Qo, Q3 = hr, Z3 = ur;
function H3(e) {
  return j3(e, Z3, Q3);
}
var W3 = H3, q3 = Qo, Y3 = jo, G3 = dr;
function X3(e) {
  return q3(e, G3, Y3);
}
var J3 = X3, e8 = It, t8 = dt, n8 = e8(t8, "DataView"), r8 = n8, o8 = It, i8 = dt, a8 = o8(i8, "Promise"), s8 = a8, l8 = It, c8 = dt, u8 = l8(c8, "Set"), d8 = u8, h8 = It, f8 = dt, g8 = h8(f8, "WeakMap"), m8 = g8, Zn = r8, Hn = ir, Wn = s8, qn = d8, Yn = m8, Zo = x1, r1 = To, U0 = "[object Map]", y8 = "[object Object]", z0 = "[object Promise]", V0 = "[object Set]", K0 = "[object WeakMap]", R0 = "[object DataView]", C8 = r1(Zn), p8 = r1(Hn), v8 = r1(Wn), b8 = r1(qn), $8 = r1(Yn), Pt = Zo;
(Zn && Pt(new Zn(new ArrayBuffer(1))) != R0 || Hn && Pt(new Hn()) != U0 || Wn && Pt(Wn.resolve()) != z0 || qn && Pt(new qn()) != V0 || Yn && Pt(new Yn()) != K0) && (Pt = function(e) {
  var t = Zo(e), r = t == y8 ? e.constructor : void 0, n = r ? r1(r) : "";
  if (n)
    switch (n) {
      case C8:
        return R0;
...
var fr = Pt, _8 = Object.prototype, k8 = _8.hasOwnProperty;
function x8(e) {
  var t = e.length, r = new e.constructor(t);
  return t && typeof e[0] == "string" && k8.call(e, "index") && (r.index = e.index, r.input = e.input), r;
}
var L8 = x8, w8 = dt, A8 = w8.Uint8Array, T8 = A8, j0 = T8;
function M8(e) {
...
var I8 = N8, Q0 = pn, Z0 = Q0 ? Q0.prototype : void 0, H0 = Z0 ? Z0.valueOf : void 0;
function B8(e) {
  return H0 ? Object(H0.call(e)) : {};
}
var E8 = B8, F8 = gr;
function U8(e, t) {
...
var z8 = U8, V8 = gr, K8 = D8, R8 = I8, j8 = E8, Q8 = z8, Z8 = "[object Boolean]", H8 = "[object Date]", W8 = "[object Map]", q8 = "[object Number]", Y8 = "[object RegExp]", G8 = "[object Set]", X8 = "[object String]", J8 = "[object Symbol]", el = "[object ArrayBuffer]", tl = "[object DataView]", nl = "[object Float32Array]", rl = "[object Float64Array]", ol = "[object Int8Array]", il = "[object Int16Array]", al = "[object Int32Array]", sl = "[object Uint8Array]", ll = "[object Uint8ClampedArray]", cl = "[object Uint16Array]", ul = "[object Uint32Array]";
function dl(e, t, r) {
  var n = e.constructor;
  switch (t) {
    case el:
...
var hl = dl, fl = Yt, W0 = Object.create, gl = function() {
  function e() {
  }
  return function(t) {
    if (!fl(t))
...
}(), ml = gl, yl = ml, Cl = Ro, pl = cr;
function vl(e) {
  return typeof e.constructor == "function" && !pl(e) ? yl(Cl(e)) : {};
}
var bl = vl, $l = fr, _l = Xt, kl = "[object Map]";
function xl(e) {
  return _l(e) && $l(e) == kl;
}
var Ll = xl, wl = Ll, Al = sr, q0 = lr, Y0 = q0 && q0.isMap, Tl = Y0 ? Al(Y0) : wl, Ml = Tl, Sl = fr, Pl = Xt, Dl = "[object Set]";
function Ol(e) {
  return Pl(e) && Sl(e) == Dl;
}
var Nl = Ol, Il = Nl, Bl = sr, G0 = lr, X0 = G0 && G0.isSet, El = X0 ? Bl(X0) : Il, Fl = El, Ul = y6, zl = p6, Vl = rr, Kl = qs, Rl = h3, jl = f3, Ql = m3, Zl = A3, Hl = z3, Wl = W3, ql = J3, Yl = fr, Gl = L8, Xl = hl, Jl = bl, e7 = Gt, t7 = Bo, n7 = Ml, r7 = Yt, o7 = Fl, i7 = ur, a7 = dr, s7 = 1, l7 = 2, c7 = 4, Ho = "[object Arguments]", u7 = "[object Array]", d7 = "[object Boolean]", h7 = "[object Date]", f7 = "[object Error]", Wo = "[object Function]", g7 = "[object GeneratorFunction]", m7 = "[object Map]", y7 = "[object Number]", qo = "[object Object]", C7 = "[object RegExp]", p7 = "[object Set]", v7 = "[object String]", b7 = "[object Symbol]", $7 = "[object WeakMap]", _7 = "[object ArrayBuffer]", k7 = "[object DataView]", x7 = "[object Float32Array]", L7 = "[object Float64Array]", w7 = "[object Int8Array]", A7 = "[object Int16Array]", T7 = "[object Int32Array]", M7 = "[object Uint8Array]", S7 = "[object Uint8ClampedArray]", P7 = "[object Uint16Array]", D7 = "[object Uint32Array]", be = {};
be[Ho] = be[u7] = be[_7] = be[k7] = be[d7] = be[h7] = be[x7] = be[L7] = be[w7] = be[A7] = be[T7] = be[m7] = be[y7] = be[qo] = be[C7] = be[p7] = be[v7] = be[b7] = be[M7] = be[S7] = be[P7] = be[D7] = !0;
be[f7] = be[Wo] = be[$7] = !1;
function on(e, t, r, n, a, s) {
  var h, f = t & s7, b = t & l7, x = t & c7;
  if (r && (h = a ? r(e, n, a, s) : r(e)), h !== void 0)
    return h;
  if (!r7(e))
    return e;
  var v = e7(e);
  if (v) {
    ...
    var w = Yl(e), B = w == Wo || w == g7;
    if (t7(e))
      return jl(e, f);
    if (w == qo || w == Ho || B && !a) {
      if (h = b || B ? {} : Jl(e), !f)
        return b ? Hl(e, Rl(h, e)) : Zl(e, Kl(h, e));
    } else {
      if (!be[w])
        return a ? e : {};
      h = Xl(e, w, f);
  ...
  if (N)
    return N;
  s.set(e, h), o7(e) ? e.forEach(function(R) {
    h.add(on(R, t, r, R, e, s));
  }) : n7(e) && e.forEach(function(R, U) {
    h.set(U, on(R, t, r, U, e, s));
  });
  var oe = x ? b ? ql : Wl : b ? a7 : i7, V = v ? void 0 : oe(e);
  return zl(V || e, function(R, U) {
    V && (U = R, R = e[U]), Vl(h, U, on(R, t, r, U, e, s));
  }), h;
}
...
var F7 = E7;
const U7 = /* @__PURE__ */ xo(F7), z7 = /* @__PURE__ */ p("<button></button>"), V7 = (e) => (() => {
  const t = z7.cloneNode(!0);
  return ct(t, "click", e.onClick, !0), C(t, () => e.children), K((r) => {
...
const K7 = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), R7 = /* @__PURE__ */ p('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), j7 = /* @__PURE__ */ p("<div></div>"), Q7 = /* @__PURE__ */ p('<span class="label"></span>'), Z7 = () => K7.cloneNode(!0), H7 = () => R7.cloneNode(!0), J0 = (e) => {
  ...
  return He(() => {
    ...
    return n.$$click = (a) => {
      ...
      const a = q(() => !!e.label);
      return () => a() && (() => {
        const s = Q7.cloneNode(!0);
        return C(s, () => e.label), s;
      })();
    })(), null), K((a) => {
      const s = e.style, h = `klinecharts-pro-checkbox ${t() && "checked" || ""} ${e.class || ""}`;
      return a._v$ = Nt(n, s, a._v$), h !== a._v$2 && ge(n, a._v$2 = h), a;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), n;
...
const W7 = /* @__PURE__ */ p('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), Yo = () => W7.cloneNode(!0), q7 = /* @__PURE__ */ p('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), Y7 = () => q7.cloneNode(!0), G7 = /* @__PURE__ */ p("<ul></ul>"), X7 = /* @__PURE__ */ p("<li></li>"), gn = (e) => (() => {
  ...
  const t = J7.cloneNode(!0), r = t.firstChild, n = r.firstChild, a = n.firstChild, s = n.nextSibling;
  return t.$$click = (h) => {
    h.target === h.currentTarget && e.onClose && e.onClose();
  }, C(n, () => e.title, a), ct(a, "click", e.onClose, !0), C(s, () => e.children), C(r, (() => {
    const h = q(() => !!(e.buttons && e.buttons.length > 0));
    return () => h() && (() => {
      const f = ec.cloneNode(!0);
      return C(f, () => e.buttons.map((b) => A(V7, ko(b, {
        get style() {
          return {
            ...e.minButtonWidth ? {
        ...
        return b._v$8 = Nt(f, x, b._v$8), v !== b._v$9 && f.classList.toggle("mobile-buttons", b._v$9 = v), b;
      }, {
        _v$8: void 0,
        _v$9: void 0
      }), f;
...
We(["click"]);
const tc = /* @__PURE__ */ p('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), nc = /* @__PURE__ */ p('<div class="drop-down-container"><ul></ul></div>'), rc = /* @__PURE__ */ p('<div><input type="text"></div>'), oc = /* @__PURE__ */ p("<li></li>"), Gn = (e) => {
  const [t, r] = M(!1), [n, a] = M("");
  let s, h;
  const f = q(() => {
    ...
    h && w && h.contains(w) || setTimeout(() => {
      h && document.activeElement && h.contains(document.activeElement) || (r(!1), a(""));
    }, 0);
  };
  return (() => {
    const v = tc.cloneNode(!0), w = v.firstChild, B = w.firstChild;
    v.addEventListener("blur", x), v.$$click = (oe) => {
      oe.stopPropagation(), !oe.target.closest(".drop-down-container") && b();
    };
    const N = h;
    return typeof N == "function" ? kt(N, v) : h = v, C(B, () => e.value), C(v, (() => {
      ...
      return () => oe() && (() => {
        ...
        return V.$$click = (U) => U.stopPropagation(), V.$$mousedown = (U) => {
          ...
          var U;
          return (U = f()) == null ? void 0 : U.map((he) => {
...
We(["click", "mousedown", "input"]);
const ic = /* @__PURE__ */ p('<span class="prefix"></span>'), ac = /* @__PURE__ */ p('<span class="suffix"></span>'), sc = /* @__PURE__ */ p('<div><input class="value"></div>'), Go = (e) => {
  const t = ko({
  ...
  const [n, a] = M("normal");
  return (() => {
    const s = sc.cloneNode(!0), h = s.firstChild;
    return s.$$click = () => {
      r == null || r.focus();
    }, C(s, A(de, {
      get when() {
      ...
      get children() {
        const f = ic.cloneNode(!0);
        return C(f, () => t.prefix), f;
      }
    }), h), h.addEventListener("change", (f) => {
      var x, v;
      ...
      get children() {
        const f = ac.cloneNode(!0);
        return C(f, () => t.suffix), f;
      }
    }), null), K((f) => {
      const b = t.style, x = `klinecharts-pro-input ${t.class ?? ""}`, v = n(), w = t.placeholder ?? "";
      return f._v$ = Nt(s, b, f._v$), x !== f._v$2 && ge(s, f._v$2 = x), v !== f._v$3 && Ee(s, "data-status", f._v$3 = v), w !== f._v$4 && Ee(h, "placeholder", f._v$4 = w), f;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
We(["click"]);
let ue = null, eo = !1;
const v1 = /* @__PURE__ */ new Map(), uc = 500, to = 3;
function J1(e) {
...
function gc(e, t) {
  ...
  if (n > Math.max(to, a)) {
    if (v1.set(r, n), v1.size > uc) {
      const h = v1.keys().next().value;
      h !== void 0 && v1.delete(h);
    }
    return !1;
  }
  const s = Math.max(to, a * 0.35);
  return n <= s;
}
function Fn(e, t, r) {
  const { x: n, y: a, width: s, height: h } = t, f = Math.max(0, Math.min(r, Math.abs(s) / 2, Math.abs(h) / 2));
  e.beginPath(), e.moveTo(n + f, a), e.arcTo(n + s, a, n + s, a + h, f), e.arcTo(n + s, a + h, n, a + h, f), e.arcTo(n, a + h, n, a, f), e.arcTo(n, a, n + s, a, f), e.closePath();
}
function mc(e, t, r) {
  const n = r.style ?? Zt.Fill, a = r.color ?? "currentColor", s = Xn(r.color) ?? Xn(r.borderColor), h = n === Zt.Stroke, f = s ? gc(t, h) : !1, b = En(a, f ? "wick" : "body", s), x = r.borderSize ?? 1, v = En(r.borderColor ?? a, "border", s), w = r.borderStyle ?? Ke.Solid, B = r.borderRadius ?? 0, N = r.borderDashedValue ?? [2, 2], oe = n === Zt.Fill || r.style === Zt.StrokeFill, V = n === Zt.Stroke || r.style === Zt.StrokeFill;
  if (oe) {
    e.fillStyle = b, Fn(e, t, B), e.fill();
    const R = En(a, "border", s);
    !f && s && R && (e.strokeStyle = R, e.lineWidth = Math.max(1, x), e.setLineDash([]), Fn(e, t, B), e.stroke());
  }
...
const u = (e, t) => {
  ...
  const te = q(() => {
    const I = e.periods.filter((F) => {
      if (!a() || J())
        return !0;
      const ye = e.period.text, Ae = h();
      if (F.text === ye || Ae && F.text === Ae)
        return !0;
      if (!Ae || Ae === ye) {
        const Ce = e.periods.find((ze) => ze.text !== ye);
  ...
  return He(() => {
    ...
    I !== D && (a() && (f(D), localStorage.setItem("klinechart_secondary_period", D)), D = I), setTimeout(E, 50);
  }), He(() => {
    J(), setTimeout(E, 100);
  }), He(() => {
    ...
    const I = Wh.cloneNode(!0), F = I.firstChild, ye = F.firstChild, Ae = ye.firstChild, Ce = ye.nextSibling, ze = Ce.firstChild;
    return I.style.setProperty("position", "relative"), I.style.setProperty("width", "100%"), I.style.setProperty("display", "flex"), I.style.setProperty("align-items", "center"), C(I, A(de, {
      ...
      t = k;
    }, F), F.style.setProperty("width", "100%"), F.style.setProperty("overflow", "auto"), ct(Ae, "click", e.onMenuClick, !0), C(F, A(de, {
      get when() {
        return e.symbol;
      },
      get children() {
        const k = Ih.cloneNode(!0), pe = k.firstChild;
        return ct(k, "click", e.onSymbolClick, !0), C(k, A(de, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            const Te = Nh.cloneNode(!0);
            return K(() => Ee(Te, "src", e.symbol.logo)), Te;
          }
      ...
      return (() => {
        const ht = qh.cloneNode(!0);
        return ht.$$click = (we) => {
          a() && Te && !J() ? (e.onMobilePeriodClick ? e.onMobilePeriodClick(k) : e.onMenuClick(), we.stopPropagation()) : e.onPeriodChange(k);
        }, ge(ht, `item period ${Te ? "selected" : ""}`), C(ht, () => k.text), ht;
      })();
    }), Ce), C(F, A(de, {
      get when() {
      ...
      get children() {
        ...
        return ct(k, "click", e.onTimeToolsClick, !0), k;
      }
    }), Ce), C(F, A(de, {
      get when() {
        return !a();
      ...
      get children() {
        ...
        return ct(k, "click", e.onIndicatorClick, !0), C(Te, () => u("indicator", e.locale)), k;
      }
      ...
      get children() {
        const k = Kh.cloneNode(!0), pe = k.firstChild, Te = pe.firstChild, ht = Te.nextSibling;
        return kt((we) => {
          r = we;
        }, k), k.style.setProperty("display", "flex"), k.style.setProperty("align-items", "center"), pe.$$click = (we) => {
          we.stopPropagation(), le();
        }, pe.style.setProperty("gap", "6px"), ht.style.setProperty("transition", "transform 0.2s ease"), C(k, A(de, {
          get when() {
            return b();
          },
          get children() {
            return A(gi, {
              ...
              get children() {
                const we = Vh.cloneNode(!0), et = we.firstChild, ft = et.firstChild, Bt = ft.firstChild, o1 = Bt.firstChild, i1 = o1.firstChild, L1 = ft.nextSibling, w1 = L1.firstChild, Et = w1.firstChild, A1 = Et.firstChild, T1 = w1.nextSibling, a1 = T1.firstChild, Ve = a1.firstChild, s1 = et.nextSibling, pt = s1.firstChild, Ft = pt.firstChild, gt = Ft.firstChild, it = gt.firstChild, M1 = pt.nextSibling, qe = M1.firstChild, S1 = qe.firstChild, P1 = S1.nextSibling, Ut = qe.nextSibling, At = Ut.firstChild, l1 = At.nextSibling, zt = l1.firstChild, D1 = zt.firstChild, O1 = s1.nextSibling, xn = O1.firstChild, N1 = xn.firstChild, Vt = O1.nextSibling, c1 = Vt.nextSibling, I1 = c1.firstChild, B1 = I1.firstChild, u1 = c1.nextSibling, Qe = u1.nextSibling, Ye = Qe.firstChild, Ge = Ye.firstChild, Ze = Qe.nextSibling, d1 = Ze.firstChild, h1 = d1.firstChild, Tt = h1.firstChild, f1 = Tt.firstChild, Me = d1.nextSibling, De = Me.firstChild, Ln = De.firstChild, Xe = Ln.firstChild, vt = De.nextSibling, bt = vt.firstChild, E1 = bt.firstChild, Mt = vt.nextSibling, wn = Mt.firstChild, at = wn.firstChild, Kt = Ze.nextSibling, An = Kt.firstChild, Rt = An.firstChild, F1 = Kt.nextSibling, g1 = F1.firstChild, U1 = g1.firstChild;
                return we.$$mousedown = ($) => $.stopPropagation(), kt(($) => {
                  n = $;
                }, we), we.style.setProperty("position", "fixed"), we.style.setProperty("z-index", "9999"), ft.$$click = ($) => {
                ...
                }, gt.$$mousedown = ($) => $.stopPropagation(), gt.$$click = ($) => $.stopPropagation(), it.addEventListener("change", ($) => {
                  var S;
                  ...
                  var $;
                  return no((($ = e.orderToolsState) == null ? void 0 : $.openOrdersDisplay) ?? "right");
                }, D1), C(l1, A(de, {
                  get when() {
                    return oe();
                  },
                  get children() {
                    ...
                    return C($, () => ["left", "center", "right"].map((S) => (() => {
                      const Be = Yh.cloneNode(!0);
                      return Be.$$click = (Fe) => {
                        var je;
                        Fe.preventDefault(), Fe.stopPropagation(), (je = e.onOrderToolsStateChange) == null || je.call(e, {
                          openOrdersDisplay: S
                        }), V(!1);
                      }, C(Be, () => no(S)), K(() => {
                        var Fe;
                        return ge(Be, (((Fe = e.orderToolsState) == null ? void 0 : Fe.openOrdersDisplay) ?? "right") === S ? "selected" : "");
                      }), Be;
                    })())), $;
                  }
                  ...
                  var jt;
                  const S = `${he().top}px`, Be = `${he().left}px`, Fe = `${he().minWidth}px`, je = `klinecharts-pro-order-tools-group${v() ? " klinecharts-pro-order-tools-group-open" : ""}`, mt = `klinecharts-pro-order-tools-group${B() ? " klinecharts-pro-order-tools-group-open" : ""}`, z1 = `klinecharts-pro-order-tools-switch${((jt = e.orderToolsState) == null ? void 0 : jt.openOrdersExtendedPriceLine) ?? !0 ? " klinecharts-pro-order-tools-switch-on" : ""}`, V1 = `klinecharts-pro-order-tools-display-arrow${oe() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, K1 = `klinecharts-pro-order-tools-group${R() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return S !== $._v$ && we.style.setProperty("top", $._v$ = S), Be !== $._v$2 && we.style.setProperty("left", $._v$2 = Be), Fe !== $._v$3 && we.style.setProperty("width", $._v$3 = Fe), je !== $._v$4 && ge(et, $._v$4 = je), mt !== $._v$5 && ge(s1, $._v$5 = mt), z1 !== $._v$6 && ge(P1, $._v$6 = z1), V1 !== $._v$7 && Ee(D1, "class", $._v$7 = V1), K1 !== $._v$8 && ge(Ze, $._v$8 = K1), $;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var $, S, Be, Fe;
                  return i1.checked = ((($ = e.orderToolsState) == null ? void 0 : $.quickOrderFloatingWindow) ?? ((S = e.orderToolsState) == null ? void 0 : S.quickOrder) ?? !0) || (((Be = e.orderToolsState) == null ? void 0 : Be.quickOrderPlusButton) ?? ((Fe = e.orderToolsState) == null ? void 0 : Fe.quickOrder) ?? !0);
                }), K(() => {
                  var $, S;
                  return A1.checked = (($ = e.orderToolsState) == null ? void 0 : $.quickOrderFloatingWindow) ?? ((S = e.orderToolsState) == null ? void 0 : S.quickOrder) ?? !0;
                }), K(() => {
                  var $, S;
                  return Ve.checked = (($ = e.orderToolsState) == null ? void 0 : $.quickOrderPlusButton) ?? ((S = e.orderToolsState) == null ? void 0 : S.quickOrder) ?? !0;
                }), K(() => {
                  var $;
                  return it.checked = (($ = e.orderToolsState) == null ? void 0 : $.openOrders) ?? !0;
                }), K(() => {
                  var $;
                  ...
                  var $;
                  return Ge.checked = (($ = e.orderToolsState) == null ? void 0 : $.liquidationPrice) ?? !0;
                }), K(() => {
                  var $, S, Be, Fe, je, mt;
                  return f1.checked = ((($ = e.orderToolsState) == null ? void 0 : $.marketPriceLine) ?? ((S = e.orderToolsState) == null ? void 0 : S.priceLine) ?? !0) || (((Be = e.orderToolsState) == null ? void 0 : Be.countDown) ?? ((Fe = e.orderToolsState) == null ? void 0 : Fe.priceLine) ?? !0) || (((je = e.orderToolsState) == null ? void 0 : je.bidAskPrice) ?? ((mt = e.orderToolsState) == null ? void 0 : mt.priceLine) ?? !0);
                }), K(() => {
                  var $, S;
                  return Xe.checked = (($ = e.orderToolsState) == null ? void 0 : $.marketPriceLine) ?? ((S = e.orderToolsState) == null ? void 0 : S.priceLine) ?? !0;
                }), K(() => {
                  var $, S;
          ...
          const et = a() ? "0 8px" : "0 10px", ft = b() ? "rotate(180deg)" : "rotate(0deg)";
          return et !== we._v$9 && pe.style.setProperty("padding", we._v$9 = et), ft !== we._v$10 && ht.style.setProperty("transform", we._v$10 = ft), we;
        }, {
          _v$9: void 0,
          _v$10: void 0
        }), k;
      ...
      get children() {
        return [(() => {
          ...
          return ct(k, "click", e.onTimezoneClick, !0), k;
        })(), (() => {
          const k = jh.cloneNode(!0);
          return ct(k, "click", e.onSettingClick, !0), k;
        })()];
      }
    }), ze), C(Ce, A(de, {
      get when() {
      ...
      get children() {
        ...
        return ct(k, "click", e.onScreenshotClick, !0), k;
      }
    }), ze), ze.$$click = () => {
      if (J())
      ...
      get children() {
        ...
        return ct(k, "click", e.chartViewToggle.onToggle, !0), C(k, (() => {
      ...
      return pe !== k._v$11 && Ee(Ae, "class", k._v$11 = pe), Te !== k._v$12 && Ce.style.setProperty("padding-right", k._v$12 = Te), k;
    }, {
      _v$11: void 0,
      _v$12: void 0
    }), I;
...
const Je = (e) => kg[e.name](e.class), Sg = /* @__PURE__ */ p('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Pg = /* @__PURE__ */ p('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), ro = /* @__PURE__ */ p('<li><span style="padding-left:8px"></span></li>'), oo = "drawing_tools", Dg = (e) => {
  const [t, r] = M("horizontalStraightLine"), [n, a] = M("priceChannelLine"), [s, h] = M("circle"), [f, b] = M("fibonacciLine"), [x, v] = M("xabcd"), [w, B] = M("weak_magnet"), [N, oe] = M("normal"), [V, R] = M(!1), [U, he] = M(!0), [Z, X] = M(""), J = q(() => [{
    key: "singleLine",
    icon: t(),
    list: xg(e.locale),
    setter: r
  ...
  return (() => {
    const W = Sg.cloneNode(!0), H = W.firstChild, ee = H.nextSibling, se = ee.firstChild, T = se.nextSibling, j = T.firstChild, Q = ee.nextSibling, z = Q.firstChild, le = Q.nextSibling, ce = le.firstChild, re = le.nextSibling, E = re.nextSibling, te = E.firstChild;
    return C(W, () => J().map((D) => (() => {
      ...
      return I.addEventListener("blur", () => {
        ...
        return () => Ce() && A(gn, {
          class: "list",
          get children() {
            return D.list.map((ze) => (() => {
              const k = ro.cloneNode(!0), pe = k.firstChild;
              return k.$$click = () => {
                D.setter(ze.key), e.onDrawingItemClick({
                  name: ze.key,
                  lock: V(),
                  mode: N()
                }), X("");
      ...
      })(), null), K(() => Ee(Ae, "class", D.key === Z() ? "rotate" : "")), I;
      ...
      return () => D() && A(gn, {
        ...
        get children() {
          return ve().map((I) => (() => {
            const F = ro.cloneNode(!0), ye = F.firstChild;
            return F.$$click = () => {
...
We(["click"]);
const io = /* @__PURE__ */ p('<li class="title"></li>'), ao = /* @__PURE__ */ p('<li class="row"></li>'), Og = (e) => A(wt, {
  get title() {
...
const Bg = /* @__PURE__ */ p('<div class="chart-style-color-picker"><button type="button" class="chart-style-color-swatch"></button></div>'), Eg = /* @__PURE__ */ p('<div class="chart-style-color-popover"><div class="chart-style-color-grid"></div></div>'), Fg = /* @__PURE__ */ p('<button type="button" class="chart-style-palette-color"></button>'), Ug = /* @__PURE__ */ p('<div class="chart-style-line-control"><div class="chart-style-width-picker"><button type="button" class="chart-style-size-button"><span></span></button></div></div>'), zg = /* @__PURE__ */ p('<div class="chart-style-width-popover"></div>'), Vg = /* @__PURE__ */ p('<button type="button"><span></span></button>'), Kg = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-title-tabs"><button type="button"></button><button type="button">Chart Style</button></div>'), Rg = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), jg = /* @__PURE__ */ p('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), Qg = /* @__PURE__ */ p('<div class="klinecharts-pro-chart-style-content"><div class="chart-style-sidebar"><button type="button">Symbol</button><button type="button">Background</button></div><div class="chart-style-panel"><p class="chart-style-note">* Chart Style takes precedence over default chart settings. Click Reset to align with the default theme.</p></div></div>'), Zg = /* @__PURE__ */ p("<h3>Symbol</h3>"), Hg = /* @__PURE__ */ p('<div class="chart-style-row"><span>Candle Stick</span><div class="chart-style-color-pair"></div></div>'), Wg = /* @__PURE__ */ p('<div class="chart-style-row"><span>Borders</span><div class="chart-style-color-pair"></div></div>'), qg = /* @__PURE__ */ p('<div class="chart-style-row"><span>Wick</span><div class="chart-style-color-pair"></div></div>'), Yg = /* @__PURE__ */ p("<h3>Background</h3>"), Gg = /* @__PURE__ */ p('<div class="chart-style-row"><span>Color</span></div>'), Xg = /* @__PURE__ */ p('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Vert Grid Lines</span></label></div>'), Jg = /* @__PURE__ */ p('<div class="chart-style-row"><label class="chart-style-check-row"><input type="checkbox"><span class="chart-style-check-box" aria-hidden="true"></span><span>Horz Grid Lines</span></label></div>'), k1 = "chart.backgroundColor", mn = "#171a27", em = ["#f6465d", "#f59e0b", "#fcd535", "#2ebd85", "#4098a8", "#22c1dc", "#3861fb", "#7b3fe4", "#ec8aa4", "#f7c56b", "#fff0a3", "#9ed4a4", "#83c7bb", "#8bdce6", "#8bb9f7", "#b7a1dc", "#c9343e", "#e76f20", "#f0b93a", "#3f8d3a", "#236e5a", "#237c88", "#1d3fbf", "#3a209f", "#ffffff", "#cbd5e1", "#9ca3af", "#6b7280", "#374151", "#111827", "#000000"], tm = [{
  ...
  return Ne(r, "candle.bar.upBorderColor", O.formatValue(r, "candle.bar.upBorderColor", n)), Ne(r, "candle.bar.downBorderColor", O.formatValue(r, "candle.bar.downBorderColor", a)), Ne(r, "candle.bar.noChangeBorderColor", O.formatValue(r, "candle.bar.noChangeBorderColor", s)), Ne(r, "candle.bar.upWickColor", O.formatValue(r, "candle.bar.upWickColor", n)), Ne(r, "candle.bar.downWickColor", O.formatValue(r, "candle.bar.downWickColor", a)), Ne(r, "candle.bar.noChangeWickColor", O.formatValue(r, "candle.bar.noChangeWickColor", s)), Ne(r, "candle.bar.borderUpColor", O.formatValue(r, "candle.bar.borderUpColor", O.formatValue(r, "candle.bar.upBorderColor"))), Ne(r, "candle.bar.borderDownColor", O.formatValue(r, "candle.bar.borderDownColor", O.formatValue(r, "candle.bar.downBorderColor"))), Ne(r, "candle.bar.borderNoChangeColor", O.formatValue(r, "candle.bar.borderNoChangeColor", O.formatValue(r, "candle.bar.noChangeBorderColor"))), Ne(r, "candle.bar.wickUpColor", O.formatValue(r, "candle.bar.wickUpColor", O.formatValue(r, "candle.bar.upWickColor"))), Ne(r, "candle.bar.wickDownColor", O.formatValue(r, "candle.bar.wickDownColor", O.formatValue(r, "candle.bar.downWickColor"))), Ne(r, "candle.bar.wickNoChangeColor", O.formatValue(r, "candle.bar.wickNoChangeColor", O.formatValue(r, "candle.bar.noChangeWickColor"))), Ne(r, k1, t), r;
}, rm = (e, t, r) => {
  if (t === k1)
    return r ?? mn;
  const a = {
  ...
  return a ? O.formatValue(e, a) : O.formatValue(e, t, O.formatValue(Jo(e), t));
}, om = (e) => {
  const [t, r] = M(e.currentStyles), [n, a] = M(Jo(e.currentStyles, e.currentBackgroundColor ?? mn)), [s, h] = M(lo(e.locale)), [f, b] = M(!1), [x, v] = M("settings"), [w, B] = M("symbol"), [N, oe] = M(null), [V, R] = M(null), U = () => {
  ...
  const he = (T, j) => {
    ...
    Ne(Q, T.key, j);
    const z = O.clone(t());
    Ne(z, T.key, j), r(z), h(s().map((le) => ({
      ...le
    }))), e.onChange(Q);
  }, Z = (T, j) => O.formatValue(n(), T, j), X = (T, j) => {
    const Q = O.clone(n());
    Ne(Q, T, j), a(Q), e.onChange(J(Q));
  }, J = (T) => {
    const j = O.formatValue(T, "candle.bar.upColor"), Q = O.formatValue(T, "candle.bar.downColor"), z = O.formatValue(T, "candle.bar.noChangeColor"), le = O.formatValue(T, "candle.bar.upBorderColor", j), ce = O.formatValue(T, "candle.bar.downBorderColor", Q), re = O.formatValue(T, "candle.bar.noChangeBorderColor", z), E = O.formatValue(T, "candle.bar.upWickColor", j), te = O.formatValue(T, "candle.bar.downWickColor", Q), D = O.formatValue(T, "candle.bar.noChangeWickColor", z);
    return {
      chart: {
    ...
    if (T) {
      const Q = O.clone(n());
      co.forEach((z) => {
        Ne(Q, z.key, rm(T, z.key, e.defaultBackgroundColor));
      }), a(Q), r(O.clone(Q)), e.onChange(J(Q));
    } else
      e.onRestoreDefault(co), a(O.clone(e.currentStyles));
  }, H = (T, j = T) => {
    const Q = Z(T, "#ffffff");
    return (() => {
      ...
      return le.$$click = () => {
        ...
        const ce = q(() => N() === j);
        return () => ce() && (() => {
          const re = Eg.cloneNode(!0), E = re.firstChild;
          return C(E, A(_1, {
            each: em,
            children: (te) => (() => {
    ...
    return (() => {
      const re = Ug.cloneNode(!0), E = re.firstChild, te = E.firstChild, D = te.firstChild;
      return C(re, A(Gn, {
        get style() {
          return {
            width: f() ? "100%" : "134px"
      ...
      return q(() => x() === "settings")() ? (() => {
        ...
        return C(T, A(_1, {
          ...
          children: (j) => {
            ...
            return (() => {
              const le = jg.cloneNode(!0), ce = le.firstChild, re = ce.nextSibling;
              return C(ce, () => j.text), C(re, Q), K(() => le.classList.toggle("mobile-item", !!f())), le;
            })();
          }
        })), K(() => T.classList.toggle("mobile-layout", !!f())), T;
      })() : (() => {
        ...
        return Q.$$click = () => B("symbol"), z.$$click = () => B("background"), C(le, (() => {
          ...
          const E = !!f(), te = w() === "symbol", D = w() === "background";
          return E !== re._v$3 && T.classList.toggle("mobile-layout", re._v$3 = E), te !== re._v$4 && Q.classList.toggle("active", re._v$4 = te), D !== re._v$5 && z.classList.toggle("active", re._v$5 = D), re;
        }, {
          _v$3: void 0,
          _v$4: void 0,
          _v$5: void 0
...
We(["click"]);
const im = /* @__PURE__ */ p('<img style="width:500px;margin-top: 20px">'), am = (e) => A(wt, {
  get title() {
  ...
  return A(wt, {
    ...
    get buttons() {
      return [{
        ...
        onClick: () => {
          ...
          O.clone(t()).forEach((h, f) => {
            !O.isValid(h) || h === "" ? "default" in a[f] && s.push(a[f].default) : s.push(h);
    ...
    get children() {
      ...
      return C(a, () => n(e.params.indicatorName).map((s, h) => [(() => {
        const f = cm.cloneNode(!0);
        return C(f, () => u(s.paramNameKey, e.locale)), f;
      })(), A(Go, {
        style: {
          width: "200px"
        },
  ...
  return A(wt, {
    ...
    get children() {
      return [A(Go, {
        ...
        renderItem: (a) => (() => {
          const s = fm.cloneNode(!0), h = s.firstChild, f = h.firstChild;
          return s.$$click = () => {
          ...
          }), f), C(f, () => a.shortName ?? a.ticker, null), C(f, () => `${a.name ? `(${a.name})` : ""}`, null), C(s, () => a.exchange ?? "", null), K(() => Ee(f, "title", a.name ?? "")), s;
        })()
      })];
    }
  });
...
const mm = /* @__PURE__ */ p('<div class="klinecharts-pro-mobile-more-modal-content"><div class="item"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="20" height="20" rx="4" ry="4" fill="none" stroke="currentColor" stroke-width="2"></rect><path d="m15.92 13.9-3.65-3.55a.773.773 0 0 1 0-1.12c.32-.33.79-.33 1.11 0l3.02 3.38c.31.32.31.81 0 1.13-.16.16-.48.16-.48.16Z" fill="currentColor" stroke="1"></path><path d="m12.43 14.23-.48-.17q-.48-.48 0-.96l4.13-4.36c.31-.32.63-.32.95 0s.32.65 0 .97l-4.13 4.35c-.15.17-.31.17-.47.17Zm-1.11-9.52c.31 0 1.11.16 1.11.97 0 .64-.95.48-1.27.48-1.43 0-1.91.81-2.07 1.45l-.31 1.94h1.58c.32 0 .64.32.64.64 0 .33-.32.65-.64.65H8.62l-1.11 4.99c-.16 1.46-1.11 1.46-1.59 0L7.03 11H5.6c-.31 0-.63-.32-.63-.65 0-.64.32-.8.63-.8h1.75l.48-2.1c.31-2.74 2.69-2.9 3.49-2.74Z" fill="noncurrentColore" stroke="1"></path></svg><span></span></div><div class="item"><svg width="20" height="20" viewBox="0 0 20 20"><path d="M18.5446,9.09091C18.3333,6.61616,17.2887,4.31818,15.5751,2.63889C13.8498,0.94697,11.6197,0,9.28404,0C8.02817,0,6.81925,0.265151,5.66901,0.782828C5.65728,0.782828,5.65728,0.795454,5.64554,0.795454C5.6338,0.795454,5.6338,0.808081,5.62207,0.808081C4.53052,1.31313,3.55634,2.0202,2.71127,2.92929C1.85446,3.85101,1.18545,4.91162,0.715963,6.11111C0.246479,7.33586,0,8.64899,0,10C0,10.8712,0.105634,11.7172,0.305164,12.5379C0.305164,12.5631,0.316901,12.5884,0.328638,12.6136C0.739437,14.2298,1.51408,15.7197,2.62911,16.9571C4.07277,18.548,5.92723,19.5581,7.93427,19.8737C7.95775,19.8737,7.96948,19.8864,7.99296,19.8864C8.3216,19.9369,8.66197,19.9747,9.00235,19.9747L9.21362,19.9747C9.61268,19.9747,10.3756,19.9369,11.0094,19.697C11.1737,19.6338,11.3028,19.5076,11.3732,19.3434C11.4437,19.1793,11.4554,18.9899,11.3967,18.8131C11.3028,18.5354,11.0563,18.346,10.7864,18.346C10.716,18.346,10.6338,18.3586,10.5634,18.3838C10.0939,18.5606,9.46009,18.5859,9.20188,18.5859L9.09624,18.5859C9.20188,18.2702,9.23709,17.9167,9.15493,17.5505C9.00235,16.8939,8.50939,16.3384,7.58216,15.7955L7.19484,15.5682C6.57277,15.2146,6.23239,15.0253,6.03286,14.7348C5.83333,14.4444,5.69249,13.9899,5.51643,12.9798C5.38732,12.298,5.04695,11.7677,4.50704,11.4646C4.14319,11.2626,3.70892,11.149,3.19249,11.149C2.82864,11.149,2.42958,11.1995,2.00704,11.3005C1.79578,11.351,1.59624,11.4141,1.42019,11.4646C1.33803,10.9848,1.30282,10.4798,1.30282,9.97475C1.30282,6.93182,2.76995,4.26768,4.98826,2.72727C5,3.00505,5.05869,3.29545,5.17606,3.57323C5.48122,4.26768,6.10329,4.7096,7.01878,4.89899C7.06573,4.91162,7.10094,4.91162,7.13615,4.91162L7.1831,4.91162C7.26526,4.91162,7.57042,4.92424,7.88732,5.0505C8.3216,5.2399,8.56808,5.55555,8.65023,6.04798C8.84977,7.61364,9.07277,10.4293,8.79108,11.3384C8.76761,11.4141,8.75587,11.4899,8.75587,11.5657C8.75587,11.9444,9.0493,12.2601,9.40141,12.2601C9.57747,12.2601,9.74179,12.1843,9.85915,12.0581C9.97653,11.9318,12.6174,9.05303,13.3216,8.09343C13.4038,7.97979,13.4859,7.87878,13.5798,7.76515C13.9202,7.33586,14.2723,6.90656,14.4014,6.26262C14.554,5.56818,14.4014,4.79798,13.9437,3.85101C13.615,3.16919,13.5563,2.86616,13.5446,2.75252C13.5563,2.7399,13.5798,2.72727,13.6033,2.71464C15.6221,4.10353,17.0188,6.43939,17.2535,9.19192C17.2887,9.55808,17.5587,9.82323,17.8991,9.82323L17.9577,9.82323C18.3099,9.8106,18.5681,9.48232,18.5446,9.09091ZM3.19249,12.5631C3.48592,12.5631,3.72066,12.6136,3.89671,12.7146C4.08451,12.8283,4.19014,12.9924,4.23709,13.2702C4.43662,14.3434,4.61268,15.0631,5,15.6061C5.37559,16.1364,5.85681,16.4015,6.58451,16.8182L6.60798,16.8308C6.71362,16.8939,6.84272,16.9571,6.96009,17.0328C7.69953,17.4621,7.86385,17.7525,7.89906,17.8914C7.93427,18.0303,7.85211,18.2323,7.74648,18.4343C4.91784,17.8535,2.65258,15.6944,1.73709,12.8283C2.15962,12.702,2.71127,12.5631,3.19249,12.5631ZM12.7934,4.5202C13.4272,5.83333,13.1455,6.18687,12.5822,6.89394C12.4883,7.00758,12.3944,7.12121,12.3005,7.24747C11.9484,7.72727,11.0211,8.77525,10.2113,9.68434C10.2113,9.24242,10.1878,8.73737,10.1526,8.19444C10.0704,6.95707,9.92958,5.90909,9.92958,5.87121L9.92958,5.83333C9.75352,4.83586,9.20188,4.11616,8.3216,3.76263C7.82864,3.56061,7.37089,3.53535,7.19484,3.53535C6.73709,3.43434,6.4554,3.24495,6.33803,2.99242C6.19718,2.68939,6.29108,2.24747,6.38498,1.9697C7.28873,1.59091,8.26291,1.37626,9.28404,1.37626C10.3873,1.37626,11.4437,1.61616,12.4061,2.04545C12.3357,2.18434,12.277,2.34848,12.2535,2.5505C12.2066,3.04293,12.3709,3.64899,12.7934,4.5202Z"></path></svg><span></span></div><div class="item"><svg viewBox="0 0 20 20"><rect x="3" y="4" width="14" height="14" rx="2" fill="none" stroke="currentColor" stroke-width="1.8"></rect><path d="M6 2.5v4M14 2.5v4M3 8h14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path><path d="M10 11v3l2.2 1.3" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path></svg><span>Time Tools</span></div><div class="item"><svg viewBox="0 0 20 20"><path d="M19.7361,12.542L18.1916,11.2919C18.2647,10.8678,18.3025,10.4347,18.3025,10.0017C18.3025,9.56861,18.2647,9.13555,18.1916,8.71142L19.7361,7.46135C19.9743,7.26938,20.0615,6.95686,19.9554,6.6756L19.9342,6.61756C19.5074,5.49026,18.8755,4.45449,18.0549,3.53926L18.0124,3.49238C17.8096,3.26692,17.4819,3.1821,17.1848,3.28032L15.2677,3.92544C14.5603,3.3763,13.7704,2.94324,12.9168,2.63966L12.5466,0.742229C12.49,0.449802,12.2472,0.222111,11.9383,0.168536L11.8746,0.157375C10.6461,-0.0524583,9.35391,-0.0524583,8.1254,0.157375L8.06174,0.168536C7.75284,0.222111,7.50997,0.449802,7.45338,0.742229L7.08082,2.64859C6.2343,2.95217,5.44909,3.383,4.74641,3.92991L2.81522,3.28032C2.52047,3.1821,2.19036,3.26469,1.98757,3.49238L1.94513,3.53926C1.12455,4.45672,0.492609,5.49249,0.0658141,6.61756L0.0445921,6.6756C-0.0615171,6.95463,0.0257283,7.26715,0.263885,7.46135L1.82723,8.72482C1.75413,9.14448,1.71876,9.57308,1.71876,9.99944C1.71876,10.428,1.75413,10.8566,1.82723,11.2741L0.263885,12.5375C0.025729,12.7295,-0.0615164,13.042,0.0445929,13.3233L0.0658148,13.3813C0.49261,14.5064,1.12455,15.5444,1.94513,16.4596L1.98757,16.5065C2.19036,16.732,2.51812,16.8168,2.81522,16.7186L4.74641,16.069C5.44909,16.6159,6.2343,17.0489,7.08082,17.3503L7.45338,19.2567C7.50997,19.5491,7.75284,19.7768,8.06174,19.8303L8.1254,19.8415C8.74084,19.9464,9.37042,20,10,20C10.6296,20,11.2615,19.9464,11.8746,19.8415L11.9383,19.8303C12.2472,19.7768,12.49,19.5491,12.5466,19.2567L12.9168,17.3592C13.7704,17.0556,14.5603,16.6248,15.2677,16.0734L17.1848,16.7186C17.4795,16.8168,17.8096,16.7342,18.0124,16.5065L18.0549,16.4596C18.8755,15.5422,19.5074,14.5064,19.9342,13.3813L19.9554,13.3233C20.0615,13.0487,19.9743,12.7362,19.7361,12.542ZM16.5175,8.97483C16.5764,9.3119,16.6071,9.65791,16.6071,10.0039C16.6071,10.3499,16.5764,10.6959,16.5175,11.033L16.3618,11.9281L18.1233,13.3545C17.8568,13.9372,17.5196,14.4863,17.1188,14.9975L14.9305,14.2631L14.1901,14.839C13.6266,15.2765,12.9994,15.6203,12.3203,15.8614L11.4219,16.1806L10.9998,18.3459C10.3372,18.4173,9.66045,18.4173,8.9955,18.3459L8.57342,16.1761L7.6821,15.8524C7.01008,15.6114,6.38521,15.2676,5.82637,14.8323L5.08596,14.2541L2.88361,14.9953C2.48275,14.4841,2.14791,13.9327,1.8791,13.3523L3.65938,11.9125L3.50611,11.0196C3.44952,10.687,3.41887,10.3432,3.41887,10.0039C3.41887,9.66237,3.44716,9.32083,3.50611,8.98822L3.65938,8.09531L1.8791,6.6555C2.14556,6.07288,2.48275,5.52374,2.88361,5.01255L5.08596,5.75367L5.82637,5.17551C6.38521,4.74022,7.01008,4.39645,7.6821,4.15536L8.57578,3.83615L8.99786,1.66638C9.66045,1.59495,10.3372,1.59495,11.0021,1.66638L11.4242,3.83168L12.3226,4.1509C12.9994,4.39198,13.6289,4.73575,14.1925,5.17328L14.9329,5.7492L17.1211,5.01479C17.522,5.52598,17.8568,6.07734,18.1256,6.65773L16.3642,8.08416L16.5175,8.97483ZM10.0024,5.85189C7.7104,5.85189,5.85231,7.61092,5.85231,9.78068C5.85231,11.9504,7.7104,13.7095,10.0024,13.7095C12.2943,13.7095,14.1524,11.9504,14.1524,9.78068C14.1524,7.61092,12.2943,5.85189,10.0024,5.85189ZM11.8699,11.5486C11.37,12.0196,10.7074,12.2808,10.0024,12.2808C9.29732,12.2808,8.63473,12.0196,8.13483,11.5486C7.6373,11.0754,7.36142,10.4481,7.36142,9.78068C7.36142,9.11323,7.6373,8.48596,8.13483,8.01272C8.63473,7.53948,9.29732,7.28054,10.0024,7.28054C10.7074,7.28054,11.37,7.53948,11.8699,8.01272C12.3674,8.48596,12.6433,9.11323,12.6433,9.78068C12.6433,10.4481,12.3674,11.0754,11.8699,11.5486Z"></path></svg><span></span></div></div>'), ym = (e) => A(wt, {
  ...
  get children() {
    const t = mm.cloneNode(!0), r = t.firstChild, n = r.firstChild, a = n.nextSibling, s = r.nextSibling, h = s.firstChild, f = h.nextSibling, b = s.nextSibling, x = b.nextSibling, v = x.firstChild, w = v.nextSibling;
    return r.$$click = () => {
      e.onIndicatorClick(), e.onClose();
    }, C(a, () => u("indicator", e.locale)), s.$$click = () => {
      e.onTimezoneClick(), e.onClose();
    }, C(f, () => u("timezone", e.locale)), b.$$click = () => {
...
const Cm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-picker"></div>'), pm = /* @__PURE__ */ p('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), vm = /* @__PURE__ */ p("<span></span>"), bm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), $m = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-grid"></div>'), _m = /* @__PURE__ */ p('<span class="weekday"></span>'), Dt = /* @__PURE__ */ p('<button type="button"></button>'), km = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-month-grid"></div>'), xm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), Lm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), wm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-content"></div>'), Am = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-tabs"></div>'), Tm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), Mm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), Sm = /* @__PURE__ */ p('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), Pm = [{
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], Dm = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], uo = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], Wt = (e) => String(e).padStart(2, "0"), ho = (e, t, r) => Math.min(r, new Date(e, t + 1, 0).getDate()), Un = (e) => {
  const t = new Date(e);
  return {
    year: t.getFullYear(),
    month: t.getMonth(),
  ...
  const [t, r] = M(!0), [n, a] = M("date"), [s, h] = M(e.value.year), [f, b] = M(e.value.month), x = q(() => Om(s(), f())), v = q(() => Math.floor(s() / 10) * 10), w = q(() => Array.from({
    length: 12
    ...
    const H = new Date(s(), f() + W, 1);
    h(H.getFullYear()), b(H.getMonth());
  }, U = () => {
    ...
    e.onChange({
      ...
      month: W.getMonth(),
      day: W.getDate()
    }), (H = e.onDateSelect) == null || H.call(e), h(W.getFullYear()), b(W.getMonth());
  }, Z = (W) => {
    b(W), e.onChange({
      ...e.value,
      year: s(),
      month: W,
      day: ho(s(), W, e.value.day)
    }), a("date");
  }, X = (W) => {
    h(W), e.onChange({
      ...e.value,
      year: W,
      day: ho(W, e.value.month, e.value.day)
    }), a("month");
  }, J = (W) => {
    const H = N() === "PM";
    e.onChange({
  ...
  return (() => {
    ...
    return C(W, (() => {
      ...
      return () => H() && (() => {
        ...
        return T.$$click = () => {
          n() === "year" ? h(s() - 10) : n() === "month" ? h(s() - 1) : R(-12);
        }, j.$$click = () => {
          n() === "year" ? h(s() - 10) : n() === "month" ? h(s() - 1) : R(-1);
        }, Q.$$click = U, C(Q, (() => {
          const ce = q(() => n() === "year");
          return () => ce() ? `${v()}-${v() + 9}` : (() => {
            const re = q(() => n() === "month");
          ...
          const ce = q(() => n() === "date");
          return () => ce() && (() => {
            const re = $m.cloneNode(!0);
            return C(re, () => Dm.map((E) => (() => {
              ...
              const D = zn({
                ...
                month: E.getMonth(),
                day: E.getDate()
              }), I = e.range ? zn(e.range.from) : NaN, F = e.range ? zn(e.range.to) : NaN, ye = Math.min(I, F), Ae = Math.max(I, F), Ce = Number.isFinite(ye) && D >= ye && D <= Ae, ze = Number.isFinite(ye) && (D === ye || D === Ae), k = E.getFullYear() === e.value.year && E.getMonth() === e.value.month && E.getDate() === e.value.day;
              return (() => {
                const pe = Dt.cloneNode(!0);
                return pe.$$click = () => he(E), ge(pe, `${te ? "" : "muted"} ${Ce ? "in-range" : ""} ${ze || k ? "selected" : ""}`), C(pe, () => E.getDate()), pe;
              })();
            }), null), re;
          })();
        })(), null), C(ee, (() => {
          const ce = q(() => n() === "month");
          return () => ce() && (() => {
            const re = km.cloneNode(!0);
            return C(re, () => uo.map((E, te) => (() => {
              const D = Dt.cloneNode(!0);
              return D.$$click = () => Z(te), C(D, E), K(() => ge(D, te === e.value.month && s() === e.value.year ? "selected" : "")), D;
            })())), re;
          })();
        })(), null), C(ee, (() => {
          const ce = q(() => n() === "year");
          ...
          const ce = q(() => n() === "date");
          return () => ce() && (() => {
            const re = Lm.cloneNode(!0), E = re.firstChild, te = E.nextSibling, D = te.nextSibling;
            return C(E, () => oe.map((I) => (() => {
  ...
  const [t, r] = M(e.initialTab ?? "goToDate"), [n, a] = M(Un(e.initialTimestamp)), [s, h] = M(Un(e.initialRange.from)), [f, b] = M(Un(e.initialRange.to)), [x, v] = M("from"), [w, B] = M({
    ...e.anchorSettings,
    ...
    get children() {
      ...
      return C(V, (() => {
        ...
        return () => R() && (() => {
          ...
          return Z.$$click = () => v("from"), C(Z, () => Jn(s())), J.$$click = () => v("to"), C(J, () => Jn(f())), C(U, (() => {
            const ve = q(() => x() === "from");
            return () => ve() ? A(tn, {
              label: "Start",
              get value() {
        ...
        return () => R() && (() => {
          const U = Mm.cloneNode(!0), he = U.firstChild, Z = he.firstChild, X = Z.nextSibling, J = he.nextSibling, ve = J.firstChild, W = ve.nextSibling, H = J.nextSibling, ee = H.firstChild, se = ee.nextSibling, T = H.nextSibling, j = T.firstChild, Q = j.nextSibling;
          return X.$$click = () => N({
            enabled: !w().enabled
            ...
            const le = `klinecharts-pro-time-tools-switch${w().enabled ? " on" : ""}`, ce = `klinecharts-pro-time-tools-row${w().enabled ? "" : " disabled"}`, re = !w().enabled, E = `klinecharts-pro-time-tools-row with-divider${w().enabled ? "" : " disabled"}`, te = `klinecharts-pro-time-tools-switch${w().anchorLine ? " on" : ""}`, D = !w().enabled, I = `klinecharts-pro-time-tools-row with-divider${w().enabled ? "" : " disabled"}`, F = `klinecharts-pro-time-tools-switch${w().acrossTokens ? " on" : ""}`, ye = !w().enabled;
            return le !== z._v$3 && ge(X, z._v$3 = le), ce !== z._v$4 && ge(J, z._v$4 = ce), re !== z._v$5 && (W.disabled = z._v$5 = re), E !== z._v$6 && ge(H, z._v$6 = E), te !== z._v$7 && ge(se, z._v$7 = te), D !== z._v$8 && (se.disabled = z._v$8 = D), I !== z._v$9 && ge(T, z._v$9 = I), F !== z._v$10 && ge(Q, z._v$10 = F), ye !== z._v$11 && (Q.disabled = z._v$11 = ye), z;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
function nn(e, t, r, n) {
  ...
  const a = (e == null ? void 0 : e.createIndicator({
    ...
    createTooltipDataSource: ({
      ...
      const f = [];
      return s.visible ? (f.push(h.tooltip.icons[1]), f.push(h.tooltip.icons[2]), f.push(h.tooltip.icons[3])) : (f.push(h.tooltip.icons[0]), f.push(h.tooltip.icons[2]), f.push(h.tooltip.icons[3])), {
        icons: f
      };
    }
  }, r, n)) ?? null;
...
function Gm(e) {
  const t = Math.max(0, Math.ceil(e / 1e3)), r = Math.floor(t / 3600), n = Math.floor(t % 3600 / 60), a = t % 60, s = (h) => String(h).padStart(2, "0");
  return r > 0 ? `${s(r)}:${s(n)}:${s(a)}` : `${s(n)}:${s(a)}`;
}
const Xm = (e) => {
  var Vr, Kr, Rr, jr, Qr, Zr, Hr, Wr, qr, Yr, Gr, Xr, Jr, e0, t0, n0, r0, o0, i0, a0, s0, l0, c0, u0, d0, h0, f0, g0, m0;
  let t, r, n = null, a;
  const [s, h] = M(!1), [f, b] = M(e.theme), [x, v] = M(e.styles), [w, B] = M(e.locale), [N, oe] = M(e.symbol), [V, R] = M(e.period), U = () => {
    var o, i, l, c;
    return {
    ...
    return l;
  }, [Ae, Ce] = M(""), [ze, k] = M(!1), [pe, Te] = M(Date.now()), [ht, we] = M({
    from: Date.now() - 30 * 24 * 60 * 60 * 1e3,
    to: Date.now()
  }), [et, ft] = M(Ym() ?? e9()), [Bt, o1] = M(e.drawingBarVisible), [i1, L1] = M(!1), [w1, Et] = M(!1), [A1, T1] = M(!1), a1 = ((Vr = e.orderTools) == null ? void 0 : Vr.quickOrder) ?? !0, [Ve, s1] = M({
    quickOrder: a1,
  ...
  let Me = /* @__PURE__ */ new Map(), De = /* @__PURE__ */ new Map();
  const Ln = (o, i, l) => {
    ...
    var i, l, c;
    try {
      const d = (i = n == null ? void 0 : n.getOverlayById) == null ? void 0 : i.call(n, o);
      if (!d)
        return;
      const y = E1(d);
      if (y) {
        const g = Me.get(o), m = ((l = g == null ? void 0 : g.points) == null ? void 0 : l.length) || 0, _ = ((c = y.points) == null ? void 0 : c.length) || 0;
        Me.set(o, y);
        const L = vt(y.type);
        if (_ >= L) {
          const P = De.get(o);
      ...
      console.error(`Error updating overlay tracking for ${o}:`, d);
    }
  }, wn = (o, i) => {
    if (De.has(o))
      return;
    ...
    document.addEventListener("mouseup", c), document.addEventListener("touchend", c), setTimeout(() => {
      ...
      const d = De.get(o);
      if (d && !d.complete) {
        d.checkInterval && clearInterval(d.checkInterval), d.mouseUpHandler && (document.removeEventListener("mouseup", d.mouseUpHandler), document.removeEventListener("touchend", d.mouseUpHandler)), Mt(o);
        const g = Me.get(o);
        if (g) {
  ...
  let at = {
    ...
    loadDrawings: (o) => {
      try {
        ...
        if (l) {
          const c = JSON.parse(l), d = [];
          return Array.isArray(c.drawings) && c.drawings.forEach((y) => {
            var _;
            const g = vt(y.type);
            (((_ = y.points) == null ? void 0 : _.length) || 0) >= g && d.push(y);
          }), d;
        }
      } catch (i) {
  ...
  const Kt = () => {
    ...
    Me.forEach((l, c) => {
      var d;
      (d = n == null ? void 0 : n.removeOverlay) == null || d.call(n, {
        id: c
      });
    }), Me.clear(), De.clear(), Ye(null), Ze(null), at.loadDrawings(o).forEach((l) => {
      var c;
      try {
        const d = m1({
          name: l.type,
          ...
          visible: l.visible ?? !0,
          lock: l.lock ?? !1,
          mode: l.mode || Dn.Normal
        }), y = n == null ? void 0 : n.createOverlay(d), g = typeof y == "string" ? y : null;
        g && (Me.set(g, {
          ...l,
          id: g
        }), De.set(g, {
        ...
        console.error("Library: Error restoring drawing:", d);
      }
    });
  }, Rt = (o) => {
    var l, c;
    ...
    if ("quickOrder" in o) {
      const d = o.quickOrder ?? !1;
      i.quickOrderFloatingWindow = d, i.quickOrderPlusButton = d;
    } else if ("priceLine" in o) {
      const d = o.priceLine ?? !1;
      i.marketPriceLine = d, i.countDown = d, i.bidAskPrice = d;
    } else
    ...
    var c, d, y, g, m, _;
    const i = Number((d = (c = o == null ? void 0 : o.points) == null ? void 0 : c[0]) == null ? void 0 : d.value);
    ...
    o && ((i = n == null ? void 0 : n.removeOverlay) == null || i.call(n, {
      id: o
    }), Me.delete(o), De.delete(o), zt(null));
  }, U1 = (o) => {
    var m, _;
    const i = Number(o.price);
    if (!n || !Number.isFinite(i) || i <= 0 || !Ve().orderPreviewLine) {
      g1();
      return;
    }
    ...
    g && (Me.delete(g), De.delete(g), zt(g));
  }, $ = (o) => {
    var l;
    ...
    const i = ((nt = n.getDataList) == null ? void 0 : nt.call(n)) ?? [], l = i[i.length - 1], c = Number(l == null ? void 0 : l.close);
    if (!l || !Number.isFinite(c) || c <= 0) {
      Vt(null);
      return;
    }
    const d = (rt = n.convertToPixel) == null ? void 0 : rt.call(n, [{
      value: c
    }], {
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((ot = d == null ? void 0 : d[0]) == null ? void 0 : ot.y), g = (y0 = n.getSize) == null ? void 0 : y0.call(n, "candle_pane"), m = (g == null ? void 0 : g.height) ?? t.clientHeight;
    ...
    }), P = (p0 = n.getSize) == null ? void 0 : p0.call(n, "candle_pane", lt.YAxis), ne = P != null && P.width && Number.isFinite(P.width) ? Math.max(74, Math.floor(P.width) - 2) : 96, ie = rn(V()), ae = o % ie, Y = ae === 0 ? ie : ie - ae, fe = Number(l.close), $e = Number(l.open), _e = n.getStyles().candle.priceMark.last, Se = _e.text, G = Number(Se.size) || 12, ke = Number(Se.paddingTop) || 2, me = Number(Se.paddingBottom) || 2, Pe = Math.min(Number(Se.paddingLeft) || 4, 3), Oe = Math.min(Number(Se.paddingRight) || 4, 3), tt = Math.max(34, G * 2 + ke + me + 6), st = Math.max(0, Math.min(y - tt / 2, m - tt));
    Vt({
      top: st,
      width: Math.min(ne, Math.max(62, L.length * (G * 0.56) + Pe + Oe + 4)),
      priceText: L,
      text: Gm(Y),
      color: Number.isFinite(fe) && Number.isFinite($e) && fe < $e ? _e.downColor : _e.upColor,
      textSize: G,
      textFamily: Se.family,
      textWeight: Se.weight,
      paddingLeft: Pe,
      paddingRight: Oe,
      paddingTop: ke,
      paddingBottom: me,
      borderRadius: Number(Se.borderRadius) || 2
    });
  }, Be = (o) => {
    var l, c;
    ...
    if (!Number.isFinite(i))
      return NaN;
    try {
      const d = n == null ? void 0 : n.convertFromPixel([{
        x: (o == null ? void 0 : o.x) ?? 0,
        y: i
      }], {
        paneId: "candle_pane"
      }), y = Number((l = d == null ? void 0 : d[0]) == null ? void 0 : l.value);
    ...
    try {
      const d = n == null ? void 0 : n.convertFromPixel([{
        ...
        paneId: "candle_pane",
        absolute: !0
      }), y = Number((c = d == null ? void 0 : d[0]) == null ? void 0 : c.value);
      if (Number.isFinite(y) && y > 0)
        return y;
    } catch {
    }
    ...
    const l = Number(o.y), c = Be(o), d = t.clientHeight;
    if (!Number.isFinite(l) || !Number.isFinite(c) || c <= 0 || l < 0 || l > d) {
      if (M1() || gt())
        return;
      Ft(null), it(!1);
      return;
    ...
    var m, _, L, P, ne, ie;
    const i = (_ = (m = t == null ? void 0 : t.parentElement) == null ? void 0 : m.getBoundingClientRect) == null ? void 0 : _.call(m), l = (L = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : L.call(t), c = o == null ? void 0 : o.overlay, d = (P = c == null ? void 0 : c.points) == null ? void 0 : P[0];
    let y = 72, g = 40;
    if (i) {
      if (Number.isFinite(o == null ? void 0 : o.pageX) ? y = o.pageX - i.left : Number.isFinite(o == null ? void 0 : o.x) && l && (y = l.left - i.left + o.x), Number.isFinite(o == null ? void 0 : o.pageY))
        ...
        g = l.top - i.top + o.y;
      else if (Number.isFinite(d == null ? void 0 : d.value))
        try {
    ...
    return (!i || ((c = Qe()) == null ? void 0 : c.id) === i) && (Ye(null), Ze(null)), !1;
  }, m1 = (o) => {
    var g, m, _, L, P, ne, ie, ae, Y;
    if (o.name !== "horizontalStraightLine")
      return o;
    const i = o.onClick, l = o.onSelected, c = o.onDeselected, d = o.onRemoved, y = o.onPressedMoveEnd;
    return {
      ...o,
      styles: {
        ...o.styles,
        line: {
          ...
          style: ((P = (L = o.styles) == null ? void 0 : L.line) == null ? void 0 : P.style) ?? Ke.Solid,
      ...
      onClick: (fe) => (jt(fe), (i == null ? void 0 : i(fe)) ?? !1),
      onSelected: (fe) => (jt(fe), (l == null ? void 0 : l(fe)) ?? !1),
      onPressedMoveEnd: (fe) => (jt(fe), (y == null ? void 0 : y(fe)) ?? !1),
      onDeselected: (fe) => (mr(fe), (c == null ? void 0 : c(fe)) ?? !1),
      onRemoved: (fe) => (mr(fe), (d == null ? void 0 : d(fe)) ?? !1)
    };
  }, t9 = () => {
    var i;
    const o = Qe();
    ...
    if (!o)
      return;
    const i = 1, l = Ke.Solid, c = [6, 4], d = "#2f6df6";
    Qt({
      styles: {
        line: {
          size: i,
    ...
    const l = (P = (L = t.parentElement) == null ? void 0 : L.getBoundingClientRect) == null ? void 0 : P.call(L);
    if (!l)
      return;
    const c = o.clientX, d = o.clientY, y = i.x, g = i.y, m = (ne) => {
      ne.preventDefault();
      const ie = y + ne.clientX - c, ae = g + ne.clientY - d;
      Ye({
        ...i,
    ...
    if (!gt())
      return;
    const i = o.target;
    (l = i == null ? void 0 : i.closest) != null && l.call(i, ".klinecharts-pro-quick-order-marker") || (c = i == null ? void 0 : i.closest) != null && c.call(i, ".klinecharts-pro-quick-order-menu-anchor") || l9();
  };
  ...
  He(() => {
    var fe, $e, _e, Se, G, ke, me, Pe, Oe, tt, st, nt, rt, ot;
    const o = (fe = e.orderTools) == null ? void 0 : fe.quickOrder, i = ($e = e.orderTools) == null ? void 0 : $e.quickOrderFloatingWindow, l = (_e = e.orderTools) == null ? void 0 : _e.quickOrderPlusButton, c = (Se = e.orderTools) == null ? void 0 : Se.openOrders, d = (G = e.orderTools) == null ? void 0 : G.openOrdersExtendedPriceLine, y = (ke = e.orderTools) == null ? void 0 : ke.openOrdersDisplay, g = (me = e.orderTools) == null ? void 0 : me.positions, m = (Pe = e.orderTools) == null ? void 0 : Pe.breakevenPrice, _ = (Oe = e.orderTools) == null ? void 0 : Oe.liquidationPrice, L = (tt = e.orderTools) == null ? void 0 : tt.priceLine, P = (st = e.orderTools) == null ? void 0 : st.marketPriceLine, ne = (nt = e.orderTools) == null ? void 0 : nt.countDown, ie = (rt = e.orderTools) == null ? void 0 : rt.bidAskPrice, ae = (ot = e.orderTools) == null ? void 0 : ot.orderHistory, Y = {};
    typeof o == "boolean" && o !== Cr && (Cr = o, Y.quickOrder = o, typeof i != "boolean" && (Y.quickOrderFloatingWindow = o), typeof l != "boolean" && (Y.quickOrderPlusButton = o)), typeof i == "boolean" && i !== pr && (pr = i, Y.quickOrderFloatingWindow = i), typeof l == "boolean" && l !== vr && (vr = l, Y.quickOrderPlusButton = l), typeof c == "boolean" && c !== br && (br = c, Y.openOrders = c), typeof d == "boolean" && d !== $r && ($r = d, Y.openOrdersExtendedPriceLine = d), y !== void 0 && y !== _r && (_r = y, Y.openOrdersDisplay = y), typeof g == "boolean" && g !== kr && (kr = g, Y.positions = g), typeof m == "boolean" && m !== xr && (xr = m, Y.breakevenPrice = m), typeof _ == "boolean" && _ !== Lr && (Lr = _, Y.liquidationPrice = _), typeof L == "boolean" && L !== wr && (wr = L, Y.priceLine = L, typeof P != "boolean" && (Y.marketPriceLine = L), typeof ne != "boolean" && (Y.countDown = L), typeof ie != "boolean" && (Y.bidAskPrice = L)), typeof P == "boolean" && P !== Ar && (Ar = P, Y.marketPriceLine = P), typeof ne == "boolean" && ne !== Tr && (Tr = ne, Y.countDown = ne), typeof ie == "boolean" && ie !== Mr && (Mr = ie, Y.bidAskPrice = ie), typeof ae == "boolean" && ae !== Sr && (Sr = ae, Y.orderHistory = ae), Object.keys(Y).length > 0 && Rt(Y);
  }), He(() => {
    Ve().marketPriceLine, Ve().countDown, V(), N(), n == null || n.setStyles({
      candle: {
        priceMark: {
          last: {
            show: !0,
    ...
    removeOverlay: (o) => {
      ...
      if ((i = n == null ? void 0 : n.removeOverlay) == null || i.call(n, o), o.id) {
        Me.delete(o.id);
        const l = De.get(o.id);
        l && (l.checkInterval && clearInterval(l.checkInterval), l.mouseUpHandler && (document.removeEventListener("mouseup", l.mouseUpHandler), document.removeEventListener("touchend", l.mouseUpHandler)), De.delete(o.id)), Kt();
      }
    },
    removeAllOverlay: () => {
      Me.forEach((o, i) => {
    ...
    getSettings: () => {
      var l, c, d, y, g, m, _, L, P, ne, ie, ae, Y, fe, $e, _e;
      if (!n)
        return {};
      ...
      return {
        ...
        showLastPrice: (g = (y = (d = o.candle) == null ? void 0 : d.priceMark) == null ? void 0 : y.last) == null ? void 0 : g.show,
        showHighestPrice: (L = (_ = (m = o.candle) == null ? void 0 : m.priceMark) == null ? void 0 : _.high) == null ? void 0 : L.show,
        showLowestPrice: (ie = (ne = (P = o.candle) == null ? void 0 : P.priceMark) == null ? void 0 : ne.low) == null ? void 0 : ie.show,
        // Indicator settings
        ...
        // Grid settings
        showGrids: (_e = o.grid) == null ? void 0 : _e.show,
        timestamp: Date.now()
      };
    },
    setSettings: (o) => {
      var l, c, d, y, g, m, _, L, P, ne, ie, ae, Y, fe;
      if (!n)
        return;
      const i = {};
      if (o.candleType !== void 0 && (i.candle = {
        ...
        const $e = ((l = i.candle) == null ? void 0 : l.bar) || {};
        i.candle = {
          ...i.candle,
          bar: {
            ...$e,
      ...
      o.showLastPrice !== void 0 && (i.candle = {
        ...
        priceMark: {
          ...
          last: {
            ...(y = (d = i.candle) == null ? void 0 : d.priceMark) == null ? void 0 : y.last,
      ...
      if (i) {
        const L = {
          candle: {
            ...
            priceMark: (d = i.candle) == null ? void 0 : d.priceMark
          },
          indicator: {
    ...
    autoScalePriceAxis: () => {
      ...
      if (!n)
        return;
      const o = ((i = n.getStyles().yAxis) == null ? void 0 : i.type) ?? On.Normal;
      n.setStyles({
        yAxis: {
          type: o
        }
      }), (l = n.resize) == null || l.call(n);
    },
    // === Drawing Methods ===
    saveDrawings: (o) => {
      const i = Array.from(Me.values());
      i.forEach((l, c) => {
        var g;
        const d = vt(l.type), y = ((g = l.points) == null ? void 0 : g.length) || 0;
        y < d && console.warn(`âš ï¸ ${l.type} ${l.id} has only ${y} point(s), should have ${d}`);
      }), at.saveDrawings(o, i);
    },
    loadDrawings: (o) => {
      at.loadDrawings(o).forEach((l, c) => {
        var d;
        try {
          const y = {
            name: l.type,
          ...
          m && (Me.set(m, {
            ...
            monitoring: !1,
            complete: !0,
            lastPointCount: ((d = l.points) == null ? void 0 : d.length) || 0
          }));
        } catch (y) {
  ...
  const c9 = () => {
    ...
    S(), Br(), $t(), u9();
  }, Nr = [St.OnVisibleRangeChange, St.OnZoom, St.OnScroll], d9 = (o) => {
    const i = new Date(o), l = i.getFullYear(), c = `${i.getMonth() + 1}`.padStart(2, "0"), d = `${i.getDate()}`.padStart(2, "0"), y = `${i.getHours()}`.padStart(2, "0"), g = `${i.getMinutes()}`.padStart(2, "0");
    return `${l}/${c}/${d} ${y}:${g}`;
  }, h9 = (o) => {
    var g;
    ...
    if (i.length === 0)
      return null;
    let l = i[0], c = 0, d = Number(l == null ? void 0 : l.timestamp), y = Math.abs(d - o);
    for (let m = 1; m < i.length; m += 1) {
      const _ = i[m], L = Number(_ == null ? void 0 : _.timestamp);
      if (!Number.isFinite(L))
        continue;
      const P = Math.abs(L - o);
      P < y && (l = _, c = m, d = L, y = P);
    }
    return l && Number.isFinite(d) ? {
      candle: l,
      dataIndex: c
    } : null;
  }, f9 = (o) => {
    ...
    for (let c = 0; c < i.length; c += 1) {
      const d = i[c];
      if (Number(d == null ? void 0 : d.timestamp) === o)
        return {
          candle: d,
          dataIndex: c
        };
    ...
    if (!n || !t)
      return null;
    const i = h9(o), l = i == null ? void 0 : i.candle, c = Number((l == null ? void 0 : l.timestamp) ?? o), d = Number((l == null ? void 0 : l.high) ?? (l == null ? void 0 : l.close) ?? (l == null ? void 0 : l.open)), y = i ? Z1(i.dataIndex) : void 0, g = i && Number.isFinite(d) ? {
      dataIndex: y,
      value: d
    } : {
      timestamp: c
      ...
      paneId: "candle_pane",
      absolute: !0
    }), _ = Number((ae = m == null ? void 0 : m[0]) == null ? void 0 : ae.x), L = Number((Y = m == null ? void 0 : m[0]) == null ? void 0 : Y.y), P = t.clientWidth, ne = t.clientHeight;
    ...
    switch (o.timespan) {
      case "minute": {
        c = c - c % (60 * 1e3), d = c - l * o.multiplier * 60 * 1e3;
        break;
      }
      case "hour": {
        c = c - c % (60 * 60 * 1e3), d = c - l * o.multiplier * 60 * 60 * 1e3;
        break;
      }
      case "day": {
        c = c - c % (60 * 60 * 1e3), d = c - l * o.multiplier * 24 * 60 * 60 * 1e3;
        break;
      }
      case "week": {
        ...
        c = c - m * 60 * 60 * 24;
        const _ = new Date(c);
        c = (/* @__PURE__ */ new Date(`${_.getFullYear()}-${_.getMonth() + 1}-${_.getDate()}`)).getTime(), d = l * o.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const y = new Date(c), g = y.getFullYear(), m = y.getMonth() + 1;
        c = (/* @__PURE__ */ new Date(`${g}-${m}-01`)).getTime(), d = l * o.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const _ = new Date(d);
        d = (/* @__PURE__ */ new Date(`${_.getFullYear()}-${_.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const g = new Date(c).getFullYear();
        c = (/* @__PURE__ */ new Date(`${g}-01-01`)).getTime(), d = l * o.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const m = new Date(d);
        d = (/* @__PURE__ */ new Date(`${m.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [d, c];
    ...
    const c = rn(i), d = Math.max(120, l);
    let y = 0.5;
    o.anchorPoint === "left" ? y = 0.12 : o.anchorPoint === "right" && (y = 0.88);
    const g = Math.max(20, Math.floor(d * y)), m = Math.max(20, d - g);
    return {
    ...
    for (let d = o.length - 1; d >= 0; d -= 1) {
      const y = Number((c = o[d]) == null ? void 0 : c.timestamp);
    ...
    const l = rn(i), c = Math.abs(o.to - o.from), d = Math.max(1, Math.ceil(c / l) + 1), y = Math.max(d, 120) * l;
    return {
      from: o.from,
    ...
    if (!n || !t || o.length === 0)
      return;
    const i = ((y = n.getSize("candle_pane", lt.YAxis)) == null ? void 0 : y.width) ?? 0, l = ((g = n.getSize("candle_pane", lt.Main)) == null ? void 0 : g.width) ?? t.clientWidth - i, c = Math.max(1, l - 8), d = Math.max(2, c / Math.max(1, o.length));
    n.setOffsetRightDistance(0), n.setLeftMinVisibleBarCount(0), n.setRightMinVisibleBarCount(0), n.setBarSpace(d);
  }, Sn = (o) => {
    var i;
    ...
    if (!n || !t)
      return null;
    const i = (_ = n.getDom) == null ? void 0 : _.call(n, "candle_pane", lt.Main), l = (L = i == null ? void 0 : i.getBoundingClientRect) == null ? void 0 : L.call(i), c = (P = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : P.call(r), d = t.getBoundingClientRect(), y = l && Number.isFinite(l.left) ? l.left - ((c == null ? void 0 : c.left) ?? d.left) : d.left - ((c == null ? void 0 : c.left) ?? d.left), g = n.getSize("candle_pane", lt.Main), m = (l == null ? void 0 : l.width) ?? (g == null ? void 0 : g.width) ?? t.clientWidth;
    return o === "left" ? Math.max(8, y) : o === "center" ? y + m / 2 : o === "right" ? y + m : null;
  }, Fr = (o, i) => {
    var L, P, ne, ie, ae, Y;
    const l = Pn(o), c = ((L = n == null ? void 0 : n.getDataList) == null ? void 0 : L.call(n)) ?? [];
    if (!n || l === null || c.length === 0)
      return i;
    const d = (P = n.convertFromPixel) == null ? void 0 : P.call(n, [{
      x: l,
      y: 0
    }], {
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((ne = d == null ? void 0 : d[0]) == null ? void 0 : ne.dataIndex), g = Math.max(0, Math.min(c.length - 1, Number.isFinite(y) ? Math.round(y) : -1)), m = f9(i);
    if (m) {
      const fe = Z1(m.dataIndex), $e = (ie = n.convertToPixel) == null ? void 0 : ie.call(n, [{
        dataIndex: fe
      }], {
        paneId: "candle_pane",
        absolute: !0
      }), _e = Number((ae = $e == null ? void 0 : $e[0]) == null ? void 0 : ae.x), Se = n.getBarSpace, G = typeof Se == "function" ? Se.call(n) : void 0, ke = Number(typeof G == "object" ? G == null ? void 0 : G.bar : G), me = Number.isFinite(ke) ? Math.max(2, ke / 2) : 8;
      if (Number.isFinite(_e) && Math.abs(_e - l) <= me)
        return i;
    }
    ...
    const i = Er(o.timestamp, "nearest"), l = Z1(i), c = Pn(o.anchorPoint);
    if (l < 0 || c === null) {
      Sn(o.timestamp), window.setTimeout(() => {
        y1 = !1;
      }, 1e3);
    ...
    n.scrollToDataIndex(l, 0), requestAnimationFrame(() => {
      var g, m;
      const d = (g = n == null ? void 0 : n.convertToPixel) == null ? void 0 : g.call(n, [{
        dataIndex: l
      }], {
        paneId: "candle_pane",
        absolute: !0
      }), y = Number((m = d == null ? void 0 : d[0]) == null ? void 0 : m.x);
    ...
    }, d = (g = n.convertToPixel) == null ? void 0 : g.call(n, [c], {
      paneId: "candle_pane",
      absolute: !0
    }), y = Number((m = d == null ? void 0 : d[0]) == null ? void 0 : m.x);
    ...
    const l = _9(i), c = (P = n.getDom) == null ? void 0 : P.call(n, "candle_pane", lt.Main), d = (ne = c == null ? void 0 : c.getBoundingClientRect) == null ? void 0 : ne.call(c), y = (ie = r == null ? void 0 : r.getBoundingClientRect) == null ? void 0 : ie.call(r), g = (ae = t == null ? void 0 : t.getBoundingClientRect) == null ? void 0 : ae.call(t), m = n.getSize("candle_pane", lt.Main), _ = d && Number.isFinite(d.top) ? d.top - ((y == null ? void 0 : y.top) ?? (g == null ? void 0 : g.top) ?? 0) : 0, L = Math.max(1, (d == null ? void 0 : d.height) ?? (m == null ? void 0 : m.height) ?? 0);
    if (l === null) {
      u1(null);
      return;
    }
    ...
    if (n) {
      ...
      try {
        const l = V(), c = o.from <= o.to ? o : {
          from: o.to,
          to: o.from
        }, d = y9(c), y = i ? d : b9(d, l), g = await e.datafeed.getHistoryKLineData(N(), l, y.from, y.to), m = C9(g, d);
        n.applyNewData(g, g.length > 0), we(d), requestAnimationFrame(() => {
          const _ = v9(g, d);
          i ? Sn(i) : ($9(m), n == null || n.scrollToDataIndex(_, 0), H1(p9(m, d))), $t();
        });
      } finally {
        h(!1), Et(!1);
      }
    ...
    Te(o), await zr(g9(o), o);
  }, x9 = (o) => {
    const l = {
      ...o,
      timestamp: (() => !n || o.anchorPoint === "date" ? o.timestamp : Fr(o.anchorPoint, o.timestamp))()
    };
    ft(l), fo(l), l.enabled ? (Te(l.timestamp), requestAnimationFrame(() => {
      Ur(l), $t(l);
    })) : requestAnimationFrame(() => $t(l));
  };
  nr(() => {
    if (window.addEventListener("resize", Pr), n = S9(t, {
      customApi: {
        formatDate: (g, m, _, L) => {
          switch (V().timespan) {
            case "minute":
      ...
      const g = n.getDom("candle_pane", lt.Main);
      if (g) {
      ...
      const m = n.getDom("candle_pane", lt.YAxis);
    ...
    const i = () => {
      ...
      if (g != null && g.ticker)
        try {
          const m = Array.from(Me.values());
          at.saveDrawings(g.ticker, m);
        } catch (m) {
    ...
    n && c && (n.removeOverlay = function(...g) {
      ...
      if (typeof _ == "string" ? L = _ : _ && typeof _ == "object" && _.id && (L = _.id), L) {
        Me.delete(L);
        const P = De.get(L);
        P && (P.checkInterval && clearInterval(P.checkInterval), P.mouseUpHandler && (document.removeEventListener("mouseup", P.mouseUpHandler), document.removeEventListener("touchend", P.mouseUpHandler)), De.delete(L)), i();
      }
      return m;
    }), X().forEach((g) => {
      nn(n, g, !0, {
    ...
    e.subIndicators.forEach((g) => {
      const m = nn(n, g, !0);
      m && (d[g] = m);
    }), W(d), n == null || n.loadMore((g) => {
      h(!0), (async () => {
        try {
          const _ = V(), [L] = Mn(_, g, 1), [P] = Mn(_, L, 500), ne = await e.datafeed.getHistoryKLineData(N(), _, P, L);
      ...
      if (g.indicatorName)
        switch (g.iconId) {
          case "visible": {
            ...
            Xe(g.indicatorName, g.paneId, m, "change");
            break;
          }
          case "invisible": {
            n == null || n.overrideIndicator({
          ...
          case "close":
            if (g.paneId === "candle_pane") {
              const m = [...X()];
              n == null || n.removeIndicator("candle_pane", g.indicatorName), m.splice(m.indexOf(g.indicatorName), 1), J(m), Xe(g.indicatorName, "candle_pane", "main", "remove");
            } else {
              const m = {
                ...ve()
              };
              n == null || n.removeIndicator(g.paneId, g.indicatorName), delete m[g.indicatorName], W(m), Xe(g.indicatorName, g.paneId, "sub", "remove");
            }
        }
    }), n == null || n.subscribeAction(St.OnCrosshairChange, Fe), Nr.forEach((g) => {
      n == null || n.subscribeAction(g, Or);
    }), R1 = window.setInterval(() => S(), 1e3), S(), document.addEventListener("mousedown", yr);
    ...
    n && y && (n.createOverlay = function(...g) {
      ...
      return L && !((P = m.extendData) != null && P.isOrderPreviewLine) && (wn(L, m.name || "unknown"), Mt(L), Kt()), _;
    });
  }), xt(() => {
    window.removeEventListener("resize", Pr), n == null || n.unsubscribeAction(St.OnCrosshairChange, Fe), Nr.forEach((o) => {
      n == null || n.unsubscribeAction(o, Or);
    }), R1 && (window.clearInterval(R1), R1 = void 0), j1 && (window.clearTimeout(j1), j1 = void 0), document.removeEventListener("mousedown", yr), De.clear(), Me.clear(), v0(t);
  }), He(() => {
    const o = N();
  ...
  const L9 = (o) => {
    const i = new Date(o), l = i.getFullYear(), c = `${i.getMonth() + 1}`.padStart(2, "0"), d = `${i.getDate()}`.padStart(2, "0"), y = `${i.getHours()}`.padStart(2, "0"), g = `${i.getMinutes()}`.padStart(2, "0"), m = `${l}-${c}-${d}`;
    switch (V().timespan) {
      case "minute":
      case "hour":
        return `${m} ${y}:${g}`;
    ...
    const {
      current: l
    } = o, c = i.tooltip.text.color, d = l.close > l.open ? i.bar.upColor : l.close < l.open ? i.bar.downColor : i.bar.noChangeColor, y = Math.min(Math.max(((_ = N()) == null ? void 0 : _.pricePrecision) ?? 2, 0), 8), g = Math.min(Math.max(((L = N()) == null ? void 0 : L.volumePrecision) ?? 0, 0), 8), m = (P) => ({
      text: O.formatPrecision(P, y),
      color: d
    });
    return [{
      title: "time",
  ...
  return He((o) => {
    ...
    return xt(() => {
      c = !1;
    }), o && e.datafeed.unsubscribe(o.symbol, o.period), h(!0), Et(!0), (async () => {
      try {
        const y = ut(et), g = y.enabled && (!o || o.symbol.ticker === i.ticker || y.acrossTokens), m = g ? m9(y, l) : null, [_, L] = m ? [m.from, m.to] : Mn(l, (/* @__PURE__ */ new Date()).getTime(), 500), P = await e.datafeed.getHistoryKLineData(i, l, _, L);
        if (!c)
          return;
        n == null || n.applyNewData(P, P.length > 0), g ? requestAnimationFrame(() => {
          Ur(y), $t(y);
        }) : $t(), S(), setTimeout(() => {
          c && (An(i == null ? void 0 : i.ticker), S());
    ...
    if (x()) {
      _t(x()), n == null || n.setStyles(x()), le(U7(n.getStyles()));
      const o = ce();
      if (o) {
        F(o);
        const i = ye(o);
    ...
    onMenuClick: async () => {
      try {
        await ti(() => o1(!Bt())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    const o = Bm.cloneNode(!0), i = o.firstChild, l = i.nextSibling;
    return o.addEventListener("mouseleave", () => {
      Ft(null), qe(!1);
    }), kt((c) => r = c, o), i.$$click = (c) => {
      var y, g;
      if (c.preventDefault(), c.stopPropagation(), !n)
        return;
      const d = ((y = n.getStyles().yAxis) == null ? void 0 : y.type) ?? On.Normal;
      n.setStyles({
        yAxis: {
          type: d
        }
      }), (g = n.resize) == null || g.call(n);
    }, i.$$mousedown = (c) => {
      ...
      children: (c) => (() => {
        ...
        return K((y) => {
          ...
          return g !== y._v$ && d.style.setProperty("left", y._v$ = g), m !== y._v$2 && d.style.setProperty("top", y._v$2 = m), _ !== y._v$3 && d.style.setProperty("height", y._v$3 = _), y;
        }, {
          _v$: void 0,
          _v$2: void 0,
          _v$3: void 0
      ...
      keyed: !0,
      children: (c) => (() => {
        const d = Fm.cloneNode(!0);
        return C(d, () => c.text), K((y) => {
          const g = `${c.left}px`, m = `${c.top}px`;
          return g !== y._v$4 && d.style.setProperty("left", y._v$4 = g), m !== y._v$5 && d.style.setProperty("top", y._v$5 = m), y;
        }, {
          _v$4: void 0,
          _v$5: void 0
        }), d;
      ...
      keyed: !0,
      children: (c) => (() => {
        const d = Um.cloneNode(!0), y = d.firstChild, g = y.nextSibling;
        return d.style.setProperty("right", "0px"), C(y, () => c.priceText), C(g, () => c.text), K((m) => {
          const _ = `${c.top}px`, L = `${c.width}px`, P = c.color, ne = `${c.borderRadius}px`, ie = c.textFamily, ae = c.textWeight, Y = `${c.paddingLeft}px`, fe = `${c.paddingRight}px`, $e = `${c.paddingTop}px`, _e = `${c.paddingBottom}px`, Se = `${c.textSize}px`, G = `${Math.max(10, c.textSize - 1)}px`;
          return _ !== m._v$6 && d.style.setProperty("top", m._v$6 = _), L !== m._v$7 && d.style.setProperty("width", m._v$7 = L), P !== m._v$8 && d.style.setProperty("background", m._v$8 = P), ne !== m._v$9 && d.style.setProperty("border-radius", m._v$9 = ne), ie !== m._v$10 && d.style.setProperty("font-family", m._v$10 = ie), ae !== m._v$11 && d.style.setProperty("font-weight", m._v$11 = ae), Y !== m._v$12 && d.style.setProperty("padding-left", m._v$12 = Y), fe !== m._v$13 && d.style.setProperty("padding-right", m._v$13 = fe), $e !== m._v$14 && d.style.setProperty("padding-top", m._v$14 = $e), _e !== m._v$15 && d.style.setProperty("padding-bottom", m._v$15 = _e), Se !== m._v$16 && y.style.setProperty("font-size", m._v$16 = Se), G !== m._v$17 && g.style.setProperty("font-size", m._v$17 = G), m;
        }, {
          _v$6: void 0,
          _v$7: void 0,
          _v$8: void 0,
      ...
      keyed: !0,
      children: (c) => (() => {
        const d = Rm.cloneNode(!0), y = d.firstChild, g = y.nextSibling, m = g.nextSibling, _ = m.firstChild, L = m.nextSibling, P = L.firstChild, ne = P.firstChild, ie = ne.nextSibling, ae = ie.firstChild, Y = L.nextSibling, fe = Y.firstChild, $e = Y.nextSibling, _e = $e.nextSibling, Se = _e.nextSibling;
        return d.$$click = (G) => {
          G.stopPropagation();
        }, d.$$mousedown = (G) => {
          G.preventDefault(), G.stopPropagation();
        }, y.$$mousedown = s9, g.$$click = i9, _.$$click = () => Ze(Ge() === "color" ? null : "color"), C(m, A(de, {
          get when() {
            return Ge() === "color";
          },
          get children() {
            const G = zm.cloneNode(!0), ke = G.firstChild;
            return C(ke, A(_1, {
              each: d1,
              children: (me) => (() => {
                const Pe = jm.cloneNode(!0);
                return Pe.$$click = () => a9(me), Pe.style.setProperty("background", me), K(() => ge(Pe, `overlay-toolbar-color-swatch ${c.color.toLowerCase() === me.toLowerCase() ? "selected" : ""}`)), Pe;
              })()
            })), G;
          }
        }), null), P.$$click = () => Ze(Ge() === "width" ? null : "width"), C(ie, () => c.lineSize, ae), C(L, A(de, {
          get when() {
            return Ge() === "width";
          },
          get children() {
            const G = Vm.cloneNode(!0);
            return C(G, A(_1, {
              each: [1, 2, 3, 4],
              children: (ke) => (() => {
                const me = Qm.cloneNode(!0), Pe = me.firstChild;
                return me.$$click = () => o9(ke), Pe.style.setProperty("height", `${ke}px`), K(() => ge(me, c.lineSize === ke ? "selected" : "")), me;
              })()
            })), G;
          }
        }), null), fe.$$click = () => Ze(Ge() === "style" ? null : "style"), C(Y, A(de, {
          get when() {
            return Ge() === "style";
          },
          get children() {
            const G = Km.cloneNode(!0), ke = G.firstChild, me = ke.nextSibling, Pe = me.nextSibling;
            return ke.$$click = () => Tn(Ke.Solid, []), me.$$click = () => Tn(Ke.Dashed, [6, 4]), Pe.$$click = () => Tn(Ke.Dashed, [2, 4]), K((Oe) => {
              var rt, ot;
              const tt = c.lineStyle === Ke.Solid ? "selected" : "", st = c.lineStyle === Ke.Dashed && ((rt = c.dashedValue) == null ? void 0 : rt[0]) === 6 ? "selected" : "", nt = c.lineStyle === Ke.Dashed && ((ot = c.dashedValue) == null ? void 0 : ot[0]) === 2 ? "selected" : "";
              return tt !== Oe._v$18 && ge(ke, Oe._v$18 = tt), st !== Oe._v$19 && ge(me, Oe._v$19 = st), nt !== Oe._v$20 && ge(Pe, Oe._v$20 = nt), Oe;
            }, {
              _v$18: void 0,
              _v$19: void 0,
              _v$20: void 0
        ...
        }), null), $e.$$click = r9, _e.$$click = n9, Se.$$click = t9, K((G) => {
          const ke = `${c.x}px`, me = `${c.y}px`, Pe = `overlay-toolbar-icon edit ${Ge() === "color" ? "active" : ""}`, Oe = `overlay-toolbar-line-size ${Ge() === "width" ? "active" : ""}`, tt = `overlay-toolbar-icon minus ${Ge() === "style" ? "active" : ""}`, st = `overlay-toolbar-icon visibility ${c.visible ? "" : "muted"}`, nt = c.visible ? "Hide" : "Show", rt = `overlay-toolbar-icon lock ${c.locked ? "active" : ""}`, ot = c.locked ? "Unlock" : "Lock";
          return ke !== G._v$21 && d.style.setProperty("left", G._v$21 = ke), me !== G._v$22 && d.style.setProperty("top", G._v$22 = me), Pe !== G._v$23 && ge(_, G._v$23 = Pe), Oe !== G._v$24 && ge(P, G._v$24 = Oe), tt !== G._v$25 && ge(fe, G._v$25 = tt), st !== G._v$26 && ge($e, G._v$26 = st), nt !== G._v$27 && Ee($e, "title", G._v$27 = nt), rt !== G._v$28 && ge(_e, G._v$28 = rt), ot !== G._v$29 && Ee(_e, "title", G._v$29 = ot), G;
        }, {
          _v$21: void 0,
          _v$22: void 0,
          _v$23: void 0,
      ...
      keyed: !0,
      children: (c) => (() => {
        const d = Zm.cloneNode(!0), y = d.firstChild;
        return d.addEventListener("mouseleave", () => {
          gt() || qe(!1);
        }), d.$$mousemove = (g) => {
          g.stopPropagation(), je();
        }, d.addEventListener("mouseenter", () => {
          qe(!0), je();
        }), y.$$click = (g) => {
          g.stopPropagation(), qe(!0), At({
            y: c.y,
            price: c.price,
            yAxisWidth: S1()
          }), it(!0), je();
        }, y.$$mousedown = (g) => {
          g.preventDefault(), g.stopPropagation(), je();
        }, C(y, (() => {
          const g = q(() => {
            var m;
          ...
          return () => g() ? (() => {
            const m = Hm.cloneNode(!0);
            return K(() => m.innerHTML = e.orderTools.quickOrderPlusIcon), m;
          })() : Wm.cloneNode(!0);
        })()), K((g) => {
          const m = `${Math.max(0, c.y - 12)}px`, _ = `${S1()}px`, L = Ve().quickOrderPlusButton ? "block" : "none";
          return m !== g._v$30 && d.style.setProperty("top", g._v$30 = m), _ !== g._v$31 && d.style.setProperty("right", g._v$31 = _), L !== g._v$32 && d.style.setProperty("display", g._v$32 = L), g;
        }, {
          _v$30: void 0,
          _v$31: void 0,
          _v$32: void 0
      ...
      keyed: !0,
      children: (c) => (() => {
        const d = qm.cloneNode(!0), y = d.firstChild, g = y.firstChild, m = g.firstChild, _ = m.nextSibling, L = _.nextSibling, P = L.nextSibling;
        P.nextSibling;
        const ne = g.nextSibling, ie = ne.firstChild, ae = ie.nextSibling, Y = ae.nextSibling, fe = Y.nextSibling;
        fe.nextSibling;
        const $e = ne.nextSibling, _e = $e.nextSibling, Se = _e.firstChild, G = Se.nextSibling;
        G.nextSibling;
        const ke = _e.nextSibling;
        return ke.firstChild, d.addEventListener("mouseleave", () => qe(!1)), d.addEventListener("mouseenter", () => qe(!0)), y.$$mousemove = () => {
          je();
        }, y.$$mousedown = (me) => {
          me.preventDefault(), me.stopPropagation(), je();
        }, g.$$click = () => mt("limit"), C(g, () => N().shortName ?? N().name ?? N().ticker, _), C(g, () => $(c.price), P), ne.$$click = () => mt("stop"), C(ne, () => N().shortName ?? N().name ?? N().ticker, ae), C(ne, () => $(c.price), fe), $e.$$click = () => mt("create"), _e.$$click = z1, C(_e, () => $(c.price), G), ke.$$click = V1, C(ke, () => $(c.price), null), K((me) => {
          const Pe = `${Math.max(0, c.y + 24)}px`, Oe = `${c.yAxisWidth + xn}px`;
          return Pe !== me._v$33 && d.style.setProperty("top", me._v$33 = Pe), Oe !== me._v$34 && d.style.setProperty("right", me._v$34 = Oe), me;
        }, {
          _v$33: void 0,
          _v$34: void 0
        }), d;
      ...
      return A(Og, {
        ...
        onMainIndicatorChange: (o) => {
          ...
          o.added ? (nn(n, o.name, !0, {
            id: "candle_pane"
          }), i.push(o.name), Xe(o.name, "candle_pane", "main", "add")) : (n == null || n.removeIndicator("candle_pane", o.name), i.splice(i.indexOf(o.name), 1), Xe(o.name, "candle_pane", "main", "remove")), J(i);
        },
        onSubIndicatorChange: (o) => {
          ...
          if (o.added) {
            const l = nn(n, o.name);
            l && (i[o.name] = l, Xe(o.name, l, "sub", "add"));
          } else
            o.paneId && (n == null || n.removeIndicator(o.paneId, o.name), delete i[o.name], Xe(o.name, o.paneId, "sub", "remove"));
          W(i);
        }
      });
    }
    ...
    get children() {
      return A(om, {
        ...
        onRestoreDefault: (o) => {
          ...
          o.forEach((c) => {
            const d = c.key;
            if (d === "chart.backgroundColor") {
              Ne(i, d, D());
              return;
            }
            Ne(i, d, O.formatValue(z(), d));
          }), F(i);
          const l = ye(i);
          _t(l), n == null || n.setStyles(l), n == null || n.resize(), W1();
        }
    ...
    get children() {
      return A(um, {
        ...
        onConfirm: (o) => {
          ...
          Xe(i.indicatorName, i.paneId, l, "change");
        }
      });
    }
  }), A(de, {

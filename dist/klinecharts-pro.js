...
import { utils as de, OverlayMode as pn, ActionType as M1, LineType as f1, init as Z9, FormatDateType as Nt, DomPosition as b1, dispose as Y0, TooltipIconPosition as It, CandleType as V9, YAxisType as H9, registerOverlay as q9 } from "klinecharts";
function gt(e, n, t) {
...
var Ae = null;
let P1 = null, pe = null, Be = null, m1 = null, Nn = 0;
function yt(e, n) {
  const t = pe, o = Ae, s = e.length === 0, l = s ? Rr : {
    owned: null,
    cleanups: null,
    context: null,
    owner: n === void 0 ? o : n
...
function y5(e, n, t) {
  ...
  function he(q, re) {
    $1(() => {
      ...
      for (const ae of M.keys())
        ae.decrement();
      M.clear();
    }, !1);
  }
  function K() {
    const q = v5, re = D(), ae = B();
    if (ae !== void 0 && !h)
      throw ae;
  ...
  function Q(q = !0) {
    ...
    const ae = d !== vn ? d : a1(() => s(re, {
      value: D(),
      refetching: q
    }));
    return typeof ae != "object" || !(ae && "then" in ae) ? (V(h, ae, void 0, re), ae) : (h = ae, x = !0, queueMicrotask(() => x = !1), $1(() => {
      W(p ? "refreshing" : "pending"), ee();
    }, !1), ae.then((_e) => V(ae, _e, void 0, re), (_e) => V(ae, void 0, Vr(_e), re)));
  }
...
function p5(e) {
  ...
  return Promise.resolve().then(() => {
    pe = n, Ae = t;
    let o;
    return $1(e, !1), pe = Ae = null, o ? o.done : void 0;
  });
}
let v5;
function Kr() {
...
function Q1(e) {
  if (!e.fn)
    return;
  Jt(e);
  const n = Ae, t = pe, o = Nn;
  pe = Ae = e, C5(e, e.value, o), pe = t, Ae = n;
}
function C5(e, n, t) {
  let o;
  try {
...
function Xt(e, n, t, o = g1, s) {
  ...
  return Ae === null || Ae !== Rr && (Ae.owned ? Ae.owned.push(l) : Ae.owned = [l]), l;
}
function Zt(e) {
  const n = P1;
  if (e.state === 0 || n)
...
function Vt(e, n) {
  ...
  for (let o = 0; o < e.sources.length; o += 1) {
    const s = e.sources[o];
    s.sources && (s.state === g1 || t ? s !== n && Zt(s) : (s.state === Qt || t) && Vt(s, n));
  }
}
function Zr(e) {
  const n = P1;
  for (let t = 0; t < e.observers.length; t += 1) {
    ...
    (!o.state || n) && (o.state = Qt, o.pure ? Be.push(o) : m1.push(o), o.observers && Zr(o));
  }
}
function Jt(e) {
  let n;
...
function k5(e, n, t = {}) {
  ...
  return O1(() => G0(l)), () => {
    let v = e() || [], x, p;
    return v[g5], a1(() => {
      let M = v.length, D, U, B, O, j, ee, z, W, V;
      if (M === 0)
        ...
        for (B = new Array(M), O = new Array(M), d && (j = new Array(M)), ee = 0, z = Math.min(h, M); ee < z && o[ee] === v[ee]; ee++)
          ;
        for (z = h - 1, W = M - 1; z >= ee && W >= ee && o[z] === v[W]; z--, W--)
          B[W] = s[z], O[W] = l[z], d && (j[W] = d[z]);
...
var z5 = U5, R5 = Object.prototype, K5 = R5.toString;
function j5(e) {
  return K5.call(e);
}
var Q5 = j5, tr = en, Z5 = z5, V5 = Q5, H5 = "[object Null]", q5 = "[object Undefined]", nr = tr ? tr.toStringTag : void 0;
function Y5(e) {
...
var En = U6, z6 = Array.isArray, V1 = z6;
function R6(e) {
  return e != null && typeof e == "object";
}
var H1 = R6, K6 = pt, j6 = H1, Q6 = "[object Symbol]";
function Z6(e) {
...
var U2 = F2, z2 = nn;
function R2(e, n) {
  var t = this.__data__, o = z2(t, e);
  return o < 0 ? (++this.size, t.push([e, n])) : t[o][1] = n, this;
}
var K2 = R2, j2 = w2, Q2 = O2, Z2 = E2, V2 = U2, H2 = K2;
function Y1(e) {
  var n = -1, t = e == null ? 0 : e.length;
  for (this.clear(); ++n < t; ) {
    var o = e[n];
...
var zi = Ui, Ri = pt, Ki = H1, ji = "[object Arguments]";
function Qi(e) {
  return Ki(e) && Ri(e) == ji;
}
...
var Rn = Yt.exports, P3 = T3, D3 = zn, hr = Rn, fr = hr && hr.isTypedArray, O3 = fr ? D3(fr) : P3, N3 = O3, I3 = zi, E3 = Wi, B3 = V1, F3 = s9, U3 = i9, z3 = N3, R3 = Object.prototype, K3 = R3.hasOwnProperty;
function j3(e, n) {
  var t = B3(e), o = !t && E3(e), s = !t && !o && F3(e), l = !t && !o && !s && z3(e), h = t || o || s || l, d = h ? I3(e.length, String) : [], v = d.length;
  for (var x in e)
...
var h9 = Ia, Ea = Na, Ba = h9, Fa = Object.prototype, Ua = Fa.propertyIsEnumerable, mr = Object.getOwnPropertySymbols, za = mr ? function(e) {
  return e == null ? [] : (e = Object(e), Ea(mr(e), function(n) {
    return Ua.call(e, n);
  }));
} : Ba, Zn = za, Ra = an, Ka = Zn;
function ja(e, n) {
  return Ra(e, Ka(e), n);
}
var Qa = ja;
...
var Vn = T1, U8 = Object.prototype, z8 = U8.hasOwnProperty;
function R8(e) {
  var n = e.length, t = new e.constructor(n);
  return n && typeof e[0] == "string" && z8.call(e, "index") && (t.index = e.index, t.input = e.input), t;
}
var K8 = R8, j8 = s1, Q8 = j8.Uint8Array, Z8 = Q8, br = Z8;
function V8(e) {
...
var Bs = Es, Fs = Vn, Us = H1, zs = "[object Map]";
function Rs(e) {
  return Us(e) && Fs(e) == zs;
}
var Ks = Rs, js = Ks, Qs = zn, Lr = Rn, wr = Lr && Lr.isMap, Zs = wr ? Qs(wr) : js, Vs = Zs, Hs = Vn, qs = H1, Ys = "[object Set]";
function Ws(e) {
  return qs(e) && Hs(e) == Ys;
}
var Gs = Ws, Xs = Gs, Js = zn, Ar = Rn, Mr = Ar && Ar.isSet, e7 = Mr ? Js(Mr) : Xs, t7 = e7, n7 = Oi, r7 = Ii, o7 = En, i7 = ha, a7 = Ta, s7 = Sa, l7 = Da, c7 = Qa, u7 = r8, d7 = d8, h7 = y8, f7 = Vn, m7 = K8, g7 = Ts, y7 = Bs, p7 = V1, v7 = s9, C7 = Vs, b7 = Z1, $7 = t7, _7 = jn, k7 = Qn, x7 = 1, L7 = 2, w7 = 4, v9 = "[object Arguments]", A7 = "[object Array]", M7 = "[object Boolean]", T7 = "[object Date]", S7 = "[object Error]", C9 = "[object Function]", P7 = "[object GeneratorFunction]", D7 = "[object Map]", O7 = "[object Number]", b9 = "[object Object]", N7 = "[object RegExp]", I7 = "[object Set]", E7 = "[object String]", B7 = "[object Symbol]", F7 = "[object WeakMap]", U7 = "[object ArrayBuffer]", z7 = "[object DataView]", R7 = "[object Float32Array]", K7 = "[object Float64Array]", j7 = "[object Int8Array]", Q7 = "[object Int16Array]", Z7 = "[object Int32Array]", V7 = "[object Uint8Array]", H7 = "[object Uint8ClampedArray]", q7 = "[object Uint16Array]", Y7 = "[object Uint32Array]", ge = {};
ge[v9] = ge[A7] = ge[U7] = ge[z7] = ge[M7] = ge[T7] = ge[R7] = ge[K7] = ge[j7] = ge[Q7] = ge[Z7] = ge[D7] = ge[O7] = ge[b9] = ge[N7] = ge[I7] = ge[E7] = ge[B7] = ge[V7] = ge[H7] = ge[q7] = ge[Y7] = !0;
ge[S7] = ge[C9] = ge[F7] = !1;
    ...
    return typeof D == "function" ? D1(D, p) : h = p, C(M, () => e.value), C(p, (() => {
      ...
      return () => U() && (() => {
        ...
        return B.$$mousedown = (j) => j.preventDefault(), C(B, (() => {
          ...
          return () => j() && (() => {
            const ee = bl.cloneNode(!0), z = ee.firstChild;
            ee.style.setProperty("padding", "8px"), ee.style.setProperty("border-bottom", "1px solid #333"), z.$$click = (V) => V.stopPropagation(), z.$$input = (V) => s(V.currentTarget.value);
            const W = l;
            return typeof W == "function" ? D1(W, z) : l = z, z.style.setProperty("width", "100%"), z.style.setProperty("padding", "6px 10px"), z.style.setProperty("border", "1px solid var(--klinecharts-pro-border-color)"), z.style.setProperty("border-radius", "4px"), z.style.setProperty("background-color", "var(--klinecharts-pro-popover-background-color)"), z.style.setProperty("color", "#fff"), z.style.setProperty("font-size", "13px"), z.style.setProperty("outline", "none"), I(() => Te(z, "placeholder", e.searchPlaceholder || "Search...")), I(() => z.value = o()), ee;
          })();
        })(), O), C(O, () => {
          var j;
...
const _l = /* @__PURE__ */ $('<span class="prefix"></span>'), kl = /* @__PURE__ */ $('<span class="suffix"></span>'), xl = /* @__PURE__ */ $('<div><input class="value"></div>'), k9 = (e) => {
  ...
  return (() => {
    ...
    return l.$$click = () => {
      ...
      return d._v$ = N1(l, v, d._v$), x !== d._v$2 && oe(l, d._v$2 = x), p !== d._v$3 && Te(l, "data-status", d._v$3 = p), w !== d._v$4 && Te(h, "placeholder", d._v$4 = w), d;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
Ze(["click"]);
const Al = "指标", Ml = "更多", Tl = "主图指标", Sl = "副图指标", Pl = "设置", Dl = "时区", Ol = "截屏", Nl = "全屏", Il = "退出全屏", El = "保存", Bl = "确定", Fl = "取消", Ul = "MA(移动平均线)", zl = "EMA(指数平滑移动平均线)", Rl = "SMA", Kl = "BOLL(布林线)", jl = "BBI(多空指数)", Ql = "SAR(停损点指向指标)", Zl = "VOL(成交量)", Vl = "MACD(指数平滑异同移动平均线)", Hl = "KDJ(随机指标)", ql = "RSI(相对强弱指标)", Yl = "BIAS(乖离率)", Wl = "BRAR(情绪指标)", Gl = "CCI(顺势指标)", Xl = "DMI(动向指标)", Jl = "CR(能量指标)", e4 = "PSY(心理线)", t4 = "DMA(平行线差指标)", n4 = "TRIX(三重指数平滑平均线)", r4 = "OBV(能量潮指标)", o4 = "VR(成交量变异率)", i4 = "WR(威廉指标)", a4 = "MTM(动量指标)", s4 = "EMV(简易波动指标)", l4 = "ROC(变动率指标)", c4 = "PVT(价量趋势指标)", u4 = "AO(动量震荡指标)", d4 = "世界统一时间", h4 = "(UTC-10) 檀香山", f4 = "(UTC-8) 朱诺", m4 = "(UTC-7) 洛杉矶", g4 = "(UTC-5) 芝加哥", y4 = "(UTC-4) 多伦多", p4 = "(UTC-3) 圣保罗", v4 = "(UTC+1) 伦敦", C4 = "(UTC+2) 柏林", b4 = "(UTC+3) 巴林", $4 = "(UTC+4) 迪拜", _4 = "(UTC+5) 阿什哈巴德", k4 = "(UTC+6) 阿拉木图", x4 = "(UTC+7) 曼谷", L4 = "(UTC+8) 上海", w4 = "(UTC+9) 东京", A4 = "(UTC+10) 悉尼", M4 = "(UTC+12) 诺福克岛", T4 = "水平直线", S4 = "水平射线", P4 = "水平线段", D4 = "垂直直线", O4 = "垂直射线", N4 = "垂直线段", I4 = "直线", E4 = "射线", B4 = "线段", F4 = "箭头", U4 = "价格线", z4 = "价格通道线", R4 = "平行直线", K4 = "斐波那契回调直线", j4 = "斐波那契回调线段", Q4 = "斐波那契圆环", Z4 = "斐波那契螺旋", V4 = "斐波那契速度阻力扇", H4 = "斐波那契趋势扩展", q4 = "江恩箱", Y4 = "矩形", W4 = "平行四边形", G4 = "圆", X4 = "三角形", J4 = "三浪", ec = "五浪", tc = "八浪", nc = "任意浪", rc = "ABCD形态", oc = "XABCD形态", ic = "弱磁模式", ac = "强磁模式", sc = "商品搜索", lc = "商品代码", cc = "参数1", uc = "参数2", dc = "参数3", hc = "参数4", fc = "参数5", mc = "周期", gc = "标准差", yc = "蜡烛图类型", pc = "全实心", vc = "全空心", Cc = "涨空心", bc = "跌空心", $c = "OHLC", _c = "面积图", kc = "最新价显示", xc = "最高价显示", Lc = "最低价显示", wc = "指标最新值显示", Ac = "价格轴类型", Mc = "线性轴", Tc = "百分比轴", Sc = "对数轴", Pc = "倒置坐标", Dc = "网格线显示", Oc = "恢复默认", Nc = {
  indicator: Al,
  more: Ml,
  main_indicator: Tl,
  sub_indicator: Sl,
...
const c = (e, n) => {
  ...
  let n, t, o;
  const [s, l] = T(window.innerWidth < 768), [h, d] = T(localStorage.getItem("klinechart_secondary_period") || ""), [v, x] = T(!1), [p, w] = T(!1), [M, D] = T(!1), [U, B] = T(!1), [O, j] = T(!1), [ee, z] = T({
    top: 0,
    left: 0,
    minWidth: 220
  }), W = () => {
    l(window.innerWidth < 768), requestAnimationFrame(ne), v() && Se();
  }, [V, he] = T(!1), K = () => document.fullscreenElement ?? document.body, Q = () => {
    he(!!document.fullscreenElement);
  }, [q, re] = T(!1), [ae, _e] = T(!1), Se = () => {
    if (!t)
      return;
  ...
  return Re(() => {
    ...
    return N.style.setProperty("position", "relative"), N.style.setProperty("width", "100%"), N.style.setProperty("display", "flex"), N.style.setProperty("align-items", "center"), C(N, L(J, {
      ...
      get children() {
        const _ = Zd.cloneNode(!0), se = _.firstChild;
        return i1(_, "click", e.onSymbolClick, !0), C(_, L(J, {
          ...
          get children() {
            ...
            return I(() => Te(De, "src", e.symbol.logo)), De;
          }
        }), se), C(se, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), _;
      }
    }), le), C(E, () => me().map((_, se) => {
      ...
      get children() {
        ...
        return _.$$click = (se) => {
          var De;
          se.stopPropagation(), (De = e.onMobileMoreClick) == null || De.call(e);
      ...
      get children() {
        const _ = Yd.cloneNode(!0), se = _.firstChild, De = se.nextSibling;
      ...
      get children() {
        const _ = Xd.cloneNode(!0), se = _.firstChild, De = se.firstChild, Ve = De.nextSibling;
        return D1((be) => {
          t = be;
        }, _), _.style.setProperty("display", "flex"), _.style.setProperty("align-items", "center"), se.$$click = (be) => {
          be.stopPropagation(), Fe();
        }, se.style.setProperty("gap", "6px"), Ve.style.setProperty("transition", "transform 0.2s ease"), C(_, L(J, {
          get when() {
            return v();
          },
          get children() {
            return L(S5, {
              ...
              get children() {
                const be = Gd.cloneNode(!0), l1 = be.firstChild, r1 = l1.firstChild, Ue = r1.firstChild, J1 = Ue.firstChild, k1 = J1.firstChild, E1 = r1.nextSibling, y1 = E1.firstChild, c1 = y1.firstChild, et = c1.firstChild, He = y1.nextSibling, vt = He.firstChild, Ct = vt.firstChild, p1 = l1.nextSibling, u1 = p1.firstChild, sn = u1.firstChild, tt = sn.firstChild, x1 = tt.firstChild, bt = u1.nextSibling, nt = bt.firstChild, ln = nt.firstChild, B1 = ln.nextSibling, Ke = nt.nextSibling, je = Ke.firstChild, qe = je.nextSibling, ze = qe.firstChild, $t = ze.firstChild, F1 = p1.nextSibling, rt = F1.firstChild, ot = rt.firstChild, xe = F1.nextSibling, Oe = xe.nextSibling, cn = Oe.firstChild, Ye = cn.firstChild, L1 = Oe.nextSibling, d1 = L1.nextSibling, un = d1.firstChild, v1 = un.firstChild, it = d1.nextSibling, Xe = it.firstChild, at = Xe.firstChild, st = at.firstChild, U1 = st.firstChild, z1 = Xe.nextSibling, Qe = z1.firstChild, dn = Qe.firstChild, lt = dn.firstChild, h1 = Qe.nextSibling, ct = h1.firstChild, _t = ct.firstChild, hn = h1.nextSibling, fn = hn.firstChild, R1 = fn.firstChild, kt = it.nextSibling, w1 = kt.firstChild, xt = w1.firstChild;
                return be.$$mousedown = (b) => b.stopPropagation(), D1((b) => {
                  ...
                  get children() {
                    ...
                    return C(b, () => ["left", "center", "right"].map((S) => (() => {
                      ...
                      return Me.$$click = (Ee) => {
                        ...
                        var Ee;
                        return oe(Me, (((Ee = e.orderToolsState) == null ? void 0 : Ee.openOrdersDisplay) ?? "right") === S ? "selected" : "");
                      }), Me;
                    })())), b;
                  }
                  ...
                  var ut;
                  const S = `${ee().top}px`, Me = `${ee().left}px`, Ee = `${ee().minWidth}px`, We = `klinecharts-pro-order-tools-group${p() ? " klinecharts-pro-order-tools-group-open" : ""}`, A1 = `klinecharts-pro-order-tools-group${M() ? " klinecharts-pro-order-tools-group-open" : ""}`, Lt = `klinecharts-pro-order-tools-switch${((ut = e.orderToolsState) == null ? void 0 : ut.openOrdersExtendedPriceLine) ?? !0 ? " klinecharts-pro-order-tools-switch-on" : ""}`, wt = `klinecharts-pro-order-tools-display-arrow${U() ? " klinecharts-pro-order-tools-display-arrow-open" : ""}`, At = `klinecharts-pro-order-tools-group${O() ? " klinecharts-pro-order-tools-group-open" : ""}`;
                  return S !== b._v$ && be.style.setProperty("top", b._v$ = S), Me !== b._v$2 && be.style.setProperty("left", b._v$2 = Me), Ee !== b._v$3 && be.style.setProperty("width", b._v$3 = Ee), We !== b._v$4 && oe(l1, b._v$4 = We), A1 !== b._v$5 && oe(p1, b._v$5 = A1), Lt !== b._v$6 && oe(B1, b._v$6 = Lt), wt !== b._v$7 && Te($t, "class", b._v$7 = wt), At !== b._v$8 && oe(it, b._v$8 = At), b;
                }, {
                  _v$: void 0,
                  _v$2: void 0,
                  _v$3: void 0,
                  ...
                  var b, S, Me, Ee;
                  return k1.checked = (((b = e.orderToolsState) == null ? void 0 : b.quickOrderFloatingWindow) ?? ((S = e.orderToolsState) == null ? void 0 : S.quickOrder) ?? !0) || (((Me = e.orderToolsState) == null ? void 0 : Me.quickOrderPlusButton) ?? ((Ee = e.orderToolsState) == null ? void 0 : Ee.quickOrder) ?? !0);
                }), I(() => {
                  var b, S;
          ...
          return l1 !== be._v$9 && se.style.setProperty("padding", be._v$9 = l1), r1 !== be._v$10 && Ve.style.setProperty("transform", be._v$10 = r1), be;
        }, {
          _v$9: void 0,
          _v$10: void 0
        }), _;
      ...
      get children() {
        ...
        return i1(_, "click", e.chartViewToggle.onToggle, !0), C(_, (() => {
          const se = Z(() => e.chartViewToggle.view === "chart");
          return () => se() ? ch.cloneNode(!0) : uh.cloneNode(!0);
        })()), I(() => Te(_, "title", e.chartViewToggle.view === "chart" ? "View Depth" : "View Chart")), _;
      }
    }), null), C(N, L(J, {
      get when() {
        return ae();
      ...
      const se = e.spread ? "" : "rotate", De = V() ? "0px" : "var(--klinecharts-pro-period-bar-padding-right)";
      return se !== _._v$11 && Te(Pe, "class", _._v$11 = se), De !== _._v$12 && le.style.setProperty("padding-right", _._v$12 = De), _;
    }, {
      _v$11: void 0,
      _v$12: void 0
    }), N;
...
const Ge = (e) => Of[e.name](e.class), zf = /* @__PURE__ */ $('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Rf = /* @__PURE__ */ $('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Pr = /* @__PURE__ */ $('<li><span style="padding-left:8px"></span></li>'), Dr = "drawing_tools", Kf = (e) => {
  const [n, t] = T("horizontalStraightLine"), [o, s] = T("priceChannelLine"), [l, h] = T("circle"), [d, v] = T("fibonacciLine"), [x, p] = T("xabcd"), [w, M] = T("weak_magnet"), [D, U] = T("normal"), [B, O] = T(!1), [j, ee] = T(!0), [z, W] = T(""), V = Z(() => [{
    key: "singleLine",
    icon: n(),
    list: Nf(e.locale),
    setter: t
  ...
  return (() => {
    const K = zf.cloneNode(!0), Q = K.firstChild, q = Q.nextSibling, re = q.firstChild, ae = re.nextSibling, _e = ae.firstChild, Se = q.nextSibling, fe = Se.firstChild, Fe = Se.nextSibling, ke = Fe.firstChild, ve = Fe.nextSibling, ne = ve.nextSibling, me = ne.firstChild;
    return C(K, () => V().map((H) => (() => {
      const N = Rf.cloneNode(!0), E = N.firstChild, Ce = E.nextSibling, Pe = Ce.firstChild;
        ...
        return () => le() && L(Gt, {
          ...
          get children() {
            return H.list.map((Ie) => (() => {
              const _ = Pr.cloneNode(!0), se = _.firstChild;
              return _.$$click = () => {
      ...
      })(), null), I(() => Te(Pe, "class", H.key === z() ? "rotate" : "")), N;
        ...
        renderItem: (s) => (() => {
          ...
          return l.$$click = () => {
            ...
            get children() {
              ...
              return I(() => Te(v, "src", s.logo)), v;
            }
          }), d), C(d, () => s.shortName ?? s.ticker, null), C(d, () => `${s.name ? `(${s.name})` : ""}`, null), C(l, () => s.exchange ?? "", null), I(() => Te(d, "title", s.name ?? "")), l;
        })()
      })];
    }
  });
...
Ze(["click"]);
const sm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-picker"></div>'), lm = /* @__PURE__ */ $('<label class="klinecharts-pro-time-tools-field"><span></span><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), cm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), um = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-grid"></div>'), dm = /* @__PURE__ */ $('<span class="weekday"></span>'), S1 = /* @__PURE__ */ $('<button type="button"></button>'), hm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid"></div>'), fm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), mm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), gm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-content"></div>'), ym = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-tabs"></div>'), pm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow">-></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), vm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div class="klinecharts-pro-time-tools-row with-divider"><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div class="klinecharts-pro-time-tools-row with-divider"><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), Cm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), bm = [{
  key: "goToDate",
  label: "Go to Date"
}, {
  key: "timeRange",
  ...
  key: "timeAnchor",
  label: "Time Anchor"
}], $m = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], Br = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], j1 = (e) => String(e).padStart(2, "0"), Fr = (e, n, t) => Math.min(t, new Date(e, n + 1, 0).getDate()), $n = (e) => {
  const n = new Date(e);
  return {
    year: n.getFullYear(),
    month: n.getMonth(),
  ...
  const [n, t] = T(!0), [o, s] = T("date"), [l, h] = T(e.value.year), [d, v] = T(e.value.month), x = Z(() => _m(l(), d())), p = Z(() => Math.floor(l() / 10) * 10), w = Z(() => Array.from({
    length: 12
  ...
  return (() => {
    ...
    return C(K, (() => {
      ...
      return () => Q() && (() => {
        const q = lm.cloneNode(!0), re = q.firstChild, ae = re.nextSibling, _e = ae.firstChild;
        return C(re, () => e.label), ae.$$click = () => t(!n()), C(_e, () => On(e.value)), q;
      })();
    })(), null), C(K, (() => {
      const Q = Z(() => !!n());
      return () => Q() && (() => {
        const q = cm.cloneNode(!0), re = q.firstChild, ae = re.firstChild, _e = ae.nextSibling, Se = _e.nextSibling, fe = Se.nextSibling, Fe = fe.nextSibling;
        return ae.$$click = () => {
          ...
          const ke = Z(() => o() === "date");
          return () => ke() && (() => {
            const ve = um.cloneNode(!0);
            return C(ve, () => $m.map((ne) => (() => {
              const me = dm.cloneNode(!0);
              return C(me, ne), me;
            })()), null), C(ve, () => x().map(({
              date: ne,
              current: me
              ...
              return (() => {
                const se = S1.cloneNode(!0);
                return se.$$click = () => ee(ne), oe(se, `${me ? "" : "muted"} ${le ? "in-range" : ""} ${Ie || _ ? "selected" : ""}`), C(se, () => ne.getDate()), se;
              })();
            }), null), ve;
          })();
        })(), null), C(q, (() => {
          ...
          return () => ke() && (() => {
            ...
            return C(ve, () => Br.map((ne, me) => (() => {
              ...
              return H.$$click = () => z(me), C(H, ne), I(() => oe(H, me === e.value.month && l() === e.value.year ? "selected" : "")), H;
            })())), ve;
          })();
        })(), null), C(q, (() => {
          const ke = Z(() => o() === "year");
          ...
          const ke = Z(() => o() === "date");
          return () => ke() && (() => {
            const ve = mm.cloneNode(!0), ne = ve.firstChild, me = ne.nextSibling, H = me.nextSibling;
            return C(ne, () => U.map((N) => (() => {
  ...
  return L(_1, {
    ...
    get children() {
      ...
      return C(B, (() => {
        ...
        return () => O() && (() => {
          const j = pm.cloneNode(!0), ee = j.firstChild, z = ee.firstChild, W = z.nextSibling, V = W.nextSibling;
          return z.$$click = () => p("from"), C(z, () => On(l())), V.$$click = () => p("to"), C(V, () => On(d())), C(j, (() => {
            const he = Z(() => x() === "from");
            return () => he() ? L(Ut, {
              label: "Start",
              get value() {
            ...
            return K !== he._v$ && oe(z, he._v$ = K), Q !== he._v$2 && oe(V, he._v$2 = Q), he;
          }, {
            _v$: void 0,
            _v$2: void 0
          }), j;
        ...
        return () => O() && (() => {
          const j = vm.cloneNode(!0), ee = j.firstChild, z = ee.firstChild, W = z.nextSibling, V = ee.nextSibling, he = V.firstChild, K = he.nextSibling, Q = V.nextSibling, q = Q.firstChild, re = q.nextSibling, ae = Q.nextSibling, _e = ae.firstChild, Se = _e.nextSibling;
          return W.$$click = () => D({
            enabled: !w().enabled
            ...
            return Fe !== fe._v$3 && oe(W, fe._v$3 = Fe), ke !== fe._v$4 && oe(V, fe._v$4 = ke), ve !== fe._v$5 && (K.disabled = fe._v$5 = ve), ne !== fe._v$6 && oe(re, fe._v$6 = ne), me !== fe._v$7 && oe(Se, fe._v$7 = me), fe;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
Ze(["click"]);
const xm = /* @__PURE__ */ $('<i class="icon-close klinecharts-pro-load-icon"></i>'), Lm = /* @__PURE__ */ $('<div class="klinecharts-pro-content"><div class="klinecharts-pro-widget"></div></div>'), wm = /* @__PURE__ */ $('<div class="klinecharts-pro-time-anchor-line"></div>'), Am = /* @__PURE__ */ $('<div class="klinecharts-pro-time-navigation-tooltip"></div>'), Mm = /* @__PURE__ */ $('<div class="klinecharts-pro-countdown-price-mark"><span class="klinecharts-pro-countdown-price-mark-price"></span><span class="klinecharts-pro-countdown-price-mark-timer"></span></div>'), Tm = /* @__PURE__ */ $('<div class="overlay-toolbar-color-popover"><div class="overlay-toolbar-color-grid"></div><div class="overlay-toolbar-color-footer"><button type="button" class="overlay-toolbar-add-color">+</button><div class="overlay-toolbar-color-slider"><span></span></div></div></div>'), Sm = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown width-menu"></div>'), Pm = /* @__PURE__ */ $('<div class="overlay-toolbar-dropdown style-menu"><button type="button"><span class="overlay-toolbar-style-sample solid"></span></button><button type="button"><span class="overlay-toolbar-style-sample dashed"></span></button><button type="button"><span class="overlay-toolbar-style-sample dotted"></span></button></div>'), Dm = /* @__PURE__ */ $('<div class="klinecharts-pro-overlay-toolbar"><button type="button" class="overlay-toolbar-icon drag" title="Move"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="6" r="1.5"></circle><circle cx="15" cy="6" r="1.5"></circle><circle cx="9" cy="12" r="1.5"></circle><circle cx="15" cy="12" r="1.5"></circle><circle cx="9" cy="18" r="1.5"></circle><circle cx="15" cy="18" r="1.5"></circle></svg></button><button type="button" class="overlay-toolbar-icon refresh" title="Reset"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 0 1 15.4-6.36L21 8"></path><path d="M21 3v5h-5"></path><path d="M21 12a9 9 0 0 1-15.4 6.36L3 16"></path><path d="M3 21v-5h5"></path></svg></button><div class="overlay-toolbar-picker"><button type="button" title="Color"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line width"><span class="overlay-toolbar-line-preview"></span><span>px</span></button></div><div class="overlay-toolbar-picker"><button type="button" title="Line style"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 12h16"></path></svg></button></div><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="5" width="14" height="14" rx="2"></rect><path d="M20 4 4 20"></path></svg></button><button type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="10" width="14" height="10" rx="2"></rect><path d="M8 10V7a4 4 0 0 1 8 0v3"></path></svg></button><button type="button" class="overlay-toolbar-icon delete" title="Delete"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18"></path><path d="M8 6V4h8v2"></path><path d="M19 6 18 20H6L5 6"></path><path d="M10 11v5"></path><path d="M14 11v5"></path></svg></button></div>'), Om = /* @__PURE__ */ $('<button type="button"></button>'), Nm = /* @__PURE__ */ $('<button type="button"><span class="overlay-toolbar-width-sample"></span></button>'), Im = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-marker"><button type="button" class="klinecharts-pro-quick-order-plus"></button></div>'), Em = /* @__PURE__ */ $('<span class="klinecharts-pro-quick-order-plus-icon"></span>'), Bm = /* @__PURE__ */ $('<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3" aria-hidden="true"><path d="M460-300h40v-160h160v-40H500v-160h-40v160H300v40h160v160ZM224.62-160q-27.62 0-46.12-18.5Q160-197 160-224.62v-510.76q0-27.62 18.5-46.12Q197-800 224.62-800h510.76q27.62 0 46.12 18.5Q800-763 800-735.38v510.76q0 27.62-18.5 46.12Q763-160 735.38-160H224.62Zm0-40h510.76q9.24 0 16.93-7.69 7.69-7.69 7.69-16.93v-510.76q0-9.24-7.69-16.93-7.69-7.69-16.93-7.69H224.62q-9.24 0-16.93 7.69-7.69 7.69-7.69 16.93v510.76q0 9.24 7.69 16.93 7.69 7.69 16.93 7.69ZM200-760v560-560Z"></path></svg>'), Fm = /* @__PURE__ */ $('<div class="klinecharts-pro-quick-order-menu-anchor"><div class="klinecharts-pro-quick-order-menu"><button type="button">Trade <!> @ <!> Limit</button><button type="button">Trade <!> @ <!> Stop</button><button type="button">Create new order...</button><button type="button">Copy Price (<!>)</button><button type="button">Draw horizontal line on </button></div></div>');
function zt(e, n, t, o) {
  n === "VOL" && (o = {
    gap: {
      bottom: 2
...
const zm = (e) => {
  ...
  const [s, l] = T(!1), [h, d] = T(e.theme), [v, x] = T(e.styles), [p, w] = T(e.locale), [M, D] = T(e.symbol), [U, B] = T(e.period), O = () => {
  ...
  }, [j, ee] = T(!1), [z, W] = T([...e.mainIndicators]), [V, he] = T({}), [K, Q] = T(!1), [q, re] = T({
    key: e.timezone,
    text: Ir(e.timezone, e.locale)
  }), [ae, _e] = T(!1), [Se, fe] = T(), [Fe, ke] = T(""), [ve, ne] = T(!1), [me, H] = T(Date.now()), [N, E] = T({
    ...
    anchorLine: !1,
    acrossTokens: !1
  }), [le, Ie] = T(e.drawingBarVisible), [_, se] = T(!1), [De, Ve] = T(!1), [be, l1] = T(!1), r1 = ((v0 = e.orderTools) == null ? void 0 : v0.quickOrder) ?? !0, [Ue, J1] = T({
    quickOrder: r1,
  ...
  let xe = /* @__PURE__ */ new Map(), Oe = /* @__PURE__ */ new Map();
  const cn = (r, i, a) => {
  ...
  const at = () => {
    ...
    }), xe.clear(), Oe.clear(), je(null), ze(null), Xe.loadDrawings(r).forEach((a) => {
      var u;
      try {
        const m = w1({
          name: a.type,
    ...
    }), P = (q0 = t.getSize) == null ? void 0 : q0.call(t, "candle_pane", b1.YAxis), Y = P != null && P.width && Number.isFinite(P.width) ? Math.max(74, Math.floor(P.width) - 2) : 96, X = Rt(U()), G = r % X, R = G === 0 ? X : X - G, te = Number(a.close), ue = Number(a.open), Le = t.getStyles().candle.priceMark.last, F = Le.text, ce = Number(F.size) || 12, ie = Number(F.paddingTop) || 2, $e = Number(F.paddingBottom) || 2, we = Math.min(Number(F.paddingLeft) || 4, 3), Je = Math.min(Number(F.paddingRight) || 4, 3), e1 = Math.max(34, ce * 2 + ie + $e + 6), o1 = Math.max(0, Math.min(g - e1 / 2, y - e1));
    x1({
      top: o1,
      width: Math.min(Y, Math.max(62, A.length * (ce * 0.56) + we + Je + 4)),
      priceText: A,
      text: Um(R),
      color: Number.isFinite(te) && Number.isFinite(ue) && te < ue ? Le.downColor : Le.upColor,
      textSize: ce,
      textFamily: F.family,
      textWeight: F.weight,
      paddingLeft: we,
      ...
      if (Number.isFinite(r == null ? void 0 : r.pageX) ? g = r.pageX - i.left : Number.isFinite(r == null ? void 0 : r.x) && a && (g = a.left - i.left + r.x), Number.isFinite(r == null ? void 0 : r.pageY))
        ...
        try {
          const G = (Y = t == null ? void 0 : t.convertToPixel) == null ? void 0 : Y.call(t, [{
            ...
            paneId: "candle_pane",
            absolute: !0
          }), R = Number((X = G == null ? void 0 : G[0]) == null ? void 0 : X.y);
    ...
    if (!(i != null && i.id) || i.name !== "horizontalStraightLine")
      return !1;
    const a = fn(r), u = Number((k = (y = i.styles) == null ? void 0 : y.line) == null ? void 0 : k.size) || 3, m = ((P = (A = i.styles) == null ? void 0 : A.line) == null ? void 0 : P.style) ?? f1.Solid, g = Array.isArray((X = (Y = i.styles) == null ? void 0 : Y.line) == null ? void 0 : X.dashedValue) ? i.styles.line.dashedValue : [], f = ((R = (G = i.styles) == null ? void 0 : G.line) == null ? void 0 : R.color) ?? "#2f6df6";
    return je({
      id: i.id,
      x: a.x,
      y: a.y,
    ...
    return {
      ...
      styles: {
        ...
        line: {
          ...
          color: ((R = (G = r.styles) == null ? void 0 : G.line) == null ? void 0 : R.color) ?? "#2f6df6"
        }
      },
      onClick: (te) => (R1(te), (i == null ? void 0 : i(te)) ?? !1),
      onSelected: (te) => (R1(te), (a == null ? void 0 : a(te)) ?? !1),
      onPressedMoveEnd: (te) => (R1(te), (g == null ? void 0 : g(te)) ?? !1),
  ...
  Re(() => {
    var te, ue, Le, F, ce, ie, $e, we, Je, e1, o1, t1, n1, ht;
    const r = (te = e.orderTools) == null ? void 0 : te.quickOrder, i = (ue = e.orderTools) == null ? void 0 : ue.quickOrderFloatingWindow, a = (Le = e.orderTools) == null ? void 0 : Le.quickOrderPlusButton, u = (F = e.orderTools) == null ? void 0 : F.openOrders, m = (ce = e.orderTools) == null ? void 0 : ce.openOrdersExtendedPriceLine, g = (ie = e.orderTools) == null ? void 0 : ie.openOrdersDisplay, f = ($e = e.orderTools) == null ? void 0 : $e.positions, y = (we = e.orderTools) == null ? void 0 : we.breakevenPrice, k = (Je = e.orderTools) == null ? void 0 : Je.liquidationPrice, A = (e1 = e.orderTools) == null ? void 0 : e1.priceLine, P = (o1 = e.orderTools) == null ? void 0 : o1.marketPriceLine, Y = (t1 = e.orderTools) == null ? void 0 : t1.countDown, X = (n1 = e.orderTools) == null ? void 0 : n1.bidAskPrice, G = (ht = e.orderTools) == null ? void 0 : ht.orderHistory, R = {};
    typeof r == "boolean" && r !== qn && (qn = r, R.quickOrder = r, typeof i != "boolean" && (R.quickOrderFloatingWindow = r), typeof a != "boolean" && (R.quickOrderPlusButton = r)), typeof i == "boolean" && i !== Yn && (Yn = i, R.quickOrderFloatingWindow = i), typeof a == "boolean" && a !== Wn && (Wn = a, R.quickOrderPlusButton = a), typeof u == "boolean" && u !== Gn && (Gn = u, R.openOrders = u), typeof m == "boolean" && m !== Xn && (Xn = m, R.openOrdersExtendedPriceLine = m), g !== void 0 && g !== Jn && (Jn = g, R.openOrdersDisplay = g), typeof f == "boolean" && f !== e0 && (e0 = f, R.positions = f), typeof y == "boolean" && y !== t0 && (t0 = y, R.breakevenPrice = y), typeof k == "boolean" && k !== n0 && (n0 = k, R.liquidationPrice = k), typeof A == "boolean" && A !== r0 && (r0 = A, R.priceLine = A, typeof P != "boolean" && (R.marketPriceLine = A), typeof Y != "boolean" && (R.countDown = A), typeof X != "boolean" && (R.bidAskPrice = A)), typeof P == "boolean" && P !== o0 && (o0 = P, R.marketPriceLine = P), typeof Y == "boolean" && Y !== i0 && (i0 = Y, R.countDown = Y), typeof X == "boolean" && X !== a0 && (a0 = X, R.bidAskPrice = X), typeof G == "boolean" && G !== s0 && (s0 = G, R.orderHistory = G), Object.keys(R).length > 0 && U1(R);
  }), Re(() => {
    ...
    getSettings: () => {
      var a, u, m, g, f, y, k, A, P, Y, X, G, R, te, ue, Le;
      if (!t)
        return {};
      ...
      return {
        ...
        // Indicator settings
        showIndicatorLastValue: (R = (G = r.indicator) == null ? void 0 : G.lastValueMark) == null ? void 0 : R.show,
        ...
        // Grid settings
        showGrids: (Le = r.grid) == null ? void 0 : Le.show,
        timestamp: Date.now()
      };
    },
    setSettings: (r) => {
      var a, u, m, g, f, y, k, A, P, Y, X, G, R, te;
      if (!t)
        return;
      const i = {};
      ...
      r.showLastPrice !== void 0 && (i.candle = {
        ...
        priceMark: {
          ...
          low: {
            ...(R = (G = i.candle) == null ? void 0 : G.priceMark) == null ? void 0 : R.low,
  ...
  const L9 = () => {
    ...
    const i = M9(r), a = i == null ? void 0 : i.candle, u = Number((a == null ? void 0 : a.timestamp) ?? r), m = Number((a == null ? void 0 : a.high) ?? (a == null ? void 0 : a.close) ?? (a == null ? void 0 : a.open)), g = i ? Pt(i.dataIndex) : void 0, f = i && Number.isFinite(m) ? {
      ...
      paneId: "candle_pane",
      absolute: !0
    }), k = Number((G = y == null ? void 0 : y[0]) == null ? void 0 : G.x), A = Number((R = y == null ? void 0 : y[0]) == null ? void 0 : R.y), P = n.clientWidth, Y = n.clientHeight;
    ...
    const a = Rt(U()), u = Math.max(1, Math.floor(i / 2)) * a;
    return {
      from: r - u,
      to: r + u
    };
  }, P9 = (r, i, a = 600) => {
    const u = Rt(i), m = Math.max(120, a);
    let g = 0.5;
    ...
    const a = Rt(i), u = Math.abs(r.to - r.from), m = Math.max(1, Math.ceil(u / a) + 1), g = Math.max(m, 120) * a;
    return {
      from: r.from,
    ...
    if (y) {
      const te = Pt(y.dataIndex), ue = (X = t.convertToPixel) == null ? void 0 : X.call(t, [{
        ...
        paneId: "candle_pane",
        absolute: !0
      }), Le = Number((G = ue == null ? void 0 : ue[0]) == null ? void 0 : G.x), F = t.getBarSpace, ce = typeof F == "function" ? F.call(t) : void 0, ie = Number(typeof ce == "object" ? ce == null ? void 0 : ce.bar : ce), $e = Number.isFinite(ie) ? Math.max(2, ie / 2) : 8;
      if (Number.isFinite(Le) && Math.abs(Le - a) <= $e)
        return i;
    }
    const k = Number((R = u[f]) == null ? void 0 : R.timestamp);
    ...
    t.scrollToDataIndex(a, 0), requestAnimationFrame(() => {
      ...
      Number.isFinite(g) && (t == null || t.scrollByDistance(u - g, 0)), requestAnimationFrame(() => {
        C1(r), Dt(r.timestamp), window.setTimeout(() => {
          dt = !1;
        }, 1e3);
      });
    }), Qe();
    ...
    const a = F9(i), u = t.getSize("candle_pane", b1.Main), m = Math.max(1, (n == null ? void 0 : n.clientHeight) ?? (u == null ? void 0 : u.height) ?? 0);
    if (a === null) {
      B1(null);
      return;
    }
    ...
    if (t) {
      ...
      try {
        ...
        t.applyNewData(f, f.length > 0), E(m), requestAnimationFrame(() => {
          const k = I9(f, m);
          i ? gn(i) : (B9(y), t == null || t.scrollToDataIndex(k, 0), Dt(N9(y, m))), C1();
        });
      } finally {
        l(!1), Ve(!1);
      }
  ...
  In(() => {
    ...
    }), Mt && (window.clearInterval(Mt), Mt = void 0), Tt && (window.clearTimeout(Tt), Tt = void 0), document.removeEventListener("mousedown", ut), Oe.clear(), xe.clear(), Y0(n);
  }), Re(() => {
    const r = M();
  ...
  return Re((r) => {
    ...
    const r = Lm.cloneNode(!0), i = r.firstChild;
    return r.addEventListener("mouseleave", () => {
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Mm.cloneNode(!0), m = u.firstChild, g = m.nextSibling;
        return u.style.setProperty("right", "0px"), C(m, () => a.priceText), C(g, () => a.text), I((f) => {
          const y = `${a.top}px`, k = `${a.width}px`, A = a.color, P = `${a.borderRadius}px`, Y = a.textFamily, X = a.textWeight, G = `${a.paddingLeft}px`, R = `${a.paddingRight}px`, te = `${a.paddingTop}px`, ue = `${a.paddingBottom}px`, Le = `${a.textSize}px`, F = `${Math.max(10, a.textSize - 1)}px`;
          return y !== f._v$6 && u.style.setProperty("top", f._v$6 = y), k !== f._v$7 && u.style.setProperty("width", f._v$7 = k), A !== f._v$8 && u.style.setProperty("background", f._v$8 = A), P !== f._v$9 && u.style.setProperty("border-radius", f._v$9 = P), Y !== f._v$10 && u.style.setProperty("font-family", f._v$10 = Y), X !== f._v$11 && u.style.setProperty("font-weight", f._v$11 = X), G !== f._v$12 && u.style.setProperty("padding-left", f._v$12 = G), R !== f._v$13 && u.style.setProperty("padding-right", f._v$13 = R), te !== f._v$14 && u.style.setProperty("padding-top", f._v$14 = te), ue !== f._v$15 && u.style.setProperty("padding-bottom", f._v$15 = ue), Le !== f._v$16 && m.style.setProperty("font-size", f._v$16 = Le), F !== f._v$17 && g.style.setProperty("font-size", f._v$17 = F), f;
        }, {
          _v$6: void 0,
          _v$7: void 0,
          _v$8: void 0,
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Dm.cloneNode(!0), m = u.firstChild, g = m.nextSibling, f = g.nextSibling, y = f.firstChild, k = f.nextSibling, A = k.firstChild, P = A.firstChild, Y = P.nextSibling, X = Y.firstChild, G = k.nextSibling, R = G.firstChild, te = G.nextSibling, ue = te.nextSibling, Le = ue.nextSibling;
        return u.$$click = (F) => {
          F.stopPropagation();
        }, u.$$mousedown = (F) => {
          F.preventDefault(), F.stopPropagation();
        }, m.$$mousedown = wt, g.$$click = A1, y.$$click = () => ze(qe() === "color" ? null : "color"), C(f, L(J, {
          get when() {
            return qe() === "color";
          },
          get children() {
            const F = Tm.cloneNode(!0), ce = F.firstChild;
            return C(ce, L(Ln, {
              each: $t,
              children: (ie) => (() => {
                const $e = Om.cloneNode(!0);
        ...
        }), null), A.$$click = () => ze(qe() === "width" ? null : "width"), C(Y, () => a.lineSize, X), C(k, L(J, {
          get when() {
            return qe() === "width";
          },
          get children() {
            const F = Sm.cloneNode(!0);
            return C(F, L(Ln, {
              each: [1, 2, 3, 4],
              children: (ce) => (() => {
                const ie = Nm.cloneNode(!0), $e = ie.firstChild;
                return ie.$$click = () => Ee(ce), $e.style.setProperty("height", `${ce}px`), I(() => oe(ie, a.lineSize === ce ? "selected" : "")), ie;
              })()
            })), F;
          }
        }), null), R.$$click = () => ze(qe() === "style" ? null : "style"), C(G, L(J, {
          get when() {
            return qe() === "style";
          },
          get children() {
            const F = Pm.cloneNode(!0), ce = F.firstChild, ie = ce.nextSibling, $e = ie.nextSibling;
            return ce.$$click = () => We(f1.Solid, []), ie.$$click = () => We(f1.Dashed, [6, 4]), $e.$$click = () => We(f1.Dashed, [2, 4]), I((we) => {
              var t1, n1;
              ...
              return Je !== we._v$18 && oe(ce, we._v$18 = Je), e1 !== we._v$19 && oe(ie, we._v$19 = e1), o1 !== we._v$20 && oe($e, we._v$20 = o1), we;
            }, {
              _v$18: void 0,
              _v$19: void 0,
              _v$20: void 0
        ...
        }), null), te.$$click = Me, ue.$$click = S, Le.$$click = xt, I((F) => {
          const ce = `${a.x}px`, ie = `${a.y}px`, $e = `overlay-toolbar-icon edit ${qe() === "color" ? "active" : ""}`, we = `overlay-toolbar-line-size ${qe() === "width" ? "active" : ""}`, Je = `overlay-toolbar-icon minus ${qe() === "style" ? "active" : ""}`, e1 = `overlay-toolbar-icon visibility ${a.visible ? "" : "muted"}`, o1 = a.visible ? "Hide" : "Show", t1 = `overlay-toolbar-icon lock ${a.locked ? "active" : ""}`, n1 = a.locked ? "Unlock" : "Lock";
          return ce !== F._v$21 && u.style.setProperty("left", F._v$21 = ce), ie !== F._v$22 && u.style.setProperty("top", F._v$22 = ie), $e !== F._v$23 && oe(y, F._v$23 = $e), we !== F._v$24 && oe(A, F._v$24 = we), Je !== F._v$25 && oe(R, F._v$25 = Je), e1 !== F._v$26 && oe(te, F._v$26 = e1), o1 !== F._v$27 && Te(te, "title", F._v$27 = o1), t1 !== F._v$28 && oe(ue, F._v$28 = t1), n1 !== F._v$29 && Te(ue, "title", F._v$29 = n1), F;
        }, {
          _v$21: void 0,
          _v$22: void 0,
          _v$23: void 0,
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Im.cloneNode(!0), m = u.firstChild;
      ...
      keyed: !0,
      children: (a) => (() => {
        const u = Fm.cloneNode(!0), m = u.firstChild, g = m.firstChild, f = g.firstChild, y = f.nextSibling, k = y.nextSibling, A = k.nextSibling;
        A.nextSibling;
        const P = g.nextSibling, Y = P.firstChild, X = Y.nextSibling, G = X.nextSibling, R = G.nextSibling;
        R.nextSibling;
        const te = P.nextSibling, ue = te.nextSibling, Le = ue.firstChild, F = Le.nextSibling;
        F.nextSibling;
        ...
        }, g.$$click = () => ct("limit"), C(g, () => M().shortName ?? M().name ?? M().ticker, y), C(g, () => z1(a.price), A), P.$$click = () => ct("stop"), C(P, () => M().shortName ?? M().name ?? M().ticker, X), C(P, () => z1(a.price), R), te.$$click = () => ct("create"), ue.$$click = _t, C(ue, () => z1(a.price), F), ce.$$click = hn, C(ce, () => z1(a.price), null), I((ie) => {
          const $e = `${Math.max(0, a.y + 24)}px`, we = `${a.yAxisWidth + sn}px`;
          return $e !== ie._v$33 && u.style.setProperty("top", ie._v$33 = $e), we !== ie._v$34 && u.style.setProperty("right", ie._v$34 = we), ie;
        }, {
          _v$33: void 0,
          _v$34: void 0
        }), u;
      })()
    }), null), I(() => Te(i, "data-drawing-bar-visible", le())), r;
  })(), L(J, {
    get when() {
      return _();
    },

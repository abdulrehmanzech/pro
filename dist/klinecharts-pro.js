...
function n9(...e) {
  ...
  for (let r = 0; r < e.length; r++) {
    const a = e[r];
    t = t || !!a && Te in a, e[r] = typeof a == "function" ? (t = !0, R(a)) : a;
  }
  if (t)
    return new Proxy({
      get(r) {
...
const i = (e, t) => {
  ...
  return (() => {
    ...
    return V1((M) => {
      ...
      const M = R(() => !!o());
      return () => M() ? Uc.cloneNode(!0) : Kc.cloneNode(!0);
...
const vu = (e) => {
  const [t, n] = w(e.timezone), r = R(() => pu(e.locale));
  return $(K1, {
    get title() {
...
const _u = /* @__PURE__ */ p('<div class="klinecharts-pro-setting-modal-content"></div>'), $u = /* @__PURE__ */ p('<div class="setting-item"><span class="setting-label"></span><div class="setting-control"></div></div>'), bu = (e) => {
  ...
  const [t, n] = w(Q.clone(e.params.calcParams)), r = (a) => ku[a];
  return $(K1, {
    get title() {
...
const Eu = (e) => {
  ...
  const A1 = (c, d, C) => {
    ...
    try {
      ...
      const I = D9(x);
      if (I) {
        const y = e1.get(c), _ = ((C = y == null ? void 0 : y.points) == null ? void 0 : C.length) || 0, A = ((m = I.points) == null ? void 0 : m.length) || 0;
        e1.set(c, I);
        const U = _1(I.type);
        if (A >= U) {
          const V = r1.get(c);
    ...
    document.addEventListener("mouseup", m), document.addEventListener("touchend", m), setTimeout(() => {
      ...
      if (x && !x.complete) {
        ...
        const y = e1.get(c);
        if (y) {
          const _ = _1(y.type), A = ((I = y.points) == null ? void 0 : I.length) || 0;
      ...
      try {
        const C = `kline_drawings_${c}`, x = {
          drawings: d.map((I) => {
            ...
            const _ = _1(I.type), A = ((U = I.points) == null ? void 0 : U.length) || 0;
  ...
  e.ref({
    ...
    getSettings: () => {
      var C, m, x, I, y, _, A, U, V, g1, z1, q1, e0, t0, n0, r0;
      if (!n)
        return {};
      ...
      return {
        ...
        showHighestPrice: (U = (A = (_ = c.candle) == null ? void 0 : _.priceMark) == null ? void 0 : A.high) == null ? void 0 : U.show,
  ...
  const qe = () => {
    ...
    switch (c.timespan) {
      ...
      case "week": {
        ...
        m = m - _ * 60 * 60 * 24;
        const A = new Date(m);
        m = (/* @__PURE__ */ new Date(`${A.getFullYear()}-${A.getMonth() + 1}-${A.getDate()}`)).getTime(), x = C * c.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
  ...
  return Ke(() => {
    if (window.addEventListener("resize", qe), n = O9(t, {
      customApi: {
        formatDate: (y, _, A, U) => {
          switch (k().timespan) {
            case "minute":
              return U === ee.XAxis ? Q.formatDate(y, _, "HH:mm") : Q.formatDate(y, _, "YYYY-MM-DD HH:mm");
            case "hour":
              return U === ee.XAxis ? Q.formatDate(y, _, "MM-DD HH:mm") : Q.formatDate(y, _, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return Q.formatDate(y, _, "YYYY-MM-DD");
            case "month":
              return U === ee.XAxis ? Q.formatDate(y, _, "YYYY-MM") : Q.formatDate(y, _, "YYYY-MM-DD");
            case "year":
              return U === ee.XAxis ? Q.formatDate(y, _, "YYYY") : Q.formatDate(y, _, "YYYY-MM-DD");
          }
    ...
    e.subIndicators.forEach((y) => {
      ...
      s(!0), (async () => {
        try {
          const A = k(), [U] = ke(A, y, 1), [V] = ke(A, U, 500), g1 = await e.datafeed.getHistoryKLineData(v(), A, V, U);

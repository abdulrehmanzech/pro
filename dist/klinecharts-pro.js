...
function Y1(e, t) {
  const n = N, r = R, a = e.length === 0, i = a ? w9 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function j5(e, t, n) {
  ...
  const p = /* @__PURE__ */ new Set(), [L, w] = (i.storage || $)(i.initialValue), [B, F] = $(void 0), [M, Z] = $(void 0, {
    equals: !1
  ...
  function b(k, D, j, n1) {
    return o === k && (o = null, u = !0, (k === s || D === s) && i.onHydrated && queueMicrotask(() => i.onHydrated(n1, {
      value: D
    })), s = C0, O(D, j)), D;
  }
  function O(k, D) {
...
function r0(e, t, n, r = o1, a) {
  ...
  return R === null || R !== w9 && (R.owned ? R.owned.push(i) : R.owned = [i]), i;
}
function X1(e) {
  const t = d1;
  if (e.state === 0 || t)
...
function V5(e, t, n = {}) {
  ...
  return k0(() => Z0(i)), () => {
    let c = e() || [], C, u;
    return c[K5], s1(() => {
      let p = c.length, L, w, B, F, M, Z, S, x, b;
      if (p === 0)
        ...
        for (B = new Array(p), F = new Array(p), s && (M = new Array(p)), Z = 0, S = Math.min(o, p); Z < S && r[Z] === c[Z]; Z++)
          ;
        for (S = o - 1, x = p - 1; S >= Z && x >= Z && r[S] === c[x]; S--, x--)
          B[x] = a[S], F[x] = i[S], s && (M[x] = s[S]);
...
var j9 = k6, A6 = e1, M6 = A6["__core-js_shared__"], w6 = M6, g0 = w6, V0 = function() {
...
var M0 = oe, ce = Array.isArray, $1 = ce;
function le(e) {
...
var ke = xe, Ae = s0, Me = "__lodash_hash_undefined__", we = Object.prototype, Se = we.hasOwnProperty;
function Te(e) {
  var t = this.__data__;
  if (Ae) {
    var n = t[e];
...
var n3 = t3, J0 = i0, r3 = n3, a3 = $1, i3 = w0, s3 = 1 / 0, W0 = J0 ? J0.prototype : void 0, q0 = W0 ? W0.toString : void 0;
function Y9(e) {
  if (typeof e == "string")
    return e;
  if (a3(e))
...
var b3 = $3, x3 = M0, k3 = y3, A3 = V9, e9 = L1, M3 = b3;
function w3(e, t, n, r) {
  if (!e9(e))
    return e;
  t = k3(t, e);
...
var X9 = L8, $8 = O1, b8 = X9, x8 = b1, k8 = "[object Arguments]", A8 = "[object Array]", M8 = "[object Boolean]", w8 = "[object Date]", S8 = "[object Error]", T8 = "[object Function]", I8 = "[object Map]", N8 = "[object Number]", D8 = "[object Object]", P8 = "[object RegExp]", B8 = "[object Set]", O8 = "[object String]", E8 = "[object WeakMap]", F8 = "[object ArrayBuffer]", K8 = "[object DataView]", j8 = "[object Float32Array]", Z8 = "[object Float64Array]", Q8 = "[object Int8Array]", R8 = "[object Int16Array]", z8 = "[object Int32Array]", U8 = "[object Uint8Array]", Y8 = "[object Uint8ClampedArray]", V8 = "[object Uint16Array]", H8 = "[object Uint32Array]", I = {};
I[j8] = I[Z8] = I[Q8] = I[R8] = I[z8] = I[U8] = I[Y8] = I[V8] = I[H8] = !0;
I[k8] = I[A8] = I[F8] = I[M8] = I[K8] = I[w8] = I[S8] = I[T8] = I[I8] = I[N8] = I[D8] = I[P8] = I[B8] = I[O8] = I[E8] = !1;
function G8(e) {
...
var q9 = k7, A7 = J9, M7 = $7, w7 = q9;
function S7(e) {
  return w7(e) ? A7(e) : M7(e);
}
...
var x4 = b4, k4 = F0, A4 = y4, M4 = v4, w4 = L4, S4 = x4, T4 = "[object Boolean]", I4 = "[object Date]", N4 = "[object Map]", D4 = "[object Number]", P4 = "[object RegExp]", B4 = "[object Set]", O4 = "[object String]", E4 = "[object Symbol]", F4 = "[object ArrayBuffer]", K4 = "[object DataView]", j4 = "[object Float32Array]", Z4 = "[object Float64Array]", Q4 = "[object Int8Array]", R4 = "[object Int16Array]", z4 = "[object Int32Array]", U4 = "[object Uint8Array]", Y4 = "[object Uint8ClampedArray]", V4 = "[object Uint16Array]", H4 = "[object Uint32Array]";
function G4(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case F4:
...
function V1(e, t, n, r, a, i) {
  ...
  if (u) {
    ...
    if (d == c5 || d == s5 || p && !a) {
      if (o = c || p ? {} : Fn(e), !s)
        return c ? Nn(e, wn(o, e)) : In(e, Mn(o, e));
    } else {
      if (!T[d])
        return a ? e : {};
      o = En(e, d, s);
...
const l = (e, t) => {
  ...
  return S9(() => {
    ...
    const i = Cc.cloneNode(!0), o = i.firstChild, s = o.firstChild, c = o.nextSibling, C = c.firstChild, u = C.nextSibling, d = c.nextSibling, p = d.firstChild, L = p.nextSibling, w = d.nextSibling, B = w.firstChild, F = B.nextSibling, M = w.nextSibling, Z = M.firstChild, S = Z.nextSibling, x = M.nextSibling;
    return A0((b) => {
      t = b;
      ...
      return O.$$click = () => {
        e.onPeriodChange(b);
      }, m(O, () => b.text), Q(() => h1(O, `item period ${b.text === e.period.text ? "selected" : ""}`)), O;
    })()), c), l1(c, "click", e.onIndicatorClick, !0), m(u, () => l("indicator", e.locale)), l1(d, "click", e.onTimezoneClick, !0), m(L, () => l("timezone", e.locale)), l1(w, "click", e.onSettingClick, !0), m(F, () => l("setting", e.locale)), l1(M, "click", e.onScreenshotClick, !0), m(S, () => l("screenshot", e.locale)), x.$$click = () => {
      if (n())
...
const J = (e) => Bl[e.name](e.class), Ql = /* @__PURE__ */ g('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Rl = /* @__PURE__ */ g('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), _9 = /* @__PURE__ */ g('<li><span style="padding-left:8px"></span></li>'), L9 = "drawing_tools", zl = (e) => {
  const [t, n] = $("horizontalStraightLine"), [r, a] = $("priceChannelLine"), [i, o] = $("circle"), [s, c] = $("fibonacciLine"), [C, u] = $("xabcd"), [d, p] = $("weak_magnet"), [L, w] = $("normal"), [B, F] = $(!1), [M, Z] = $(!0), [S, x] = $(""), b = K(() => [{
    key: "singleLine",
    icon: t(),
    list: Ol(e.locale),
    setter: n
  ...
  return (() => {
    const H = Ql.cloneNode(!0), t1 = H.firstChild, k = t1.nextSibling, D = k.firstChild, j = D.nextSibling, n1 = j.firstChild, T1 = k.nextSibling, I1 = T1.firstChild, C1 = T1.nextSibling, E1 = C1.firstChild, F1 = C1.nextSibling, K1 = F1.nextSibling, j1 = K1.firstChild;
    return m(H, () => b().map((A) => (() => {
      ...
      })(), null), Q(() => G(N1, "class", A.key === S() ? "rotate" : "")), z;
    })()), t1), k.addEventListener("blur", () => {
      x("");
    }), D.$$click = () => {
      let A = d();
      L() !== "normal" && (A = "normal"), w(A), e.onModeChange(A);
    }, m(D, (() => {
      const A = K(() => d() === "weak_magnet");
      return () => A() ? (() => {
      ...
      return () => A() && y(n0, {
        ...
        get children() {
          return O().map((z) => (() => {
            ...
            return W.$$click = () => {
              p(z.key), w(z.key), e.onModeChange(z.key), x("");
            }, m(W, y(J, {
              get name() {
                return z.key;
              }
...
const lu = (e) => {
  let t, n = null, r, a = !1;
  const [i, o] = $(e.theme), [s, c] = $(e.styles), [C, u] = $(e.locale), [d, p] = $(e.symbol), [L, w] = $(e.period), [B, F] = $(!1), [M, Z] = $([...e.mainIndicators]), [S, x] = $({}), [b, O] = $(!1), [H, t1] = $({
    key: e.timezone,
    text: x9(e.timezone, e.locale)
  }), [k, D] = $(!1), [j, n1] = $(), [T1, I1] = $(""), [C1, E1] = $(e.drawingBarVisible), [F1, K1] = $(!1), [j1, A] = $(!1), [z, W] = $({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  return S9(() => {
      ...
      return y(Ul, {
        ...
        onMainIndicatorChange: (h) => {
          ...
          h.added ? (U1(n, h.name, !0, {
            id: "candle_pane"
          }), f.push(h.name)) : (n == null || n.removeIndicator("candle_pane", h.name), f.splice(f.indexOf(h.name), 1)), Z(f);
        },
    ...
    const v = t;
    return typeof v == "function" ? A0(v, f) : t = f, Q(() => G(f, "data-drawing-bar-visible", C1())), h;
  })()];

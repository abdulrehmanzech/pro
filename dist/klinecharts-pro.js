...
import { utils as fe, OverlayMode as pn, ActionType as S1, LineType as d1, init as V9, FormatDateType as Ut, DomPosition as h1, dispose as W0, TooltipIconPosition as zt, CandleType as H9, YAxisType as q9, registerOverlay as Y9 } from "klinecharts";
function ft(e, t, r) {
  ...
  if (e = h && r[0] && r[0].parentNode || e, l === "string" || l === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (d.length === 0) {
        ...
        v ? r.length === 0 ? er(e, d, n) : w5(e, r, d) : (r && K1(e), er(e, d));
      r = d;
...
var e9 = h6, f6 = Jr, m6 = c6, g6 = Q1, y6 = e9, p6 = /[\\^$.*+?()[\]{}|]/g, v6 = /^\[object .+?Constructor\]$/, C6 = Function.prototype, b6 = Object.prototype, $6 = C6.toString, _6 = b6.hasOwnProperty, k6 = RegExp(
  "^" + $6.call(_6).replace(p6, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function x6(e) {
  if (!g6(e) || m6(e))
    return !1;
...
var g2 = m2, y2 = sn, p2 = "__lodash_hash_undefined__";
function v2(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = y2 && t === void 0 ? p2 : t, this;
}
var C2 = v2, b2 = n2, $2 = o2, _2 = u2, k2 = g2, x2 = C2;
function H1(e) {
...
var vo = po, Co = to, bo = lo, $o = ho, _o = go, ko = vo;
function Y1(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
function li(e, t, r, n) {
  ...
  for (var s = -1, l = t.length, h = l - 1, d = e; d != null && ++s < l; ) {
    ...
    if (s != h) {
      var p = d[v];
      x = n ? n(p, v, d) : void 0, x === void 0 && (x = dr(p) ? p : ai(t[s + 1]) ? [] : {});
    }
    oi(d, v, x), d = d[v];
  }
  return e;
...
var Ai = wi, Mi = cn, Ti = gi, Si = pi, Pi = Ci, Di = $i, Oi = Ai;
function W1(e) {
...
function Ui(e, t, r, n) {
  ...
  for (var l = -1, h = t.length; ++l < h; ) {
    ...
    v === void 0 && (v = e[d]), s ? Fi(r, d, v) : Bi(r, d, v);
  }
  return r;
}
var dn = Ui;
...
Jt.exports;
(function(e, t) {
  var r = i1, n = Ji, s = t && !t.nodeType && t, l = s && !0 && e && !e.nodeType && e, h = l && l.exports === s, d = h ? r.Buffer : void 0, v = d ? d.isBuffer : void 0, x = v || n;
  e.exports = x;
})(Jt, Jt.exports);
...
var c9 = t3, n3 = gt, r3 = c9, o3 = V1, i3 = "[object Arguments]", a3 = "[object Array]", s3 = "[object Boolean]", l3 = "[object Date]", c3 = "[object Error]", u3 = "[object Function]", d3 = "[object Map]", h3 = "[object Number]", f3 = "[object Object]", m3 = "[object RegExp]", g3 = "[object Set]", y3 = "[object String]", p3 = "[object WeakMap]", v3 = "[object ArrayBuffer]", C3 = "[object DataView]", b3 = "[object Float32Array]", $3 = "[object Float64Array]", _3 = "[object Int8Array]", k3 = "[object Int16Array]", x3 = "[object Int32Array]", L3 = "[object Uint8Array]", w3 = "[object Uint8ClampedArray]", A3 = "[object Uint16Array]", M3 = "[object Uint32Array]", ve = {};
ve[b3] = ve[$3] = ve[_3] = ve[k3] = ve[x3] = ve[L3] = ve[w3] = ve[A3] = ve[M3] = !0;
ve[i3] = ve[a3] = ve[v3] = ve[s3] = ve[C3] = ve[l3] = ve[c3] = ve[u3] = ve[d3] = ve[h3] = ve[f3] = ve[m3] = ve[g3] = ve[y3] = ve[p3] = !1;
function T3(e) {
  return o3(e) && r3(e.length) && !!ve[n3(e)];
}
var S3 = T3;
function P3(e) {
  return function(t) {
...
function Q3(e, t) {
  var r = F3(e), n = !r && B3(e), s = !r && !n && U3(e), l = !r && !n && !s && K3(e), h = r || n || s || l, d = h ? E3(e.length, String) : [], v = d.length;
  for (var x in e)
...
var ga = ma, ya = Q1, pa = Rn, va = ga, Ca = Object.prototype, ba = Ca.hasOwnProperty;
function $a(e) {
  if (!ya(e))
    return va(e);
  var t = pa(e), r = [];
...
var p9 = s8, l8 = p9, c8 = Zn, u8 = jn;
function d8(e) {
  return l8(e, u8, c8);
}
var h8 = d8, f8 = p9, m8 = y9, g8 = Qn;
function y8(e) {
  return f8(e, g8, m8);
}
var p8 = y8, v8 = E1, C8 = i1, b8 = v8(C8, "DataView"), $8 = b8, _8 = E1, k8 = i1, x8 = _8(k8, "Promise"), L8 = x8, w8 = E1, A8 = i1, M8 = w8(A8, "Set"), T8 = M8, S8 = E1, P8 = i1, D8 = S8(P8, "WeakMap"), O8 = D8, Mn = $8, Tn = Fn, Sn = L8, Pn = T8, Dn = O8, v9 = gt, G1 = e9, yr = "[object Map]", N8 = "[object Object]", pr = "[object Promise]", vr = "[object Set]", Cr = "[object WeakMap]", br = "[object DataView]", I8 = G1(Mn), E8 = G1(Tn), B8 = G1(Sn), F8 = G1(Pn), U8 = G1(Dn), P1 = v9;
(Mn && P1(new Mn(new ArrayBuffer(1))) != br || Tn && P1(new Tn()) != yr || Sn && P1(Sn.resolve()) != pr || Pn && P1(new Pn()) != vr || Dn && P1(new Dn()) != Cr) && (P1 = function(e) {
  var t = v9(e), r = t == N8 ? e.constructor : void 0, n = r ? G1(r) : "";
  if (n)
    switch (n) {
      case I8:
        return br;
...
var os = rs, is = Hn, as = W8, ss = J8, ls = ts, cs = os, us = "[object Boolean]", ds = "[object Date]", hs = "[object Map]", fs = "[object Number]", ms = "[object RegExp]", gs = "[object Set]", ys = "[object String]", ps = "[object Symbol]", vs = "[object ArrayBuffer]", Cs = "[object DataView]", bs = "[object Float32Array]", $s = "[object Float64Array]", _s = "[object Int8Array]", ks = "[object Int16Array]", xs = "[object Int32Array]", Ls = "[object Uint8Array]", ws = "[object Uint8ClampedArray]", As = "[object Uint16Array]", Ms = "[object Uint32Array]";
function Ts(e, t, r) {
  var n = e.constructor;
  switch (t) {
    case vs:
...
var Xs = Gs, Js = Xs, e7 = zn, Mr = Kn, Tr = Mr && Mr.isSet, t7 = Tr ? e7(Tr) : Js, n7 = t7, r7 = Ni, o7 = Ei, i7 = En, a7 = fa, s7 = Sa, l7 = Pa, c7 = Oa, u7 = Za, d7 = o8, h7 = h8, f7 = p8, m7 = Vn, g7 = j8, y7 = Ss, p7 = Fs, v7 = Z1, C7 = l9, b7 = Hs, $7 = Q1, _7 = n7, k7 = jn, x7 = Qn, L7 = 1, w7 = 2, A7 = 4, C9 = "[object Arguments]", M7 = "[object Array]", T7 = "[object Boolean]", S7 = "[object Date]", P7 = "[object Error]", b9 = "[object Function]", D7 = "[object GeneratorFunction]", O7 = "[object Map]", N7 = "[object Number]", $9 = "[object Object]", I7 = "[object RegExp]", E7 = "[object Set]", B7 = "[object String]", F7 = "[object Symbol]", U7 = "[object WeakMap]", z7 = "[object ArrayBuffer]", K7 = "[object DataView]", R7 = "[object Float32Array]", j7 = "[object Float64Array]", Q7 = "[object Int8Array]", Z7 = "[object Int16Array]", V7 = "[object Int32Array]", H7 = "[object Uint8Array]", q7 = "[object Uint8ClampedArray]", Y7 = "[object Uint16Array]", W7 = "[object Uint32Array]", ye = {};
...
function Ht(e, t, r, n, s, l) {
  ...
  if (p) {
    ...
    if (L == $9 || L == C9 || D && !s) {
      if (h = v || D ? {} : p7(e), !d)
        return v ? d7(e, s7(h, e)) : u7(e, a7(h, e));
    } else {
      if (!ye[L])
        return s ? e : {};
      h = y7(e, L, d);
  ...
  var q = x ? v ? f7 : h7 : v ? x7 : k7, N = p ? void 0 : q(e);
...
const hl = /* @__PURE__ */ b('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), _9 = () => hl.cloneNode(!0), fl = /* @__PURE__ */ b('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), ml = () => fl.cloneNode(!0), gl = /* @__PURE__ */ b("<ul></ul>"), yl = /* @__PURE__ */ b("<li></li>"), nn = (e) => (() => {
  ...
  return t.$$click = (h) => {
    ...
    return () => h() && (() => {
      ...
      return C(d, () => e.buttons.map((v) => w(il, Yr(v, {
        get style() {
          return {
            ...e.minButtonWidth ? {
...
const Cl = /* @__PURE__ */ b('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), bl = /* @__PURE__ */ b('<div class="drop-down-container"><ul></ul></div>'), $l = /* @__PURE__ */ b('<div><input type="text"></div>'), _l = /* @__PURE__ */ b("<li></li>"), k9 = (e) => {
  ...
  return (() => {
    const p = Cl.cloneNode(!0), L = p.firstChild, D = L.firstChild;
...
const c = (e, t) => {
  ...
  const de = j(() => {
    const O = e.periods.filter((E) => {
      ...
      if (E.text === be || we && E.text === we)
        return !0;
      if (!we || we === be) {
        const ue = e.periods.find((Ae) => Ae.text !== be);
        return E.text === (ue == null ? void 0 : ue.text);
      }
      return !1;
  ...
  return Ke(() => {
    ...
    const O = ih.cloneNode(!0), E = O.firstChild, be = E.firstChild, we = be.firstChild, ue = be.nextSibling, Ae = ue.firstChild;
    return O.style.setProperty("position", "relative"), O.style.setProperty("width", "100%"), O.style.setProperty("display", "flex"), O.style.setProperty("align-items", "center"), C(O, w(J, {
    ...
    }), ue), ue.style.setProperty("display", "flex"), ue.style.setProperty("gap", "4px"), ue.style.setProperty("margin-left", "auto"), ue.style.setProperty("align-items", "center"), ue.style.setProperty("flex", "0 0 auto"), C(ue, w(J, {
      get when() {
      ...
      return le !== _._v$11 && Oe(we, "class", _._v$11 = le), Pe !== _._v$12 && ue.style.setProperty("padding-right", _._v$12 = Pe), _;
    }, {
      _v$11: void 0,
      _v$12: void 0
    }), O;
...
const qe = (e) => Nf[e.name](e.class), Kf = /* @__PURE__ */ b('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), Rf = /* @__PURE__ */ b('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), Dr = /* @__PURE__ */ b('<li><span style="padding-left:8px"></span></li>'), Or = "drawing_tools", jf = (e) => {
  ...
  return (() => {
    const U = Kf.cloneNode(!0), Q = U.firstChild, H = Q.nextSibling, te = H.firstChild, se = te.nextSibling, Le = se.firstChild, $e = H.nextSibling, ie = $e.firstChild, Ue = $e.nextSibling, ke = Ue.firstChild, pe = Ue.nextSibling, oe = pe.nextSibling, de = oe.firstChild;
    return C(U, () => V().map((Z) => (() => {
...
const am = /* @__PURE__ */ b('<div class="klinecharts-pro-mobile-more-modal-content"><div class="item"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="20" height="20" rx="4" ry="4" fill="none" stroke="currentColor" stroke-width="2"></rect><path d="m15.92 13.9-3.65-3.55a.773.773 0 0 1 0-1.12c.32-.33.79-.33 1.11 0l3.02 3.38c.31.32.31.81 0 1.13-.16.16-.48.16-.48.16Z" fill="currentColor" stroke="1"></path><path d="m12.43 14.23-.48-.17q-.48-.48 0-.96l4.13-4.36c.31-.32.63-.32.95 0s.32.65 0 .97l-4.13 4.35c-.15.17-.31.17-.47.17Zm-1.11-9.52c.31 0 1.11.16 1.11.97 0 .64-.95.48-1.27.48-1.43 0-1.91.81-2.07 1.45l-.31 1.94h1.58c.32 0 .64.32.64.64 0 .33-.32.65-.64.65H8.62l-1.11 4.99c-.16 1.46-1.11 1.46-1.59 0L7.03 11H5.6c-.31 0-.63-.32-.63-.65 0-.64.32-.8.63-.8h1.75l.48-2.1c.31-2.74 2.69-2.9 3.49-2.74Z" fill="noncurrentColore" stroke="1"></path></svg><span></span></div><div class="item"><svg width="20" height="20" viewBox="0 0 20 20"><path d="M18.5446,9.09091C18.3333,6.61616,17.2887,4.31818,15.5751,2.63889C13.8498,0.94697,11.6197,0,9.28404,0C8.02817,0,6.81925,0.265151,5.66901,0.782828C5.65728,0.782828,5.65728,0.795454,5.64554,0.795454C5.6338,0.795454,5.6338,0.808081,5.62207,0.808081C4.53052,1.31313,3.55634,2.0202,2.71127,2.92929C1.85446,3.85101,1.18545,4.91162,0.715963,6.11111C0.246479,7.33586,0,8.64899,0,10C0,10.8712,0.105634,11.7172,0.305164,12.5379C0.305164,12.5631,0.316901,12.5884,0.328638,12.6136C0.739437,14.2298,1.51408,15.7197,2.62911,16.9571C4.07277,18.548,5.92723,19.5581,7.93427,19.8737C7.95775,19.8737,7.96948,19.8864,7.99296,19.8864C8.3216,19.9369,8.66197,19.9747,9.00235,19.9747L9.21362,19.9747C9.61268,19.9747,10.3756,19.9369,11.0094,19.697C11.1737,19.6338,11.3028,19.5076,11.3732,19.3434C11.4437,19.1793,11.4554,18.9899,11.3967,18.8131C11.3028,18.5354,11.0563,18.346,10.7864,18.346C10.716,18.346,10.6338,18.3586,10.5634,18.3838C10.0939,18.5606,9.46009,18.5859,9.20188,18.5859L9.09624,18.5859C9.20188,18.2702,9.23709,17.9167,9.15493,17.5505C9.00235,16.8939,8.50939,16.3384,7.58216,15.7955L7.19484,15.5682C6.57277,15.2146,6.23239,15.0253,6.03286,14.7348C5.83333,14.4444,5.69249,13.9899,5.51643,12.9798C5.38732,12.298,5.04695,11.7677,4.50704,11.4646C4.14319,11.2626,3.70892,11.149,3.19249,11.149C2.82864,11.149,2.42958,11.1995,2.00704,11.3005C1.79578,11.351,1.59624,11.4141,1.42019,11.4646C1.33803,10.9848,1.30282,10.
1524,7.61092,12.2943,5.85189,10.0024,5.85189ZM11.8699,11.5486C11.37,12.0196,10.7074,12.2808,10.0024,12.2808C9.29732,12.2808,8.63473,12.0196,8.13483,11.5486C7.6373,11.0754,7.36142,10.4481,7.36142,9.78068C7.36142,9.11323,7.6373,8.48596,8.13483,8.01272C8.63473,7.53948,9.29732,7.28054,10.0024,7.28054C10.7074,7.28054,11.37,7.53948,11.8699,8.01272C12.3674,8.48596,12.6433,9.11323,12.6433,9.78068C12.6433,10.4481,12.3674,11.0754,11.8699,11.5486Z"></path></svg><span></span></div></div>'), sm = (e) => w(x1, {
  ...
  get children() {
    const t = am.cloneNode(!0), r = t.firstChild, n = r.firstChild, s = n.nextSibling, l = r.nextSibling, h = l.firstChild, d = h.nextSibling, v = l.nextSibling, x = v.firstChild, p = x.nextSibling;
    return r.$$click = () => {
...
const lm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-picker"></div>'), cm = /* @__PURE__ */ b('<label class="klinecharts-pro-time-tools-field"><button type="button" class="klinecharts-pro-time-tools-input"><span></span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></button></label>'), um = /* @__PURE__ */ b("<span></span>"), dm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-calendar"><div class="klinecharts-pro-time-tools-month"><button type="button">&lt;&lt;</button><button type="button">&lt;</button><button type="button" class="calendar-title"></button><button type="button">></button><button type="button">>></button></div></div>'), hm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-grid"></div>'), fm = /* @__PURE__ */ b('<span class="weekday"></span>'), D1 = /* @__PURE__ */ b('<button type="button"></button>'), mm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-month-grid"></div>'), gm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-month-grid year-grid"></div>'), ym = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-spinners"><div class="spinner-column scrollable"></div><div class="spinner-column scrollable"></div><div class="spinner-column"></div></div>'), pm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-content"></div>'), vm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-tabs"></div>'), Cm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-range-panel"><div class="klinecharts-pro-time-tools-range-header"><button type="button"></button><span class="klinecharts-pro-time-tools-range-arrow" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></span><button type="button"></button><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="16" height="15" rx="2"></rect><path d="M8 3v4M16 3v4M4 10h16"></path></svg></div></div>'), bm = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-panel"><div class="klinecharts-pro-time-tools-row"><div><strong>Time Anchor</strong><span>Anchor to a time on the chart when switching between intervals</span></div><button type="button"><span></span></button></div><div><div><strong>Anchor Point</strong></div><select><option value="date">Date</option><option value="left">Left</option><option value="center">Center</option><option value="right">Right</option></select></div><div><div><strong>Anchor line</strong><span>Mark the anchored time on the chart with a vertical line</span></div><button type="button"><span></span></button></div><div><div><strong>Across Tokens</strong><span>Retain onscreen chart range when switching symbols</span></div><button type="button"><span></span></button></div></div>'), $m = /* @__PURE__ */ b('<div class="klinecharts-pro-time-tools-anchor-date"></div>'), _m = [{
  ...
  const [t, r] = T(!0), [n, s] = T("date"), [l, h] = T(e.value.year), [d, v] = T(e.value.month), x = j(() => xm(l(), d())), p = j(() => Math.floor(l() / 10) * 10), L = j(() => Array.from({
    length: 12
    ...
    return C(U, (() => {
      ...
      return () => Q() && (() => {
        ...
        return se.$$click = () => {
          ...
          const ke = j(() => n() === "date");
          return () => ke() && (() => {
            const pe = hm.cloneNode(!0);
            return C(pe, () => km.map((oe) => (() => {
              const de = fm.cloneNode(!0);
              return C(de, oe), de;
            })()), null), C(pe, () => x().map(({
              date: oe,
              current: de
              ...
              const Z = _n({
                ...
                month: oe.getMonth(),
                day: oe.getDate()
              }), O = e.range ? _n(e.range.from) : NaN, E = e.range ? _n(e.range.to) : NaN, be = Math.min(O, E), we = Math.max(O, E), ue = Number.isFinite(be) && Z >= be && Z <= we, Ae = Number.isFinite(be) && (Z === be || Z === we), _ = oe.getFullYear() === e.value.year && oe.getMonth() === e.value.month && oe.getDate() === e.value.day;
              return (() => {
                const le = D1.cloneNode(!0);
                return le.$$click = () => re(oe), ne(le, `${de ? "" : "muted"} ${ue ? "in-range" : ""} ${Ae || _ ? "selected" : ""}`), C(le, () => oe.getDate()), le;
              })();
            }), null), pe;
          })();
        })(), null), C(H, (() => {
          const ke = j(() => n() === "month");
          return () => ke() && (() => {
            const pe = mm.cloneNode(!0);
            return C(pe, () => Fr.map((oe, de) => (() => {
              const Z = D1.cloneNode(!0);
              return Z.$$click = () => R(de), C(Z, oe), B(() => ne(Z, de === e.value.month && l() === e.value.year ? "selected" : "")), Z;
            })())), pe;
          })();
        })(), null), C(H, (() => {
          const ke = j(() => n() === "year");
          return () => ke() && (() => {
            ...
            return C(pe, () => L().map((oe) => (() => {
              const de = D1.cloneNode(!0);
              return de.$$click = () => Y(oe), C(de, oe), B(() => ne(de, `${oe < p() || oe > p() + 9 ? "muted" : ""} ${oe === e.value.year ? "selected" : ""}`)), de;
            })())), pe;
          })();
        })(), null), C(H, (() => {
          const ke = j(() => n() === "date");
          return () => ke() && (() => {
            const pe = ym.cloneNode(!0), oe = pe.firstChild, de = oe.nextSibling, Z = de.nextSibling;
            return C(oe, () => q.map((O) => (() => {
      ...
      return C(N, (() => {
        ...
        return () => F() && (() => {
          ...
          return Y.$$click = () => M({
            ...
            const Ue = `klinecharts-pro-time-tools-switch${L().enabled ? " on" : ""}`, ke = `klinecharts-pro-time-tools-row${L().enabled ? "" : " disabled"}`, pe = !L().enabled, oe = `klinecharts-pro-time-tools-row with-divider${L().enabled ? "" : " disabled"}`, de = `klinecharts-pro-time-tools-switch${L().anchorLine ? " on" : ""}`, Z = !L().enabled, O = `klinecharts-pro-time-tools-row with-divider${L().enabled ? "" : " disabled"}`, E = `klinecharts-pro-time-tools-switch${L().acrossTokens ? " on" : ""}`, be = !L().enabled;
            return Ue !== ie._v$3 && ne(Y, ie._v$3 = Ue), ke !== ie._v$4 && ne(V, ie._v$4 = ke), pe !== ie._v$5 && (U.disabled = ie._v$5 = pe), oe !== ie._v$6 && ne(Q, ie._v$6 = oe), de !== ie._v$7 && ne(te, ie._v$7 = de), Z !== ie._v$8 && (te.disabled = ie._v$8 = Z), O !== ie._v$9 && ne(se, ie._v$9 = O), E !== ie._v$10 && ne($e, ie._v$10 = E), be !== ie._v$11 && ($e.disabled = ie._v$11 = be), ie;
          }, {
            _v$3: void 0,
            _v$4: void 0,
            _v$5: void 0,
...
const Rm = (e) => {
  ...
  }), [Le, $e] = T(!1), [ie, Ue] = T(), [ke, pe] = T(""), [oe, de] = T(!1), [Z, O] = T(Date.now()), [E, be] = T({
  ...
  const w9 = () => {
    ...
    Number.isFinite(i) && i !== o.timestamp && ue({
      ...o,
      timestamp: i
    });
  }, A9 = () => {
    ...
    ue(a), a.enabled ? (O(a.timestamp), requestAnimationFrame(() => {
      p0(a), $1(a);
